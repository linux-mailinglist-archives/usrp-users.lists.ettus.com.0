...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D7EC10741E
	for <lists+usrp-users@lfdr.de>; Fri, 22 Nov 2019 15:36:55 +0100 (CET)
Received: from [::1] (port=37550 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iYA3H-0005pD-Gc; Fri, 22 Nov 2019 09:36:51 -0500
Received: from mail-lj1-f173.google.com ([209.85.208.173]:33894)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <jlockhartrt@gmail.com>)
 id 1iYA3C-0005kF-On
 for usrp-users@lists.ettus.com; Fri, 22 Nov 2019 09:36:47 -0500
Received: by mail-lj1-f173.google.com with SMTP id m6so269515ljc.1
 for <usrp-users@lists.ettus.com>; Fri, 22 Nov 2019 06:36:26 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=kxc2hCxMDGshBpPrCAE01Rf5E18wV4lhaLUWgVFrFYU=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=kxc2hCxMDGshBpPrCAE01Rf5E18wV4lhaLUWgVFrFYU=;
 b=
X-Gm-Message-State: APjAAAUY7J+fQloA2nfVOekEav4Hs3Za3XxWBZN9RBPKiQYa0ATBAoJl
 WczGqO1/G3QLHDCbN9X1sH5yAx8XRjGaHtMS3ro=
X-Google-Smtp-Source: APXvYqxnJapGUlDu2ZnVfwA7zvvvbI+zwvg1cFck/uKROhWgKXSRXCZf3eDTLwZsfNd2GSdptILGM3KkWH39JrEG2m0=
X-Received: by 2002:a05:651c:209:: with SMTP id
 y9mr12161168ljn.65.1574433364445; 
 Fri, 22 Nov 2019 06:36:04 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CADRnH2296cr7moDbDLPg1gSt2Q+VT_P_Jin5Vh8r_s=eCZdbwQ@mail.gmail.com>
Date: Fri, 22 Nov 2019 09:33:21 -0500
Message-ID: <CALY+5sK3D-ndWG-anNPEejrpGkk2vNz2EpfBA6eQ7edjj3q3NA@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============0186257325172047077=="
...
--===============0186257325172047077==
Content-Type: multipart/alternative; boundary="000000000000690fde0597f05549"

--000000000000690fde0597f05549
...
<div dir=3D"ltr"><div>Hey EJ,</div><div><br></div><div>Sorry for being slow=
 I had to dig=20
...
t;<a href=3D"mailto:ejkreinar@gmail.com">ejkreinar@gmail.com</a>&gt; wrote:=
<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8=
ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"aut=
o">Okay, great...<div dir=3D"auto"><br></div><div dir=3D"auto">You might wa=
nt to try increasing the log level. Export UHD_LOG_CONSOLE_LEVEL=3Dtrace or=
 debug and try to make sure the correct xml file is getting applied to the =
block correctly.</div><div dir=3D"auto"><br></div><div dir=3D"auto">There&#=
39;s also something like a &quot;--tree&quot; parameter in the uhd_usrp_pro=
be so try running the probe with the tree option to print out the device tr=
ee and look for the arguments assigned to your new block.</div><div dir=3D"=
auto"><br></div><div dir=3D"auto">Let&#39;s see if any of that helps figure=
 out what&#39;s going on...</div><div dir=3D"auto">EJ</div></div><br><div c=
lass=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Nov 21, =
2019, 4:01 PM Jonathan Lockhart &lt;<a href=3D"mailto:jlockhartrt@gmail.com=
" rel=3D"noreferrer" target=3D"_blank">jlockhartrt@gmail.com</a>&gt; wrote:=
<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8=
ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr=
"><div>Also, when I compiled from the OOT directory for ARM, I used this co=
mmand, which I pieced together from the RFNoC build guide, and the release-=
4 guide for cross-compiling gr-ettus. <br></div><div><br></div><div>cmake -=
DCMAKE_TOOLCHAIN_FILE=3D~/rfnoc/src/gnuradio/cmake/Toolchains/oe-sdk_cross.=
cmake -DCMAKE_INSTALL_PREFIX=3D/usr -DUHD_FPGA_DIR=3D&quot;/home/jon/rfnoc/=
src/uhd/fpga-src/&quot; ../</div><div><br></div><div>Regards,</div><div>Jon=
<br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gm=
ail_attr">On Thu, Nov 21, 2019 at 3:48 PM Jonathan Lockhart &lt;<a href=3D"=
mailto:jlockhartrt@gmail.com" rel=3D"noreferrer noreferrer" target=3D"_blan=
k">jlockhartrt@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail=
_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204=
,204);padding-left:1ex"><div dir=3D"ltr"><div>Greetings EJ,</div><div><br><=
/div><div>So, from the tutorial, they have you edit the gain.xml file, and =
this is what I have for it. <br></div><div><br></div><div>&lt;?xml version=
=3D&quot;1.0&quot;?&gt;<br>&lt;!--Default XML file--&gt;<br>&lt;nocblock&gt=
;<br>=C2=A0 &lt;name&gt;gain&lt;/name&gt;<br>=C2=A0 &lt;blockname&gt;gain&l=
t;/blockname&gt;<br>=C2=A0 &lt;ids&gt;<br>=C2=A0 =C2=A0 &lt;id revision=3D&=
quot;0&quot;&gt;B7DD64941A952AAC&lt;/id&gt;<br>=C2=A0 &lt;/ids&gt;<br>=C2=
=A0 &lt;!-- Registers --&gt;<br>=C2=A0 &lt;registers&gt;<br>=C2=A0 =C2=A0 &=
lt;setreg&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;name&gt;Gain&lt;/name&gt;<br>=C2=
=A0 =C2=A0 =C2=A0 &lt;address&gt;128&lt;/address&gt;<br>=C2=A0 =C2=A0 &lt;/=
setreg&gt;<br>=C2=A0 &lt;/registers&gt;<br>=C2=A0 &lt;!-- Args --&gt;<br>=
=C2=A0 &lt;args&gt;<br>=C2=A0 =C2=A0 &lt;args&gt;<br>=C2=A0 =C2=A0 =C2=A0 &=
lt;name&gt;gain&lt;/name&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;type&gt;double&lt;=
/type&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;value&gt;1.0&lt;/value&gt;<br>=C2=A0 =
=C2=A0 =C2=A0 &lt;check&gt;GE($gain, 0.0) AND LE($gain, 32767.0)&lt;/check&=
gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;check_message&gt;Invalid Gain!&lt;/check_me=
ssage&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;action&gt;<br>=C2=A0 =C2=A0 =C2=A0 =
=C2=A0 SR_WRITE(&quot;GAIN&quot;, IROUND($gain))<br>=C2=A0 =C2=A0 =C2=A0 &l=
t;/action&gt;<br>=C2=A0 =C2=A0 &lt;/args&gt;<br>=C2=A0 &lt;/args&gt;<br>=C2=
=A0 &lt;!--One input, one output. If this is used, better have all the info=
 the C++ file.--&gt;<br>=C2=A0 &lt;ports&gt;<br>=C2=A0 =C2=A0 &lt;sink&gt;<=
br>=C2=A0 =C2=A0 =C2=A0 &lt;name&gt;in0&lt;/name&gt;<br>=C2=A0 =C2=A0 =C2=
=A0 &lt;type&gt;sc16&lt;/name&gt;<br>=C2=A0 =C2=A0 &lt;/sink&gt;<br>=C2=A0 =
=C2=A0 &lt;source&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;name&gt;out0&lt;/name&gt;=
<br>=C2=A0 =C2=A0 =C2=A0 &lt;type&gt;sc16&lt;/name&gt;<br>=C2=A0 =C2=A0 &lt=
;/source&gt;<br>=C2=A0 &lt;/ports&gt;<br>&lt;/nocblock&gt;</div><div><br></=
div><div>There is an args value and it is declared as gain. <br></div><div>=
<br></div><div>So from there, I followed your second suggestion and tried t=
o find where it was installed when I did the cross compile. It was not plac=
ed in the &quot;GRC_BLOCKS_PATH&quot; of &quot;/share/gnuradio/grc/blocks&q=
uot; like the default RFNoC blocks. It was instead placed in &quot;/share/u=
hd/rfnoc/bocks&quot; so I added that to the setup.env file, included below.=
 <br></div><div><br></div><div>LOCALPREFIX=3D~/newinstall/usr<br>export PAT=
H=3D$LOCALPREFIX/bin:$PATH<br>export LD_LOAD_LIBRARY=3D$LOCALPREFIX/lib:$LD=
_LOAD_LIBRARY<br>export LD_LIBRARY_PATH=3D$LOCALPREFIX/lib:$LD_LIBRARY_PATH=
<br>export PYTHONPATH=3D$LOCALPREFIX/lib/python2.7/site-packages:$PYTHONPAT=
H<br>export PKG_CONFIG_PATH=3D$LOCALPREFIX/lib/pkgconfig:$PKG_CONFIG_PATH<b=
r>export GRC_BLOCKS_PATH=3D$LOCALPREFIX/share/gnuradio/grc/blocks:$GRC_BLOC=
KS_PATH<br>export UHD_RFNOC_DIR=3D$LOCALPREFIX/share/uhd/rfnoc/<br>export U=
HD_IMAGES_DIR=3D$LOCALPREFIX/share/uhd/images<br>export GRC_BLOCKS_PATH=3D$=
LOCALPREFIX/share/uhd/rfnoc/blocks:$GRC_BLOCKS_PATH</div><div><br></div><di=
v>Unfortunately, after re-sourcing the setup.env, I still get the same mess=
age. <br></div><div><br></div><div>=C2=A0 File &quot;rfnoc_myGain_usrp.py&q=
uot;, line 223, in &lt;module&gt;<br>=C2=A0 =C2=A0 main()<br>=C2=A0 File &q=
uot;rfnoc_myGain_usrp.py&quot;, line 212, in main<br>=C2=A0 =C2=A0 tb =3D t=
op_block_cls(fpga_path=3Doptions.fpga_path, rx_gain=3Doptions.rx_gain, rx_d=
igital_gain=3Doptions.rx_digital_gain, rx_freq=3Doptions.rx_freq, host_ip_a=
ddr=3Doptions.host_ip_addr)<br>=C2=A0 File &quot;rfnoc_myGain_usrp.py&quot;=
, line 117, in __init__<br>=C2=A0 =C2=A0 self.tutorial_gain_0.set_arg(&quot=
;gain&quot;, rx_digital_gain)<br>=C2=A0 File &quot;/home/root/newinstall/us=
r/lib/python2.7/site-packages/tutorial/tutorial_swig.py&quot;, line 315, in=
 set_arg<br>=C2=A0 =C2=A0 return _tutorial_swig.gain_sptr_set_arg(self, *ar=
gs)<br>RuntimeError: LookupError: Path not found in tree: /mboards/0/xbar/g=
ain_0/args/0/gain/value</div><div><br></div><div>I looked at some of your e=
xamples (which have been very helpful to get me this far) from what I belie=
ve is your github someone linked me. Everything appears to match what it sh=
ould, for what gain is trying to accomplish. <br></div><div><br></div><div>=
Regards,</div><div>Jon<br></div></div><br><div class=3D"gmail_quote"><div d=
ir=3D"ltr" class=3D"gmail_attr">On Thu, Nov 21, 2019 at 3:27 PM EJ Kreinar =
&lt;<a href=3D"mailto:ejkreinar@gmail.com" rel=3D"noreferrer noreferrer" ta=
rget=3D"_blank">ejkreinar@gmail.com</a>&gt; wrote:<br></div><blockquote cla=
ss=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid =
rgb(204,204,204);padding-left:1ex"><div dir=3D"auto">Hi Jon,<div dir=3D"aut=
o"><br></div><div dir=3D"auto">The rfnoc &quot;nocscript&quot; xml definiti=
on can create arguments and attach to the device tree like you are trying t=
o set there (it&#39;s not compiled directly, but rather created dynamically=
 from the xml definition)</div><div dir=3D"auto"><br></div><div dir=3D"auto=
">Recommended debugging...</div><div dir=3D"auto">1. Check your OOT gain bl=
ock xml (in rfnoc/blocks) and make sure it has a &quot;gain&quot; field in =
the &quot;args&quot; list. You&#39;ll also want to make sure it writes your=
 desired register, but I don&#39;t think you&#39;re even getting that far</=
div><div dir=3D"auto">2. Make sure the block xml is installed on the e310 e=
mbedded prefix and is found at run time during uhd_usrp_probe and when runn=
ing your application. If it&#39;s not in the right place or not attaching t=
o your block then it won&#39;t create the gain argument</div><div dir=3D"au=
to"><br></div><div dir=3D"auto">I&#39;m guessing it&#39;s one of those two =
possibilities...=C2=A0</div><div dir=3D"auto">EJ</div></div><br><div class=
=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Nov 21, 2019=
, 3:19 PM Jonathan Lockhart via USRP-users &lt;<a href=3D"mailto:usrp-users=
...
tr"><div dir=3D"ltr"><div>Greetings,</div><div><br></div><div>I was able to=
 get the ARM cross compile working. I removed the build directory and re-so=
urced the dev environment and then the cross-compile used the -mfloar=3Dhar=
d flag. Not sure what caused the issue earlier and why it wasn&#39;t pickin=
g it up. <br></div><div><br></div><div>Now I have a different issue. So I h=
ave completed this guide: <a href=3D"https://kb.ettus.com/Getting_Started_w=
ith_RFNoC_Development" rel=3D"noreferrer noreferrer noreferrer noreferrer" =
target=3D"_blank">https://kb.ettus.com/Getting_Started_with_RFNoC_Developme=
nt</a></div><div><br></div><div>I modified the GNURadio just a bit so that =
the output from gain was placed on a ZMQ push, and the graphics were on the=
 host to graph the signal (seen in the screenshots below).</div><div><br></=
div><div><img src=3D"https://mail.google.com/mail/?ui=3D2&amp;ik=3D1ae81886=
2e&amp;attid=3D0.1&amp;th=3D16e8fa0d29d41a0b&amp;view=3Dfimg&amp;rm=3D16e8f=
a0d29d41a0b&amp;sz=3Dw1600-h1000&amp;attbid=3DANGjdJ9y7gFvlLamcYxSJn6AlQPaO=
WxC-yKbQfs66eomTeFYM6q3_niAOKNUXc1Zg3SMXvqL5kKB2WW0iVIUpeHmo3J5jnu8i5PrKbSu=
fhNtuNcli1NuCSF6ANVjs9A&amp;disp=3Demb&amp;realattid=3Dii_k395j53q0&amp;zw"=
 alt=3D"Screenshot from 2019-11-21 15-06-33.jpg" width=3D"566" height=3D"32=
3"></div><div><br></div><div><div><div><img src=3D"https://mail.google.com/=
mail/?ui=3D2&amp;ik=3D1ae818862e&amp;attid=3D0.2&amp;th=3D16e8fa0d29d41a0b&=
amp;view=3Dfimg&amp;rm=3D16e8fa0d29d41a0b&amp;sz=3Dw1600-h1000&amp;attbid=
=3DANGjdJ-pgUA2IxgobGph9ydEXrRSxBiZ2abKuAIUC6-7E30-eRFqzoPp7Si4HBspS4AqGUMX=
1xI3FnJFhwEqKs4fyPQ6s4_qFai45x5QazbWRR2aPlrFaKrc6EfeGhw&amp;disp=3Demb&amp;=
realattid=3Dii_k395j8qd1&amp;zw" alt=3D"Screenshot from 2019-11-21 15-010-4=
4.jpg" width=3D"566" height=3D"335"><br></div></div><div><br></div><div>How=
ever, when I run the top file for the USRP, I am running into this error. <=
br></div><div><br></div><div>Traceback (most recent call last):<br>=C2=A0 F=
ile &quot;rfnoc_myGain_usrp.py&quot;, line 223, in &lt;module&gt;<br>=C2=A0=
 =C2=A0 main()<br>=C2=A0 File &quot;rfnoc_myGain_usrp.py&quot;, line 212, i=
n main<br>=C2=A0 =C2=A0 tb =3D top_block_cls(fpga_path=3Doptions.fpga_path,=
 rx_gain=3Doptions.rx_gain, rx_digital_gain=3Doptions.rx_digital_gain, rx_f=
req=3Doptions.rx_freq, host_ip_addr=3Doptions.host_ip_addr)<br>=C2=A0 File =
&quot;rfnoc_myGain_usrp.py&quot;, line 117, in __init__<br>=C2=A0 =C2=A0 se=
lf.tutorial_gain_0.set_arg(&quot;gain&quot;, rx_digital_gain)<br>=C2=A0 Fil=
e &quot;/home/root/newinstall/usr/lib/python2.7/site-packages/tutorial/tuto=
rial_swig.py&quot;, line 315, in set_arg<br>=C2=A0 =C2=A0 return _tutorial_=
swig.gain_sptr_set_arg(self, *args)<br>RuntimeError: LookupError: Path not =
found in tree: /mboards/0/xbar/gain_0/args/0/gain/value</div><div><br></div=
><div>No where else in building GNURadio scripts and .bit files does this &=
quot;/mboards&quot; arise, and I have looked through my verilog file for ga=
in (gain.v) and it is correct per the instructions in the linked guide, and=
 I built the python and gnuradio hook exactly as the instructions stated to=
. <br></div><div><br></div><div>Anyone have an troubleshooting ideas b/c I =
am currently at a loss. It did past the test bench they have you build with=
 no issues. <br></div><div><br></div><div>Regards,</div><div></div><div></d=
iv><div>Jon</div><div><br></div><div><br></div><div><br></div></div></div><=
/div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_a=
ttr">On Wed, Nov 20, 2019 at 3:21 PM Jonathan Lockhart &lt;<a href=3D"mailt=
o:jlockhartrt@gmail.com" rel=3D"noreferrer noreferrer noreferrer noreferrer=
" target=3D"_blank">jlockhartrt@gmail.com</a>&gt; wrote:<br></div><blockquo=
te class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px =
solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div dir=3D"ltr">=
<div>Greetings,</div><div><br></div><div>I am having some issues completing=
 the RFNOC build tutorial on the Ettus E312. The reference documentation is=
 using an X3xx series radio, and from the final python script it appears to=
 be running the GNR script natively on the host. I built the exact script f=
rom the KB but when running on the radio it fails stating it can&#39;t &quo=
t;import tutorial.&quot; I realized all the files that were installed were =
placed on the host but not cross compiled for the E3xx using the SDK and AR=
M cross compile tool. I tried to complete this task, but unfortunately the =
compilation dies here. </div><div><br></div><div>/home/jon/rfnoc/oe/sysroot=
s/armv7ahf-vfp-neon-oe-linux-gnueabi/usr/include/gnu/stubs.h:7:11: fatal er=
ror: gnu/stubs-soft.h: No such file or directory<br>=C2=A0# include &lt;gnu=
/stubs-soft.h&gt;<br>=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0^~~~~~~~~~~~~=
~~~~~<br>compilation terminated.</div><div><br></div><div>Now I did find th=
e stubs-soft.h file in the libc6-dev-armel-cross in the apt repo. I install=
ed it and tried to cp the file into the /home/jon/rfnoc/oe/sysroots/armv7ah=
f-vfp-neon-oe-linux-gnueabi/usr/include/gnu/ location but it still doesn&#3=
9;t like that. I verified that on my echo $CC that the -mfloat is set to ha=
rd as shown here.</div><div><br></div><div>jon@jon-OptiPlex-9020:~/rfnoc/sr=
c/rfnoc-tutorial$ echo $CC<br>arm-oe-linux-gnueabi-gcc -march=3Darmv7-a -mf=
loat-abi=3Dhard -mfpu=3Dneon --sysroot=3D/home/jon/rfnoc/oe/sysroots/armv7a=
hf-vfp-neon-oe-linux-gnueabi</div><div><br></div><div>So I am not sure why =
the gain module in the tutorial is looking for the soft file. <br></div><di=
v><br></div><div>If anyone has experience in porting their OOT modules over=
 to the E-series of radios I would appreciate the help. <br></div><div><br>=
</div><div>Regards,</div><div>Jon<br></div></div></div>
</blockquote></div></div>
