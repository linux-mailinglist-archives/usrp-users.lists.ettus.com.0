...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 6724734026B
	for <lists+usrp-users@lfdr.de>; Thu, 18 Mar 2021 10:49:14 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 34B03383707
	for <lists+usrp-users@lfdr.de>; Thu, 18 Mar 2021 05:49:13 -0400 (EDT)
Received: from mail-lf1-f54.google.com (mail-lf1-f54.google.com [209.85.167.54])
	by mm2.emwd.com (Postfix) with ESMTPS id 6AE633836A7
	for <usrp-users@lists.ettus.com>; Thu, 18 Mar 2021 05:48:14 -0400 (EDT)
Received: by mail-lf1-f54.google.com with SMTP id x28so3545023lfu.6
        for <usrp-users@lists.ettus.com>; Thu, 18 Mar 2021 02:48:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=L1wXu8vanAbtDaO4llILVmiFPodP/M0fLkX+LgjTb7w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=L1wXu8vanAbtDaO4llILVmiFPodP/M0fLkX+LgjTb7w=;
        b=
X-Gm-Message-State: AOAM531mGf3lHPpP0UT8OGQhcwe3ZsanwN3l+mSoRjFu3AxEqK9J2nid
	uI+3BfFX2Tlk4XR+jUyuAAuhanUFih5sOXjosi7zOGHEiLA=
X-Google-Smtp-Source: ABdhPJyVeRlUlGkLigznv9qiCf0bnV5UdMN76k+zrbGqMgxYcjDxvVN4G5+0BRANJPLFCrn0iV7j0EH44ukxGVbADgs=
X-Received: by 2002:ac2:5f56:: with SMTP id 22mr4959744lfz.35.1616060892512;
 Thu, 18 Mar 2021 02:48:12 -0700 (PDT)
MIME-Version: 1.0
References: <CAB__hTQUGf5fbAyC4BjmxTSrQE7LwYrQd4U=hWQx-3ekdAgNnA@mail.gmail.com>
In-Reply-To: <CAB__hTQUGf5fbAyC4BjmxTSrQE7LwYrQd4U=hWQx-3ekdAgNnA@mail.gmail.com>
From: Anders Wallin <anders.e.e.wallin@gmail.com>
Date: Thu, 18 Mar 2021 11:48:00 +0200
Message-ID: <CAPnVNRUAp1_OT2VZb8KyQsc-H1U+YxSEgqcNkfwx1VbU97H+1Q@mail.gmail.com>
To: Rob Kossler <rkossler@nd.edu>
Message-ID-Hash: 7L6OU5QQWQEXXUOCDSXKA2E2PHPM45SO
X-Message-ID-Hash: 7L6OU5QQWQEXXUOCDSXKA2E2PHPM45SO
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/7L6OU5QQWQEXXUOCDSXKA2E2PHPM45SO/>
...
Content-Type: multipart/mixed; boundary="===============3055399656433770574=="

--===============3055399656433770574==
Content-Type: multipart/related; boundary="0000000000006f18df05bdcc7fcf"

--0000000000006f18df05bdcc7fcf
Content-Type: multipart/alternative; boundary="0000000000006f18de05bdcc7fce"

--0000000000006f18de05bdcc7fce
Content-Type: text/plain; charset="UTF-8"

Hi Rob,

Accuracy: The attached ADEV-plot shows the free-running and GM modes of the
WR-switch (and the low-jitter variant).
...
Transceivers: There are no restrictions afaik, almost any 1Gbit transceiver
should work. For short 1-2m distances you could try DAC-cables also. Some
BX10 BiDir transceivers are recognized by the default firmware, and it
knows how to apply a correction for the chromatic dispersion. This matters
only on long links.
...
>       using 2-fiber transceivers (common wavelength of 1310nm) at both master and
...
<div dir=3D"ltr">Hi Rob,<div><br></div><div>Accuracy: The attached ADEV-plo=
t shows the free-running and GM modes of the WR-switch (and the low-jitter =
variant).</div><div>The OctoClock is a decent (but not great) distribution =
amplifier, see e.g. measurements at [1]</div><div>Some general comments to =
this would be: in free-run mode the WR-switch is quite poor. The frequency =
is off by 1-10 PPM or more, and the stability is based on a fairly cheap/sm=
all quartz crystal in the switch. (This is not to say several slaves all co=
nnected to the same free-run switch wouldn&#39;t be synchronized all to the=
 same unstable oscillator - I don&#39;t have test-data on that).</div><div>=
In GM mode the standard WR-switch shows about 2e-11 ADEV at 1s, with the lo=
w-jitter switch potentially 10x better. If you work with a high quality sou=
rce like a Cs-clock or maser this will make a difference.</div><div>Note th=
at 2e-11=C2=A0@ 1s number is about the noise-floor of a time-interval count=
er like the Keygilent 53230A - so use a phase-meter like a Microsemi/chip 3=
120A and measure 10 MHz if you want reliable numbers.</div><div><br></div><=
div>Modes:</div><div>GM: yes you must have external 10MHz and 1PPS sources.=
 The switch locks onto one edge of the 10MHz, the edge &#39;marked&#39; by =
the 1PPS (the exact position of the 1PPS rising edge does not matter!)</div=
><div>Boundary Clock means you have a GM switch somewhere upstream, with th=
e GM Master-port connecting to your BC-switch slave-port (usually ports 1 a=
nd 2). 1PPS and 10MHz (adjustable) outputs should be available in all modes=
.</div><div><br></div><div>Transceivers: There are no restrictions afaik, a=
lmost any 1Gbit transceiver should work. For short 1-2m distances you could=
 try DAC-cables also. Some BX10 BiDir transceivers are recognized by the de=
fault firmware, and it knows how to apply a correction for the chromatic di=
spersion. This matters only on long links.</div><div><br></div><div>For gen=
eral WR-switch questions also try the ohwr forum:=C2=A0<a href=3D"https://f=
orums.ohwr.org/">https://forums.ohwr.org/</a></div><div><br></div><div>HTH,=
</div><div>Anders</div><div><br></div><div>[1]=C2=A0<a href=3D"http://www.a=
nderswallin.net/2016/09/ettus-octoclock-distribution-amplifier/fda_2016-09-=
12_adev/">http://www.anderswallin.net/2016/09/ettus-octoclock-distribution-=
amplifier/fda_2016-09-12_adev/</a>=C2=A0</div><div><br></div><div><img src=
=3D"cid:ii_kmeoftfq0" alt=3D"stability_plot_2020-12x.png" width=3D"562" hei=
ght=3D"337"><br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr"=
 class=3D"gmail_attr">On Wed, Mar 17, 2021 at 4:12 PM Rob Kossler &lt;<a hr=
ef=3D"mailto:rkossler@nd.edu">rkossler@nd.edu</a>&gt; wrote:<br></div><bloc=
kquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:=
1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">In my use cas=
e, I have a single WR Switch (from Seven Solutions) connected to 8 N3xx dev=
ices (WR slaves) via single-mode fiber (~ 10m).=C2=A0 I have a few question=
s:<div><ul><li><b>Accuracy</b>: How does the accuracy of WR compare to runn=
ing 10 MHz/PPS over coax of similar length (~10m) from a reference such as =
an OctoClock? I don&#39;t need specific quantification, but I am just looki=
ng for general comments.</li><li><b>WR switch mode</b>: There are 3 choices=
: GrandMaster, Boundary Clock, or Free-running Master.=C2=A0 (In my use cas=
e, there are occasions where I will have a 10MHz/PPS reference available an=
d other occasions where I won&#39;t.)</li><ul><li>It appears that if I choo=
se GrandMaster, I *must* have a 10 MHz/PPS reference input. The WR Switch d=
oes not seem to behave well if these signals are not present. Is this corre=
ct?</li><li>Conversely, if I have a 10MHz/PPS reference available and want =
to use it, I *must* choose GrandMaster mode. Is this correct?</li><li>I hav=
e found documentation that indicates that it is optional to have a 10MHz/PP=
S reference. But, it is not clear which mode I should choose for the case w=
here I do not have such a reference. I have also found documentation that i=
ndicates that the PPS output is *not* available in Boundary Clock mode, but=
 that it *is* available in Free-Running Master mode.=C2=A0 Does this mean t=
hat in my use case with devices that require PPS, I must use the Free-Runni=
ng Master mode for times when I don&#39;t have an external reference but th=
en switch to GrandMaster mode for times when I do have an external referenc=
e?=C2=A0 (This would imply that I would never use the default Boundary Cloc=
k mode.)</li></ul><li><b>Optical Transceivers</b>: There are only a few opt=
ical transceivers listed on the WR website compatibility list and in the do=
t-config file of the WR Switch device. All of them are BiDi transceivers.=
