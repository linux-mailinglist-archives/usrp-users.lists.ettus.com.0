...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id D95E81796EE
	for <lists+usrp-users@lfdr.de>; Wed,  4 Mar 2020 18:43:13 +0100 (CET)
Received: from [::1] (port=44696 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1j9Y36-0007jR-MT; Wed, 04 Mar 2020 12:43:12 -0500
Received: from mail-oi1-f176.google.com ([209.85.167.176]:37396)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <rkossler@nd.edu>) id 1j9Y33-0007bq-4k
 for usrp-users@lists.ettus.com; Wed, 04 Mar 2020 12:43:09 -0500
Received: by mail-oi1-f176.google.com with SMTP id q65so2954889oif.4
 for <usrp-users@lists.ettus.com>; Wed, 04 Mar 2020 09:42:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nd.edu; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=IeFrJV7P0E85XfhZV4ZMdvEVuVTBM7DJ5LXjER8nZds=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=IeFrJV7P0E85XfhZV4ZMdvEVuVTBM7DJ5LXjER8nZds=;
 b=
X-Gm-Message-State: ANhLgQ3Ft5IpadqDBTaUxP6Ipx5AN8iXj90ogkLYGKNBitiW5CslPYaU
 ydD79M1L/6/Rhc8+gcooA4xg8R0SldKjiYe8H7JzZw==
X-Google-Smtp-Source: ADFU+vtAgWNRXUSxIlfwcDxZ8zjhRxSAEI/YiJ9Z/sguqGYEgK1v1k6VG2rpqBwVTFE0bR43xQCDyxoxLQIFPxjXKz4=
X-Received: by 2002:a05:6808:aaf:: with SMTP id
 r15mr2482863oij.124.1583343748266; 
 Wed, 04 Mar 2020 09:42:28 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CAB__hTSG1d_XEYv2WowP4zRoL7cqb94wirb5LRG1oGL7zMAh6g@mail.gmail.com>
Date: Wed, 4 Mar 2020 12:42:16 -0500
Message-ID: <CAB__hTT=qkX=vq7tuG9ugXnL57o_YXzig1j1d9Cf3sB-vhzdfg@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============1321259234216467767=="
...
--===============1321259234216467767==
Content-Type: multipart/alternative; boundary="000000000000acab0805a00af174"

--000000000000acab0805a00af174
...
I "believe" that either method should be possible to accomplish the goal of
...
streaming samples.  Let me explain with a few remarks:
   ...
   - If you then start hopping your DUC with time stamps such as 0.6, 0.7,
   0.8, etc, then UHD should apply the hop at the correct part of the strea=
m
   since it knows the time of each sample.
   - But, be sure that you know for certain that the UHD time is truly set
   to zero at the start of the run.  Otherwise, if it is at some arbitrary
...
>> time do you set?  Probably just something like "get_time_now() + 0.1". I=
t
>> may be a bit tricky since this value is to be set before starting the fl=
ow
...
>> when the flow graph starts you could execute a command to set_time_now()=
 to
>> 0.0.  Anyway, if this advice doesn't pan out, perhaps just search around=
 a
>> bit in GR archives.  I'm sure others have successfully streamed with tim=
ed
>> Tx commands.
>> Rob
>>
...
us.com/manual/structuhd_1_1tx__metadata__t.html%5D%5D>
>>
...
m_______________________________________________USRP-users%5D%5D>
>> mailing list
>> USRP-users@lists.ettus.com[mailto:USRP-users@lists.ettus.com][mailto:
>> USRP-users@lists.ettus.com[mailto:USRP-users@lists.ettus.com]][mailto:
>> USRP-users@lists.ettus.com[mailto:USRP-users@lists.ettus.com][mailto:
...
s.ettus.com/mailman/listinfo/usrp-users_lists.ettus.com%5D%5D>
>>
>
...
<div dir=3D"ltr"><div dir=3D"ltr">Regarding #2)<div>I don&#39;t think that =
what you want is a &quot;command&quot; tag, but rather a &quot;time stamp t=
ag&quot; which I believe is &quot;tx_time&quot; based on the link you provi=
ded to the documentation.=C2=A0 The documentation says, &quot;The timestamp=
 tag value is a PMT tuple of the following: (uint64 seconds, double fractio=
nal seconds)&quot;.=C2=A0 If I am correct, perhaps the code snipped you pro=
vided will not come into play.</div><div><br></div><div>Just to be clear, I=
 don&#39;t think you should need to do both #1 and #2.=C2=A0 But, I &quot;b=
elieve&quot; that either method should be possible to accomplish the goal o=
f attaching a time stamp to the streaming.=C2=A0=C2=A0</div><div><br></div>=
<div>Also, keep in mind that the time stamp that you provide to the DUC blo=
ck for the freq change is related to the time stamp you attach to the strea=
ming samples.=C2=A0 Let me explain with a few remarks:</div><div><ul><li>If=
 you apply the time stamp of 0.5 to the streaming samples, then the first s=
ample will have time 0.5 and then UHD will keep track of all subsequent sam=
ples to know the absolute time of any given sample.=C2=A0 I am assuming tha=
t once you start transmitting you will keep transmitting continuously until=
 the flow graph ends.</li><li>If you then start hopping your DUC with time =
stamps such as 0.6, 0.7, 0.8, etc, then UHD should apply the hop at the cor=
rect part of the stream since it knows the time of each sample.</li><li>But=
, be sure that you know for certain that the UHD time is truly set to zero =
at the start of the run.=C2=A0 Otherwise, if it is at some arbitrary value =
at startup such as 9876.1 seconds, and you are using time stamps to set you=
r DUC tuning such as &quot;get_time_now()+0.5&quot;, then it will want to a=
pply the tuning at 9876.6 seconds. Thus, if you time stamped your tx stream=
 at 0.5 seconds, you will have a long time to wait before the tuning occurs=
.=C2=A0=C2=A0</li></ul></div><div>Rob</div></div><br><div class=3D"gmail_qu=
ote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Mar 4, 2020 at 12:13 PM =
Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu">rkossler@nd.edu</a>&gt; =
wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0=
px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=
=3D"ltr"><div>Hi Lukas,</div><div>Let me respond to #1 right away.=C2=A0 Th=
e &quot;set_start_time&quot; function sets the time of the tx stream.=C2=A0=
 It does not set the &quot;clock time&quot; on the usrp.=C2=A0 If you are i=
ndeed correct that the &quot;clock time&quot; on the usrp is initialized to=
 0.0 at the start of the GR run, then you are lucky and all you should need=
 to do is use the &quot;set_start_time&quot; function with a time spec of s=
omething like 0.2 or 0.5 (any time after 0.0 with perhaps a little delay bu=
ilt in).=C2=A0 To see if it is working, you could set the time spec to some=
thing very large like 5.0 or 10.0 and then you should see the GR run start =
up but no Tx for the next 5 or 10 seconds.=C2=A0 Then the Tx should start.=
=C2=A0 Does that make sense?</div><div>Rob</div><div><br></div><br><div cla=
ss=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Mar 4, 202=
0 at 12:06 PM Lukas Haase &lt;<a href=3D"mailto:lukashaase@gmx.at" target=
=3D"_blank">lukashaase@gmx.at</a>&gt; wrote:<br></div><blockquote class=3D"=
gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(20=
4,204,204);padding-left:1ex">Hi Rob,<br>
<br>
