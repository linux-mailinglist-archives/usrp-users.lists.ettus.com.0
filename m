...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 267FF99F0DC
	for <lists+usrp-users@lfdr.de>; Tue, 15 Oct 2024 17:19:30 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 648BD385A11
	for <lists+usrp-users@lfdr.de>; Tue, 15 Oct 2024 11:19:29 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1729005569; bh=FkVQ4I1Bt49ZA19aj39hSGZeuXD8ayU62x/7ZrfBzk0=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qt1-f175.google.com (mail-qt1-f175.google.com [209.85.160.175])
	by mm2.emwd.com (Postfix) with ESMTPS id CA52E385663
	for <usrp-users@lists.ettus.com>; Tue, 15 Oct 2024 11:19:15 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="EHnoKBnP";
	dkim-atps=neutral
Received: by mail-qt1-f175.google.com with SMTP id d75a77b69052e-46041d86566so31052531cf.3
        for <usrp-users@lists.ettus.com>; Tue, 15 Oct 2024 08:19:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1729005555; x=1729610355; darn=lists.ettus.com;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=YDG7k4NYOrpDs6k7icc4L92iZVV/yeq5LImm/nDryWo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1729005555; x=1729610355;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=YDG7k4NYOrpDs6k7icc4L92iZVV/yeq5LImm/nDryWo=;
        b=
X-Gm-Message-State: AOJu0Yw732kfS1QEC4pMJNZItVfp3TtvvmdusHN8pjKijfzekvGtc9hU
	KhK4vfd88JWN8j79Skgh8WFUEwlOkdVkaD5yqRIZumPlwrV8WI9E
X-Google-Smtp-Source: AGHT+IELwaDdPWsGCqA/WocXN+hr4ZrPOm1EUPa7P4z0Lp5/r6qbIr9aVrzdho/99RgfqQN3IfCTEQ==
X-Received: by 2002:a05:622a:1aa0:b0:460:7840:5dab with SMTP id d75a77b69052e-4608a52b8a4mr8161641cf.41.1729005554792;
        Tue, 15 Oct 2024 08:19:14 -0700 (PDT)
Received: from [192.168.2.170] ([174.88.53.166])
        by smtp.googlemail.com with ESMTPSA id d75a77b69052e-4607b0a3fcfsm7517541cf.2.2024.10.15.08.19.13
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Tue, 15 Oct 2024 08:19:14 -0700 (PDT)
Message-ID: <42e71cb4-0fb9-4ead-8d04-a16645f86f9f@gmail.com>
Date: Tue, 15 Oct 2024 11:19:03 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAO=xj9UA=cV5nagb=E02Zs7mQdksrU5Bfb9tcADp8w3wAD_eOQ@mail.gmail.com>
Message-ID-Hash: BWUSLGKS3AYOZ7W3D22YHOZDWKCQL76W
X-Message-ID-Hash: BWUSLGKS3AYOZ7W3D22YHOZDWKCQL76W
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/BWUSLGKS3AYOZ7W3D22YHOZDWKCQL76W/>
...
Content-Type: multipart/mixed; boundary="===============6743041356905638436=="

This is a multi-part message in MIME format.
--===============6743041356905638436==
Content-Type: multipart/alternative;
 boundary="------------Z3QnIUtt6ZIA1kknZ80Lio1G"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------Z3QnIUtt6ZIA1kknZ80Lio1G
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 15/10/2024 11:12, Houshang wrote:
> Regarding firewall, please see the screenshot below from the host and=20
...
>
> On Tue, 15 Oct 2024 at 17:05, Marcus D. Leech=20
...
>>     for both version and the exact error message:
>>
>>     15_16:59:31.jpg
...
>>>             Boost_107400; DPDK_23.11; UHD_4.6.0.HEAD-0-g50fa3baa
>>>             [INFO] [MPMD] Initializing 1 device(s) in parallel with
>>>             args:
>>>             mgmt_addr=3D10.10.1.100,type=3Dn3xx,product=3Dn310,serial=
=3D32000F1,name=3Dni-n3xx-32000F1,fpga=3DXG,claimed=3DFalse,addr=3D10.10.=
1.100
...
>>>             initialization. EnvironmentError: IOError: recv error on
>>>             socket: Connection refused
>>>             [ERROR] [RFNOC::GRAPH] Caught exception while
>>>             initializing graph: EnvironmentError: IOError: recv
>>>             error on socket: Connection refused
...
>>
>>             In general, you need to be running the same UHD versions
>>             on both your host computer, and the USRP N3xx radio.
>>
>>             It may be the case that in 4.7, the RPC ports used are
>>             different, and a UHD 4.6 wouldn't be able to deal with thi=
s.
>>
>>
>>             /
...
>>>>                 First of all:
>>>>
>>>>                 /ad@bm-super11-intel:~/accelleran$ uhd_usrp_probe
>>>>                 -a "type=3Dn3xx,product=3Dn310,addr=3D10.10.1.100"
...
>>>                 /
>>>>
>>>>                 Secondly, Maybe the following is the issue; WHen I
>>>>                 run xxx in the host machine I see a version and
>>>>                 when I run the same command on the n310 itself, I
>>>>                 get another version. How to avoid this?
>>>>
>>>>                 15_16:21:07.jpg
>>>                 Indeed, I noticed that your radio hardware is ahead
>>>                 of your host computer in UHD version.
>>>
>>>                 The best thing might be to upgrade UHD on your host,
>>>                 if possible.=C2=A0 If not, then follow the steps for
>>>                 programming a fresh
>>>                 =C2=A0 system image on your N310:
>>>
>>>                 https://kb.ettus.com/Writing_the_USRP_File_System_Dis=
k_Image_to_a_SD_Card
>>>
>>>
>>>>
...
>>>>                     root@10.10.0.100/
>>>>                     /root@ni-n3xx-32000F1:~# uhd_config_info --versi=
on
...
>>>>
>>>>                     /ad@bm-super11-intel:~/accelleran$ ping 10.10.0.=
100
>>>>                     PING 10.10.0.100 (10.10.0.100) 56(84) bytes of
>>>>                     data.
>>>>                     64 bytes from 10.10.0.100 <http://10.10.0.100>:
>>>>                     icmp_seq=3D1 ttl=3D64 time=3D0.250 ms
>>>>                     64 bytes from 10.10.0.100 <http://10.10.0.100>:
>>>>                     icmp_seq=3D2 ttl=3D64 time=3D0.199 ms
>>>>                     ^C
>>>>                     --- 10.10.0.100 ping statistics ---
>>>>                     2 packets transmitted, 2 received, 0% packet
>>>>                     loss, time 1051ms
>>>>                     rtt min/avg/max/mdev =3D 0.199/0.224/0.250/0.025=
 ms
>>>>                     ad@bm-super11-intel:~/accelleran$ ping 10.10.1.1=
00
>>>>                     PING 10.10.1.100 (10.10.1.100) 56(84) bytes of
>>>>                     data.
>>>>                     64 bytes from 10.10.1.100 <http://10.10.1.100>:
>>>>                     icmp_seq=3D1 ttl=3D64 time=3D1.02 ms
>>>>                     64 bytes from 10.10.1.100 <http://10.10.1.100>:
>>>>                     icmp_seq=3D2 ttl=3D64 time=3D0.970 ms
>>>>                     ^C
>>>>                     --- 10.10.1.100 ping statistics ---
>>>>                     2 packets transmitted, 2 received, 0% packet
>>>>                     loss, time 1001ms
>>>>                     rtt min/avg/max/mdev =3D 0.970/0.996/1.022/0.026=
 ms
>>>>                     ad@bm-super11-intel:~/accelleran$ ping 10.10.2.1=
00
>>>>                     PING 10.10.2.100 (10.10.2.100) 56(84) bytes of
>>>>                     data.
>>>>                     64 bytes from 10.10.2.100 <http://10.10.2.100>:
>>>>                     icmp_seq=3D1 ttl=3D64 time=3D1.03 ms
>>>>                     64 bytes from 10.10.2.100 <http://10.10.2.100>:
>>>>                     icmp_seq=3D2 ttl=3D64 time=3D0.963 ms
>>>>                     ^C
>>>>                     --- 10.10.2.100 ping statistics ---
>>>>                     2 packets transmitted, 2 received, 0% packet
>>>>                     loss, time 1001ms
>>>>                     rtt min/avg/max/mdev =3D 0.963/0.994/1.025/0.031=
 ms
>>>>                     ad@bm-super11-intel:~/accelleran$ /
>>>>
>>>>
...
>>>>>                         Hi Marcus
>>>>>
>>>>>                           * There are two fiber interfaces for
>>>>>                             this n310 which I will be using for
>>>>>                             DPDK later.
>>>>>                           * There is also a RJ-45 port for this n31=
0.
>>>>>
>>>>>                         As the first step, I want to make sure
>>>>>                         things are working without DPDK. I will
>>>>>                         then test the DPDK.
>>>>>
>>>>>                         Based on your question, I am attaching
>>>>>                         some more info. Let me know if something
>>>>>                         is missing.
>>>>>
>>>>>                         Thanks
>>>>>                         Houshang
...
>>>>
>>>>
>>>>>                         On Tue, 15 Oct 2024 at 16:04, Marcus D.
>>>>>                         Leech <patchvonbraun@gmail.com> wrote:
>>>>>
>>>>>                             On 15/10/2024 09:41, Houshang wrote:
>>>>>>                             Hello
>>>>>>                             Can anyone help with this issue
>>>>>>                             please? This is an n310 and the
>>>>>>                             version of UHD is visible in the
>>>>>>                             screenshot below.
>>>>>>
>>>>>>                             15_15:37:26.jpg
>>>>>>                             Thanks
...
>>>>>>
>>>>>>                             linkedin icon
>>>>>>                             <https://www.linkedin.com/company/acce=
lleran>
>>>>>>                             twitter icon
>>>>>>                             <https://twitter.com/accelleran>
>>>>>>                             youtube icon
>>>>>>                             <https://www.youtube.com/channel/UCrAE=
tqWp21cibZgSFVIEx2g?themeRefresh=3D1>
>>>>>>
>>>>>>
>>>>>>
>>>>>>                             ______________________________________=
_________
>>>>>>                             USRP-users mailing list --usrp-users@l=
ists.ettus.com
>>>>>>                             To unsubscribe send an email tousrp-us=
ers-leave@lists.ettus.com
...
Content-Type: multipart/related;
 boundary="------------I2U5kHLLb4azy0SfvIvDIRE8"

--------------I2U5kHLLb4azy0SfvIvDIRE8
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 15/10/2024 11:12, Houshang wrote:<b=
r>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAO=3Dxj9UA=3DcV5nagb=3DE02Zs7mQdksrU5Bfb9tcADp8w3wAD_eOQ@mai=
l.gmail.com">
...
TF-8">
      <div dir=3D"ltr">
        <div>Regarding firewall, please see the screenshot below from
          ...
          be checked?</div>
        <div><img src=3D"cid:part1.3tWMgx6x.b0Cx0HDK@gmail.com"
            alt=3D"15_17:11:14.jpg" style=3D"margin-right: 0px;" class=3D=
""
            width=3D"701" height=3D"220"><br>
        </div>
      </div>
    </blockquote>
    Please run:<br>
...
l.gmail.com"><br>
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct 2024 at 17:0=
5,
          ...
          <div>
            ...
            <blockquote type=3D"cite">
              <div dir=3D"ltr">
                ...
                <div><img src=3D"cid:part2.7JNR7lqd.k0ujeZl0@gmail.com"
                    alt=3D"15_16:59:31.jpg" style=3D"margin-right: 0px;"
                    class=3D"" width=3D"985" height=3D"257"><br>
                </div>
              </div>
            </blockquote>
...
ual/page_usrp_x3x0_config.html#x3x0cfg_hostpc_netcfg_firewall</a><br>
            <br>
            <br>
...
padding-left:1ex">
                  ...
                  <div class=3D"gmail_quote">
                    <div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct
                      2024 at 16:32, Marcus D. Leech &lt;<a
...
ran$
                                  uhd_usrp_probe --args
                                  "type=3Dn3xx,product=3Dn310,addr=3D10.1=
0.1.100"<br>
...
clock_source=3Dinternal,time_source=3Dinternal'.<br>
                                  ...
                                  rfnoc_graph.<br>
                                  ad@bm-super11-intel:~/accelleran$ </spa=
n></i><br>
                            </div>
                          </div>
                        </blockquote>
 ...
 15
                              Oct 2024 at 16:27, Marcus D. Leech &lt;<a
                                href=3D"mailto:patchvonbraun@gmail.com"
                                target=3D"_blank" moz-do-not-send=3D"true=
"
...
ran$
                                          uhd_usrp_probe -a
                                          "type=3Dn3xx,product=3Dn310,add=
r=3D10.10.1.100"<br>
...
ad@bm-super11-intel:~/accelleran$ </span></i><br>
                                ...
                                <i>Sorry, I meant "--args" rather than
                                  "-a".<br>
                                  <br>
                                </i>
                                <blockquote type=3D"cite">
                                  <div dir=3D"ltr">
                                    ...
                                    <div><img
src=3D"cid:part3.D6huTUj0.0Tw0yw1b@gmail.com" alt=3D"15_16:21:07.jpg"
                                        class=3D"" width=3D"578"
                                        height=3D"513"><br>
                                    </div>
                                  </div>
                                </blockquote>
                                ...
                                on your host, if possible.=C2=A0 If not, =
then
...
/kb.ettus.com/Writing_the_USRP_File_System_Disk_Image_to_a_SD_Card</a><br=
>
                                <br>
                                <br>
                                <blockquote type=3D"cite"><br>
...
oushang.azizi@accelleran.com</a>&gt;
                                      wrote:<br>
                                    </div>
                                    <blockquote class=3D"gmail_quote"
style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);=
...
>
                                                          ...
                                                          <div><img
src=3D"cid:part4.fQVviZ9m.XMClcFrx@gmail.com" alt=3D"15_15:37:26.jpg"
...
--
                                  ...
                                  <div dir=3D"ltr" class=3D"gmail_signatu=
re">
                                    <div dir=3D"ltr">
                                      <div style=3D"text-align:left">
                                        <p class=3D"MsoNormal"
...
Content-Id: <part1.3tWMgx6x.b0Cx0HDK@gmail.com>
...
Content-Id: <part2.7JNR7lqd.k0ujeZl0@gmail.com>
Content-Transfer-Encoding: base64
...
Content-Id: <part3.D6huTUj0.0Tw0yw1b@gmail.com>
Content-Transfer-Encoding: base64
...
Content-Id: <part4.fQVviZ9m.XMClcFrx@gmail.com>
Content-Transfer-Encoding: base64
