...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id B3210400DE3
	for <lists+usrp-users@lfdr.de>; Sun,  5 Sep 2021 06:09:15 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 5144E3841AC
	for <lists+usrp-users@lfdr.de>; Sun,  5 Sep 2021 00:09:14 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=ettus-com.20150623.gappssmtp.com header.i=@ettus-com.20150623.gappssmtp.com header.b="LvIJwRWA";
	dkim-atps=neutral
Received: from mail-ua1-f47.google.com (mail-ua1-f47.google.com [209.85.222.47])
	by mm2.emwd.com (Postfix) with ESMTPS id 74F81383D47
	for <usrp-users@lists.ettus.com>; Sun,  5 Sep 2021 00:08:28 -0400 (EDT)
Received: by mail-ua1-f47.google.com with SMTP id r20so1873331uat.2
        for <usrp-users@lists.ettus.com>; Sat, 04 Sep 2021 21:08:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ettus-com.20150623.gappssmtp.com; s=20150623;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=hvgrpq8w8cLXeC7mGvC3qsmFk9CUE70sCl0JCMc50QM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=hvgrpq8w8cLXeC7mGvC3qsmFk9CUE70sCl0JCMc50QM=;
        b=
X-Gm-Message-State: AOAM533+dHQXcsUtCXOxxh4/xG0e0KL/FSJg56tJHX35U5DZ8u4wGQyV
	vGm02hSsgNG/v6LBt5JJkkX1e0uEAeUBA3FQt7IFKbCZ
X-Google-Smtp-Source: ABdhPJyKWQH0KkylIT+2A2FXPfzNlJwZ6L4j7YBtQ6GoLKAuP9d3Z3/A3tii6/Qf+p8rk8dg2yLG+V7kqGwLwEAtmgA=
X-Received: by 2002:ab0:8c:: with SMTP id 12mr2928674uaj.112.1630814908376;
 Sat, 04 Sep 2021 21:08:28 -0700 (PDT)
MIME-Version: 1.0
References: <b24ff5bf-8432-8b63-d75c-82631e45fd9f@cttc.es>
In-Reply-To: <b24ff5bf-8432-8b63-d75c-82631e45fd9f@cttc.es>
From: Jonathon Pendlum <jonathon.pendlum@ettus.com>
Date: Sun, 5 Sep 2021 00:07:52 -0400
Message-ID: <CAL7q81tPjxNWaUbf-2v3dEtsxYgh6QGjV-+LmwCjwG50xgRZTw@mail.gmail.com>
To: Armin Ghani <aghani@cttc.es>
Message-ID-Hash: SKNBIISBJKR3L2PR5U32B4FVMYEAS5LE
X-Message-ID-Hash: SKNBIISBJKR3L2PR5U32B4FVMYEAS5LE
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/SKNBIISBJKR3L2PR5U32B4FVMYEAS5LE/>
...
Content-Type: multipart/mixed; boundary="===============6667716058228056262=="

--===============6667716058228056262==
Content-Type: multipart/related; boundary="0000000000004f3f0205cb37af70"

--0000000000004f3f0205cb37af70
Content-Type: multipart/alternative; boundary="0000000000004f3f0005cb37af6f"

--0000000000004f3f0005cb37af6f
...
>   File "/home/.../Documents/.../ml/autoencoder/grc/dnn_ofdm_test.py", lin=
e
> 1067, in <module>
>     main()
>   File "/home/.../Documents/.../ml/autoencoder/grc/dnn_ofdm_test.py", lin=
e
> 1043, in main
>     tb =3D top_block_cls(cp_len=3Doptions.cp_len, fft_len=3Doptions.fft_l=
en,
...
> difficult for me. I'd like to know if there are any other way to solve th=
is
...
<div dir=3D"ltr">Hi Armin,<div><br></div><div>While this is not an official=
 feature and you won&#39;t receive any support for this, you can trigger a =
reset for X3xx devices with this command: uhd/firmware/usrp3/x300/x300_debu=
g.py --addr &lt;device IP address&gt; --poke=3D0x00100058 --data=3D1. Note =
the script is not python3 compatible.</div><div><br></div><div>Jonathon</di=
v></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr=
">On Fri, Sep 3, 2021 at 5:00 AM Armin Ghani &lt;<a href=3D"mailto:aghani@c=
ttc.es" target=3D"_blank">aghani@cttc.es</a>&gt; wrote:<br></div><blockquot=
