...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id EE86A48F28A
	for <lists+usrp-users@lfdr.de>; Fri, 14 Jan 2022 23:44:56 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 137E1385A62
	for <lists+usrp-users@lfdr.de>; Fri, 14 Jan 2022 17:44:56 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="mVPGzDOt";
	dkim-atps=neutral
Received: from mail-qt1-f178.google.com (mail-qt1-f178.google.com [209.85.160.178])
	by mm2.emwd.com (Postfix) with ESMTPS id 5D7FC3856E3
	for <usrp-users@lists.ettus.com>; Fri, 14 Jan 2022 17:43:55 -0500 (EST)
Received: by mail-qt1-f178.google.com with SMTP id v7so12266228qtw.13
        for <usrp-users@lists.ettus.com>; Fri, 14 Jan 2022 14:43:55 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=message-id:date:mime-version:user-agent:subject:content-language:to
         :cc:references:from:in-reply-to;
        bh=gL2+TRi4G5/XTu0zxh7gVMN26d9vimpyhN3/sxcmUsc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=gL2+TRi4G5/XTu0zxh7gVMN26d9vimpyhN3/sxcmUsc=;
        b=
X-Gm-Message-State: AOAM531SuIE4AwESI+j+c6WF6OV/AyOwWT3E1LiWgmrITCDkvvEviRt5
	cuWV1pFhwTh/oEHcIXWGkAA2YMSgkwDHng==
X-Google-Smtp-Source: ABdhPJyYv09omB7lkG9DFiUQQ65rl6kg4Ok0HKwWCulH+tUZ6tGJvhq30qIER10ZEnFUn3lLbw7wSg==
X-Received: by 2002:a05:622a:13d0:: with SMTP id p16mr9575133qtk.45.1642200234810;
        Fri, 14 Jan 2022 14:43:54 -0800 (PST)
Received: from [192.168.2.225] (bras-base-smflon1825w-grc-05-174-88-53-52.dsl.bell.ca. [174.88.53.52])
        by smtp.googlemail.com with ESMTPSA id t2sm1131229qtx.10.2022.01.14.14.43.53
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 14 Jan 2022 14:43:54 -0800 (PST)
Message-ID: <344538c2-638c-46db-397d-2609f8b48dff@gmail.com>
Date: Fri, 14 Jan 2022 17:43:53 -0500
MIME-Version: 1.0
...
References: <55a9f781-6dfd-d2e5-0311-396854c054b3@gmail.com>
 ...
 <CACwKM9Kogf3x961=spgvcP75VRqGTbX5UaxMdYZEUy_+MqG-0w@mail.gmail.com>
From: "Marcus D. Leech" <patchvonbraun@gmail.com>
In-Reply-To: <CACwKM9Kogf3x961=spgvcP75VRqGTbX5UaxMdYZEUy_+MqG-0w@mail.gmail.com>
Message-ID-Hash: 6M6L67UDVQJLNJGG22F3DYNRF6JBPFQU
X-Message-ID-Hash: 6M6L67UDVQJLNJGG22F3DYNRF6JBPFQU
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/6M6L67UDVQJLNJGG22F3DYNRF6JBPFQU/>
...
Content-Type: multipart/mixed; boundary="===============1245916609250768036=="

This is a multi-part message in MIME format.
--===============1245916609250768036==
Content-Type: multipart/alternative;
 boundary="------------b0RW028gw8x0xY3KypCCuQ2L"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------b0RW028gw8x0xY3KypCCuQ2L
...
couple of dBm, which is
 =C2=A0 "loud as a heavy metal concert" from the perspective of a receive=
r input.

If the splitter isn't enabled in this test, then what you're seeing is=20
the leakage through the RF
 =C2=A0 switch that enables the splitter, which means that once the split=
ter=20
is turned on, the
...
>>     get_device()->get_tree()->access<bool>("mboards/0/dboards/A/tx_fro=
ntends/0/los/lo1/lo_distribution/LO_OUT_0/export").set(true)
>>
...
Content-Type: multipart/related;
 boundary="------------awICgMo938aDMufpphUgjrJI"

--------------awICgMo938aDMufpphUgjrJI
...
cite=3D"mid:CACwKM9Kogf3x961=3DspgvcP75VRqGTbX5UaxMdYZEUy_+MqG-0w@mail.gm=
ail.com">
      <div dir=3D"ltr"><img src=3D"cid:part1.JECl7UZl.muUlaSHq@gmail.com"
          alt=3D"image.png" class=3D"" width=3D"416" height=3D"264"><br>
        <div><br>
        </div>
      </div>
      <br>
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Fri, Jan 14, 2022 at 5:3=
2
          PM Marcus D. Leech &lt;<a
          ...
          <div>
            ...
            <blockquote type=3D"cite">
              <div dir=3D"ltr">
                ...
                <div><font face=3D"monospace">% set both LO sources to us=
e
                    external</font></div>
                <font face=3D"monospace">set_tx_lo_source(=E2=80=9Cextern=
al=E2=80=9D,
                  =E2=80=9Clo1=E2=80=9D, 0)<br>
                </font>
                <div><font face=3D"monospace">set_tx_lo_source(=E2=80=9Ce=
xternal=E2=80=9D,
                ...
                <div><font face=3D"monospace">set_tx_lo_export_enabled(tr=
ue,
                    =E2=80=9Clo1=E2=80=9D, 0)<br>
                  </font></div>
                <div><font face=3D"monospace"><br>
                ...
                <div><font face=3D"monospace">get_device()-&gt;get_tree()=
-&gt;access&lt;bool&gt;("mboards/0/dboards/A/tx_frontends/0/los/lo1/lo_di=
stribution/LO_OUT_0/export").set(true)</font><br>
                </div>
              </div>
              <br>
            </blockquote>
