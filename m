...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id BB6F51A6A2
	for <lists+usrp-users@lfdr.de>; Sat, 11 May 2019 06:28:13 +0200 (CEST)
Received: from [::1] (port=37728 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.91)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1hPJcI-0005k9-So; Sat, 11 May 2019 00:28:10 -0400
Received: from atl4mhob12.registeredsite.com ([209.17.115.50]:51826)
 by mm2.emwd.com with esmtp (Exim 4.91)
 (envelope-from <k5so@k5so.com>) id 1hPJcD-0005b0-RZ
 for usrp-users@lists.ettus.com; Sat, 11 May 2019 00:28:06 -0400
Received: from mailpod.hostingplatform.com
 (atl4qobmail01pod3.registeredsite.com [10.30.77.67])
 by atl4mhob12.registeredsite.com (8.14.4/8.14.4) with ESMTP id x4B4RIYf013161
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL)
 for <usrp-users@lists.ettus.com>; Sat, 11 May 2019 00:27:19 -0400
Received: (qmail 34244 invoked by uid 0); 11 May 2019 04:27:18 -0000
...
Received: from unknown (HELO ?192.168.1.76?) (k5so@k5so.com@192.206.203.10)
 by 0 with ESMTPA; 11 May 2019 04:27:17 -0000
Message-Id: <7ED18503-218F-400A-8E9B-C1F61052240C@k5so.com>
Mime-Version: 1.0 (Mac OS X Mail 11.5 \(3445.9.1\))
Date: Fri, 10 May 2019 22:27:16 -0600
In-Reply-To: <5CD64370.8010902@gmail.com>
...
References: <556BBE2D-2BA6-40A3-BFF5-F5FA2351DB06@k5so.com>
 ...
 <9048636F-BF43-404C-AEF2-5557BE49A8BA@k5so.com> <5CD64370.8010902@gmail.com>
...
Content-Type: multipart/mixed; boundary="===============7095582721960366134=="
...
Content-Type: multipart/alternative;
	boundary="Apple-Mail=_2F14E345-6564-4022-BF9C-D6C740678E3B"


--Apple-Mail=_2F14E345-6564-4022-BF9C-D6C740678E3B
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain;
	charset=utf-8

Indeed, it is.  IMHO as well, thus my post.

> On May 10, 2019, at 9:37 PM, Marcus D. Leech <patchvonbraun@gmail.com> =
wrote:
>=20
> On 05/10/2019 11:31 PM, Joe Martin wrote:
>>=20
>> The =E2=80=9Ckey=E2=80=9D to the un-bricking in this case, not =
mentioned in any =E2=80=9Cunbricking=E2=80=9D procedure described in =
current Ettus documents was to hold S2 down on the rev2/3 motherboard =
while loading the =E2=80=9C.bit=E2=80=9D file into the FPGA when using =
the JTAG cable. =20
...
is why people shouldn't leave R&D departments--all the "lore"
>   is in their head :) :)
>=20
>=20
>>=20
...
>> Joe
>>=20
>>> On May 10, 2019, at 8:03 PM, Marcus D. Leech =
<patchvonbraun@gmail.com <mailto:patchvonbraun@gmail.com>> wrote:
>>>=20
>>> On 05/10/2019 09:57 PM, Joe Martin wrote:
>>>> Okay, Marcus, thanks for the info.  I=E2=80=99m not aware of their =
organizational details although I=E2=80=99m in very regular =
communications with the current president of DSES.  They have installed =
permanent commercial power to the site once again and I was under the =
impression DSES actually owns the site, but I don=E2=80=99t know any of =
those details so perhaps my impressions are not totally correct.  I=E2=80=99=
m simply helping the president to get some of the data acquisition =
functionality and a bit of the tracking functionality in place.  I=E2=80=99=
ve never been to the site.  This N210 will help them a lot!
>>>>=20
>>>> Joe
...
SETI-type drift scan observations with that 60=E2=80=99 dish.  They are =
itching to do some pulsar work now!
>>>>> The early instantiation of DSES was a lot like SBRAC--access to =
dishes on a controlled government site, which they ultimately lost and =
had
...
>>>>>>>> Yes, Nick=E2=80=99s suggestion concerning S2 was certainly the =
key!  I learned a ton about this from all of you guys though and do =
...
site now operational?  It was certainly a "project" last time I saw any =
news of it...
>>>>>>>=20
>>>>>>>=20
>>>>>>>>=20
...
test!).  Holding S2 during iMPACT loading of the .bit image results in =
the uhd_image_loader step being SUCCESSFUL!!  I am so happy to see that! =
...
N210.  A monumental achievement in my book!   I don=E2=80=99t know what =
to say except that we TOTALLY appreciate you efforts to get us running.  =
You guys are GREAT!=20
>>>>>>>>>>=20
...
>>>>>>>>>=20
>>>>>>>>> Hopefully DSES will now have a receiver -- what daughtercard =
do they have in it?
>>>>>>>>>=20
>>>>>>>>>=20
...
>>>>>>>>>>> I have been very careful to avoid the pitfalls you detailed. =
 I began with a fresh installation of Ubuntu 18.04 then performed a =
...
>>>>>>>>>>>=20
>>>>>>>>>>> Then used ISE iMPACT to load the =E2=80=9Cusrp_n210_r3_fpga.bi=
t=E2=80=9D file into the FPGA of the N210.  iMPACT reports =E2=80=9CPROGRA=
M SUCCESSFUL=E2=80=9D.=20
>>>>>>>>>>>=20
...
the =E2=80=9CRuntimeError: Received invalid 32 reply from device=E2=80=9D =
...
>>>>>>>>>>>=20
>>>>>>>>>>> The command uhd_find_devices returns by reporting it can =
find a usrp2 device at address 192.168.10.2, as you would hope. =20
>>>>>>>>>>>=20
>>>>>>>>>>> After trying every conceivable combination of these actions =
with numerous versions of UHD and r2/r3 .bit FPGA files and r2/r3 .bin =
files on several fresh installations of Ubuntu 18.04 and 16.04 the =
result is always the same in that things proceed normally as the various =
documents concerning un-bricking an N210 explains, until the step of =
using the usrp_image_loader is executed, at which point a RuntimeError =
returns stating that the =E2=80=9Cinvalid 32 reply=E2=80=9D has =
occurred. =20
>>>>>>>>>>>=20
>>>>>>>>>>> I was hopeful that careful use of rev3 .bit and .bin files =
with UHD 3.9.7 would do the trick but alas that is not the case. =20
>>>>>>>>>>>=20
>>>>>>>>>>> I suspect that you are near the bottom of the list of =
suggestions for me and I do appreciate the time and thinking you have =
afforded me on this issue.  If there is anything remaining to try I=E2=80=99=
d be most willing to try it.=20
>>>>>>>>>>>=20
>>>>>>>>>>> BTW, the suggestion made by someone earlier to try holding =
the safe button down during the loading of the FPGA from iMPACT causes =
the programming to fail (as reported by iMPACT), so that=E2=80=99s =
...
>>>>>>>>>>>>=20
>>>>>>>>>>>> Joe,=20
>>>>>>>>>>>> To save you time, It may well be worth you trying jumping =
to the 3) step initially and seeing if your current loaded image or safe =
...
>>>>>>>>>>>>>> (Sorry if I=E2=80=99m telling you stuff you know here, =
too many messages in this thread to go reread them)
>>>>>>>>>>>>>>=20
...
Any 3.9.x version is pretty ideal, it=E2=80=99s well supported in =
Gnuradio, is perhaps the most stable, and has N210 support. If you are =
...
support your H/W, the N210 specific code has changed very little for =
some time, but you will benefit from much improved general UHD =
functionality and much better community support)
>>>>>>>>>>>>>> 2. (Given you understand how to load a new image via =
JTAG) Follow the procedure outlined in =E2=80=9CUnbricking an N Series =
Device=E2=80=9D. Run =E2=80=9Cuhd_images_downloader=E2=80=9D under =
UHD3.9.x to be sure you have a compatible set of FPGA images for this =
version of UHD. Use an R3 .bit file (Stay away from R4 images since we =
know that is electrically incompatible with your H/W) and load this via =
JTAG. Verify you can ping this once it=E2=80=99s loaded. Remember this =
is a volatile load, no flash has changed yet, if you reset the H/W this =
download is lost. The goal now is to use the embedded firmware in this =
JTAG image to load the same images in .bin format via the ethernet =
network and update both slot=E2=80=99s in the flash memory with =
...
instructions) to verify that all fields are                              =
                             sane and match your case label.
>>>>>>>>>>>>>> 4) At this point, if all has gone as intended, USRP and =
UHD should be in sync, power cycling H/W should work, and tools like =
...
<usrp-users@lists.ettus.com <mailto:usrp-users@lists.ettus.com>> wrote:
>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>> Oh, okay, I didn=E2=80=99t get that.  Understood now.  I =
have UHD 3.14.0 running on my main machine so I could try again some =
newer .bit files into the FPGA than I previously have tried (I tried the =
...
JTAG load a more modern FPGA image. It's possible you have to hold down =
the safe mode button while loading the image.=20
>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>> On Thu, May 9, 2019, 2:22 PM Joe Martin <k5so@k5so.com =
<mailto:k5so@k5so.com>> wrote:
>>>>>>>>>>>>>>>> Thanks for digging into that for us, Nick.  =
Interesting.  As the hardware change to rev4 occurred around mid 2011 =
and the earliest UHD version that exists on the files.ettus.com/uhd =
...
>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>> So far I=E2=80=99ve not been successful in reviving the =
2014 UHD version so I=E2=80=99m asking to determine whether continued =
effort to do so is likely to yield anything positive with respect to =
...
literally pulled an old hard drive out of a closet, and found a copy of =
the old hardware repository from back in the days when N210 was called =
"USRP2+". Best that I can tell, we only ever released two versions to =
the public. We might have sold R3 stickered as R2 -- I don't see =
anything in the repository that would indicate otherwise. Rev 2/3 was =
sold until around June or July 2011, when we moved to rev 4. The only =
firmware/host code changes I can see between any of the versions are =
that R4 used LVDS clocking to the daughterboard where previous versions =
used CMOS. So I think you should be able to run r3 firmware on your =
N210.
>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>> That said, the very very old N210s with very very old =
firmware might not have used the same safe/production firmware/fpga =
image arrangement that we later arrived at. The hardware is still fine, =
but you might be in for a bit of a deep dive to get it all running =
again.
>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>> If you have a TTL-serial adapter or a logic analyzer =
that works as such, you can connect to the debug UART header and get =
printout information from the firmware at boot time. Another good idea =
would be to take a video of the front panel LEDs as you apply power -- =
the boot LED lights give good indication of the firmware/FPGA image =
loading process.
>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>> Nick
>>>>>>>>>>>>>>>>>=20
...
Jason went through this last year with a couple of N210 he has it        =
                                                   would seem unlikely =
that all three of the N210 are broken.  That being said and considering =
what you jus said it seems that I should=E2=80=99ve been able to find =
some version of UHD that will successfully communicate with the firmware =
and fpga images stored in the unit;  I have not, using UHD versions from =
3.9.0 to 3.14.0. =20
>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>> I wanted to try with even earlier versions of UHD but =
am finding trouble in utilizing UHD v3.4.0 (earliest version I could =
find) as it seems that =E2=80=9Cprebuilt=E2=80=9D v3.4.0 needs only =
Ubuntu 10.10 or 11.10 which so far I=E2=80=99m not able to successfully =
install and run.   Seems we=E2=80=99re running out of option on this one =
so the Deep Space Exploration Society, who I=E2=80=99m trying to help =
...
rev 2 N210 and it is actually a rev 3 N210, is there hope in being able =
to load rev 3 firmware and fpga images (which I have located previously =
and tried actually) with some available UHD version?  If so, would you =
be able to tell me which UHD version(s) might be able to communicate =
with it? =20
>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>> Joe
>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>> Theoretically, most versions in the last several =
years should be able to talk to it.  In *general* UHD never drops =
support for older hardware,
>>>>>>>>>>>>>>>>>>   and tries to maintain compatibility.  Now, it is =
the case that newer features are almost never "back-ported", but basic =
functionality should
>>>>>>>>>>>>>>>>>>   always be there. =20
>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>> What this *should* mean is that you should be able to =
use the firmware tools once the device is in "safe mode" to get yourself =
to where you
>>>>>>>>>>>>>>>>>>   want to be.  If that doesn't work, that may well =
mean that the hardware is broken, and it's unlikely to be economical to =
repair.
>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>=20
...
<mailto:usrp-users@lists.ettus.com>> wrote:
>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>> Okay.  I=E2=80=99ve asserted from the outset that =
it=E2=80=99s a rev 2, based on the factory label.  Is this N210 a lost =
cause if it is actually a Rev2 N210?=20
>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>> Joe
>>>>>>>>>>>>>>>>>>>>=20
...
mode, same result regardless.  Yes, I am able to pin to 192.168.10.2 =
successfully.=20
>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>> Joe
>>>>>>>>>>>>>>>>>>>>>>=20
...
>>>>>>>>>>>>>>>>>>>>>>> Ian and Nick,=20
>>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>>> Thanks for the assistance.  Attached are dropbox =
links to two snapshot photos:  1) the factory label on the back of the =
N210, showing N210 r:2.0 and 2) a top side view of the N210.=20
>>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>>> 1) =
...
N210 motherboard. If the SRAM chip is on the top side, it's a rev 2/3. =
If the SRAM is on the bottom side, it's a rev 4. If you send a picture =
along of the top of the N210, I can tell you if it's early or late rev.
>>>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>>>> On Thu, May 9, 2019 at 11:36 AM Ian Buckley via =
USRP-users <usrp-users@lists.ettus.com =
<mailto:usrp-users@lists.ettus.com>> wrote:
>>>>>>>>>>>>>>>>>>>>>>>> Joe,
>>>>>>>>>>>>>>>>>>>>>>>> So I scratched my head about this a little late =
...
for a Rev2 N210. Chatting with Matt this morning he shared my feeling =
that a Rev2 wasn't sold to customers, so I'm curious if you have a unit =
that has a factory label that says N210Rev2 or if you have seen "usrp2 =
rev2.0" on the PCB (which can be missleading).
>>>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>>>> Also have you tried booting into the safe image =
and verifying that it at least pings on 192.168.10.2?
>>>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>>>> If we can conclusively identify which rev of =
h/w you have I can probably help further.
>>>>>>>>>>>>>>>>>>>>>>>>=20
>>>>>>>>>>>>>>>>>>>>>>>> Ian
>>>>>>>>>>>>>>>>>>>>>>>=20
...
class=3D"">Indeed, it is. &nbsp;IMHO as well, thus my post.<br =
class=3D""><div><br class=3D""><blockquote type=3D"cite" class=3D""><div =
class=3D"">On May 10, 2019, at 9:37 PM, Marcus D. Leech &lt;<a =
...
http-equiv=3D"Content-Type" class=3D"">
 =20
  <div bgcolor=3D"#FFFFFF" text=3D"#000000" class=3D"">
    <div class=3D"moz-cite-prefix">On 05/10/2019 11:31 PM, Joe Martin
      wrote:<br class=3D"">
    </div>
    <blockquote cite=3D"mid:9048636F-BF43-404C-AEF2-5557BE49A8BA@k5so.com"=
 type=3D"cite" class=3D"">
      <meta http-equiv=3D"Content-Type" content=3D"text/html; =
charset=3Dutf-8" class=3D"">
      <div class=3D""><br class=3D"">
      </div>
      <div class=3D"">The =E2=80=9Ckey=E2=80=9D to the un-bricking in =
this case, not
        mentioned in any =E2=80=9Cunbricking=E2=80=9D procedure =
described in current
        Ettus documents was to hold S2 down on the rev2/3 motherboard
        while loading the =E2=80=9C.bit=E2=80=9D file into the FPGA when =
using the JTAG
        cable.&nbsp; <br class=3D"">
      </div>
    </blockquote>
    That is something I didn't know, or failed to recall.&nbsp; In the =
decade
    (!!!) that I've been doing Ettus tech support, I've never had to
    JTAG<br class=3D"">
    &nbsp; an N210, but I've never actually had one in my local lab to =
play
    with--I have a couple of its older cousins--the USRP2.&nbsp; With =
those,<br class=3D"">
    &nbsp; everything is loaded off an SD Card, so when something screws =
up
    on the card, you just burn a new card...<br class=3D"">
    <br class=3D"">
    But this is good info for the "unbricking with JTAG" documents--this
    is why people shouldn't leave R&amp;D departments--all the "lore"<br =
class=3D"">
    &nbsp; is in their head :) :)<br class=3D"">
    <br class=3D"">
    <br class=3D"">
    <blockquote cite=3D"mid:9048636F-BF43-404C-AEF2-5557BE49A8BA@k5so.com"=
 type=3D"cite" class=3D"">
        ...
        <div class=3D"">Joe<br class=3D"">
          <div class=3D""><br class=3D"">
            <blockquote type=3D"cite" class=3D"">
              <div class=3D"">On May 10, 2019, at 8:03 PM, Marcus D. =
Leech
                &lt;<a moz-do-not-send=3D"true" =
href=3D"mailto:patchvonbraun@gmail.com" =
class=3D"">patchvonbraun@gmail.com</a>&gt;
                wrote:</div>
...
http-equiv=3D"Content-Type" class=3D"">
                <div bgcolor=3D"#FFFFFF" text=3D"#000000" class=3D"">
                  <div class=3D"moz-cite-prefix">On 05/10/2019 09:57 PM,
                    Joe Martin wrote:<br class=3D"">
                  </div>
                  <blockquote =
cite=3D"mid:C4F03C96-4C2D-41A8-A115-BED8FF73F85B@k5so.com" type=3D"cite" =
class=3D"">
                    <meta http-equiv=3D"Content-Type" =
content=3D"text/html;
                      charset=3Dutf-8" class=3D"">
                    Okay, Marcus, thanks for the info. &nbsp;I=E2=80=99m =
not aware of
                    their organizational details although I=E2=80=99m in =
very
...
been to the
                  ...
                  years, but it looks like significant<br class=3D"">
                  &nbsp; progress has been made, and it is an 18m
                  dish--similar to the one SBRAC had.<br class=3D"">
                  <br class=3D"">
                  I visited their original site years ago, back when I
                  was still doing SBRAC.&nbsp; I happened to be in =
Colorado
                  for an IETF meeting, and made a<br class=3D"">
                  &nbsp; side-trip.&nbsp; <br class=3D"">
                  <br class=3D"">
                  All very encouraging, for sure.<br class=3D"">
                  <br class=3D"">
                  I still think collections of smaller, more-manageable,
                  dishes are better :) :)<br class=3D"">
                  <br class=3D"">
                  <br class=3D"">
                  <blockquote =
cite=3D"mid:C4F03C96-4C2D-41A8-A115-BED8FF73F85B@k5so.com" type=3D"cite" =
class=3D"">
                    <div class=3D"">
                      <div class=3D""><br class=3D"">
                        <blockquote type=3D"cite" class=3D"">
                          <div class=3D"">On May 10, 2019, at 7:38 PM,
                            Marcus D. Leech &lt;<a =
moz-do-not-send=3D"true" href=3D"mailto:patchvonbraun@gmail.com" =
class=3D"">patchvonbraun@gmail.com</a>&gt;
                            wrote:</div>
                          <br class=3D"Apple-interchange-newline">
                          <div class=3D"">
...
05/10/2019
                                09:29 PM, Joe Martin wrote:<br class=3D"">=

                              </div>
                              <blockquote =
cite=3D"mid:0A955663-E38A-4677-BE65-B53476BBD503@k5so.com" type=3D"cite" =
class=3D"">
                                <meta http-equiv=3D"Content-Type" =
...
class=3D"">
                                <div class=3D""><br class=3D"">
                                  <blockquote type=3D"cite" class=3D"">
                                    <div class=3D"">On May 10, 2019, at
...
text=3D"#000000" class=3D"">
                                        <div class=3D"moz-cite-prefix">On
                                          ...
                                          Martin wrote:<br class=3D"">
                                        </div>
                                        <blockquote =
cite=3D"mid:6A14E23C-AAFE-43EF-A207-C830BFD62642@k5so.com" type=3D"cite" =
class=3D"">
                                          <meta =
http-equiv=3D"Content-Type" content=3D"text/html;
                                            charset=3Dutf-8" class=3D"">
                                          Yes, Nick=E2=80=99s suggestion
...
class=3D"">
                                                      ...
                                                      <blockquote =
cite=3D"mid:365E5ED3-897E-402B-B5BA-D8F9A217B3EF@k5so.com" type=3D"cite" =
class=3D"">
                                                        <meta =
http-equiv=3D"Content-Type" content=3D"text/html;
                                                          charset=3Dutf-8"=
...
-webkit-nbsp-mode:
                                                          ...
                                                          line-break:
                                                          =
after-white-space;" class=3D"">Ian
                                                          and all,&nbsp;
                                                          <div =
class=3D""><br class=3D"">
                                                          </div>
...
class=3D""><br class=3D"">
                                                          ...
                                                          <div =
class=3D"">uhd_images_downloader</div>
                                                          <div =
class=3D""><br class=3D"">
                                                          </div>
                                                          <div =
...
class=3D"">Then
                                                          ...
                                                          the
                                                          =
=E2=80=9Cusrp_n210_r3_fpga.bit=E2=80=9D
                                                          file into the
                                                          FPGA of the
                                                          N210. =
&nbsp;iMPACT
...
passed
                                                          ...
                                                          ICMP
                                                          =
packets=E2=80=A6that=E2=80=99s
                                                          a sign the
                                                          hardware is in
                                                          reasonable
                                                          shape,
...
class=3D"">4)
                                                          ...
                                                          tools like
                                                          =
=E2=80=9Cuhd_usrp_probe=E2=80=9D
                                                          should find
                                                          the USRP and
                                                          print it=E2=80=99=
s
                                                          ...
                                                          check in the
                                                          =
=E2=80=9CTroubleshooting=E2=80=9D
                                                          section if
                                                          things still
                                                          don=E2=80=99t =
seem to
