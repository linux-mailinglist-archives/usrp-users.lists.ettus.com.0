...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DB18F50EC
	for <lists+usrp-users@lfdr.de>; Fri,  8 Nov 2019 17:20:23 +0100 (CET)
Received: from [::1] (port=34316 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iT6zf-0007ik-UJ; Fri, 08 Nov 2019 11:20:15 -0500
Received: from mail-lf1-f51.google.com ([209.85.167.51]:36634)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <sam.reiter@ettus.com>)
 id 1iT6zb-0007aU-Jg
 for usrp-users@lists.ettus.com; Fri, 08 Nov 2019 11:20:12 -0500
Received: by mail-lf1-f51.google.com with SMTP id m6so4909824lfl.3
 for <usrp-users@lists.ettus.com>; Fri, 08 Nov 2019 08:19:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ettus-com.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=tgW//hdHSSzLXwuXHSJDdQeBg20AxVSEB0NIZkt8S9E=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=tgW//hdHSSzLXwuXHSJDdQeBg20AxVSEB0NIZkt8S9E=;
 b=
X-Gm-Message-State: APjAAAWgzmxHeXLsLNi9mxylyrcaCkz6MwoNwa2FIXL11D/JlxHQ+fgJ
 oZbz0gJnHVjH0uVLKFqygWrjaxmoJnhaBSwIKSliKJ6+l8U=
X-Google-Smtp-Source: APXvYqz7dNCuwHuuDT6xX9E+nalLPKwrrZNX3230sE7a/9TMXHxM1OeGDh8k6f14UaBtPrdjvvfIEhTdzemFAeO5Of4=
X-Received: by 2002:a19:f710:: with SMTP id z16mr7201002lfe.47.1573229969494; 
 Fri, 08 Nov 2019 08:19:29 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CALSKgPwe31Aoe0a367Gp5g+Arurjt+D=A8tC7x_+oY16ndcOhQ@mail.gmail.com>
Date: Fri, 8 Nov 2019 10:19:16 -0600
Message-ID: <CANf970aQ9JO+_wT=RiTjXs_3Q0XHpFGLtdJaSr4R8fJ0fOFqKw@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============8013283369340308466=="
...
--===============8013283369340308466==
Content-Type: multipart/related; boundary="0000000000007df9a20596d825b7"

--0000000000007df9a20596d825b7
Content-Type: multipart/alternative; boundary="0000000000007df99f0596d825b6"

--0000000000007df99f0596d825b6
...
On Fri, Nov 1, 2019 at 1:55 PM Wheberth Damascena Dias <wheberth@gmail.com>
wrote:
...
>> Hi Sam,
>>
>> - In fact the i7 machine is totally different from the i9. Not just a CP=
U
>> upgrade a new machine with a different motherboard.
>> - Regarding the OS version, I have downgraded form Ubuntu 18 to Ubuntu 1=
6
>> but there are no difference at all.
>> I have also upgraded another machine to Ubuntu 18 and the USRP worked
>> like charm on this third machine (also very different from the i7 and th=
e
>> i9).
...
>>
>>
>> Em qui, 31 de out de 2019 =C3=A0s 16:38, Sam Reiter <sam.reiter@ettus.co=
m>
>> escreveu:
>>
>>> I also spoke with someone on our PXI team regarding 8371 compatibility,
>>> what that manual note means, and some other troubleshooting steps. Not =
sure
>>> if any of this will be actionable, but here are some tidbits of knowled=
ge:
>>>
>>> - "Slots intended for graphics cards" are usually x16 PCIe slots that
>>> may not be fully PCIe compliant. You might check the motherboard manual=
 for
>>> any **vague** language surrounding that slot being intended for GPU use=
. I
>>> question whether this is relevant or not considering the fact that it w=
as
>>> working with your i7.
>>> - Related to the point above, gaming oriented motherboards seem to give
>>> the 8371 and similar MXI cards more trouble than non-gaming motherboard=
s.
...
>>> to Gen 1 and try that as well see the snippet from the motherboard manu=
al
>>> below:
>>>
>>> [image: image.png]
...
:
>>>
>>>> I'm not sure if the graphics card thing is worth spending too much tim=
e
...
>>>> drivers handling the 8371. Were you able to try recompiling and reload=
ing
...
>>>> *lsmod*
>>>>
>>>> If you could attach those outputs as text files, that may be helpful i=
n
...
>>>>
>>>>> Another piece of info. The manual of the PCIe-8371 card states that i=
t
>>>>> may not work in a slot intended for graphics card. Anyone have an ide=
a of
>>>>> the reason for that?
>>>>>
>>>>> [image: image.png]
...
>>>>>>>
>>>>>>> Em sex, 25 de out de 2019 =C3=A0s 18:28, Sam Reiter <sam.reiter@ett=
us.com>
>>>>>>> escreveu:
>>>>>>>
>>>>>>>> Would you be able to try shifting this card to another PCIe slot i=
n
>>>>>>>> your machine?
>>>>>>>>
>>>>>>>> I'm also interested in knowing what other PCIe devices you have
>>>>>>>> connected to the computer. It might be worth making the X310's PCI=
e link
...
>>>>>>>>>
>>>>>>>>> Actually yes, the same X310 runs perfectly in another machine. It=
s
>>>>>>>>> a i7 6th gen with ubuntu 18.04 kernel  4.15.0, libuhd and uhd-hos=
t on same
>>>>>>>>> version.
>>>>>>>>>
>>>>>>>>> I think this can be some PCIe related setting on the BIOS, since
>>>>>>>>> the lspci shows [disabled] next to the base address, but I can't =
find any
...
<div dir=3D"ltr"><div>Just a final follow up on this, in the event that thi=
s thread is referenced by someone in a similar situation. Based on the info=
 you&#39;ve sent over and the hardware you&#39;re using, this sounds like a=
 compat issue between that 8371 PCIe / MXIe card and your motherboard. If y=
ou&#39;d like to dig into this further, you should look into opening a supp=
ort ticket with NI, but I&#39;d guess you&#39;ll probably end up at the sam=
e &quot;this is a gaming motherboard and those are sometimes incompatible w=
ith the strict PCIe standard that the 8371 is working with&quot;. <br></div=
><div><br></div><div>If I was in your shoes, I&#39;d try to get your hands =
on a good dual 10GbE NIC and use that as your link to the X310. If you&#39;=
re using PCIe for latency, you can get a low latency linux kernel with DPDK=
 and try to optimize from there. <br></div><div><br></div><div>-Sam <br></d=
iv></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_att=
r">On Fri, Nov 1, 2019 at 1:55 PM Wheberth Damascena Dias &lt;<a href=3D"ma=
ilto:wheberth@gmail.com">wheberth@gmail.com</a>&gt; wrote:<br></div><blockq=
uote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1p=
x solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">Hi Sam,=C2=A0<d=
iv>A quick update. I found the setting you referred=C2=A0from the Motherboa=
rd manual.</div><div>I tried to force the PCIe to Gen1 but again, no luck.<=
/div><div><br></div><div>Regards</div></div><br><div class=3D"gmail_quote">=
<div dir=3D"ltr" class=3D"gmail_attr">Em qui, 31 de out de 2019 =C3=A0s 17:=
39, Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com" targe=
t=3D"_blank">wheberth@gmail.com</a>&gt; escreveu:<br></div><blockquote clas=
s=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid r=
gb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Hi Sam,</div><div><=
br></div><div></div><div></div><div>- In fact the i7 machine is totally dif=
ferent from the i9. Not just a CPU upgrade a new machine with a different m=
otherboard.</div><div>- Regarding the OS version, I have downgraded form Ub=
untu 18 to Ubuntu 16 but there are no difference at all.</div><div>I have a=
lso upgraded another machine to Ubuntu 18 and the USRP worked like charm on=
 this third machine (also very different from the i7 and the i9).</div><div=
>- I have also noticed the that the driver is not &quot;tied&quot; to the P=
CIe device despite compiled and loaded successfully.<br></div><div></div><d=
iv></div><div></div><div>- The PCIe slot on this board is indeed x16 gen 3.=
 But on the BIOS, the only PCIe settings available are related to power man=
agement and Virtualization (SR-IOV).</div><div>- Being a game motherboard w=
ith a single PCIe Slot looks like a good indication of intended usage.</div=
><div>I have also upgraded the BIOS but, again, no success.</div><div><br><=
/div><div>Please find attached the lspci -vvv output form the i7 and i9.</d=
iv><div>for the i9 i also included the dmesg and lsmod.</div><div><br></div=
><div>Thank you Again.</div><div>Best Regards,<br></div><div><br></div><div=
><br></div></div><div dir=3D"ltr"><br></div><br><div class=3D"gmail_quote">=
<div dir=3D"ltr" class=3D"gmail_attr">Em qui, 31 de out de 2019 =C3=A0s 16:=
38, Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" target=3D"_blank=
">sam.reiter@ettus.com</a>&gt; escreveu:<br></div><blockquote class=3D"gmai=
l_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,20=
4,204);padding-left:1ex"><div dir=3D"ltr"><div>I also spoke with someone on=
 our PXI team regarding 8371 compatibility, what that manual note means, an=
d some other troubleshooting steps. Not sure if any of this will be actiona=
ble, but here are some tidbits of knowledge:</div><div><br></div><div>- &qu=
ot;Slots intended for graphics cards&quot; are usually x16 PCIe slots that =
...
working with your i7.<br></div><div>- Related to the point above, gaming or=
iented motherboards seem to give the 8371 and similar MXI cards more troubl=
e than non-gaming motherboards. The CPU typically isn&#39;t as big of a fac=
tor as motherboard / BIOS. This makes your i7 / i9 issue all the more puzzl=
ing. <br></div><div>- You can see if there are BIOS settings to change the =
PCIe link speed to Gen 1 and try that as well see the snippet from the moth=
erboard manual below:</div><div><br></div><div><div><img src=3D"cid:ii_k2f3=
uskb1" alt=3D"image.png" width=3D"568" height=3D"186"><br></div></div><div>=
- You might also check for and install any BIOS updates you have available =
for your motherboard.</div><div><br></div><div>Let me know if these steps o=
r those from my last email have helped to move anything forward.</div><div>=
<br></div><div>-Sam <br></div></div><br><div class=3D"gmail_quote"><div dir=
=3D"ltr" class=3D"gmail_attr">On Thu, Oct 31, 2019 at 1:27 PM Sam Reiter &l=
...
1ex"><div dir=3D"ltr">I&#39;m not sure if the graphics card thing is worth =
spending too much time on -- I can&#39;t find a great answer for the reason=
ing behind it either.<br><br>From the initial lspci output, there don&#39;t=
 seem to be any kernel drivers handling the 8371. Were you able to try reco=
mpiling and reloading the RIO drivers after installing your new CPU?<br><br=
>Here are a couple other commands I&#39;d like you to run and report the ou=
tputs of:<br><br><b>sudo lspci -vvv</b><br><br><b>dmesg</b><br><br><b>lsmod=
</b><br><br>If you could attach those outputs as text files, that may be he=
lpful in moving this forward. Feel free to pass along any changes you obser=
ved between 18.04 and 16.04 as well.<br><br>-Sam</div><br><div class=3D"gma=
il_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Oct 30, 2019 at 8:2=
1 AM Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com" targ=
...
m" target=3D"_blank">wheberth@gmail.com</a>&gt; escreveu:<br></div><blockqu=
ote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px=
 solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Here is the=
 full output of the lspci. I will try to install Ubuntu 16.04 and see <br><=
/div><div><br></div><div>00:00.0 Host bridge: Intel Corporation Device 3e30=
 (rev 0a)<br>00:01.0 PCI bridge: Intel Corporation Xeon E3-1200 v5/E3-1500 =
v5/6th Gen Core Processor PCIe Controller (x16) (rev 0a)<br>00:02.0 VGA com=
patible controller: Intel Corporation Device 3e98<br>00:14.0 USB controller=
: Intel Corporation Cannon Lake PCH USB 3.1 xHCI Host Controller (rev 10)<b=
r>00:14.2 RAM memory: Intel Corporation Cannon Lake PCH Shared SRAM (rev 10=
)<br>00:14.3 Network controller: Intel Corporation Wireless-AC 9560 [Jeffer=
son Peak] (rev 10)<br>00:16.0 Communication controller: Intel Corporation C=
annon Lake PCH HECI Controller (rev 10)<br>00:17.0 SATA controller: Intel C=
orporation Cannon Lake PCH SATA AHCI Controller (rev 10)<br>00:1b.0 PCI bri=
dge: Intel Corporation Device a340 (rev f0)<br>00:1c.0 PCI bridge: Intel Co=
rporation Device a338 (rev f0)<br>00:1d.0 PCI bridge: Intel Corporation Can=
non Lake PCH PCI Express Root Port 9 (rev f0)<br>00:1f.0 ISA bridge: Intel =
Corporation Device a305 (rev 10)<br>00:1f.3 Audio device: Intel Corporation=
 Cannon Lake PCH cAVS (rev 10)<br>00:1f.4 SMBus: Intel Corporation Cannon L=
ake PCH SMBus Controller (rev 10)<br>00:1f.5 Serial bus controller [0c80]: =
Intel Corporation Cannon Lake PCH SPI Controller (rev 10)<br>00:1f.6 Ethern=
et controller: Intel Corporation Ethernet Connection (7) I219-V (rev 10)<br=
>01:00.0 PCI bridge: PLX Technology, Inc. PEX 8608 8-lane, 8-Port PCI Expre=
ss Gen 2 (5.0 GT/s) Switch (rev ba)<br>02:01.0 PCI bridge: PLX Technology, =
Inc. PEX 8608 8-lane, 8-Port PCI Express Gen 2 (5.0 GT/s) Switch (rev ba)<b=
r>03:00.0 Signal processing controller: National Instruments PXIe/PCIe Devi=
ce<br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"=
gmail_attr">Em sex, 25 de out de 2019 =C3=A0s 20:55, Wheberth Damascena Dia=
s &lt;<a href=3D"mailto:wheberth@gmail.com" target=3D"_blank">wheberth@gmai=
l.com</a>&gt; escreveu:<br></div><blockquote class=3D"gmail_quote" style=3D=
"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-le=
ft:1ex"><div dir=3D"ltr"><div>This computer has a mini-ITX board (ASUS ROG =
Strix Z390-I ) with just one x16 slot.=C2=A0</div><div>However,=C2=A0on mon=
day I can get the full output of the lspci command.<br></div></div><br><div=
 class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em sex, 25 de =
out de 2019 =C3=A0s 18:28, Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettu=
s.com" target=3D"_blank">sam.reiter@ettus.com</a>&gt; escreveu:<br></div><b=
lockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-le=
ft:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">Would you =
be able to try shifting this card to another PCIe slot in your machine?<div=
><br></div><div>I&#39;m also interested in knowing what other PCIe devices =
you have connected to the computer. It might be worth making the X310&#39;s=
 PCIe link the only connection, at least for testing purposes.=C2=A0</div><=
div><br clear=3D"all"><div><div dir=3D"ltr"><div dir=3D"ltr"><div><div dir=
=3D"ltr">Sam=C2=A0</div></div></div></div></div><br></div></div><br><div cl=
ass=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Oct 23, 2=
019 at 6:58 PM Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail=
.com" target=3D"_blank">wheberth@gmail.com</a>&gt; wrote:<br></div><blockqu=
ote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px=
 solid rgb(204,204,204);padding-left:1ex"><div dir=3D"auto"><div dir=3D"aut=
o">Hi Mr Reiter,=C2=A0</div><div dir=3D"auto">Thank you for your answer.</d=
iv><div dir=3D"auto"><br></div>Actually yes, the same X310 runs perfectly i=
n another machine. Its a i7 6th gen with ubuntu 18.04 kernel=C2=A0 4.15.0, =
libuhd and uhd-host on same version.<div dir=3D"auto"><br></div><div dir=3D=
"auto">I think this can be some PCIe related setting on the BIOS, since the=
 lspci shows [disabled] next to the base address, but I can&#39;t find any =
option to change it on the BIOS.=C2=A0</div><div dir=3D"auto"><br></div><di=
v dir=3D"auto">Best Regards</div><div dir=3D"auto"><br></div><div dir=3D"au=
to"><br></div><div dir=3D"auto"><br><div dir=3D"auto"><br></div></div></div=
>
</blockquote></div>
