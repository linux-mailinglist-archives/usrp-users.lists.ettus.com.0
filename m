...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 7DA163665A6
	for <lists+usrp-users@lfdr.de>; Wed, 21 Apr 2021 08:50:20 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 54BCE384235
	for <lists+usrp-users@lfdr.de>; Wed, 21 Apr 2021 02:50:19 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=vectalabs-com.20150623.gappssmtp.com header.i=@vectalabs-com.20150623.gappssmtp.com header.b="NkfUabEa";
	dkim-atps=neutral
Received: from mail-ua1-f45.google.com (mail-ua1-f45.google.com [209.85.222.45])
	by mm2.emwd.com (Postfix) with ESMTPS id C8FF0383D79
	for <usrp-users@lists.ettus.com>; Wed, 21 Apr 2021 02:49:32 -0400 (EDT)
Received: by mail-ua1-f45.google.com with SMTP id v23so12799741uaq.13
        for <usrp-users@lists.ettus.com>; Tue, 20 Apr 2021 23:49:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=vectalabs-com.20150623.gappssmtp.com; s=20150623;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=B3hLxVganTm4xTBsdpYEFaiN0IsKR5LaFWRFvD9F1Rg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=B3hLxVganTm4xTBsdpYEFaiN0IsKR5LaFWRFvD9F1Rg=;
        b=
X-Gm-Message-State: AOAM531tiqzUriui2pmTyavBUl/sh/9znue78YbgaGOVbqN+0G7f8e8W
	QERIph9Zfm6Cie+oze1+yIzqG+cCgn3nI/CZyiQg+g==
X-Google-Smtp-Source: ABdhPJw4ogFvFMGGFtsSGjhTLPfiUUSt4or8xgZdzFnd5hwfwVKjui7virkEySKn+4UAOcr7Mq+n451Mhx3iyo28aFI=
X-Received: by 2002:ab0:36a3:: with SMTP id v3mr15738957uat.116.1618987772192;
 Tue, 20 Apr 2021 23:49:32 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CALNMZ8UQ8RyEozohS6i_K-7_+5p7NQB5fLOJito4=7u+r-bYKQ@mail.gmail.com>
From: Brendan Horsfield <brendan.horsfield@vectalabs.com>
Date: Wed, 21 Apr 2021 16:49:21 +1000
Message-ID: <CALNMZ8VwCH805F1NU0uq032-4HCV7fLx5tzo0Tys0OMH2tME=w@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Message-ID-Hash: XIDIJRNJ33NOIABXOJKPMPNVTHWAPJZH
X-Message-ID-Hash: XIDIJRNJ33NOIABXOJKPMPNVTHWAPJZH
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/XIDIJRNJ33NOIABXOJKPMPNVTHWAPJZH/>
...
Content-Type: multipart/mixed; boundary="===============2756126629676328470=="

--===============2756126629676328470==
Content-Type: multipart/alternative; boundary="0000000000000ebaa205c075f79b"

--0000000000000ebaa205c075f79b
...
Radio installations, and manually deleted every remaining file & folder on
...
terminal.  The bad news is that it generates a lot of warning messages, and
...
> UHD to add this feature, I broke GNU Radio.  (However, the Python API wor=
ks
> great!)
>
> >>If you're doing a lot of this "back and forth" from various package
> repositories, the
> >>official repositories, and source-based installs, you really need to be
> a "Linux Geek"
> >>in order not to create the "tangle" that you've created for yourself.
>
> I hear what you are saying -- I am definitely on a steep
> learning curve, and have taken some missteps.  However, I need to get thi=
s
...
>> $ dpkg -S "$(basename
>> "/usr/lib/x86_64-linux-gnu/libuhd.so.003.010.003")"  -->  dpkg-query: no
...
by
>> a config file or history file from the Ubuntu Software version of GRC th=
at
...
>>
>>
>> I think I will try and scrub my system of everything related to GNU Radi=
o
...
>>   decisions about bits and pieces you may have installed from source, an=
d
...
>>> >> If you download the source, build and install it (following GNU Radi=
o
>>> >> wiki),
...
>>> > resolve package from __spec__ or __package__, falling back on __name_=
_
>>> and
>>> > __path__
>>> >   return f(*args, **kwds)
...
<div dir=3D"ltr">Just a quick follow up to close out this thread (for now):=
<div><br></div><div>I have run &quot;sudo make uninstall&quot; and &quot;su=
do make clean&quot; on my Volk &amp;=C2=A0GNU Radio installations, and manu=
ally deleted every remaining file &amp; folder on my laptop that contained =
the string &quot;gnuradio&quot; in their titles.=C2=A0 I have also deleted =
every libuhd file I could find, apart from those related to UHD v4.0.0.0.</=
div><div><br></div><div>I then reinstalled Volk &amp; GNU Radio from source=
.=C2=A0 This process was completed with no errors, apart from a &quot;no te=
sts found&quot; message when I tried to run &quot;make test&quot; on the GN=
U Radio build.</div><div><br></div><div>The good news is that I can now ope=
n GNU Radio Companion from the terminal.=C2=A0 The bad news is that it gene=
rates a lot of warning messages, and won&#39;t run any flowgraphs -- even v=
ery simple ones.</div><div><br></div><div>Going forward, I will take this i=
ssue up with the GNU Radio mailing list, as I don&#39;t believe the UHD dri=
ver has anything to do with my current crop of problems.<br></div><div><br>=
</div><div>Thank you all for your help and patience with this novice GNU Ra=
dio user!</div><div><br></div><div>Cheers,</div><div>Brendan.</div><div><br=
></div><div><br></div><div><br></div></div><br><div class=3D"gmail_quote"><=
div dir=3D"ltr" class=3D"gmail_attr">On Wed, Apr 21, 2021 at 10:33 AM Brend=
an Horsfield &lt;<a href=3D"mailto:brendan.horsfield@vectalabs.com" target=
=3D"_blank">brendan.horsfield@vectalabs.com</a>&gt; wrote:<br></div><blockq=
uote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1p=
x solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">Hi Marcus,<div>=
<br></div><div>&gt;&gt;On Ubuntu 18.04, Gnu Radio and UHD installed from th=
e official repositories &quot;just works&quot;,=C2=A0</div><div>&gt;&gt;but=
 won&#39;t have the Python API you&#39;re looking for.</div><div><br></div>=
<div>Yes, my attempt to add the UHD Python API is what started all this.=C2=
=A0 I originally had GNU Radio &amp; UHD working well together, but I reall=
y needed (and still need) the UHD Python API for my main project.=C2=A0 Whe=
n I rebuilt UHD to add this feature, I broke GNU Radio.=C2=A0 (However, the=
 Python API works great!)</div><div><br></div><div>&gt;&gt;If you&#39;re do=
ing a lot of this &quot;back and forth&quot; from various package repositor=
ies, the</div><div>&gt;&gt;official repositories, and source-based installs=
, you really need to be a &quot;Linux Geek&quot;=C2=A0</div><div>&gt;&gt;in=
 order not to create the &quot;tangle&quot; that you&#39;ve created for you=
rself.</div><div><br></div><div>I hear what you are saying -- I am definite=
ly on a steep learning=C2=A0curve,=C2=A0and have taken some missteps.=C2=A0=
 However, I need to get this working somehow.=C2=A0 If I can roll back my s=
ystem to a GNU Radio-free state, and then install the latest version of GNU=
 Radio from source as per the instructions in=C2=A0<a href=3D"https://wiki.=
gnuradio.org/index.php/InstallingGR#From_Source" target=3D"_blank">https://=
wiki.gnuradio.org/index.php/InstallingGR#From_Source</a>, surely the system=
 should be pretty close to working?=C2=A0</div><div><br></div><div>Brendan.=
</div><div><br></div><div><br></div></div><br><div class=3D"gmail_quote"><d=
iv dir=3D"ltr" class=3D"gmail_attr">On Wed, Apr 21, 2021 at 10:02 AM Marcus=
