...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id D0B1D9F91F4
	for <lists+usrp-users@lfdr.de>; Fri, 20 Dec 2024 13:12:43 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 99C38385BD2
	for <lists+usrp-users@lfdr.de>; Fri, 20 Dec 2024 07:12:42 -0500 (EST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1734696762; bh=GuSoX/ZAen58zszOq1DSttK9zOT2UOw+jaYe3qu10Us=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-ej1-f53.google.com (mail-ej1-f53.google.com [209.85.218.53])
	by mm2.emwd.com (Postfix) with ESMTPS id 202093859EA
	for <usrp-users@lists.ettus.com>; Fri, 20 Dec 2024 07:11:31 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=ettus-com.20230601.gappssmtp.com header.i=@ettus-com.20230601.gappssmtp.com header.b="0nkx3RT4";
	dkim-atps=neutral
Received: by mail-ej1-f53.google.com with SMTP id a640c23a62f3a-a9a977d6cc7so262481566b.3
        for <usrp-users@lists.ettus.com>; Fri, 20 Dec 2024 04:11:30 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ettus-com.20230601.gappssmtp.com; s=20230601; t=1734696690; x=1735301490; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=bmNK+oHXaex1IVWRILUs99gWfDDhmK54EVQUf1H268s=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1734696690; x=1735301490;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=bmNK+oHXaex1IVWRILUs99gWfDDhmK54EVQUf1H268s=;
        b=
X-Gm-Message-State: AOJu0Yw2/6eIvJGwy1TkFB3yi8LYWz+AU6EY1ACfVjECj0WpWgDgZe6J
	vA0ZUHvQ4/1a8MSP4Spqy89zcLoGmSvO+jj8Am3hwgkcAjyxc7JChcskdoAyKpi7GPC0M5MB/Ai
	Mn7Eothq66nCBIPlNzn5UpVI21rXmpVvvXTj4y0g8+stnlI0y1ZUREA==
X-Gm-Gg: ASbGnctZjyrZlfUC8w3xS4M7pXPZU3cXHWYn1MwZLU2rsB3r7XF6Plpe9SyZmSk+Fxv
	uDMlIrMfLn180n6bkwffg2LrsOGMi0XZShe8L
X-Google-Smtp-Source: AGHT+IGxQVvQLRc6iZYlZ4LgMERvLR5H+ZcrDXnNI9hjc3MWHnE0+oOEFMEwuzQRsw6xcCSZttV0DY4nonELhm6+XLM=
X-Received: by 2002:a05:6402:270d:b0:5d0:fb56:3f with SMTP id
 4fb4d7f45d1cf-5d81dd9cdf0mr5326942a12.12.1734696688714; Fri, 20 Dec 2024
 04:11:28 -0800 (PST)
MIME-Version: 1.0
References: <CAE=q3UPVjJMaehJ=FN7gtNvHgPXBOoXyPqhAfDMkKb1XEg8ErA@mail.gmail.com>
 <CAFOi1A63WnfL1k5UiuL9hV07-uMg-fJBEXDcn3H+eiaoZZX8zA@mail.gmail.com> <CAE=q3UNd5j=eH6ZdGNTPppF-W90=yOMFYNe5G4+AM1UmsEq+Zw@mail.gmail.com>
In-Reply-To: <CAE=q3UNd5j=eH6ZdGNTPppF-W90=yOMFYNe5G4+AM1UmsEq+Zw@mail.gmail.com>
From: Martin Braun <martin.braun@ettus.com>
Date: Fri, 20 Dec 2024 13:11:17 +0100
Message-ID: <CAFOi1A7v32uogWnmKeHoDF=CpYhrDPh5aUrpCBNxmUa55=_2pw@mail.gmail.com>
To: David <vitishlsfan21@gmail.com>
Message-ID-Hash: KI7UJ5IEQQQSRXH6YCSRSVW2NFIU55SW
X-Message-ID-Hash: KI7UJ5IEQQQSRXH6YCSRSVW2NFIU55SW
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/KI7UJ5IEQQQSRXH6YCSRSVW2NFIU55SW/>
...
Content-Type: multipart/mixed; boundary="===============4157019002366215559=="

--===============4157019002366215559==
Content-Type: multipart/related; boundary="000000000000ed45230629b28b5e"

--000000000000ed45230629b28b5e
Content-Type: multipart/alternative; boundary="000000000000ed45210629b28b5d"

--000000000000ed45210629b28b5d
...
On Fri, Dec 20, 2024 at 3:27=E2=80=AFAM David <vitishlsfan21@gmail.com> wro=
te:

> Martin,
>
> Thanks for the reply. I will take any modules you suggest for AXI
> alignment, even if they do not "fix" my issue, it is good for me to look =
at.
>
...
> image and my image. I also was able to add a dummy port on my image and r=
un
...
> that the AXI handshake is one packet with two parallel streams. I will tr=
y
...
>       ...
>
> 4. right now, since I want to issue the streaming command while doing *re=
cord
...
> block. It is not trivial for me since I am not a C++ person, so I won't b=
e
...
> David
>
> On Thu, Dec 19, 2024 at 3:24=E2=80=AFAM Martin Braun <martin.braun@ettus.=
com>
> wrote:
>
>> Hey David,
...
>> that. However, maybe I'm forgetting something that would cause the outpu=
ts
>> of the DDCs to misalign data by a few clock cycles. Which makes me wonde=
r:
>> Are you sure your input packets are misaligned? In RFNoC, we make no
>> guarantee that the output of the DDC (or any other) block is aligned to =
the
>> clock cycle, because we encode the timestamp with the data. Meaning that
>> the first, actual sample that arrives at your block on each channel is i=
n
>> fact time-aligned, they just arrive a few clock cycles apart. This is th=
e
>> same logic that applies when packets arrive at the host computer, where =
we
...
>> actually align samples within your block, or you just do some AXI alignm=
ent
...
>> set_action_forwarding_policy(forwarding_policy_t::ONE_TO_FAN, "stream_cm=
d")
...
>>> application and not my block. My Vivado simulations show my block is ab=
le
...
>>> command because I was having issues with my block propagating. Issuing =
to
>>> the DDCs lets the data flow from 2 inputs to the 1 output, where the ou=
tput
...
>>> I have two methods of measuring the synchronization, with data collecte=
d
...
>>>    correlation and show that the correlation peaks as expected, and sho=
w the
>>>    delay between channels in samples.
>>>    2. *Vivado Waveform Viewer*: When the ILA cores are collecting DDC
>>>    channel data, I can see that the base image samples are available on=
 the
...
<div dir=3D"ltr"><div>David,</div><div><br></div><div>is it possible that y=
our block is deasserting tready on one of its inputs, thus delaying the DDC=
?</div><div><br></div><div>--M<br></div></div><br><div class=3D"gmail_quote=
 gmail_quote_container"><div dir=3D"ltr" class=3D"gmail_attr">On Fri, Dec 2=
0, 2024 at 3:27=E2=80=AFAM David &lt;<a href=3D"mailto:vitishlsfan21@gmail.=
com">vitishlsfan21@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"g=
mail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204=
,204,204);padding-left:1ex"><div dir=3D"ltr"><div dir=3D"ltr"><div dir=3D"l=
tr"><div dir=3D"ltr"><div dir=3D"ltr">Martin,=C2=A0<div><br></div><div>Than=
ks for the reply. I will take any modules you suggest for AXI alignment, ev=
en if they do not &quot;fix&quot; my issue, it is good for me to look at.</=
div><div><br></div><div>1. thanks for the comment, this block is a long tim=
e coming.</div><div><br></div><div>2. We captured some screen shots of the =
ILA core recording both the base image and my image. I also was able to add=
 a dummy port on my image and run the <i>rx_samples_to_file </i>on that (be=
cause it was statically connected), which confirmed=C2=A0that the multi_usr=
p method producing the expected results, with/without my block in line:</di=
v><div><br></div><div>below I present some screenshots of the behavior, whe=
re the ILA is capturing the output of both DDCs <i>before</i>=C2=A0packetiz=
ation.<b> What is not shown is the multi_usrp method running with=C2=A0my b=
lock, but it has the same behavior as the base image</b><b>:</b></div><div>=
<br></div><div><b>Base Image, with rx_samples_to_file (multi_usrp)</b></div=
><div>Example 1: zoomed in run</div><div><img src=3D"cid:ii_m4w4843v6" alt=
=3D"base_image_zoomed.PNG" width=3D"739" height=3D"142" style=3D"margin-rig=
ht: 0px;"><br></div><div>Example 2: different run, zoomed out. both DDCs pe=
rform as expected:</div><div><img src=3D"cid:ii_m4w4gywn10" alt=3D"base_ima=
ge_zoomed_out.PNG" width=3D"743" height=3D"146" style=3D"margin-right: 0px;=
"><br></div><div><br></div><div><br></div><div><b>Custom Image, with davids=
_rx_to_file (ddc_block_controller)</b></div><div>Example 1: random distance=
 between samples on both DDCs, clear on DDC1. The last 4 valids have a big =
change in cycle distance.</div><div><img src=3D"cid:ii_m4w4ac0d7" alt=3D"ra=
ndom_dist.PNG" width=3D"735" height=3D"140" style=3D"margin-right: 0px;"><b=
r></div><div>Example 2: a different run, same behavior as above and time ta=
gs.</div><div><img src=3D"cid:ii_m4w4cwr48" alt=3D"time_tags.PNG" width=3D"=
737" height=3D"157" style=3D"margin-right: 0px;"><br></div><div>Example 3: =
A run where it &quot;almost&quot; worked, and my block also &quot;almost wo=
rked&quot;. You can see the alignment slips at the end:</div><div><img src=
=3D"cid:ii_m4w4esko9" alt=3D"Timing_mostly_aligned.PNG" width=3D"720" heigh=
t=3D"180" style=3D"margin-right: 0px;"><br></div><div><br></div><div><br></=
div><div>3. right now in the yaml I am using the named inputs with one port=
 each:</div><div><br></div><div><div style=3D"color:rgb(204,204,204);backgr=
ound-color:rgb(31,31,31);font-family:Consolas,&quot;Courier New&quot;,monos=
pace;font-size:14px;line-height:19px;white-space:pre-wrap"><div><span style=
=3D"color:rgb(86,156,214)">data</span>:</div><div>=C2=A0 <span style=3D"col=
or:rgb(86,156,214)">fpga_iface</span>: <span style=3D"color:rgb(206,145,120=
)">axis_data</span></div><div>=C2=A0 <span style=3D"color:rgb(86,156,214)">=
clk_domain</span>: <span style=3D"color:rgb(206,145,120)">rfnoc_chdr</span>=
</div><div>=C2=A0 <span style=3D"color:rgb(86,156,214)">inputs</span>:</div=
><div>=C2=A0 =C2=A0 <span style=3D"color:rgb(86,156,214)">in_1</span>:</div=
><div>=C2=A0 =C2=A0 =C2=A0 <span style=3D"color:rgb(86,156,214)">num_ports<=
/span>: <span style=3D"color:rgb(181,206,168)">1</span></div><div>=C2=A0 =
=C2=A0 =C2=A0 <span style=3D"color:rgb(181,206,168)">...</span></div><div>=
=C2=A0 =C2=A0 <span style=3D"color:rgb(86,156,214)">in_2</span>:</div><div>=
=C2=A0 =C2=A0 =C2=A0 <span style=3D"color:rgb(86,156,214)">num_ports</span>=
: <span style=3D"color:rgb(181,206,168)">1</span></div><div>=C2=A0 =C2=A0 =
=C2=A0 <span style=3D"color:rgb(181,206,168)">...</span></div></div></div><=
div><br></div><div>I have done some experiments with one named input with 2=
 port, and I see that the AXI handshake is one packet with two parallel str=
eams. I will try to &quot;AXI align&quot; as you suggested with this first:=
</div><div><div style=3D"background-color:rgb(31,31,31);font-family:Consola=
s,&quot;Courier New&quot;,monospace;font-size:14px;line-height:19px;white-s=
pace:pre-wrap"><div style=3D"color:rgb(204,204,204)"><span style=3D"color:r=
gb(86,156,214)">data</span>:</div><div style=3D"color:rgb(204,204,204)">=C2=
=A0 <span style=3D"color:rgb(86,156,214)">fpga_iface</span>: <span style=3D=
"color:rgb(206,145,120)">axis_data</span></div><div style=3D"color:rgb(204,=
204,204)">=C2=A0 <span style=3D"color:rgb(86,156,214)">clk_domain</span>: <=
span style=3D"color:rgb(206,145,120)">rfnoc_chdr</span></div><div style=3D"=
color:rgb(204,204,204)">=C2=A0 <span style=3D"color:rgb(86,156,214)">inputs=
</span>:</div><div style=3D"color:rgb(204,204,204)">=C2=A0 =C2=A0 <span sty=
le=3D"color:rgb(86,156,214)">in</span>:</div><div><font color=3D"#cccccc">=
=C2=A0 =C2=A0 =C2=A0 </font><span style=3D"color:rgb(86,156,214)">num_ports=
</span><font color=3D"#cccccc">: </font><font color=3D"#b5cea8">2</font></d=
iv><div style=3D"color:rgb(204,204,204)">=C2=A0 =C2=A0 =C2=A0 <span style=
=3D"color:rgb(181,206,168)">...</span></div></div></div><div><br></div><div=
>4. right now, since I want to issue the streaming command while doing <b>r=
ecord to file</b> and <b>transmit loopback</b>, I will start with the forwa=
rding policy as you suggested and also try to add my own issue stream comma=
nd to my block. It is not trivial for me since I am not a C++ person, so I =
won&#39;t be able to provide much feedback on that effort.</div><div><br></=
div><div>Thanks,</div><div><br></div><div>David</div></div></div></div></di=
v><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On T=
hu, Dec 19, 2024 at 3:24=E2=80=AFAM Martin Braun &lt;<a href=3D"mailto:mart=
in.braun@ettus.com" target=3D"_blank">martin.braun@ettus.com</a>&gt; wrote:=
<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8=
ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr=
"><div>Hey David,</div><div><br></div><div>this looks like you&#39;ve gotte=
n pretty far on a sophisticated project!=C2=A0 I have a few observations:<b=
r></div><div><br></div><div>- At first glance, your C++ looks correct.</div=
><div>- I would expect samples to arrive at your block synchronously based =
on that. However, maybe I&#39;m forgetting something that would cause the o=
utputs of the DDCs to misalign data by a few clock cycles. Which makes me w=
onder: Are you sure your input packets are misaligned? In RFNoC, we make no=
 guarantee that the output of the DDC (or any other) block is aligned to th=
e clock cycle, because we encode the timestamp with the data. Meaning that =
the first, actual sample that arrives at your block on each channel is in f=
act time-aligned, they just arrive a few clock cycles apart. This is the sa=
me logic that applies when packets arrive at the host computer, where we ma=
ke no assumptions that they arrive at the exact same time.</div><div>- If t=
his is the issue, I think we have some modules you can use to actually alig=
n samples within your block, or you just do some AXI alignment yourself by =
combining the tready and tvalid signals of two streams.<br></div><div>- Sid=
e note, although it&#39;s not important: I would consider it a best practic=
e to have your block call set_action_forwarding_policy(forwarding_policy_t:=
:ONE_TO_FAN, &quot;stream_cmd&quot;) so it would properly forward stream co=
mmands, and then you can plop the stream command into the streamer.</div><d=
iv><br></div><div>--M<br></div></div><br><div class=3D"gmail_quote"><div di=
r=3D"ltr" class=3D"gmail_attr">On Sun, Dec 15, 2024 at 10:49=E2=80=AFPM Dav=
...
dding-left:1ex"><div dir=3D"ltr"><div dir=3D"ltr">Hello all,<div><br></div>=
<div>I apologize in advance for=C2=A0data=C2=A0dumping. I have made a 2 inp=
ut/1 output RFNoC block that requires repeatable synchronized DDC starts. M=
y current method of starting the DDC is not working as desired.</div><div><=
br></div><div><b><u>Question</u>=C2=A0-=C2=A0</b><b>How can I correctly sta=
rt both DDC&#39;s so samples are available on the same clock cycle, similar=
 to the rx_samples_to_file, while still using my 2 in/1 out RFNoC block?=C2=
=A0</b></div><div>I would like to focus the conversation on my C++ implemen=
tation for now. All my simulations have convinced me my block is consuming =
AXI-Stream data correctly.</div><div><br></div><div><b><u>Problem</u></b></=
div><div>When starting two DDCs with=C2=A0timed commands sent to DDC in my =
C++ application,<i>=C2=A0</i>I am not getting the same result as the rx_sam=
ples_to_file.cpp... rx_samples_to_file has repeatable alignment, and mine h=
as random. This has led me to believe the problem is in my application and =
not my block. My Vivado simulations show my block is able to consume the AX=
I-Stream transactions in parallel as I expect.</div><div><br></div><div>Con=
sidering sampling noise from a sig gen that is split to both inputs, I see =
the following behavior:=C2=A0</div><div><table cellspacing=3D"0" cellpaddin=
g=3D"0" dir=3D"ltr" border=3D"1" style=3D"table-layout:fixed;font-size:10pt=
;font-family:Arial;width:0px;border-collapse:collapse;border:medium"><colgr=
oup><col width=3D"100"><col width=3D"100"><col width=3D"100"><col width=3D"=
100"><col width=3D"100"><col width=3D"100"><col width=3D"23"><col width=3D"=
100"><col width=3D"100"><col width=3D"100"><col width=3D"100"><col width=3D=
"100"><col width=3D"100"></colgroup><tbody><tr style=3D"height:21px"><td st=
yle=3D"border:1px solid rgb(0,0,0);overflow:hidden;padding:2px 3px;vertical=
-align:bottom"></td><td style=3D"border-width:1px;border-style:solid;border=
-color:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;pa=
dding:2px 3px;vertical-align:bottom;font-size:12pt;font-weight:bold;text-al=
ign:center" rowspan=3D"1" colspan=3D"5">rx_samples_to_file (base image)</td=
><td style=3D"border-width:1px;border-style:solid;border-color:rgb(0,0,0) r=
...
204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom"></td><t=
...
"1" colspan=3D"5">davids_samples_to_file (custom image)</td></tr><tr style=
...
vertical-align:bottom;font-weight:bold">DDC A samples</td><td style=3D"bord=
...
rflow:hidden;padding:2px 3px;vertical-align:bottom">X_1</td><td style=3D"bo=
...
bottom">Y_1</td><td style=3D"border-width:1px;border-style:solid;border-col=
or:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;=
padding:2px 3px;vertical-align:bottom">Z_1</td><td style=3D"border-width:1p=
...
ertical-align:bottom;font-weight:bold">DDC A samples</td><td style=3D"borde=
...
tom;font-size:14pt">...</td><td style=3D"border-width:1px;border-style:soli=
d;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);over=
flow:hidden;padding:2px 3px;vertical-align:bottom">X_1</td><td style=3D"bor=
der-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) r=
gb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:b=
ottom">Y_1</td><td style=3D"border-width:1px;border-style:solid;border-colo=
r:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;p=
adding:2px 3px;vertical-align:bottom">Z_1</td><td style=3D"border-width:1px=
...
ze:14pt">...</td></tr><tr style=3D"height:21px"><td style=3D"border-width:1=
px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0);o=
verflow:hidden;padding:2px 3px;vertical-align:bottom;font-weight:bold">DDC =
B samples</td><td style=3D"border-width:1px;border-style:solid;border-color=
...
rder-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) =
rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:=
bottom">X_2</td><td style=3D"border-width:1px;border-style:solid;border-col=
or:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;=
padding:2px 3px;vertical-align:bottom">Y_2</td><td style=3D"border-width:1p=
x;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rg=
b(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom">Z_2</=
...
px;vertical-align:bottom;font-size:14pt">...</td><td style=3D"border-width:=
1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) =
rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;back=
ground-color:rgb(0,0,0)"></td><td style=3D"border-width:1px;border-style:so=
lid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);ov=
erflow:hidden;padding:2px 3px;vertical-align:bottom;font-weight:bold">DDC B=
 samples</td><td style=3D"border-width:1px;border-style:solid;border-color:=
rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;pad=
ding:2px 3px;vertical-align:bottom">X_2</td><td style=3D"border-width:1px;b=
order-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(2=
04,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom">Y_2</td>=
...
vertical-align:bottom">Z_2</td><td style=3D"border-width:1px;border-style:s=
olid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);o=
verflow:hidden;padding:2px 3px;vertical-align:bottom;font-size:14pt">...</t=
...
x;vertical-align:bottom;font-size:14pt">...</td></tr></tbody></table></div>=
<div><b><u><br></u></b></div><div>*sample_1 is not equal to sample_2, but o=
ver a large number of samples they will correlate well.=C2=A0</div><div><br=
></div><div>In the above example, the noise correlates as expected, but it =
is delayed by 1 sample. When using my application, I have seen no delay (de=
sired), and also delay in the range of 5 samples.=C2=A0</div><div><br></div=
><div><b><u>C++ Implementation</u></b></div><div><img src=3D"cid:ii_m4q2yje=
80" alt=3D"image.png" width=3D"562" height=3D"98"><br></div><div><br></div>=
<div>I am using<b><i> uhd::rfnoc::ddc_block_control</i></b> types to issue =
the stream command because I was having issues with my block propagating. I=
ssuing=C2=A0to the DDCs lets the data flow from 2 inputs to the 1 output, w=
here the output is either a file or loopback to transmit.</div><div><br></d=
iv><div>The base image with rx_samples_to_file uses a multi_usrp type, whic=
h propagates the stream command from the rx_streamer.</div><div><br></div><=
div><u style=3D"font-weight:700">RFNoC laydown</u><b></b></div><div><u styl=
e=3D"font-weight:700"><br></u></div><div><img src=3D"cid:ii_m4q46qnx1" alt=
=3D"image.png" width=3D"562" height=3D"279"><br></div><div><br></div><div>D=
ata flows in both Tx loopback configuration and Rx to file configuration.</=
div><div><br></div><div><b><u>Methods and Symptoms</u></b></div><div>I have=
 two methods of measuring the synchronization, with data collected by ILA c=
ores at either the output of DDC or input of custom block:=C2=A0</div><div>=
<ol><li><b>Math: </b>When receiving correlated noise, I can measure the cro=
ss correlation and show that the correlation peaks as expected, and show th=
e delay between channels in samples.</li><li><b>Vivado Waveform Viewer</b>:=
 When the ILA cores are collecting DDC channel data, I can see that the bas=
e image samples are available on the same clock. My image does not have tha=
t behavior.</li></ol></div><div><br></div><div>Thanks,</div><div><br></div>=
<div>David</div><div><b><u><br></u></b></div><div><b><u><br></u></b></div><=
