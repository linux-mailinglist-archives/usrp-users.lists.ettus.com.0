...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DD779E5E6E
	for <lists+usrp-users@lfdr.de>; Thu,  5 Dec 2024 19:48:16 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 490583859C8
	for <lists+usrp-users@lfdr.de>; Thu,  5 Dec 2024 13:48:15 -0500 (EST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1733424495; bh=yme9jFEIrVRm9fjV4X5rrQPvECE/bJcphNwTi+//78A=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qk1-f178.google.com (mail-qk1-f178.google.com [209.85.222.178])
	by mm2.emwd.com (Postfix) with ESMTPS id D2BE938584B
	for <usrp-users@lists.ettus.com>; Thu,  5 Dec 2024 13:47:39 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="Crs4SYh7";
	dkim-atps=neutral
Received: by mail-qk1-f178.google.com with SMTP id af79cd13be357-7b673cb2708so123944385a.2
        for <usrp-users@lists.ettus.com>; Thu, 05 Dec 2024 10:47:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1733424459; x=1734029259; darn=lists.ettus.com;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=lMiJEw2gnP8eXheSOV/hhKrPUtOS7ctNGVUnzqDVg+I=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1733424459; x=1734029259;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=lMiJEw2gnP8eXheSOV/hhKrPUtOS7ctNGVUnzqDVg+I=;
        b=
X-Gm-Message-State: AOJu0YwzN0yBepV+W90p55TFWkAA+5muDAwdthOQ0780jeuPkjAr17hj
	+t7y6xV9ffdtFdkFXnqcoQiKvtkKF/GqORhJ1HZUvwHOCn5CGnDZ
X-Gm-Gg: 
	41JkmlOX9jdWkYARBZ5t7iXeqkGFePKPRcviCHnlU+aVw0Hr
X-Google-Smtp-Source: AGHT+IG1nUcFLvKOhso6g0mVWlz9Xbp1AQNhHg1k/pnYp74nn8iPYFeVB4CBWFZbWpWFbn2X8yZHSg==
X-Received: by 2002:a05:620a:29c6:b0:7b1:880c:5834 with SMTP id af79cd13be357-7b6bcb5116dmr47837785a.48.1733424458783;
        Thu, 05 Dec 2024 10:47:38 -0800 (PST)
Received: from [192.168.2.170] (bras-base-smflon1825w-grc-05-174-88-53-166.dsl.bell.ca. [174.88.53.166])
        by smtp.googlemail.com with ESMTPSA id af79cd13be357-7b6b5a66d6esm86268585a.55.2024.12.05.10.47.37
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 05 Dec 2024 10:47:38 -0800 (PST)
Message-ID: <54f72452-ae5c-4b91-a382-ad6324ee69c2@gmail.com>
Date: Thu, 5 Dec 2024 13:47:37 -0500
MIME-Version: 1.0
...
Message-ID-Hash: OX5EWQHNEG4BVHS6W72QVO6YW35VPOER
X-Message-ID-Hash: OX5EWQHNEG4BVHS6W72QVO6YW35VPOER
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/OX5EWQHNEG4BVHS6W72QVO6YW35VPOER/>
...
Content-Type: multipart/mixed; boundary="===============0935361440704722840=="

This is a multi-part message in MIME format.
--===============0935361440704722840==
Content-Type: multipart/alternative;
 boundary="------------gzSPnClFp0j8oTShyWGA4tUU"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------gzSPnClFp0j8oTShyWGA4tUU
...
> Here it is:
>
> ad@bm-super11-intel:~$ sudo /usr/local/lib/uhd/examples/benchmark_rate=20
> --args=20
> "type=3Dn3xx,product=3Dn310,addr=3D10.10.0.100,master_clock_rate=3D125e=
6"=20
> --rx_rate 25e6 --tx_rate 25e6
My recollection of your config is that 10.10.0.100 is the RJ-45 you use=20
for your management port?=C2=A0 What if you use
 =C2=A0 one of the SFP+ port addresses for the same thing?

25Msps is the absolute limit of streaming over a 1GiGe connection, and I=20
think 10.10.0.100 was the RJ-45 port on
 =C2=A0 your configuration as I recall.=C2=A0=C2=A0 It's likely that the =
combined=20
network traffic of full-duplex streaming and management
 =C2=A0 traffic cause your 1GIGe interface to totally saturate and start=20
...
> [00:00:00.000131] Creating the usrp device with:=20
...
e=3Dni-n3xx-32000F1,fpga=3DXG,claimed=3DFalse,addr=3D10.10.0.100,master_c=
lock_rate=3D125e6
> [WARNING] [MPM.RPCServer] A timeout event occured!
> [INFO] [MPM.PeriphManager] init() called with device args=20
> `fpga=3DXG,master_clock_rate=3D125e6,mgmt_addr=3D10.10.0.100,name=3Dni-=
n3xx-32000F1,product=3Dn310,clock_source=3Dinternal,time_source=3Dinterna=
l'.
...
> UOUUUUUUUUUUUUUUUUUterminate called after throwing an instance of=20
> 'uhd::op_timeout'
...
> 64 bytes from 10.10.0.100 <http://10.10.0.100>: icmp_seq=3D1 ttl=3D64=20
> time=3D0.311 ms
> 64 bytes from 10.10.0.100 <http://10.10.0.100>: icmp_seq=3D2 ttl=3D64=20
> time=3D0.297 ms
> ^C
...
> ad@bm-super11-intel:~$
>
> On Thu, 5 Dec 2024 at 18:23, Marcus D. Leech <patchvonbraun@gmail.com>=20
> wrote:
>
...
>>     "addr=3D10.10.1.100,second_addr=3D10.10.2.100,mgmt_addr=3D10.10.0.=
100,master_clock_rate=3D125e6,use_dpdk=3D1"|
>>
>>     |[INFO] [UHD] linux; GNU C++ version 11.4.0; Boost_107400;
>>     DPDK_23.11; UHD_4.7.0.HEAD-0-ga5ed1872|
>>
...
>>     addr=3D10.10.1.100,second_addr=3D10.10.2.100,mgmt_addr=3D10.10.0.1=
00,master_clock_rate=3D125e6,use_dpdk=3D1...|
>>
>>     |EAL: FATAL: already called initialization.|
>>
>>     |EAL: already called initialization.|
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 05/12/2024 12:27, Houshang wrote:<b=
r>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAO=3Dxj9WWy4FwmOVvK1D2-XNKNnvn4q7vUeDv_u=3DiXbz4zycJ7A@mail.=
gmail.com">
...
ate=3D125e6"
    ...
    =C2=A0 your configuration as I recall.=C2=A0=C2=A0 It's likely that t=
he combined
    network traffic of full-duplex streaming and management<br>
    =C2=A0 traffic cause your 1GIGe interface to totally saturate and sta=
rt
...
.<br>
            ...
            =C2=A0 what(): =C2=A0RfnocError: OpTimeout: Control operation=
 timed
            ...
            64 bytes from <a href=3D"http://10.10.0.100"
              moz-do-not-send=3D"true">10.10.0.100</a>: icmp_seq=3D1 ttl=3D=
64
            time=3D0.311 ms<br>
            64 bytes from <a href=3D"http://10.10.0.100"
              moz-do-not-send=3D"true">10.10.0.100</a>: icmp_seq=3D2 ttl=3D=
64
            time=3D0.297 ms<br>
            ^C<br>
...
padding-left:1ex">
          <div>
            <div>On 05/12/2024 11:44, <a
                ...
                class=3D"moz-txt-link-freetext">houshang.azizi@accelleran=
.com</a>
              wrote:<br>
            </div>
            <blockquote type=3D"cite">
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D</code></p>
              ...
              <p><code>0000:43:00.0 'Ethernet Controller X710 for 10GbE
                  SFP+ 1572' if=3Dens1f0 drv=3Di40e unused=3Dvfio-pci </c=
ode></p>
              <p><code>0000:43:00.3 'Ethernet Controller X710 for 10GbE
                  SFP+ 1572' if=3Dens1f3 drv=3Di40e unused=3Dvfio-pci *Ac=
tive*</code></p>
              <p><code>0000:70:00.0 'Ethernet Controller X710 for 10GbE
                  SFP+ 1572' if=3Dens2f0 drv=3Di40e unused=3Dvfio-pci </c=
ode></p>
              <p><code>0000:70:00.1 'Ethernet Controller X710 for 10GbE
                  SFP+ 1572' if=3Dens2f1 drv=3Di40e unused=3Dvfio-pci </c=
ode></p>
...
=3D=3D=3D=3D=3D=3D=3D</code></p>
              ...
              <p><code>[INFO] [UHD] linux; GNU C++ version 11.4.0;
                  Boost_107400; DPDK_23.11; UHD_4.7.0.HEAD-0-ga5ed1872</c=
ode></p>
              <p><code>--------------------------------------------------=
</code></p>
              ...
              <p><code>ad@bm-super11-intel:~/accelleran$ sudo
                  ...
                  --tx_rate 125e6 --tx_subdev "A:0 B:0" --tx_channels
                  0,1 --args
...
ode></p>
              ...
              <p><code>i40e_dev_rx_queue_start(): Failed to allocate RX
                  queue mbuf</code></p>
              <p><code>[ERROR] [DPDK] Port 1: Could not start device</cod=
e></p>
              <p><code>EAL: FATAL: already called initialization.</code><=
/p>
