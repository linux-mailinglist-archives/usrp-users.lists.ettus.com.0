...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id DFE1348F2D9
	for <lists+usrp-users@lfdr.de>; Sat, 15 Jan 2022 00:11:27 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id D51663859C5
	for <lists+usrp-users@lfdr.de>; Fri, 14 Jan 2022 18:11:26 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="itVZ7FEF";
	dkim-atps=neutral
Received: from mail-qk1-f170.google.com (mail-qk1-f170.google.com [209.85.222.170])
	by mm2.emwd.com (Postfix) with ESMTPS id BF087385515
	for <usrp-users@lists.ettus.com>; Fri, 14 Jan 2022 18:10:25 -0500 (EST)
Received: by mail-qk1-f170.google.com with SMTP id 193so11755842qkh.13
        for <usrp-users@lists.ettus.com>; Fri, 14 Jan 2022 15:10:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=content-transfer-encoding:from:mime-version:subject:date:message-id
         :references:cc:in-reply-to:to;
        bh=PhFp6/JLrnijERK7Rqk5ZCsJYpFdmgLTcfS3R8TzWSE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=PhFp6/JLrnijERK7Rqk5ZCsJYpFdmgLTcfS3R8TzWSE=;
        b=
X-Gm-Message-State: AOAM531ti8W/W3/EWdFhU6Vw/OrvhmbFDNOf7K6g4UPhMfolYt70kHrr
	3uAxxf6oEg+IHxZ/y2f7gmS4ft57qhk=
X-Google-Smtp-Source: ABdhPJzc8i8c4UhSal8STaQhtI0zmZXOjckr+FPVSXUs+ybkw1PV/MXKzt3P8iy/XuGxx1sPUsCIPg==
X-Received: by 2002:a05:620a:4304:: with SMTP id u4mr8014625qko.43.1642201825006;
        Fri, 14 Jan 2022 15:10:25 -0800 (PST)
Received: from smtpclient.apple ([2600:380:183c:a2b4:3d54:ef6a:f627:a3e3])
        by smtp.gmail.com with ESMTPSA id h13sm4234548qtr.47.2022.01.14.15.10.23
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 14 Jan 2022 15:10:24 -0800 (PST)
From: Paul Atreides <maud.dib1984@gmail.com>
Mime-Version: 1.0 (1.0)
Date: Fri, 14 Jan 2022 18:10:22 -0500
Message-Id: <9BF6739D-27C9-40FD-9939-1840B77BBB59@gmail.com>
References: <344538c2-638c-46db-397d-2609f8b48dff@gmail.com>
In-Reply-To: <344538c2-638c-46db-397d-2609f8b48dff@gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
X-Mailer: iPhone Mail (19B74)
Message-ID-Hash: 6YQXIMWEI7LMH2UL736WIUQIDD5PVHAL
X-Message-ID-Hash: 6YQXIMWEI7LMH2UL736WIUQIDD5PVHAL
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/6YQXIMWEI7LMH2UL736WIUQIDD5PVHAL/>
...
Content-Type: multipart/mixed; boundary="===============7685821274040487861=="


--===============7685821274040487861==
Content-Type: multipart/alternative; boundary=Apple-Mail-464D49F6-1960-49D7-BA2B-849A3536EEF7
Content-Transfer-Encoding: 7bit


--Apple-Mail-464D49F6-1960-49D7-BA2B-849A3536EEF7
Content-Type: text/plain;
	charset=utf-8
Content-Transfer-Encoding: quoted-printable

Ok thanks. In my haste I was mistaken in assuming that the LO gain would tra=
ck with the RF output gain. Silly mistake. I=E2=80=99m still getting used to=
 separating out the LO.=20

I can put this on a SpectrumAnalyzer (with an attenuator in line) on Monday.=


I=E2=80=99m trying to take channel to channel phase measurements to determin=
e what level of phase control I can have over one channel.

It=E2=80=99s not critical that I use GNURadio but it seemed like the logical=
 option as it=E2=80=99s very easy to make those adjustments.

I will look at the python API and see if the commands Rob was talking about c=
an be invoked using Python  instead of writing a C++ application.
Then I=E2=80=99ll see if that is included in gr-uhd. If not, I can submit a p=
ull request with any changes.
...
> On Jan 14, 2022, at 17:43, Marcus D. Leech <patchvonbraun@gmail.com> wrote=
:
>=20
> =EF=BB=BF
> On 2022-01-14 17:35, Paul Atreides wrote:
>> Using a B210 at f_c of the N321. TX LO OUT0 is plugged into RX2 of the  B=
210
> You might want to put an attenuator inline, since the LO output is a coupl=
e of dBm, which is
...
>   switch that enables the splitter, which means that once the splitter is t=
urned on, the
...
>>>> These thare the UHD commands. I don't know how these translate to gnura=
dio.
>>>>=20
...
>>>>=20
>>> I don't think the current GR code has support for controlling the splitt=
er, so a "code snippet" would likely be required.
>>>=20
>>>=20
...
Content-Type: multipart/related;
	type="text/html";
	boundary=Apple-Mail-A16449F1-7253-4291-A4FD-5CD1981DD7EC
Content-Transfer-Encoding: 7bit


--Apple-Mail-A16449F1-7253-4291-A4FD-5CD1981DD7EC
Content-Type: text/html;
	charset=utf-8
Content-Transfer-Encoding: quoted-printable

<html><head><meta http-equiv=3D"content-type" content=3D"text/html; charset=3D=
utf-8"></head><body dir=3D"auto">Ok thanks. In my haste I was mistaken in as=
suming that the LO gain would track with the RF output gain. Silly mistake. I=
=E2=80=99m still getting used to separating out the LO.&nbsp;<div><br></div>=
<div>I can put this on a SpectrumAnalyzer (with an attenuator in line) on Mo=
nday.</div><div><br></div><div>I=E2=80=99m trying to take channel to channel=
 phase measurements to determine what level of phase control I can have over=
 one channel.</div><div><br></div><div>It=E2=80=99s not critical that I use G=
NURadio but it seemed like the logical option as it=E2=80=99s very easy to m=
ake those adjustments.</div><div><br></div><div>I will look at the python AP=
I and see if the commands Rob was talking about can be invoked using Python &=
nbsp;instead of writing a C++ application.</div><div>Then I=E2=80=99ll see i=
f that is included in gr-uhd. If not, I can submit a pull request with any c=
hanges.</div><div><br></div><div>I=E2=80=99ll ping the gnuradio chat later t=
onight.</div><div><br></div><div><br></div><div>Thanks for the help guys are=
 in<br><div dir=3D"ltr">&lt;<span class=3D"Apple-style-span" style=3D"-webki=
...
><br><blockquote type=3D"cite">On Jan 14, 2022, at 17:43, Marcus D. Leech &l=
t;patchvonbraun@gmail.com&gt; wrote:<br><br></blockquote></div><blockquote t=
...
>
 =20
 =20
    <div class=3D"moz-cite-prefix">On 2022-01-14 17:35, Paul Atreides
      wrote:<br>
    </div>
    <blockquote type=3D"cite" cite=3D"mid:CACwKM9Kogf3x961=3DspgvcP75VRqGTbX=
5UaxMdYZEUy_+MqG-0w@mail.gmail.com">
      <meta http-equiv=3D"content-type" content=3D"text/html; charset=3DUTF-=
8">
      <div dir=3D"ltr">Using a B210 at f_c of the N321. TX LO OUT0 is
        plugged into RX2 of the&nbsp; B210<br>
      </div>
    </blockquote>
    You might want to put an attenuator inline, since the LO output is a
    couple of dBm, which is<br>
    &nbsp; "loud as a heavy metal concert" from the perspective of a receive=
r
    input.<br>
    <br>
    If the splitter isn't enabled in this test, then what you're seeing
    is the leakage through the RF<br>
    &nbsp; switch that enables the splitter, which means that once the
    splitter is turned on, the<br>
    &nbsp; signal will be even louder...<br>
    <br>
    <br>
    <blockquote type=3D"cite" cite=3D"mid:CACwKM9Kogf3x961=3DspgvcP75VRqGTbX=
5UaxMdYZEUy_+MqG-0w@mail.gmail.com">
      <div dir=3D"ltr"><img alt=3D"image.png" width=3D"416" height=3D"264" s=
rc=3D"cid:part1.JECl7UZl.muUlaSHq@gmail.com"><br>
        <div><br>
        </div>
      </div>
      <br>
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Fri, Jan 14, 2022 at 5:32
            ...
            <blockquote type=3D"cite">
              <div dir=3D"ltr">
                <div><font face=3D"monospace">These thare the UHD
                    commands. I don't know how these translate to
                    gnuradio.</font></div>
                <div><font face=3D"monospace"><br>
                  </font></div>
                <div><font face=3D"monospace">% set both LO sources to use
                    external</font></div>
                <font face=3D"monospace">set_tx_lo_source(=E2=80=9Cexternal=E2=
=80=9D,
                  =E2=80=9Clo1=E2=80=9D, 0)<br>
                </font>
                <div><font face=3D"monospace">set_tx_lo_source(=E2=80=9Cexte=
rnal=E2=80=9D,
                    =E2=80=9Clo1=E2=80=9D, 1)<br>
                  </font></div>
                <div><font face=3D"monospace"><br>
                  </font></div>
                <div><font face=3D"monospace">% export the internal LO to
                    the 1:4 splitter</font></div>
                ...
                <div><font face=3D"monospace">% enable the 1:4 splitter
                    output port</font></div>
                <div><font face=3D"monospace">get_device()-&gt;get_tree()-&g=
t;access&lt;bool&gt;("mboards/0/dboards/A/tx_frontends/0/los/lo1/lo_distribu=
tion/LO_OUT_0/export").set(true)</font><br>
                </div>
              </div>
              <br>
            </blockquote>
            I don't think the current GR code has support for
            controlling the splitter, so a "code snippet" would likely
            be required.<br>
            <br>
            <br>
            <blockquote type=3D"cite">
                ...
                <blockquote class=3D"gmail_quote" style=3D"margin:0px 0px
                  ...
                  <div class=3D"gmail_quote">
                    <blockquote class=3D"gmail_quote" style=3D"margin:0px
                      ...
                      rgb(204,204,204);padding-left:1ex"> To unsubscribe
                      send an email to <a href=3D"mailto:usrp-users-leave@li=
sts.ettus.com" target=3D"_blank" moz-do-not-send=3D"true" class=3D"moz-txt-l=
ink-freetext">usrp-users-leave@lists.ettus.com</a><br>
                    </blockquote>
                  </div>
                </blockquote>
              </div>
...
Content-Type: image/png;
	name=image.png;
	x-apple-part-url="part1.JECl7UZl.muUlaSHq@gmail.com"
Content-Disposition: inline;
	filename=image.png
Content-Transfer-Encoding: base64
Content-Id: <part1.JECl7UZl.muUlaSHq@gmail.com>
