...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id D3B559F8A17
	for <lists+usrp-users@lfdr.de>; Fri, 20 Dec 2024 03:28:52 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id A39B538591F
	for <lists+usrp-users@lfdr.de>; Thu, 19 Dec 2024 21:28:51 -0500 (EST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1734661731; bh=O7wyIWbtKqE8BmpawfwWxuLd51O/CGhFlHoTJfzvGEg=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-oa1-f45.google.com (mail-oa1-f45.google.com [209.85.160.45])
	by mm2.emwd.com (Postfix) with ESMTPS id 1EA2B385869
	for <usrp-users@lists.ettus.com>; Thu, 19 Dec 2024 21:27:45 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="QbZ5ACyo";
	dkim-atps=neutral
Received: by mail-oa1-f45.google.com with SMTP id 586e51a60fabf-29fad34bb62so680838fac.1
        for <usrp-users@lists.ettus.com>; Thu, 19 Dec 2024 18:27:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1734661664; x=1735266464; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=fV/u8lyRxO9r0ld6RVVJ2bIuPjN9VBmPrEG35QhDTrs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1734661664; x=1735266464;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=fV/u8lyRxO9r0ld6RVVJ2bIuPjN9VBmPrEG35QhDTrs=;
        b=
X-Gm-Message-State: AOJu0YwntCVC+696ae+DnoXtlSwH2j2hfaVNUFLJh2wfN03QwQk46EDy
	JjNsiJBxCAbBsYe6SxgkKFbGf7QJg4sNunW97pY5IV1Xssr7JgDFZHUYMJjLJCuJwKnEjMIBstl
	p8SwAyefhQ66RoKRstdVUFiR2pwRfj5HV7ak=
X-Gm-Gg: ASbGnctTE1uGRsjVfgyYXr7rkCQ476lIV8BJDuPadvBBr7U3hq0RRy6JiYclC2emNsY
	4IlURMwmAjtVJ0UNO3el2id7Q77KMioRUa+slsA==
X-Google-Smtp-Source: AGHT+IHnXryiR2rW01HOFhjT6wFDQJiPYXLw2zh7C8xlm/55mSS5x5h+pItCeImSAWD5kN2l8hclgeYpuzT921ge+2I=
X-Received: by 2002:a05:6871:2209:b0:29f:b7f1:d844 with SMTP id
 586e51a60fabf-2a7fb1859c1mr761148fac.2.1734661663226; Thu, 19 Dec 2024
 18:27:43 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CAFOi1A63WnfL1k5UiuL9hV07-uMg-fJBEXDcn3H+eiaoZZX8zA@mail.gmail.com>
From: David <vitishlsfan21@gmail.com>
Date: Thu, 19 Dec 2024 18:27:32 -0800
Message-ID: <CAE=q3UNd5j=eH6ZdGNTPppF-W90=yOMFYNe5G4+AM1UmsEq+Zw@mail.gmail.com>
To: Martin Braun <martin.braun@ettus.com>
Message-ID-Hash: IOITL5AJK4VVBWQ3HYG6UKDKP6GJIDF5
X-Message-ID-Hash: IOITL5AJK4VVBWQ3HYG6UKDKP6GJIDF5
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/IOITL5AJK4VVBWQ3HYG6UKDKP6GJIDF5/>
...
Content-Type: multipart/mixed; boundary="===============8532032593057608360=="

--===============8532032593057608360==
Content-Type: multipart/related; boundary="0000000000003f513b0629aa646f"

--0000000000003f513b0629aa646f
Content-Type: multipart/alternative; boundary="0000000000003f513a0629aa646e"

--0000000000003f513a0629aa646e
...
4. right now, since I want to issue the streaming command while doing *reco=
rd
...
On Thu, Dec 19, 2024 at 3:24=E2=80=AFAM Martin Braun <martin.braun@ettus.co=
m> wrote:
...
> that. However, maybe I'm forgetting something that would cause the output=
s
...
> guarantee that the output of the DDC (or any other) block is aligned to t=
he
...
> same logic that applies when packets arrive at the host computer, where w=
e
...
> actually align samples within your block, or you just do some AXI alignme=
nt
...
>> available on the same clock cycle, similar to the rx_samples_to_file, wh=
ile
>> still using my 2 in/1 out RFNoC block? *
>> I would like to focus the conversation on my C++ implementation for now.
>> All my simulations have convinced me my block is consuming AXI-Stream da=
ta
>> correctly.
>>
>> *Problem*
...
>> rx_samples_to_file.cpp... rx_samples_to_file has repeatable alignment, a=
nd
>> mine has random. This has led me to believe the problem is in my
>> application and not my block. My Vivado simulations show my block is abl=
e
...
>>
>> In the above example, the noise correlates as expected, but it is delaye=
d
>> by 1 sample. When using my application, I have seen no delay (desired), =
and
...
>> command because I was having issues with my block propagating. Issuing t=
o
>> the DDCs lets the data flow from 2 inputs to the 1 output, where the out=
put
...
>> [image: image.png]
>>
>> Data flows in both Tx loopback configuration and Rx to file configuratio=
n.
>>
...
r=3D"ltr">Martin,=C2=A0<div><br></div><div>Thanks for the reply. I will tak=
e any modules you suggest for AXI alignment, even if they do not &quot;fix&=
quot; my issue, it is good for me to look at.</div><div><br></div><div>1. t=
hanks for the comment, this block is a long time coming.</div><div><br></di=
v><div>2. We captured some screen shots of the ILA core recording both the =
base image and my image. I also was able to add a dummy port on my image an=
d run the <i>rx_samples_to_file </i>on that (because it was statically conn=
ected), which confirmed=C2=A0that the multi_usrp method producing the expec=
ted results, with/without my block in line:</div><div><br></div><div>below =
I present some screenshots of the behavior, where the ILA is capturing the =
output of both DDCs <i>before</i>=C2=A0packetization.<b> What is not shown =
is the multi_usrp method running with=C2=A0my block, but it has the same be=
havior as the base image</b><b>:</b></div><div><br></div><div><b>Base Image=
, with rx_samples_to_file (multi_usrp)</b></div><div>Example 1: zoomed in r=
un</div><div><img src=3D"cid:ii_m4w4843v6" alt=3D"base_image_zoomed.PNG" wi=
dth=3D"739" height=3D"142" style=3D"margin-right: 0px;"><br></div><div>Exam=
ple 2: different run, zoomed out. both DDCs perform as expected:</div><div>=
<img src=3D"cid:ii_m4w4gywn10" alt=3D"base_image_zoomed_out.PNG" width=3D"7=
43" height=3D"146" style=3D"margin-right: 0px;"><br></div><div><br></div><d=
iv><br></div><div><b>Custom Image, with davids_rx_to_file (ddc_block_contro=
ller)</b></div><div>Example 1: random distance between samples on both DDCs=
, clear on DDC1. The last 4 valids have a big change in cycle distance.</di=
v><div><img src=3D"cid:ii_m4w4ac0d7" alt=3D"random_dist.PNG" width=3D"735" =
height=3D"140" style=3D"margin-right: 0px;"><br></div><div>Example 2: a dif=
ferent run, same behavior as above and time tags.</div><div><img src=3D"cid=
:ii_m4w4cwr48" alt=3D"time_tags.PNG" width=3D"737" height=3D"157" style=3D"=
margin-right: 0px;"><br></div><div>Example 3: A run where it &quot;almost&q=
uot; worked, and my block also &quot;almost worked&quot;. You can see the a=
lignment slips at the end:</div><div><img src=3D"cid:ii_m4w4esko9" alt=3D"T=
iming_mostly_aligned.PNG" width=3D"720" height=3D"180" style=3D"margin-righ=
t: 0px;"><br></div><div><br></div><div><br></div><div>3. right now in the y=
aml I am using the named inputs with one port each:</div><div><br></div><di=
...
t:19px;white-space:pre"><div><span style=3D"color:rgb(86,156,214)">data</sp=
an>:</div><div>=C2=A0 <span style=3D"color:rgb(86,156,214)">fpga_iface</spa=
n>: <span style=3D"color:rgb(206,145,120)">axis_data</span></div><div>=C2=
...
ce;font-size:14px;line-height:19px;white-space:pre"><div style=3D"color:rgb=
(204,204,204)"><span style=3D"color:rgb(86,156,214)">data</span>:</div><div=
 style=3D"color:rgb(204,204,204)">=C2=A0 <span style=3D"color:rgb(86,156,21=
4)">fpga_iface</span>: <span style=3D"color:rgb(206,145,120)">axis_data</sp=
an></div><div style=3D"color:rgb(204,204,204)">=C2=A0 <span style=3D"color:=
rgb(86,156,214)">clk_domain</span>: <span style=3D"color:rgb(206,145,120)">=
rfnoc_chdr</span></div><div style=3D"color:rgb(204,204,204)">=C2=A0 <span s=
tyle=3D"color:rgb(86,156,214)">inputs</span>:</div><div style=3D"color:rgb(=
204,204,204)">=C2=A0 =C2=A0 <span style=3D"color:rgb(86,156,214)">in</span>=
:</div><div><font color=3D"#cccccc">=C2=A0 =C2=A0 =C2=A0 </font><span style=
=3D"color:rgb(86,156,214)">num_ports</span><font color=3D"#cccccc">: </font=
><font color=3D"#b5cea8">2</font></div><div style=3D"color:rgb(204,204,204)=
">=C2=A0 =C2=A0 =C2=A0 <span style=3D"color:rgb(181,206,168)">...</span></d=
iv></div></div><div><br></div><div>4. right now, since I want to issue the =
streaming command while doing <b>record to file</b> and <b>transmit loopbac=
k</b>, I will start with the forwarding policy as you suggested and also tr=
y to add my own issue stream command to my block. It is not trivial for me =
since I am not a C++ person, so I won&#39;t be able to provide much feedbac=
k on that effort.</div><div><br></div><div>Thanks,</div><div><br></div><div=
>David</div></div></div></div></div><br><div class=3D"gmail_quote gmail_quo=
te_container"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Dec 19, 2024 at=
 3:24=E2=80=AFAM Martin Braun &lt;<a href=3D"mailto:martin.braun@ettus.com"=
>martin.braun@ettus.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_=
quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,=
204);padding-left:1ex"><div dir=3D"ltr"><div>Hey David,</div><div><br></div=
><div>this looks like you&#39;ve gotten pretty far on a sophisticated proje=
ct!=C2=A0 I have a few observations:<br></div><div><br></div><div>- At firs=
t glance, your C++ looks correct.</div><div>- I would expect samples to arr=
ive at your block synchronously based on that. However, maybe I&#39;m forge=
tting something that would cause the outputs of the DDCs to misalign data b=
y a few clock cycles. Which makes me wonder: Are you sure your input packet=
s are misaligned? In RFNoC, we make no guarantee that the output of the DDC=
 (or any other) block is aligned to the clock cycle, because we encode the =
timestamp with the data. Meaning that the first, actual sample that arrives=
 at your block on each channel is in fact time-aligned, they just arrive a =
few clock cycles apart. This is the same logic that applies when packets ar=
rive at the host computer, where we make no assumptions that they arrive at=
 the exact same time.</div><div>- If this is the issue, I think we have som=
e modules you can use to actually align samples within your block, or you j=
ust do some AXI alignment yourself by combining the tready and tvalid signa=
ls of two streams.<br></div><div>- Side note, although it&#39;s not importa=
nt: I would consider it a best practice to have your block call set_action_=
forwarding_policy(forwarding_policy_t::ONE_TO_FAN, &quot;stream_cmd&quot;) =
so it would properly forward stream commands, and then you can plop the str=
eam command into the streamer.</div><div><br></div><div>--M<br></div></div>=
<br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Sun=
, Dec 15, 2024 at 10:49=E2=80=AFPM David &lt;<a href=3D"mailto:vitishlsfan2=
1@gmail.com" target=3D"_blank">vitishlsfan21@gmail.com</a>&gt; wrote:<br></=
div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;bor=
der-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div=
 dir=3D"ltr">Hello all,<div><br></div><div>I apologize in advance for=C2=A0=
data=C2=A0dumping. I have made a 2 input/1 output RFNoC block that requires=
 repeatable synchronized DDC starts. My current method of starting the DDC =
is not working as desired.</div><div><br></div><div><b><u>Question</u>=C2=
=A0-=C2=A0</b><b>How can I correctly start both DDC&#39;s so samples are av=
ailable on the same clock cycle, similar to the rx_samples_to_file, while s=
till using my 2 in/1 out RFNoC block?=C2=A0</b></div><div>I would like to f=
ocus the conversation on my C++ implementation for now. All my simulations =
have convinced me my block is consuming AXI-Stream data correctly.</div><di=
v><br></div><div><b><u>Problem</u></b></div><div>When starting two DDCs wit=
h=C2=A0timed commands sent to DDC in my C++ application,<i>=C2=A0</i>I am n=
ot getting the same result as the rx_samples_to_file.cpp... rx_samples_to_f=
ile has repeatable alignment, and mine has random. This has led me to belie=
ve the problem is in my application and not my block. My Vivado simulations=
 show my block is able to consume the AXI-Stream transactions in parallel a=
s I expect.</div><div><br></div><div>Considering sampling noise from a sig =
gen that is split to both inputs, I see the following behavior:=C2=A0</div>=
<div><table cellspacing=3D"0" cellpadding=3D"0" dir=3D"ltr" border=3D"1" st=
yle=3D"table-layout:fixed;font-size:10pt;font-family:Arial;width:0px;border=
-collapse:collapse;border:medium"><colgroup><col width=3D"100"><col width=
=3D"100"><col width=3D"100"><col width=3D"100"><col width=3D"100"><col widt=
h=3D"100"><col width=3D"23"><col width=3D"100"><col width=3D"100"><col widt=
h=3D"100"><col width=3D"100"><col width=3D"100"><col width=3D"100"></colgro=
up><tbody><tr style=3D"height:21px"><td style=3D"border:1px solid rgb(0,0,0=
...
0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bott=
om;font-size:12pt;font-weight:bold;text-align:center" rowspan=3D"1" colspan=
=3D"5">rx_samples_to_file (base image)</td><td style=3D"border-width:1px;bo=
rder-style:solid;border-color:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) rgb(204,204,=
...
olor:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padd=
ing:2px 3px;vertical-align:bottom"></td><td style=3D"border-width:1px;borde=
r-style:solid;border-color:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204=
);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-size:12pt;font=
-weight:bold;text-align:center" rowspan=3D"1" colspan=3D"5">davids_samples_=
to_file (custom image)</td></tr><tr style=3D"height:21px"><td style=3D"bord=
er-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rg=
b(0,0,0);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-weight:=
...
ding:2px 3px;vertical-align:bottom;font-size:14pt">...</td><td style=3D"bor=
...
ottom;background-color:rgb(0,0,0)"></td><td style=3D"border-width:1px;borde=
r-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,2=
04,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-weight:b=
old">DDC A samples</td><td style=3D"border-width:1px;border-style:solid;bor=
...
al-align:bottom">X_1</td><td style=3D"border-width:1px;border-style:solid;b=
order-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflo=
w:hidden;padding:2px 3px;vertical-align:bottom">Y_1</td><td style=3D"border=
-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(=
0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bott=
om">Z_1</td><td style=3D"border-width:1px;border-style:solid;border-color:r=
gb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padd=
ing:2px 3px;vertical-align:bottom;font-size:14pt">...</td></tr><tr style=3D=
"height:21px"><td style=3D"border-width:1px;border-style:solid;border-color=
:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0);overflow:hidden;padding:2px 3px;ver=
tical-align:bottom;font-weight:bold">DDC B samples</td><td style=3D"border-=
...
border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overfl=
ow:hidden;padding:2px 3px;vertical-align:bottom">X_2</td><td style=3D"borde=
r-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb=
(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bot=
tom">Y_2</td><td style=3D"border-width:1px;border-style:solid;border-color:=
rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;pad=
ding:2px 3px;vertical-align:bottom">Z_2</td><td style=3D"border-width:1px;b=
order-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(2=
04,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-size=
:14pt">...</td><td style=3D"border-width:1px;border-style:solid;border-colo=
r:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;p=
adding:2px 3px;vertical-align:bottom;background-color:rgb(0,0,0)"></td><td =
...
ical-align:bottom;font-weight:bold">DDC B samples</td><td style=3D"border-w=
...
">X_2</td><td style=3D"border-width:1px;border-style:solid;border-color:rgb=
(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;paddin=
g:2px 3px;vertical-align:bottom">Y_2</td><td style=3D"border-width:1px;bord=
er-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,=
204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom">Z_2</td><td=
 style=3D"border-width:1px;border-style:solid;border-color:rgb(204,204,204)=
 rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;ver=
tical-align:bottom;font-size:14pt">...</td><td style=3D"border-width:1px;bo=
rder-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(20=
4,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-size:=
14pt">...</td></tr></tbody></table></div><div><b><u><br></u></b></div><div>=
*sample_1 is not equal to sample_2, but over a large number of samples they=
 will correlate well.=C2=A0</div><div><br></div><div>In the above example, =
the noise correlates as expected, but it is delayed by 1 sample. When using=
 my application, I have seen no delay (desired), and also delay in the rang=
e of 5 samples.=C2=A0</div><div><br></div><div><b><u>C++ Implementation</u>=
</b></div><div><img src=3D"cid:ii_m4q2yje80" alt=3D"image.png" width=3D"562=
" height=3D"98"><br></div><div><br></div><div>I am using<b><i> uhd::rfnoc::=
ddc_block_control</i></b> types to issue the stream command because I was h=
aving issues with my block propagating. Issuing=C2=A0to the DDCs lets the d=
ata flow from 2 inputs to the 1 output, where the output is either a file o=
r loopback to transmit.</div><div><br></div><div>The base image with rx_sam=
ples_to_file uses a multi_usrp type, which propagates the stream command fr=
om the rx_streamer.</div><div><br></div><div><u style=3D"font-weight:700">R=
FNoC laydown</u><b></b></div><div><u style=3D"font-weight:700"><br></u></di=
v><div><img src=3D"cid:ii_m4q46qnx1" alt=3D"image.png" width=3D"562" height=
=3D"279"><br></div><div><br></div><div>Data flows in both Tx loopback confi=
guration and Rx to file configuration.</div><div><br></div><div><b><u>Metho=
ds and Symptoms</u></b></div><div>I have two methods of measuring the synch=
ronization, with data collected by ILA cores at either the output of DDC or=
 input of custom block:=C2=A0</div><div><ol><li><b>Math: </b>When receiving=
 correlated noise, I can measure the cross correlation and show that the co=
rrelation peaks as expected, and show the delay between channels in samples=
.</li><li><b>Vivado Waveform Viewer</b>: When the ILA cores are collecting =
DDC channel data, I can see that the base image samples are available on th=
e same clock. My image does not have that behavior.</li></ol></div><div><br=
></div><div>Thanks,</div><div><br></div><div>David</div><div><b><u><br></u>=
</b></div><div><b><u><br></u></b></div><div><b><u><br></u></b></div></div>
</div>
