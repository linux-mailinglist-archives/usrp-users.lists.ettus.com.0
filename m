...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 1BEB7B14978
	for <lists+usrp-users@lfdr.de>; Tue, 29 Jul 2025 09:53:16 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id C878B38657F
	for <lists+usrp-users@lfdr.de>; Tue, 29 Jul 2025 03:53:14 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1753775594; bh=06n7r8KlTEXB+BHOfqvbi7E0B2nB46CDOwEpb9+kqAo=;
	h=From:To:Date:References:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from za-smtp-delivery-57.mimecast.co.za (za-smtp-delivery-57.mimecast.co.za [41.74.205.57])
	by mm2.emwd.com (Postfix) with ESMTPS id 864853864B7
	for <usrp-users@lists.ettus.com>; Tue, 29 Jul 2025 03:52:33 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (1024-bit key; unprotected) header.d=vastech.co.za header.i=@vastech.co.za header.b="klGbC+sm";
	dkim-atps=neutral
Received: from mail.vastech.co.za (41.193.248.106 [41.193.248.106]) by
 relay.mimecast.com with ESMTP id za-mta-4-NLG_CeP_O4WPn2wsxSiCEw-1; Tue, 29
 Jul 2025 09:52:28 +0200
X-MC-Unique: NLG_CeP_O4WPn2wsxSiCEw-1
X-Mimecast-MFC-AGG-ID: NLG_CeP_O4WPn2wsxSiCEw_1753775548
dkim-signature: v=1; a=rsa-sha256; d=vastech.co.za; s=dkim;
	...
	bh=bcBmzC83FfhGUq+HXHXyB162cKOTD4+IoSVCSj3IA2E=;
	b=klGbC+smNlXRGVpRhQ+fMzbXSf//44dVjo3qFhZDX/h6Q9Jeq2aWCUppVGFEgaVyHY4zsM8xRICXVgP+WAu70Jpyzzaj4LJ82cGM9gSOwrLB20t/RODRUTj7osHoMF8zbVYc8SkVZX1kzXdvTayK2UMz+cqQrM2JZ6BE4he2zoA=
Received: from exchange3.vastech.co.za (Unknown [172.30.81.31])
	by mail.vastech.co.za with ESMTPSA
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256)
	; Tue, 29 Jul 2025 09:52:24 +0200
...
Thread-Index: AQHb++IkYMk+p2kicke3vxbc7X5L4bRCs8Hg///2/ACAACOsQIAEpzIAgAAlivD//+kdAIABGuHQgAAaqED//+YPAAAEaZ8w
Date: Tue, 29 Jul 2025 07:52:23 +0000
Message-ID: <f2f6f4a9aa574c9599c240b8353e2d02@vastech.co.za>
...
In-Reply-To: <CAFOi1A4X3PcST+MYSdpCSZUwZtNvBE14xSoHywGZ1RZeR7AP2g@mail.gmail.com>
...
MIME-Version: 1.0
Message-ID-Hash: ZDDYXONLLEHD5A4S47CHNDIWRLWPWTUK
X-Message-ID-Hash: ZDDYXONLLEHD5A4S47CHNDIWRLWPWTUK
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/ZDDYXONLLEHD5A4S47CHNDIWRLWPWTUK/>
...
Content-Type: multipart/mixed; boundary="===============6906707784256040298=="

--===============6906707784256040298==
Content-Language: en-US
Content-Type: multipart/signed; protocol="application/x-pkcs7-signature";
	micalg=2.16.840.1.101.3.4.2.3;
	boundary="----=_NextPart_000_01C4_01DC006E.7AD00D10"

------=_NextPart_000_01C4_01DC006E.7AD00D10
Content-Type: multipart/related;
	boundary="----=_NextPart_001_01C5_01DC006E.7AD00D10"


------=_NextPart_001_01C5_01DC006E.7AD00D10
Content-Type: multipart/alternative;
	boundary="----=_NextPart_002_01C6_01DC006E.7AD00D10"


------=_NextPart_002_01C6_01DC006E.7AD00D10
...
<https://url.za.m.mimecastprotect.com/s/irP4C98BNNiN4PosofKiqtmhw?domain=3D=
github.com>=20
...
p.msonormal0, li.msonormal0, div.msonormal0
	...
	font-size:11.0pt;
	font-family:"Calibri",sans-serif;}
p.m1275845332921058704msolistparagraph, =
li.m1275845332921058704msolistparagraph, =
div.m1275845332921058704msolistparagraph
	{mso-style-name:m_1275845332921058704msolistparagraph;
	mso-margin-top-alt:auto;
	margin-right:0cm;
	mso-margin-bottom-alt:auto;
	margin-left:0cm;
...
/* List Definitions */
@list l0
	{mso-list-id:709646971;
	mso-list-template-ids:-1117354744;}
@list l0:level1
	...
	text-indent:-18.0pt;}
@list l1
	{mso-list-id:1406417027;
	mso-list-template-ids:-1761814720;}
ol
	{margin-bottom:0cm;}
ul
	{margin-bottom:0cm;}
...
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>I do see a =
single =E2=80=9CO=E2=80=9D, but this is remote streaming so I =
didn=E2=80=99t think that should occur?<o:p></o:p></span></p><p =
class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>Yes, this =
is a radio -&gt; my custom block dynamic =
...
<br><b>Sent:</b> Tuesday, 29 July 2025 09:44<br><b>Cc:</b> =
...
class=3DMsoNormal><o:p>&nbsp;</o:p></p></div><div><p =
class=3DMsoNormal>based on the src port, this looks like it's going from =
Device to Host, not the other way around. This means it's an async =
message from an RFNoC block, with address 0x1000. I can't tell for sure =
from this screenshot, but I think this is coming from the radio, and =
0x1000 is the &quot;RX Error&quot; address. The data is incorrectly =
formatted (probably an issue of the CHDR dissector, but I think it's =
telling us the data is &quot;2&quot; (if we read this in network =
order).<o:p></o:p></p></div><div><p =
class=3DMsoNormal><o:p>&nbsp;</o:p></p></div><div><p =
class=3DMsoNormal>Put these together, and we're looking at a simple =
overrun. Something in your chain is holding up the radio after a few =
packets. Are you sure you're not seeing an &quot;O&quot; anywhere in =
your output? You are using a radio block, =
right?<o:p></o:p></p></div><div><p =
class=3DMsoNormal><o:p>&nbsp;</o:p></p></div><div><p =
class=3DMsoNormal>--M<o:p></o:p></p></div></div><p =
class=3DMsoNormal><o:p>&nbsp;</o:p></p><div><div><p class=3DMsoNormal>On =
Tue, Jul 29, 2025 at 9:19=E2=80=AFAM Kevin Williams &lt;<a =
...
id=3D"m_1275845332921058704Picture_x0020_1" =
src=3D"cid:image001.png@01DC006E.7A1150F0"><o:p></o:p></p><p =
class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
...
class=3Dm1275845332921058704msolistparagraph style=3D'mso-list:l1 level1 =
lfo1'>This is a summary of my custom block streaming where the data =
...
class=3Dm1275845332921058704msolistparagraph style=3D'mso-list:l0 level1 =
lfo2'>ILA results<o:p></o:p></li></ol><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p><p class=3DMsoNormal =
...
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;&nbsp;=
<a =
href=3D"https://url.za.m.mimecastprotect.com/s/irP4C98BNNiN4PosofKiqtmhw?=
domain=3Dgithub.com" =
...
o:p></p></div></div></div></div></div></div></blockquote></div></div></bo=
dy></html>
------=_NextPart_002_01C6_01DC006E.7AD00D10--
...
Content-ID: <image001.png@01DC006E.7A1150F0>
...
CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNTA3MjkwNzUyMjJaME8GCSqGSIb3DQEJ
BDFCBEDq8HChryxSHzC8UKbhaDKcCT4OSPCyqRRABpQzc1DK5fVUWyT8t3qcSCoU0TbIHW0ScbLj
hhmvJgBo5HBGsKuuMH0GCSsGAQQBgjcQBDFwMG4waTEmMCQGCSqGSIb3DQEJARYXaXRzdXBwb3J0
...

