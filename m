...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 93F371A5A5
	for <lists+usrp-users@lfdr.de>; Sat, 11 May 2019 01:54:59 +0200 (CEST)
Received: from [::1] (port=48038 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.91)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1hPFLp-00024O-6k; Fri, 10 May 2019 19:54:53 -0400
Received: from atl4mhob16.registeredsite.com ([209.17.115.109]:38610)
 by mm2.emwd.com with esmtp (Exim 4.91)
 (envelope-from <k5so@k5so.com>) id 1hPFLH-0001wV-Mh
 for usrp-users@lists.ettus.com; Fri, 10 May 2019 19:54:49 -0400
Received: from mailpod.hostingplatform.com
 (atl4qobmail02pod3.registeredsite.com [10.30.77.68])
 by atl4mhob16.registeredsite.com (8.14.4/8.14.4) with ESMTP id x4ANrWlR029486
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL)
 for <usrp-users@lists.ettus.com>; Fri, 10 May 2019 19:53:32 -0400
Received: (qmail 26079 invoked by uid 0); 10 May 2019 23:53:32 -0000
...
Received: from unknown (HELO ?192.168.1.76?) (k5so@k5so.com@192.206.203.10)
 by 0 with ESMTPA; 10 May 2019 23:53:32 -0000
Message-Id: <365E5ED3-897E-402B-B5BA-D8F9A217B3EF@k5so.com>
Mime-Version: 1.0 (Mac OS X Mail 11.5 \(3445.9.1\))
Date: Fri, 10 May 2019 17:53:30 -0600
In-Reply-To: <A0D159D0-D4D7-4645-8132-44768EF28D22@k5so.com>
...
Content-Type: multipart/mixed; boundary="===============4371296961662955776=="
...
Content-Type: multipart/alternative;
	boundary="Apple-Mail=_98077A4B-27C6-4F23-8640-58410D298A52"


--Apple-Mail=_98077A4B-27C6-4F23-8640-58410D298A52
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain;
	charset=utf-8

Holy smoke!  SUCCESS!!  Nick pointed out that there are two switches on =
the N210; S1 and S2 and S1 is a reset, so an upload of FPGA code fails =
if that is held (which I was holding for his suggested test!).  Holding =
S2 during iMPACT loading of the .bit image results in the =
...
device at address 192.168.10.2, as you would hope. =20
>=20
...
>>> Ian,=20
>>>=20
>>> Very good, that=E2=80=99s encouraging at least.  Yes, I am familiar =
with using ISE iMPACT to load the FPGA with .bit code and even how to =
create the .bit from the associated .bin file and did try doing that =
earlier but perhaps not identically to your prescribed steps below.  =
...
can ping 192.168.10.2 in safe mode tell=E2=80=99s you that the FPGA has =
...
>>>>>>=20
>>>>>> I'm saying that you might try to continue the effort to JTAG load =
a more modern FPGA image. It's possible you have to hold down the safe =
...
<mailto:bistromath@gmail.com>> wrote:
>>>>>>>=20
>>>>>>> So I really dug into the old archives here and literally pulled =
an old hard drive out of a closet, and found a copy of the old hardware =
...
>>>>>>>=20
>>>>>>> If you have a TTL-serial adapter or a logic analyzer that works =
as such, you can connect to the debug UART header and get printout =
...
<usrp-users@lists.ettus.com <mailto:usrp-users@lists.ettus.com>> wrote:
>>>>>>>>>>=20
>>>>>>>>>> Okay.  I=E2=80=99ve asserted from the outset that it=E2=80=99s =
a rev 2, based on the factory label.  Is this N210 a lost cause if it is =
...
>>>>>>>>>>>>> Ian and Nick,=20
>>>>>>>>>>>>>=20
>>>>>>>>>>>>> Thanks for the assistance.  Attached are dropbox links to =
two snapshot photos:  1) the factory label on the back of the N210, =
showing N210 r:2.0 and 2) a top side view of the N210.=20
>>>>>>>>>>>>>=20
>>>>>>>>>>>>> 1) =
...
-webkit-nbsp-mode: space; line-break: after-white-space;" class=3D"">Holy =
smoke! &nbsp;SUCCESS!! &nbsp;Nick pointed out that there are two =
switches on the N210; S1 and S2 and S1 is a reset, so an upload of FPGA =
code fails if that is held (which I was holding for his suggested =
test!). &nbsp;Holding S2 during iMPACT loading of the .bit image results =
in the uhd_image_loader step being SUCCESSFUL!! &nbsp;I am so happy to =
see that! &nbsp;Uhd_usrp_probe works wonderfully. &nbsp;Finally. =
&nbsp;We now can put this little to work doing some tough things! =
&nbsp;<div class=3D""><br class=3D""></div><div class=3D"">Thank you all =
SO MUCH for your assistance with reviving this N210. &nbsp;A monumental =
achievement in my book! &nbsp; I don=E2=80=99t know what to say except =
that we TOTALLY appreciate you efforts to get us running. &nbsp;You guys =
are GREAT!&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">Very best wishes to you each and every one! =
&nbsp;&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">Joe<br class=3D""><div><br class=3D""><blockquote type=3D"cite"=
 class=3D""><div class=3D"">On May 10, 2019, at 5:30 PM, Joe Martin via =
...
space; line-break: after-white-space;" class=3D"">Ian and all,&nbsp;<div =
class=3D""><br class=3D""></div><div class=3D"">I have been very careful =
to avoid the pitfalls you detailed. &nbsp;I began with a fresh =
installation of Ubuntu 18.04 then performed a successful build of UHD =
3.9.7, then used command:</div><div class=3D""><br class=3D""></div><div =
class=3D"">uhd_images_downloader</div><div class=3D""><br =
class=3D""></div><div class=3D"">to load the appropriate/associated =
images into the PC.&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">Then used ISE iMPACT to load the =E2=80=9Cusrp_n210_r3_fpga.bit=
=E2=80=9D file into the FPGA of the N210. &nbsp;iMPACT reports =
=E2=80=9CPROGRAM SUCCESSFUL=E2=80=9D.&nbsp;</div><div class=3D""><br =
class=3D""></div><div class=3D"">Then without power cycling the N210 =
used the command:&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">usrp_image_loader =
=E2=80=94args=3D=E2=80=9Ctype=3Dusrp2,addr=3D192.168.10.2,overwrite-safe=E2=
=80=9D =E2=80=94fw-path=3D/usr/local/share/uhd/images/usrp_n210_fw.bin =
=E2=80=94fpga-path=3D/usr/local/share/uhd/images/usrp_n210_r3_fpga.bin</di=
v><div class=3D""><br class=3D""></div><div class=3D"">To load the =
non-volatile memory of the N210 but I always get the =E2=80=9CRuntimeError=
: Received invalid 32 reply from device=E2=80=9D error when running =
usrp_image_loader.&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">I am able to successfully ping 192.168.10.2 but no matter =
what combinations of r2 or r3 .bit file and firmware and fpga image .bin =
files I use the response when invoking the usrp_image_loader is always =
the same, namely =E2=80=9Cinvalid reply 32 from device=E2=80=9D. =
&nbsp;</div><div class=3D""><br class=3D""></div><div class=3D"">The =
command uhd_find_devices returns by reporting it can find a usrp2 device =
at address 192.168.10.2, as you would hope. &nbsp;</div><div =
class=3D""><br class=3D""></div><div class=3D"">After trying every =
conceivable combination of these actions with numerous versions of UHD =
and r2/r3 .bit FPGA files and r2/r3 .bin files on several fresh =
installations of Ubuntu 18.04 and 16.04 the result is always the same in =
that things proceed normally as the various documents concerning =
un-bricking an N210 explains, until the step of using the =
usrp_image_loader is executed, at which point a RuntimeError returns =
stating that the =E2=80=9Cinvalid 32 reply=E2=80=9D has occurred. =
&nbsp;</div><div class=3D""><br class=3D""></div><div class=3D"">I was =
hopeful that careful use of rev3 .bit and .bin files with UHD 3.9.7 =
would do the trick but alas that is not the case. &nbsp;</div><div =
class=3D""><br class=3D""></div><div class=3D"">I suspect that you are =
near the bottom of the list of suggestions for me and I do appreciate =
the time and thinking you have afforded me on this issue. &nbsp;If there =
is anything remaining to try I=E2=80=99d be most willing to try =
it.&nbsp;</div><div class=3D""><br class=3D""></div><div class=3D"">BTW, =
the suggestion made by someone earlier to try holding the safe button =
down during the loading of the FPGA from iMPACT causes the programming =
to fail (as reported by iMPACT), so that=E2=80=99s apparently not a good =
thing to do. &nbsp;But one can recover from that state by simply by =
re-programming with the safe button not held but the fundamental problem =
with the uhd_image_loader step in the unbricking process always seems to =
result.&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">Joe</div><div class=3D""><br class=3D""></div><div =
class=3D""><div class=3D""><blockquote type=3D"cite" class=3D""><div =
class=3D"">On May 10, 2019, at 9:31 AM, Ian Buckley &lt;<a =
...
after-white-space;">Joe,&nbsp;<div class=3D"">To save you time, It may =
well be worth you trying jumping to the 3) step initially and seeing if =
your current loaded image or safe image is capable of being upgraded =
=E2=80=A6it likely is since that protocol is widely compatible across =
UHD variants. The key here I have to emphasize (since you appear to have =
been previously getting stuck with incompatibility between whatever is =
loaded in the USRP and your host UHD installation) is to be sure your =
new UHD installation is the only one on your system, and that you have =
the binary images that are version matched with it=E2=80=A6people often =
get caught out by reminants of various UHD versions installed in various =
system directories from different install methods.</div><div =
class=3D"">-Ian</div><div class=3D""><br class=3D""><div =
class=3D""><blockquote type=3D"cite" class=3D""><div class=3D"">On May =
10, 2019, at 5:58 AM, Joe Martin via USRP-users &lt;<a =
href=3D"mailto:usrp-users@lists.ettus.com" =
class=3D"">usrp-users@lists.ettus.com</a>&gt; wrote:</div><br =
class=3D"Apple-interchange-newline"><div class=3D""><div class=3D"" =
style=3D"word-wrap: break-word; -webkit-nbsp-mode: space; line-break: =
after-white-space;">Ian,&nbsp;<div class=3D""><br class=3D""></div><div =
...
class=3D"Apple-interchange-newline"><div class=3D""><div class=3D"" =
style=3D"word-wrap: break-word; -webkit-nbsp-mode: space; line-break: =
after-white-space;">Joe,&nbsp;<div class=3D"">This is generally all good =
news and somewhat hopeful. The fact you can ping 192.168.10.2 in safe =
mode tell=E2=80=99s you that the FPGA has loaded an image from Flash, =
that it=E2=80=99s passed CRC and booted the embedded micro controller on =
the FPGA and run the firmware that replies to ICMP packets=E2=80=A6that=E2=
=80=99s a sign the hardware is in reasonable shape, regardless of what =
actually version of image ins currently loaded. If you had the internal =
UART connected to a 3.3V interface you would be seeing the FPGA and FW =
compatibility numbers for this image printed at boot if it got this =
far.</div><div class=3D"">(Sorry if I=E2=80=99m telling you stuff you =
know here, too many messages in this thread to go reread them)</div><div =
class=3D""><br class=3D""></div><div class=3D"">You should now refer to =
these 2 pages:</div><div class=3D""><a =
...
class=3D"Apple-interchange-newline"><div class=3D""><div class=3D"" =
style=3D"word-wrap: break-word; -webkit-nbsp-mode: space; line-break: =
after-white-space;">Oh, okay, I didn=E2=80=99t get that. =
&nbsp;Understood now. &nbsp;I have UHD 3.14.0 running on my main machine =
so I could try again some newer .bit files into the FPGA than I =
...
&nbsp;I also was able to build UHD 3.9.0 on a different machine so I can =
try that too with some of the other .bit files. &nbsp;Will hold the safe =
button down while loading the FPGA this time around. &nbsp;<div =
class=3D""><br class=3D""></div><div class=3D"">Joe<br class=3D""><div =
class=3D""><br class=3D""><blockquote type=3D"cite" class=3D""><div =
class=3D"">On May 9, 2019, at 3:38 PM, Nick Foster &lt;<a =
...
style=3D"word-wrap: break-word; line-break: after-white-space;">Thanks =
for digging into that for us, Nick.&nbsp; Interesting.&nbsp; As the =
hardware change to rev4 occurred around mid 2011 and the earliest UHD =
version that exists on the&nbsp;<a href=3D"http://files.ettus.com/uhd" =
...
padding-left: 1ex;"><div class=3D"">Thanks for the info, Marcus.&nbsp; =
However, seeing that Jason went through this last year with a couple of =
N210 he has it would seem unlikely that all three of the N210 are =
broken.&nbsp; That being said and considering what you jus said it seems =
that I should=E2=80=99ve been able to find some version of UHD that will =
...
&nbsp;<div class=3D""><br class=3D""></div><div class=3D"">I wanted to =
try with even earlier versions of UHD but am finding trouble in =
...
-newline"><div class=3D""><div bgcolor=3D"#FFFFFF" class=3D""><div =
class=3D"m_3343428221959612084gmail-m_3428410372027926386moz-cite-prefix">=
On 05/09/2019 04:18 PM, Joe Martin via USRP-users wrote:<br =
class=3D""></div><blockquote type=3D"cite" class=3D"">Nick, =
...
class=3D"">Joe<br class=3D""><div class=3D""><br =
class=3D""></div></div></blockquote>Theoretically, most versions in the =
last several years should be able to talk to it.&nbsp; In *general* UHD =
never drops support for older hardware,<br class=3D"">&nbsp; and tries =
to maintain compatibility.&nbsp; Now, it is the case that newer features =
are almost never "back-ported", but basic functionality should<br =
class=3D"">&nbsp; always be there.&nbsp;&nbsp;<br class=3D""><br =
class=3D"">What this *should* mean is that you should be able to use the =
firmware tools once the device is in "safe mode" to get yourself to =
where you<br class=3D"">&nbsp; want to be.&nbsp; If that doesn't work, =
that may well mean that the hardware is broken, and it's unlikely to be =
economical to repair.<br class=3D""><br class=3D""><br =
class=3D""><blockquote type=3D"cite" class=3D""><div class=3D""><div =
class=3D""><blockquote type=3D"cite" class=3D""><div class=3D"">On May =
9, 2019, at 2:12 PM, Joe Martin via USRP-users &lt;<a =
href=3D"mailto:usrp-users@lists.ettus.com" target=3D"_blank" =
rel=3D"noreferrer" class=3D"">usrp-users@lists.ettus.com</a>&gt; =
wrote:</div><br =
class=3D"m_3343428221959612084gmail-m_3428410372027926386Apple-interchange=
-newline"><div class=3D""><div class=3D"">Okay. &nbsp;I=E2=80=99ve =
asserted from the outset that it=E2=80=99s a rev 2, based on the factory =
label.&nbsp; Is this N210 a lost cause if it is actually a Rev2 =
...
wrote:</div><br =
class=3D"m_3343428221959612084gmail-m_3428410372027926386Apple-interchange=
-newline"><div class=3D""><div dir=3D"ltr" class=3D"">Well, it's not a =
rev 4. It's either 2 or 3 in terms of hardware revision.&nbsp;<br =
class=3D""></div><br class=3D""><div class=3D"gmail_quote"><div =
dir=3D"ltr" class=3D"gmail_attr">On Thu, May 9, 2019 at 12:58 PM Joe =
Martin &lt;<a href=3D"mailto:k5so@k5so.com" target=3D"_blank" =
rel=3D"noreferrer" class=3D"">k5so@k5so.com</a>&gt; wrote:<br =
...
class=3D"">=E2=80=A6able to ping 192.168.10.2 successfully.<br =
class=3D""><div class=3D""><br class=3D""><blockquote type=3D"cite" =
class=3D""><div class=3D"">On May 9, 2019, at 1:54 PM, Joe Martin &lt;<a =
...
80084366361Apple-interchange-newline"><div class=3D""><div =
...
class=3D"">usrp-users@lists.ettus.com</a>&gt; wrote:</div><br =
class=3D"m_3343428221959612084gmail-m_3428410372027926386gmail-m_-25132065=
80084366361Apple-interchange-newline"><div class=3D""><div class=3D"">Ian =
...
class=3D"">bistromath@gmail.com</a>&gt; wrote:</div><br =
class=3D"m_3343428221959612084gmail-m_3428410372027926386gmail-m_-25132065=
80084366361Apple-interchange-newline"><div class=3D""><div dir=3D"ltr" =
...
0px 0px 0.8ex; border-left-width: 1px; border-left-style: solid; =
border-left-color: rgb(204, 204, 204); padding-left: 1ex;"><div =
dir=3D"auto" class=3D"">Joe,<div dir=3D"auto" class=3D"">So I scratched =
my head about this a little late last night and looked back through the =
development repository for the N210 and as far as I can tell there was =
never customer facing FPGA code for a Rev2 N210. Chatting with Matt =
this&nbsp;morning he shared my feeling that a Rev2 wasn't sold to =
...
can be missleading).</div><div dir=3D"auto" class=3D""><br =
class=3D""></div><div dir=3D"auto" class=3D"">Also have you tried =
booting into the safe image and verifying that it at least pings on =
192.168.10.2?</div><div dir=3D"auto" class=3D""><br class=3D""></div><div =
dir=3D"auto" class=3D"">If we can conclusively identify which rev of h/w =
you have I can probably help further.</div><div dir=3D"auto" =
...
class=3D"">http://lists.ettus.com/mailman/listinfo/usrp-users_lists.ettus.=
com</a><br class=3D""></blockquote></div></div></blockquote></div><br =
...
class=3D""><blockquote type=3D"cite" class=3D""><div class=3D"">On May =
10, 2019, at 9:31 AM, Ian Buckley &lt;<a =
href=3D"mailto:ian.buckley@gmail.com" =
class=3D"">ian.buckley@gmail.com</a>&gt; wrote:</div><br =
class=3D"Apple-interchange-newline"><div class=3D""><meta =
http-equiv=3D"Content-Type" content=3D"text/html charset=3Dutf-8" =
...
class=3D"">To save you time, It may well be worth you trying jumping to =
the 3) step initially and seeing if your current loaded image or safe =
image is capable of being upgraded =E2=80=A6it likely is since that =
protocol is widely compatible across UHD variants. The key here I have =
to emphasize (since you appear to have been previously getting stuck =
with incompatibility between whatever is loaded in the USRP and your =
host UHD installation) is to be sure your new UHD installation is the =
only one on your system, and that you have the binary images that are =
version matched with it=E2=80=A6people often get caught out by reminants =
of various UHD versions installed in various system directories from =
different install methods.</div><div class=3D"">-Ian</div><div =
class=3D""><br class=3D""><div class=3D""><blockquote type=3D"cite" =
class=3D""><div class=3D"">On May 10, 2019, at 5:58 AM, Joe Martin via =
USRP-users &lt;<a href=3D"mailto:usrp-users@lists.ettus.com" =
class=3D"">usrp-users@lists.ettus.com</a>&gt; wrote:</div><br =
class=3D"Apple-interchange-newline"><div class=3D""><meta =
http-equiv=3D"Content-Type" content=3D"text/html; charset=3Dutf-8" =
class=3D""><div style=3D"word-wrap: break-word; -webkit-nbsp-mode: =
space; line-break: after-white-space;" class=3D"">Ian,&nbsp;<div =
class=3D""><br class=3D""></div><div class=3D"">Very good, that=E2=80=99s =
encouraging at least. &nbsp;Yes, I am familiar with using ISE iMPACT to =
load the FPGA with .bit code and even how to create the .bit from the =
associated .bin file and did try doing that earlier but perhaps not =
identically to your prescribed steps below. &nbsp;I=E2=80=99ll revisit =
it. &nbsp;I successfully built UHD 003_009_000 earlier so I can probably =
also successfully build UHD 003_009_007 too. &nbsp;I=E2=80=99ll do that =
and give it a go. &nbsp;I am familiar with the documents you mentioned. =
&nbsp;Generally things have gone exactly as described right up until UHD =
needs to communicate with the stored images at which point it never =
does; so far anyway.</div><div class=3D""><br class=3D""></div><div =
class=3D"">Thanks much for the additional information. &nbsp;I=E2=80=99ll =
certainly hammer on it some more now that I have a few more pertinent =
details under my belt to guide the process =
appropriately.&nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">Joe<br class=3D""><div class=3D""><br class=3D""><blockquote =
type=3D"cite" class=3D""><div class=3D"">On May 10, 2019, at 12:32 AM, =
Ian Buckley &lt;<a href=3D"mailto:ian.buckley@gmail.com" =
class=3D"">ian.buckley@gmail.com</a>&gt; wrote:</div><br =
class=3D"Apple-interchange-newline"><div class=3D""><meta =
http-equiv=3D"Content-Type" content=3D"text/html charset=3Dutf-8" =
class=3D""><div style=3D"word-wrap: break-word; -webkit-nbsp-mode: =
...
></div></div></blockquote></div></div></blockquote></div></div></div></blo=
ckquote></div></div></blockquote></div></div></div></div></blockquote></di=
v></div></blockquote></div></div></div></div></blockquote></div></div></di=
v></div></blockquote></div></div></div></div></blockquote></div></div></di=
