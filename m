...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id E47CC18C389
	for <lists+usrp-users@lfdr.de>; Fri, 20 Mar 2020 00:17:15 +0100 (CET)
Received: from [::1] (port=38754 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1jF4PY-0004P5-8m; Thu, 19 Mar 2020 19:17:12 -0400
Received: from mail-ot1-f51.google.com ([209.85.210.51]:44211)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <rkossler@nd.edu>) id 1jF4PT-0004HX-KT
 for usrp-users@lists.ettus.com; Thu, 19 Mar 2020 19:17:07 -0400
Received: by mail-ot1-f51.google.com with SMTP id a49so4246863otc.11
 for <usrp-users@lists.ettus.com>; Thu, 19 Mar 2020 16:16:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nd.edu; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=E+1kBQzooredLc9tsqwLo2VWpF8Ebl+swPj8tMw6ptQ=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=E+1kBQzooredLc9tsqwLo2VWpF8Ebl+swPj8tMw6ptQ=;
 b=
X-Gm-Message-State: ANhLgQ1D2NOV3IzLpXOEvoixcF8CqbyBxjJBMzd24GiFtao8NfLufdkf
 SoccOIHwD4Hv+UnfsxpfRh0E/Yw29KpHSi3IVikI1Q==
X-Google-Smtp-Source: ADFU+vt1dTDzbk8PlbEl57e37SC9kTrs8c3QUikQLcYiMK675ThaKBTLSJD5KnttrymHiIstky5TiX/iyYuENeAJF2M=
X-Received: by 2002:a05:6830:3090:: with SMTP id
 f16mr4243761ots.211.1584659786499; 
 Thu, 19 Mar 2020 16:16:26 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAB__hTTfEYVEQAZvVLfR1GJHyWfz_uwCTDREX+4vsHWHi1MpOw@mail.gmail.com>
Date: Thu, 19 Mar 2020 19:16:15 -0400
Message-ID: <CAB__hTSojeJRcHo899zVCqXQPA=f+DamUq06TA88xNVWE3SRyg@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============6584787172888418028=="
...
--===============6584787172888418028==
Content-Type: multipart/alternative; boundary="000000000000aa7e2705a13d5b69"

--000000000000aa7e2705a13d5b69
...
> Rx-Tx phase for the first mode where both Tx and Rx start/stop at each te=
st.
> Rob
>
...
>>    test.  Now, I added a mode where the Tx is on continuously, and the R=
x
...
>>    random for Rx-Tx.  The phase results are constant for Rx-Rx but rando=
m for
>>    Rx-Tx.
>>
...
+
>>> & matlab software using X310/UBX-160 with the connections I described. =
 The
...
>>> changed the LO freq in my test.  I will try again with moving the DSP f=
req
>>> instead.
>>> Rob
>>>
...
Then I
>>>>    divide both streams and take the phase part. I take a moving averag=
e (for
...
>>>>    switch_on_click.py" should do. Let me quickly elaborate how it work=
s:
...
>>>>       which is executed when user clicks on button "Switch RTX (togeth=
er)"
>>>>    - Again, thank you for trying this out!! If it works, would you
>>>>    mind sharing this code then? I may be able to check then where it b=
reaks on
>>>>    my system
>>>>    - I use 900 MHz as default center frequency (and "rf_freq"). When
>>>>    clicking, I jump between dsp_freq=3D0 and dsp_freq=3D500e3. As to m=
y waveform,
>>>>    you can infer from my screenshots and code above: I am transmitting=
 and
>>>>    receiving a 1MHz waveform (which acts as an additional "IF stage").=
 The
>>>>    received signal is then downconcerted from 1MHz to DC. I use 5 MSsp=
s
>>>>    sampling rate.
>>>>
>>>>
...
>>>> Tx0/Tx1 are phase coherent.  But, phase from Tx-to-Rx is random.  Plea=
se
...
>>>>    previously, I am not too good at gnuradio/Python, but I might be ab=
le to
>>>>    spot something.
>>>>    - As to your question, I always use synchronous measurements.  And,
>>>>    I'm confident that my Rx-to-Rx phase is coherent.  But, I haven't r=
eally
>>>>    looked at Tx-to-Rx in a while so I will do so later today.  Here ar=
e the
...
>>>>       leakage signal from Tx0 to Rx0 so I don't really need to provide=
 a physical
>>>>       connection in order to get a signal on Rx0.  The signal attenuat=
ion in this
>>>>       leakage path is approx 40 dB so it is not too much different tha=
n the
>>>>       signal level I will receive on Rx1 if I use an external 30 dB at=
tenuator.
...
>>>>> suggested test is always the same! In fact, it is always 4.56 rad, ev=
en
>>>>> across restarts and for different frequencies! That somewhat makes se=
nse
>>>>> because the phase offset is now only dependent on the difference betw=
een
>>>>> the two channels (fixed) and cable lengths from the splitter (fixed).=
 I
>>>>> verified by removing the timed command on usrp source, the phase offs=
et
>>>>> becomes random after each retune. Of course, this is independent of T=
X
...
>>>>>         tune_req_rx.dsp_freq_policy =3D uhd.tune_request.POLICY_MANUA=
L
...
>>>>>         tune_req_tx.dsp_freq_policy =3D uhd.tune_request.POLICY_MANUA=
L
...
>>>>> "RX2" on UBX #2 (TX2 --> RX2). In absence of a second 30dB attenuator=
 I
>>>>> used two antennas closely spaced together. For reference, my code loo=
ks now
>>>>> like:
>>>>>
>>>>>         tune_req_rx =3D uhd.tune_request()
...
>>>>> What does that mean? I think it means that TX must be tuned coherentl=
y
>>>>> and RX must be tuned coherently, i.e., timed commands generally work =
for
...
>>>>> at any point or know somebody who did. It would be so much worth to k=
now if
>>>>> this is something that never worked to begin with or if I'm just doin=
g
...
>>>>> timed commands (to my understanding, even a constant delay would resu=
lt in
>>>>> coherent phase)
>>>>> 2.) While the phase accumulators in RX are set to the same values (an=
d
...
>>>>>    Tx DSP at the same time (rather than below where you are only tuni=
ng one of
>>>>>    them).  So, assuming that this will not produce consistent phase r=
esults,
...
Then,
>>>>>    measure the relative phase Rx0/Rx1 and then tune back and forth be=
tween two
>>>>>    Rx DSP freqs to see if the relative phase on Rx remains constant. =
 If so,
>>>>>    this would give you good confidence that Rx DSP tuning is indeed h=
appening
>>>>>    synchronously
...
connected
>>>>>    to Rx0 and Tx1 connected to Rx1.  At this point we are confident t=
hat Rx
>>>>>    DSP tuning is synchronous so any synchronous misbehavior would imp=
ly a Tx
>>>>>    sync problem.
>>>>>
...
>>>>>> uhd.time_spec(2.0)" and I see the chance 2 seconds after my click on=
 the
...
>>>>>> https://github.com/EttusResearch/fpga/commit/0b2364653405612a6d5dfaa=
0e69b1c6798771e6d]
>>>>>> related to phase.  However, the version you provided with uhd_usrp_p=
robe
>>>>>> confirms that you have the bug fix included.  So, this is not the pr=
oblem.
>>>>>>
...
>>>>>> not change TX RF) and you can see the frequency change at the specif=
ied
>>>>>> command time (i.e., if you specify the command time 1 sec in the fut=
ure,
>>>>>> the change does not occur until 1 sec in the future).
>>>>>> 2) opposite of #1: with Tx tuning fixed, tune Rx DSP only and you ca=
n
>>>>>> see the frequency change at the specified command time.
>>>>>>
>>>>>> I am trying to simplify the issue by removing RF tuning completely
>>>>>> and by tuning only 1 of Rx/Tx at a time.  Perhaps this will help lea=
d to
>>>>>> the answer.
>>>>>> Rob
>>>>>>
...
>>>>>> Yes, I confirm:
>>>>>>
>>>>>> 1.) Finally I get the commands to execute at the same time (TX and R=
X
...
<div dir=3D"ltr"><div>Lukas,</div><div>I installed gnuradio and tried to ru=
n but encounter the following.=C2=A0 I&#39;m guessing this is your block.<b=
r></div><div>Traceback (most recent call last):<br>=C2=A0 File &quot;test.p=
y&quot;, line 25, in &lt;module&gt;<br>=C2=A0 =C2=A0 import epy_block_1<br>=
ImportError: No module named epy_block_1</div><div>Rob<br></div></div><br><=
div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Mar=
 19, 2020 at 6:28 PM Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu">rko=
ssler@nd.edu</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" styl=
e=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);paddin=
g-left:1ex"><div dir=3D"ltr"><div>Ok.=C2=A0 False alarm.=C2=A0 I forgot abo=
ut the dboard clock needing set to 20MHz for RF freq below 1 GHz.=C2=A0 Whe=
n I made this change, now I get consistent Rx-Tx phase for the first mode w=
here both Tx and Rx start/stop at each test.</div><div>Rob<br></div></div><=
br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu,=
 Mar 19, 2020 at 6:10 PM Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu"=
 target=3D"_blank">rkossler@nd.edu</a>&gt; wrote:<br></div><blockquote clas=
s=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid r=
gb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div dir=3D"ltr"><div><s=
pan style=3D"font-family:arial,sans-serif">Ok. I modified my code to be mor=
e like yours...</span></div><div><ul><li><span style=3D"font-family:arial,s=
ans-serif">toggling dsp freq rather than LO freq</span></li><li><span style=
=3D"font-family:arial,sans-serif">LO at 900 MHz</span></li><li><span style=
=3D"font-family:arial,sans-serif">external connections Tx0 =3D&gt; Splitter=
_1x2 =3D&gt; both Rx0 and Rx1</span></li><li><span style=3D"font-family:ari=
al,sans-serif">Previously, I was starting / stopping both Rx &amp; Tx in be=
tween each test.=C2=A0 Now, I added a mode where the Tx is on continuously,=
 and the Rx starts &amp; stops for each test after the dsp freq change</spa=
n></li></ul><div>The results are the following:</div><ul><li>In the first m=
ode where both Tx and Rx start/stop at each test, I get consistent group de=
lay (as measured by the correlation peak index) for both Rx-Rx and Rx-Tx.=
=C2=A0 But for phase, the Rx-Rx phase is consistent, but the Rx-Tx phase se=
ems random</li><li>In the second mode where Tx is on continuously and I sta=
rt/stop Rx after each dsp freq change, the group delay is constant for Rx-R=
x but random for Rx-Tx.=C2=A0 The phase results are constant for Rx-Rx but =
random for Rx-Tx.</li></ul><div>Regarding the 2nd mode, this makes sense to=
 me.=C2=A0 But, for the 1st mode, I don&#39;t understand=C2=A0why the Rx-Tx=
 phase seems random. Still thinking about it....</div><div>Rob<br></div></d=
iv><br></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail=
_attr">On Thu, Mar 19, 2020 at 4:35 PM Rob Kossler &lt;<a href=3D"mailto:rk=
ossler@nd.edu" target=3D"_blank">rkossler@nd.edu</a>&gt; wrote:<br></div><b=
lockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-le=
ft:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Lukas=
,</div><div>Just before receiving your email, I ran the following with my c=
ustom c++ &amp; matlab software using X310/UBX-160 with the connections I d=
escribed.=C2=A0 The following shows the output which is very consistent.=C2=
=A0 I used a 100 tone multi-tone waveform spread over 4 MHz bandwidth (usin=
g 5 MS/s sample rate on Tx and Rx).=C2=A0 Note the consistency of results a=
s I toggled between 2 frequencies: 2450 and 2460 MHz. <br></div><div><br></=
div><div>My method was the following:</div><div><ul><li>Tx waveform was 500=
 points long</li><li>Rx capture was 5000 points long</li><li>Compute cross-=
correlation (using Matlab xcorr) as follows: xcorr(rx0, conj(tx)) AND xcorr=
(rx0,conj(rx1))</li><li>Find the correlation peak (which was very pronounce=
d) which shows the sample delay between the two signals.=C2=A0 Extract the =
phase at the peak</li></ul><div>Oops, I just realized that I used a constan=
t DSP freq (10 MHz) and I changed the LO freq in my test.=C2=A0 I will try =
again with moving the DSP freq instead.<br></div><div>Rob<br></div></div><d=
iv><span style=3D"font-family:monospace"><br></span></div><div><span style=
=3D"font-family:monospace">Test 1: freq =3D 2450.0 MHz<br>=C2=A0 Rx0/Tx0 xc=
orr peak at index 108 with phase -121.8<br>=C2=A0 Rx0/Rx1 xcorr peak at ind=
ex 115 with phase -95.7<br>Test 2: freq =3D 2460.0 MHz<br>=C2=A0 Rx0/Tx0 xc=
orr peak at index 108 with phase -58.7<br>=C2=A0 Rx0/Rx1 xcorr peak at inde=
x 115 with phase 13.1<br>Test 3: freq =3D 2450.0 MHz<br>=C2=A0 Rx0/Tx0 xcor=
r peak at index 108 with phase -121.7<br>=C2=A0 Rx0/Rx1 xcorr peak at index=
 115 with phase -95.8<br>Test 4: freq =3D 2460.0 MHz<br>=C2=A0 Rx0/Tx0 xcor=
r peak at index 108 with phase -58.6<br>=C2=A0 Rx0/Rx1 xcorr peak at index =
115 with phase 13.0<br>Test 5: freq =3D 2450.0 MHz<br>=C2=A0 Rx0/Tx0 xcorr =
peak at index 108 with phase -121.7<br>=C2=A0 Rx0/Rx1 xcorr peak at index 1=
15 with phase -95.8<br>Test 6: freq =3D 2460.0 MHz<br>=C2=A0 Rx0/Tx0 xcorr =
peak at index 108 with phase -58.8<br>=C2=A0 Rx0/Rx1 xcorr peak at index 11=
5 with phase 12.7<br>Test 7: freq =3D 2450.0 MHz<br>=C2=A0 Rx0/Tx0 xcorr pe=
ak at index 108 with phase -121.8<br>=C2=A0 Rx0/Rx1 xcorr peak at index 115=
 with phase -95.9<br>Test 8: freq =3D 2460.0 MHz<br>=C2=A0 Rx0/Tx0 xcorr pe=
ak at index 108 with phase -58.7<br>=C2=A0 Rx0/Rx1 xcorr peak at index 115 =
with phase 12.9<br>Test 9: freq =3D 2450.0 MHz<br>=C2=A0 Rx0/Tx0 xcorr peak=
 at index 108 with phase -121.8<br>=C2=A0 Rx0/Rx1 xcorr peak at index 115 w=
ith phase -95.8<br>Test 10: freq =3D 2460.0 MHz<br>=C2=A0 Rx0/Tx0 xcorr pea=
k at index 108 with phase -58.7<br>=C2=A0 Rx0/Rx1 xcorr peak at index 115 w=
ith phase 12.9<br>&gt;&gt; <br></span></div><div><br></div><br><div class=
=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Mar 19, 2020=
 at 4:21 PM Lukas Haase &lt;<a href=3D"mailto:lukashaase@gmx.at" target=3D"=
_blank">lukashaase@gmx.at</a>&gt; wrote:<br></div><blockquote class=3D"gmai=
l_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,20=
4,204);padding-left:1ex"><div><div style=3D"font-family:Verdana;font-size:1=
2px"><div>Hi Rob,</div>
