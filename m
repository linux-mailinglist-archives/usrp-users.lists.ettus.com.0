...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id C4BBA752B37
	for <lists+usrp-users@lfdr.de>; Thu, 13 Jul 2023 21:53:13 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 1AF84384A97
	for <lists+usrp-users@lfdr.de>; Thu, 13 Jul 2023 15:53:13 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1689277993; bh=NZASYpJK2sDzZg7vDX+L9lRxgodP+WNU9Gm/99m74h8=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qk1-f182.google.com (mail-qk1-f182.google.com [209.85.222.182])
	by mm2.emwd.com (Postfix) with ESMTPS id C82EA383E9E
	for <usrp-users@lists.ettus.com>; Thu, 13 Jul 2023 15:52:29 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="BNoFm3hz";
	dkim-atps=neutral
Received: by mail-qk1-f182.google.com with SMTP id af79cd13be357-765ae938b1bso98634385a.0
        for <usrp-users@lists.ettus.com>; Thu, 13 Jul 2023 12:52:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1689277949; x=1691869949;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=j0w1NSkoGsNRy9WxMm49S+9ofD38voGk1Z67d7uNN5I=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689277949; x=1691869949;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=j0w1NSkoGsNRy9WxMm49S+9ofD38voGk1Z67d7uNN5I=;
        b=
X-Gm-Message-State: ABy/qLa/0xvyB7HnNMJ7emO/EcaWXdc6lTsjd1kUm+kxwEiG9li2oxNh
	Se5n/4bF8mkprjzsI1YyAX0=
X-Google-Smtp-Source: APBJJlFZyUeE+58bZQqJBZGvqEuq0CcuRBLbL+LHmW7OTum0WfbZl4vsDyABEwPc2va5mYQHLB88dg==
X-Received: by 2002:a05:620a:191b:b0:765:a720:5a61 with SMTP id bj27-20020a05620a191b00b00765a7205a61mr2615565qkb.31.1689277948368;
        Thu, 13 Jul 2023 12:52:28 -0700 (PDT)
Received: from [192.168.2.196] ([174.93.2.82])
        by smtp.googlemail.com with ESMTPSA id pj38-20020a05620a1da600b00767d6ec578csm3149947qkn.20.2023.07.13.12.52.27
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 13 Jul 2023 12:52:28 -0700 (PDT)
Message-ID: <294e5d7e-6c5f-d3cb-7932-73a435287057@gmail.com>
Date: Thu, 13 Jul 2023 15:52:19 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAOkUcSv2Z+0csXu-fy5xERwcJ82zL16vsMbtJEUZ3-Z_F+yJHQ@mail.gmail.com>
Message-ID-Hash: W36WFSBGS63S2HLNCDSK5IUWXUAFML6F
X-Message-ID-Hash: W36WFSBGS63S2HLNCDSK5IUWXUAFML6F
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/W36WFSBGS63S2HLNCDSK5IUWXUAFML6F/>
...
Content-Type: multipart/mixed; boundary="===============6316158205415636515=="

This is a multi-part message in MIME format.
--===============6316158205415636515==
Content-Type: multipart/alternative;
 boundary="------------Fqi5j4yDqr9dShmblCt6vW0y"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------Fqi5j4yDqr9dShmblCt6vW0y
...
> Hi Marcus,
>
> We are doing this from the embedded host PC, not from the 10G=20
> connection externally
>
> Thank you
>
I believe that only HG-type images are supported on the built-in X310,=20
in which case the standard IP address for
 =C2=A0=C2=A0 SFP0 on the X310 component would be 192.168.10.2, NOT=20
192.268.40.2.=C2=A0=C2=A0 But if you're running your own
 =C2=A0=C2=A0 images, I can't say how it would be setup.

I don't actually have an 2974, so I'm going by datasheets of the i7 SOM=20
that's on-board, and what I know about the
 =C2=A0 X310.


>
> On Thu, 13 Jul 2023 at 19:17, Marcus D. Leech=20
...
>>     program it.=C2=A0 Normally we use image loader like so:
...
>>
>>
>>     Once enp1s0f0 is up, I still am not able to ping 192.168.40.2,
>>     which probably explains why the image loader has a problem, in
>>     fact so does the usrp probe tool.=C2=A0 =C2=A0Normally all i need =
is to get
...
Content-Type: multipart/related;
 boundary="------------hqilIUWUU4B1069AKNALuQSc"

--------------hqilIUWUU4B1069AKNALuQSc
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 13/07/2023 15:39, cyberphox wrote:<=
br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAOkUcSv2Z+0csXu-fy5xERwcJ82zL16vsMbtJEUZ3-Z_F+yJHQ@mail.gmai=
l.com">
...
TF-8">
    ...
    <br>
    I don't actually have an 2974, so I'm going by datasheets of the i7
              ...
              <blockquote type=3D"cite">
                <div dir=3D"ltr">Hi all,
                  ...
                  <div>I have a USRP where I have a problem accessing
                    ...
                    loader like so:</div>
                  <div><span dir=3D"ltr"><font face=3D"monospace">uhd_ima=
ge_loader
                  ...
                  <div>
                    <p class=3D"MsoNormal" style=3D"margin:0cm"><font
                        face=3D"monospace">sudo ifconfig enp1s0f0
                        192.168.40.1 netmask 255.255.255.0</font></p>
                    <p class=3D"MsoNormal"
                      style=3D"margin:0cm;font-size:11pt;font-family:Cali=
bri,sans-serif"><br>
                    </p>
                    <p class=3D"MsoNormal"
                      style=3D"margin:0cm;font-size:11pt;font-family:Cali=
bri,sans-serif">Once
                      ...
                      usrp probe tool.=C2=A0 =C2=A0Normally all i need is=
 to get
                      enp1s0f0 showing up with IFCONFIG</p>
                    <br>
                  </div>
                  <div><img src=3D"cid:part1.xr0grKm2.Sxiknr0J@gmail.com"
                      alt=3D"image.png" style=3D"width:812px;max-width:10=
0%"
                      class=3D""><br>
                  </div>
                  <div><br>
...
Content-Id: <part1.xr0grKm2.Sxiknr0J@gmail.com>
