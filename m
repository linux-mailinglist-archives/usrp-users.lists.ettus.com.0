...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BA8EB15E1A
	for <lists+usrp-users@lfdr.de>; Wed, 30 Jul 2025 12:26:58 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 739D53867A7
	for <lists+usrp-users@lfdr.de>; Wed, 30 Jul 2025 06:26:57 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1753871217; bh=KFd8j4cLS0E0on232leA6mCxNZK0394itXE0DN5wM2I=;
	h=From:To:Date:References:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from za-smtp-delivery-57.mimecast.co.za (za-smtp-delivery-57.mimecast.co.za [41.74.201.57])
	by mm2.emwd.com (Postfix) with ESMTPS id 0BF3A386612
	for <usrp-users@lists.ettus.com>; Wed, 30 Jul 2025 06:26:04 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (1024-bit key; unprotected) header.d=vastech.co.za header.i=@vastech.co.za header.b="T2wdZPsc";
	dkim-atps=neutral
Received: from mail.vastech.co.za (41.193.248.106 [41.193.248.106]) by
 relay.mimecast.com with ESMTP id za-mta-59-O0M6NI6HMlGXQ_a4KATwjQ-1; Wed,
 30 Jul 2025 12:25:59 +0200
X-MC-Unique: O0M6NI6HMlGXQ_a4KATwjQ-1
X-Mimecast-MFC-AGG-ID: O0M6NI6HMlGXQ_a4KATwjQ_1753871158
dkim-signature: v=1; a=rsa-sha256; d=vastech.co.za; s=dkim;
	...
	bh=wtZ1IP14Cr3F34D8cCu3q83VHzl9KM3r0+gRr+gfgH4=;
	b=T2wdZPscxxY2RzyZKizBpo5N1JIS/wOeXkGllKnTazxg+DbcBL43zIygsAhuV+5TC5932InCCyjBpF9e/mLE9OcAd1gEa5MY8bN39fSDaTMK/iw92cOok0sLIXel7Glr7njnVo41tspZg5rSQL31G1cMo0S6Luq98QLBY8E90vQ=
Received: from EXCHANGE2.vastech.co.za (Unknown [172.30.81.30])
	by mail.vastech.co.za with ESMTPSA
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256)
	; Wed, 30 Jul 2025 12:25:53 +0200
Received: from exchange3.vastech.co.za (172.30.81.31) by
 ...
 15.2.1118.40; Wed, 30 Jul 2025 12:25:53 +0200
Received: from exchange3.vastech.co.za ([172.30.81.31]) by
 exchange3.vastech.co.za ([172.30.81.31]) with mapi id 15.02.1118.040; Wed, 30
 Jul 2025 12:25:46 +0200
...
Thread-Index: AQHb++IkYMk+p2kicke3vxbc7X5L4bRCs8Hg///2/ACAACOsQIAEpzIAgAAlivD//+kdAIABGuHQgAAaqED//+YPAAAEaZ8w///hd4D//61/0IAArRqAgAAC1YD//9iUsIAAO9uA///bltAABVqngP//21/g//6eewD//RbfMA==
Date: Wed, 30 Jul 2025 10:25:46 +0000
Message-ID: <30750dd2ff8e4bdaae69bd295e068fe0@vastech.co.za>
References: <111b29cda9ce4309b4966fcfcc3b7ece@vastech.co.za>
 ...
 <CAFOi1A4-F0zGAfF_C5aBBwTy1UwzE=LcsHy4esHUKU-R1fzaZA@mail.gmail.com>
In-Reply-To: <CAFOi1A4-F0zGAfF_C5aBBwTy1UwzE=LcsHy4esHUKU-R1fzaZA@mail.gmail.com>
...
MIME-Version: 1.0
Message-ID-Hash: CHQSECEPTZGAEBR73NDE5NENFWXUQOT5
X-Message-ID-Hash: CHQSECEPTZGAEBR73NDE5NENFWXUQOT5
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/CHQSECEPTZGAEBR73NDE5NENFWXUQOT5/>
...
Content-Type: multipart/mixed; boundary="===============1441646601794149505=="

--===============1441646601794149505==
Content-Language: en-US
Content-Type: multipart/signed; protocol="application/x-pkcs7-signature";
	micalg=2.16.840.1.101.3.4.2.3;
	boundary="----=_NextPart_000_0314_01DC014D.11DDA440"

------=_NextPart_000_0314_01DC014D.11DDA440
Content-Type: multipart/related;
	boundary="----=_NextPart_001_0315_01DC014D.11DDA440"


------=_NextPart_001_0315_01DC014D.11DDA440
Content-Type: multipart/alternative;
	boundary="----=_NextPart_002_0316_01DC014D.11DDA440"


------=_NextPart_002_0316_01DC014D.11DDA440
Content-Type: text/plain;
	charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

I added the Ettus DDC in-front of the splitter, so its radio->ddc->4 way =
splitter-> 4x my blocks, and it looks like things are working nicely if =
I set the early decimator to 2:1.
...
I haven=E2=80=99t checked sequence numbers, but there are no indications =
of the overflow anymore.
...
and do remote streaming, it won't choke. But if it does, then I'd like =
to know so we can look into it.
...
On Tue, Jul 29, 2025 at 5:27=E2=80=AFPM Kevin Williams =
...
usrp-users@lists.ettus.com <mailto:usrp-users@lists.ettus.com> ; Werner =
Bode <werner.bode@vastech.co.za <mailto:werner.bode@vastech.co.za> >
...
565 =
<https://url.za.m.mimecastprotect.com/s/5lsaCj2MKKfGoWghWf9imjqds?domain=3D=
github.com>=20
...
style=3D'mso-fareast-language:EN-US'>I added the Ettus DDC in-front of =
the splitter, so its radio-&gt;ddc-&gt;4 way splitter-&gt; 4x my blocks, =
and it looks like things are working nicely if I set the early decimator =
to 2:1.<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>So it looks =
like I currently can get 4x 100 MHz UDP streams to my host. =
:)<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>I =
haven=E2=80=99t checked sequence numbers, but there are no indications =
of the overflow anymore.<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>Now for 8, =
albeit slower.<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><b><span lang=3DEN-US>From:</span></b><span =
lang=3DEN-US> Martin Braun &lt;martin.braun@ettus.com&gt; =
<br><b>Sent:</b> Wednesday, 30 July 2025 12:06<br><b>Cc:</b> =
...
class=3DMsoNormal>It's a headscratcher, for sure. *Something* is holding =
up the radio. I'm very sure that if you connect just the radio, or the =
radio+DDC to an SEP and do remote streaming, it won't choke. But if it =
does, then I'd like to know so we can look into =
it.<o:p></o:p></p></div><div><p =
class=3DMsoNormal><o:p>&nbsp;</o:p></p></div><div><p =
class=3DMsoNormal>--M<o:p></o:p></p></div></div><p =
class=3DMsoNormal><o:p>&nbsp;</o:p></p><div><div><p class=3DMsoNormal>On =
Tue, Jul 29, 2025 at 5:27=E2=80=AFPM Kevin Williams &lt;<a =
...
class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>This is the =
issue =E2=80=93 my block processes inputs 1:1 without requiring to give =
back-pressure.<o:p></o:p></p><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>It =
decimates, sure, but that is 1:N.<o:p></o:p></p><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p><p class=3DMsoNormal =
...
full?<o:p></o:p></p><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'><b><span =
lang=3DEN-US>From:</span></b><span lang=3DEN-US> Brian Padalino &lt;<a =
href=3D"mailto:bpadalino@gmail.com" =
target=3D"_blank">bpadalino@gmail.com</a>&gt; <br><b>Sent:</b> Tuesday, =
29 July 2025 17:12<br><b>To:</b> Kevin Williams &lt;<a =
...
29, 2025 at 11:06=E2=80=AFAM Kevin Williams &lt;<a =
href=3D"mailto:kevin.williams@vastech.co.za" =
...
id=3D"m_8253101306612140783m_1590977016333117940Picture_x0020_1" =
src=3D"cid:image001.png@01DC014D.10F20BC0"><o:p></o:p></p><p =
class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p><p class=3DMsoNormal =
...
id=3D"m_8253101306612140783m_1590977016333117940Picture_x0020_2" =
src=3D"cid:image002.png@01DC014D.10F20BC0"><o:p></o:p></p><p =
class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
...
because of the radio RX FSM here:<o:p></o:p></p></div><div><p =
class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p></div><div><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;&nbsp;=
<a =
href=3D"https://url.za.m.mimecastprotect.com/s/5lsaCj2MKKfGoWghWf9imjqds?=
domain=3Dgithub.com" =
target=3D"_blank">https://github.com/EttusResearch/uhd/blob/40403b7c00154=
e4559c47bd6dde924f092992d45/fpga/usrp3/lib/rfnoc/blocks/rfnoc_block_radio=
/radio_rx_core.v#L565</a><o:p></o:p></p></div><div><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p></div><div><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>When an =
error condition occurs, it reports the OVERFLOW then it waits for =
another stream command to start up again.<o:p></o:p></p></div><div><p =
class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>&nbsp;<o:p><=
/o:p></p></div><div><p class=3DMsoNormal =
style=3D'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'>For what =
it's worth, I don't think you should blindly give it TREADY asserted =
when things can't process things downstream. The block should be =
designed such that you know you can consume all the samples in real =
...
Content-ID: <image001.png@01DC014D.10F20BC0>
...
Content-Type: image/png;
	name="image002.png"
Content-Transfer-Encoding: base64
Content-ID: <image002.png@01DC014D.10F20BC0>
...
CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNTA3MzAxMDI1NDNaME8GCSqGSIb3DQEJ
BDFCBEAQUkj4Xemcpf/sigivmGsjmbBlFlDq5EOCEL28OCvLGQKmuaVtkxXLU+YkYFPC/El+XZjf
mKspP0P170ZqRy/aMH0GCSsGAQQBgjcQBDFwMG4waTEmMCQGCSqGSIb3DQEJARYXaXRzdXBwb3J0
...

