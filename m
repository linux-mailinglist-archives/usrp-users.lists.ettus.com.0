...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 16EDC1817D
	for <lists+usrp-users@lfdr.de>; Wed,  8 May 2019 23:09:36 +0200 (CEST)
Received: from [::1] (port=52322 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.91)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1hOToj-0001aX-8F; Wed, 08 May 2019 17:09:33 -0400
Received: from atl4mhob11.registeredsite.com ([209.17.115.49]:34846)
 by mm2.emwd.com with esmtp (Exim 4.91)
 (envelope-from <k5so@k5so.com>) id 1hOToA-0001QA-OI
 for usrp-users@lists.ettus.com; Wed, 08 May 2019 17:09:28 -0400
Received: from mailpod.hostingplatform.com
 (atl4qobmail02pod3.registeredsite.com [10.30.77.68])
 by atl4mhob11.registeredsite.com (8.14.4/8.14.4) with ESMTP id x48L8EFa021216
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL)
 for <usrp-users@lists.ettus.com>; Wed, 8 May 2019 17:08:15 -0400
Received: (qmail 25914 invoked by uid 0); 8 May 2019 21:08:14 -0000
...
Received: from unknown (HELO ?192.168.1.76?) (k5so@k5so.com@192.206.203.10)
 by 0 with ESMTPA; 8 May 2019 21:08:14 -0000
Message-Id: <5F41CEE9-58DF-4868-89C2-5F88876803DF@k5so.com>
Mime-Version: 1.0 (Mac OS X Mail 11.5 \(3445.9.1\))
Date: Wed, 8 May 2019 15:08:12 -0600
In-Reply-To: <19BFE8B3-662A-4DC0-BB72-557E7495F6D0@k5so.com>
...
Content-Type: multipart/mixed; boundary="===============4044114035671607302=="
...
Content-Type: multipart/alternative;
	boundary="Apple-Mail=_248E658B-D4DE-404F-ACE8-1FA94BE7EBD4"


--Apple-Mail=_248E658B-D4DE-404F-ACE8-1FA94BE7EBD4
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain;
	charset=utf-8

I=E2=80=99ve successfully built UHD v3.9.0 but it has the same error as =
3.14.0 did before (=E2=80=9CReceived invalid reply 32 from device=E2=80=9D=
) and uhd_usrp_probe still complains that it is expecting compatibility =
number 11 but is receiving 6.  So I think that means I need an earlier =
version of UHD than 3.9.0. =20
...
> Joe
>=20
>> On May 8, 2019, at 2:31 PM, Nick Foster <bistromath@gmail.com =
...
class=3D"">I=E2=80=99ve successfully built UHD v3.9.0 but it has the =
same error as 3.14.0 did before (=E2=80=9CReceived invalid reply 32 from =
device=E2=80=9D) and uhd_usrp_probe still complains that it is expecting =
compatibility number 11 but is receiving 6. &nbsp;So I think that means =
I need an earlier version of UHD than 3.9.0. &nbsp;<div class=3D""><br =
class=3D""></div><div class=3D"">I will dig into the earliest version in =
the git tag -l, namely 003_007_002_rc1, that would not build without =
errors and try to work out the compiler errors then. &nbsp;Unless =
someone has a better idea to try. &nbsp; Thanks!<div class=3D""><br =
...
8, 2019, at 2:40 PM, Joe Martin via USRP-users &lt;<a =
href=3D"mailto:usrp-users@lists.ettus.com" =
class=3D"">usrp-users@lists.ettus.com</a>&gt; wrote:</div><br =
class=3D"Apple-interchange-newline"><div class=3D""><meta =
http-equiv=3D"Content-Type" content=3D"text/html; charset=3Dutf-8" =
class=3D""><div style=3D"word-wrap: break-word; -webkit-nbsp-mode: =
space; line-break: after-white-space;" class=3D"">Okay, thanks, that=E2=80=
=99s what I thought but that isn=E2=80=99t useful for me until I find a =
UHD version that can communicate with it. &nbsp;I=E2=80=99ve been trying =
to build older UHD versions from 003_007_002_rc1 forward but all so far =
fail to build due to compiler errors. &nbsp;Am up to 003_008_005_rc1 =
now, moving forward until I can successfully build one to try. &nbsp;Are =
there any old pre-built versions I could simply try without having to =
build each one myself?<div class=3D""><br class=3D""></div><div =
class=3D"">Joe<br class=3D""><div class=3D""><br class=3D""><blockquote =
type=3D"cite" class=3D""><div class=3D"">On May 8, 2019, at 2:31 PM, =
Nick Foster &lt;<a href=3D"mailto:bistromath@gmail.com" =
