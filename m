...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 39AE7AA041A
	for <lists+usrp-users@lfdr.de>; Tue, 29 Apr 2025 09:08:39 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id B0B5C383B4C
	for <lists+usrp-users@lfdr.de>; Tue, 29 Apr 2025 03:08:37 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1745910517; bh=V650yckMIMpIIOp8mqagDlQ2BoAyV9DfPpsZU02VxI0=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-il1-f178.google.com (mail-il1-f178.google.com [209.85.166.178])
	by mm2.emwd.com (Postfix) with ESMTPS id CDB3C385B2B
	for <usrp-users@lists.ettus.com>; Tue, 29 Apr 2025 03:07:34 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="FdA2AYUO";
	dkim-atps=neutral
Received: by mail-il1-f178.google.com with SMTP id e9e14a558f8ab-3d46ef71b6cso53178855ab.3
        for <usrp-users@lists.ettus.com>; Tue, 29 Apr 2025 00:07:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1745910454; x=1746515254; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=Wkx4v//MxxooKX4OnV0P+C8SwLFB9/qGIn5jC2xaqHc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1745910454; x=1746515254;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Wkx4v//MxxooKX4OnV0P+C8SwLFB9/qGIn5jC2xaqHc=;
        b=
X-Gm-Message-State: AOJu0Yzz8ZX7+Z2O1F0egoXAvDSV26J67c90cMrLCn4+vEaTBF/GNAyq
	Zvp0B9r9UUhXGxXHxYM+KXNYaB16EdloNgBDnFqAxIcRJ2h+HOzm4d24g9dReuIeGD/hhdbtLFk
	GAAbdHO3X5F/UiMyx5Y2+I+Bvmqc1aBGlCDc=
X-Gm-Gg: ASbGnctPj0/5SUAuPazA1wE0on3aF0+4Vw0Nou9bByuZ/wZL0QduGUpmShTW78qnYc1
	UL2yHd7qHlnx39j4WnT5LEA+vxTngmXlkLKS2yEaAXmCTbCuY5093xEvI2jgRQPQcIn59sth571
	xdGyiyRA8z09894IKLpAol
X-Google-Smtp-Source: AGHT+IGfrD2qerM6Jfx7XsonjTYEKrb7MNLQPI2hB3N67uOQiskjysdxrv0LLi0OCmA7+iJEvkBK+6lkDxzdRwYvCzk=
X-Received: by 2002:a05:6e02:2289:b0:3d9:3a09:415e with SMTP id
 e9e14a558f8ab-3d95d87db74mr21151305ab.19.1745910453850; Tue, 29 Apr 2025
 00:07:33 -0700 (PDT)
MIME-Version: 1.0
...
Date: Tue, 29 Apr 2025 10:07:20 +0300
X-Gm-Features: ATxdqUE2-WLep24hxylZBqKgbsQ2rjJ4hHb2FL6Y-UCFAcRJsfSoHvEqp9qCpVs
Message-ID: <CAAxXO2HpyzPbvztAonqFrmOc6+6GQGgHtf0Ga_BXrN=9V56_0w@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Message-ID-Hash: BL5XIPLMXCRA66OXNU2X63LW77BAM6HR
X-Message-ID-Hash: BL5XIPLMXCRA66OXNU2X63LW77BAM6HR
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/BL5XIPLMXCRA66OXNU2X63LW77BAM6HR/>
...
Content-Type: multipart/mixed; boundary="===============5069863518242460295=="

--===============5069863518242460295==
Content-Type: multipart/alternative; boundary="000000000000695e000633e574c3"

--000000000000695e000633e574c3
...
Debug messages show that maxsampls =3D  1996 with --rx_spb =3D 19960.
Further testing, printing just before the SSE2 code,
either  --rx_spp, or --rx_spb =3D 19960 will change the streamer's
cmd.num_sampls
...
in cmd.num_sampls or in the streamer, maxsps =3D 1969 and that's
...
On Tue, Apr 29, 2025 at 1:04=E2=80=AFAM Nikos Balkanas <nbalkanas@gmail.com=
> wrote:
...
v><div class=3D"gmail_default" style=3D"font-size:small">I stand corrected =
for the benchmark_rate results:</div><div class=3D"gmail_default" style=3D"=
font-size:small"><br></div><div class=3D"gmail_default" style=3D"font-size:=
small">[DEBUG] [RFNOC::MGMT] Finished RX stream setup for EPID=3D2<br>[DEBU=
G] [0/Radio#0] spp value 2032 exceeds MTU of 8000! Coercing to 1996<br>[00:=
00:02.843054239] Testing receive rate 2.000000 Msps on 1 channels<br>[00:00=
:12.845077647] Benchmark complete.</div><div class=3D"gmail_default" style=
=3D"font-size:small"><br></div><div class=3D"gmail_default" style=3D"font-s=
ize:small">Debug messages show that maxsampls =3D=C2=A0 1996 with --rx_spb =
=3D 19960.</div><div class=3D"gmail_default" style=3D"font-size:small">Furt=
her testing, printing just before the SSE2 code,</div><div class=3D"gmail_d=
efault" style=3D"font-size:small">either=C2=A0 --rx_spp, or --rx_spb =3D 19=
960 will change the streamer&#39;s cmd.num_sampls</div><div class=3D"gmail_=
default" style=3D"font-size:small">to 19960 and cause buffer to get convert=
ed by the SSE2 code. Single</div><div class=3D"gmail_default" style=3D"font=
-size:small">USRPs can&#39;t execute the=C2=A0 SSE2 code. No matter what th=
ey use</div><div class=3D"gmail_default" style=3D"font-size:small">in cmd.n=
um_sampls or in the streamer, maxsps =3D 1969 and that&#39;s</div><div clas=
s=3D"gmail_default" style=3D"font-size:small">what reaches the convert func=
tion:(</div><div class=3D"gmail_default" style=3D"font-size:small"><br></di=
v><div class=3D"gmail_default" style=3D"font-size:small">As noted MAXSPS pa=
ckages will cause excessive network fragmentation, and cause</div><div clas=
s=3D"gmail_default" style=3D"font-size:small">more delays in the NIC. As it=
 stands right now it&#39;a a wash in my system.</div><div class=3D"gmail_de=
fault" style=3D"font-size:small">In either case I get exactly the same benc=
hmark results with SSE2 code</div><div class=3D"gmail_default" style=3D"fon=
t-size:small">or without: 2e6 S/s. In your systems it might make a differen=
ce. If there are</div><div class=3D"gmail_default" style=3D"font-size:small=
">further improvements in the SSE2 code (ie embedded asm, instead of macro)=
</div><div class=3D"gmail_default" style=3D"font-size:small">It could make =
more of a difference.</div><div class=3D"gmail_default" style=3D"font-size:=
small"><br></div><div class=3D"gmail_default" style=3D"font-size:small">Sor=
ry about the confusion:(</div></div><br><div class=3D"gmail_quote gmail_quo=
te_container"><div dir=3D"ltr" class=3D"gmail_attr">On Tue, Apr 29, 2025 at=
 1:04=E2=80=AFAM Nikos Balkanas &lt;<a href=3D"mailto:nbalkanas@gmail.com">=
nbalkanas@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quot=
e" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204)=
;padding-left:1ex"><div dir=3D"ltr"><div class=3D"gmail_default" style=3D"f=
ont-size:small">Hi Marcus,</div><div class=3D"gmail_default" style=3D"font-=
size:small"><br></div><div class=3D"gmail_default" style=3D"font-size:small=
">spb(=3Dsamples/buffer)=C2=A0 is not what I hoped for. It is just another =
way to set the=C2=A0</div><div class=3D"gmail_default" style=3D"font-size:s=
mall">stream_cmd.num_samples in=C2=A0 the=C2=A0 streamer. I already use the=
re MAXSMPS.</div><div class=3D"gmail_default" style=3D"font-size:small">Bes=
ides benchmark_rate reports maxsmps 1996 like me:(</div><div class=3D"gmail=
_default" style=3D"font-size:small">That part is only controlled by the MTU=
. Seems it is the same</div><div class=3D"gmail_default" style=3D"font-size=
:small">for everyone, and that we are using the generic chdr_sc16_to_xx</di=
v><div class=3D"gmail_default" style=3D"font-size:small">instead the guts (=
sse2) conversion:( Unless they use the multi_usrp</div><div class=3D"gmail_=
default" style=3D"font-size:small">class and set spp on their own.</div><di=
v class=3D"gmail_default" style=3D"font-size:small">I think that MAXSMPS us=
ed to be 1996, before someone changed it to=C2=A0</div><div class=3D"gmail_=
default" style=3D"font-size:small">19960.</div><div class=3D"gmail_default"=
 style=3D"font-size:small"><br></div><div class=3D"gmail_default" style=3D"=
font-size:small">BR</div><div class=3D"gmail_default" style=3D"font-size:sm=
...
lass=3D"gmail_default" style=3D"font-size:small">Nikos</div></div><br><div =
class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Mon, Apr 28,=
 2025 at 5:22=E2=80=AFPM Nikos Balkanas &lt;<a href=3D"mailto:nbalkanas@gma=
il.com" target=3D"_blank">nbalkanas@gmail.com</a>&gt; wrote:<br></div><bloc=
kquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:=
1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div dir=3D"l=
tr"><div class=3D"gmail_default" style=3D"font-size:small">Thx Marcus for t=
he clarifications,</div></div><br><div class=3D"gmail_quote"><div dir=3D"lt=
r" class=3D"gmail_attr">On Mon, Apr 28, 2025 at 4:37=E2=80=AFPM Marcus D. L=
