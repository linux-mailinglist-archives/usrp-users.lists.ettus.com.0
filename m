...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CA291F8051
	for <lists+usrp-users@lfdr.de>; Sat, 13 Jun 2020 04:19:30 +0200 (CEST)
Received: from [::1] (port=34208 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1jjvlW-0007wU-Up; Fri, 12 Jun 2020 22:19:26 -0400
Received: from mail-qk1-f195.google.com ([209.85.222.195]:39691)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <patchvonbraun@gmail.com>)
 id 1jjvlS-0007r7-PH
 for usrp-users@lists.ettus.com; Fri, 12 Jun 2020 22:19:22 -0400
Received: by mail-qk1-f195.google.com with SMTP id w3so10909157qkb.6
 for <usrp-users@lists.ettus.com>; Fri, 12 Jun 2020 19:19:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=message-id:date:from:user-agent:mime-version:to:subject:references
 :in-reply-to; bh=0d5SXe1fDt6MEdgQzP27+KkKCzpTEWEAyxYBCoTY41g=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:message-id:date:from:user-agent:mime-version:to
 :subject:references:in-reply-to;
 bh=0d5SXe1fDt6MEdgQzP27+KkKCzpTEWEAyxYBCoTY41g=;
 b=
X-Gm-Message-State: AOAM530MFvb8gtXPXMrcHM4Lj4vHLrpyutVObcPRUSsZCEOJO+EH4nDO
 GymN30FCNzLZOy7so5gOwe5jZ+WQmeY=
X-Google-Smtp-Source: ABdhPJwJ63oviicNK5QAerV08OUdlXhRJkKgzC/StyyxiCxlAQx1i10LD7uppE6/GD5PubfbLS4bdA==
X-Received: by 2002:a37:a416:: with SMTP id n22mr5739500qke.49.1592014722019; 
 Fri, 12 Jun 2020 19:18:42 -0700 (PDT)
Received: from [192.168.2.12] (smflon1825w-lp140-01-174-95-14-109.dsl.bell.ca.
 [174.95.14.109])
 by smtp.googlemail.com with ESMTPSA id b26sm6486493qta.84.2020.06.12.19.18.41
 for <usrp-users@lists.ettus.com>
 (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
 Fri, 12 Jun 2020 19:18:41 -0700 (PDT)
Message-ID: <5EE43780.40600@gmail.com>
Date: Fri, 12 Jun 2020 22:18:40 -0400
...
In-Reply-To: <CAH2Hh73FqoMQaCpCmpRbbOaQQefYZ83up6BF9k+qCuTBApKNuQ@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============3174696104754521790=="
...
Content-Type: multipart/alternative;
 boundary="------------040805020301030208050004"

This is a multi-part message in MIME format.
--------------040805020301030208050004
...
>
> On Fri, Jun 12, 2020 at 7:35 PM Robin Coxe <coxe@quanttux.com 
> <mailto:coxe@quanttux.com>> wrote:
>
...
<html>
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    <div class="moz-cite-prefix">On 06/12/2020 10:07 PM, Aaron Smith via
      USRP-users wrote:<br>
    </div>
    <blockquote
cite="mid:CAH2Hh73FqoMQaCpCmpRbbOaQQefYZ83up6BF9k+qCuTBApKNuQ@mail.gmail.com"
      type="cite">
      <div dir="ltr">
        <div dir="ltr">Robin - with your insight I see that other users
          have addressed this on this mailing list. In this thread:
          <div><a moz-do-not-send="true"
href="http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/2018-June/057080.html">http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/2018-June/057080.html</a>
    ...
    reference clock and 1PPS.  Things are much more nuanced than that.<br>
    <br>
...
cite="mid:CAH2Hh73FqoMQaCpCmpRbbOaQQefYZ83up6BF9k+qCuTBApKNuQ@mail.gmail.com"
      ...
      <div class="gmail_quote">
        <div dir="ltr" class="gmail_attr">On Fri, Jun 12, 2020 at 7:35
          PM Robin Coxe &lt;<a moz-do-not-send="true"
            href="mailto:coxe@quanttux.com">coxe@quanttux.com</a>&gt;
          wrote:<br>
        </div>
...
0.8ex;border-left-width:1px;border-left-style:solid;border-left-color:rgb(204,204,204);padding-left:1ex">
          <div dir="ltr">The phase ambiguity is introduced by the
            ...
            integrated transceiver on the B200.   These dividers
          ...
          <br>
          <div class="gmail_quote">
            <div dir="ltr" class="gmail_attr">On Fri, Jun 12, 2020 at
              4:08 PM Aaron Smith via USRP-users &lt;<a
            ...
            <blockquote class="gmail_quote" style="margin:0px 0px 0px
0.8ex;border-left-width:1px;border-left-style:solid;border-left-color:rgb(204,204,204);padding-left:1ex">
              <div dir="auto">All of the devices share a 10 MHz
                reference that is generated from the same source as the
                1 PPS.
                <div dir="auto"><br>
                </div>
                <div dir="auto">When you say it's a phase ambiguity, are
              ...
              <div class="gmail_quote">
                <div dir="ltr" class="gmail_attr">On Fri, Jun 12, 2020,
                  4:05 PM Nick Foster &lt;<a moz-do-not-send="true"
...
0.8ex;border-left-width:1px;border-left-style:solid;border-left-color:rgb(204,204,204);padding-left:1ex">
                  ...
                  <div class="gmail_quote">
                    <div dir="ltr" class="gmail_attr">On Fri, Jun 12,
                      2020 at 2:23 PM Aaron Smith via USRP-users &lt;<a
                        moz-do-not-send="true"
