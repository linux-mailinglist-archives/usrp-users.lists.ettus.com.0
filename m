...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 917A19F9C99
	for <lists+usrp-users@lfdr.de>; Fri, 20 Dec 2024 23:10:20 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id BD829384166
	for <lists+usrp-users@lfdr.de>; Fri, 20 Dec 2024 17:10:18 -0500 (EST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1734732618; bh=fwFwRFvlvABpiYoBgOH4p0RRcA6POUsBDKhx/2KW9dM=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-oo1-f45.google.com (mail-oo1-f45.google.com [209.85.161.45])
	by mm2.emwd.com (Postfix) with ESMTPS id 908A83859EF
	for <usrp-users@lists.ettus.com>; Fri, 20 Dec 2024 17:09:08 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="EdOxCqLY";
	dkim-atps=neutral
Received: by mail-oo1-f45.google.com with SMTP id 006d021491bc7-5f3328fca29so1006585eaf.1
        for <usrp-users@lists.ettus.com>; Fri, 20 Dec 2024 14:09:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1734732548; x=1735337348; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=/29Gk0GdNakD9a/BEZZJACje9S8os24fIIzL9f3ARhs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1734732548; x=1735337348;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=/29Gk0GdNakD9a/BEZZJACje9S8os24fIIzL9f3ARhs=;
        b=
X-Gm-Message-State: AOJu0Yxnd0Z+YCgfAezfhkcTht6wTt9VO7XxutjT/typOd9eyQ4O0UJK
	HBvefyCR+8sarRDDWq24XhsyO8fiLkUoJEPzkAyk2gZog1OBGfzdOsst4j1G5ZiWuhKgNuxY2k7
	o96FDdKmzY6oPSGLk/OttVVHZoerD/8PZ
X-Gm-Gg: ASbGncuGtzvhvddACcc1mkPpwuHkTj/Odjf2ILXPdfJLm4US6jXzsWFJLoUNnojPS6l
	QfZ2A9wKmzpay+QbEHHI/B2UMb0f/exSms+WP+w==
X-Google-Smtp-Source: AGHT+IEXmvNBpL516hZDr0BHdYttaZ5166aiZaUY+gy+8FzIqG8Vk0+dA0cmBO75NhkaKmLCGEEUVngwLN6DOnIMDqo=
X-Received: by 2002:a05:6871:20cb:b0:29e:37bb:c0e0 with SMTP id
 586e51a60fabf-2a7fb141bcdmr2715341fac.23.1734732547200; Fri, 20 Dec 2024
 14:09:07 -0800 (PST)
MIME-Version: 1.0
References: <CAE=q3UPVjJMaehJ=FN7gtNvHgPXBOoXyPqhAfDMkKb1XEg8ErA@mail.gmail.com>
 ...
 <CAE=q3UNd5j=eH6ZdGNTPppF-W90=yOMFYNe5G4+AM1UmsEq+Zw@mail.gmail.com> <CAFOi1A7v32uogWnmKeHoDF=CpYhrDPh5aUrpCBNxmUa55=_2pw@mail.gmail.com>
In-Reply-To: <CAFOi1A7v32uogWnmKeHoDF=CpYhrDPh5aUrpCBNxmUa55=_2pw@mail.gmail.com>
From: David <vitishlsfan21@gmail.com>
Date: Fri, 20 Dec 2024 14:08:56 -0800
Message-ID: <CAE=q3UOM5mFihF4S_M2n3Z30iWCeTYVaWbbCgxet3=hYJFKg6Q@mail.gmail.com>
To: Martin Braun <martin.braun@ettus.com>
Message-ID-Hash: N7IOJQ53FE3APAGOPQRNBH6E5ANMBOLQ
X-Message-ID-Hash: N7IOJQ53FE3APAGOPQRNBH6E5ANMBOLQ
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/N7IOJQ53FE3APAGOPQRNBH6E5ANMBOLQ/>
...
Content-Type: multipart/mixed; boundary="===============0053284723354762175=="

--===============0053284723354762175==
Content-Type: multipart/related; boundary="00000000000041b5a30629bae543"

--00000000000041b5a30629bae543
Content-Type: multipart/alternative; boundary="00000000000041b5a20629bae542"

--00000000000041b5a20629bae542
...
input sample_in_eob,
(* dont_touch=3D"true",mark_debug=3D"true"*) output [31:0] sample_out_tdata=
,
...
On Fri, Dec 20, 2024 at 4:11=E2=80=AFAM Martin Braun <martin.braun@ettus.co=
m> wrote:
...
> --M
>
> On Fri, Dec 20, 2024 at 3:27=E2=80=AFAM David <vitishlsfan21@gmail.com> w=
rote:
>
>> Martin,
>>
...
>> which confirmed that the multi_usrp method producing the expected result=
s,
...
>> shown is the multi_usrp method running with my block, but it has the sam=
e
...
>> that the AXI handshake is one packet with two parallel streams. I will t=
ry
...
>>       ...
>>
>> 4. right now, since I want to issue the streaming command while doing *r=
ecord
...
to
>> my block. It is not trivial for me since I am not a C++ person, so I won=
't
...
>>> that. However, maybe I'm forgetting something that would cause the outp=
uts
>>> of the DDCs to misalign data by a few clock cycles. Which makes me wond=
er:
...
>>> guarantee that the output of the DDC (or any other) block is aligned to=
 the
>>> clock cycle, because we encode the timestamp with the data. Meaning tha=
t
>>> the first, actual sample that arrives at your block on each channel is =
in
>>> fact time-aligned, they just arrive a few clock cycles apart. This is t=
he
...
>>> actually align samples within your block, or you just do some AXI align=
ment
...
>>> set_action_forwarding_policy(forwarding_policy_t::ONE_TO_FAN, "stream_c=
md")
...
>>>> Hello all,
>>>>
>>>> I apologize in advance for data dumping. I have made a 2 input/1 outpu=
t
>>>> RFNoC block that requires repeatable synchronized DDC starts. My curre=
nt
...
>>>> now. All my simulations have convinced me my block is consuming AXI-St=
ream
>>>> data correctly.
>>>>
>>>> *Problem*
...
>>>> application and not my block. My Vivado simulations show my block is a=
ble
...
>>>> command because I was having issues with my block propagating. Issuing=
 to
>>>> the DDCs lets the data flow from 2 inputs to the 1 output, where the o=
utput
...
>>>>    correlation and show that the correlation peaks as expected, and sh=
ow the
>>>>    delay between channels in samples.
>>>>    2. *Vivado Waveform Viewer*: When the ILA cores are collecting DDC
>>>>    channel data, I can see that the base image samples are available o=
n the
...
<div dir=3D"ltr">Martin,<div><br></div><div>I don&#39;t have waveform viewe=
r screenshots yet of the inputs (working on it), but I have run the simulat=
ion with a packet delayed 500 clock cycles on one of my block&#39;s channel=
s. I can see that my block &quot;waits&quot; for the second channel, which =
aligns the axi transaction. This is because my block=C2=A0is an HLS block t=
hat is data driven,=C2=A0and won&#39;t be ready unless it has both inputs. =
I verified the output data from the delayed packet simulation. Because of t=
hese factors, I think it is unlikely my block is deasserting tready=C2=A0in=
 my FPGA images.=C2=A0</div><div><br></div><div>Simulation output with a de=
layed packet on channel 1:</div><div><img src=3D"cid:ii_m4x9nsmt7" alt=3D"d=
elayed_port1_packet.png" width=3D"1266" height=3D"268" style=3D"margin-righ=
t: 0px;"><br><br></div><div><br></div><div>I also know the maximum sample r=
ate we can run with on my block, and have done many tests to ensure that my=
 block=C2=A0is consuming data fast enough so there are no overflows upstrea=
m.</div><div><br></div><div>My understanding of how the RFNoC packets work =
is that the output of the DDC is filling a packet formed in the NoC shell, =
which is then released once the 64 samples are filled. You can see that the=
 DDC0 and DDC1 <b>tready</b> in all my debug screenshots is always asserted=
, even in the non-working cases. Likewise, on my blocks input, tvalid from =
the noc shell is always asserted, while my blocks tready=C2=A0drives the tr=
ansaction.</div><div><br></div><div>Where we are now,=C2=A0is that using th=
e usrp and multi_usrp APIs, my block works as expected. When using RFNoC AP=
I, which sets the rate on the DDC and starts streaming, we get the problem =
behavior. Is it possible that DDC0 and DDC1 are not sampling correctly when=
 I am using RFNoC API to set the rate and start streaming? I have seen a di=
fference before between the APIs, where the multi_usrp was able to set the =
center frequency on the base image, and the RFNoC API kept the center frequ=
ency at 0 MHz. <br></div><div><br></div><div>I don&#39;t understand why the=
 clock distance between the tvalids on DDC0 and DDC1 would change in my pre=
vious images, which only happens on the RFNoC API application. I would expe=
ct a ddc output to be equidistant based on the output sample rate. This is =
where the debugging is in the DDC blocks (uhd/fpga/usrp3/lib/rfnoc/ddc.v):<=
/div><div><br></div><div><div style=3D"color:rgb(204,204,204);background-co=
lor:rgb(31,31,31);font-family:&quot;Droid Sans Mono&quot;,&quot;monospace&q=
uot;,monospace;font-weight:normal;font-size:14px;line-height:19px;white-spa=
ce:pre"><div><span style=3D"color:rgb(106,153,85)">//! RFNoC specific digit=
al down-conversion chain</span></div><br><div><span style=3D"color:rgb(86,1=
56,214)">module</span><span style=3D"color:rgb(204,204,204)"> </span><span =
...
rgb(204,204,204)"> SR_FREQ_ADDR     </span><span style=3D"color:rgb(212,212=
