...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 73D0945DE39
	for <lists+usrp-users@lfdr.de>; Thu, 25 Nov 2021 17:02:36 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id BAD46384476
	for <lists+usrp-users@lfdr.de>; Thu, 25 Nov 2021 11:02:35 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="lGQTbFhQ";
	dkim-atps=neutral
Received: from mail-qv1-f53.google.com (mail-qv1-f53.google.com [209.85.219.53])
	by mm2.emwd.com (Postfix) with ESMTPS id 9AD8D38436F
	for <usrp-users@lists.ettus.com>; Thu, 25 Nov 2021 11:01:32 -0500 (EST)
Received: by mail-qv1-f53.google.com with SMTP id m17so4925667qvx.8
        for <usrp-users@lists.ettus.com>; Thu, 25 Nov 2021 08:01:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=message-id:date:mime-version:user-agent:subject:content-language:to
         :references:from:in-reply-to;
        bh=OIYSeZ1AzIUEHAYemNPEv+p4nFmy/c7VehgIyuSWWwQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OIYSeZ1AzIUEHAYemNPEv+p4nFmy/c7VehgIyuSWWwQ=;
        b=
X-Gm-Message-State: AOAM532+zxR9//jPbP/3NZLJm8LVtBNgx+hZCxxANSRcQ6M0oO9xq0U4
	GjlMK6qG7FJVL6OXB5FZThIk0KUbtsg=
X-Google-Smtp-Source: ABdhPJzk1hW72MfGuOnnesjLhCyF6k3Bia9QY2Wa2069SjFySy4yNEp0g8ojfS4E0YY1Ta9gPPL4zg==
X-Received: by 2002:a05:6214:cc9:: with SMTP id 9mr7159621qvx.86.1637856091799;
        Thu, 25 Nov 2021 08:01:31 -0800 (PST)
Received: from [192.168.2.213] (bras-base-smflon1825w-grc-05-174-88-53-52.dsl.bell.ca. [174.88.53.52])
        by smtp.googlemail.com with ESMTPSA id u18sm1725417qki.69.2021.11.25.08.01.30
        for <usrp-users@lists.ettus.com>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 25 Nov 2021 08:01:31 -0800 (PST)
Message-ID: <0774a790-42f8-98cc-1f68-fee29eea9022@gmail.com>
Date: Thu, 25 Nov 2021 11:01:24 -0500
MIME-Version: 1.0
...
In-Reply-To: <CAJ49BKjeiaLeK9-BqH59KYsA0L3D9w_jPF4ZXbFYVtC0zpfsxQ@mail.gmail.com>
Message-ID-Hash: 3QA24AU7BB67ETRSPQ5EOICP2L3277TX
X-Message-ID-Hash: 3QA24AU7BB67ETRSPQ5EOICP2L3277TX
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/3QA24AU7BB67ETRSPQ5EOICP2L3277TX/>
...
Content-Type: multipart/mixed; boundary="===============0212169841673871111=="

This is a multi-part message in MIME format.
--===============0212169841673871111==
Content-Type: multipart/alternative;
 boundary="------------nTCnD5ZiDXrZfTGD7C4Ki5yU"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------nTCnD5ZiDXrZfTGD7C4Ki5yU
...
> Hi all,
>
> I have a=C2=A010Gb=C2=A0PCIe NIC, Intel X520-DA1, installed on=C2=A0my =
desktop=C2=A0and=20
...
> image.png
>
> Bath mtu of interfaces=C2=A0on N310 and my desktop are set to be 9000.
>
> Many thanks
> Chun-Chih Lin
>
...
You'll not get anywhere close to 10Gig when exchanging packets with the=20
*CPU* on the N310.=C2=A0=C2=A0 You only see the high-bandwidth rates when=
=20
streaming samples--the CPU is NOT
 =C2=A0 involved in that at all.

--------------nTCnD5ZiDXrZfTGD7C4Ki5yU
Content-Type: multipart/related;
 boundary="------------DtdUQcKlVnK7mY2cAEK7PtI0"

--------------DtdUQcKlVnK7mY2cAEK7PtI0
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 2021-11-25 10:54, ChunChih Lin
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAJ49BKjeiaLeK9-BqH59KYsA0L3D9w_jPF4ZXbFYVtC0zpfsxQ@mail.gmai=
l.com">
      ...
      <div dir=3D"ltr">
        <div dir=3D"ltr">
          <div dir=3D"ltr">Hi all,
            ...
            <div>I have a=C2=A010Gb=C2=A0PCIe NIC, Intel X520-DA1, instal=
led on=C2=A0my
              desktop=C2=A0and connected to sfp+1 port with SFP+ DAC cabl=
e.</div>
...
div>
            ...
            <div>The bandwidth is fat from 10Gb. The screenshot below is
              from my desktop.</div>
            <div><img src=3D"cid:part1.z2IBn2FL.O0w0IQYg@gmail.com"
                alt=3D"image.png" class=3D"" width=3D"562" height=3D"285"=
><br>
            </div>
            <div><br>
            </div>
            <div>Bath mtu of interfaces=C2=A0on N310 and my desktop are s=
et
              to be 9000.</div>
            <div><br>
            </div>
...
s.com</a>
    ...
    the *CPU* on the N310.=C2=A0=C2=A0 You only see the high-bandwidth ra=
tes when
...
Content-Id: <part1.z2IBn2FL.O0w0IQYg@gmail.com>
