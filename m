...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 31D49100095
	for <lists+usrp-users@lfdr.de>; Mon, 18 Nov 2019 09:41:33 +0100 (CET)
Received: from [::1] (port=58140 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iWcbA-0004Ai-4q; Mon, 18 Nov 2019 03:41:28 -0500
Received: from mail-qt1-f181.google.com ([209.85.160.181]:44990)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <vapham.inria@gmail.com>)
 id 1iWcb6-00043W-6k
 for usrp-users@lists.ettus.com; Mon, 18 Nov 2019 03:41:24 -0500
Received: by mail-qt1-f181.google.com with SMTP id o11so19297348qtr.11
 for <usrp-users@lists.ettus.com>; Mon, 18 Nov 2019 00:41:04 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=pmEPm/NPp3fHXmiDHLJgfeXG2tBmvT6ehk0NHQtFPVY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=pmEPm/NPp3fHXmiDHLJgfeXG2tBmvT6ehk0NHQtFPVY=;
 b=
X-Gm-Message-State: APjAAAVS04iVf1l6pa3CeIHSDIgi5FOtbewCz/Yvf5kUpWxkF+tkLnnK
 hTPsPS4Fclv/nBrTFfNBPh6ZpTw0EqRqCh7mzoQ=
X-Google-Smtp-Source: APXvYqznjrOEGLUz41ifNtPg3FYd4Oj1406txZAFS51+0liu+ogKvLXUadm/OXcTZAnbv63N9cXp+HY6KxuFuFmqC28=
X-Received: by 2002:aed:3924:: with SMTP id l33mr26470080qte.6.1574066443474; 
 Mon, 18 Nov 2019 00:40:43 -0800 (PST)
MIME-Version: 1.0
References: <CAGLe3RnJAJQ=pf1F0SvDfG3AexdS52KRKrQ6CsouhXvAFxyfNg@mail.gmail.com>
 ...
 <c43a5604-ef63-8502-af37-041684824036@comcast.net>
In-Reply-To: <c43a5604-ef63-8502-af37-041684824036@comcast.net>
Date: Mon, 18 Nov 2019 09:40:32 +0100
Message-ID: <CAGLe3R=FOMDKH8mQQY_y5kqV5=Nk58ydo8SivAR_wOAmftAtQg@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============8620598559142913871=="
...
--===============8620598559142913871==
Content-Type: multipart/related; boundary="00000000000037807605979ae7ec"

--00000000000037807605979ae7ec
Content-Type: multipart/alternative; boundary="00000000000037807305979ae7eb"

--00000000000037807305979ae7eb
...
V=C3=A0o Th 6, 15 thg 11, 2019 va=CC=80o lu=CC=81c 21:46 Ron Economos via U=
SRP-users <
usrp-users@lists.ettus.com> =C4=91=C3=A3 vi=E1=BA=BFt:

> Try reducing the gain in the UHD Sink block. At full output, the waveform
> will be compressed.
>
...
>
> As you said, I change the frequency to 50MHz-6GHz, and I the Oscilloscope
> I got the correct frequency as I want
>
...
>
>
> V=C3=A0o Th 6, 15 thg 11, 2019 va=CC=80o lu=CC=81c 13:30 Malik Saad via U=
SRP-users <
> usrp-users@lists.ettus.com> =C4=91=C3=A3 vi=E1=BA=BFt:
>
>> Dear,
>>
>> You can change the signal waveform (fro signal source) from sine to
>> cosine.
>>
...
>>> MHz signal.
>>>
>>> Be sure to terminate the output of the B200 with 50 ohms. With Gain Typ=
e
>>> =3D Normalized, Gain Value =3D 1 and Amplitude =3D 1 in the Signal Sour=
ce, you'll
...
>>> Dear all,
>>>
>>> I am a newbie in this domain. I want to generate a cosine waveform in
>>> the output of usrp-B200 (TX/RX). So I make it as the following picture
>>> [image: image.png]
>>> But what I got in the oscilloscope is not a cosine/sine waveform. I
>>> don't know where I have a mistake.
>>>
...
<div dir=3D"ltr">Thank Ron,<div><br><div>The problem is the maximum support=
ed frequency of the oscilloscope is 1GHz, while the generated frequency is =
500 MHz to 6 GHz. Then the Oscilloscope can not capture the waveform with a=
 good enough resolution.</div><div><br></div><div>I would like to close thi=
s question and thank you very much for your useful information.</div><div><=
br></div><div>Best</div></div></div><br><div class=3D"gmail_quote"><div dir=
=3D"ltr" class=3D"gmail_attr">V=C3=A0o Th 6, 15 thg 11, 2019 va=CC=80o lu=
=CC=81c 21:46 Ron Economos via USRP-users &lt;<a href=3D"mailto:usrp-users@=
lists.ettus.com">usrp-users@lists.ettus.com</a>&gt; =C4=91=C3=A3 vi=E1=BA=
...
x 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">
 ...
 =20
  <div bgcolor=3D"#FFFFFF">
    ...
    <div>On 11/15/19 07:05, Van-Dung PHAM wrote:<br>
    </div>
    <blockquote type=3D"cite">
     =20
      <div dir=3D"ltr">Dear @Ron,=C2=A0
        <div><br>
        </div>
        ...
        <div>Do you think the sample rate could change the shape of the
          sine waveform? (I set the samp_rate=3D50MHz)</div>
        <div><br>
        </div>
        <div>Best,</div>
        <div><br>
        ...
        <div class=3D"gmail_quote">
          <div dir=3D"ltr" class=3D"gmail_attr">V=C3=A0o Th 6, 15 thg 11, 2=
019
            va=CC=80o lu=CC=81c 13:30 Malik Saad via USRP-users &lt;<a href=
=3D"mailto:usrp-users@lists.ettus.com" target=3D"_blank">usrp-users@lists.e=
ttus.com</a>&gt;
            =C4=91=C3=A3 vi=E1=BA=BFt:<br>
          </div>
...
ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">
            ...
            <br>
            <div class=3D"gmail_quote">
              <div dir=3D"ltr" class=3D"gmail_attr">On Fri, Nov 15, 2019 at
                9:25 PM Ron Economos via USRP-users &lt;<a href=3D"mailto:u=
 ...
 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">
                <div bgcolor=3D"#FFFFFF">
                  ...
                  <p>Be sure to terminate the output of the B200 with 50
                    ohms. With Gain Type =3D Normalized, Gain Value =3D 1
                    and Amplitude =3D 1 in the Signal Source, you&#39;ll be
                  ...
                  <blockquote type=3D"cite">
                    <div dir=3D"ltr">Dear all,
                      ...
                      <div>I am a newbie in this domain. I want to
                        generate a cosine waveform in the output=C2=A0of
                        usrp-B200 (TX/RX). So I make it as the following
                        picture</div>
                      <div>
                        <div><img src=3D"cid:16e7da70f0ccb971f161" alt=3D"i=
mage.png" style=3D"margin-right: 0px;" width=3D"542" height=3D"355"><br>
                        </div>
                      </div>
                      <div>But what I got in the oscilloscope=C2=A0is not a
...
Content-ID: <16e7da70f0ccb971f161>
X-Attachment-Id: 16e7da70f0ccb971f161
