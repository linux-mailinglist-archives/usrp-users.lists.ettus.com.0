...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id B41D144ED20
	for <lists+usrp-users@lfdr.de>; Fri, 12 Nov 2021 20:15:46 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id EC409384B00
	for <lists+usrp-users@lfdr.de>; Fri, 12 Nov 2021 14:15:45 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=nd.edu header.i=@nd.edu header.b="He6wRJu+";
	dkim-atps=neutral
Received: from mail-ed1-f42.google.com (mail-ed1-f42.google.com [209.85.208.42])
	by mm2.emwd.com (Postfix) with ESMTPS id 29206384643
	for <usrp-users@lists.ettus.com>; Fri, 12 Nov 2021 14:15:00 -0500 (EST)
Received: by mail-ed1-f42.google.com with SMTP id f4so41599708edx.12
        for <usrp-users@lists.ettus.com>; Fri, 12 Nov 2021 11:15:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=nd.edu; s=google;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=tYmHXcRRigYrKhR7WBSq0MKobyJn2UDzlDFLDLOyudo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tYmHXcRRigYrKhR7WBSq0MKobyJn2UDzlDFLDLOyudo=;
        b=
X-Gm-Message-State: AOAM532WrOUmWRjoGVaOgwQilDKASBTswIZxD6EkC5lpaRYgdKVYvEnm
	AkTKOsYuBPt6ny5PsE+L44eF/k27I3h2VdaFv29JyQVpvBo=
X-Google-Smtp-Source: ABdhPJyJi3uyOGRhUGcRA2UGK8kQ8C6iUz4f/qDvauQh8Nr9J/wvwXaDwGwphO+m12MFZFReY/3FfwEL099YsvQddMw=
X-Received: by 2002:aa7:dc15:: with SMTP id b21mr24214315edu.237.1636744499674;
 Fri, 12 Nov 2021 11:14:59 -0800 (PST)
MIME-Version: 1.0
References: <CAB__hTT2dcHqDV-OKN9konwjX-5ru1DicuVjU1gsjYPf+CGz1A@mail.gmail.com>
 ...
 <CAB__hTQOESBO+B_=ZxRD2x84qbkWK6HCBewmGSkG7HPFnv1j0w@mail.gmail.com>
In-Reply-To: <CAB__hTQOESBO+B_=ZxRD2x84qbkWK6HCBewmGSkG7HPFnv1j0w@mail.gmail.com>
From: Rob Kossler <rkossler@nd.edu>
Date: Fri, 12 Nov 2021 14:14:48 -0500
Message-ID: <CAB__hTQ7-2wRrXeB_f9hU9DxX+Be+4OpdxsfTqbKCvLmK8pNug@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Message-ID-Hash: AZ5W4XNE7VRANEPUROIJF2IJJQUOYRDF
X-Message-ID-Hash: AZ5W4XNE7VRANEPUROIJF2IJJQUOYRDF
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/AZ5W4XNE7VRANEPUROIJF2IJJQUOYRDF/>
...
Content-Type: multipart/mixed; boundary="===============7735960529357445380=="

--===============7735960529357445380==
Content-Type: multipart/alternative; boundary="0000000000007e3e7a05d09c4662"

--0000000000007e3e7a05d09c4662
...
On Fri, Nov 12, 2021 at 1:55 PM Rob Kossler <rkossler@nd.edu> wrote:
...
<div dir=3D"ltr">Just confirmed that when I reboot following a boot with ne=
twork-acquired time, the next boot (with no network cable) does not keep re=
al-time between boots. It simply starts with the most recent time from the =
last boot.</div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gm=
ail_attr">On Fri, Nov 12, 2021 at 1:55 PM Rob Kossler &lt;<a href=3D"mailto=
:rkossler@nd.edu">rkossler@nd.edu</a>&gt; wrote:<br></div><blockquote class=
=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rg=
b(204,204,204);padding-left:1ex"><div dir=3D"ltr">By the way, I just remove=
d my working SD card from the E310 and inserted it in my host (Ubuntu 20.04=
) SD card reader and issued the &quot;umount&quot; commands.=C2=A0 Nothing =
else.=C2=A0 When I reinserted into the E310, boot issue appears (fsck fails=
 for /data and thus won&#39;t mount and puts me in some maintenance mode).<=
div>Rob</div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D=
"gmail_attr">On Fri, Nov 12, 2021 at 1:49 PM Rob Kossler &lt;<a href=3D"mai=
lto:rkossler@nd.edu" target=3D"_blank">rkossler@nd.edu</a>&gt; wrote:<br></=
div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;bor=
der-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div=
 dir=3D"ltr">On Fri, Nov 12, 2021 at 1:17 PM Marcus D. Leech &lt;<a href=3D=
