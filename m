...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E33760B546
	for <lists+usrp-users@lfdr.de>; Mon, 24 Oct 2022 20:19:30 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id D742E383C3A
	for <lists+usrp-users@lfdr.de>; Mon, 24 Oct 2022 14:19:29 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1666635569; bh=m/ur8WuaMnj6RNHLSz5Li/HKD/bUVxprAqcM2oqCj4s=;
	h=Date:To:References:From:In-Reply-To:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=
Received: from mail-qk1-f177.google.com (mail-qk1-f177.google.com [209.85.222.177])
	by mm2.emwd.com (Postfix) with ESMTPS id 2F0B6383684
	for <usrp-users@lists.ettus.com>; Mon, 24 Oct 2022 14:18:18 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="Z/seWQ3E";
	dkim-atps=neutral
Received: by mail-qk1-f177.google.com with SMTP id a5so6593212qkl.6
        for <usrp-users@lists.ettus.com>; Mon, 24 Oct 2022 11:18:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=in-reply-to:from:references:to:content-language:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=1emebJ2ncwrs2prHR1UM693e3hbYrqTTLluDD8wdxrs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1emebJ2ncwrs2prHR1UM693e3hbYrqTTLluDD8wdxrs=;
        b=
X-Gm-Message-State: ACrzQf3AC5h/9PnQuLOx6gorRPO8+4U/3EZr6GLA0x3Yeu+f3tEkfFyT
	CAgCqCXzoqRaNC3KHHQNyLTZPpRmQVw=
X-Google-Smtp-Source: AMsMyM43dfDw90k+hdR3Y0vjSy+QzrdKTBNb1jZg9MIdYkiUtxWJ6Quo2dIrKUePmb6iiYpd4Mzouw==
X-Received: by 2002:a05:620a:448d:b0:6cf:2a91:9a31 with SMTP id x13-20020a05620a448d00b006cf2a919a31mr24021496qkp.660.1666635497610;
        Mon, 24 Oct 2022 11:18:17 -0700 (PDT)
Received: from [192.168.2.171] (bras-base-smflon1825w-grc-09-174-93-2-222.dsl.bell.ca. [174.93.2.222])
        by smtp.googlemail.com with ESMTPSA id w16-20020a05620a425000b006eeb25369e9sm450089qko.25.2022.10.24.11.18.17
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Mon, 24 Oct 2022 11:18:17 -0700 (PDT)
Message-ID: <83daad56-0ef9-32d0-2760-902138dd9a48@gmail.com>
Date: Mon, 24 Oct 2022 14:18:16 -0400
MIME-Version: 1.0
...
In-Reply-To: <BN0P110MB1015F22E32FF8751559CC6F2B12E9@BN0P110MB1015.NAMP110.PROD.OUTLOOK.COM>
Message-ID-Hash: G64ZX74NX64FDS5IJHSZA6QBG2CKCPQN
X-Message-ID-Hash: G64ZX74NX64FDS5IJHSZA6QBG2CKCPQN
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/G64ZX74NX64FDS5IJHSZA6QBG2CKCPQN/>
...
Content-Type: multipart/mixed; boundary="===============1272881132759441904=="

This is a multi-part message in MIME format.
--===============1272881132759441904==
Content-Type: multipart/alternative;
 boundary="------------M7iisTRrDyyayE6faXFKUYaY"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------M7iisTRrDyyayE6faXFKUYaY
...
>     attempting to set up and test. I have UHD 4.3.0.0-6-g5aa6bc44 on
>     my host PC and downloaded and flashed the most recent sdimg from
>     https://files.ettus.com/binaries/cache/e3xx/ onto the E312, which
>     is UHD 4.3.0.0-0-g1f8fd345. Running uhd_usrp_probe on the E312
>     itself over an SSH connection works as expected, but when I try to
>     run uhd_usrp_probe from the host PC, I get the following error:
>
...
>
>     Error: RuntimeError: MPM minor compat number mismatch. Expected:
>     4.3 Actual: 4.2. Please update the version of MPM on your USRP device.
>
...
>     with MPM 4.2? If so, is there a way to update it? Is there some
>     other reason for the error, and if so, is there a way to correct
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 2022-10-24 14:14, White, Joshua J
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:BN0P110MB1015F22E32FF8751559CC6F2B12E9@BN0P110MB1015.NAMP110.=
PROD.OUTLOOK.COM">
...
tps://files.ettus.com/binaries/cache/e3xx/</a>
            onto the E312, which is UHD 4.3.0.0-0-g1f8fd345. Running
            uhd_usrp_probe on the E312 itself over an SSH connection
            works as expected, but when I try to run uhd_usrp_probe from
            the host PC, I get the following error:<br>
            <br>
...
.<o:p></o:p></p>
          ...
          <p class=3D"MsoNormal">[INFO] [MPM.RPCServer] RPC server ready!=
<o:p></o:p></p>
          ...
          <p class=3D"MsoNormal">Thinking it might be related to the FPGA
            image, I attempted to update it using uhd_image_loader,
            which produced a similar error:<br>
            <br>
            jjwhite@5cd01378zc:~$ uhd_image_loader --args
...
p></p>
          <p class=3D"MsoNormal">[INFO] [MPMD] Claimed device without ful=
l
...
ind_all=3D1<o:p></o:p></p>
          ...
          <p class=3D"MsoNormal">Is there a reason that my host PC thinks
            the E312 has MPM v.4.2 installed instead of 4.3? Does the
            UHD 4.3 image for the E312 come with MPM 4.2? If so, is
            there a way to update it? Is there some other reason for the
            error, and if so, is there a way to correct it? Thank you in
            advance for your time and assistance.<o:p></o:p></p>
          <p class=3D"MsoNormal">=C2=A0<o:p></o:p></p>
