...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 317A610760C
	for <lists+usrp-users@lfdr.de>; Fri, 22 Nov 2019 17:56:23 +0100 (CET)
Received: from [::1] (port=50290 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iYCEG-0000ze-IQ; Fri, 22 Nov 2019 11:56:20 -0500
Received: from mail-lf1-f43.google.com ([209.85.167.43]:37011)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <jlockhartrt@gmail.com>)
 id 1iYCEB-0000qH-PL
 for usrp-users@lists.ettus.com; Fri, 22 Nov 2019 11:56:16 -0500
Received: by mail-lf1-f43.google.com with SMTP id b20so6019516lfp.4
 for <usrp-users@lists.ettus.com>; Fri, 22 Nov 2019 08:55:55 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=A3g3C6FfvIEZjroawtjggLxvzlEdQm1ZQay/YWTtSOQ=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=A3g3C6FfvIEZjroawtjggLxvzlEdQm1ZQay/YWTtSOQ=;
 b=
X-Gm-Message-State: APjAAAW+N5N7oDbniGifs7TetABqC9b3ru5ENScjS7LS+ltzj0mkFmZp
 TPgFRG7S1Myfp58LbOR0aulK0mA2JXddEoYDw5g=
X-Google-Smtp-Source: APXvYqwGXpNrErJwns3v8cgdvp+qEVgZZA0h4aLXR8G1GOs6V0lzFLFRVRINO4sl3IuEPH4wT0SxtB4Dojkya22u2KA=
X-Received: by 2002:a05:6512:71:: with SMTP id
 i17mr12693757lfo.113.1574441734143; 
 Fri, 22 Nov 2019 08:55:34 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CALY+5sKym9oDpbHb48n4DopxMsnxkHKLDsV+zA_XVJ+pPN3jTg@mail.gmail.com>
Date: Fri, 22 Nov 2019 11:55:22 -0500
Message-ID: <CALY+5s+tWaCqkbO5bL_+iwELhXp9j-hmL11mAvsYWXVp05SqSw@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============2422937353704082236=="
...
--===============2422937353704082236==
Content-Type: multipart/alternative; boundary="0000000000004886490597f24817"

--0000000000004886490597f24817
...
> NVM, I got it set. I am teasing through the long console output now. Migh=
t
...
>>> which easy enough it was just a simple export. I then ran uhd_usrp_prob=
e
...
>>> can't find "/mboards/0/xbar/gain_0/args/0/gain/value" and when I look a=
t
>>> the tree, there is no value instantiated by the probe. It only looks li=
ke
...
>>>> UHD_LOG_CONSOLE_LEVEL=3Dtrace or debug and try to make sure the correc=
t xml
...
>>>>>
>>>>> cmake
>>>>> -DCMAKE_TOOLCHAIN_FILE=3D~/rfnoc/src/gnuradio/cmake/Toolchains/oe-sdk=
_cross.cmake
...
>>>>>> Greetings EJ,
>>>>>>
>>>>>> So, from the tutorial, they have you edit the gain.xml file, and thi=
s
...
>>>>>> where it was installed when I did the cross compile. It was not plac=
ed in
>>>>>> the "GRC_BLOCKS_PATH" of "/share/gnuradio/grc/blocks" like the defau=
lt
...
>>>>>> export PYTHONPATH=3D$LOCALPREFIX/lib/python2.7/site-packages:$PYTHON=
PATH
>>>>>> export PKG_CONFIG_PATH=3D$LOCALPREFIX/lib/pkgconfig:$PKG_CONFIG_PATH
>>>>>> export
>>>>>> GRC_BLOCKS_PATH=3D$LOCALPREFIX/share/gnuradio/grc/blocks:$GRC_BLOCKS=
_PATH
>>>>>> export UHD_RFNOC_DIR=3D$LOCALPREFIX/share/uhd/rfnoc/
>>>>>> export UHD_IMAGES_DIR=3D$LOCALPREFIX/share/uhd/images
>>>>>> export
>>>>>> GRC_BLOCKS_PATH=3D$LOCALPREFIX/share/uhd/rfnoc/blocks:$GRC_BLOCKS_PA=
TH
>>>>>>
...
>>>>>> rx_gain=3Doptions.rx_gain, rx_digital_gain=3Doptions.rx_digital_gain=
,
...
>>>>>>   File
>>>>>> "/home/root/newinstall/usr/lib/python2.7/site-packages/tutorial/tuto=
rial_swig.py",
>>>>>> line 315, in set_arg
...
>>>>>> get me this far) from what I believe is your github someone linked m=
e.
...
>>>>>>> Hi Jon,
>>>>>>>
>>>>>>> The rfnoc "nocscript" xml definition can create arguments and attac=
h
>>>>>>> to the device tree like you are trying to set there (it's not compi=
led
...
>>>>>>> has a "gain" field in the "args" list. You'll also want to make sur=
e it
...
>>>>>>> and is found at run time during uhd_usrp_probe and when running you=
r
>>>>>>> application. If it's not in the right place or not attaching to you=
r block
...
>>>>>>>> cross-compile used the -mfloar=3Dhard flag. Not sure what caused t=
he issue
...
>>>>>>>>
>>>>>>>> I modified the GNURadio just a bit so that the output from gain wa=
s
>>>>>>>> placed on a ZMQ push, and the graphics were on the host to graph t=
he signal
...
>>>>>>>> /mboards/0/xbar/gain_0/args/0/gain/value
>>>>>>>>
>>>>>>>> No where else in building GNURadio scripts and .bit files does thi=
s
>>>>>>>> "/mboards" arise, and I have looked through my verilog file for ga=
in
>>>>>>>> (gain.v) and it is correct per the instructions in the linked guid=
e, and I
>>>>>>>> built the python and gnuradio hook exactly as the instructions sta=
ted to.
>>>>>>>>
...
>>>>>>>>> Greetings,
>>>>>>>>>
>>>>>>>>> I am having some issues completing the RFNOC build tutorial on th=
e
>>>>>>>>> Ettus E312. The reference documentation is using an X3xx series r=
adio, and
>>>>>>>>> from the final python script it appears to be running the GNR scr=
ipt
>>>>>>>>> natively on the host. I built the exact script from the KB but wh=
en running
>>>>>>>>> on the radio it fails stating it can't "import tutorial." I reali=
zed all
>>>>>>>>> the files that were installed were placed on the host but not cro=
ss
...
>>>>>>>>>
>>>>>>>>> /home/jon/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi/us=
r/include/gnu/stubs.h:7:11:
...
>>>>>>>>> /home/jon/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi/us=
r/include/gnu/
>>>>>>>>> location but it still doesn't like that. I verified that on my ec=
ho $CC
...
>>>>>>>>> -mfpu=3Dneon
>>>>>>>>> --sysroot=3D/home/jon/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-linu=
x-gnueabi
>>>>>>>>>
...
<div dir=3D"ltr"><div>So here is the trace for the gain block, and it certa=
inly is loading the right XML file it seems. =F0=9F=A4=94</div><div><br></d=
iv><div>[DEBUG] [RFNOC] Reading XML file /home/root/newinstall/usr/share/uh=
d/rfnoc/blocks/gain.xml for NOC ID 0xB7DD64941A952AAC<br>[TRACE] [RFNOC] [R=
FNoC Factory] block_ctrl_base::make()<br>[DEBUG] [RFNOC] Reading XML file /=
home/root/newinstall/usr/share/uhd/rfnoc/blocks/gain.xml for NOC ID 0xB7DD6=
4941A952AAC<br>[TRACE] [RFNOC] [RFNoC Factory] Using controller key &#39;ga=
in&#39; and block name &#39;gain&#39;<br>[DEBUG] [RFNOC] Reading XML file /=
home/root/newinstall/usr/share/uhd/rfnoc/blocks/gain.xml for NOC ID 0xB7DD6=
4941A952AAC<br>[INFO] [0/gain_0] Initializing block control (NOC ID: 0xB7DD=
64941A952AAC)<br>[DEBUG] [0/gain_0] Checking compat number for FPGA compone=
nt `noc_shell&#39;: Expecting 5.1, actual: 5.1.<br>[TRACE] [0/gain_0] Addin=
g port definition at xbar/gain_0/ports/in/0: type =3D &#39;sc16&#39; pkt_si=
ze =3D &#39;0&#39; vlen =3D &#39;0&#39;<br>[TRACE] [0/gain_0] Adding port d=
efinition at xbar/gain_0/ports/out/0: type =3D &#39;sc16&#39; pkt_size =3D =
&#39;0&#39; vlen =3D &#39;0&#39;<br>[DEBUG] [E300] [E300] Setting up dest m=
ap for host ep 112 to be stream 3<br></div><div><br></div><div>However I do=
n&#39;t show it instantiating any of the args. I did vim the file and it ap=
pears correct (output below). <br></div><div><br></div><div>&lt;?xml versio=
n=3D&quot;1.0&quot;?&gt;<br>&lt;!--Default XML file--&gt;<br>&lt;nocblock&g=
t;<br>=C2=A0 &lt;name&gt;gain&lt;/name&gt;<br>=C2=A0 &lt;blockname&gt;gain&=
lt;/blockname&gt;<br>=C2=A0 &lt;ids&gt;<br>=C2=A0 =C2=A0 &lt;id revision=3D=
&quot;0&quot;&gt;B7DD64941A952AAC&lt;/id&gt;<br>=C2=A0 &lt;/ids&gt;<br>=C2=
...
=A0 &lt;type&gt;sc16&lt;/type&gt;<br>=C2=A0 =C2=A0 &lt;/sink&gt;<br>=C2=A0 =
=C2=A0 &lt;source&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;name&gt;out0&lt;/name&gt;=
<br>=C2=A0 =C2=A0 =C2=A0 &lt;type&gt;sc16&lt;/type&gt;<br>=C2=A0 =C2=A0 &lt=
;/source&gt;<br>=C2=A0 &lt;/ports&gt;<br>&lt;/nocblock&gt;</div><div><br></=
div><div><br></div><div>Regards,</div><div>Jon<br></div><div><br></div><div=
><br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"g=
mail_attr">On Fri, Nov 22, 2019 at 10:51 AM Jonathan Lockhart &lt;<a href=
=3D"mailto:jlockhartrt@gmail.com">jlockhartrt@gmail.com</a>&gt; wrote:<br><=
...
9 at 10:20 AM EJ Kreinar &lt;<a href=3D"mailto:ejkreinar@gmail.com" target=
=3D"_blank">ejkreinar@gmail.com</a>&gt; wrote:<br></div><blockquote class=
