...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id AA058A9FCBC
	for <lists+usrp-users@lfdr.de>; Tue, 29 Apr 2025 00:05:43 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 6C4943861B0
	for <lists+usrp-users@lfdr.de>; Mon, 28 Apr 2025 18:05:33 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1745877933; bh=XIFRYyGua/nr5yNaHGeT/prRxXLQqMZmt9J0GE2iG+8=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-il1-f174.google.com (mail-il1-f174.google.com [209.85.166.174])
	by mm2.emwd.com (Postfix) with ESMTPS id 371F7385BC0
	for <usrp-users@lists.ettus.com>; Mon, 28 Apr 2025 18:04:27 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="VC1qCwK6";
	dkim-atps=neutral
Received: by mail-il1-f174.google.com with SMTP id e9e14a558f8ab-3cfce97a3d9so23895485ab.2
        for <usrp-users@lists.ettus.com>; Mon, 28 Apr 2025 15:04:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1745877866; x=1746482666; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=AcdOy8BV9/giLCJpR2jy7myp9vh2J1GTZ2sKWlCXxp4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1745877866; x=1746482666;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=AcdOy8BV9/giLCJpR2jy7myp9vh2J1GTZ2sKWlCXxp4=;
        b=
X-Gm-Message-State: AOJu0YxHi43rtLVxtnZK5ksr05e7vn7aGzHWzstX6tB+hjn9BtxEuVBS
	MG9d+fsKRlUo91MdLy9mh2X5o7mQtccgYZV+4Clis/V0d7lrp6uy0GtLyy9nNQjK2zMu6n9NE5G
	tS1hP5nZEoEmcmx0NPTzy3nj0lrc=
X-Gm-Gg: ASbGncsQUZ38UyKVaoirD+fCHZbsKwkCao3jV2LGEr+IJrTuMJAHRDckWkWba2mIObW
	ymP2c3lM0qyfGjBdaA2TuD1vrksXzrKjZZB7I44I7sTmupfTlUnxwNCXlNiQKoJzBwphTkONQHl
	c7ATE1+qcZ/GrJjK7i399TAMxqcDc=
X-Google-Smtp-Source: AGHT+IFBmtG1/ermN1ojJl5iVUTUs5RqbhIQjaaoC8puC1bx/orABIy61JNHbzuR9StNllQ2rG7AbWCFySxcCglzE/k=
X-Received: by 2002:a92:c26a:0:b0:3d6:d162:be12 with SMTP id
 e9e14a558f8ab-3d942e424bcmr124399125ab.21.1745877866147; Mon, 28 Apr 2025
 15:04:26 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAAxXO2Gf9J1MDYOykt+Bz+RS5_OjOAa1rAsnfs+sPdcWLgWgHg@mail.gmail.com>
From: Nikos Balkanas <nbalkanas@gmail.com>
Date: Tue, 29 Apr 2025 01:04:13 +0300
X-Gm-Features: ATxdqUGwYZBLp89UkUVE0dDULXsl2q5gprjydPSdTssghDo1bVx8nRU3nPZYKxc
Message-ID: <CAAxXO2Eg3rxEJNSufR3tf1juKZC53KGH+2=_OGjpUeKnxwX=tg@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Message-ID-Hash: IFFBDVMNMNKTER6XVPRMG7GNYBLAX5ZX
X-Message-ID-Hash: IFFBDVMNMNKTER6XVPRMG7GNYBLAX5ZX
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/IFFBDVMNMNKTER6XVPRMG7GNYBLAX5ZX/>
...
Content-Type: multipart/mixed; boundary="===============1690125042620861959=="

--===============1690125042620861959==
Content-Type: multipart/alternative; boundary="0000000000000878280633ddde1e"

--0000000000000878280633ddde1e
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

Hi Marcus,

spb(=3Dsamples/buffer)  is not what I hoped for. It is just another way to
set the
...
On Mon, Apr 28, 2025 at 5:22=E2=80=AFPM Nikos Balkanas <nbalkanas@gmail.com=
> wrote:

> Thx Marcus for the clarifications,
>
> On Mon, Apr 28, 2025 at 4:37=E2=80=AFPM Marcus D. Leech <patchvonbraun@gm=
ail.com>
> wrote:
>
...
>>>
>>> Just found and downloaded the sources to uhd 4.6.0 from Ubuntu Launchpa=
d.
...
>>>
>>>
>>> On Mon, Apr 28, 2025 at 5:01=E2=80=AFAM Marcus D. Leech <patchvonbraun@=
gmail.com>
>>> wrote:
>>>
...
>>>>
>>>>
>>>> On Mon, Apr 28, 2025 at 12:37=E2=80=AFAM Nikos Balkanas <nbalkanas@gma=
il.com>
>>>> wrote:
>>>>
>>>>> Hi Marcus,
...
>>>>> This is not a software issue. uhd_rx_streamer_max_num_samps runs righ=
t
...
>>>>> Nikos
>>>>>
>>>>> On Sat, Apr 26, 2025 at 7:02=E2=80=AFAM Nikos Balkanas <nbalkanas@gma=
il.com>
>>>>> wrote:
>>>>>
...
>>>>>>>>> series.
>>>>>>>>> It can only do 1996 S/s, need 19960 (10x more) to work with lates=
t
>>>>>>>>> uhd.
...
iv><div class=3D"gmail_default" style=3D"font-size:small">spb(=3Dsamples/bu=
ffer)=C2=A0 is not what I hoped for. It is just another way to set the=C2=
=A0</div><div class=3D"gmail_default" style=3D"font-size:small">stream_cmd.=
num_samples in=C2=A0 the=C2=A0 streamer. I already use there MAXSMPS.</div>=
<div class=3D"gmail_default" style=3D"font-size:small">Besides benchmark_ra=
te reports maxsmps 1996 like me:(</div><div class=3D"gmail_default" style=
=3D"font-size:small">That part is only controlled by the MTU. Seems it is t=
he same</div><div class=3D"gmail_default" style=3D"font-size:small">for eve=
ryone, and that we are using the generic chdr_sc16_to_xx</div><div class=3D=
"gmail_default" style=3D"font-size:small">instead the guts (sse2) conversio=
n:( Unless they use the multi_usrp</div><div class=3D"gmail_default" style=
=3D"font-size:small">class and set spp on their own.</div><div class=3D"gma=
il_default" style=3D"font-size:small">I think that MAXSMPS used to be 1996,=
 before someone changed it to=C2=A0</div><div class=3D"gmail_default" style=
=3D"font-size:small">19960.</div><div class=3D"gmail_default" style=3D"font=
-size:small"><br></div><div class=3D"gmail_default" style=3D"font-size:smal=
l">BR</div><div class=3D"gmail_default" style=3D"font-size:small">Nikos</di=
...
_quote gmail_quote_container"><div dir=3D"ltr" class=3D"gmail_attr">On Mon,=
 Apr 28, 2025 at 5:22=E2=80=AFPM Nikos Balkanas &lt;<a href=3D"mailto:nbalk=
...
lass=3D"gmail_default" style=3D"font-size:small">Thx Marcus for the clarifi=
cations,</div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=
=3D"gmail_attr">On Mon, Apr 28, 2025 at 4:37=E2=80=AFPM Marcus D. Leech &lt=
