...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id CAADE3512F5
	for <lists+usrp-users@lfdr.de>; Thu,  1 Apr 2021 12:01:41 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id C1458383E8C
	for <lists+usrp-users@lfdr.de>; Thu,  1 Apr 2021 06:01:40 -0400 (EDT)
Received: from postman.dtnt.info (postman.dtnt.info [62.219.91.51])
	by mm2.emwd.com (Postfix) with ESMTP id 701D4383991
	for <usrp-users@lists.ettus.com>; Thu,  1 Apr 2021 06:00:49 -0400 (EDT)
Received: from o.dtnt.email (o.dtnt.email [62.219.91.154])
	by postman.dtnt.info (Postfix) with ESMTPS id 0A0D042FCC
	for <usrp-users@lists.ettus.com>; Thu,  1 Apr 2021 13:00:29 +0300 (IDT)
Received: from o.dtnt.email (o.dtnt.email [127.0.0.1])
	by o.dtnt.email (Postfix) with ESMTP id BD6FF9F9C5
	for <usrp-users@lists.ettus.com>; Thu,  1 Apr 2021 13:00:28 +0300 (IDT)
...
Received: from o.dtnt.email ([127.0.0.1])
	...
	with ESMTP id exaETM_uh9ek for <usrp-users@lists.ettus.com>;
	Thu,  1 Apr 2021 13:00:22 +0300 (IDT)
Received: from mail-ot1-f42.google.com (mail-ot1-f42.google.com [209.85.210.42])
	by o.dtnt.email (Postfix) with ESMTPSA id 6E7879FC07
	for <usrp-users@lists.ettus.com>; Thu,  1 Apr 2021 13:00:21 +0300 (IDT)
Received: by mail-ot1-f42.google.com with SMTP id k14-20020a9d7dce0000b02901b866632f29so1643151otn.1
        for <usrp-users@lists.ettus.com>; Thu, 01 Apr 2021 03:00:20 -0700 (PDT)
X-Gm-Message-State: AOAM530cLZ4velIYyB/S6N6HXmhE2yuD9purJz1OBanCVE5lx0OAilsP
	mNzPOgorckAqLSMmTyYLuTpGa91w0l0B0ptw/y4=
X-Google-Smtp-Source: ABdhPJz5/0kV9OUv85l6Ub2xPgExw9CRO2ixAvvByzK6Y3fymBC6GFkXfB4US0+uMT1C3qKYOAq0cco2UN1gQH2gCM8=
X-Received: by 2002:a9d:4719:: with SMTP id a25mr6575523otf.101.1617271219362;
 Thu, 01 Apr 2021 03:00:19 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <43ACF8A6-727F-4B81-8696-51BA770C9CC3@gmail.com>
From: Ofer Saferman <ofer@navigicom.com>
Date: Thu, 1 Apr 2021 13:00:08 +0300
X-Gmail-Original-Message-ID: <CACDReSz8BcZU8=KDRw3v4y9GqNEDi8C-_YQXHydd3FcFJ7_JWg@mail.gmail.com>
Message-ID: <CACDReSz8BcZU8=KDRw3v4y9GqNEDi8C-_YQXHydd3FcFJ7_JWg@mail.gmail.com>
To: Marcus D Leech <patchvonbraun@gmail.com>
X-DTNT-MailScanner-Information: Please contact the ISP for more information
X-DTNT-MailScanner-ID: 0A0D042FCC.A7A07
X-DTNT-MailScanner: Found to be clean
X-DTNT-MailScanner-From: ofer@navigicom.com
X-Spam-Status: No
Message-ID-Hash: SLUPXHUUNPUOOIHDNGDRPAB2YOIBNBRV
X-Message-ID-Hash: SLUPXHUUNPUOOIHDNGDRPAB2YOIBNBRV
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/SLUPXHUUNPUOOIHDNGDRPAB2YOIBNBRV/>
...
Content-Type: multipart/mixed; boundary="===============2790140854275972429=="

--===============2790140854275972429==
Content-Type: multipart/alternative; boundary="000000000000891ee205bee64cc6"

--000000000000891ee205bee64cc6
...
> set_time_next_pps().
>
> The fact that all your E310s will be running GPSD means they=E2=80=99ll be
> adjusting system time appropriately and they=E2=80=99ll all agree on what=
 time it
...
>> next occurrence (wait=3Dtrue),  but for the others does not wait.  But t=
his
>> doesn't fully explain the behavior you are seeing.  If you do the follow=
ing:
...
>> that there is no additional wait added and also perhaps you should add s=
tep
...
>>> try the other sensors (perhaps there is a "gps_gpgga" sensor?)?  The ti=
me
...
>>>> seconds. I don't understand how the size or complexity of the code aff=
ects
...
>>>> connected enough time to a GPS antenna? and then just access their tim=
e -
...
<div dir=3D"ltr"><div>Hello Marcus,</div><div><br></div><div>I am working o=
n E310 with the latest UHD-3.15 SD card image.</div><div>It seems not to in=
clude ntpd that is required to synchronize system time to GPS time.</div><d=
iv>Any idea how to install it on the E310?</div><div><br></div><div>Regards=
,</div><div>Ofer Saferman<br></div><br><div class=3D"gmail_quote"><div dir=
=3D"ltr" class=3D"gmail_attr">On Wed, Mar 31, 2021 at 11:40 PM Marcus D Lee=
ch &lt;<a href=3D"mailto:patchvonbraun@gmail.com">patchvonbraun@gmail.com</=
a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0p=
x 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><d=
iv dir=3D"auto">Just use gettimeofday() or any of the myriad subtle variant=
s available in boost to get you the Linux system time, and use that in a ca=
ll to set_time_next_pps().=C2=A0<div><br></div><div>The fact that all your =
E310s will be running GPSD means they=E2=80=99ll be adjusting system time a=
ppropriately and they=E2=80=99ll all agree on what time it is, depending on=
 the level of precision you need.=C2=A0<br><br><div dir=3D"ltr">Sent from m=
y iPhone</div><div dir=3D"ltr"><br><blockquote type=3D"cite">On Mar 31, 202=
1, at 3:50 PM, Ofer Saferman &lt;<a href=3D"mailto:ofer@navigicom.com" targ=
et=3D"_blank">ofer@navigicom.com</a>&gt; wrote:<br><br></blockquote></div><=
blockquote type=3D"cite"><div dir=3D"ltr">=EF=BB=BF<div dir=3D"ltr"><div>Th=
ank you Rob. Your suggestions are always helpful. I will look into using gp=
s_gpgga.</div><div>Thank you Marcus. I am already adding one, per other exa=
mples posted here and sync_to_gps example. Can you please comment how I can=
 benefit from the fact that E310 units use gpsd in Linux?</div><div><br></d=
iv><div>Regards,</div><div>Ofer Saferman<br></div><br><div class=3D"gmail_q=
uote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Mar 31, 2021 at 10:13 P=
...
04,204,204);padding-left:1ex"><div dir=3D"auto"><br><br><div dir=3D"ltr">Se=
nt from my iPhone</div><div dir=3D"ltr"><br><blockquote type=3D"cite">On Ma=
r 31, 2021, at 2:22 PM, Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu" =
target=3D"_blank">rkossler@nd.edu</a>&gt; wrote:<br><br></blockquote></div>=
<blockquote type=3D"cite"><div dir=3D"ltr">=EF=BB=BF<div dir=3D"ltr"><div d=
ir=3D"ltr">Hi Ofer,</div><div dir=3D"ltr">Take a look at the Ettus source c=
ode gps_ctrl.cpp.=C2=A0 In particular, look at the get_sentence() usage whi=
ch in the case of &quot;gps_time&quot; waits for the next occurrence (wait=
=3Dtrue), =C2=A0but for the others does not wait.=C2=A0 But this doesn&#39;=
t fully explain the behavior you are seeing.=C2=A0 If you do the following:=
<br>1) wait for PPS time to change<br>2) read the &quot;gps_time&quot; sens=
or<br>3) set_time_next_pps (use the value you just read)<br></div></div></d=
iv></blockquote>Add 1 to the time you just read before calling set_time_nex=
t_pps.=C2=A0<div><br></div><div><br><blockquote type=3D"cite"><div dir=3D"l=
tr"><div dir=3D"ltr"><div dir=3D"ltr">It should still work because the &quo=
t;gps_time&quot; command should just wait until the next PPS.=C2=A0 I guess=
 it depends upon how &quot;synchronized&quot; are the received NMEA string =
with the PPS edge.=C2=A0 Step 1 above waits for the PPS edge, but maybe the=
 NMEA string arrives 0.1 secs before or after that.=C2=A0 I don&#39;t reall=
y know.=C2=A0 Perhaps you need to switch to using &quot;gps_gpgga&quot; suc=
h that there is no additional wait added and also perhaps you should add st=
ep 1B which would be just a fixed delay of perhaps 0.4 secs so that you wil=
l read the NMEA string in between the PPS edges.<br>Rob<br></div><br><div c=
lass=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Mar 31, =
2021 at 1:22 PM Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu" target=
=3D"_blank">rkossler@nd.edu</a>&gt; wrote:<br></div><blockquote class=3D"gm=
ail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,=
204,204);padding-left:1ex"><div dir=3D"ltr"><div>Hi Ofer,</div><div>I don&#=
39;t know why the &quot;gps_time&quot; sensor takes long to read. But, can =
you try the other sensors (perhaps there is a &quot;gps_gpgga&quot; sensor?=
)?=C2=A0 The time is embedded in these as well.=C2=A0=C2=A0</div><div>Rob</=
div><div><br></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D=
"gmail_attr">On Wed, Mar 31, 2021 at 12:21 PM Ofer Saferman &lt;<a href=3D"=
mailto:ofer@navigicom.com" target=3D"_blank">ofer@navigicom.com</a>&gt; wro=
te:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px =
0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"=
ltr"><div dir=3D"ltr">Marcus Hi,</div><div dir=3D"ltr"><br></div><div>If th=
e gps_time &quot;sensor&quot; returns a value only once per second how come=
 I manage to read it sometimes in less than 1 second?</div><div>In my code =
the situation is worse than the simple example below. It usually takes more=
 than 1 sec. to read it and sometimes even 1.7 or 1.8 seconds. I don&#39;t =
understand how the size or complexity of the code affects the time it takes=
 to read gps_time.<br></div><div dir=3D"ltr"><br></div><div>How to treat yo=
ur comment about the use of GPSD and good synchronization as it relates to =
code?</div><div>Should I not change the time source in code and go through =
the whole process of synchronization using gps_time?</div><div>Can I &quot;=
assume&quot; the systems are synced just by the effect they were connected =
enough time to a GPS antenna? and then just access their time - radio_ctrl-=
&gt;get_time_last_pps()?</div><div>How to use this information programmatic=
ally?<br></div><div><br></div><div>Regards,</div><div>Ofer Saferman<br></di=
v><br><div class=3D"gmail_quote"><br><blockquote class=3D"gmail_quote" styl=
e=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);paddin=
g-left:1ex">---------- Forwarded message ----------<br>From:=C2=A0&quot;Mar=
...
>Cc:=C2=A0<br>Bcc:=C2=A0<br>Date:=C2=A0Wed, 31 Mar 2021 09:19:20 -0400<br>S=
ubject:=C2=A0[USRP-users] Re: Intermittent problem with GPS synchronization=
 for multiple E310 units<br>On 03/31/2021 06:49 AM, Ofer Saferman wrote:<br>
&gt; Hello,<br>
&gt;<br>
