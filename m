...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 98F0A6D546E
	for <lists+usrp-users@lfdr.de>; Tue,  4 Apr 2023 00:04:02 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 13512384883
	for <lists+usrp-users@lfdr.de>; Mon,  3 Apr 2023 18:04:01 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1680559441; bh=qCX1sR+HpoqqTM/5KEU9G5YQr7tNEzf/I7ZiFFnvv0E=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qk1-f181.google.com (mail-qk1-f181.google.com [209.85.222.181])
	by mm2.emwd.com (Postfix) with ESMTPS id 7E1D5384871
	for <usrp-users@lists.ettus.com>; Mon,  3 Apr 2023 18:03:19 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=ettus-com.20210112.gappssmtp.com header.i=@ettus-com.20210112.gappssmtp.com header.b="Zzjh3+hE";
	dkim-atps=neutral
Received: by mail-qk1-f181.google.com with SMTP id u4so3008463qkp.11
        for <usrp-users@lists.ettus.com>; Mon, 03 Apr 2023 15:03:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ettus-com.20210112.gappssmtp.com; s=20210112; t=1680559399;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=1wq9yC+CRaXNUYCWtrO70IPGYr+YW7hX4mkLaNGQfkU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1680559399;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=1wq9yC+CRaXNUYCWtrO70IPGYr+YW7hX4mkLaNGQfkU=;
        b=
X-Gm-Message-State: AAQBX9f0/3kpKdiFQN18PTQlPCDR5q9lruwwhWQjAlsJCebE+q+XDCyY
	jKVHUEzqhap7REpyHHursYGW5fpehAj++cMK30g7QA01
X-Google-Smtp-Source: AKy350ZeaTDkHmzH94xa8IEEJAdHaixigB3m5dqzWKRoXQNEM7pX74YV1utooS228VmeNRtXgf32tnUvNya9PsxAcZI=
X-Received: by 2002:a05:620a:28d6:b0:742:4d08:a8bd with SMTP id
 l22-20020a05620a28d600b007424d08a8bdmr244884qkp.4.1680559398486; Mon, 03 Apr
 2023 15:03:18 -0700 (PDT)
MIME-Version: 1.0
References: <CAPY8uVNRaqfjD=+a4wWfFPTAR5JiKfpkiGpru7aN48gVei=e-A@mail.gmail.com>
 ...
 <CAPY8uVOJTuSad75yaKTxihmqjX-heE-a2SbwT4DZS2qo0WoYaA@mail.gmail.com> <CAPY8uVPPhkz7CcF7V9fu=t6UqhCD8NXfH_C4U_iL-u_ydH9N3g@mail.gmail.com>
In-Reply-To: <CAPY8uVPPhkz7CcF7V9fu=t6UqhCD8NXfH_C4U_iL-u_ydH9N3g@mail.gmail.com>
From: Michael West <michael.west@ettus.com>
Date: Mon, 3 Apr 2023 15:03:06 -0700
Message-ID: <CAM4xKrqnf63kqYbZXKiE6oK=6MbEZoHM44RmZ9iNS6aJGvG+jg@mail.gmail.com>
To: Dor Ratz <dorratz12@gmail.com>
Message-ID-Hash: FCEAFNGCJ32QLGATEEWTC3MO7SZVQZZY
X-Message-ID-Hash: FCEAFNGCJ32QLGATEEWTC3MO7SZVQZZY
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/FCEAFNGCJ32QLGATEEWTC3MO7SZVQZZY/>
...
Content-Type: multipart/mixed; boundary="===============6787738812462214699=="

--===============6787738812462214699==
Content-Type: multipart/related; boundary="000000000000f9360505f875b9e5"

--000000000000f9360505f875b9e5
Content-Type: multipart/alternative; boundary="000000000000f9360305f875b9e4"

--000000000000f9360305f875b9e4
...
setting "dboard_clock_rate=3D<rate>" in the device args.  Phase noise will
increase as you reduce that rate.  But I believe the "spurs" you are seeing
when not a multiple of 50 MHz are likely the DC offset image (also known as
LO leakage).  You can try using an LO offset to shift the image out of the
spectrum.  Just do something like:

uhd.tune_request_t(target_freq=3D1003e6,
rf_freq=3D1050e6,rf_freq_policy=3Duhd.tune_request_t.POLICY_MANUAL,args=3D"=
mode_n=3Dinteger"))

Since you are using a 20 Msps sample rate, the rf_freq should be at least
10 MHz away from the target_freq and a multiple of 50 MHz.  (The rf_freq is
the LO frequency.)

Regards,
MIchael

On Mon, Mar 27, 2023 at 5:55=E2=80=AFAM Dor Ratz <dorratz12@gmail.com> wrot=
e:

> Hey Michael,
>
> When the target_freq is not integer multiple of 50MHz,  then we have spur=
s
> in -40dBc in variable offset of 1Mhz/2Mhz/10Mhz/20Mhz.
>
...
> Dor
>
> =D7=91=D7=AA=D7=90=D7=A8=D7=99=D7=9A =D7=99=D7=95=D7=9D =D7=93=D7=B3, 22 =
=D7=91=D7=9E=D7=A8=D7=A5 2023, 3:10 =D7=90=D7=97=D7=94=D7=B4=D7=A6, =D7=9E=
=D7=90=D7=AA Dor Ratz =E2=80=8F<
> dorratz12@gmail.com>:
>
>> Hey Michael,
>>
...
>>
>>
>> =D7=91=D7=AA=D7=90=D7=A8=D7=99=D7=9A =D7=99=D7=95=D7=9D =D7=92=D7=B3, 14=
 =D7=91=D7=9E=D7=A8=D7=A5 2023, 9:32 =D7=9C=D7=A4=D7=A0=D7=94=D7=B4=D7=A6, =
=D7=9E=D7=90=D7=AA Dor Ratz =E2=80=8F<
>> dorratz12@gmail.com>:
>>
>>> Michael ,
>>>
>>> What are the limitations/ disadvantages of integer mode of the PLL as I
>>> set?
>>>
>>> Best
>>> Dor
...
=D7=B3, 14 =D7=91=D7=9E=D7=A8=D7=A5 2023 =D7=91-9:26 =D7=9E=D7=90=D7=AA =E2=
=80=AADor Ratz=E2=80=AC=E2=80=8F <=E2=80=AA
...
>>>>>
>>>>> Will both work? This is as Marcus suggested, If I understand correctl=
y.
>>>>>
>>>>> Thanks
>>>>>
...
>>>>> =E2=80=AADate: =D7=99=D7=95=D7=9D =D7=95=D7=B3, 10 =D7=91=D7=9E=D7=A8=
=D7=A5 2023, 10:01 =D7=90=D7=97=D7=94=D7=B4=D7=A6=E2=80=AC
...
>>>>> Michael
>>>>>
>>>>> On Thu, Mar 9, 2023 at 10:37=E2=80=AFAM Dor Ratz <dorratz12@gmail.com=
> wrote:
>>>>>
>>>>>>
>>>>>>
...
>>>>>> By the way, all the time(even in original fractional mode) the spur
>>>>>> does not exist in specific frequencies such as 1000MHz, 1110MHz,
>>>>>> 1200MHz...I guess that when (dboard_clock/target_frequency =3D integ=
er) then
>>>>>> we are OK.
>>>>>>
>>>>>> If you can share your gnuradio flowgraph / grc + py files  / spectru=
m
...
>>>>> "mode_n=3Dinteger" needs to be part of the tune args and not the devi=
ce
>>>>> args.  Try setting the frequency as Marcus suggested using:
>>>>>
>>>>>
>>>>> my_uhd_block.set_center_frequency(uhd.tune_request(target_freq=3D2.4e=
9,args=3D"mode_n=3Dinteger"))
>>>>>
>>>>>
>>>>>> 2. When you said about breaking coherency between channels - what
>>>>>> channels did you mean? the 2 different TX or Rx channels on 2 differ=
ent
...
>>>>>> changing the R divider value, which will break phase coherency betwe=
en
>>>>>> channels"
>>>>>>
>>>>>>
>>>>> It will break phase coherency between any channels on the same device
>>>>> or across devices.  If you are using a single channel or are using mu=
ltiple
>>>>> channels and do not require phase coherency, you can ignore it.
>>>>>
>>>>>
>>>>>> 3. Do you still recommend putting "dboard_clock_rate=3D20e6" in the
>>>>>> device arguments parameter when transmitting frequencies smaller tha=
n 1GHz
>>>>>> as written here <https://kb.ettus.com/UBX#Phase_Synchronization>?
>>>>>>
>>>>>>
>>>>> That is required to keep phase coherency between channels.  If you ar=
e
>>>>> using a single channel or are using multiple channels and do not
>>>>> require phase coherency, you can ignore it.  The default reference cl=
ock
...
>>>>>>
>>>>>>
>>>>>> *The spur still exists as before with your proposal- does the setup
...
>>>>>> POLICY_AUTO.
>>>>>> dboard_clock_rate =3D didn't touch it so I guess it is default=3D50M=
Hz.
>>>>>>
>>>>>>
>>>>>> [image: image.png]
...
>>>>>>
>>>>>>
>>>>>> *This gnuradio flowgraph moves the signal to the original frequency
>>>>>> of the spur(=3Dfrequency offset of 3-6KHz, that's bad) but eliminate=
 the
...
>>>>>> ---------- Forwarded message ---------
>>>>>> =D7=9E=D7=90=D7=AA: Michael West <michael.west@ettus.com>
>>>>>> =E2=80=AADate: =D7=99=D7=95=D7=9D =D7=92=D7=B3, 7 =D7=91=D7=9E=D7=A8=
=D7=A5 2023 =D7=91-4:22=E2=80=AC
>>>>>> Subject: Re: Spurs in UBX-160 Daughterboard with USRP X310
...
>>>>>> int_n_step tune arg and the dboard_clock_rate device arg.  The int_n=
_step
>>>>>> tune arg will explicitly change the step size by changing the R divi=
der
...
clock
>>>>>> rate, which will keep the R divider set to 1 and support phase coher=
ency
>>>>>> between channels.  Both will change the PFD frequency for the PLL.  =
The UBX
>>>>>> was designed for a PFD frequency of 50 MHz, which is why 50 MHz is t=
he
>>>>>> default reference clock rate and the default R value is 1.  Reducing=
 the
>>>>>> PFD frequency will result in more phase noise.  My recommendation is=
 to set
>>>>>> the 'mode_n=3Dinteger' in the tune args, let the DSP tuning take car=
e of the
>>>>>> offset by leaving the DSP tuning policy to the default (POLICY_AUTO)=
, and
>>>>>> use the highest dboard_clock_rate possible (up to 50 MHz).  The high=
est
>>>>>> 'dboard_clock_rate' can be achieved based on the required bandwidth =
of the
...
>>>>>>>
>>>>>>>
>>>>>>>    - Motherboard clock =3D MCR  =3Dmaster_clock_rate  =3D main cloc=
k rate
>>>>>>>    =3D default value is 200MHz. The 10MHz REFCLK is used to set it.
>>>>>>>    - Daughterboard Clock Rate in Hz =3D dboard_clock_rate =3D defau=
lt
>>>>>>>    value is 50MHz, need to change it to 20MHz for center frequencie=
s under
...
>>>>>>>    <http://www.radio-science.net/2017/12/adventures-in-usrp-tuning.=
html>,
>>>>>>>    if I set "mode_n=3Dinteger","int_n_step=3D100e3", in Device Addr=
ess parameter
>>>>>>>    in USRP Sink block, then the frequency resolution on the PLL is:
>>>>>>>    frequency resolution [Hz] =3D int_n_step [Hz] =3D dboard_clock_r=
ate
>>>>>>>    [Hz] / (R divider  [-])
>>>>>>>
>>>>>>>    For example:
...
>>>>>>>> frequency resolution -> it feeds my PLL in the UBX-160 daughterboa=
rd in the
>>>>>>>> X310 USRP.
>>>>>>>>
>>>>>>>> The REFCLCK input to the X310 is used to control the
>>>>>>>> master-clock(s) on the motherboard, which, in turn produce clocks =
for
...
>>>>>>>> parameter of the UHD: USRP Sink block in GNURadio to set PLL in in=
teger-N
...
00 ->
>>>>>>>> the frequency resolution is 10MHz/1000 =3D 0.01MHz=3D 10KHz, corre=
ct?
>>>>>>>>
...
?
>>>>>>>>>
>>>>>>>>> I've looked in ANALOG max2871 PLL datasheet - not sure I found th=
e
>>>>>>>>> answer there.
>>>>>>>>>
...
>>>>>>>>>
>>>>>>>>> =E2=80=AB=D7=91=D7=AA=D7=90=D7=A8=D7=99=D7=9A =D7=99=D7=95=D7=9D =
=D7=93=D7=B3, 1 =D7=91=D7=9E=D7=A8=D7=A5 2023 =D7=91-21:10 =D7=9E=D7=90=D7=
=AA =E2=80=AAMarcus D. Leech=E2=80=AC=E2=80=8F <=E2=80=AA
>>>>>>>>> patchvonbraun@gmail.com=E2=80=AC=E2=80=8F>:=E2=80=AC
>>>>>>>>>
...
>>>>>>>>>>
>>>>>>>>>>
>>>>>>>>>> https://lists.gnu.org/archive/html/discuss-gnuradio/2011-09/msg0=
0309.html
>>>>>>>>>>
>>>>>>>>>>
>>>>>>>>>> In the USRP Sinc block, in center frequency parameter, I've put
>>>>>>>>>> this:
>>>>>>>>>>
...
>>>>>>>>>>
>>>>>>>>>>
>>>>>>>>>> With this, the transmitted 1003MHz signal is cleaner and the spu=
r
>>>>>>>>>> is now further away at 16KHz offset with amplitude of 60dBc belo=
w the
>>>>>>>>>> signal.
>>>>>>>>>>
...
>>>>>>>>>>   on here who can authoritatively comment, but this is a bit of =
a
>>>>>>>>>> surprise.
>>>>>>>>>>
>>>>>>>>>>
...
>>>>>>>>>>
>>>>>>>>>> =E2=80=AB=D7=91=D7=AA=D7=90=D7=A8=D7=99=D7=9A =D7=99=D7=95=D7=9D=
 =D7=91=D7=B3, 27 =D7=91=D7=A4=D7=91=D7=A8=D7=B3 2023 =D7=91-15:08 =D7=9E=
=D7=90=D7=AA =E2=80=AADor Ratz=E2=80=AC=E2=80=8F <=E2=80=AA
>>>>>>>>>> dorratz12@gmail.com=E2=80=AC=E2=80=8F>:=E2=80=AC
>>>>>>>>>>
>>>>>>>>>>> Hi Marcus,
>>>>>>>>>>>
>>>>>>>>>>> Can I pass the desired center frequency with a PMT message?
>>>>>>>>>>> I want to dynamically change the transmitted center frequency o=
f
>>>>>>>>>>> UHD: USRP Sink block.
>>>>>>>>>>>
...
>>>>>>>>>>>> Hi Dor,
>>>>>>>>>>>>
>>>>>>>>>>>> >  1. How to change the to integer_n tuning? Should I just typ=
e
...
>>>>>>>>>>>>
>>>>>>>>>>>> Note that you're probably best off using tune_request_t anyway=
,
>>>>>>>>>>>> as it allows you to tune
...
>>>>>>>>>>>>
>>>>>>>>>>>> >  2. How to know for sure what the mode(integer of fractional=
)
>>>>>>>>>>>> of the NCO is? Can I print
...
>>>>>>>>>>>>
>>>>>>>>>>>> [1]
>>>>>>>>>>>> https://files.ettus.com/manual/page_general.html#general_tunin=
g
>>>>>>>>>>>>
>>>>>>>>>>>
>>>>>>>>>>
...
<div dir=3D"ltr">Hi Dor,<div><br></div><div>I am glad to hear you had some =
success.=C2=A0 The integer-N step size is the dboard_clock_rate, which defa=
ults to 50 MHz.=C2=A0 You can change that by setting &quot;dboard_clock_rat=
e=3D&lt;rate&gt;&quot; in the device args.=C2=A0 Phase noise will increase =
as you reduce that rate.=C2=A0 But I believe the &quot;spurs&quot; you are =
seeing when not a multiple of 50 MHz are likely the DC offset image (also k=
nown as LO leakage).=C2=A0 You can try using an LO offset to shift the imag=
e out of the spectrum.=C2=A0 Just do something like:</div><div><br></div><d=
iv><span style=3D"font-size:12.8px">uhd.tune_request_t(</span><span style=
=3D"font-size:12.8px">target_freq=3D1003e6,</span><span style=3D"font-size:=
12.8px">rf_freq=3D1050e6,rf_freq_policy=3Duhd.tune_request_t.POLICY_MANUAL,=
args=3D&quot;mode_n=3Dinteger&quot;))</span><br></div><div><span style=3D"f=
ont-size:12.8px"><br></span></div><div><span style=3D"font-size:12.8px">Sin=
ce you are using a 20 Msps sample rate, the rf_freq should be at least 10 M=
Hz away from the target_freq and a multiple of 50 MHz.=C2=A0 (The rf_freq i=
s the LO frequency.)</span></div><div><br></div><div>Regards,</div><div>MIc=
hael</div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gm=
ail_attr">On Mon, Mar 27, 2023 at 5:55=E2=80=AFAM Dor Ratz &lt;<a href=3D"m=
ailto:dorratz12@gmail.com">dorratz12@gmail.com</a>&gt; wrote:<br></div><blo=
ckquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left=
:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"auto">Hey Michael=
,<div dir=3D"auto"><br></div><div dir=3D"auto">When the target_freq is not =
integer multiple of 50MHz,=C2=A0 then we have spurs in -40dBc in variable o=
ffset of 1Mhz/2Mhz/10Mhz/20Mhz.</div><div dir=3D"auto"><br></div><div dir=
=3D"auto">What you recommend to do?</div><div dir=3D"auto"><br></div><div d=
ir=3D"auto">Thanks</div><div dir=3D"auto">Dor=C2=A0</div></div><br><div cla=
ss=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">=D7=91=D7=AA=D7=90=
=D7=A8=D7=99=D7=9A =D7=99=D7=95=D7=9D =D7=93=D7=B3, 22 =D7=91=D7=9E=D7=A8=
=D7=A5 2023, 3:10 =D7=90=D7=97=D7=94=D7=B4=D7=A6, =D7=9E=D7=90=D7=AA Dor Ra=
tz =E2=80=8F&lt;<a href=3D"mailto:dorratz12@gmail.com" target=3D"_blank">do=
rratz12@gmail.com</a>&gt;:<br></div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div dir=3D"auto"><div>Hey Michael,=C2=A0</div><div dir=3D"auto"=
><br></div><div dir=3D"auto">Not sure if you got my question.</div><div dir=
=3D"auto"><br></div><div dir=3D"auto">I&#39;m trying to understand what are=
 the limitations/ disadvantages of integer mode of the PLL as I set.</div><=
div dir=3D"auto"><br></div><div dir=3D"auto">Thanks</div><div dir=3D"auto">=
<br></div><div dir=3D"auto">Dor=C2=A0<br><div dir=3D"auto"><br></div><div d=
ir=3D"auto"><br></div><br><br><div class=3D"gmail_quote" dir=3D"auto"><div =
dir=3D"ltr" class=3D"gmail_attr">=D7=91=D7=AA=D7=90=D7=A8=D7=99=D7=9A =D7=
=99=D7=95=D7=9D =D7=92=D7=B3, 14 =D7=91=D7=9E=D7=A8=D7=A5 2023, 9:32 =D7=9C=
=D7=A4=D7=A0=D7=94=D7=B4=D7=A6, =D7=9E=D7=90=D7=AA Dor Ratz =E2=80=8F&lt;<a=
 href=3D"mailto:dorratz12@gmail.com" rel=3D"noreferrer" target=3D"_blank">d=
orratz12@gmail.com</a>&gt;:<br></div><blockquote class=3D"gmail_quote" styl=
e=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);paddin=
g-left:1ex"><div dir=3D"rtl"><div dir=3D"ltr">Michael ,</div><div dir=3D"lt=
r"><br></div><div dir=3D"ltr">What are the limitations/ disadvantages of in=
teger mode of the PLL as I set?</div><div dir=3D"ltr"><br></div><div dir=3D=
"ltr">Best</div><div dir=3D"ltr">Dor</div></div><br><div class=3D"gmail_quo=
te"><div dir=3D"rtl" class=3D"gmail_attr">=E2=80=AB=D7=91=D7=AA=D7=90=D7=A8=
=D7=99=D7=9A =D7=99=D7=95=D7=9D =D7=92=D7=B3, 14 =D7=91=D7=9E=D7=A8=D7=A5 2=
023 =D7=91-9:26 =D7=9E=D7=90=D7=AA =E2=80=AADor Ratz=E2=80=AC=E2=80=8F &lt;=
...
rtl"><div dir=3D"rtl"><div dir=3D"ltr">Hey,=C2=A0</div><div dir=3D"ltr"><br=
></div><div dir=3D"ltr">I&#39;ve done it and the spur is gone, while the fr=
equency=C2=A0is still accurate as the fractional mode.</div><div dir=3D"ltr=
"><br></div><div dir=3D"ltr">This is the flowgraph:</div><div dir=3D"ltr"><=
br></div><div dir=3D"ltr">In center frequency I&#39;ve written=C2=A0that:</=
div><div dir=3D"ltr">=C2=A0uhd.tune_request(target_freq, args=3D&quot;mode_=
n=3Dinteger&quot;)<br></div><div dir=3D"ltr"><br></div><div dir=3D"ltr"><im=
g src=3D"cid:ii_lf7xhe3c0" alt=3D"image.png" width=3D"562" height=3D"507"><=
br></div><div dir=3D"ltr"><br></div><div dir=3D"ltr"><img src=3D"cid:ii_lf7=
xi17g2" alt=3D"image.png" width=3D"562" height=3D"493"><br></div><div dir=
=3D"ltr"><br></div><div dir=3D"ltr"><br></div><div dir=3D"ltr">This is the =
flowgraph:</div><div dir=3D"ltr"><img src=3D"cid:ii_lf7xitvl3" alt=3D"image=
.png" width=3D"562" height=3D"330"><br></div><div dir=3D"ltr">Thanks a lot<=
/div><div dir=3D"ltr"><br></div><div dir=3D"ltr">Dor</div></div><br><div cl=
ass=3D"gmail_quote"><div dir=3D"rtl" class=3D"gmail_attr">=E2=80=AB=D7=91=
=D7=AA=D7=90=D7=A8=D7=99=D7=9A =D7=99=D7=95=D7=9D =D7=90=D7=B3, 12 =D7=91=
=D7=9E=D7=A8=D7=A5 2023 =D7=91-23:24 =D7=9E=D7=90=D7=AA =E2=80=AADor Ratz=
=E2=80=AC=E2=80=8F &lt;=E2=80=AA<a href=3D"mailto:dorratz12@gmail.com" rel=
=3D"noreferrer noreferrer" target=3D"_blank">dorratz12@gmail.com</a>=E2=80=
=AC=E2=80=8F&gt;:=E2=80=AC<br></div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div dir=3D"auto"><div>Hey Michael,<div dir=3D"auto"><br></div><=
div dir=3D"auto">Thanks a lot.</div><div dir=3D"auto"><br></div><div dir=3D=
"auto">1.Can I just type in UHD USRP Sink block in RF options in center fre=
quency this line?</div><div dir=3D"auto"><br></div><div dir=3D"auto"><br></=
div><span style=3D"font-size:12.8px">uhd.tune_request_t(</span><span style=
=3D"font-size:12.8px">target_freq =3D1003e6,</span><span style=3D"font-size=
:12.8px">=C2=A0args=3D&quot;mode_n=3Dinteger&quot;))</span></div><div dir=
=3D"auto"><span style=3D"font-size:12.8px"><br></span></div><div dir=3D"aut=
o"><span style=3D"font-size:12.8px">2. Or with older Gnuradio versions (tun=
e request without t):</span></div><div dir=3D"auto"><span style=3D"font-siz=
e:12.8px"><br></span></div><div dir=3D"auto"><span style=3D"font-size:12.8p=
x">uhd.tune_request(target_freq =3D1003e6, args=3D&quot;mode_n=3Dinteger&qu=
ot;))</span></div><div dir=3D"auto"><span style=3D"font-size:12.8px"><br></=
span></div><div dir=3D"auto"><span style=3D"font-size:12.8px"><br></span></=
div><div dir=3D"auto"><span style=3D"font-size:12.8px">In order to transmit=
 1003MHz in integer mode with dsp tuning.</span></div><div dir=3D"auto"><sp=
an style=3D"font-size:12.8px"><br></span></div><div dir=3D"auto"><span styl=
e=3D"font-size:12.8px">Will both work? This is as Marcus suggested, If I un=
derstand correctly.</span></div><div dir=3D"auto"><span style=3D"font-size:=
12.8px"><br></span></div><div dir=3D"auto"><span style=3D"font-size:12.8px"=
>Thanks</span></div><div dir=3D"auto"><span style=3D"font-size:12.8px"><br>=
</span></div><div dir=3D"auto"><span style=3D"font-size:12.8px">Dor=C2=A0<b=
r></span><br><div class=3D"gmail_quote" dir=3D"auto"><div dir=3D"ltr" class=
...
eferrer noreferrer noreferrer" target=3D"_blank">michael.west@ettus.com</a>=
&gt;</span><br>=E2=80=AADate: =D7=99=D7=95=D7=9D =D7=95=D7=B3, 10 =D7=91=D7=
=9E=D7=A8=D7=A5 2023, 10:01 =D7=90=D7=97=D7=94=D7=B4=D7=A6=E2=80=AC<br>Subj=
ect: Re: Spurs in UBX-160 Daughterboard with USRP X310<br>To: Dor Ratz &lt;=
<a href=3D"mailto:dorratz12@gmail.com" rel=3D"noreferrer noreferrer norefer=
rer" target=3D"_blank">dorratz12@gmail.com</a>&gt;<br>Cc: Ettus Research Te=
chnical Support &lt;<a href=3D"mailto:support@ettus.com" rel=3D"noreferrer =
noreferrer noreferrer" target=3D"_blank">support@ettus.com</a>&gt;,  &lt;<a=
 href=3D"mailto:usrp-users@lists.ettus.com" rel=3D"noreferrer noreferrer no=
referrer" target=3D"_blank">usrp-users@lists.ettus.com</a>&gt;<br></div><br=
><br><div dir=3D"ltr"><div>Hi Dor,</div><div><br></div><div>Answers inline.=
..</div><div><br></div><div>Regards,</div><div>Michael</div><br><div class=
=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Mar 9, 2023 =
at 10:37=E2=80=AFAM Dor Ratz &lt;<a href=3D"mailto:dorratz12@gmail.com" rel=
=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank">dorratz1=
...
_Synchronization" rel=3D"noreferrer noreferrer noreferrer noreferrer" targe=
t=3D"_blank">here</a>?</div><div dir=3D"ltr"><br></div></div></blockquote><=
div><br></div><div>That is required to keep phase coherency=C2=A0between ch=
annels.=C2=A0 If you are using a single channel or are using multiple chann=
els and do not require=C2=A0phase coherency, you can ignore it.=C2=A0 The d=
efault reference clock rate of 50 MHz provides best phase noise performance=
.</div><div>=C2=A0</div><blockquote class=3D"gmail_quote" style=3D"margin:0=
px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><=
div dir=3D"rtl"><div dir=3D"ltr"></div><div dir=3D"ltr"><br></div><div dir=
=3D"ltr"><br></div><div dir=3D"ltr"><u>The spur still exists as before with=
 your proposal- does the=C2=A0setup match your recommendation or should I c=
hange something??</u></div><div dir=3D"ltr"><br></div><div dir=3D"ltr">Plea=
se see gnuradio=C2=A0flowgraph:</div><div dir=3D"ltr"><u><br></u></div><div=
 dir=3D"ltr">&#39;&#39;mode_n=3Dinteger&#39;&#39; in Device Address and Dev=
ice Arguments<u><br></u></div><div dir=3D"ltr">center freq =3D 1003e6 [Hz]<=
/div><div dir=3D"ltr"><br></div><div dir=3D"ltr">DSP tuning policy=C2=A0- d=
idn&#39;t touch it so I guess it is default =3D POLICY_AUTO.<br></div><div =
dir=3D"ltr">dboard_clock_rate =3D didn&#39;t touch it so I guess it is defa=
ult=3D50MHz.<br></div><div dir=3D"ltr"><u><br></u></div><div dir=3D"ltr"><b=
r></div><div dir=3D"ltr"><img src=3D"https://mail.google.com/mail/?ui=3D2&a=
mp;ik=3D7adc42cfb3&amp;attid=3D0.1&amp;th=3D186d7b012caf9a2e&amp;view=3Dfim=
g&amp;fur=3Dip&amp;rm=3D186d7b012caf9a2e&amp;sz=3Dw1600-h1000&amp;attbid=3D=
ANGjdJ8fQWzWuAdCq5UXMOUTGFsPOfBoUvA7cqJC5Vg1Y5zgsUpPdFZL--_e0bFfd9jDKnuRIsr=
9ksBtZBnM4kSn5gZEb12S9yUi19rnFIHl7cJC6Igbx0x2HleEidI&amp;disp=3Demb&amp;rea=
lattid=3Dii_lf0weri10&amp;zw" alt=3D"image.png" width=3D"563" height=3D"355=
"><br></div><div dir=3D"ltr"><img src=3D"https://mail.google.com/mail/?ui=
=3D2&amp;ik=3D7adc42cfb3&amp;attid=3D0.2&amp;th=3D186d7b012caf9a2e&amp;view=
=3Dfimg&amp;fur=3Dip&amp;rm=3D186d7b012caf9a2e&amp;sz=3Dw1600-h1000&amp;att=
bid=3DANGjdJ-5BCHxSIi-LzbUC_-4r894ScPfD8CZyWtiYs_P5dVrIR94JoBqwQ5U9iFUbKxib=
9bv2aC1BliVnrcuIlv9EHsw6boYejNDGmbThIWwLiO0Ye_TnvexF8ghx4U&amp;disp=3Demb&a=
mp;realattid=3Dii_lf0wkrco4&amp;zw" alt=3D"image.png" width=3D"562" height=
=3D"491"><br></div><div dir=3D"ltr"><br></div><div dir=3D"ltr"><img src=3D"=
https://mail.google.com/mail/?ui=3D2&amp;ik=3D7adc42cfb3&amp;attid=3D0.3&am=
p;th=3D186d7b012caf9a2e&amp;view=3Dfimg&amp;fur=3Dip&amp;rm=3D186d7b012caf9=
a2e&amp;sz=3Dw1600-h1000&amp;attbid=3DANGjdJ_Qk8gL494QCnlfDPWHJQI6k-l0z2DAd=
gfkXINDOIlmjJZ3DneVpWKB9-oMlcj1rPhLkoxRNbE2pB1avJ6lz3jEuKmULWZqiB_eex9AWTJp=
bArmauFDagqzVW0&amp;disp=3Demb&amp;realattid=3Dii_lf0wmthd5&amp;zw" alt=3D"=
image.png" width=3D"562" height=3D"503"><br></div><div dir=3D"ltr"><br></di=
v><div dir=3D"ltr"><br></div><div dir=3D"ltr"><br></div><div dir=3D"ltr"><u=
>This gnuradio flowgraph moves the signal to the original frequency of the =
spur(=3Dfrequency offset of 3-6KHz, that&#39;s bad) but eliminate the origi=
nal spur itself</u></div><div dir=3D"ltr"><u><br></u></div><div dir=3D"ltr"=
>I guess that anyway the=C2=A0frequency resolution range is:</div><div dir=
=3D"ltr"><ul><li>When dboard_clock_rate=3D50MHz -&gt; ranges from 50MHz whe=
n R divider=3D 1[-] up to 0.05[MHz] when R divider =3D 1000[-]</li><li>When=
 dboard_clock_rate=3D20MHz -&gt;ranges from 20MHz when R divider=3D 1[-] up=
 to 0.02[MHz] when R divider =3D 1000[-]</li></ul></div><div dir=3D"ltr"><u=
><br></u></div><div dir=3D"ltr">=C2=A0center freq :=C2=A0 uhd.tune_request(=
target_freq, dsp_freq=3D0, =C2=A0 =C2=A0 dsp_freq_policy=3Duhd.tune_request=
.POLICY_MANUAL)<u><br></u></div><div dir=3D"ltr"><br></div><div dir=3D"ltr"=
><div dir=3D"ltr"><div dir=3D"ltr">&#39;&#39;mode_n=3Dinteger&#39;&#39; in =
Device Address and Device Arguments<u><br></u></div><br></div></div><div di=
r=3D"ltr"><div dir=3D"ltr">dboard_clock_rate =3D didn&#39;t touch it so I g=
uess it is default=3D50MHz.<br></div><br></div><div dir=3D"ltr"><br></div><=
div dir=3D"ltr"><img src=3D"https://mail.google.com/mail/?ui=3D2&amp;ik=3D7=
adc42cfb3&amp;attid=3D0.5&amp;th=3D186d7b012caf9a2e&amp;view=3Dfimg&amp;fur=
=3Dip&amp;rm=3D186d7b012caf9a2e&amp;sz=3Dw1600-h1000&amp;attbid=3DANGjdJ8Bn=
IPmI4uGPyorNmsXTRk-63ZjDQaPx2s6REEPO3iRVFp2IrgzT1dvktLavoqSzD_DTASLkLjdRUmg=
NjYR4NbjlCPnF_W8O9LhZaeo9PohVMFeIEe-hTb0ucI&amp;disp=3Demb&amp;realattid=3D=
ii_lf0xmhye4&amp;zw" alt=3D"image.png" width=3D"562" height=3D"358"><br></d=
iv><div dir=3D"ltr"><img src=3D"https://mail.google.com/mail/?ui=3D2&amp;ik=
=3D7adc42cfb3&amp;attid=3D0.6&amp;th=3D186d7b012caf9a2e&amp;view=3Dfimg&amp=
;fur=3Dip&amp;rm=3D186d7b012caf9a2e&amp;sz=3Dw1600-h1000&amp;attbid=3DANGjd=
J8Log3RySpZ4j3H_A_JfqaKyd2W8eNe2cIvesaNCcvG3arz5y4kjD0hD0ZLV5EHWCyTfoLDJuYU=
fi8uix2VSnNJWlheRMoIYkObnat3VLL6vvMijG2lauv_Hn0&amp;disp=3Demb&amp;realatti=
d=3Dii_lf0xo4q65&amp;zw" alt=3D"image.png" width=3D"562" height=3D"486"><br=
></div><div dir=3D"ltr"><u><br></u></div><div dir=3D"ltr"><img src=3D"https=
://mail.google.com/mail/?ui=3D2&amp;ik=3D7adc42cfb3&amp;attid=3D0.4&amp;th=
=3D186d7b012caf9a2e&amp;view=3Dfimg&amp;fur=3Dip&amp;rm=3D186d7b012caf9a2e&=
amp;sz=3Dw1600-h1000&amp;attbid=3DANGjdJ89XMc4hgJA5HKSMu8CM98YTAHyZZA3p5-tH=
nLyQsPPP6kdhlD2NK8MK7p3EsZhXvaI-kH3EDodez6lHvRq1TvjJxmYn4sO6dBev4-gsoFOoZ_9=
NNHtRLgACv4&amp;disp=3Demb&amp;realattid=3Dii_lf0xk8i13&amp;zw" alt=3D"imag=
e.png" width=3D"562" height=3D"497"><br></div><div dir=3D"ltr"><u><br></u><=
/div><div dir=3D"ltr"><br></div><div dir=3D"ltr"><br></div><div dir=3D"ltr"=
>Thanks=C2=A0</div><div dir=3D"ltr">Dor</div><div class=3D"gmail_quote"><di=
v dir=3D"ltr" class=3D"gmail_attr">---------- Forwarded message ---------<b=
r>=D7=9E=D7=90=D7=AA: <strong class=3D"gmail_sendername" dir=3D"auto">Micha=
el West</strong> <span dir=3D"auto">&lt;<a href=3D"mailto:michael.west@ettu=
s.com" rel=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank=
">michael.west@ettus.com</a>&gt;</span><br>=E2=80=AADate: =D7=99=D7=95=D7=
=9D =D7=92=D7=B3, 7 =D7=91=D7=9E=D7=A8=D7=A5 2023 =D7=91-4:22=E2=80=AC<br>S=
ubject: Re: Spurs in UBX-160 Daughterboard with USRP X310<br>To: Marcus D. =
Leech &lt;<a href=3D"mailto:patchvonbraun@gmail.com" rel=3D"noreferrer nore=
ferrer noreferrer noreferrer" target=3D"_blank">patchvonbraun@gmail.com</a>=
&gt;<br>Cc: Dor Ratz &lt;<a href=3D"mailto:dorratz12@gmail.com" rel=3D"nore=
ferrer noreferrer noreferrer noreferrer" target=3D"_blank">dorratz12@gmail.=
com</a>&gt;, Marcus M=C3=BCller &lt;<a href=3D"mailto:marcus.mueller@ettus.=
com" rel=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank">=
marcus.mueller@ettus.com</a>&gt;,  &lt;<a href=3D"mailto:mmueller@gnuradio.=
org" rel=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank">=
mmueller@gnuradio.org</a>&gt;, <a href=3D"mailto:usrp-users@lists.ettus.com=
" rel=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank">usr=
p-users@lists.ettus.com</a> &lt;<a href=3D"mailto:usrp-users@lists.ettus.co=
m" rel=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank">us=
rp-users@lists.ettus.com</a>&gt;, Eduard Sivolenko &lt;<a href=3D"mailto:ed=
uard.sivolenko@ni.com" rel=3D"noreferrer noreferrer noreferrer noreferrer" =
target=3D"_blank">eduard.sivolenko@ni.com</a>&gt;,  &lt;<a href=3D"mailto:d=
erek.mckay@utu.fi" rel=3D"noreferrer noreferrer noreferrer noreferrer" targ=
et=3D"_blank">derek.mckay@utu.fi</a>&gt;, Michael Dickens &lt;<a href=3D"ma=
ilto:michael.dickens@ettus.com" rel=3D"noreferrer noreferrer noreferrer nor=
eferrer" target=3D"_blank">michael.dickens@ettus.com</a>&gt;,  &lt;<a href=
=3D"mailto:claudio.franchini@tlrnet.eu" rel=3D"noreferrer noreferrer norefe=
rrer noreferrer" target=3D"_blank">claudio.franchini@tlrnet.eu</a>&gt;<br><=
/div><br><br><div dir=3D"ltr"><div>Hi Dor,</div><div><br></div><div>There a=
re 2 arguments that can control the integer-N step size:=C2=A0 the int_n_st=
ep tune arg and the dboard_clock_rate device arg.=C2=A0 The int_n_step tune=
 arg will explicitly change the step size by changing the R divider value, =
which will break phase coherency between channels.=C2=A0 The &#39;dboard_cl=
ock_rate&#39; value in the device args controls the reference clock rate, w=
hich will keep the R divider set to 1 and support phase coherency between c=
hannels.=C2=A0 Both will change the PFD frequency for the PLL.=C2=A0 The UB=
X was designed for a PFD frequency of 50 MHz, which is why 50 MHz is the de=
fault reference=C2=A0clock rate and the default R value is 1.=C2=A0 Reducin=
g the PFD frequency will result in more phase noise.=C2=A0 My recommendatio=
n is to set the &#39;mode_n=3Dinteger&#39; in the tune args, let the DSP tu=
ning take care of the offset by leaving the DSP tuning policy to the defaul=
t (POLICY_AUTO), and use the highest dboard_clock_rate possible (up to 50 M=
Hz).=C2=A0 The highest &#39;dboard_clock_rate&#39; can be achieved based on=
 the required bandwidth of the application by using the formula:</div><div>=
<br></div><div>dbaord_clock_rate =3D (160 MHz - bandwidth) / 2</div><div><b=
r></div><div>I hope this helps.</div><div></div><div></div><div><br></div><=
div>Best regards,</div><div>Michael E. West</div><br><div class=3D"gmail_qu=
ote"><div dir=3D"ltr" class=3D"gmail_attr">On Mon, Mar 6, 2023 at 3:07=E2=
=80=AFPM Marcus D. Leech &lt;<a href=3D"mailto:patchvonbraun@gmail.com" rel=
=3D"noreferrer noreferrer noreferrer noreferrer" target=3D"_blank">patchvon=
