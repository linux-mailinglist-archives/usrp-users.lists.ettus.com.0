...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id B4CE352352B
	for <lists+usrp-users@lfdr.de>; Wed, 11 May 2022 16:16:07 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 04FFB384458
	for <lists+usrp-users@lfdr.de>; Wed, 11 May 2022 10:16:07 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1652278567; bh=jpxer4SwUXt2/P3CIKKFwxmG/MKe6/FbqKUNrFSe+gM=;
	h=Date:To:References:From:In-Reply-To:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=
Received: from mail-qk1-f173.google.com (mail-qk1-f173.google.com [209.85.222.173])
	by mm2.emwd.com (Postfix) with ESMTPS id 3AA1338444E
	for <usrp-users@lists.ettus.com>; Wed, 11 May 2022 10:14:52 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="duj2FSVw";
	dkim-atps=neutral
Received: by mail-qk1-f173.google.com with SMTP id b20so2347250qkc.6
        for <usrp-users@lists.ettus.com>; Wed, 11 May 2022 07:14:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=message-id:date:mime-version:user-agent:subject:content-language:to
         :references:from:in-reply-to;
        bh=4Xkmxg+BYggrAibGh4z8/JoieT96ARHuw6r6uyHYlfs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=4Xkmxg+BYggrAibGh4z8/JoieT96ARHuw6r6uyHYlfs=;
        b=
X-Gm-Message-State: AOAM530yBmBZiEKMO7yF0QNaT8zHWTc0dyYIxA2KXAFUW/HiDlzsl2vi
	M3ZzexyLDbwh7osthFgBZaCRBoi1ejs=
X-Google-Smtp-Source: ABdhPJyYqziNUoLmfZcKggIjN3G6gGmMKdkNiXi+6DPpTUxwK+PCDpZTx0MpRMdT++oAAga59G8Deg==
X-Received: by 2002:a05:620a:240b:b0:6a0:5187:656d with SMTP id d11-20020a05620a240b00b006a05187656dmr16572941qkn.273.1652278491407;
        Wed, 11 May 2022 07:14:51 -0700 (PDT)
Received: from [192.168.2.184] (bras-base-smflon1825w-grc-19-76-68-79-178.dsl.bell.ca. [76.68.79.178])
        by smtp.googlemail.com with ESMTPSA id h1-20020a05620a244100b0069fc6484c06sm1412798qkn.23.2022.05.11.07.14.49
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 11 May 2022 07:14:49 -0700 (PDT)
Message-ID: <e5a70f4b-c3d9-729c-dffd-aa79194da80d@gmail.com>
Date: Wed, 11 May 2022 10:14:48 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAFghhNO3LZ9beJbCgfiRZUvzOwRd6vgoCMsrBYECONmHgjx=OA@mail.gmail.com>
Message-ID-Hash: IKJRB5PET7S7DS6IOXODQLIP4LVADXTS
X-Message-ID-Hash: IKJRB5PET7S7DS6IOXODQLIP4LVADXTS
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/IKJRB5PET7S7DS6IOXODQLIP4LVADXTS/>
...
Content-Type: multipart/mixed; boundary="===============4473464384538058880=="

This is a multi-part message in MIME format.
--===============4473464384538058880==
Content-Type: multipart/alternative;
 boundary="------------Ey0iBSzgFppVk9YgbMzIJuQ8"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------Ey0iBSzgFppVk9YgbMzIJuQ8
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 2022-05-11 09:51, Marcin Puchlik wrote:
> Will=C2=A0it be enough to clock USRP from the external 10 MHz signal=20
> generator? When I run the flowgraph I cannot see the information that=20
...
> image.png
>
Yeah, I don't think it puts out an "i'm locked to the external=20
reference" message.

But you've asked for "external" clock source, so you should be good to=20
go, assuming your external generator meets the requirements.


> =C5=9Br., 11 maj 2022 o 15:24=C2=A0Marcus D. Leech <patchvonbraun@gmail=
.com>=20
> napisa=C5=82(a):
>
...
>>     *Z powa=C5=BCaniem *
>>     *Marcin Puchlik*
>     *Yes, absolutely.=C2=A0 If timestamp synchronization is not importa=
nt
...
d by
>     the on-board clock and/or you want some type of phase-synchronizati=
on
...
>>         =C2=A0 TWO timestamp clocks.=C2=A0 Use the 1PPS synchronizatio=
n
...
Content-Type: multipart/related;
 boundary="------------mSA24LgTs2e8NZPWkt8rOlHO"

--------------mSA24LgTs2e8NZPWkt8rOlHO
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 2022-05-11 09:51, Marcin Puchlik
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAFghhNO3LZ9beJbCgfiRZUvzOwRd6vgoCMsrBYECONmHgjx=3DOA@mail.gm=
ail.com">
      <meta http-equiv=3D"content-type" content=3D"text/html; charset=3DU=
TF-8">
      <div dir=3D"ltr">
        <div>Will=C2=A0it be enough to clock USRP from the external 10 MH=
z
...
onously)<br>
        ...
        <img src=3D"cid:part1.TYmwZe7O.goEu9e5R@gmail.com" alt=3D"image.p=
ng"
          class=3D"" width=3D"562" height=3D"562"><br>
      </div>
      <br>
    </blockquote>
    ...
    <br>
    But you've asked for "external" clock source, so you should be good
...
e
              ...
              =C2=A0 but don't care much about mutual phase offsets....<b=
r>
              <br>
              <br>
              <br>
                    ...
                    <blockquote type=3D"cite">
                      <div dir=3D"ltr">Hello Community,
                        <div>Like in the topic, I know that a stable 10
                          ...
                          do we need=C2=A01 PPS signal? How is it used by=
 the
...
Content-Id: <part1.TYmwZe7O.goEu9e5R@gmail.com>
