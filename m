...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id F379EFBB5B
	for <lists+usrp-users@lfdr.de>; Wed, 13 Nov 2019 23:07:15 +0100 (CET)
Received: from [::1] (port=37140 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iV0nB-0006TA-45; Wed, 13 Nov 2019 17:07:13 -0500
Received: from mail-qv1-f50.google.com ([209.85.219.50]:45357)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <wddias@gmail.com>) id 1iV0n6-0006IG-8l
 for usrp-users@lists.ettus.com; Wed, 13 Nov 2019 17:07:08 -0500
Received: by mail-qv1-f50.google.com with SMTP id g12so1497622qvy.12
 for <usrp-users@lists.ettus.com>; Wed, 13 Nov 2019 14:06:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to;
 bh=gV1vVKaxOLLU7rnjzgi7M/w0njItZxe7tmTWD8b7lQY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=gV1vVKaxOLLU7rnjzgi7M/w0njItZxe7tmTWD8b7lQY=;
 b=
X-Gm-Message-State: APjAAAW7OCU+j/x4ovcQ8JhkIstDL31vxAug7CF/ukMwV9zfvq0S6Qy7
 yAFI+gvB7zg9/lBr0feELI3wbFfO3ALRvu87rK0=
X-Google-Smtp-Source: APXvYqwN75xznrAcZsuzdv0tXnxAW3ACurRH12nljQArphwuNcIGECUsal6NkQPWg8IY9QKY/MNnoh6lAPfkeMqFfjY=
X-Received: by 2002:a0c:ef48:: with SMTP id t8mr5115223qvs.38.1573682786701;
 Wed, 13 Nov 2019 14:06:26 -0800 (PST)
MIME-Version: 1.0
References: <CALSKgPy9YoLX2fXWJPiy5kWDxswB_0oQ4VC1chWw6EqCVKJ+Rw@mail.gmail.com>
 ...
 <CANf970b_06XaYmobienLZjO114N-aKKA_uyW+Kd_nFKQdT3tqA@mail.gmail.com>
 <CALSKgPy7ket3jU4VDJM3MTP0VxgyZ5=8v_rv4ktTmB+h4NU7Zw@mail.gmail.com>
 <CALSKgPwe31Aoe0a367Gp5g+Arurjt+D=A8tC7x_+oY16ndcOhQ@mail.gmail.com>
 <CANf970aQ9JO+_wT=RiTjXs_3Q0XHpFGLtdJaSr4R8fJ0fOFqKw@mail.gmail.com>
 <CALSKgPycDoAMAq6-=C855bJLa355H+BDxK+wXyWcXB+Wf84CaQ@mail.gmail.com>
In-Reply-To: <CALSKgPycDoAMAq6-=C855bJLa355H+BDxK+wXyWcXB+Wf84CaQ@mail.gmail.com>
Date: Wed, 13 Nov 2019 19:06:13 -0300
Message-ID: <CALSKgPySLattWNEL5pfyzqGzPrK_XLBj7XXifT=JLh3sPyzzyA@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============8114885697875903721=="
...
--===============8114885697875903721==
Content-Type: multipart/related; boundary="0000000000007ea24d059741936e"

--0000000000007ea24d059741936e
Content-Type: multipart/alternative; boundary="0000000000007ea24c059741936d"

--0000000000007ea24c059741936d
...
Em qua, 13 de nov de 2019 18:52, Wheberth Damascena Dias <wheberth@gmail.co=
m>
escreveu:
...
> to find. (PEG Settings). The x16 PCIe slot have a separate setting from t=
he
> other chipset slots.
>
> Thank you very much for you support in this matter.
...
>
>
> Em sex, 8 de nov de 2019 13:19, Sam Reiter <sam.reiter@ettus.com>
> escreveu:
>
>> Just a final follow up on this, in the event that this thread is
>> referenced by someone in a similar situation. Based on the info you've s=
ent
>> over and the hardware you're using, this sounds like a compat issue betw=
een
>> that 8371 PCIe / MXIe card and your motherboard. If you'd like to dig in=
to
>> this further, you should look into opening a support ticket with NI, but
>> I'd guess you'll probably end up at the same "this is a gaming motherboa=
rd
>> and those are sometimes incompatible with the strict PCIe standard that =
the
...
>>> Regards
>>>
>>> Em qui, 31 de out de 2019 =C3=A0s 17:39, Wheberth Damascena Dias <
...
>>>> like charm on this third machine (also very different from the i7 and =
the
>>>> i9).
>>>> - I have also noticed the that the driver is not "tied" to the PCIe
>>>> device despite compiled and loaded successfully.
>>>> - The PCIe slot on this board is indeed x16 gen 3. But on the BIOS, th=
e
...
>>>>
>>>>
>>>> Em qui, 31 de out de 2019 =C3=A0s 16:38, Sam Reiter <sam.reiter@ettus.=
com>
>>>> escreveu:
>>>>
>>>>> I also spoke with someone on our PXI team regarding 8371
>>>>> compatibility, what that manual note means, and some other troublesho=
oting
...
>>>>> may not be fully PCIe compliant. You might check the motherboard manu=
al for
>>>>> any **vague** language surrounding that slot being intended for GPU u=
se. I
>>>>> question whether this is relevant or not considering the fact that it=
 was
...
>>>>> motherboards. The CPU typically isn't as big of a factor as motherboa=
rd /
>>>>> BIOS. This makes your i7 / i9 issue all the more puzzling.
>>>>> - You can see if there are BIOS settings to change the PCIe link spee=
d
>>>>> to Gen 1 and try that as well see the snippet from the motherboard ma=
nual
>>>>> below:
>>>>>
>>>>> [image: image.png]
...
>>>>> -Sam
>>>>>
>>>>> On Thu, Oct 31, 2019 at 1:27 PM Sam Reiter <sam.reiter@ettus.com>
>>>>> wrote:
>>>>>
>>>>>> I'm not sure if the graphics card thing is worth spending too much
>>>>>> time on -- I can't find a great answer for the reasoning behind it e=
ither.
>>>>>>
>>>>>> From the initial lspci output, there don't seem to be any kernel
>>>>>> drivers handling the 8371. Were you able to try recompiling and relo=
ading
...
>>>>>> in moving this forward. Feel free to pass along any changes you obse=
rved
...
>>>>>>> it may not work in a slot intended for graphics card. Anyone have a=
n idea
...
>>>>>>>> 00:16.0 Communication controller: Intel Corporation Cannon Lake PC=
H
...
>>>>>>>> (rev 10)
>>>>>>>> 00:1f.5 Serial bus controller [0c80]: Intel Corporation Cannon Lak=
e
...
.
>>>>>>>>>
>>>>>>>>> Em sex, 25 de out de 2019 =C3=A0s 18:28, Sam Reiter <
>>>>>>>>> sam.reiter@ettus.com> escreveu:
>>>>>>>>>
...
>>>>>>>>>> connected to the computer. It might be worth making the X310's P=
CIe link
...
>>>>>>>>>>> Its a i7 6th gen with ubuntu 18.04 kernel  4.15.0, libuhd and u=
hd-host on
>>>>>>>>>>> same version.
>>>>>>>>>>>
>>>>>>>>>>> I think this can be some PCIe related setting on the BIOS, sinc=
e
>>>>>>>>>>> the lspci shows [disabled] next to the base address, but I can'=
t find any
...
r=3D"auto"><br>Hi Sam, good afternoon. I finally managed to get the USRP wo=
rking on the motherboard. Your tip regarding the PCIe Link speed did the tr=
ick.</div><div dir=3D"auto" style=3D"font-family:sans-serif;font-size:12.8p=
x"><br></div><div dir=3D"auto" style=3D"font-family:sans-serif;font-size:12=
.8px">The location on the BIOS to do this setting that was counter intuitiv=
e to find. (PEG Settings). The x16 PCIe slot have a separate setting from t=
he other chipset slots.</div><div dir=3D"auto" style=3D"font-family:sans-se=
rif;font-size:12.8px"><br></div><div dir=3D"auto" style=3D"font-family:sans=
-serif;font-size:12.8px">Thank you very much for you support in this matter=
.</div><div dir=3D"auto" style=3D"font-family:sans-serif;font-size:12.8px">=
<br></div><div dir=3D"auto" style=3D"font-family:sans-serif;font-size:12.8p=
x">Best Regards,</div><div dir=3D"auto" style=3D"font-family:sans-serif;fon=
t-size:12.8px">Wheberth Dias</div></div><br><div class=3D"gmail_quote"><div=
 dir=3D"ltr" class=3D"gmail_attr">Em qua, 13 de nov de 2019 18:52, Wheberth=
 Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com">wheberth@gmail.co=
...
o"><div>Hi Sam, good afternoon. I finally managed to get thu USRP working o=
n the board. Your tip regarding the PCIe Link speed did the trick.</div><di=
v dir=3D"auto"><br></div><div dir=3D"auto">The location on the BIOS to do t=
his setting is that was conter intuitive to find. (PEG Settings). The x16 P=
CIe slot have a separate setting from the other chipset slots.</div><div di=
r=3D"auto"><br></div><div dir=3D"auto">Thank you very much for you support =
in this matter.</div><div dir=3D"auto"><br></div><div dir=3D"auto">Best Reg=
ards,</div><div dir=3D"auto">Wheberth Dias</div><div dir=3D"auto"><br><br><=
div class=3D"gmail_quote" dir=3D"auto"><div dir=3D"ltr" class=3D"gmail_attr=
">Em sex, 8 de nov de 2019 13:19, Sam Reiter &lt;<a href=3D"mailto:sam.reit=
er@ettus.com" target=3D"_blank" rel=3D"noreferrer">sam.reiter@ettus.com</a>=
&gt; escreveu:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0=
 0 0 .8ex;border-left:1px #ccc solid;padding-left:1ex"><div dir=3D"ltr"><di=
v>Just a final follow up on this, in the event that this thread is referenc=
ed by someone in a similar situation. Based on the info you&#39;ve sent ove=
r and the hardware you&#39;re using, this sounds like a compat issue betwee=
n that 8371 PCIe / MXIe card and your motherboard. If you&#39;d like to dig=
 into this further, you should look into opening a support ticket with NI, =
but I&#39;d guess you&#39;ll probably end up at the same &quot;this is a ga=
ming motherboard and those are sometimes incompatible with the strict PCIe =
standard that the 8371 is working with&quot;. <br></div><div><br></div><div=
>If I was in your shoes, I&#39;d try to get your hands on a good dual 10GbE=
 NIC and use that as your link to the X310. If you&#39;re using PCIe for la=
tency, you can get a low latency linux kernel with DPDK and try to optimize=
 from there. <br></div><div><br></div><div>-Sam <br></div></div><br><div cl=
ass=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Fri, Nov 1, 20=
19 at 1:55 PM Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.=
com" rel=3D"noreferrer noreferrer" target=3D"_blank">wheberth@gmail.com</a>=
&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px =
0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div=
 dir=3D"ltr">Hi Sam,=C2=A0<div>A quick update. I found the setting you refe=
rred=C2=A0from the Motherboard manual.</div><div>I tried to force the PCIe =
to Gen1 but again, no luck.</div><div><br></div><div>Regards</div></div><br=
><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em qui, 3=
1 de out de 2019 =C3=A0s 17:39, Wheberth Damascena Dias &lt;<a href=3D"mail=
to:wheberth@gmail.com" rel=3D"noreferrer noreferrer" target=3D"_blank">wheb=
erth@gmail.com</a>&gt; escreveu:<br></div><blockquote class=3D"gmail_quote"=
 style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);p=
adding-left:1ex"><div dir=3D"ltr"><div>Hi Sam,</div><div><br></div><div></d=
iv><div></div><div>- In fact the i7 machine is totally different from the i=
9. Not just a CPU upgrade a new machine with a different motherboard.</div>=
<div>- Regarding the OS version, I have downgraded form Ubuntu 18 to Ubuntu=
 16 but there are no difference at all.</div><div>I have also upgraded anot=
her machine to Ubuntu 18 and the USRP worked like charm on this third machi=
ne (also very different from the i7 and the i9).</div><div>- I have also no=
ticed the that the driver is not &quot;tied&quot; to the PCIe device despit=
e compiled and loaded successfully.<br></div><div></div><div></div><div></d=
iv><div>- The PCIe slot on this board is indeed x16 gen 3. But on the BIOS,=
 the only PCIe settings available are related to power management and Virtu=
alization (SR-IOV).</div><div>- Being a game motherboard with a single PCIe=
 Slot looks like a good indication of intended usage.</div><div>I have also=
 upgraded the BIOS but, again, no success.</div><div><br></div><div>Please =
find attached the lspci -vvv output form the i7 and i9.</div><div>for the i=
9 i also included the dmesg and lsmod.</div><div><br></div><div>Thank you A=
gain.</div><div>Best Regards,<br></div><div><br></div><div><br></div></div>=
<div dir=3D"ltr"><br></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" =
class=3D"gmail_attr">Em qui, 31 de out de 2019 =C3=A0s 16:38, Sam Reiter &l=
t;<a href=3D"mailto:sam.reiter@ettus.com" rel=3D"noreferrer noreferrer" tar=
get=3D"_blank">sam.reiter@ettus.com</a>&gt; escreveu:<br></div><blockquote =
class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px sol=
id rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>I also spoke wi=
th someone on our PXI team regarding 8371 compatibility, what that manual n=
ote means, and some other troubleshooting steps. Not sure if any of this wi=
ll be actionable, but here are some tidbits of knowledge:</div><div><br></d=
iv><div>- &quot;Slots intended for graphics cards&quot; are usually x16 PCI=
e slots that may not be fully PCIe compliant. You might check the motherboa=
rd manual for any **vague** language surrounding that slot being intended f=
or GPU use. I question whether this is relevant or not considering the fact=
 that it was working with your i7.<br></div><div>- Related to the point abo=
ve, gaming oriented motherboards seem to give the 8371 and similar MXI card=
s more trouble than non-gaming motherboards. The CPU typically isn&#39;t as=
 big of a factor as motherboard / BIOS. This makes your i7 / i9 issue all t=
he more puzzling. <br></div><div>- You can see if there are BIOS settings t=
o change the PCIe link speed to Gen 1 and try that as well see the snippet =
from the motherboard manual below:</div><div><br></div><div><div><img src=
=3D"cid:ii_k2f3uskb1" alt=3D"image.png" width=3D"568" height=3D"186"><br></=
div></div><div>- You might also check for and install any BIOS updates you =
have available for your motherboard.</div><div><br></div><div>Let me know i=
f these steps or those from my last email have helped to move anything forw=
ard.</div><div><br></div><div>-Sam <br></div></div><br><div class=3D"gmail_=
quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Oct 31, 2019 at 1:27 P=
M Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" rel=3D"noreferrer =
noreferrer" target=3D"_blank">sam.reiter@ettus.com</a>&gt; wrote:<br></div>=
<blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-=
left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">I&#39;m =
not sure if the graphics card thing is worth spending too much time on -- I=
 can&#39;t find a great answer for the reasoning behind it either.<br><br>F=
rom the initial lspci output, there don&#39;t seem to be any kernel drivers=
 handling the 8371. Were you able to try recompiling and reloading the RIO =
drivers after installing your new CPU?<br><br>Here are a couple other comma=
nds I&#39;d like you to run and report the outputs of:<br><br><b>sudo lspci=
 -vvv</b><br><br><b>dmesg</b><br><br><b>lsmod</b><br><br>If you could attac=
h those outputs as text files, that may be helpful in moving this forward. =
Feel free to pass along any changes you observed between 18.04 and 16.04 as=
 well.<br><br>-Sam</div><br><div class=3D"gmail_quote"><div dir=3D"ltr" cla=
ss=3D"gmail_attr">On Wed, Oct 30, 2019 at 8:21 AM Wheberth Damascena Dias &=
lt;<a href=3D"mailto:wheberth@gmail.com" rel=3D"noreferrer noreferrer" targ=
et=3D"_blank">wheberth@gmail.com</a>&gt; wrote:<br></div><blockquote class=
=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rg=
b(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Another piece of inf=
o. The manual of the PCIe-8371 card states that it may not work in a slot i=
ntended for graphics card. Anyone have an idea of the reason for that?</div=
><div><br></div><div><div><img src=3D"cid:ii_k2db2u0v1" alt=3D"image.png" w=
idth=3D"566" height=3D"270"><br></div></div></div><br><div class=3D"gmail_q=
uote"><div dir=3D"ltr" class=3D"gmail_attr">Em ter, 29 de out de 2019 =C3=
=A0s 16:11, Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.co=
m" rel=3D"noreferrer noreferrer" target=3D"_blank">wheberth@gmail.com</a>&g=
t; escreveu:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px=
 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><di=
v dir=3D"ltr"><div>Here is the full output of the lspci. I will try to inst=
all Ubuntu 16.04 and see <br></div><div><br></div><div>00:00.0 Host bridge:=
 Intel Corporation Device 3e30 (rev 0a)<br>00:01.0 PCI bridge: Intel Corpor=
ation Xeon E3-1200 v5/E3-1500 v5/6th Gen Core Processor PCIe Controller (x1=
6) (rev 0a)<br>00:02.0 VGA compatible controller: Intel Corporation Device =
3e98<br>00:14.0 USB controller: Intel Corporation Cannon Lake PCH USB 3.1 x=
HCI Host Controller (rev 10)<br>00:14.2 RAM memory: Intel Corporation Canno=
n Lake PCH Shared SRAM (rev 10)<br>00:14.3 Network controller: Intel Corpor=
ation Wireless-AC 9560 [Jefferson Peak] (rev 10)<br>00:16.0 Communication c=
ontroller: Intel Corporation Cannon Lake PCH HECI Controller (rev 10)<br>00=
:17.0 SATA controller: Intel Corporation Cannon Lake PCH SATA AHCI Controll=
er (rev 10)<br>00:1b.0 PCI bridge: Intel Corporation Device a340 (rev f0)<b=
r>00:1c.0 PCI bridge: Intel Corporation Device a338 (rev f0)<br>00:1d.0 PCI=
 bridge: Intel Corporation Cannon Lake PCH PCI Express Root Port 9 (rev f0)=
<br>00:1f.0 ISA bridge: Intel Corporation Device a305 (rev 10)<br>00:1f.3 A=
udio device: Intel Corporation Cannon Lake PCH cAVS (rev 10)<br>00:1f.4 SMB=
us: Intel Corporation Cannon Lake PCH SMBus Controller (rev 10)<br>00:1f.5 =
Serial bus controller [0c80]: Intel Corporation Cannon Lake PCH SPI Control=
ler (rev 10)<br>00:1f.6 Ethernet controller: Intel Corporation Ethernet Con=
nection (7) I219-V (rev 10)<br>01:00.0 PCI bridge: PLX Technology, Inc. PEX=
 8608 8-lane, 8-Port PCI Express Gen 2 (5.0 GT/s) Switch (rev ba)<br>02:01.=
0 PCI bridge: PLX Technology, Inc. PEX 8608 8-lane, 8-Port PCI Express Gen =
2 (5.0 GT/s) Switch (rev ba)<br>03:00.0 Signal processing controller: Natio=
nal Instruments PXIe/PCIe Device<br></div></div><br><div class=3D"gmail_quo=
te"><div dir=3D"ltr" class=3D"gmail_attr">Em sex, 25 de out de 2019 =C3=A0s=
 20:55, Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com" r=
el=3D"noreferrer noreferrer" target=3D"_blank">wheberth@gmail.com</a>&gt; e=
screveu:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px=
 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div di=
r=3D"ltr"><div>This computer has a mini-ITX board (ASUS ROG Strix Z390-I ) =
with just one x16 slot.=C2=A0</div><div>However,=C2=A0on monday I can get t=
he full output of the lspci command.<br></div></div><br><div class=3D"gmail=
_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em sex, 25 de out de 2019 =C3=
=A0s 18:28, Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" rel=3D"n=
oreferrer noreferrer" target=3D"_blank">sam.reiter@ettus.com</a>&gt; escrev=
eu:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px =
0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"=
ltr">Would you be able to try shifting this card to another PCIe slot in yo=
ur machine?<div><br></div><div>I&#39;m also interested in knowing what othe=
r PCIe devices you have connected to the computer. It might be worth making=
 the X310&#39;s PCIe link the only connection, at least for testing purpose=
s.=C2=A0</div><div><br clear=3D"all"><div><div dir=3D"ltr"><div dir=3D"ltr"=
><div><div dir=3D"ltr">Sam=C2=A0</div></div></div></div></div><br></div></d=
iv><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On =
Wed, Oct 23, 2019 at 6:58 PM Wheberth Damascena Dias &lt;<a href=3D"mailto:=
wheberth@gmail.com" rel=3D"noreferrer noreferrer" target=3D"_blank">whebert=
h@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div dir=3D"auto"><div dir=3D"auto">Hi Mr Reiter,=C2=A0</div><di=
v dir=3D"auto">Thank you for your answer.</div><div dir=3D"auto"><br></div>=
Actually yes, the same X310 runs perfectly in another machine. Its a i7 6th=
 gen with ubuntu 18.04 kernel=C2=A0 4.15.0, libuhd and uhd-host on same ver=
sion.<div dir=3D"auto"><br></div><div dir=3D"auto">I think this can be some=
 PCIe related setting on the BIOS, since the lspci shows [disabled] next to=
 the base address, but I can&#39;t find any option to change it on the BIOS=
...
><br><div dir=3D"auto"><br></div></div></div>
</blockquote></div>
...
br><div><a href=3D"http://www.linkedin.com/in/wheberth" rel=3D"noreferrer n=
oreferrer" target=3D"_blank">http://www.linkedin.com/in/wheberth</a></div><=
div><a href=3D"mailto:e-mail%3Awheberth@gmail.com" rel=3D"noreferrer norefe=
rrer" target=3D"_blank">e-mail:wheberth@gmail.com</a></div><div><div><div><=
...
a href=3D"http://www.linkedin.com/in/wheberth" rel=3D"noreferrer noreferrer=
" target=3D"_blank">http://www.linkedin.com/in/wheberth</a></div><div><a hr=
ef=3D"mailto:e-mail%3Awheberth@gmail.com" rel=3D"noreferrer noreferrer" tar=
get=3D"_blank">e-mail:wheberth@gmail.com</a></div><div><div><div><br></div>=
</div></div></div></div></div>
</blockquote></div><br clear=3D"all"><br>-- <br><div dir=3D"ltr"><div dir=
=3D"ltr"><div><span style=3D"font-size:12.8px"><b>Wheberth Damascena Dias</=
b></span><br></div><div><span style=3D"color:rgb(80,0,80);font-size:12.8px"=
