...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 402F49FBFB6
	for <lists+usrp-users@lfdr.de>; Tue, 24 Dec 2024 16:41:25 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 52AC5385A1B
	for <lists+usrp-users@lfdr.de>; Tue, 24 Dec 2024 10:41:24 -0500 (EST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1735054884; bh=DGv/gK7KjXPK0GbBWw9+xyCt+6+GP3QPnioHIdtyonQ=;
	h=References:In-Reply-To:Date:To:CC:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From:Reply-To:From;
	b=
Received: from mail-ed1-f48.google.com (mail-ed1-f48.google.com [209.85.208.48])
	by mm2.emwd.com (Postfix) with ESMTPS id 1678A385ADB
	for <usrp-users@lists.ettus.com>; Tue, 24 Dec 2024 10:40:15 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=nd.edu header.i=@nd.edu header.b="CXkfzJWA";
	dkim-atps=neutral
Received: by mail-ed1-f48.google.com with SMTP id 4fb4d7f45d1cf-5d3bbb0f09dso8617637a12.2
        for <usrp-users@lists.ettus.com>; Tue, 24 Dec 2024 07:40:15 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=nd.edu; s=google; t=1735054815; x=1735659615; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=Jdyq9K1F50M3tT1GM9u6IeadU+tryVVM3JeJTOO0kM4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1735054815; x=1735659615;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Jdyq9K1F50M3tT1GM9u6IeadU+tryVVM3JeJTOO0kM4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVeU+SrNnF/Ra/NjeXGbYAHcBYCh8MFWYCJHXh+92Do1iwxhDb9kmzmht/y1QaKppibArGaRwZAanks@lists.ettus.com
X-Gm-Message-State: AOJu0YywtF8w6zVAGLCIy32XA9ufHjAcHAYi2KqS43fTjJOu+WLz5lK2
	T3N0Z9BmLe01ScH0tP95yvnHrsVrDbcDfpv3zZtdnd4YC/tAlkFDGp8onivzFVvDo3V+F+C+GQ4
	vjbhgVtG51bMLZ4lc8Gy6FJppdFJGv5sSNuu3A9KzU43Extg=
X-Gm-Gg: ASbGnctC7k04UgCFSYupRRZUUPH/uwCofmBk95nQUuZfcd47FglWx+zrYf8jQgPv+4M
	OYmQ1FX7ERVuDNxSiTCJmsOtvanFWBAxCPC0=
X-Google-Smtp-Source: AGHT+IGloKYGIQslEPvCIzNNbiObv4COiHvumzRICS0loMpSMG/s8GL/7ZNXk6kC6D76pCn/aZWqR2QkLp25dtLkE2M=
X-Received: by 2002:a05:6402:27d4:b0:5cf:a1c1:5289 with SMTP id
 4fb4d7f45d1cf-5d81de48c0bmr12102845a12.21.1735054814193; Tue, 24 Dec 2024
 07:40:14 -0800 (PST)
MIME-Version: 1.0
References: <CAE=q3UPVjJMaehJ=FN7gtNvHgPXBOoXyPqhAfDMkKb1XEg8ErA@mail.gmail.com>
 ...
 <CAB__hTT4DdzV6wCrc3ZU219njLF8GdYVupbfCAQO7m9anxgVew@mail.gmail.com> <CAE=q3UPMSBikTCN0gj_qiSXXFhuteLBy_6sse68epDpHqeqkyg@mail.gmail.com>
In-Reply-To: <CAE=q3UPMSBikTCN0gj_qiSXXFhuteLBy_6sse68epDpHqeqkyg@mail.gmail.com>
Date: Tue, 24 Dec 2024 10:40:01 -0500
Message-ID: <CAB__hTT+T7_ScA_cdG0GcK2eZEMngwSLMtdng276uzspj0kM3g@mail.gmail.com>
To: David <vitishlsfan21@gmail.com>
Message-ID-Hash: KGEDG7T23XTGYNJVQB2ZS6OPI4VSUFNR
X-Message-ID-Hash: KGEDG7T23XTGYNJVQB2ZS6OPI4VSUFNR
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/KGEDG7T23XTGYNJVQB2ZS6OPI4VSUFNR/>
...
Content-Type: multipart/mixed; boundary="===============9115538812413169168=="

--===============9115538812413169168==
Content-Type: multipart/related; boundary="000000000000de4e10062a05edd4"

--000000000000de4e10062a05edd4
Content-Type: multipart/alternative; boundary="000000000000de4e0e062a05edd3"

--000000000000de4e0e062a05edd3
...
On Mon, Dec 23, 2024 at 5:55=E2=80=AFPM David <vitishlsfan21@gmail.com> wro=
te:

> Rob,
>
> Thank you for your response, I was actually unaware of the
> mutli_usrp_rfnoc class, and I see how it calls the same command. I now ha=
ve
> an extra tool I can fiddle with after the holidays, plus the new FPGA deb=
ug
> images...
>
...
> David
>
> On Mon, Dec 23, 2024 at 8:28=E2=80=AFAM Rob Kossler <rkossler@nd.edu> wro=
te:
>
>> Hi David,
>> Your email distinguishes between the multi_usrp API and the rfnoc API.
>> But, under the hood, the multi_usrp API
>> <https://github.com/EttusResearch/uhd/blob/master/host/lib/usrp/multi_us=
rp_rfnoc.cpp>
>> implements all of its functionality with the rfnoc API.  So, it seems th=
at
>> the multi_usrp implementation (using rfnoc API commands) is doing someth=
ing
...
>>> it), but I have run the simulation with a packet delayed 500 clock cycl=
es
...
>>> block is an HLS block that is data driven, and won't be ready unless it=
 has
>>> both inputs. I verified the output data from the delayed packet simulat=
ion.
>>> Because of these factors, I think it is unlikely my block is deassertin=
g
...
>>> have done many tests to ensure that my block is consuming data fast eno=
ugh
>>> so there are no overflows upstream.
>>>
>>> My understanding of how the RFNoC packets work is that the output of th=
e
...
>>> non-working cases. Likewise, on my blocks input, tvalid from the noc sh=
ell
...
>>> works as expected. When using RFNoC API, which sets the rate on the DDC=
 and
>>> starts streaming, we get the problem behavior. Is it possible that DDC0=
 and
>>> DDC1 are not sampling correctly when I am using RFNoC API to set the ra=
te
...
>>> RFNoC API application. I would expect a ddc output to be equidistant ba=
sed
>>> on the output sample rate. This is where the debugging is in the DDC bl=
ocks
...
>>> input sample_in_eob,
>>> (* dont_touch=3D"true",mark_debug=3D"true"*) output [31:0] sample_out_t=
data,
...
>>> David
>>>
>>> On Fri, Dec 20, 2024 at 4:11=E2=80=AFAM Martin Braun <martin.braun@ettu=
s.com>
>>> wrote:
>>>
>>>> David,
...
>>>>> alignment, even if they do not "fix" my issue, it is good for me to l=
ook at.
>>>>>
...
>>>>> base image and my image. I also was able to add a dummy port on my im=
age
...
>>>>> see that the AXI handshake is one packet with two parallel streams. I=
 will
...
>>>>> policy as you suggested and also try to add my own issue stream comma=
nd to
...
>>>>> David
>>>>>
>>>>> On Thu, Dec 19, 2024 at 3:24=E2=80=AFAM Martin Braun <martin.braun@et=
tus.com>
>>>>> wrote:
>>>>>
>>>>>> Hey David,
...
>>>>>> on that. However, maybe I'm forgetting something that would cause th=
e
>>>>>> outputs of the DDCs to misalign data by a few clock cycles. Which ma=
kes me
>>>>>> wonder: Are you sure your input packets are misaligned? In RFNoC, we=
 make
>>>>>> no guarantee that the output of the DDC (or any other) block is alig=
ned to
>>>>>> the clock cycle, because we encode the timestamp with the data. Mean=
ing
>>>>>> that the first, actual sample that arrives at your block on each cha=
nnel is
>>>>>> in fact time-aligned, they just arrive a few clock cycles apart. Thi=
s is
>>>>>> the same logic that applies when packets arrive at the host computer=
, where
...
>>>>>> actually align samples within your block, or you just do some AXI al=
ignment
...
>>>>>> set_action_forwarding_policy(forwarding_policy_t::ONE_TO_FAN, "strea=
m_cmd")
...
>>>>>>> available on the same clock cycle, similar to the rx_samples_to_fil=
e, while
>>>>>>> still using my 2 in/1 out RFNoC block? *
>>>>>>> I would like to focus the conversation on my C++ implementation for
>>>>>>> now. All my simulations have convinced me my block is consuming AXI=
-Stream
>>>>>>> data correctly.
>>>>>>>
>>>>>>> *Problem*
...
>>>>>>> rx_samples_to_file.cpp... rx_samples_to_file has repeatable alignme=
nt, and
>>>>>>> mine has random. This has led me to believe the problem is in my
>>>>>>> application and not my block. My Vivado simulations show my block i=
s able
...
>>>>>>> delayed by 1 sample. When using my application, I have seen no dela=
y
...
>>>>>>> stream command because I was having issues with my block propagatin=
g.
>>>>>>> Issuing to the DDCs lets the data flow from 2 inputs to the 1 outpu=
t, where
>>>>>>> the output is either a file or loopback to transmit.
>>>>>>>
>>>>>>> The base image with rx_samples_to_file uses a multi_usrp type, whic=
h
...
>>>>>>> collected by ILA cores at either the output of DDC or input of cust=
om
>>>>>>> block:
>>>>>>>
>>>>>>>    1. *Math: *When receiving correlated noise, I can measure the
>>>>>>>    cross correlation and show that the correlation peaks as expecte=
d, and show
>>>>>>>    the delay between channels in samples.
>>>>>>>    2. *Vivado Waveform Viewer*: When the ILA cores are collecting
>>>>>>>    DDC channel data, I can see that the base image samples are avai=
lable on
...
<div dir=3D"ltr"><div dir=3D"ltr">Hi David,<div>Just to clarify, functions =
in the file multi_usrp.cpp are only used for devices that don&#39;t support=
 rfnoc. For any device that supports rfnoc, the &quot;make&quot; function a=
t the bottom of multi_usrp.cpp simply makes a multi_usrp_rfnoc object when =
the user instantiates a multi_usrp object. So, when you are using it with y=
our device, it is using the functions from multi_usrp_rfnoc rather than mul=
ti_usrp.=C2=A0 If you change the UHD logging level to trace (which may requ=
ire a re-build), you will see that the rfnoc api functions are being called=
 (such as the ddc block controller &quot;issue_stream_cmd&quot; shown below=
).</div><div>Rob</div></div><br><div class=3D"gmail_quote gmail_quote_conta=
iner"><div dir=3D"ltr" class=3D"gmail_attr">On Mon, Dec 23, 2024 at 5:55=E2=
=80=AFPM David &lt;<a href=3D"mailto:vitishlsfan21@gmail.com">vitishlsfan21=
@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div dir=3D"ltr"><div>Rob,</div><div><br></div><div>Thank you fo=
r your response, I was actually unaware of the mutli_usrp_rfnoc class, and =
I see how it calls the same command. I now have an extra tool I can fiddle =
with after the holidays, plus the new FPGA debug images...</div><div><br></=
div><div>I have been using the multi_usrp.cpp class as my working case, whi=
ch came from the examples. It looks like it sets the stream property on the=
 ddc directly, whereas the RFNoC methods call a method post_action(dst_edge=
, new_action). Still looking into it, which will take some time. <br></div>=
<div><br></div><div><div style=3D"color:rgb(204,204,204);background-color:r=
gb(31,31,31);font-family:&quot;Droid Sans Mono&quot;,&quot;monospace&quot;,=
monospace;font-weight:normal;font-size:14px;line-height:19px;white-space:pr=
e-wrap"><div><span style=3D"color:rgb(106,153,85)">// multi_usrp</span></di=
v><div><span style=3D"color:rgb(204,204,204)">    </span><span style=3D"col=
or:rgb(86,156,214)">void</span><span style=3D"color:rgb(204,204,204)"> </sp=
an><span style=3D"color:rgb(220,220,170)">issue_stream_cmd</span><span styl=
e=3D"color:rgb(204,204,204)">(</span><span style=3D"color:rgb(86,156,214)">=
const</span><span style=3D"color:rgb(204,204,204)"> </span><span style=3D"c=
olor:rgb(78,201,176)">stream_cmd_t</span><span style=3D"color:rgb(86,156,21=
4)">&amp;</span><span style=3D"color:rgb(204,204,204)"> </span><span style=
=3D"color:rgb(156,220,254)">stream_cmd</span><span style=3D"color:rgb(204,2=
04,204)">, </span><span style=3D"color:rgb(86,156,214)">size_t</span><span =
style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:rgb(156,220,2=
54)">chan</span><span style=3D"color:rgb(204,204,204)">) </span><span style=
=3D"color:rgb(86,156,214)">override</span></div><div><span style=3D"color:r=
gb(204,204,204)">    {</span></div><div><span style=3D"color:rgb(204,204,20=
4)">        </span><span style=3D"color:rgb(197,134,192)">if</span><span st=
yle=3D"color:rgb(204,204,204)"> (chan </span><span style=3D"color:rgb(212,2=
12,212)">!=3D</span><span style=3D"color:rgb(204,204,204)"> ALL_CHANS) {</s=
pan></div><div><span style=3D"color:rgb(204,204,204)">            </span><s=
pan style=3D"color:rgb(156,220,254)">_tree</span><span style=3D"color:rgb(2=
04,204,204)">-&gt;</span><span style=3D"color:rgb(156,220,254)">access</spa=
n><span style=3D"color:rgb(212,212,212)">&lt;</span><span style=3D"color:rg=
b(78,201,176)">stream_cmd_t</span><span style=3D"color:rgb(212,212,212)">&g=
t;</span><span style=3D"color:rgb(204,204,204)">(</span><span style=3D"colo=
r:rgb(220,220,170)">rx_dsp_root</span><span style=3D"color:rgb(204,204,204)=
">(chan) </span><span style=3D"color:rgb(212,212,212)">/</span><span style=
=3D"color:rgb(204,204,204)"> </span><span style=3D"color:rgb(206,145,120)">=
&quot;stream_cmd&quot;</span><span style=3D"color:rgb(204,204,204)">).</spa=
n><span style=3D"color:rgb(220,220,170)">set</span><span style=3D"color:rgb=
(204,204,204)">(stream_cmd);</span></div><div><span style=3D"color:rgb(204,=
204,204)">            </span><span style=3D"color:rgb(197,134,192)">return<=
/span><span style=3D"color:rgb(204,204,204)">;</span></div><div><span style=
=3D"color:rgb(204,204,204)">        }</span></div><div><span style=3D"color=
:rgb(204,204,204)">        </span><span style=3D"color:rgb(197,134,192)">fo=
r</span><span style=3D"color:rgb(204,204,204)"> (</span><span style=3D"colo=
r:rgb(86,156,214)">size_t</span><span style=3D"color:rgb(204,204,204)"> c <=
/span><span style=3D"color:rgb(212,212,212)">=3D</span><span style=3D"color=
:rgb(204,204,204)"> </span><span style=3D"color:rgb(181,206,168)">0</span><=
span style=3D"color:rgb(204,204,204)">; c </span><span style=3D"color:rgb(2=
12,212,212)">&lt;</span><span style=3D"color:rgb(204,204,204)"> </span><spa=
n style=3D"color:rgb(220,220,170)">get_rx_num_channels</span><span style=3D=
"color:rgb(204,204,204)">(); c</span><span style=3D"color:rgb(212,212,212)"=
>++</span><span style=3D"color:rgb(204,204,204)">) {</span></div><div><span=
 style=3D"color:rgb(204,204,204)">            </span><span style=3D"color:r=
gb(220,220,170)">issue_stream_cmd</span><span style=3D"color:rgb(204,204,20=
4)">(stream_cmd, c);</span></div><div><span style=3D"color:rgb(204,204,204)=
">        }</span></div><div><span style=3D"color:rgb(204,204,204)">    }</=
span></div><br><div><span style=3D"color:rgb(106,153,85)">// multi_usrp_rfn=
oc</span></div><div><span style=3D"color:rgb(204,204,204)">    </span><span=
 style=3D"color:rgb(86,156,214)">void</span><span style=3D"color:rgb(204,20=
4,204)"> </span><span style=3D"color:rgb(220,220,170)">issue_stream_cmd</sp=
an><span style=3D"color:rgb(204,204,204)">(</span><span style=3D"color:rgb(=
86,156,214)">const</span><span style=3D"color:rgb(204,204,204)"> </span><sp=
an style=3D"color:rgb(78,201,176)">stream_cmd_t</span><span style=3D"color:=
rgb(86,156,214)">&amp;</span><span style=3D"color:rgb(204,204,204)"> </span=
><span style=3D"color:rgb(156,220,254)">stream_cmd</span><span style=3D"col=
or:rgb(204,204,204)">, </span><span style=3D"color:rgb(86,156,214)">size_t<=
/span><span style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:r=
gb(156,220,254)">chan</span><span style=3D"color:rgb(204,204,204)"> </span>=
<span style=3D"color:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(2=
04,204,204)"> ALL_CHANS) </span><span style=3D"color:rgb(86,156,214)">overr=
ide</span></div><div><span style=3D"color:rgb(204,204,204)">    {</span></d=
iv><div><span style=3D"color:rgb(204,204,204)">        </span><span style=
=3D"color:rgb(220,220,170)">MUX_RX_API_CALL</span><span style=3D"color:rgb(=
204,204,204)">(issue_stream_cmd, stream_cmd);</span></div><div><span style=
=3D"color:rgb(204,204,204)">        </span><span style=3D"color:rgb(86,156,=
214)">auto</span><span style=3D"color:rgb(212,212,212)">&amp;</span><span s=
tyle=3D"color:rgb(204,204,204)"> rx_chain </span><span style=3D"color:rgb(2=
12,212,212)">=3D</span><span style=3D"color:rgb(204,204,204)"> </span><span=
 style=3D"color:rgb(220,220,170)">_get_rx_chan</span><span style=3D"color:r=
gb(204,204,204)">(chan);</span></div><div><span style=3D"color:rgb(204,204,=
204)">        </span><span style=3D"color:rgb(197,134,192)">if</span><span =
style=3D"color:rgb(204,204,204)"> (</span><span style=3D"color:rgb(156,220,=
254)">rx_chain</span><span style=3D"color:rgb(204,204,204)">.</span><span s=
tyle=3D"color:rgb(156,220,254)">ddc</span><span style=3D"color:rgb(204,204,=
...
ddc</span><span style=3D"color:rgb(204,204,204)">-&gt;</span><span style=3D=
"color:rgb(220,220,170)">issue_stream_cmd</span><span style=3D"color:rgb(20=
4,204,204)">(stream_cmd, </span><span style=3D"color:rgb(156,220,254)">rx_c=
hain</span><span style=3D"color:rgb(204,204,204)">.</span><span style=3D"co=
lor:rgb(156,220,254)">block_chan</span><span style=3D"color:rgb(204,204,204=
)">);</span></div><div><span style=3D"color:rgb(204,204,204)">        } </s=
pan><span style=3D"color:rgb(197,134,192)">else</span><span style=3D"color:=
rgb(204,204,204)"> {</span></div><div><span style=3D"color:rgb(204,204,204)=
">            </span><span style=3D"color:rgb(156,220,254)">rx_chain</span>=
<span style=3D"color:rgb(204,204,204)">.</span><span style=3D"color:rgb(156=
,220,254)">radio</span><span style=3D"color:rgb(204,204,204)">-&gt;</span><=
span style=3D"color:rgb(220,220,170)">issue_stream_cmd</span><span style=3D=
"color:rgb(204,204,204)">(stream_cmd, </span><span style=3D"color:rgb(156,2=
20,254)">rx_chain</span><span style=3D"color:rgb(204,204,204)">.</span><spa=
n style=3D"color:rgb(156,220,254)">block_chan</span><span style=3D"color:rg=
b(204,204,204)">);</span></div><div><span style=3D"color:rgb(204,204,204)">=
        }</span></div><div><span style=3D"color:rgb(204,204,204)">    }</sp=
an></div><br><br><div><span style=3D"color:rgb(106,153,85)">// ddc block co=
ntroller</span></div><div><span style=3D"color:rgb(204,204,204)">    </span=
><span style=3D"color:rgb(86,156,214)">void</span><span style=3D"color:rgb(=
204,204,204)"> </span><span style=3D"color:rgb(220,220,170)">issue_stream_c=
md</span><span style=3D"color:rgb(204,204,204)">(</span><span style=3D"colo=
r:rgb(86,156,214)">const</span><span style=3D"color:rgb(204,204,204)"> </sp=
an><span style=3D"color:rgb(78,201,176)">uhd</span><span style=3D"color:rgb=
(204,204,204)">::</span><span style=3D"color:rgb(78,201,176)">stream_cmd_t<=
/span><span style=3D"color:rgb(86,156,214)">&amp;</span><span style=3D"colo=
r:rgb(204,204,204)"> </span><span style=3D"color:rgb(156,220,254)">stream_c=
md</span><span style=3D"color:rgb(204,204,204)">, </span><span style=3D"col=
or:rgb(86,156,214)">const</span><span style=3D"color:rgb(204,204,204)"> </s=
pan><span style=3D"color:rgb(86,156,214)">size_t</span><span style=3D"color=
:rgb(204,204,204)"> </span><span style=3D"color:rgb(156,220,254)">port</spa=
n><span style=3D"color:rgb(204,204,204)">) </span><span style=3D"color:rgb(=
86,156,214)">override</span></div><div><span style=3D"color:rgb(204,204,204=
)">    {</span></div><div><span style=3D"color:rgb(204,204,204)">        </=
span><span style=3D"color:rgb(220,220,170)">RFNOC_LOG_TRACE</span><span sty=
le=3D"color:rgb(204,204,204)">(</span><span style=3D"color:rgb(206,145,120)=
">&quot;issue_stream_cmd(stream_mode=3D&quot;</span><span style=3D"color:rg=
b(204,204,204)"> </span><span style=3D"color:rgb(212,212,212)">&lt;&lt;</sp=
an><span style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:rgb(=
86,156,214)">char</span><span style=3D"color:rgb(204,204,204)">(</span><spa=
n style=3D"color:rgb(156,220,254)">stream_cmd</span><span style=3D"color:rg=
b(204,204,204)">.</span><span style=3D"color:rgb(156,220,254)">stream_mode<=
/span><span style=3D"color:rgb(204,204,204)">)</span></div><div><span style=
=3D"color:rgb(204,204,204)">                                               =
         </span><span style=3D"color:rgb(212,212,212)">&lt;&lt;</span><span=
 style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:rgb(206,145,=
120)">&quot;, port=3D&quot;</span><span style=3D"color:rgb(204,204,204)"> <=
/span><span style=3D"color:rgb(212,212,212)">&lt;&lt;</span><span style=3D"=
color:rgb(204,204,204)"> port);</span></div><div><span style=3D"color:rgb(2=
04,204,204)">        res_source_info dst_edge{</span><span style=3D"color:r=
gb(78,201,176)">res_source_info</span><span style=3D"color:rgb(204,204,204)=
">::OUTPUT_EDGE, port};</span></div><div><span style=3D"color:rgb(204,204,2=
04)">        </span><span style=3D"color:rgb(86,156,214)">auto</span><span =
style=3D"color:rgb(204,204,204)"> new_action        </span><span style=3D"c=
olor:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(204,204,204)"> </=
span><span style=3D"color:rgb(78,201,176)">stream_cmd_action_info</span><sp=
an style=3D"color:rgb(204,204,204)">::</span><span style=3D"color:rgb(220,2=
20,170)">make</span><span style=3D"color:rgb(204,204,204)">(</span><span st=
yle=3D"color:rgb(156,220,254)">stream_cmd</span><span style=3D"color:rgb(20=
4,204,204)">.</span><span style=3D"color:rgb(156,220,254)">stream_mode</spa=
n><span style=3D"color:rgb(204,204,204)">);</span></div><div><span style=3D=
"color:rgb(204,204,204)">        </span><span style=3D"color:rgb(156,220,25=
4)">new_action</span><span style=3D"color:rgb(204,204,204)">-&gt;</span><sp=
an style=3D"color:rgb(156,220,254)">stream_cmd</span><span style=3D"color:r=
gb(204,204,204)"> </span><span style=3D"color:rgb(212,212,212)">=3D</span><=
span style=3D"color:rgb(204,204,204)"> stream_cmd;</span></div><div><span s=
tyle=3D"color:rgb(204,204,204)">        </span><span style=3D"color:rgb(220=
,220,170)">issue_stream_cmd_action_handler</span><span style=3D"color:rgb(2=
04,204,204)">(dst_edge, new_action);</span></div><div><span style=3D"color:=
rgb(204,204,204)">    }</span></div></div></div><div><br></div><div>Thanks,=
</div><div><br></div><div>David<br></div></div><br><div class=3D"gmail_quot=
e"><div dir=3D"ltr" class=3D"gmail_attr">On Mon, Dec 23, 2024 at 8:28=E2=80=
=AFAM Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu" target=3D"_blank">=
rkossler@nd.edu</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" s=
tyle=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);pad=
ding-left:1ex"><div dir=3D"ltr"><div>Hi David,</div><div>Your email disting=
uishes between the multi_usrp API and the rfnoc API. But, under the hood, t=
he <a href=3D"https://github.com/EttusResearch/uhd/blob/master/host/lib/usr=
p/multi_usrp_rfnoc.cpp" target=3D"_blank">multi_usrp API</a> implements all=
 of its functionality with the rfnoc API.=C2=A0 So, it seems that the multi=
_usrp implementation (using rfnoc API commands) is doing something differen=
t than your own implementation (using rfnoc API commands).=C2=A0 I realize =
that this is not a very helpful comment but perhaps if you take a closer lo=
ok at the multi_usrp_rfnoc class, you might find something different in the=
 underlying commands.</div><div>Rob</div><br><div class=3D"gmail_quote"><di=
v dir=3D"ltr" class=3D"gmail_attr">On Fri, Dec 20, 2024 at 5:10=E2=80=AFPM =
David &lt;<a href=3D"mailto:vitishlsfan21@gmail.com" target=3D"_blank">viti=
shlsfan21@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quot=
e" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204)=
;padding-left:1ex"><div dir=3D"ltr">Martin,<div><br></div><div>I don&#39;t =
have waveform viewer screenshots yet of the inputs (working on it), but I h=
ave run the simulation with a packet delayed 500 clock cycles on one of my =
block&#39;s channels. I can see that my block &quot;waits&quot; for the sec=
ond channel, which aligns the axi transaction. This is because my block=C2=
=A0is an HLS block that is data driven,=C2=A0and won&#39;t be ready unless =
it has both inputs. I verified the output data from the delayed packet simu=
lation. Because of these factors, I think it is unlikely my block is deasse=
rting tready=C2=A0in my FPGA images.=C2=A0</div><div><br></div><div>Simulat=
ion output with a delayed packet on channel 1:</div><div><img src=3D"cid:ii=
_m4x9nsmt7" alt=3D"delayed_port1_packet.png" width=3D"1266" height=3D"268" =
style=3D"margin-right: 0px;"><br><br></div><div><br></div><div>I also know =
the maximum sample rate we can run with on my block, and have done many tes=
ts to ensure that my block=C2=A0is consuming data fast enough so there are =
no overflows upstream.</div><div><br></div><div>My understanding of how the=
 RFNoC packets work is that the output of the DDC is filling a packet forme=
d in the NoC shell, which is then released once the 64 samples are filled. =
You can see that the DDC0 and DDC1 <b>tready</b> in all my debug screenshot=
s is always asserted, even in the non-working cases. Likewise, on my blocks=
 input, tvalid from the noc shell is always asserted, while my blocks tread=
y=C2=A0drives the transaction.</div><div><br></div><div>Where we are now,=
=C2=A0is that using the usrp and multi_usrp APIs, my block works as expecte=
d. When using RFNoC API, which sets the rate on the DDC and starts streamin=
g, we get the problem behavior. Is it possible that DDC0 and DDC1 are not s=
ampling correctly when I am using RFNoC API to set the rate and start strea=
ming? I have seen a difference before between the APIs, where the multi_usr=
p was able to set the center frequency on the base image, and the RFNoC API=
 kept the center frequency at 0 MHz. <br></div><div><br></div><div>I don&#3=
9;t understand why the clock distance between the tvalids on DDC0 and DDC1 =
would change in my previous images, which only happens on the RFNoC API app=
lication. I would expect a ddc output to be equidistant based on the output=
 sample rate. This is where the debugging is in the DDC blocks (uhd/fpga/us=
rp3/lib/rfnoc/ddc.v):</div><div><br></div><div><div style=3D"color:rgb(204,=
204,204);background-color:rgb(31,31,31);font-family:&quot;Droid Sans Mono&q=
uot;,&quot;monospace&quot;,monospace;font-weight:normal;font-size:14px;line=
-height:19px;white-space:pre-wrap"><div><span style=3D"color:rgb(106,153,85=
)">//! RFNoC specific digital down-conversion chain</span></div><br><div><s=
pan style=3D"color:rgb(86,156,214)">module</span><span style=3D"color:rgb(2=
04,204,204)"> </span><span style=3D"color:rgb(78,201,176)">ddc</span><span =
...
/span><span style=3D"color:rgb(204,204,204)"> SR_FREQ_ADDR     </span><span=
 style=3D"color:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(204,20=
4,204)"> </span><span style=3D"color:rgb(181,206,168)">0</span><span style=
...
span style=3D"color:rgb(204,204,204)"> SR_SCALE_IQ_ADDR </span><span style=
=3D"color:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(204,204,204)=
"> </span><span style=3D"color:rgb(181,206,168)">1</span><span style=3D"col=
or:rgb(204,204,204)">,</span></div><div><span style=3D"color:rgb(204,204,20=
4)">  </span><span style=3D"color:rgb(86,156,214)">parameter</span><span st=
yle=3D"color:rgb(204,204,204)"> SR_DECIM_ADDR    </span><span style=3D"colo=
r:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(204,204,204)"> </spa=
n><span style=3D"color:rgb(181,206,168)">2</span><span style=3D"color:rgb(2=
04,204,204)">,</span></div><div><span style=3D"color:rgb(204,204,204)">  </=
span><span style=3D"color:rgb(86,156,214)">parameter</span><span style=3D"c=
olor:rgb(204,204,204)"> SR_MUX_ADDR      </span><span style=3D"color:rgb(21=
2,212,212)">=3D</span><span style=3D"color:rgb(204,204,204)"> </span><span =
style=3D"color:rgb(181,206,168)">3</span><span style=3D"color:rgb(204,204,2=
04)">,</span></div><div><span style=3D"color:rgb(204,204,204)">  </span><sp=
an style=3D"color:rgb(86,156,214)">parameter</span><span style=3D"color:rgb=
(204,204,204)"> SR_COEFFS_ADDR   </span><span style=3D"color:rgb(212,212,21=
2)">=3D</span><span style=3D"color:rgb(204,204,204)"> </span><span style=3D=
"color:rgb(181,206,168)">4</span><span style=3D"color:rgb(204,204,204)">,</=
...
,204)"> PRELOAD_HBS      </span><span style=3D"color:rgb(212,212,212)">=3D<=
/span><span style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:r=
gb(181,206,168)">1</span><span style=3D"color:rgb(204,204,204)">, </span><s=
pan style=3D"color:rgb(106,153,85)">// Preload half band filter state with =
0s</span></div><div><span style=3D"color:rgb(204,204,204)">  </span><span s=
tyle=3D"color:rgb(86,156,214)">parameter</span><span style=3D"color:rgb(204=
,204,204)"> NUM_HB           </span><span style=3D"color:rgb(212,212,212)">=
=3D</span><span style=3D"color:rgb(204,204,204)"> </span><span style=3D"col=
or:rgb(181,206,168)">3</span><span style=3D"color:rgb(204,204,204)">,</span=
...
)"> CIC_MAX_DECIM    </span><span style=3D"color:rgb(212,212,212)">=3D</spa=
n><span style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:rgb(1=
81,206,168)">255</span><span style=3D"color:rgb(204,204,204)">,</span></div=
><div><span style=3D"color:rgb(204,204,204)">  </span><span style=3D"color:=
rgb(86,156,214)">parameter</span><span style=3D"color:rgb(204,204,204)"> SA=
MPLE_WIDTH     </span><span style=3D"color:rgb(212,212,212)">=3D</span><spa=
n style=3D"color:rgb(204,204,204)"> </span><span style=3D"color:rgb(181,206=
,168)">16</span><span style=3D"color:rgb(204,204,204)">,</span></div><div><=
span style=3D"color:rgb(204,204,204)">  </span><span style=3D"color:rgb(86,=
156,214)">parameter</span><span style=3D"color:rgb(204,204,204)"> WIDTH    =
...
24</span></div><div><span style=3D"color:rgb(204,204,204)">)(</span></div><=
div><span style=3D"color:rgb(204,204,204)">  </span><span style=3D"color:rg=
b(86,156,214)">input</span><span style=3D"color:rgb(204,204,204)"> clk, </s=
pan><span style=3D"color:rgb(86,156,214)">input</span><span style=3D"color:=
rgb(204,204,204)"> reset,</span></div><div><span style=3D"color:rgb(204,204=
,204)">  </span><span style=3D"color:rgb(86,156,214)">input</span><span sty=
le=3D"color:rgb(204,204,204)"> clear, </span><span style=3D"color:rgb(106,1=
53,85)">// Resets everything except the timed phase inc FIFO and phase inc<=
...
4)"> set_stb, </span><span style=3D"color:rgb(86,156,214)">input</span><spa=
n style=3D"color:rgb(204,204,204)"> [</span><span style=3D"color:rgb(181,20=
6,168)">7</span><span style=3D"color:rgb(204,204,204)">:</span><span style=
=3D"color:rgb(181,206,168)">0</span><span style=3D"color:rgb(204,204,204)">=
] set_addr, </span><span style=3D"color:rgb(86,156,214)">input</span><span =
...
=3D"color:rgb(181,206,168)">0</span><span style=3D"color:rgb(204,204,204)">=
] set_data,</span></div><div><span style=3D"color:rgb(204,204,204)">  </spa=
n><span style=3D"color:rgb(86,156,214)">input</span><span style=3D"color:rg=
b(204,204,204)"> timed_set_stb, </span><span style=3D"color:rgb(86,156,214)=
">input</span><span style=3D"color:rgb(204,204,204)"> [</span><span style=
=3D"color:rgb(181,206,168)">7</span><span style=3D"color:rgb(204,204,204)">=
:</span><span style=3D"color:rgb(181,206,168)">0</span><span style=3D"color=
:rgb(204,204,204)">] timed_set_addr, </span><span style=3D"color:rgb(86,156=
,214)">input</span><span style=3D"color:rgb(204,204,204)"> [</span><span st=
yle=3D"color:rgb(181,206,168)">31</span><span style=3D"color:rgb(204,204,20=
4)">:</span><span style=3D"color:rgb(181,206,168)">0</span><span style=3D"c=
olor:rgb(204,204,204)">] timed_set_data,</span></div><div><span style=3D"co=
lor:rgb(204,204,204)">  </span><span style=3D"color:rgb(86,156,214)">input<=
...
204,204)">] sample_in_tdata,</span></div><div><span style=3D"color:rgb(204,=
204,204)">  </span><span style=3D"color:rgb(86,156,214)">input</span><span =
style=3D"color:rgb(204,204,204)"> sample_in_tvalid,</span></div><div><span =
style=3D"color:rgb(204,204,204)">  </span><span style=3D"color:rgb(86,156,2=
14)">input</span><span style=3D"color:rgb(204,204,204)"> sample_in_tlast,</=
span></div><div><span style=3D"color:rgb(204,204,204)">  (</span><span styl=
e=3D"color:rgb(212,212,212)">*</span><span style=3D"color:rgb(204,204,204)"=
> dont_touch</span><span style=3D"color:rgb(212,212,212)">=3D</span><span s=
tyle=3D"color:rgb(206,145,120)">&quot;true&quot;</span><span style=3D"color=
:rgb(204,204,204)">,mark_debug</span><span style=3D"color:rgb(212,212,212)"=
>=3D</span><span style=3D"color:rgb(206,145,120)">&quot;true&quot;</span><s=
pan style=3D"color:rgb(212,212,212)">*</span><span style=3D"color:rgb(204,2=
04,204)">) </span><span style=3D"color:rgb(86,156,214)">output</span><span =
style=3D"color:rgb(204,204,204)"> sample_in_tready,</span></div><div><span =
style=3D"color:rgb(204,204,204)">  </span><span style=3D"color:rgb(86,156,2=
14)">input</span><span style=3D"color:rgb(204,204,204)"> sample_in_tuser,</=
span></div><div><span style=3D"color:rgb(204,204,204)">  </span><span style=
=3D"color:rgb(86,156,214)">input</span><span style=3D"color:rgb(204,204,204=
)"> sample_in_eob,</span></div><div><span style=3D"color:rgb(204,204,204)">=
  (</span><span style=3D"color:rgb(212,212,212)">*</span><span style=3D"col=
or:rgb(204,204,204)"> dont_touch</span><span style=3D"color:rgb(212,212,212=
)">=3D</span><span style=3D"color:rgb(206,145,120)">&quot;true&quot;</span>=
<span style=3D"color:rgb(204,204,204)">,mark_debug</span><span style=3D"col=
or:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(206,145,120)">&quot=
;true&quot;</span><span style=3D"color:rgb(212,212,212)">*</span><span styl=
e=3D"color:rgb(204,204,204)">) </span><span style=3D"color:rgb(86,156,214)"=
>output</span><span style=3D"color:rgb(204,204,204)"> [</span><span style=
=3D"color:rgb(181,206,168)">31</span><span style=3D"color:rgb(204,204,204)"=
>:</span><span style=3D"color:rgb(181,206,168)">0</span><span style=3D"colo=
r:rgb(204,204,204)">] sample_out_tdata,</span></div><div><span style=3D"col=
or:rgb(204,204,204)">  (</span><span style=3D"color:rgb(212,212,212)">*</sp=
an><span style=3D"color:rgb(204,204,204)"> dont_touch</span><span style=3D"=
color:rgb(212,212,212)">=3D</span><span style=3D"color:rgb(206,145,120)">&q=
uot;true&quot;</span><span style=3D"color:rgb(204,204,204)">,mark_debug</sp=
an><span style=3D"color:rgb(212,212,212)">=3D</span><span style=3D"color:rg=
b(206,145,120)">&quot;true&quot;</span><span style=3D"color:rgb(212,212,212=
)">*</span><span style=3D"color:rgb(204,204,204)">) </span><span style=3D"c=
olor:rgb(86,156,214)">output</span><span style=3D"color:rgb(204,204,204)"> =
sample_out_tvalid,</span></div><div><span style=3D"color:rgb(204,204,204)">=
  </span><span style=3D"color:rgb(86,156,214)">input</span><span style=3D"c=
olor:rgb(204,204,204)"> sample_out_tready,</span></div><div><span style=3D"=
color:rgb(204,204,204)">  </span><span style=3D"color:rgb(86,156,214)">outp=
ut</span><span style=3D"color:rgb(204,204,204)"> sample_out_tlast</span></d=
iv><div><span style=3D"color:rgb(204,204,204)">);</span></div></div></div><=
div><br></div><div>Thanks,</div><div><br></div><div>David <br></div></div><=
br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Fri,=
 Dec 20, 2024 at 4:11=E2=80=AFAM Martin Braun &lt;<a href=3D"mailto:martin.=
braun@ettus.com" target=3D"_blank">martin.braun@ettus.com</a>&gt; wrote:<br=
></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;=
border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><=
div>David,</div><div><br></div><div>is it possible that your block is deass=
erting tready on one of its inputs, thus delaying the DDC?</div><div><br></=
div><div>--M<br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr"=
 class=3D"gmail_attr">On Fri, Dec 20, 2024 at 3:27=E2=80=AFAM David &lt;<a =
...
div dir=3D"ltr">Martin,=C2=A0<div><br></div><div>Thanks for the reply. I wi=
ll take any modules you suggest for AXI alignment, even if they do not &quo=
t;fix&quot; my issue, it is good for me to look at.</div><div><br></div><di=
v>1. thanks for the comment, this block is a long time coming.</div><div><b=
r></div><div>2. We captured some screen shots of the ILA core recording bot=
h the base image and my image. I also was able to add a dummy port on my im=
age and run the <i>rx_samples_to_file </i>on that (because it was staticall=
y connected), which confirmed=C2=A0that the multi_usrp method producing the=
 expected results, with/without my block in line:</div><div><br></div><div>=
below I present some screenshots of the behavior, where the ILA is capturin=
g the output of both DDCs <i>before</i>=C2=A0packetization.<b> What is not =
shown is the multi_usrp method running with=C2=A0my block, but it has the s=
ame behavior as the base image</b><b>:</b></div><div><br></div><div><b>Base=
 Image, with rx_samples_to_file (multi_usrp)</b></div><div>Example 1: zoome=
d in run</div><div><img src=3D"cid:ii_m4w4843v6" alt=3D"base_image_zoomed.P=
NG" width=3D"739" height=3D"142" style=3D"margin-right: 0px;"><br></div><di=
v>Example 2: different run, zoomed out. both DDCs perform as expected:</div=
><div><img src=3D"cid:ii_m4w4gywn10" alt=3D"base_image_zoomed_out.PNG" widt=
h=3D"743" height=3D"146" style=3D"margin-right: 0px;"><br></div><div><br></=
div><div><br></div><div><b>Custom Image, with davids_rx_to_file (ddc_block_=
controller)</b></div><div>Example 1: random distance between samples on bot=
h DDCs, clear on DDC1. The last 4 valids have a big change in cycle distanc=
e.</div><div><img src=3D"cid:ii_m4w4ac0d7" alt=3D"random_dist.PNG" width=3D=
"735" height=3D"140" style=3D"margin-right: 0px;"><br></div><div>Example 2:=
 a different run, same behavior as above and time tags.</div><div><img src=
=3D"cid:ii_m4w4cwr48" alt=3D"time_tags.PNG" width=3D"737" height=3D"157" st=
yle=3D"margin-right: 0px;"><br></div><div>Example 3: A run where it &quot;a=
lmost&quot; worked, and my block also &quot;almost worked&quot;. You can se=
e the alignment slips at the end:</div><div><img src=3D"cid:ii_m4w4esko9" a=
lt=3D"Timing_mostly_aligned.PNG" width=3D"720" height=3D"180" style=3D"marg=
in-right: 0px;"><br></div><div><br></div><div><br></div><div>3. right now i=
n the yaml I am using the named inputs with one port each:</div><div><br></=
div><div><div style=3D"color:rgb(204,204,204);background-color:rgb(31,31,31=
);font-family:Consolas,&quot;Courier New&quot;,monospace;font-size:14px;lin=
e-height:19px;white-space:pre-wrap"><div><span style=3D"color:rgb(86,156,21=
4)">data</span>:</div><div>=C2=A0 <span style=3D"color:rgb(86,156,214)">fpg=
a_iface</span>: <span style=3D"color:rgb(206,145,120)">axis_data</span></di=
v><div>=C2=A0 <span style=3D"color:rgb(86,156,214)">clk_domain</span>: <spa=
n style=3D"color:rgb(206,145,120)">rfnoc_chdr</span></div><div>=C2=A0 <span=
 style=3D"color:rgb(86,156,214)">inputs</span>:</div><div>=C2=A0 =C2=A0 <sp=
an style=3D"color:rgb(86,156,214)">in_1</span>:</div><div>=C2=A0 =C2=A0 =C2=
=A0 <span style=3D"color:rgb(86,156,214)">num_ports</span>: <span style=3D"=
color:rgb(181,206,168)">1</span></div><div>=C2=A0 =C2=A0 =C2=A0 <span style=
=3D"color:rgb(181,206,168)">...</span></div><div>=C2=A0 =C2=A0 <span style=
=3D"color:rgb(86,156,214)">in_2</span>:</div><div>=C2=A0 =C2=A0 =C2=A0 <spa=
...
r:rgb(181,206,168)">...</span></div></div></div><div><br></div><div>I have =
done some experiments with one named input with 2 port, and I see that the =
AXI handshake is one packet with two parallel streams. I will try to &quot;=
AXI align&quot; as you suggested with this first:</div><div><div style=3D"b=
ackground-color:rgb(31,31,31);font-family:Consolas,&quot;Courier New&quot;,=
monospace;font-size:14px;line-height:19px;white-space:pre-wrap"><div style=
=3D"color:rgb(204,204,204)"><span style=3D"color:rgb(86,156,214)">data</spa=
n>:</div><div style=3D"color:rgb(204,204,204)">=C2=A0 <span style=3D"color:=
rgb(86,156,214)">fpga_iface</span>: <span style=3D"color:rgb(206,145,120)">=
axis_data</span></div><div style=3D"color:rgb(204,204,204)">=C2=A0 <span st=
yle=3D"color:rgb(86,156,214)">clk_domain</span>: <span style=3D"color:rgb(2=
06,145,120)">rfnoc_chdr</span></div><div style=3D"color:rgb(204,204,204)">=
=C2=A0 <span style=3D"color:rgb(86,156,214)">inputs</span>:</div><div style=
=3D"color:rgb(204,204,204)">=C2=A0 =C2=A0 <span style=3D"color:rgb(86,156,2=
14)">in</span>:</div><div><font color=3D"#cccccc">=C2=A0 =C2=A0 =C2=A0 </fo=
nt><span style=3D"color:rgb(86,156,214)">num_ports</span><font color=3D"#cc=
cccc">: </font><font color=3D"#b5cea8">2</font></div><div style=3D"color:rg=
b(204,204,204)">=C2=A0 =C2=A0 =C2=A0 <span style=3D"color:rgb(181,206,168)"=
>...</span></div></div></div><div><br></div><div>4. right now, since I want=
 to issue the streaming command while doing <b>record to file</b> and <b>tr=
ansmit loopback</b>, I will start with the forwarding policy as you suggest=
ed and also try to add my own issue stream command to my block. It is not t=
rivial for me since I am not a C++ person, so I won&#39;t be able to provid=
e much feedback on that effort.</div><div><br></div><div>Thanks,</div><div>=
<br></div><div>David</div></div></div></div></div><br><div class=3D"gmail_q=
uote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Dec 19, 2024 at 3:24=E2=
=80=AFAM Martin Braun &lt;<a href=3D"mailto:martin.braun@ettus.com" target=
=3D"_blank">martin.braun@ettus.com</a>&gt; wrote:<br></div><blockquote clas=
s=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid r=
gb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Hey David,</div><di=
v><br></div><div>this looks like you&#39;ve gotten pretty far on a sophisti=
cated project!=C2=A0 I have a few observations:<br></div><div><br></div><di=
v>- At first glance, your C++ looks correct.</div><div>- I would expect sam=
ples to arrive at your block synchronously based on that. However, maybe I&=
#39;m forgetting something that would cause the outputs of the DDCs to misa=
lign data by a few clock cycles. Which makes me wonder: Are you sure your i=
nput packets are misaligned? In RFNoC, we make no guarantee that the output=
 of the DDC (or any other) block is aligned to the clock cycle, because we =
encode the timestamp with the data. Meaning that the first, actual sample t=
hat arrives at your block on each channel is in fact time-aligned, they jus=
t arrive a few clock cycles apart. This is the same logic that applies when=
 packets arrive at the host computer, where we make no assumptions that the=
y arrive at the exact same time.</div><div>- If this is the issue, I think =
we have some modules you can use to actually align samples within your bloc=
k, or you just do some AXI alignment yourself by combining the tready and t=
valid signals of two streams.<br></div><div>- Side note, although it&#39;s =
not important: I would consider it a best practice to have your block call =
set_action_forwarding_policy(forwarding_policy_t::ONE_TO_FAN, &quot;stream_=
cmd&quot;) so it would properly forward stream commands, and then you can p=
lop the stream command into the streamer.</div><div><br></div><div>--M<br><=
/div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_a=
ttr">On Sun, Dec 15, 2024 at 10:49=E2=80=AFPM David &lt;<a href=3D"mailto:v=
itishlsfan21@gmail.com" target=3D"_blank">vitishlsfan21@gmail.com</a>&gt; w=
rote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0p=
x 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=
=3D"ltr"><div dir=3D"ltr">Hello all,<div><br></div><div>I apologize in adva=
nce for=C2=A0data=C2=A0dumping. I have made a 2 input/1 output RFNoC block =
that requires repeatable synchronized DDC starts. My current method of star=
ting the DDC is not working as desired.</div><div><br></div><div><b><u>Ques=
tion</u>=C2=A0-=C2=A0</b><b>How can I correctly start both DDC&#39;s so sam=
ples are available on the same clock cycle, similar to the rx_samples_to_fi=
le, while still using my 2 in/1 out RFNoC block?=C2=A0</b></div><div>I woul=
d like to focus the conversation on my C++ implementation for now. All my s=
imulations have convinced me my block is consuming AXI-Stream data correctl=
y.</div><div><br></div><div><b><u>Problem</u></b></div><div>When starting t=
wo DDCs with=C2=A0timed commands sent to DDC in my C++ application,<i>=C2=
=A0</i>I am not getting the same result as the rx_samples_to_file.cpp... rx=
_samples_to_file has repeatable alignment, and mine has random. This has le=
d me to believe the problem is in my application and not my block. My Vivad=
o simulations show my block is able to consume the AXI-Stream transactions =
in parallel as I expect.</div><div><br></div><div>Considering sampling nois=
e from a sig gen that is split to both inputs, I see the following behavior=
:=C2=A0</div><div><table cellspacing=3D"0" cellpadding=3D"0" dir=3D"ltr" bo=
rder=3D"1" style=3D"table-layout:fixed;font-size:10pt;font-family:Arial;wid=
th:0px;border-collapse:collapse;border:medium"><colgroup><col width=3D"100"=
><col width=3D"100"><col width=3D"100"><col width=3D"100"><col width=3D"100=
"><col width=3D"100"><col width=3D"23"><col width=3D"100"><col width=3D"100=
"><col width=3D"100"><col width=3D"100"><col width=3D"100"><col width=3D"10=
0"></colgroup><tbody><tr style=3D"height:21px"><td style=3D"border:1px soli=
d rgb(0,0,0);overflow:hidden;padding:2px 3px;vertical-align:bottom"></td><t=
d style=3D"border-width:1px;border-style:solid;border-color:rgb(0,0,0) rgb(=
0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical=
-align:bottom;font-size:12pt;font-weight:bold;text-align:center" rowspan=3D=
"1" colspan=3D"5">rx_samples_to_file (base image)</td><td style=3D"border-w=
idth:1px;border-style:solid;border-color:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) r=
gb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;backg=
round-color:rgb(0,0,0)"></td><td style=3D"border-width:1px;border-style:sol=
id;border-color:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:=
hidden;padding:2px 3px;vertical-align:bottom"></td><td style=3D"border-widt=
h:1px;border-style:solid;border-color:rgb(0,0,0) rgb(0,0,0) rgb(0,0,0) rgb(=
204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-siz=
e:12pt;font-weight:bold;text-align:center" rowspan=3D"1" colspan=3D"5">davi=
ds_samples_to_file (custom image)</td></tr><tr style=3D"height:21px"><td st=
...
ont-weight:bold">DDC A samples</td><td style=3D"border-width:1px;border-sty=
le:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,20=
4);overflow:hidden;padding:2px 3px;vertical-align:bottom;font-size:14pt">..=
...
x 3px;vertical-align:bottom">X_1</td><td style=3D"border-width:1px;border-s=
tyle:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,=
204);overflow:hidden;padding:2px 3px;vertical-align:bottom">Y_1</td><td sty=
...
l-align:bottom">Z_1</td><td style=3D"border-width:1px;border-style:solid;bo=
...
cal-align:bottom;background-color:rgb(0,0,0)"></td><td style=3D"border-widt=
h:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0=
) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:bottom;fo=
nt-weight:bold">DDC A samples</td><td style=3D"border-width:1px;border-styl=
...
204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px=
 3px;vertical-align:bottom">X_1</td><td style=3D"border-width:1px;border-st=
yle:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,2=
04);overflow:hidden;padding:2px 3px;vertical-align:bottom">Y_1</td><td styl=
e=3D"border-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(=
0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical=
-align:bottom">Z_1</td><td style=3D"border-width:1px;border-style:solid;bor=
...
tr style=3D"height:21px"><td style=3D"border-width:1px;border-style:solid;b=
order-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0);overflow:hidden;padding:=
2px 3px;vertical-align:bottom;font-weight:bold">DDC B samples</td><td style=
...
tyle:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,=
204);overflow:hidden;padding:2px 3px;vertical-align:bottom">X_2</td><td sty=
le=3D"border-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb=
(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertica=
l-align:bottom">Y_2</td><td style=3D"border-width:1px;border-style:solid;bo=
rder-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow=
:hidden;padding:2px 3px;vertical-align:bottom">Z_2</td><td style=3D"border-=
width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0=
,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:botto=
m;font-size:14pt">...</td><td style=3D"border-width:1px;border-style:solid;=
border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overfl=
ow:hidden;padding:2px 3px;vertical-align:bottom;background-color:rgb(0,0,0)=
"></td><td style=3D"border-width:1px;border-style:solid;border-color:rgb(20=
4,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2=
px 3px;vertical-align:bottom;font-weight:bold">DDC B samples</td><td style=
=3D"border-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0=
,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-=
align:bottom">X_2</td><td style=3D"border-width:1px;border-style:solid;bord=
er-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:h=
idden;padding:2px 3px;vertical-align:bottom">Y_2</td><td style=3D"border-wi=
...
>Z_2</td><td style=3D"border-width:1px;border-style:solid;border-color:rgb(=
204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding=
:2px 3px;vertical-align:bottom;font-size:14pt">...</td><td style=3D"border-=
width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0=
,0,0) rgb(204,204,204);overflow:hidden;padding:2px 3px;vertical-align:botto=
m;font-size:14pt">...</td></tr></tbody></table></div><div><b><u><br></u></b=
></div><div>*sample_1 is not equal to sample_2, but over a large number of =
samples they will correlate well.=C2=A0</div><div><br></div><div>In the abo=
ve example, the noise correlates as expected, but it is delayed by 1 sample=
. When using my application, I have seen no delay (desired), and also delay=
 in the range of 5 samples.=C2=A0</div><div><br></div><div><b><u>C++ Implem=
entation</u></b></div><div><img src=3D"cid:ii_m4q2yje80" alt=3D"image.png" =
width=3D"562" height=3D"98"><br></div><div><br></div><div>I am using<b><i> =
uhd::rfnoc::ddc_block_control</i></b> types to issue the stream command bec=
ause I was having issues with my block propagating. Issuing=C2=A0to the DDC=
s lets the data flow from 2 inputs to the 1 output, where the output is eit=
her a file or loopback to transmit.</div><div><br></div><div>The base image=
 with rx_samples_to_file uses a multi_usrp type, which propagates the strea=
m command from the rx_streamer.</div><div><br></div><div><u style=3D"font-w=
eight:700">RFNoC laydown</u><b></b></div><div><u style=3D"font-weight:700">=
<br></u></div><div><img src=3D"cid:ii_m4q46qnx1" alt=3D"image.png" width=3D=
"562" height=3D"279"><br></div><div><br></div><div>Data flows in both Tx lo=
opback configuration and Rx to file configuration.</div><div><br></div><div=
><b><u>Methods and Symptoms</u></b></div><div>I have two methods of measuri=
ng the synchronization, with data collected by ILA cores at either the outp=
ut of DDC or input of custom block:=C2=A0</div><div><ol><li><b>Math: </b>Wh=
en receiving correlated noise, I can measure the cross correlation and show=
 that the correlation peaks as expected, and show the delay between channel=
s in samples.</li><li><b>Vivado Waveform Viewer</b>: When the ILA cores are=
 collecting DDC channel data, I can see that the base image samples are ava=
ilable on the same clock. My image does not have that behavior.</li></ol></=
div><div><br></div><div>Thanks,</div><div><br></div><div>David</div><div><b=
><u><br></u></b></div><div><b><u><br></u></b></div><div><b><u><br></u></b><=
/div></div>
</div>
