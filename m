...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EBA7100A47
	for <lists+usrp-users@lfdr.de>; Mon, 18 Nov 2019 18:31:25 +0100 (CET)
Received: from [::1] (port=33248 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iWkrz-0000b9-0V; Mon, 18 Nov 2019 12:31:23 -0500
Received: from mail-eopbgr750109.outbound.protection.outlook.com
 ([40.107.75.109]:63618 helo=NAM02-BL2-obe.outbound.protection.outlook.com)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256)
 (Exim 4.92) (envelope-from <ilbeeman@wpi.edu>) id 1iWkrv-0000PD-6s
 for usrp-users@lists.ettus.com; Mon, 18 Nov 2019 12:31:19 -0500
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=IWOKdeqZrrzkyhenCdAaQIdz7NidBAN2E5CcbfE9sUo=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=wpi.edu; s=selector2; 
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=IWOKdeqZrrzkyhenCdAaQIdz7NidBAN2E5CcbfE9sUo=;
 b=gcyYnxaJI0y+xVjn7KChL3+RbneZLYf6yzO9fSrs/dhnnUBhnxpQ3Y9Af4L3kJtG756wi+92RD24+cLq40dbuXf12M/mv60DIC63nSSvtioP7/YP7NKHU+Jua29nJoyLdPFV5wSMfdGD2MhiYe1Y4Q/jK4u67P9BGNwfXyMpqGU=
Received: from BN7PR01MB3859.prod.exchangelabs.com (52.132.5.158) by
 BN7PR01MB3700.prod.exchangelabs.com (52.132.217.18) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.2451.23; Mon, 18 Nov 2019 17:30:36 +0000
...
Thread-Topic: [EXT] Re: [USRP-users] Question about the IMU (MPU-9150) on the
 E310
Thread-Index: AdWZb3mZFAIglF61Tj2+JVs4nO8D5wAKFyaAAATtiIABIAZ0WgABbFaG
Date: Mon, 18 Nov 2019 17:30:35 +0000
Message-ID: <BN7PR01MB3859AD85F2769247DFF70555CB4D0@BN7PR01MB3859.prod.exchangelabs.com>
...
x-ms-office365-filtering-correlation-id: 95b59e5f-2359-45f2-c2fe-08d76c4d05b3
x-ms-traffictypediagnostic: BN7PR01MB3700:
x-microsoft-antispam-prvs: <BN7PR01MB370006094A3748D7530A1C08CB4D0@BN7PR01MB3700.prod.exchangelabs.com>
x-ms-oob-tlc-oobclassifiers: OLM:8273;
x-forefront-prvs: 0225B0D5BC
x-forefront-antispam-report: SFV:NSPM;
 SFS:(10019020)(366004)(376002)(136003)(39860400002)(396003)(346002)(13464003)(199004)(189003)(14444005)(256004)(8936002)(478600001)(6116002)(11346002)(71200400001)(446003)(236005)(54896002)(3846002)(53546011)(71190400001)(102836004)(6506007)(19627405001)(6306002)(25786009)(55016002)(76116006)(476003)(8676002)(786003)(296002)(316002)(6436002)(52536014)(486006)(33656002)(76176011)(110136005)(99286004)(74316002)(66066001)(2906002)(5660300002)(88552002)(86362001)(229853002)(66946007)(186003)(7696005)(2501003)(9686003)(66476007)(66556008)(81156014)(81166006)(66446008)(64756008)(14454004)(7736002)(966005)(606006)(105004)(2171002)(26005)(6246003)(2940100002)(75432002);
 DIR:OUT; SFP:1102; SCL:1; SRVR:BN7PR01MB3700;
...
x-microsoft-antispam-message-info: 
x-ms-exchange-transport-forked: True
MIME-Version: 1.0
X-OriginatorOrg: wpi.edu
X-MS-Exchange-CrossTenant-Network-Message-Id: 95b59e5f-2359-45f2-c2fe-08d76c4d05b3
X-MS-Exchange-CrossTenant-originalarrivaltime: 18 Nov 2019 17:30:35.8354 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 589c76f5-ca15-41f9-884b-55ec15a0672a
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: m9UrpJ7MtUYC4vjr6ASD1kDUV8+xXSsaTmmf1dvSGQje9/gOrjA9jp5CQe3DpgVyx88FYLu87JWIzjNNgsgk1A==
X-MS-Exchange-Transport-CrossTenantHeadersStamped: BN7PR01MB3700
...
Content-Type: multipart/mixed; boundary="===============0625095937823595043=="
...
Content-Type: multipart/alternative;
	boundary="_000_BN7PR01MB3859AD85F2769247DFF70555CB4D0BN7PR01MB3859prod_"

--_000_BN7PR01MB3859AD85F2769247DFF70555CB4D0BN7PR01MB3859prod_
Content-Type: text/plain; charset="us-ascii"
Content-Transfer-Encoding: quoted-printable

I figured I should modify the RTIMULib.ini file in /etc/ to at least point =
at the correct bus 0 instead of 1:

I2CBus=3D0

because the MPU-9150 should be at address 0x69 on bus 0. But got an output =
of
...
At least I get an output now, even if it failed to work. I don't know how t=
o fix this error.


I decided to do some investigating and found that the I2C device at 0x69 is=
 not the MPU-9150, but the MPU-6050, which is one of the two chips on the M=
PU-9150.

root@ni-e31x-:~# cat /sys/class/i2c-dev/i2c-0/device/0-0069/name
mpu6050

There is no sign of the other chips: AK8975 (3-axis compass) at 0x0C or BMP=
085 (pressure sensor) at 0x77. Maybe I'm doing something wrong, but it seem=
s as if something is more wrong than just the failed I2C read.
...
To: Samuel Prager <sprager@usc.edu>; usrp-users@lists.ettus.com <usrp-users=
@lists.ettus.com>
Subject: Re: [EXT] Re: [USRP-users] Question about the IMU (MPU-9150) on th=
e E310
...
I figured I should modify the RTIMULib.ini file in /etc/ to at least point =
at the correct bus 0 instead of 1:<br>
</div>
<div style=3D"font-family: Calibri, Arial, Helvetica, sans-serif; font-size=
: 12pt; color: rgb(0, 0, 0);">
<br>
...
le /etc/RTIMULib.ini loaded</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">Using fusio=
n algorithm RTQF</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">min/max com=
pass calibration not in use</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">Ellipsoid c=
ompass calibration not in use</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">Accel calib=
ration not in use</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">I2C read er=
ror from 0, 117 - Failed to read MPU9150 id</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">I2C read er=
ror from 0, 114 - Failed to read fifo count</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">Press Ctrl =
&#43; C to stop streaming...</span><br>
</div>
<div><span style=3D"font-family: Consolas, Courier, monospace;">I2C read er=
ror from 0, 114 - Failed to read fifo count</span><br>
</div>
...
<div><span style=3D"font-family: Consolas, Courier, monospace;">I2C read er=
ror from 0, 114 - Failed to read fifo count</span></div>
...
: 12pt; color: rgb(0, 0, 0);">
<span style=3D"font-family: Consolas, Courier, monospace;">root@ni-e31x-:~#=
 cat /sys/class/i2c-dev/i2c-0/device/0-0069/name</span><span><br>
</span>
<div><span style=3D"font-family: Consolas, Courier, monospace;">mpu6050</sp=
an><br>
</div>
</div>
<div style=3D"font-family: Calibri, Arial, Helvetica, sans-serif; font-size=
...
There is no sign of the other chips: AK8975 (3-axis compass) at 0x0C or BMP=
085 (pressure sensor) at 0x77. Maybe I'm doing something wrong, but it seem=
s as if something is more wrong than just the failed I2C read.<br>
</div>
<div style=3D"font-family: Calibri, Arial, Helvetica, sans-serif; font-size=
: 12pt; color: rgb(0, 0, 0);">
<br>
...
yle=3D"font-size:11pt" color=3D"#000000"><b>From:</b> Beeman, Isaac L. &lt;=
ilbeeman@wpi.edu&gt;<br>
<b>Sent:</b> Monday, November 18, 2019 11:24 AM<br>
<b>To:</b> Samuel Prager &lt;sprager@usc.edu&gt;; usrp-users@lists.ettus.co=
m &lt;usrp-users@lists.ettus.com&gt;<br>
<b>Subject:</b> Re: [EXT] Re: [USRP-users] Question about the IMU (MPU-9150=
) on the E310</font>
<div>&nbsp;</div>
</div>
...
<span style=3D"font-family:Consolas,Courier,monospace">root@ni-e31x-:~/usr/=
E312IMUTest/build# ./E312IMUTest
</span><span><br>
</span>
<div><span style=3D"font-family:Consolas,Courier,monospace">Do something he=
re with example option input: for example</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">Settings file n=
ot found. Using defaults and creating settings file</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">Failed to open =
I2C bus 1</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">Failed to open =
SPI bus 0, select 0</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">Failed to open =
SPI bus 0, select 1</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">No IMU detected=
</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">Using fusion al=
gorithm RTQF</span><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">No IMU found</s=
pan><br>
</div>
<div><span style=3D"font-family:Consolas,Courier,monospace">Error intializi=
ng IMU</span><br>
</div>
<span></span>
<div style=3D"font-family:Calibri,Arial,Helvetica,sans-serif; font-size:12p=
...
<p style=3D"margin-top:0px; margin-bottom:0px"><span id=3D"x_ms-rterangepas=
te-start"></span></p>
<div style=3D"color:rgb(33,33,33); font-family:wf_segoe-ui_normal,&quot;Seg=
oe UI&quot;,&quot;Segoe WP&quot;,Tahoma,Arial,sans-serif,serif,EmojiFont; f=
ont-size:15px; margin:0px">
...
color=3D"#000000" style=3D"font-size:11pt"><b>From:</b> Samuel Prager &lt;s=
prager@usc.edu&gt;<br>
...
<div>
<div name=3D"x_x_messageBodySection">
...
<div name=3D"x_x_messageReplySection">On Nov 12, 2019, 12:30 PM -0800, Mich=
ael Dickens via USRP-users &lt;usrp-users@lists.ettus.com&gt;, wrote:<br>
<blockquote type=3D"cite" class=3D"x_x_spark_quote" style=3D"margin:5px 5px=
...
<div dir=3D"ltr" class=3D"x_x_gmail_attr">On Tue, Nov 12, 2019 at 12:37 PM =
Beeman, Isaac L. via USRP-users &lt;<a href=3D"mailto:usrp-users@lists.ettu=
s.com">usrp-users@lists.ettus.com</a>&gt; wrote:<br>
</div>
<blockquote class=3D"x_x_gmail_quote x_x_spark_quote" style=3D"margin:5px 5=
px; padding-left:10px; border-left:thin solid #e67e22">
Marcus and List,<br>
<br>
I was hoping someone knew the steps involved to get the RTIMULib setup on t=
he USRP. I tried building and installing both the RTIMULib and Linux folder=
