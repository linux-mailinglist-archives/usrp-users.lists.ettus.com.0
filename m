...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 3999A239D81
	for <lists+usrp-users@lfdr.de>; Mon,  3 Aug 2020 04:36:57 +0200 (CEST)
Received: from [::1] (port=40700 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1k2QLN-00056L-3B; Sun, 02 Aug 2020 22:36:53 -0400
Received: from resqmta-po-01v.sys.comcast.net ([96.114.154.160]:49598)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
 (Exim 4.93) (envelope-from <w6rz@comcast.net>) id 1k2QLJ-0004v4-5N
 for usrp-users@lists.ettus.com; Sun, 02 Aug 2020 22:36:49 -0400
Received: from resomta-po-04v.sys.comcast.net ([96.114.154.228])
 by resqmta-po-01v.sys.comcast.net with ESMTP
 id 2Q39kWTsnAbw42QKekgNol; Mon, 03 Aug 2020 02:36:08 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=comcast.net;
 s=20190202a; t=1596422168;
 bh=qIcyI96H5FHftEGDSDVJPDSFhvtOFO8LC77eKF+LJ1s=;
 h=Received:Received:Subject:To:From:Message-ID:Date:MIME-Version:
 Content-Type;
 b=
Received: from [IPv6:2601:647:4200:ea30:dd94:1042:6897:a0f2]
 ([IPv6:2601:647:4200:ea30:dd94:1042:6897:a0f2])
 by resomta-po-04v.sys.comcast.net with ESMTPSA
 id 2QKckJPCLCjgD2QKdkdigQ; Mon, 03 Aug 2020 02:36:07 +0000
...
Message-ID: <628c90eb-a132-bfed-daee-ed9a30733eda@comcast.net>
Date: Sun, 2 Aug 2020 19:36:06 -0700
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.10.0
MIME-Version: 1.0
In-Reply-To: <47A975ECF45F43D2A3CFAB47ABFB49FA@PC1>
...
Content-Type: multipart/mixed; boundary="===============6923052900733081627=="
...
Content-Type: multipart/alternative;
 boundary="------------AF465AF9794D7A8AB4ABE0E3"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------AF465AF9794D7A8AB4ABE0E3
...
<html>
  ...
  <body>
    <p>You don't need to supply a Findpybind11.cmake file. That is
      already provided by the pybind11 install (take a look in
      /usr/lib/cmake/pybind11).</p>
    <p>Ron<br>
    </p>
    <div class="moz-cite-prefix">On 8/2/20 10:20, David Taylor
      (manx.net) wrote:<br>
    </div>
      ...
      <div dir="ltr">
        <div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Calibri'; COLOR:
          ...
          <div>I have persevered with the GRC 9.0 installation and have
            followed the 3.9 OOT module porting guide.</div>
          <div>pybind11 2.4.3 and the other required dependencies have
            been installed. CMake reports all present during configure.</div>
          <div> </div>
          <div>A simple C++ OOT under the Workflow instruction produces
            the correct binding files under ‘$gr_modtool bind test_cc’</div>
          <div>CMake configure correctly reported an ‘out of sync error’
            before binding.</div>
          <div> </div>
          ...
          <div><font color="#ff0000">    Unknown CMake command
              “pybind11_add_module”.</font></div>
          <div><font color="#ff0000">Call Stack (most recent call
              first):</font></div>
          <div><font color="#ff0000">   
              python/bindings/CMakeLists.txt:23 (GR_PYBIND_MAKE_OOT)</font></div>
          <div> </div>
          <div>I added my own version of Findpybind11.cmake, which may
            of course be contributory.</div>
          <div> </div>
          <div>Is there a version of Findpybind11.cmake out there that
            pairs specifically with pybind11 2.4.3 or am I missing
            something fundamental with modern cmake.</div>
            ...
            <div style="FONT: 10pt tahoma">
              ...
              <div style="BACKGROUND: #f5f5f5">
                <div style="font-color: black"><b>From:</b> <a
                    ...
                    moz-do-not-send="true">Ron Economos via USRP-users</a>
                </div>
          ...
          <div style="FONT-SIZE: small; TEXT-DECORATION: none;
            ...
            COLOR: #000000; FONT-STYLE: normal; DISPLAY: inline">
            <p>David,</p>
            <p>You don't need MPIR. The dependency can be resolved with
              libgmp. Here's what that portion of my OOT CMake looks
              like:</p>
            ...
            <p>For VOLKGNSSSDR, the techniques you used for 3.7.11
...
href="https://github.com/drmpeg/gr-dvbgse/blob/master/cmake/Modules/FindPcap.cmake"
            ...
            <blockquote cite="mid:274815FD178544A4B80B844E5119AFCD@PC1"
              type="cite">
              <div dir="ltr">
                <div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Calibri';
                  COLOR: #000000">
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt"><font style="FONT-SIZE: 11pt">Apologies
                      if this question is out of scope, or if the answer
                      is to be found elsewhere in the history.</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      style="FONT-SIZE: 11pt">I have been upgrading the
                      GRC from 3.7.11 (with Ubuntu 18.04) to GRC 9.0
                      (with Ubuntu 20.04 LTS). See previous dialogue
                      below, using </font><font style="LINE-HEIGHT:
                      13pt" size="3" color="#0000ff">3.8.1.0~rc12build2</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      style="FONT-SIZE: 11pt">Currently, the synaptic
                      package manager and $sudo apt install gnuradio
                      methods both align on GRC version 9.0. So I have
                      persevered at this version.</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      style="FONT-SIZE: 11pt">UHD is at v 3.15 and with
                      Python3 the package is basically functional using
                      an available B210 over USB3.</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt">--------------</p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt">The problem arises with OOT
                    blocks transfer, CMake in its “modern form” and with
                    the new dependency of MPIR.</p>
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt"><font style="FONT-SIZE: 11pt">1).
                      MPIR library has been installed independently and
                      built at V3.0 , with libraries and header located
                      in /usr/local/lib and /usr/local/include
                      respectively.</font></p>
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt"><font style="FONT-SIZE: 11pt">2).
                      My 3.7.11 code also uses VOLKGNSSSDR in the build.
                      As with the 3.7.11 version, VOLKGNSSSDR was
                      installed and tested independently with libraries
                      and headers located</font><font style="FONT-SIZE:
                      11pt"> using FindVOLKGNSSSDR</font><font
                      style="FONT-SIZE: 11pt"><span style="mso-spacerun:
                        yes">  </span>in /cmake/modules and a find
                      package reference added to CMakeLists.txt.</font></p>
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt"><font style="FONT-SIZE: 11pt">I
                      have yet to check whether {VOLK_GNSSSDR_LIBRARIES}
                      has to be added to the target_link_libraries,
                      noting the significantly different approach now
                      used in .. //my_development/lib/CMakeLists.txt</font></p>
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt"><font style="FONT-SIZE: 11pt">3).
                      The standard VOLK library is found in CMake
                      configure as it is now part of the v 9.0 build
                      package. </font></p>
                  <p class="MsoNormal" style="MARGIN: 0cm 0cm 10pt;
                    LINE-HEIGHT: 13pt"><font style="FONT-SIZE: 11pt">4).
                      I have tried adapting the older find package
                      method used in 2) for MPIR without success, but
                      note the following CMake configure output.</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                  ...
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      style="FONT-SIZE: 11pt" color="#ff0000">Can anyone
                      help with the MPIR problem please?</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      style="FONT-SIZE: 11pt">As an OOT build
                      requirement at V 9.0., I would have expected
                      expected the gr-modtool to generate some
                      boiler-plate code to cover this dependency
                      addition!</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      style="FONT-SIZE: 11pt" color="#ff0000">Is there a
                      more elegant and better way of incorporating
                      VOLKGNSSSDR and the MPIR libraries using modern
                      CMake?</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"><font
                      color="#ff0000">Would reversion to 3.8.1 help in
                      the short term, noting  that the output from my
                      work might benefit and the later GRC scheduler
                      improvements?</font></p>
                  <p class="MsoNoSpacing" style="MARGIN: 0cm 0cm 0pt"> </p>
                  ...
                  <div style="FONT-SIZE: small; TEXT-DECORATION: none;
                    ...
                    normal; COLOR: #000000; FONT-STYLE: normal; DISPLAY:
                    inline">
                    <div class="moz-cite-prefix">On 06/23/2020 03:23 PM,
                    ...
                    <blockquote
                      ...
                      <div dir="ltr">
                        <div style="FONT-SIZE: 12pt; FONT-FAMILY:
                          ...
                          <div> </div>
                          <div>I have only managed to try this with a
                            B210 as the other transceivers remain in the
                            laboratory under Covid19 university building
                            closure measures.</div>
                          <div>The N210 is yet to be used, but thanks
                            for the advising on the particular EEPROM
                            image load method, </div>
                        </div>
                      </div>
                    </blockquote>
                    OK, so with B2xx, if they already have a loaded FPGA
                    image, they won't try to re-load from your host
                    during start-up, unless you<br>
                      power-cycle them first.  So, this can result in
                    you having upgraded the host side of things,
                    complete with host-resident images,<br>
                      and getting a "mis-match" error with B2xx.  The
                    UHD code does NOT attempt to re-load the FPGA image
                    if the host side is<br>
                      newer than the code resident on the B2xx--only
                    after a power-cycle.<br>
                    <blockquote
                      cite="mid:07FCC8E1668F4D4A814BC4DA01DCA8BE@PC1"
                      type="cite">
                      <div dir="ltr">
                        <div style="FONT-SIZE: 12pt; FONT-FAMILY:
                          'Calibri'; COLOR: #000000">
                          <div> </div>
                          <div>It was interesting to see the extra
                            console UHD diagnostics, particularly about
                            clock sources and the 1 PPS input.</div>
                          ...
                          <div> </div>
                          <div>However, I am now in the process of
                            setting up the toolchain and new gr_modtool
                            and transitioning the 3.7x OOT blocks</div>
                          <div>The GNU Radio 3.8 OOT Module Porting
                            Guide looks helpful at 16 May 2020.</div>
                          <div>The only real issue I had before was to
                            include FindVOLKGNSSSDRcmake and the
                              ...
                              <div style="BACKGROUND: #f5f5f5">
                                <div style="font-color: black"><b>From:</b>
                                  <a title="usrp-users@lists.ettus.com"
                                    moz-do-not-send="true">Marcus D.
                                    Leech via USRP-users</a> </div>
                                <div><b>Sent:</b> Tuesday, June 23, 2020
                                  1:47 AM</div>
                                <div><b>To:</b> <a
                                    title="usrp-users@lists.ettus.com"
                                    moz-do-not-send="true">usrp-users@lists.ettus.com</a>
                                </div>
                                <div><b>Subject:</b> Re: [USRP-users]
                                  GRC up-grade - installation issues</div>
                              </div>
                            </div>
                            <div> </div>
                          </div>
                          <div style="FONT-SIZE: small; TEXT-DECORATION:
                            ...
                            FONT-WEIGHT: normal; COLOR: #000000;
                            FONT-STYLE: normal; DISPLAY: inline">
                            <div class="moz-cite-prefix">On 06/22/2020
                              02:45 PM, David Taylor (manx.net) via
                              USRP-users wrote:<br>
                            </div>
                            <blockquote
                              ...
                              <div dir="ltr">
                                <div style="FONT-SIZE: 12pt;
                                  ...
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">Dear all,</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">I have
                                      been successfully running a B200/
                                      B210 research project for two
                                      years based on Ubuntu 18.04 LTS
                                      and version 3.7x GRC.</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">This
                                      includes a number of OOT blocks
                                      developed for direct sequence
                                      spread spectrum, using the Volk
                                      GNSSSDR library extensions. An
                                      N210 USRP is also at my disposal.</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">I now have
                                      a clean upgrade to Ubuntu 20.04
                                      LTS and wish to refresh the GRC
                                      &amp; UHD drivers to the latest
                                      stable release, taking best advice
                                      please to ensure project
                                      conclusion.</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt">The
                                    issues:-</p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">1). GRC
                                      version <font size="3"
                                        color="#0000ff">3.8.1.0~rc12build2</font>
                                      works standalone and appears to
                                      have similar Cmake files structure
                                      and content. (<font size="3"
                                        color="#0000ff">3.9.0.0</font>
                                      is listed in the package manager
                                      as available, but with significant
                                      and noticeable changes in the
                                      software migration and
                                      dependencies)? </font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">2).
                                      Libuhd-dev at <font size="3"
                                        color="#0000ff">3.15.0.0-2build5</font>
                                      correctly identifies the B210 over
                                      USB3. (I note that library-file
                                      libuhd003 no longer forms part of
                                      this package).</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">3).
                                      Running “uhd_images_downloader.py”
                                      fully populates
                                      /usr/share/images/.</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">There is
                                      an issue with FPGA compatibility,
                                      which I have seen before in 3.7x
                                      GRC.<span style="mso-spacerun:
                                        yes">  “</span>Expected FPGA
                                      compatibility number 16 expected
                                      got 14.”</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">This issue
                                      was solved under V3.7x  simply by
                                      replacement of the FPGA image from
                                      archive. </font></p>
                                </div>
                              </div>
                            </blockquote>
                            Is this compatibility issue with your N210
                            or B2xx?  It isn't clear.<br>
                            <br>
                            <blockquote
                              cite="mid:3106CD4CFDE84EF2B512E9D68DC0AFF8@PC1"
                              type="cite">
                                ...
                                <div style="FONT-SIZE: 12pt;
                                  ...
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      ...
                                      removed all FPGA images from the
                                      /usr/share/images directory and
                                      have selectively tried installing
                                      a number of earlier discrete
                                      images and boot-loader from the
                                      archive, but all without success.</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">5). A
                                      re-run of the
                                      uhd-images-downloader now fails to
                                      re-populate the images folder,
                                      however the python(3) script
                                      itself runs.</font></p>
                                </div>
                              </div>
                            </blockquote>
                            You might want to simply remove *everything*
                            from /usr/share/uhd/images, and re-run:<br>
                            <br>
                            sudo uhd_images_downloader.py<br>
                            <br>
                            [Making certain it's running the version you
                            think it's running--if you installed from
                            pre-packaged, it'll be in /usr/bin]<br>
                            <br>
                            If this doesn't work, please share the error
                            messages produced with us.<br>
                            <br>
                            <br>
                            Also, because I didn't see anything in your
                            ...
                            <br>
                            This loads the appropriate image into the
                            EEPROM of the N210.  The N2xxx series,
                            unlike the B2xx series don't do this
                            dynamically at<br>
                              runtime.  Once you load an image into
                            them, that image is there until it is
                            reprogrammed, even across power-off.  This
                            is different than<br>
                              B2xx, which manages this automatically
                            after power-up.<br>
                            <br>
                            <br>
                            <blockquote
                              ...
                              <div dir="ltr">
                                <div style="FONT-SIZE: 12pt;
                                  ...
                                  #000000">
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"> </p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">Many
                                      thanks in advance and I look
                                      forward to being able to
                                      contribute to the group.</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt">Best
                                    regards,</p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">David
                                      Taylor</font></p>
                                  <p class="MsoNormal" style="MARGIN:
                                    0cm 0cm 10pt; LINE-HEIGHT: 13pt"><font
                                      style="FONT-SIZE: 11pt">Ph.D
                                      Researcher, Limerick University,
                                      Ireland. GD4FMB</font></p>
                                </div>
                              </div>
                              <br>
