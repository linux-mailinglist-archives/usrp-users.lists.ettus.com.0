...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 801BF99F09F
	for <lists+usrp-users@lfdr.de>; Tue, 15 Oct 2024 17:05:54 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id BE09A38599E
	for <lists+usrp-users@lfdr.de>; Tue, 15 Oct 2024 11:05:53 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1729004753; bh=YOUDVpLJWwt1zC80ikTRyACH/qeilpJZp5AwFIscH4Q=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qt1-f181.google.com (mail-qt1-f181.google.com [209.85.160.181])
	by mm2.emwd.com (Postfix) with ESMTPS id 901EE385978
	for <usrp-users@lists.ettus.com>; Tue, 15 Oct 2024 11:05:41 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="A4rETYHr";
	dkim-atps=neutral
Received: by mail-qt1-f181.google.com with SMTP id d75a77b69052e-4608564478bso3862771cf.1
        for <usrp-users@lists.ettus.com>; Tue, 15 Oct 2024 08:05:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1729004741; x=1729609541; darn=lists.ettus.com;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=yOjuAbQ0uc6iyOlNI4smkF3pfK8lYmu1OgnMEsPVkck=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1729004741; x=1729609541;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=yOjuAbQ0uc6iyOlNI4smkF3pfK8lYmu1OgnMEsPVkck=;
        b=
X-Gm-Message-State: AOJu0YzSzs6dkDyCZ7BwYHK8wtaT/ORt2f102ukNVXf+kIiz6sDNlPvE
	CloAJC9iuBNXtxUXqcoK8pOSlMugSdyU3IDoNjxzTqVzI/tJJmh/+tblNg==
X-Google-Smtp-Source: AGHT+IEgMXenWGXR1VpUeFb6i5L29nPYCq86o/C+ZnSKSQ98toQzRrxBIZEYFOy1xfXero0vsc6aVg==
X-Received: by 2002:a05:622a:518b:b0:458:4e9e:634e with SMTP id d75a77b69052e-4605839cd32mr204030801cf.11.1729004740039;
        Tue, 15 Oct 2024 08:05:40 -0700 (PDT)
Received: from [192.168.2.170] ([174.88.53.166])
        by smtp.googlemail.com with ESMTPSA id d75a77b69052e-4607b0a5e87sm7353181cf.20.2024.10.15.08.05.39
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Tue, 15 Oct 2024 08:05:39 -0700 (PDT)
Message-ID: <108ca81e-cb51-4e53-a64a-7722f02c0cee@gmail.com>
Date: Tue, 15 Oct 2024 11:05:28 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAO=xj9VyL9M7gP504BjTF7HN0g7=-uffaiZqMqdFhbEa7frkAw@mail.gmail.com>
Message-ID-Hash: B54QLUTGQYVCMSCOJE2LVKI7VRZ7OZ2W
X-Message-ID-Hash: B54QLUTGQYVCMSCOJE2LVKI7VRZ7OZ2W
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/B54QLUTGQYVCMSCOJE2LVKI7VRZ7OZ2W/>
...
Content-Type: multipart/mixed; boundary="===============0279471283129448984=="

This is a multi-part message in MIME format.
--===============0279471283129448984==
Content-Type: multipart/alternative;
 boundary="------------FuaT3D1cIzzbQPRMz7LPt6Dt"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------FuaT3D1cIzzbQPRMz7LPt6Dt
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 15/10/2024 11:01, Houshang wrote:
> Hi
> I updated my server UHD to the same version of the one in n310 itself=20
> and I still get the same error message. Please see below for both=20
...
>
> On Tue, 15 Oct 2024 at 16:39, Houshang <houshang.azizi@accelleran.com>=20
> wrote:
>
...
>>         DPDK_23.11; UHD_4.6.0.HEAD-0-g50fa3baa
...
>         /Yes, so it's likely that it's a system-image-compatibility iss=
ue.
>
>         In general, you need to be running the same UHD versions on
>         both your host computer, and the USRP N3xx radio.
>
>         It may be the case that in 4.7, the RPC ports used are
>         different, and a UHD 4.6 wouldn't be able to deal with this.
>
>
>         /
>>
...
>>             /
>>>
>>>             Secondly, Maybe the following is the issue; WHen I run
>>>             xxx in the host machine I see a version and when I run
>>>             the same command on the n310 itself, I get another
...
>>             possible.=C2=A0 If not, then follow the steps for programm=
ing
>>             a fresh
...
>>>                 /
>>>                 /
>>>                 /ad@bm-super11-intel:~/accelleran$ ssh root@10.10.0.1=
00/
...
>>>>                     Hi Marcus
>>>>
>>>>                       * There are two fiber interfaces for this
>>>>                         n310 which I will be using for DPDK later.
>>>>                       * There is also a RJ-45 port for this n310.
>>>>
>>>>                     As the first step, I want to make sure things
>>>>                     are working without DPDK. I will then test the
>>>>                     DPDK.
>>>>
>>>>                     Based on your question, I am attaching some
>>>>                     more info. Let me know if something is missing.
>>>>
>>>>                     Thanks
>>>>                     Houshang
>>>>
...
ettus.com
>>>>>                         To unsubscribe send an email tousrp-users-l=
eave@lists.ettus.com
>>>>                         I think I've asked you this before on this
>>>>                         issue:
>>>>
>>>>                         What does your network connection setup
>>>>                         look like?
>>>>
>>>>                         Are you using the RJ-45 port and the SFP+
>>>>                         port(s)?=C2=A0=C2=A0 How are things connecte=
d, and on
>>>>                         what subnets?
>>>>
>>>>
...
Content-Type: multipart/related;
 boundary="------------qw0N7Ozls9lFhrJyQ7bROq3D"

--------------qw0N7Ozls9lFhrJyQ7bROq3D
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 15/10/2024 11:01, Houshang wrote:<b=
r>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAO=3Dxj9VyL9M7gP504BjTF7HN0g7=3D-uffaiZqMqdFhbEa7frkAw@mail.=
gmail.com">
...
TF-8">
      <div dir=3D"ltr">
        ...
        <div><img src=3D"cid:part1.GLlYRKbs.4DF96rQd@gmail.com"
            alt=3D"15_16:59:31.jpg" style=3D"margin-right: 0px;" class=3D=
""
...
/page_usrp_x3x0_config.html#x3x0cfg_hostpc_netcfg_firewall">https://files=
.ettus.com/manual/page_usrp_x3x0_config.html#x3x0cfg_hostpc_netcfg_firewa=
ll</a><br>
    <br>
    <br>
    <blockquote type=3D"cite"
...
gmail.com"><br>
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct 2024 at 16:3=
9,
          Houshang &lt;<a href=3D"mailto:houshang.azizi@accelleran.com"
            moz-do-not-send=3D"true" class=3D"moz-txt-link-freetext">hous=
hang.azizi@accelleran.com</a>&gt;
          wrote:<br>
        </div>
...
padding-left:1ex">
              <div>
                ...
                <blockquote type=3D"cite">
                  <div dir=3D"ltr">
                    <div>This is the output of the command you asked:</di=
v>
                    <div><br>
                    </div>
                    <div><i><span
                          style=3D"background-color:rgb(204,204,204)">ad@=
...
r>
                ...
                <i>Yes, so it's likely that it's a
                  ...
                  <br>
                  It may be the case that in 4.7, the RPC ports used are
                  different, and a UHD 4.6 wouldn't be able to deal with
                  this.<br>
                  <br>
                  <br>
                </i>
                <blockquote type=3D"cite"><br>
                  <div class=3D"gmail_quote">
                    <div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct
                      2024 at 16:27, Marcus D. Leech &lt;<a
...
n></i><br>
                        ...
                        <blockquote type=3D"cite">
                          <div dir=3D"ltr">
                            ...
                            <div><img
src=3D"cid:part2.aEJYuqrw.c0KZw30V@gmail.com" alt=3D"15_16:21:07.jpg"
                                class=3D"" width=3D"578" height=3D"513"><=
br>
                            </div>
                          </div>
                        </blockquote>
...
_SD_Card"
                          target=3D"_blank" moz-do-not-send=3D"true"
                          class=3D"moz-txt-link-freetext">https://kb.ettu=
s.com/Writing_the_USRP_File_System_Disk_Image_to_a_SD_Card</a><br>
                        <br>
                        <br>
                        <blockquote type=3D"cite"><br>
                          <div class=3D"gmail_quote">
...
ran$
                                        ...
                                        64 bytes from <a
                                          href=3D"http://10.10.0.100"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true">10.10.=
0.100</a>:
                                        icmp_seq=3D1 ttl=3D64 time=3D0.25=
0 ms<br>
                                        64 bytes from <a
                                          href=3D"http://10.10.0.100"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true">10.10.=
0.100</a>:
                                        icmp_seq=3D2 ttl=3D64 time=3D0.19=
9 ms<br>
                                        ^C<br>
                                        --- 10.10.0.100 ping statistics
                                        ---<br>
...
ad@bm-super11-intel:~/accelleran$ ping 10.10.1.100<br>
                                        ...
                                        56(84) bytes of data.<br>
                                        64 bytes from <a
                                          href=3D"http://10.10.1.100"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true">10.10.=
1.100</a>:
                                        icmp_seq=3D1 ttl=3D64 time=3D1.02=
 ms<br>
                                        64 bytes from <a
                                          href=3D"http://10.10.1.100"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true">10.10.=
1.100</a>:
                                        icmp_seq=3D2 ttl=3D64 time=3D0.97=
0 ms<br>
                                        ^C<br>
                                        --- 10.10.1.100 ping statistics
                                        ---<br>
...
ad@bm-super11-intel:~/accelleran$ ping 10.10.2.100<br>
                                        ...
                                        56(84) bytes of data.<br>
                                        64 bytes from <a
                                          href=3D"http://10.10.2.100"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true">10.10.=
2.100</a>:
                                        icmp_seq=3D1 ttl=3D64 time=3D1.03=
 ms<br>
                                        64 bytes from <a
                                          href=3D"http://10.10.2.100"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true">10.10.=
2.100</a>:
                                        icmp_seq=3D2 ttl=3D64 time=3D0.96=
3 ms<br>
                                        ^C<br>
                                        --- 10.10.2.100 ping statistics
                                        ---<br>
                                            ...
                                            <div>
                                              ...
                                              <blockquote type=3D"cite">
                                                <div dir=3D"ltr">
                                                  ...
                                                  <div><img
src=3D"cid:part3.4whr1DFI.XUybuYoJ@gmail.com" alt=3D"15_15:37:26.jpg"
...
Content-Id: <part1.GLlYRKbs.4DF96rQd@gmail.com>
...
Content-Id: <part2.aEJYuqrw.c0KZw30V@gmail.com>
Content-Transfer-Encoding: base64
...
Content-Id: <part3.4whr1DFI.XUybuYoJ@gmail.com>
Content-Transfer-Encoding: base64
