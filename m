 zw_Zk3sxIGl3jr1c7zEC1niX_kwXdeDIVY0tdFd6.NZPFVLhJK2EYbtJGfxTF.7C3TzQvJ5Eve_Z
 OFllmABu7ppSCfsBJM0BO6i7vOFDRFHQlE_jxMZOoYf5KOfsxy27lBkDTFwaauxZG7RhyMA--
X-Sonic-MF: <qanwang83@yahoo.com.au>
X-Sonic-ID: 3dce4e0e-4e3d-4809-ab13-0f6c572ecf7b
Received: from sonic.gate.mail.ne1.yahoo.com by sonic309.consmr.mail.bf2.yahoo.com with HTTP; Wed, 11 Dec 2024 11:58:42 +0000
Date: Wed, 11 Dec 2024 11:58:38 +0000 (UTC)
To: Usrp-users Mailing-list <usrp-users@lists.ettus.com>
Message-ID: <34378001.1123526.1733918318303@mail.yahoo.com>
MIME-Version: 1.0
Content-Type: multipart/mixed;
	boundary="----=_Part_1123525_1901096055.1733918318303"
References: <34378001.1123526.1733918318303.ref@mail.yahoo.com>
X-Mailer: WebService/1.1.23040 YMailNorrin
Message-ID-Hash: MS3BNWEOEL4ORHBCK3Q6J7ZJCOWVYWFT
X-Message-ID-Hash: MS3BNWEOEL4ORHBCK3Q6J7ZJCOWVYWFT
X-MailFrom: qanwang83@yahoo.com.au
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-usrp-users.lists.ettus.com-0; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
X-Mailman-Version: 3.3.3
Precedence: list
Subject: [USRP-users] UHD Python API
List-Id: "Discussion and technical support related to USRP, UHD, RFNoC" <usrp-users.lists.ettus.com>
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/MS3BNWEOEL4ORHBCK3Q6J7ZJCOWVYWFT/>
...
------=_Part_1123525_1901096055.1733918318303
Content-Type: multipart/alternative;
	boundary="----=_Part_1123524_1451955615.1733918318205"

------=_Part_1123524_1451955615.1733918318205
...
<html><head></head><body><div class=3D"ydp1b9857efyahoo-style-wrap" style=
=3D"font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:13px=
;"><div dir=3D"ltr" data-setdir=3D"false">Hi there,</div><div dir=3D"ltr" d=
ata-setdir=3D"false"><br></div><div dir=3D"ltr" data-setdir=3D"false">I jus=
t started using UHD Python API to implement a simple transmission-reception=
 experiment on an Ettus X310. I have a UBX 160 daughterboard installed on s=
lot B, with its TX (TX/RX port) connected to RX (RX2 port) directly using a=
 SMA cable and a 30dB attenuator. I plan to transmit a sequence of waveform=
s from TX/RX port and to see the waveforms received at the RX2 port. Ideall=
y the two waveforms should be highly similar with some time shift in betwee=
n, but the received waveforms turned out to be not quite right (see the dia=
gram below, the upper diagram shows the real part of the transmitted wavefo=
rm and the lower, the real part of the received.).</div><div dir=3D"ltr" da=
ta-setdir=3D"false"><img title=3D"Inline image" alt=3D"Inline image" src=3D=
"cid:e3a1147a-aa37-f426-d1ef-427511b4a99c@yahoo.com" class=3D"ydp1b9857efya=
hoo-inline-image ydp1b9857efyahoo-loading" style=3D"max-width: 800px; width=
: 100%;" data-id=3D"<e3a1147a-aa37-f426-d1ef-427511b4a99c@yahoo.com>"><br><=
span></span><br></div><div dir=3D"ltr" data-setdir=3D"false">Some of the pa=
rameters are defined as following:</div><div dir=3D"ltr" data-setdir=3D"fal=
se">duration =3D 10 # second, the time length of the transmitter sending th=
e waveforms</div><div dir=3D"ltr" data-setdir=3D"false">centre_freq=3D1e8</=
div><div dir=3D"ltr" data-setdir=3D"false">sample_rate=3D200000</div><div d=
ir=3D"ltr" data-setdir=3D"false">num_samples=3D200000 # number of samples t=
o be collected by the receiving side.</div><div dir=3D"ltr" data-setdir=3D"=
false">gain_tx=3D0 #dB</div><div dir=3D"ltr" data-setdir=3D"false">gain_rx=
=3D20</div><div dir=3D"ltr" data-setdir=3D"false"><br></div><div dir=3D"ltr=
" data-setdir=3D"false">USRP is defined as:</div><div dir=3D"ltr" data-setd=
ir=3D"false"><div><div>usrp =3D uhd.usrp.MultiUSRP()</div><div>usrp.set_tx_=
subdev_spec(uhd.usrp.SubdevSpec("B:0"))</div><div>usrp.set_tx_antenna("TX/R=
X")</div><div><br></div><div>usrp.set_rx_subdev_spec(uhd.usrp.SubdevSpec("B=
:0"))</div><div>usrp.set_rx_antenna("RX2")</div><div>usrp.set_rx_bandwidth(=
sample_rate, 0)</div></div><div><br></div><div dir=3D"ltr" data-setdir=3D"f=
alse">As the transmission and the reception happen at the same time, they a=
re put in two separate threads, as below:</div><div><div><div>threads =3D [=
]</div><div>rx_thread =3D threading.Thread(target=3Dreceive_data, args=3D(u=
srp, num_samples, centre_freq_rx, sample_rate, gain_rx))</div><div>threads.=
append(rx_thread)</div><div>rx_thread.start()</div><div>tx_thread =3D threa=
ding.Thread(target=3Dusrp.send_waveform, args=3D(tx_signal, duration, centr=
e_freq_tx, sample_rate, [0], gain_tx))</div><div>threads.append(tx_thread)<=
/div><div>tx_thread.start()</div></div><div><br></div><div dir=3D"ltr" data=
-setdir=3D"false">Here the function, receive_data() in the first thread, is=
 a user-defined (by me) function, receiving samples using the uhd provided =
method, usrp.recv_num_samps() and saving the samples to a .txt file. A litt=
le more on the data format saved in the file, I used np.savetxt() function =
to save the samples (a numpy array) to a text file. As the numpy array has =
a data type of np.complex64, the real and imaginary of the samples are save=
d in the same file in the format of np.float32. I can confirm that&nbsp;<sp=
an><span style=3D"color: rgb(0, 0, 0); font-family: Helvetica Neue, Helveti=
ca, Arial, sans-serif;">200000 complex samples were collected in the file s=
aved, which verifies (partially at least) that data format didn't go wrong.=
&nbsp; &nbsp;</span></span></div><div dir=3D"ltr" data-setdir=3D"false"><br=
></div><div dir=3D"ltr" data-setdir=3D"false">I have been working on this s=
cript for a whole day, but couldn't fix it. I suspect I didn't configure th=
e usrp variable correctly. Any suggestions would be appreciated.</div><div =
dir=3D"ltr" data-setdir=3D"false"><br></div><div dir=3D"ltr" data-setdir=3D=
"false">Kind regards,</div><div dir=3D"ltr" data-setdir=3D"false">Tom</div>=
<div dir=3D"ltr" data-setdir=3D"false"><br></div><div dir=3D"ltr" data-setd=
ir=3D"false"><br></div><div dir=3D"ltr" data-setdir=3D"false"><br></div><di=
v dir=3D"ltr" data-setdir=3D"false"><br></div><br></div><div><br></div><br>=
...
iv><div dir=3D"ltr" data-setdir=3D"false">As the transmission and reception=
 happen simultaneously, the Python scritp&nbsp;</div><div dir=3D"ltr" data-=
setdir=3D"false">&nbsp;</div></div></body></html>
------=_Part_1123524_1451955615.1733918318205--
...
Content-ID: <e3a1147a-aa37-f426-d1ef-427511b4a99c@yahoo.com>
