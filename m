...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id E9662E0B26
	for <lists+usrp-users@lfdr.de>; Tue, 22 Oct 2019 20:00:10 +0200 (CEST)
Received: from [::1] (port=58482 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iMyRx-00011v-QH; Tue, 22 Oct 2019 14:00:05 -0400
Received: from mail-io1-f50.google.com ([209.85.166.50]:39706)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <samberhanu@gmail.com>)
 id 1iMyRs-0000xl-9F
 for usrp-users@lists.ettus.com; Tue, 22 Oct 2019 14:00:00 -0400
Received: by mail-io1-f50.google.com with SMTP id y12so3970704ioa.6
 for <usrp-users@lists.ettus.com>; Tue, 22 Oct 2019 10:59:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to;
 bh=rkYQ9/cnCRPMEJIVG89gyc951v6Sxw8FqCnT/3oh3RM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=rkYQ9/cnCRPMEJIVG89gyc951v6Sxw8FqCnT/3oh3RM=;
 b=
X-Gm-Message-State: APjAAAUVXFmkese3YPd8ooJpCQGwvfmqduQBLW2WSGHltUCQNiLiaHQ6
 c3a3iUUGKQlz4IM9Qg97ZXhgCDjyLYeJsBe5IRhj3sDv
X-Google-Smtp-Source: APXvYqy8XPU6MMom/TI4sloBO+VOIET8sMq0nMvgqCBUsplXAkvbv57jVk236X6VCaml++/kx21ELXVa55RTK4Vkg/Q=
X-Received: by 2002:a02:c84c:: with SMTP id r12mr5134609jao.20.1571767158475; 
 Tue, 22 Oct 2019 10:59:18 -0700 (PDT)
MIME-Version: 1.0
References: <mailman.43.1571500803.17414.usrp-users_lists.ettus.com@lists.ettus.com>
In-Reply-To: <mailman.43.1571500803.17414.usrp-users_lists.ettus.com@lists.ettus.com>
Date: Tue, 22 Oct 2019 13:58:31 -0400
Message-ID: <CAEyq4NfDLRUdBYo89nJfbGW6Hb3+CCOwcJ0Vyzq-NBeTP5WcBg@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============0099955333846757597=="
...
--===============0099955333846757597==
Content-Type: multipart/alternative; boundary="0000000000002691080595838f92"

--0000000000002691080595838f92
...
I went ahead and proceeded to make a bin file from a HG bit file  (used the
Xilinx SDK gui to generate a bin file.
...
all:
{
/home/berhas1/fluffybunny/fluffy_with_NI/usrp3/top/n3xx/build-N310_HG/n3xx.=
bit
}
...
Here is the terminal output when the error happens at bin file writing time=
:
...
[   15.121491] Flags: Nzcv  IRQs on  FIQs on  Mode SVC_32  ISA ARM  Segment
none
...
[   15.723479] [<c06f1410>] (__of_changeset_entry_notify) from [<c06f1bdc>]
(__of_changeset_apply+0xac/0xbc)
...
[   15.759066] [<c06f0dc0>] (cfs_overlay_item_path_store) from [<c02d633c>]
(configfs_write_file+0x13c/0x16c)
...
> Vivado 2017.4.  Also, I don't think the schematic is actually correct, fo=
r
> the record.
>
> -Robin
...
> >> script with GUI=3D1, a project, which   afterwards I save to make a tc=
l
...
0191018/4e3cf6ce/attachment-0001.html
> >
> -------------- next part --------------
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/4e3cf6ce/attachment-0001.bmp
> >
>
> ------------------------------
>
...
> Message-ID:
>         <
> BL0PR12MB2340D0029B42A30FFD0BC314AF6C0@BL0PR12MB2340.namprd12.prod.outloo=
k.com
> >
>
...
>
>
> https://github.com/EttusResearch/fpga/blob/bb85bdff45cad4da5008ab0c58749c=
e32797cea7/usrp3/top/n3xx/setupenv.sh
>
...
> To: Samuel Berhanu <samberhanu@gmail.com>
> Cc: Ettus Mail List <usrp-users@lists.ettus.com>
> Subject: Re: [USRP-users] N310 generation of a project/bit file from Ettu=
s
> design (HG version)
>
> What version of Vivado are you using?
...
> https://urldefense.proofpoint.com/v2/url?u=3Dhttps-3A__www.xilinx.com_sup=
port_answers_68238.html&d=3DDwMFaQ&c=3DeuGZstcaTDllvimEN8b7jXrwqOf-v5A_Cdpg=
nVfiiMM&r=3DW_MQLyUWPXWHfsF4mr51mTMqpeO4RbBBLexficV9DG8&m=3D3eiW44eEXen8sH4=
bvJLonsYOrBQlSZTtEN1f0476lHE&s=3D-27ilFCQOwzFKD4xO7v0coUAB_WM_p_lm9RF391SBe=
4&e=3D>.
...
> Having difficulty creating a project to actually test out the N310 HG
> design. (I am having problems with a no-Os setup that I am trying to
> execute to find out what exactly the pin assignment should be for the MIO=
s.
> On a side note, the issue specifically is wrt I2C0, USB and TPM pin
> assignments. Schematics vs PS7 design does not seem to match up. Ettus
...
> having second thoughts about it)
>
> Usually, when working with ettus products, I generate, using ettus' scrip=
t
> with GUI=3D1, a project, which   afterwards I save to make a tcl script f=
or a
...
> https://urldefense.proofpoint.com/v2/url?u=3Dhttp-3A__n310-5Fps-5Fbd.bd&d=
=3DDwMFaQ&c=3DeuGZstcaTDllvimEN8b7jXrwqOf-v5A_CdpgnVfiiMM&r=3DW_MQLyUWPXWHf=
sF4mr51mTMqpeO4RbBBLexficV9DG8&m=3D3eiW44eEXen8sH4bvJLonsYOrBQlSZTtEN1f0476=
lHE&s=3Dv_uR1v1M6qpcMcrnOG4j6n9EfYEJR0E78MOBZDPHgvM&e=3D>
> is not generated for Synthesis target. Please open this sub-design and
> generate with synth_checkpoint_mode as signular in original project befor=
e
...
8&m=3D3eiW44eEXen8sH4bvJLonsYOrBQlSZTtEN1f0476lHE&s=3DOoJK6KBq8fqrN-m5Sj3kV=
A77pT_-zkwp3z52c-wWf3o&e=3D
> >
> -------------- next part --------------
> An HTML attachment was scrubbed...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/84b4c0ec/attachment-0001.html
> >
> -------------- next part --------------
> A non-text attachment was scrubbed...
> Name: Selection_062.bmp
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/84b4c0ec/attachment-0001.bmp
> >
>
> ------------------------------
>
...
> time-align samples from every USRP as they come in. The reason you see 10=
02
...
> > communication failure #1EnvironmentError: IOError: x300 fw poke32 - rep=
ly
> > timed out*
> >
>
> There is either a backup or a lack of samples coming from the radio. Do y=
ou
> see flow control errors leading up to this failure?
>
> I'd say that pulling pieces out of this system would be a good way to sta=
rt
> troubleshooting:
>
...
>
> It sounds like this is something you can reproduce independent of your DS=
P
...
> behavior, then I'd be happy to set something up on my end try to reproduc=
e
...
> [1]
>
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/2017-August/0=
53986.html
> [2]
>
...
> [3]
>
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/2014-November=
/039561.html
>
>
...
> > Hello community,
> >
> > I am working on a gnuradio application that synchronously retrieves dat=
a
> > from a usrp_source, does some DSP on each of the streams and selects th=
e
...
> >
> > The application runs for a while until UHD outputs a message saying tha=
t
...
> > off.
> >
> > We are under the impression that the DSP blocks working independently m=
ay
...
> > *{uhd_prefix}/host/lib/transport/super_recv_packet_handler.hpp, *throug=
h
...
> > file_sinks to the outputs from the usrp_source and a simple analog sign=
al
...
> >
> > * [ERROR] [X300] 192.168.100.2 <http://192.168.100.2>: x300 fw
> > communication failure #3EnvironmentError: IOError: x300 fw poke32 - rep=
ly
> > timed out*
...
> 4096,
> > using ethtool.
> > - The OS ring buffers are set as suggested bu Ettus, using the followin=
g
> > commands:
> >
> >
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/935a1d54/attachment-0001.html
> >
>
> ------------------------------
>
...
>         <coxe@quanttux.com>,  Ettus Mail List <usrp-users@lists.ettus.com=
>
> Subject: Re: [USRP-users] N310 generation of a project/bit file from
>         Ettus design (HG version)
> Message-ID:
...
> Hi all,
>
> As Jason mentioned, UHD 3.14.x uses Vivado 2017.4. UHD 3.15.x.x which wil=
l
...
>
> We are working on adding in an archive of all previously tagged manuals s=
o
...
> > 3.15.0.0-69-gc350eb5a6, which requires 2018.3 and is not actually an
> > official release.
> > If memory serves, the actual tagged release (v.3.14.1.1) requires Vivad=
o
> > 2017.4.
> >
...
> > Usually, when working with ettus products, I generate, using ettus'
> script
> > with GUI=3D1, a project, which   afterwards I save to make a tcl script
> for a
> > project to  impl and resynthesize it as my own project.
> >
> > Through this process, (mind you i have not gotten to regenerating a tcl
> > script yet) (and this was a relatively easy fix), the custom packaged i=
ps
> > were not found and I had to insert them from (vivado_ipi) folder.
> >
> > Design went through synthesis  fine. At implementation, though, I am
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/9ff6a316/attachment-0001.html
> >
> -------------- next part --------------
> A non-text attachment was scrubbed...
> Name: Selection_062.bmp
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/9ff6a316/attachment-0001.bmp
> >
>
> ------------------------------
>
...
> >
> > With our X310s I set TXgain=3D20 and RX_gain=3D10. Both devices are 1-2=
m
...
> > 0.0005 for the samples that I get of a USRP source. I assume this shoul=
d
...
> The sample apps like uhd_fft are not in the path like they used to be wit=
h
...
> > Installing Py27-six should be pretty straight forward & should allow yo=
u
> to
...
> >> -- Python checking for six - python 2 and 3 compatibility library - no=
t
> >> found
...
> >>
> >>
> >> Checking out tag v3.8.0.0 results in Cmake dependency of 3.8 and up, s=
o
> I
...
> >>>> michael.dickens@ettus.com> wrote:
> >>>>
> >>>>> Hi Saeid - Thanks for the followup. I totally agree that if you jus=
t
...
> here <
> >>>>>
> https://wiki.gnuradio.org/index.php/UbuntuInstall#Xenial_Xerus_.2816.04.2=
9
> >>>>> >. I have an Ubuntu 18.04 install that went very smoothly using thi=
s
> guide,
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/dc28a653/attachment-0001.html
> >
>
> ------------------------------
>
...
> blocks "work" function cannot proceed until there is equal amounts of dat=
a
> available on all streams. In the absence of the hardware dropping samples=
,
> coherence is maintained in that case. What you are seeing here seems to b=
e
...
> RX.
> - The SFP connector attached to the USRP-X310s: AVAGO, 1.25GBd, 1000BASE-=
T,
> ABCU-5730ARZ.
...
> maybe this is just the natural behavior- to drop misaligned packets befor=
e
...
> and having lower sampling rates would rise new problems. I can go ahead a=
nd
...
> issue, attached in this email. For instance, the 6x1 connections would ma=
p
...
> DSP
> > blocks, which helps simplify things a bit. If you could go a bit furthe=
r
> > and find a simple example (i.e. take one of the GNURadio UHD shipping
> > examples and expand it to use 3x USRPs) and get it to reproduce the
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/1ceaa3f8/attachment-0001.html
> >
> -------------- next part --------------
> A non-text attachment was scrubbed...
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/1ceaa3f8/attachment-0001.py
> >
>
> ------------------------------
>
...
> known to unnecessarily drop packets *particularly at unexpectedly-low flo=
w
>    rates*.
>
...
> URL: <
> http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/attachments/2=
0191018/262c8d60/attachment-0001.html
> >
>
> ------------------------------
>
...
<div dir=3D"ltr"><div>As I have mentioned a bit earlier, I have noticed tha=
t there was an issue trying to run a no-Os setup but was not getting ACK fr=
om the TCA9548 expander. [Curious if anyone has gone the no-Os route and fo=
und an issue there.]<br></div><div><br></div><div>I went ahead and proceede=
d to make a bin file from a HG bit file=C2=A0 (used the Xilinx SDK gui to g=
enerate a bin file.=C2=A0 <br></div><div><br></div><div>The entry in the sw=
if file=C2=A0 is the following:</div><div><br></div><div>//arch =3D zynq; s=
plit =3D false; format =3D BIN<br>all:<br>{<br>	/home/berhas1/fluffybunny/f=
luffy_with_NI/usrp3/top/n3xx/build-N310_HG/n3xx.bit<br>} <br></div><div></d=
iv><div><br></div><div>I copied the generated file into the SDcard /primary=
/lib/firmware folder and renamed the n3xx.bit.bin to n310.bin.</div><div><b=
r></div><div>My thought was that this bin file should work with the dtbo al=
ready there in the design. After loading the bin file using fpga-manager (d=
to method) or even hard rebooting the machine, it looks like the kernel is =
panicking and not able to correctly load some drivers or addresses.</div><d=
iv><br></div><div>Does this mean that, even for a generic untouched HG desi=
gn, i would have to go through the process of making a dtbo (hence generati=
ng a device tree from Xilinx SDK)?<br></div><div><br></div><div>Here is the=
 terminal output when the error happens at bin file writing time:</div><div=
><br></div><div>[ =C2=A0OK =C2=A0] Started Network Name Resolution.<br>[ =
=C2=A0OK =C2=A0] Reached target Network.<br>[ =C2=A0OK =C2=A0] Started Mend=
er OTA update service.<br>[ =C2=A0OK =C2=A0] Reached target Host and Networ=
k Name Lookups.<br>[ =C2=A0 12.860517] macb e000b000.ethernet eth0: link up=
 (1000/Full)<br>[ =C2=A0 13.889925] fpga_manager fpga0: writing n310.bin to=
 Xilinx Zynq FPGA Manager<br>[ =C2=A0 15.012332] libphy: nixge_mii_bus: pro=
bed<br><br>[ =C2=A0 15.036810] libphy: nixge_mii_bus: probed<br>[ =C2=A0 15=
.040902] Unhandled fault: imprecise external abort (0x1406) at 0x004f1dcc<b=
r>[ =C2=A0 15.047895] pgd =3D eddec000<br>[ =C2=A0 15.050572] [004f1dcc] *p=
gd=3D00000000<br>[ =C2=A0 15.054138] Internal error: : 1406 [#1] PREEMPT SM=
P ARM<br>[ =C2=A0 15.055350] nixge 40000000.ethernet sfp0: renamed from eth=
1<br>[ =C2=A0 15.064894] Modules linked in:<br>[ =C2=A0 15.067932] CPU: 0 P=
ID: 194 Comm: python3 Not tainted 4.12.26-yocto-standard #1<br>[ =C2=A0 15.=
075225] Hardware name: Xilinx Zynq Platform<br>[ =C2=A0 15.079736] task: ee=
0063c0 task.stack: edde8000<br>[ =C2=A0 15.084259] PC is at nixge_mdio_read=
+0x90/0x180<br>[ =C2=A0 15.088763] LR is at 0x2800000<br>[ =C2=A0 15.091801=
] pc : [&lt;c05ed5d8&gt;] =C2=A0 =C2=A0lr : [&lt;02800000&gt;] =C2=A0 =C2=
=A0psr: 80030013<br>[ =C2=A0 15.091801] sp : edde9a58 =C2=A0ip : 00000018 =
=C2=A0fp : edde9a7c<br>[ =C2=A0 15.103270] r10: edcb5078 =C2=A0r9 : 0000000=
3 =C2=A0r8 : 804dd639<br>[ =C2=A0 15.108467] r7 : 00000000 =C2=A0r6 : 000f4=
240 =C2=A0r5 : edc9f500 =C2=A0r4 : 00000081<br>[ =C2=A0 15.114980] r3 : fff=
fffff =C2=A0r2 : 00000008 =C2=A0r1 : 00000003 =C2=A0r0 : 803e93f9<br>[ =C2=
=A0 15.121491] Flags: Nzcv =C2=A0IRQs on =C2=A0FIQs on =C2=A0Mode SVC_32 =
=C2=A0ISA ARM =C2=A0Segment none<br>[ =C2=A0 15.128609] Control: 18c5387d =
=C2=A0Table: 2ddec04a =C2=A0DAC: 00000051<br>[ =C2=A0 15.134335] Process py=
thon3 (pid: 194, stack limit =3D 0xedde8210)<br>[ =C2=A0 15.140324] Stack: =
(0xedde9a58 to 0xeddea000)<br>[ =C2=A0 15.144663] 9a40: =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 ffffe000 00010000<br>[ =C2=A0 15.152834] 9a60: edc=
b5000 00000004 40010006 edcb5058 edde9abc edde9a80 c05dcc50 c05ed554<br>[ =
=C2=A0 15.161005] 9a80: edde9adc edde9a90 c016df5c c016d8a4 edde9ab4 edde9a=
f4 00010000 edcb5000<br>[ =C2=A0 15.169166] 9aa0: 00000004 00000001 0000000=
0 edcb5078 edde9adc edde9ac0 c05dab88 c05dcbf4<br>[ =C2=A0 15.177326] 9ac0:=
 edcb5000 00000004 edde9af4 00000001 edde9b44 edde9ae0 c05dbf98 c05dab68<br=
>[ =C2=A0 15.185484] 9ae0: 00000000 edc0cb80 edde9b24 edde9af8 c06ed628 000=
00000 00000000 00000000<br>[ =C2=A0 15.193642] 9b00: 00000000 00000000 0000=
0000 00000000 00000000 00000000 edde9b44 edc18300<br>[ =C2=A0 15.201802] 9b=
20: 00000001 edcb5000 00000004 00000000 00000000 edcb5078 edde9b74 edde9b48=
<br>[ =C2=A0 15.209962] 9b40: c06f4144 c05dbf30 edde9b74 edde9b58 c06f4564 =
c06ed6bc edcb5000 edc18f80<br>[ =C2=A0 15.218120] 9b60: edc18300 00000004 e=
dde9bac edde9b78 c06f46e4 c06f4050 00000000 00000000<br>[ =C2=A0 15.226280]=
 9b80: edde9ba4 edc9f000 edcb5000 ee00c200 edc9f500 edc18f80 00000006 00000=
000<br>[ =C2=A0 15.234440] 9ba0: edde9bdc edde9bb0 c05ed900 c06f45dc c0146e=
68 00000006 ee00c210 c05ed6c8<br>[ =C2=A0 15.242599] 9bc0: ee00c210 c0d8031=
4 00000000 c0d80314 edde9bfc edde9be0 c05701c4 c05ed6d4<br>[ =C2=A0 15.2507=
58] 9be0: ee00c210 c0e35150 00000000 00000000 edde9c24 edde9c00 c056e330 c0=
570170<br>[ =C2=A0 15.258917] 9c00: c0d80314 ee00c210 edde9c70 ee00c244 c0e=
3512c 00000000 edde9c44 edde9c28<br>[ =C2=A0 15.267076] 9c20: c056e5a0 c056=
e12c edde9c70 c056e4fc 00000000 ee00c244 edde9c6c edde9c48<br>[ =C2=A0 15.2=
75235] 9c40: c056c7c8 c056e508 ef16e06c ee6d3d38 ee00c210 ee00c210 c0d73658=
 00000001<br>[ =C2=A0 15.283395] 9c60: edde9c94 edde9c70 c056e068 c056c73c =
ee00c210 00000001 ee00c210 c0d73658<br>[ =C2=A0 15.291554] 9c80: ee00c210 e=
f18ee10 edde9ca4 edde9c98 c056e5d4 c056dfc8 edde9cc4 edde9ca8<br>[ =C2=A0 1=
5.299713] 9ca0: c056d600 c056e5c4 ee00c210 ee00c218 00000000 ef18ee10 edde9=
d04 edde9cc8<br>[ =C2=A0 15.307872] 9cc0: c056b858 c056d5d4 40008000 4000df=
ff ee04d100 00000200 00000000 ee00c200<br>[ =C2=A0 15.316031] 9ce0: edc18fd=
0 00000000 00000000 ef18ee10 ee235b28 00000000 edde9d14 edde9d08<br>[ =C2=
