...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 48FAFB0F69D
	for <lists+usrp-users@lfdr.de>; Wed, 23 Jul 2025 17:10:56 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 8DCAD385BA2
	for <lists+usrp-users@lfdr.de>; Wed, 23 Jul 2025 11:10:55 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1753283455; bh=LiRO2408/zhdry64aNHLTTdMZOINLBm6j/w8vNZoUSI=;
	h=From:To:Date:References:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from za-smtp-delivery-57.mimecast.co.za (za-smtp-delivery-57.mimecast.co.za [41.74.205.57])
	by mm2.emwd.com (Postfix) with ESMTPS id 37217385513
	for <usrp-users@lists.ettus.com>; Wed, 23 Jul 2025 11:10:03 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (1024-bit key; unprotected) header.d=vastech.co.za header.i=@vastech.co.za header.b="A9TIok7V";
	dkim-atps=neutral
Received: from mail.vastech.co.za (41.193.248.106 [41.193.248.106]) by
 relay.mimecast.com with ESMTP id za-mta-44-LeZLDAzDMC28IRs_rKbz1g-1; Wed,
 23 Jul 2025 17:09:58 +0200
X-MC-Unique: LeZLDAzDMC28IRs_rKbz1g-1
X-Mimecast-MFC-AGG-ID: LeZLDAzDMC28IRs_rKbz1g_1753283398
dkim-signature: v=1; a=rsa-sha256; d=vastech.co.za; s=dkim;
	...
	bh=k8rSECw6b5mQUwes7Wy/hgCNOpbIq2kNesSao/rVzx8=;
	b=A9TIok7VWeXK69aKX/kmnx+7MUTcccTMOultxHmaxmOg0o+DNYaFNNDz14bvaIvEPTS/w9aWQIN13mpnk12olga8fvc1JcYNubGYMRCv7Nmuo4zVEqbJXi1solE/VOAIfOwXpWZZ2cnB9NNySLaCy+LP6ugZ/D7mALoVFewvz5s=
Received: from exchange3.vastech.co.za (Unknown [172.30.81.31])
	by mail.vastech.co.za with ESMTPSA
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256)
	; Wed, 23 Jul 2025 17:09:56 +0200
...
Thread-Index: AQHb++IkYMk+p2kicke3vxbc7X5L4bQ/z17Q
Date: Wed, 23 Jul 2025 15:09:55 +0000
Message-ID: <952a649d6b964784ac6922804a1549eb@vastech.co.za>
...
MIME-Version: 1.0
Message-ID-Hash: SHAGTYFGV4UHDQWJMPG2TBQS7NNJ5JVY
X-Message-ID-Hash: SHAGTYFGV4UHDQWJMPG2TBQS7NNJ5JVY
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/SHAGTYFGV4UHDQWJMPG2TBQS7NNJ5JVY/>
...
Content-Type: multipart/mixed; boundary="===============9083777987886895001=="

--===============9083777987886895001==
Content-Language: en-US
Content-Type: multipart/signed; protocol="application/x-pkcs7-signature";
	micalg=2.16.840.1.101.3.4.2.3;
	boundary="----=_NextPart_000_0110_01DBFBF4.9BA07DA0"

------=_NextPart_000_0110_01DBFBF4.9BA07DA0
Content-Type: multipart/alternative;
	boundary="----=_NextPart_001_0111_01DBFBF4.9BA07DA0"


------=_NextPart_001_0111_01DBFBF4.9BA07DA0
Content-Type: text/plain;
	charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

I=E2=80=99m using the default which I read is fc=3D0.
...
Some more info: if I increase the decimation in my block I get more =
packets, but it still stalls.
...
style=3D'mso-fareast-language:EN-US'>I=E2=80=99m using the default which =
I read is fc=3D0.<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>I will try =
explicitly setting it.<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span style=3D'mso-fareast-language:EN-US'>Some more =
info: if I increase the decimation in my block I get more packets, but =
it still stalls.<o:p></o:p></span></p><p class=3DMsoNormal><span =
style=3D'mso-fareast-language:EN-US'><o:p>&nbsp;</o:p></span></p><p =
...
CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNTA3MjMxNTA5NTNaME8GCSqGSIb3DQEJ
BDFCBEAC7g3ZcUuiGfLCkiQwO3T3LuZF/ot3EK1uwvdX7hjafxZSaRHQMha+aP4lmeajQFZ4jb5i
MmPOE2mlw/JfavUFMH0GCSsGAQQBgjcQBDFwMG4waTEmMCQGCSqGSIb3DQEJARYXaXRzdXBwb3J0
...

