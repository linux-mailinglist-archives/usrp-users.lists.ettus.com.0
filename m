
Content-Language: en-US

This is a multi-part message in MIME format.
--------------x2dnajGReOtD0RtiQtXra5cP
...
> First of all:
>
> /ad@bm-super11-intel:~/accelleran$ uhd_usrp_probe -a=20
...
/
>
> Secondly, Maybe the following is the issue; WHen I run xxx in the host=20
> machine I see a version and when I run the same command on the n310=20
> itself, I get another version. How to avoid this?
>
> 15_16:21:07.jpg
Indeed, I noticed that your radio hardware is ahead of your host=20
computer in UHD version.

The best thing might be to upgrade UHD on your host, if possible. If=20
...
>
> On Tue, 15 Oct 2024 at 16:18, Houshang <houshang.azizi@accelleran.com>=20
> wrote:
>
>     Hi
>     /
...
>     64 bytes from 10.10.1.100 <http://10.10.1.100>: icmp_seq=3D1 ttl=3D=
64
>     time=3D1.02 ms
>     64 bytes from 10.10.1.100 <http://10.10.1.100>: icmp_seq=3D2 ttl=3D=
64
>     time=3D0.970 ms
>     ^C
...
>     64 bytes from 10.10.2.100 <http://10.10.2.100>: icmp_seq=3D1 ttl=3D=
64
>     time=3D1.03 ms
>     64 bytes from 10.10.2.100 <http://10.10.2.100>: icmp_seq=3D2 ttl=3D=
64
>     time=3D0.963 ms
>     ^C
...
>>>             To unsubscribe send an email tousrp-users-leave@lists.ett=
us.com
>>             I think I've asked you this before on this issue:
>>
>>             What does your network connection setup look like?
>>
>>             Are you using the RJ-45 port and the SFP+ port(s)?=C2=A0=C2=
=A0 How
...
Content-Type: multipart/related;
 boundary="------------D011Xpc0Hi0cV5PZtkGYGqO0"

--------------D011Xpc0Hi0cV5PZtkGYGqO0
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 15/10/2024 10:24, Houshang wrote:<b=
r>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAO=3Dxj9X2WY3n=3DFAH8Wikfh-o5iLM2RrA6c9yRbgj7rym3UeWXw@mail.=
gmail.com">
...
gmail.com">
      <div dir=3D"ltr">
        ...
        <div><img src=3D"cid:part1.lv9Cj000.wg42VcB4@gmail.com"
            alt=3D"15_16:21:07.jpg" class=3D"" width=3D"578" height=3D"51=
3"><br>
        </div>
      </div>
    </blockquote>
...
gmail.com"><br>
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct 2024 at 16:1=
8,
...
padding-left:1ex">
          <div dir=3D"ltr">
            <div dir=3D"ltr">
              <div>Hi</div>
              <div><span style=3D"background-color:rgb(204,204,204)"><i><=
br>
                  </i></span></div>
              <div><i style=3D"background-color:rgb(204,204,204)">ad@bm-s=
uper11-intel:~/accelleran$
                  ssh <a href=3D"mailto:root@10.10.0.100" target=3D"_blan=
k"
                    moz-do-not-send=3D"true" class=3D"moz-txt-link-freete=
xt">root@10.10.0.100</a></i></div>
              <span style=3D"background-color:rgb(204,204,204)"><i>root@n=
i-n3xx-32000F1:~#
                  uhd_config_info --version<br>
                  UHD 4.7.0.0-0-ga5ed1872<br>
                </i></span>
              <div><i style=3D"background-color:rgb(204,204,204)">root@ni=
-n3xx-32000F1:~#
                </i><br>
              </div>
              <div><br>
...
br>
                    64 bytes from <a href=3D"http://10.10.0.100"
                      target=3D"_blank" moz-do-not-send=3D"true">10.10.0.=
100</a>:
...
100</a>:
                    ...
                    time 1051ms<br>
                    rtt min/avg/max/mdev =3D 0.199/0.224/0.250/0.025 ms<b=
r>
...
br>
                    64 bytes from <a href=3D"http://10.10.1.100"
                      target=3D"_blank" moz-do-not-send=3D"true">10.10.1.=
100</a>:
...
100</a>:
                    ...
                    2 packets transmitted, 2 received, 0% packet loss,
                    time 1001ms<br>
                    rtt min/avg/max/mdev =3D 0.970/0.996/1.022/0.026 ms<b=
r>
...
br>
                    64 bytes from <a href=3D"http://10.10.2.100"
                      target=3D"_blank" moz-do-not-send=3D"true">10.10.2.=
100</a>:
...
100</a>:
                    ...
                    2 packets transmitted, 2 received, 0% packet loss,
                    time 1001ms<br>
                    rtt min/avg/max/mdev =3D 0.963/0.994/1.025/0.031 ms<b=
r>
                    ad@bm-super11-intel:~/accelleran$ </span></i><br>
              </div>
              <div><br>
...
>
                      ...
                      <div>Based on your question, I am attaching some
                        more info. Let me know if something is missing.<b=
r>
                      </div>
                      <div><br>
                      </div>
...
t
                        2024 at 16:04, Marcus D. Leech &lt;<a
                        ...
                        <div>
                          ...
                          <blockquote type=3D"cite">
                            <div dir=3D"ltr">
                              ...
                              <div><img
src=3D"cid:part2.7UPoc6ZX.Pi2AKOK3@gmail.com" alt=3D"15_15:37:26.jpg"
...
style=3D"font-size:11pt;font-family:Arial,sans-serif;color:rgb(246,146,30=
                                    ...
                                    <a
                                      href=3D"https://www.accelleran.com/=
"
                                      rel=3D"noopener"
...
ave@lists.ettus.com</a>
                          ...
                          port(s)?=C2=A0=C2=A0 How are things connected, =
and on
                          what subnets?<br>
                          <br>
                          <br>
...
style=3D"font-size:10pt;font-family:Arial,sans-serif"><b><span
                          style=3D"color:black"><a
                            href=3D"mailto:Email@accelleran.com"
                            target=3D"_blank" moz-do-not-send=3D"true">ho=
...
style=3D"font-size:10pt;font-family:Arial,sans-serif"><a
                        ...
                        moz-do-not-send=3D"true"><b><span
                            style=3D"color:rgb(246,146,30)">www.accellera=
n.com</span></b></a></span></p>
                </div>
                <p style=3D"text-align:left;margin:20px 0px"><a
...
style=3D"border: 0px; vertical-align: middle; height: 15px; width: 15px;"
                    ...
                    href=3D"https://twitter.com/accelleran" rel=3D"noopen=
er"
style=3D"color:rgb(51,122,183);background-color:transparent"
                    target=3D"_blank" moz-do-not-send=3D"true"><img
                      alt=3D"twitter icon"
...
Content-Id: <part1.lv9Cj000.wg42VcB4@gmail.com>
...
Content-Id: <part2.7UPoc6ZX.Pi2AKOK3@gmail.com>
Content-Transfer-Encoding: base64
