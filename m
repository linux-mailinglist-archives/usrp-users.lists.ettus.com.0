...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id EE4542DC914
	for <lists+usrp-users@lfdr.de>; Wed, 16 Dec 2020 23:42:45 +0100 (CET)
Received: from [::1] (port=54214 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1kpfVM-0001TQ-V0; Wed, 16 Dec 2020 17:42:44 -0500
Received: from mail-ot1-f46.google.com ([209.85.210.46]:44636)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <rkossler@nd.edu>) id 1kpfVI-0001Oh-Nw
 for usrp-users@lists.ettus.com; Wed, 16 Dec 2020 17:42:40 -0500
Received: by mail-ot1-f46.google.com with SMTP id f16so25001770otl.11
 for <usrp-users@lists.ettus.com>; Wed, 16 Dec 2020 14:42:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nd.edu; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=z0+vMp1yDL5NSY2qZF9zQFBsk2DHjDrDOrRRF/TJuiE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=z0+vMp1yDL5NSY2qZF9zQFBsk2DHjDrDOrRRF/TJuiE=;
 b=
X-Gm-Message-State: AOAM531swVqR0ARCeSTmLuIMVZaKjvNJpiTntq53NLR3BYLiH0nHgxjG
 Du8OZieEDM95jyh7eAPfN08ZjXqvx4OO7FJvjESyoLeihyMlmQ==
X-Google-Smtp-Source: ABdhPJwNfOGkxRk08DcUEqYD15M21r20g+GvrZzoFbUbtC9JCLWPRMhhV0J4tYNT/XVSMLSNBzq8MWK7d89dYNe5C/U=
X-Received: by 2002:a9d:4e87:: with SMTP id v7mr17796141otk.302.1608158519660; 
 Wed, 16 Dec 2020 14:41:59 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CAFche=jfksHjme=MEtTou4cNWOzToudHqZH1TSWOr1xCWTfV3w@mail.gmail.com>
Date: Wed, 16 Dec 2020 17:41:48 -0500
Message-ID: <CAB__hTRu24de7NWf_7RY4qS5tGVyGC_f-COmPYAVxxg0tYis+A@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============4262155913237092464=="
...
--===============4262155913237092464==
Content-Type: multipart/alternative; boundary="0000000000004ee1f205b69c9540"

--0000000000004ee1f205b69c9540
...
<div dir=3D"ltr">Thanks Wade,<div>That fixes it for my test case with 2 swi=
tchboards in series.=C2=A0 I&#39;ll let you know if I see anything strange =
when testing with my custom blocks.</div><div><br></div><div>By the way, do=
es this bug only affect N3xx devices or all RFNoC devices?</div><div>Rob</d=
iv></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_att=
r">On Wed, Dec 16, 2020 at 5:33 PM Wade Fife &lt;<a href=3D"mailto:wade.fif=
e@ettus.com">wade.fife@ettus.com</a>&gt; wrote:<br></div><blockquote class=
=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rg=
b(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Rob,</div><div><br><=
/div><div>I think I found the source of the IQ swap issue you observed. Thi=
s fixes it for me:<br></div><div><br></div><div>diff --git a/host/lib/rfnoc=
/mgmt_portal.cpp b/host/lib/rfnoc/mgmt_portal.cpp<br>index a54efaaf7..7b09c=
540b 100644<br>--- a/host/lib/rfnoc/mgmt_portal.cpp<br>+++ b/host/lib/rfnoc=
/mgmt_portal.cpp<br>@@ -617,6 +617,24 @@ public:<br>=C2=A0 =C2=A0 =C2=A0 =
