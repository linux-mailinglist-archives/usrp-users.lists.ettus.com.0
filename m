...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C664368770
	for <lists+usrp-users@lfdr.de>; Thu, 22 Apr 2021 21:51:42 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 2F9973848F7
	for <lists+usrp-users@lfdr.de>; Thu, 22 Apr 2021 15:51:41 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="QwTtJcer";
	dkim-atps=neutral
Received: from mail-ej1-f49.google.com (mail-ej1-f49.google.com [209.85.218.49])
	by mm2.emwd.com (Postfix) with ESMTPS id BDCFB384244
	for <usrp-users@lists.ettus.com>; Thu, 22 Apr 2021 15:50:45 -0400 (EDT)
Received: by mail-ej1-f49.google.com with SMTP id w23so54767526ejb.9
        for <usrp-users@lists.ettus.com>; Thu, 22 Apr 2021 12:50:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=mbZHvTq1nJmWB5twR9UU4sWngRZe7CZbniceXaLLEvQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mbZHvTq1nJmWB5twR9UU4sWngRZe7CZbniceXaLLEvQ=;
        b=
X-Gm-Message-State: AOAM531V1/c+2SGDc3/agzpAxWMltEa5HeF+exFZLeCoGC6w+o4tmIDi
	VAh46Xd0sAj2kK9k1ZH5AsLqzdwfZ7JNeJ73EsA=
X-Google-Smtp-Source: ABdhPJxhSmGvqR7E73tNYanLmfshDZW0HHIODnsK2LjjOIRT2ptQPNLw+MkM2cBXBAX2ykOA9z9N7S+XKkpAHmFY93U=
X-Received: by 2002:a17:906:c01a:: with SMTP id e26mr364342ejz.300.1619121044184;
 Thu, 22 Apr 2021 12:50:44 -0700 (PDT)
MIME-Version: 1.0
References: <CAB__hTQUGf5fbAyC4BjmxTSrQE7LwYrQd4U=hWQx-3ekdAgNnA@mail.gmail.com>
 <CAPnVNRUAp1_OT2VZb8KyQsc-H1U+YxSEgqcNkfwx1VbU97H+1Q@mail.gmail.com> <CAB__hTRBBMFtwyTq7hcf1HU4097FgtKFqwpN_yFxFGi=xp3Ymw@mail.gmail.com>
In-Reply-To: <CAB__hTRBBMFtwyTq7hcf1HU4097FgtKFqwpN_yFxFGi=xp3Ymw@mail.gmail.com>
From: Cameron Matson <ncmatson95@gmail.com>
Date: Thu, 22 Apr 2021 14:50:32 -0500
Message-ID: <CAGLr63taVOtkpCHS8xd9GJp_qkt9wMQiePECTf5baP+aAoEB+Q@mail.gmail.com>
To: Rob Kossler <rkossler@nd.edu>, Anders Wallin <anders.e.e.wallin@gmail.com>
Message-ID-Hash: SRPZJTVBUDAJR3DULIWJIZLYEMQ33VIM
X-Message-ID-Hash: SRPZJTVBUDAJR3DULIWJIZLYEMQ33VIM
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/SRPZJTVBUDAJR3DULIWJIZLYEMQ33VIM/>
...
Content-Type: multipart/mixed; boundary="===============1714707646331705153=="

--===============1714707646331705153==
Content-Type: multipart/related; boundary="000000000000b1882705c094fede"

--000000000000b1882705c094fede
Content-Type: multipart/alternative; boundary="000000000000b1882605c094fedd"

--000000000000b1882605c094fedd
...
UHD_4.0.0.0-185-g546ea894

[INFO] [MPMD] Initializing 1 device(s) in parallel with args:
mgmt_addr=192.168.0.101,type=n3xx,product=n310,serial=3176DE4,claimed=False,addr=192.168.0.101,time_source=sfp0,clock_source=internal
...
`clock_source=internal,mgmt_addr=192.168.0.101,product=n310,time_source=sfp0'.
...
*[WARNING] [UDP] *The current recv_buff_size of 212992 is less than
the minimum recommended size of 816000 and may result in dropped
packets on some NICs

*[WARNING] [UDP] *The current send_buff_size of 212992 is less than
...
> Rob
>
> On Thu, Mar 18, 2021 at 5:48 AM Anders Wallin <anders.e.e.wallin@gmail.com>
> wrote:
>
>> Hi Rob,
>>
...
>> Some general comments to this would be: in free-run mode the WR-switch is
>> quite poor. The frequency is off by 1-10 PPM or more, and the stability is
>> based on a fairly cheap/small quartz crystal in the switch. (This is not to
>> say several slaves all connected to the same free-run switch wouldn't be
...
>> Boundary Clock means you have a GM switch somewhere upstream, with the GM
>> Master-port connecting to your BC-switch slave-port (usually ports 1 and
...
<div dir=3D"ltr"><div dir=3D"ltr">Following up on this because I&#39;m in a=
 similar boat.=C2=A0 I currently have a single WRS without 10Mhz/PPS refere=
nce source connected to several N310s.=C2=A0 I&#39;ve tried all of the diff=
erent modes on the WRS and it always complains of not having the clock/pps.=
=C2=A0 For example using the &quot;test_pps_intput&quot; example script pro=
duces the following output<div><br></div><div>./test_pps_input --args addr=
=3D192.168.0.101,time_source=3Dsfp0,clock_source=3Dinternal<br></div><div><=
br></div><div>The first time it looks like the daughterboard initialization=
 fails:</div></div><blockquote style=3D"margin:0 0 0 40px;border:none;paddi=
ng:0px"><div><div><pre>Creating the USRP device with: addr=3D192.168.0.101,=
time_source=3Dsfp0,clock_source=3Dinternal...</pre></div></div><div><div><p=
re><font color=3D"#00AA00">[INFO] [UHD] </font>linux; GNU C++ version 7.5.0=
; Boost_106501; UHD_4.0.0.0-185-g546ea894</pre></div></div><div><div><pre><=
font color=3D"#00AA00">[INFO] [MPMD] </font>Initializing 1 device(s) in par=
allel with args: mgmt_addr=3D192.168.0.101,type=3Dn3xx,product=3Dn310,seria=
l=3D3176DE4,claimed=3DFalse,addr=3D192.168.0.101,time_source=3Dsfp0,clock_s=
ource=3Dinternal</pre></div></div><div><div><pre><font color=3D"#FF5555"><b=
>[ERROR] [RPC] </b></font>TDC Failed to reset.</pre></div></div><div><div><=
pre><font color=3D"#00AA00">[INFO] [MPM.Magnesium-0] </font>Re-initializing=
 daughter board. This may take some time.</pre></div></div><div><div><pre><=
font color=3D"#FF5555"><b>[ERROR] [MPM.Sync-0] </b></font>TDC Failed to Res=
et! Check your clocks! Status: 0x0</pre></div></div><div><div><pre><font co=
lor=3D"#FF5555"><b>[ERROR] [MPM.RPCServer] </b></font>init() failed with er=
ror: TDC Failed to reset.</pre></div></div><div><div><pre>Error: RuntimeErr=
or: Error during RPC call to `init&#39;. Error message: TDC Failed to reset=
.</pre></div></div></blockquote><div dir=3D"ltr"><div><pre><br></pre><pre><=
font face=3D"arial, sans-serif">* After that, subsequent calls just indicat=
e that the pps signal isn&#39;t found:</font></pre></div></div><blockquote =
style=3D"margin:0 0 0 40px;border:none;padding:0px"><div><div><pre>Creating=
 the USRP device with: addr=3D192.168.0.101,time_source=3Dsfp0,clock_source=
=3Dinternal...</pre></div></div><div><div><pre><font color=3D"#00AA00">[INF=
O] [UHD] </font>linux; GNU C++ version 7.5.0; Boost_106501; UHD_4.0.0.0-185=
-g546ea894</pre></div></div><div><div><pre><font color=3D"#00AA00">[INFO] [=
MPMD] </font>Initializing 1 device(s) in parallel with args: mgmt_addr=3D19=
2.168.0.101,type=3Dn3xx,product=3Dn310,serial=3D3176DE4,claimed=3DFalse,add=
r=3D192.168.0.101,time_source=3Dsfp0,clock_source=3Dinternal</pre></div></d=
iv><div><div><pre><font color=3D"#00AA00">[INFO] [MPM.PeriphManager] </font=
>init() called with device args `clock_source=3Dinternal,mgmt_addr=3D192.16=
8.0.101,product=3Dn310,time_source=3Dsfp0&#39;.</pre></div></div><div><div>=
<pre><font color=3D"#FFFF55"><b>[WARNING] [UDP] </b></font>The recv buffer =
...
><pre><font color=3D"#FFFF55"><b>[WARNING] [UDP] </b></font>The send buffer=
 could not be resized sufficiently.</pre></div></div><div><div><pre>Target =
sock buff size: 2500000 bytes.</pre></div></div><div><div><pre>Actual sock =
buff size: 212992 bytes.</pre></div></div><div><div><pre>See the transport =
application notes on buffer resizing.</pre></div></div><div><div><pre>Pleas=
e run: sudo sysctl -w net.core.wmem_max=3D2500000</pre></div></div><div><di=
v><pre><font color=3D"#FFFF55"><b>[WARNING] [UDP] </b></font>The current re=
cv_buff_size of 212992 is less than the minimum recommended size of 816000 =
and may result in dropped packets on some NICs</pre></div></div><div><div><=
pre><font color=3D"#FFFF55"><b>[WARNING] [UDP] </b></font>The current send_=
buff_size of 212992 is less than the minimum recommended size of 307200 and=
 may result in dropped packets on some NICs</pre></div></div><div><div><pre=
>Using Device: Single USRP:</pre></div></div><div><div><pre>  Device: N300-=
Series Device</pre></div></div><div><div><pre>  Mboard 0: n310</pre></div><=
/div><div><div><pre>  RX Channel: 0</pre></div></div><div><div><pre>    RX =
DSP: 0</pre></div></div><div><div><pre>    RX Dboard: A</pre></div></div><d=
iv><div><pre>    RX Subdev: Magnesium</pre></div></div><div><div><pre>  RX =
Channel: 1</pre></div></div><div><div><pre>    RX DSP: 1</pre></div></div><=
div><div><pre>    RX Dboard: A</pre></div></div><div><div><pre>    RX Subde=
v: Magnesium</pre></div></div><div><div><pre>  RX Channel: 2</pre></div></d=
iv><div><div><pre>    RX DSP: 2</pre></div></div><div><div><pre>    RX Dboa=
rd: B</pre></div></div><div><div><pre>    RX Subdev: Magnesium</pre></div><=
/div><div><div><pre>  RX Channel: 3</pre></div></div><div><div><pre>    RX =
DSP: 3</pre></div></div><div><div><pre>    RX Dboard: B</pre></div></div><d=
iv><div><pre>    RX Subdev: Magnesium</pre></div></div><div><div><pre>  TX =
Channel: 0</pre></div></div><div><div><pre>    TX DSP: 0</pre></div></div><=
div><div><pre>    TX Dboard: A</pre></div></div><div><div><pre>    TX Subde=
v: Magnesium</pre></div></div><div><div><pre>  TX Channel: 1</pre></div></d=
iv><div><div><pre>    TX DSP: 1</pre></div></div><div><div><pre>    TX Dboa=
rd: A</pre></div></div><div><div><pre>    TX Subdev: Magnesium</pre></div><=
/div><div><div><pre>  TX Channel: 2</pre></div></div><div><div><pre>    TX =
DSP: 2</pre></div></div><div><div><pre>    TX Dboard: B</pre></div></div><d=
iv><div><pre>    TX Subdev: Magnesium</pre></div></div><div><div><pre>  TX =
Channel: 3</pre></div></div><div><div><pre>    TX DSP: 3</pre></div></div><=
div><div><pre>    TX Dboard: B</pre></div></div><div><div><pre>    TX Subde=
v: Magnesium</pre></div></div><div><div><pre></pre></div></div><div><div><p=
re>Attempt to detect the PPS and set the time...</pre></div></div><div><div=
><pre></pre></div></div><div><div><pre><font color=3D"#00AA00">[INFO] [MULT=
I_USRP] </font>    1) catch time transition at pps edge</pre></div></div><d=
iv><div><pre>Error: RuntimeError: Board 0 may not be getting a PPS signal!<=
/pre></div></div><div><div><pre>No PPS detected within the time interval.</=
pre></div></div><div><div><pre>See the application notes for your device.</=
pre></div></div></blockquote><div dir=3D"ltr"><pre><br></pre><pre><span sty=
le=3D"font-family:arial,sans-serif">Thanks for your help,</span><br></pre><=
pre>Cameron</pre><pre><br></pre></div><br><div class=3D"gmail_quote"><div d=
ir=3D"ltr" class=3D"gmail_attr">On Thu, Mar 18, 2021 at 9:10 AM Rob Kossler=
 &lt;<a href=3D"mailto:rkossler@nd.edu" target=3D"_blank">rkossler@nd.edu</=
a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0p=
x 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><d=
iv dir=3D"ltr">Hi Anders,<div>Thanks for all of the great information. Part=
icularly regarding accuracy, this was much more than I expected - but very =
much=C2=A0appreciated.</div><div><br></div><div>Regarding modes, I want to =
confirm: in the case where I do not have a 10MHz/PPS source, I *must* choos=
e Free Running Master mode?=C2=A0 Or, is it possible that if I keep the def=
ault Boundary Clock mode, the WR Switch will automatically transition to us=
ing its internal=C2=A0oscillator when it does not have an upstream GM??</di=
v><div><br></div><div>One reason that I ask is that I presently have 1 WR S=
witch and 1 N3xx connected (with no 10 Mhz/PPS source) and my N3xx is compl=
aining about not getting a PPS signal.=C2=A0 I have tried all WR switch mod=
es.=C2=A0</div><div>Rob</div></div><br><div class=3D"gmail_quote"><div dir=
