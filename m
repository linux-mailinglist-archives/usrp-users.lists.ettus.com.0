...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BF3E58AB47
	for <lists+usrp-users@lfdr.de>; Fri,  5 Aug 2022 15:07:26 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 1E219383CD6
	for <lists+usrp-users@lfdr.de>; Fri,  5 Aug 2022 09:07:25 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1659704845; bh=3qXzjBV0VjZwjoYJQyCErPGT38GAAfulgBBZ4EO9NqI=;
	h=Date:To:Subject:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From:Reply-To:From;
	b=
Received: from mail-40140.protonmail.ch (mail-40140.protonmail.ch [185.70.40.140])
	by mm2.emwd.com (Postfix) with ESMTPS id 71C4A383B00
	for <usrp-users@lists.ettus.com>; Fri,  5 Aug 2022 09:05:20 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=protonmail.com header.i=@protonmail.com header.b="gfNjJ2xD";
	dkim-atps=neutral
Date: Fri, 05 Aug 2022 13:05:12 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=protonmail.com;
	s=protonmail3; t=1659704718; x=1659963918;
	bh=G0rxKm0oTqwLdcl+ZKEOsbRjH9M396KqkRR7xwTkP/M=;
	h=Date:To:From:Reply-To:Subject:Message-ID:Feedback-ID:From:To:Cc:
	 Date:Subject:Reply-To:Feedback-ID:Message-ID;
	b=
To: "usrp-users@lists.ettus.com" <usrp-users@lists.ettus.com>
Message-ID: <imCtxLofpX-3fpMGmbvOkk-3ohkyMfXpNecBfU5byRFXj5AKIS7t5M0wef0STZEjNrK4y7c2JEvmbhWdghW9x0KKo-s4sDyWqUkKTmZuqzo=@protonmail.com>
Feedback-ID: 4856445:user:proton
MIME-Version: 1.0
Message-ID-Hash: 7OQ5AZBR7FRW6UWWF2PELT3QGZNSE6PE
X-Message-ID-Hash: 7OQ5AZBR7FRW6UWWF2PELT3QGZNSE6PE
X-MailFrom: kosinov@protonmail.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-usrp-users.lists.ettus.com-0; header-match-usrp-users.lists.ettus.com-1; header-match-usrp-users.lists.ettus.com-2; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
X-Mailman-Version: 3.3.3
Precedence: list
Subject: [USRP-users] Debugging with chipscope. Unable to connect to debug core
List-Id: USRP-related discussion and support <usrp-users.lists.ettus.com>
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/7OQ5AZBR7FRW6UWWF2PELT3QGZNSE6PE/>
...
Content-Type: multipart/mixed; boundary="===============0990400344564623538=="

This is a multi-part message in MIME format.

--===============0990400344564623538==
Content-Type: multipart/alternative;
 boundary="b1_mAGcLjYYxPsov3v8CAhdNS3vHIDngRDFb5czwhiBvvQ"

This is a multi-part message in MIME format.

--b1_mAGcLjYYxPsov3v8CAhdNS3vHIDngRDFb5czwhiBvvQ
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: base64


dCByZWdhcmRzLApBbGV4

--b1_mAGcLjYYxPsov3v8CAhdNS3vHIDngRDFb5czwhiBvvQ
Content-Type: multipart/related;
 boundary="b2_mAGcLjYYxPsov3v8CAhdNS3vHIDngRDFb5czwhiBvvQ";
 type="text/html"

--b2_mAGcLjYYxPsov3v8CAhdNS3vHIDngRDFb5czwhiBvvQ
Content-Type: text/html; charset=utf-8
Content-Transfer-Encoding: base64


...

DQpBbGV4PC9kaXY+

--b2_mAGcLjYYxPsov3v8CAhdNS3vHIDngRDFb5czwhiBvvQ
Content-Type: image/jpeg; name=Untitled.jpg
Content-Transfer-Encoding: base64
Content-ID: <cac9c705@protonmail.com>
