...
ut<br><br>input 0 =C2=A0---&gt; DUC ---&gt;<br>=C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 add ---&=
gt; output<br>input 1 =C2=A0---&gt; DUC ---&gt;<br><br>I have added an adds=
ub module between dds_timed and axi_wrapper. Apparently it works fine. I ca=
n see two tones in the output if the inputs are 2 tones. <br><br>But I have=
 a synchronization problem. If input_0 is a sine and input_1 is a sine with=
 pi phase the output should be 0. And the output is 0, but after a while (3=
 minutes) no. I think that the channels are out of sync before the adder.<b=
r><br>Any idea about what is happening?<br><br>Thank you :)<br></div>
</blockquote></div>
