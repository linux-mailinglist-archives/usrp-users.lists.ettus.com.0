...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 27A50FDD78
	for <lists+usrp-users@lfdr.de>; Fri, 15 Nov 2019 13:25:41 +0100 (CET)
Received: from [::1] (port=49756 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iVafO-0001X9-0i; Fri, 15 Nov 2019 07:25:34 -0500
Received: from resqmta-po-01v.sys.comcast.net ([96.114.154.160]:36480)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256)
 (Exim 4.92) (envelope-from <w6rz@comcast.net>) id 1iVafK-0001R0-Kl
 for usrp-users@lists.ettus.com; Fri, 15 Nov 2019 07:25:30 -0500
Received: from resomta-po-03v.sys.comcast.net ([96.114.154.227])
 by resqmta-po-01v.sys.comcast.net with ESMTP
 id VacEiqT9EAlDJVaefigBu8; Fri, 15 Nov 2019 12:24:49 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=comcast.net;
 s=20190202a; t=1573820689;
 bh=0qKVP6wam0WJhqCFX+QK1lUH/EppQPF7OoExmVilmK8=;
 h=Received:Received:Subject:To:From:Message-ID:Date:MIME-Version:
 Content-Type;
 b=
Received: from [IPv6:2601:647:4200:ea30:2956:68cc:6be0:7b56]
 ...
 id VaeeiU6R062cKVaeeioX3k; Fri, 15 Nov 2019 12:24:49 +0000
X-Xfinity-VMeta: sc=0.00;st=legit
To: usrp-users@lists.ettus.com
References: <CAGLe3RnJAJQ=pf1F0SvDfG3AexdS52KRKrQ6CsouhXvAFxyfNg@mail.gmail.com>
Message-ID: <88768f87-f59e-e5a3-3a17-d884721fc3fa@comcast.net>
Date: Fri, 15 Nov 2019 04:24:48 -0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.0
MIME-Version: 1.0
In-Reply-To: <CAGLe3RnJAJQ=pf1F0SvDfG3AexdS52KRKrQ6CsouhXvAFxyfNg@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============6513707087904342328=="
...
Content-Type: multipart/alternative;
 boundary="------------6EFD4A6FCAA978078239EA81"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------6EFD4A6FCAA978078239EA81
...
= Normalized, Gain Value = 1 and Amplitude = 1 in the Signal Source, 
you'll be transmitting at maximum power.
...
Content-Type: multipart/related;
 boundary="------------2D36B83C98FD09BA06F13FD6"


--------------2D36B83C98FD09BA06F13FD6
...
<html>
  ...
  <body text="#000000" bgcolor="#FFFFFF">
    ...
    <p>Be sure to terminate the output of the B200 with 50 ohms. With
      Gain Type = Normalized, Gain Value = 1 and Amplitude = 1 in the
      Signal Source, you'll be transmitting at maximum power.<br>
    </p>
    <p>Ron<br>
    </p>
    <div class="moz-cite-prefix">On 11/15/19 00:44, Van-Dung PHAM via
      USRP-users wrote:<br>
    </div>
    <blockquote type="cite"
cite="mid:CAGLe3RnJAJQ=pf1F0SvDfG3AexdS52KRKrQ6CsouhXvAFxyfNg@mail.gmail.com">
      <meta http-equiv="content-type" content="text/html; charset=UTF-8">
      <div dir="ltr">Dear all,
        ...
        <div>
          <div><img src="cid:part1.94CE2D3C.E5E2418E@comcast.net"
              alt="image.png" style="margin-right: 0px;" class=""
              width="542" height="355"><br>
          </div>
        </div>
        <div>But what I got in the oscilloscope is not a cosine/sine
...
Content-ID: <part1.94CE2D3C.E5E2418E@comcast.net>
