...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id B2CCF3CE079
	for <lists+usrp-users@lfdr.de>; Mon, 19 Jul 2021 18:02:11 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 6B2D53846DA
	for <lists+usrp-users@lfdr.de>; Mon, 19 Jul 2021 12:02:10 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=cttc.es header.i=@cttc.es header.b="Y1yaemx5";
	dkim-atps=neutral
Received: from mx02.puc.rediris.es (outbound3sev.lav.puc.rediris.es [130.206.19.174])
	by mm2.emwd.com (Postfix) with ESMTPS id 93C543845E8
	for <usrp-users@lists.ettus.com>; Mon, 19 Jul 2021 11:59:22 -0400 (EDT)
Received: from leo.cttc.es (leo.cttc.es [84.88.62.208])
	by mx02.puc.rediris.es  with ESMTP id 16JFxJUI005472-16JFxJUK005472
	(version=TLSv1.3 cipher=TLS_AES_256_GCM_SHA384 bits=256 verify=OK)
	for <usrp-users@lists.ettus.com>; Mon, 19 Jul 2021 17:59:19 +0200
Received: from localhost (localhost [127.0.0.1])
To: usrp-users <usrp-users@lists.ettus.com>,
 usrp-users <usrp-users@lists.ettus.com>
From: Armin Ghani <aghani@cttc.es>
Message-ID: <dd5441db-ec2a-06fc-1bef-8453be3797a3@cttc.es>
Date: Mon, 19 Jul 2021 17:59:19 +0200
MIME-Version: 1.0
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; d=cttc.es; s=DKIM; c=relaxed/relaxed;
 ...
 bh=v7l021d5IelHibzJ7fbsnNxosnE3hspsh4q4sXNS580=;
 b=
Message-ID-Hash: HSGDJ6UJOWTHPLMQSNSNO6AZALOLDEWV
X-Message-ID-Hash: HSGDJ6UJOWTHPLMQSNSNO6AZALOLDEWV
X-MailFrom: prvs=1830493470=aghani@cttc.es
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/HSGDJ6UJOWTHPLMQSNSNO6AZALOLDEWV/>
...
Content-Type: multipart/mixed; boundary="===============7064564571893971045=="

This is a multi-part message in MIME format.
--===============7064564571893971045==
Content-Type: multipart/alternative;
 boundary="------------84C06F161FE728349469F380"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------84C06F161FE728349469F380
...
Content-Type: multipart/related;
 boundary="------------86EA2C5C9ED4A650B674B231"


--------------86EA2C5C9ED4A650B674B231
...
-8">
  ...
  <body>
    ...
    <p>In the UHD host code examples there are two example source files
      where one transmits TX samples in specific time in future, the
      other does this in RX side.</p>
    <p>I am pretty aware how timing commands works but since I've been
      developing my system in GRC environment, I prefer to do it in GRC.<=
/p>
    <p>When I put USRP sink and source blocks in the flowgraph, and try
      to transmit 1ms tone signal every 1 second, the delay which TX
      samples will be in RX samples are fixed during one run but
...
l"><img
          src=3D"cid:part1.03D1E930.4320DF11@cttc.es" width=3D"151"
...
Content-ID: <part1.03D1E930.4320DF11@cttc.es>
