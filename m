...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 837A3757F84
	for <lists+usrp-users@lfdr.de>; Tue, 18 Jul 2023 16:30:57 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 36302384B23
	for <lists+usrp-users@lfdr.de>; Tue, 18 Jul 2023 10:30:56 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1689690656; bh=jNV+ohGsdYz/tMvztFn3OREfOzRsTT3PmR2Vx0RLq1s=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qv1-f46.google.com (mail-qv1-f46.google.com [209.85.219.46])
	by mm2.emwd.com (Postfix) with ESMTPS id 2AA31384B03
	for <usrp-users@lists.ettus.com>; Tue, 18 Jul 2023 10:30:14 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="Pe2QUtYU";
	dkim-atps=neutral
Received: by mail-qv1-f46.google.com with SMTP id 6a1803df08f44-635e5b06aaeso30854856d6.0
        for <usrp-users@lists.ettus.com>; Tue, 18 Jul 2023 07:30:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1689690613; x=1692282613;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=uV1yH21Ws5CTKtBxVcgr/PIqP98hnTYvaxJEpwvVOag=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689690613; x=1692282613;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=uV1yH21Ws5CTKtBxVcgr/PIqP98hnTYvaxJEpwvVOag=;
        b=
X-Gm-Message-State: ABy/qLa/ylMOfhLB4Rf2ahEs9DeUXOWfhfQYEVTHvrmqLUzEFkyQDZOq
	tN+rVfbeDyeLhykmSayG2xo=
X-Google-Smtp-Source: APBJJlEQezoFuQcSUgEXK5rRtxcTWfTFOCqrC3NexbzeWWqEFAl3mEWcdESGvAxTS17DsykrrWcIVQ==
X-Received: by 2002:ad4:59c2:0:b0:621:48be:baa8 with SMTP id el2-20020ad459c2000000b0062148bebaa8mr1844527qvb.48.1689690613021;
        Tue, 18 Jul 2023 07:30:13 -0700 (PDT)
Received: from [192.168.2.175] ([174.93.2.82])
        by smtp.googlemail.com with ESMTPSA id k23-20020a0cb257000000b00630228acc45sm731415qve.145.2023.07.18.07.30.11
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Tue, 18 Jul 2023 07:30:11 -0700 (PDT)
Message-ID: <ab7e6b6f-30a3-6c87-6091-7a4f54c14ea6@gmail.com>
Date: Tue, 18 Jul 2023 10:30:02 -0400
MIME-Version: 1.0
...
References: <CAOkUcSviKSko5fQu-TvQrANqYqVM5-N7_TTtTuBoGu+27tmKPA@mail.gmail.com>
 ...
 <CAOkUcSv+_-mpaD+_QKR0vE934K+616XTZNjt0DbpYGVAkP_Gxw@mail.gmail.com>
From: "Marcus D. Leech" <patchvonbraun@gmail.com>
In-Reply-To: <CAOkUcSv+_-mpaD+_QKR0vE934K+616XTZNjt0DbpYGVAkP_Gxw@mail.gmail.com>
Message-ID-Hash: NTUDNT55ZJE2KTM5Z7GJSZBIHBYVEC7U
X-Message-ID-Hash: NTUDNT55ZJE2KTM5Z7GJSZBIHBYVEC7U
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/NTUDNT55ZJE2KTM5Z7GJSZBIHBYVEC7U/>
...
Content-Type: multipart/mixed; boundary="===============7775558709938857477=="

This is a multi-part message in MIME format.
--===============7775558709938857477==
Content-Type: multipart/alternative;
 boundary="------------5ddNP7oBXTQu0Qfr3ylIyKdz"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------5ddNP7oBXTQu0Qfr3ylIyKdz
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 14/07/2023 12:06, cyberphox wrote:
> Hi=C2=A0Marcus,
>
> So some updates that may help others who may face this problem in the=20
> future.
>
> What I believe=C2=A0happened was the FPGA was corrupted, ie. the=20
> programming got interrupted.
>
> To restore the FPGA, I followed the notes from the Ettus web site: -
>
> X300/X310 Device Recovery - Ettus Knowledge Base=20
> <https://kb.ettus.com/X300/X310_Device_Recovery#:~:text=3DPower%20off%2=
0the%20USRP%20X300,UHD%20utility%2Fapplication%20as%20normal>
> Building and Installing the USRP Open-Source Toolchain (UHD and GNU=20
> Radio) on Linux - Ettus Knowledge Base=20
> <https://kb.ettus.com/Building_and_Installing_the_USRP_Open-Source_Tool=
chain_(UHD_and_GNU_Radio)_on_Linux>
>
> Kind regards,
> Marino
Thanks for this.=C2=A0 I had started to suspect it was something like tha=
t,=20
and glad you were able to get things sorted.


>
> On Thu, 13 Jul 2023 at 21:35, Marcus D. Leech=20
> <patchvonbraun@gmail.com> wrote:
>
>     On 13/07/2023 16:33, cyberphox wrote:
>>     Thanks for confirming.=C2=A0 The issue seems to be on a particular
>>     unit. I am trying to figure out why it is not accessible
>     You should be able to see link lights--which may on the 2974
>     require that you pop the cover off--unfortunately, I don't
>     =C2=A0 have one of these to test.
>
>
>>
>>     On Thu, 13 Jul 2023 at 21:31, Marcus D. Leech
>>     <patchvonbraun@gmail.com> wrote:
>>
...
>>>
>>>         Marino
>>         I was confused by the block-diagram for the 2974, which swaps
>>         the usual nomenclature for the SFP0/SFP1 ports on the
>>         =C2=A0 X310.=C2=A0 It all makes sense now.=C2=A0 Yes, the port=
 you're trying
>>         to reach should be 192.168.40.2 using the default HG image
...
>>>>             Hi Marcus,
>>>>
>>>>             We are doing this from the embedded host PC, not from
>>>>             the 10G connection externally
>>>>
>>>>             Thank you
>>>>
>>>             I believe that only HG-type images are supported on the
>>>             built-in X310, in which case the standard IP address for
>>>             =C2=A0=C2=A0 SFP0 on the X310 component would be 192.168.=
10.2, NOT
...
>>>             datasheets of the i7 SOM that's on-board, and what I
>>>             know about the
>>>             =C2=A0 X310.
>>>
>>>
...
>>>>>                 Hi all,
>>>>>
>>>>>                 I have a USRP where I have a problem accessing the
>>>>>                 FPGA to program it. Normally we use image loader
>>>>>                 like so:
>>>>>                 uhd_image_loader
>>>>>                 --args=3D"type=3Dx300,addr=3D192.168.40.2"
>>>>>                 --fpga-path=3D"AnFpgaImage.bit"
>>>>>
>>>>>                 If I bring up enp1s0f0 like so:
>>>>>
>>>>>                 sudo ifconfig enp1s0f0 192.168.40.1 netmask
>>>>>                 255.255.255.0
>>>>>
>>>>>
...
>>>>>                 usrp probe tool. =C2=A0Normally all i need is to ge=
t
>>>>>                 enp1s0f0 showing up with IFCONFIG
>>>>>
>>>>>
>>>>>                 image.png
>>>>>
...
m
>>>>>                 To unsubscribe send an email tousrp-users-leave@lis=
ts.ettus.com
>>>>                 To clarify, are you doing this from your own host,
>>>>                 over the 10G interface, or from the embedded X86
>>>>                 host that's part of the
>>>>                 =C2=A0 2974?
>>>>
>>>>
>>>>                 _______________________________________________
...
Content-Type: multipart/related;
 boundary="------------tUjnhNC6BQ11tgJu7qsIh09j"

--------------tUjnhNC6BQ11tgJu7qsIh09j
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 14/07/2023 12:06, cyberphox wrote:<=
br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAOkUcSv+_-mpaD+_QKR0vE934K+616XTZNjt0DbpYGVAkP_Gxw@mail.gmai=
l.com">
...
TF-8">
      <div dir=3D"ltr">Hi=C2=A0Marcus,
        ...
        <div>So some updates that may help others who may face this
          problem in the future.=C2=A0=C2=A0</div>
        <div><br>
        </div>
        <div>What I believe=C2=A0happened was the FPGA was corrupted, ie.=
 the
          programming got interrupted.=C2=A0</div>
        <div><br>
        </div>
        <div>To restore the FPGA, I followed the notes from the Ettus
          web site: -</div>
        <div><br>
        </div>
        <div><a
href=3D"https://kb.ettus.com/X300/X310_Device_Recovery#:~:text=3DPower%20=
off%20the%20USRP%20X300,UHD%20utility%2Fapplication%20as%20normal"
            moz-do-not-send=3D"true">X300/X310 Device Recovery - Ettus
            Knowledge Base</a><br>
        </div>
        <div><a
href=3D"https://kb.ettus.com/Building_and_Installing_the_USRP_Open-Source=
_Toolchain_(UHD_and_GNU_Radio)_on_Linux"
            moz-do-not-send=3D"true">Building and Installing the USRP
            Open-Source Toolchain (UHD and GNU Radio) on Linux - Ettus
            Knowledge Base</a><br>
        </div>
        <div><br>
        </div>
    ...
    Thanks for this.=C2=A0 I had started to suspect it was something like
    that, and glad you were able to get things sorted.<br>
    <br>
    <br>
    <blockquote type=3D"cite"
cite=3D"mid:CAOkUcSv+_-mpaD+_QKR0vE934K+616XTZNjt0DbpYGVAkP_Gxw@mail.gmai=
l.com"><br>
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Thu, 13 Jul 2023 at 21:3=
5,
...
hvonbraun@gmail.com</a>&gt;
        ...
        <blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px
          ...
          <div>
            ...
            <blockquote type=3D"cite">
              <div dir=3D"auto">Thanks for confirming.=C2=A0 The issue se=
ems to
                be on a particular unit. I am trying to figure out why
                it is not accessible <br>
              </div>
            </blockquote>
            You should be able to see link lights--which may on the 2974
            require that you pop the cover off--unfortunately, I don't<br=
>
            ...
            <blockquote type=3D"cite">
              <div><br>
                <div class=3D"gmail_quote">
                  <div dir=3D"ltr" class=3D"gmail_attr">On Thu, 13 Jul 20=
23
                    at 21:31, Marcus D. Leech &lt;<a
...
px
                    ...
                    <div>
                      ...
                      <blockquote type=3D"cite">
                        <div dir=3D"auto">I will need to check tomorrow,
                          as I am now not a my work.</div>
                        <div dir=3D"auto"><br>
                        </div>
                        <div dir=3D"auto">Thanks for your help. I will
                          keep you posted</div>
                        <div dir=3D"auto"><br>
                        </div>
                        <div dir=3D"auto">Marino</div>
                      </blockquote>
                      I was confused by the block-diagram for the 2974,
                      which swaps the usual nomenclature for the
                      SFP0/SFP1 ports on the<br>
                      =C2=A0 X310.=C2=A0 It all makes sense now.=C2=A0 Ye=
s, the port
                      you're trying to reach should be 192.168.40.2
                      using the default HG image<br>
 ...
 13
                              Jul 2023 at 20:52, Marcus D. Leech &lt;<a
                                href=3D"mailto:patchvonbraun@gmail.com"
                                target=3D"_blank" moz-do-not-send=3D"true=
"
...
raun@gmail.com</a>&gt;
                            ...
                            <blockquote class=3D"gmail_quote"
                              ...
                              rgb(204,204,204);padding-left:1ex">
                              <div>
                                <div>On 13/07/2023 15:39, cyberphox
                                  wrote:<br>
                                </div>
                                <blockquote type=3D"cite">
                                  ...
                                  <div dir=3D"auto">We are doing this fro=
m
                                    the embedded host PC, not from the
                                    10G connection externally=C2=A0</div>
                                  <div dir=3D"auto"><br>
                                  </div>
                                ...
                                I believe that only HG-type images are
                                supported on the built-in X310, in which
                                case the standard IP address for<br>
                                =C2=A0=C2=A0 SFP0 on the X310 component w=
ould be
                                192.168.10.2, NOT 192.268.40.2.=C2=A0=C2=A0=
 But if
                                you're running your own<br>
                                =C2=A0=C2=A0 images, I can't say how it w=
ould be
                                setup.<br>
                                <br>
                                I don't actually have an 2974, so I'm
                                going by datasheets of the i7 SOM that's
                                on-board, and what I know about the<br>
                                =C2=A0 X310.</div>
                              <div><br>
                                <br>
                                <br>
...
r">On
                                        Thu, 13 Jul 2023 at 19:17,
                                        Marcus D. Leech &lt;<a
                                          href=3D"mailto:patchvonbraun@gm=
ail.com"
                                          target=3D"_blank"
                                        ...
                                        <div>
                                          <blockquote type=3D"cite">
                                            <div dir=3D"ltr">Hi all,
                                              ...
                                              <div>I have a USRP where I
                                                have a problem accessing
                                                the FPGA to program it.=C2=
=A0
                                                Normally we use image
                                                loader like so:</div>
                                              <div><span dir=3D"ltr"><fon=
t
                                                    face=3D"monospace">uh=
d_image_loader
...
"</font></span><br>
                                              ...
                                              <div>If I bring up
                                                enp1s0f0 like so:</div>
                                              <div>
                                                <p class=3D"MsoNormal"
                                                  style=3D"margin:0cm"><f=
ont
                                                    face=3D"monospace">su=
do
                                                    ifconfig enp1s0f0
...
/p>
                                                <p class=3D"MsoNormal"
                                                  style=3D"margin:0cm;fon=
t-size:11pt;font-family:Calibri,sans-serif"><br>
                                                </p>
                                                <p class=3D"MsoNormal"
                                                  style=3D"margin:0cm;fon=
t-size:11pt;font-family:Calibri,sans-serif">Once
                                                  enp1s0f0 is up, I
                                                  still am not able to
                                                  ping 192.168.40.2,
                                                  which probably
                                                  explains why the image
                                                  loader has a problem,
                                                  in fact so does the
                                                  usrp probe tool.=C2=A0
                                                  =C2=A0Normally all i ne=
ed
                                                  is to get enp1s0f0
                                                  showing up with
                                                  IFCONFIG</p>
                                              ...
                                              <div><img
                                                  src=3D"cid:part1.MSx6ZB=
aI.MXeFWQA2@gmail.com"
                                                  alt=3D"image.png"
                                                  style=3D"width: 812px;
                                                  max-width: 100%;"
                                                  class=3D""><br>
                                              </div>
                                              <div><br>
...
nk-freetext">usrp-users-leave@lists.ettus.com</a>
                                          ...
                                          To clarify, are you doing this
                                          from your own host, over the
                                          10G interface, or from the
                                          embedded X86 host that's part
                                          of the<br>
                                          =C2=A0 2974?<br>
                                          <br>
                                          <br>
...
_______________________________________________<br>
                                        USRP-users mailing list -- <a
                                          href=3D"mailto:usrp-users@lists=
.ettus.com"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true"
                                          class=3D"moz-txt-link-freetext"=
>usrp-users@lists.ettus.com</a><br>
                                        To unsubscribe send an email to
                                        <a
                                          href=3D"mailto:usrp-users-leave=
@lists.ettus.com"
                                          target=3D"_blank"
                                          moz-do-not-send=3D"true"
                                          class=3D"moz-txt-link-freetext"=
...
Content-Id: <part1.MSx6ZBaI.MXeFWQA2@gmail.com>
