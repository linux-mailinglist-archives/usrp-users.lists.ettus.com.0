...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 875A210770E
	for <lists+usrp-users@lfdr.de>; Fri, 22 Nov 2019 19:13:08 +0100 (CET)
Received: from [::1] (port=43084 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iYDQT-0005MM-Nk; Fri, 22 Nov 2019 13:13:01 -0500
Received: from mail-wm1-f48.google.com ([209.85.128.48]:37094)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <ejkreinar@gmail.com>) id 1iYDQQ-0005DP-II
 for usrp-users@lists.ettus.com; Fri, 22 Nov 2019 13:12:58 -0500
Received: by mail-wm1-f48.google.com with SMTP id f129so7313691wmf.2
 for <usrp-users@lists.ettus.com>; Fri, 22 Nov 2019 10:12:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=doop7ajrN8H8RLhZUDgfencm/Lu47fvvB0teHB8N0kE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=doop7ajrN8H8RLhZUDgfencm/Lu47fvvB0teHB8N0kE=;
 b=
X-Gm-Message-State: APjAAAV6QSBz7W7gJqfr4Fs/BZE7W5j5uc7WrkWNTE5ErzKZmk/k7edS
 F8TDw40gVzaYv4ns4uOypzHcj8vdi1nw0rt7kfDZbA==
X-Google-Smtp-Source: APXvYqw8SkHKsfKOonZSk1UnHE40yqamjrE1QdmViTNHYEy5826yQzQRvXT7Q+0bjrRPsHOlkIdfoNTYRPxg4so+A3E=
X-Received: by 2002:a1c:6686:: with SMTP id a128mr4461552wmc.169.1574446337152; 
 Fri, 22 Nov 2019 10:12:17 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CALY+5s+tWaCqkbO5bL_+iwELhXp9j-hmL11mAvsYWXVp05SqSw@mail.gmail.com>
Date: Fri, 22 Nov 2019 13:12:03 -0500
Message-ID: <CADRnH227dj+xbh0UMEZXU0zsDmbSoFcX+h3GyoDxD-0Lc5dMWw@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============3245849722885237225=="
...
--===============3245849722885237225==
Content-Type: multipart/alternative; boundary="000000000000a4db870597f35a2a"

--000000000000a4db870597f35a2a
...
> /home/root/newinstall/usr/share/uhd/rfnoc/blocks/gain.xml for NOC ID
> 0xB7DD64941A952AAC
> [TRACE] [RFNOC] [RFNoC Factory] Using controller key 'gain' and block nam=
e
> 'gain'
> [DEBUG] [RFNOC] Reading XML file
> /home/root/newinstall/usr/share/uhd/rfnoc/blocks/gain.xml for NOC ID
...
> [TRACE] [0/gain_0] Adding port definition at xbar/gain_0/ports/out/0: typ=
e
> =3D 'sc16' pkt_size =3D '0' vlen =3D '0'
...
>     </args>
>   </args>
>   <!--One input, one output. If this is used, better have all the info th=
e
> C++ file.-->
>   <ports>
>     <sink>
...
>
>
> On Fri, Nov 22, 2019 at 10:51 AM Jonathan Lockhart <jlockhartrt@gmail.com=
>
> wrote:
>
...
>>> file it loaded. I'd try to find that xml and confirm it looks like what=
 you
...
>>> provide the same "gain" block... I've definitely fought with conflictin=
g
...
>>>> which easy enough it was just a simple export. I then ran uhd_usrp_pro=
be
>>>> with the --tree and setting the fpga to my bit file. Here is the outpu=
t
>>>> from the probe.
>>>>
...
at
>>>> the tree, there is no value instantiated by the probe. It only looks l=
ike
...
>>>>> UHD_LOG_CONSOLE_LEVEL=3Dtrace or debug and try to make sure the corre=
ct xml
>>>>> file is getting applied to the block correctly.
>>>>>
>>>>> There's also something like a "--tree" parameter in the uhd_usrp_prob=
e
>>>>> so try running the probe with the tree option to print out the device=
 tree
...
>>>>> EJ
>>>>>
>>>>> On Thu, Nov 21, 2019, 4:01 PM Jonathan Lockhart <jlockhartrt@gmail.co=
m>
>>>>> wrote:
>>>>>
...
>>>>>>
>>>>>> cmake
>>>>>> -DCMAKE_TOOLCHAIN_FILE=3D~/rfnoc/src/gnuradio/cmake/Toolchains/oe-sd=
k_cross.cmake
...
>>>>>>> where it was installed when I did the cross compile. It was not pla=
ced in
>>>>>>> the "GRC_BLOCKS_PATH" of "/share/gnuradio/grc/blocks" like the defa=
ult
...
>>>>>>> export PKG_CONFIG_PATH=3D$LOCALPREFIX/lib/pkgconfig:$PKG_CONFIG_PAT=
H
>>>>>>> export
>>>>>>> GRC_BLOCKS_PATH=3D$LOCALPREFIX/share/gnuradio/grc/blocks:$GRC_BLOCK=
S_PATH
>>>>>>> export UHD_RFNOC_DIR=3D$LOCALPREFIX/share/uhd/rfnoc/
>>>>>>> export UHD_IMAGES_DIR=3D$LOCALPREFIX/share/uhd/images
>>>>>>> export
>>>>>>> GRC_BLOCKS_PATH=3D$LOCALPREFIX/share/uhd/rfnoc/blocks:$GRC_BLOCKS_P=
ATH
>>>>>>>
>>>>>>> Unfortunately, after re-sourcing the setup.env, I still get the sam=
e
>>>>>>> message.
>>>>>>>
...
>>>>>>> rx_gain=3Doptions.rx_gain, rx_digital_gain=3Doptions.rx_digital_gai=
n,
...
>>>>>>>   File
>>>>>>> "/home/root/newinstall/usr/lib/python2.7/site-packages/tutorial/tut=
orial_swig.py",
>>>>>>> line 315, in set_arg
...
>>>>>>>> attach to the device tree like you are trying to set there (it's n=
ot
>>>>>>>> compiled directly, but rather created dynamically from the xml def=
inition)
>>>>>>>>
>>>>>>>> Recommended debugging...
>>>>>>>> 1. Check your OOT gain block xml (in rfnoc/blocks) and make sure i=
t
>>>>>>>> has a "gain" field in the "args" list. You'll also want to make su=
re it
>>>>>>>> writes your desired register, but I don't think you're even gettin=
g that far
>>>>>>>> 2. Make sure the block xml is installed on the e310 embedded prefi=
x
>>>>>>>> and is found at run time during uhd_usrp_probe and when running yo=
ur
>>>>>>>> application. If it's not in the right place or not attaching to yo=
ur block
...
>>>>>>>>> was placed on a ZMQ push, and the graphics were on the host to gr=
aph the
...
for gain
>>>>>>>>> (gain.v) and it is correct per the instructions in the linked gui=
de, and I
>>>>>>>>> built the python and gnuradio hook exactly as the instructions st=
ated to.
>>>>>>>>>
...
>>>>>>>>>> the Ettus E312. The reference documentation is using an X3xx ser=
ies radio,
>>>>>>>>>> and from the final python script it appears to be running the GN=
R script
>>>>>>>>>> natively on the host. I built the exact script from the KB but w=
hen running
>>>>>>>>>> on the radio it fails stating it can't "import tutorial." I real=
ized all
>>>>>>>>>> the files that were installed were placed on the host but not cr=
oss
...
>>>>>>>>>>
>>>>>>>>>> /home/jon/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi/u=
sr/include/gnu/stubs.h:7:11:
>>>>>>>>>> fatal error: gnu/stubs-soft.h: No such file or directory
>>>>>>>>>>  # include <gnu/stubs-soft.h>
>>>>>>>>>>            ^~~~~~~~~~~~~~~~~~
>>>>>>>>>> compilation terminated.
>>>>>>>>>>
>>>>>>>>>> Now I did find the stubs-soft.h file in the libc6-dev-armel-cros=
s
>>>>>>>>>> in the apt repo. I installed it and tried to cp the file into th=
e
>>>>>>>>>> /home/jon/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi/u=
sr/include/gnu/
>>>>>>>>>> location but it still doesn't like that. I verified that on my e=
cho $CC
...
>>>>>>>>>> -mfpu=3Dneon
>>>>>>>>>> --sysroot=3D/home/jon/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-lin=
ux-gnueabi
>>>>>>>>>>
>>>>>>>>>> So I am not sure why the gain module in the tutorial is looking
>>>>>>>>>> for the soft file.
>>>>>>>>>>
>>>>>>>>>> If anyone has experience in porting their OOT modules over to th=
e
...
<div dir=3D"auto">Oh!<div dir=3D"auto"><br></div><div dir=3D"auto">I suspec=
t you want...</div><div dir=3D"auto"><br></div><div dir=3D"auto">&lt;args&g=
t;</div><div dir=3D"auto">=C2=A0 &lt;arg&gt;</div><div dir=3D"auto">=C2=A0 =
=C2=A0 ...</div><div dir=3D"auto">=C2=A0 &lt;/arg&gt;</div><div dir=3D"auto=
">&lt;/args&gt;</div><div dir=3D"auto"><br></div><div dir=3D"auto">(Rather =
than two nested &quot;args&quot;)</div><div dir=3D"auto"><br></div><div dir=
=3D"auto">That ought to do it...</div><div dir=3D"auto">EJ</div></div><br><=
div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Fri, Nov=
 22, 2019, 11:55 AM Jonathan Lockhart &lt;<a href=3D"mailto:jlockhartrt@gma=
il.com">jlockhartrt@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"=
gmail_quote" style=3D"margin:0 0 0 .8ex;border-left:1px #ccc solid;padding-=
left:1ex"><div dir=3D"ltr"><div>So here is the trace for the gain block, an=
d it certainly is loading the right XML file it seems. =F0=9F=A4=94</div><d=
iv><br></div><div>[DEBUG] [RFNOC] Reading XML file /home/root/newinstall/us=
r/share/uhd/rfnoc/blocks/gain.xml for NOC ID 0xB7DD64941A952AAC<br>[TRACE] =
[RFNOC] [RFNoC Factory] block_ctrl_base::make()<br>[DEBUG] [RFNOC] Reading =
XML file /home/root/newinstall/usr/share/uhd/rfnoc/blocks/gain.xml for NOC =
ID 0xB7DD64941A952AAC<br>[TRACE] [RFNOC] [RFNoC Factory] Using controller k=
ey &#39;gain&#39; and block name &#39;gain&#39;<br>[DEBUG] [RFNOC] Reading =
XML file /home/root/newinstall/usr/share/uhd/rfnoc/blocks/gain.xml for NOC =
ID 0xB7DD64941A952AAC<br>[INFO] [0/gain_0] Initializing block control (NOC =
ID: 0xB7DD64941A952AAC)<br>[DEBUG] [0/gain_0] Checking compat number for FP=
GA component `noc_shell&#39;: Expecting 5.1, actual: 5.1.<br>[TRACE] [0/gai=
n_0] Adding port definition at xbar/gain_0/ports/in/0: type =3D &#39;sc16&#=
39; pkt_size =3D &#39;0&#39; vlen =3D &#39;0&#39;<br>[TRACE] [0/gain_0] Add=
ing port definition at xbar/gain_0/ports/out/0: type =3D &#39;sc16&#39; pkt=
_size =3D &#39;0&#39; vlen =3D &#39;0&#39;<br>[DEBUG] [E300] [E300] Setting=
 up dest map for host ep 112 to be stream 3<br></div><div><br></div><div>Ho=
wever I don&#39;t show it instantiating any of the args. I did vim the file=
 and it appears correct (output below). <br></div><div><br></div><div>&lt;?=
xml version=3D&quot;1.0&quot;?&gt;<br>&lt;!--Default XML file--&gt;<br>&lt;=
nocblock&gt;<br>=C2=A0 &lt;name&gt;gain&lt;/name&gt;<br>=C2=A0 &lt;blocknam=
e&gt;gain&lt;/blockname&gt;<br>=C2=A0 &lt;ids&gt;<br>=C2=A0 =C2=A0 &lt;id r=
evision=3D&quot;0&quot;&gt;B7DD64941A952AAC&lt;/id&gt;<br>=C2=A0 &lt;/ids&g=
t;<br>=C2=A0 &lt;!-- Registers --&gt;<br>=C2=A0 &lt;registers&gt;<br>=C2=A0=
 =C2=A0 &lt;setreg&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;name&gt;GAIN&lt;/name&gt=
...
=A0 =C2=A0 &lt;type&gt;sc16&lt;/type&gt;<br>=C2=A0 =C2=A0 &lt;/sink&gt;<br>=
=C2=A0 =C2=A0 &lt;source&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;name&gt;out0&lt;/n=
ame&gt;<br>=C2=A0 =C2=A0 =C2=A0 &lt;type&gt;sc16&lt;/type&gt;<br>=C2=A0 =C2=
=A0 &lt;/source&gt;<br>=C2=A0 &lt;/ports&gt;<br>&lt;/nocblock&gt;</div><div=
><br></div><div><br></div><div>Regards,</div><div>Jon<br></div><div><br></d=
iv><div><br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" cla=
ss=3D"gmail_attr">On Fri, Nov 22, 2019 at 10:51 AM Jonathan Lockhart &lt;<a=
 href=3D"mailto:jlockhartrt@gmail.com" target=3D"_blank" rel=3D"noreferrer"=
>jlockhartrt@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_q=
uote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,2=
04);padding-left:1ex"><div dir=3D"ltr">NVM, I got it set. I am teasing thro=
ugh the long console output now. Might of wanted to set the file log instea=
d. Live and learn. <br></div><br><div class=3D"gmail_quote"><div dir=3D"ltr=
" class=3D"gmail_attr">On Fri, Nov 22, 2019 at 10:20 AM EJ Kreinar &lt;<a h=
ref=3D"mailto:ejkreinar@gmail.com" target=3D"_blank" rel=3D"noreferrer">ejk=
reinar@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" =
style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);pa=
dding-left:1ex"><div dir=3D"auto">Good progress, agreed it looks like the g=
ain arg isn&#39;t getting created here...=C2=A0<div dir=3D"auto"><br></div>=
<div dir=3D"auto">If you run with log level trace, rfnoc should (might?) in=
dicate the xml file it loaded. I&#39;d try to find that xml and confirm it =
looks like what you expect, with the gain arg entry.</div><div dir=3D"auto"=
><br></div><div dir=3D"auto">Also, perhaps grep your prefix and share direc=
tories on the embedded device to search for any other xml files that might =
match the noc id or provide the same &quot;gain&quot; block... I&#39;ve def=
initely fought with conflicting xml definitions before, you might be seeing=
 that here.</div><div dir=3D"auto"><br></div><div dir=3D"auto">EJ</div></di=
v><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On F=
ri, Nov 22, 2019, 9:36 AM Jonathan Lockhart &lt;<a href=3D"mailto:jlockhart=
rt@gmail.com" rel=3D"noreferrer noreferrer noreferrer" target=3D"_blank">jl=
ockhartrt@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quot=
e" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204)=
;padding-left:1ex"><div dir=3D"ltr"><div>Hey EJ,</div><div><br></div><div>S=
orry for being slow I had to dig=20
