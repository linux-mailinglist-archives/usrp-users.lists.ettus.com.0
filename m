...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id E06DC2C4820
	for <lists+usrp-users@lfdr.de>; Wed, 25 Nov 2020 20:22:07 +0100 (CET)
Received: from [::1] (port=45138 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1ki0Mf-0002Ab-F7; Wed, 25 Nov 2020 14:22:05 -0500
Received: from mail-lf1-f44.google.com ([209.85.167.44]:38174)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <wandrewp@gmail.com>) id 1ki0Mc-00022k-9F
 for usrp-users@lists.ettus.com; Wed, 25 Nov 2020 14:22:02 -0500
Received: by mail-lf1-f44.google.com with SMTP id s27so4690519lfp.5
 for <usrp-users@lists.ettus.com>; Wed, 25 Nov 2020 11:21:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=LeW11iegTbESFiXFzYFzFFCNSoJ5wf+t/e60tWXmV5s=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=LeW11iegTbESFiXFzYFzFFCNSoJ5wf+t/e60tWXmV5s=;
 b=
X-Gm-Message-State: AOAM5327G6urzBQkVGyITRkozrHeYN5JExDUFMto8SZ1GQqcCG8yax4Y
 mi/ZkSCjJjZhPHnkc7REqQIFohZQdMEvmTsvq4U=
X-Google-Smtp-Source: ABdhPJzXZAIzc9ErrpS3pA8Qh3+P+hKgQoc5v9ob4UmEwSFb3PVsIK+2JOK0TWkAE34ItP+qwnZQsOpLxPD4GhsqZo4=
X-Received: by 2002:ac2:568b:: with SMTP id 11mr133710lfr.397.1606332080862;
 Wed, 25 Nov 2020 11:21:20 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <82C8BA12-2EC5-45E9-9446-1890860A8F30@gmail.com>
Date: Wed, 25 Nov 2020 14:21:11 -0500
Message-ID: <CAB50+dT2ah526Vw7gp7q0UYNw5iWA8zt0Gyx0hOhhSF5F1Lxag@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============2440512849417001272=="
...
--===============2440512849417001272==
Content-Type: multipart/alternative; boundary="00000000000012391a05b4f3559b"

--00000000000012391a05b4f3559b
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

Of the 8 e310s that I have tested with the same image, only one of them has
the actual MAC address of 00:80:2f:19:4c:37, which I was able to find out
via:
...
>> >
>> > When is that .patch file ran, is it during compilation of the BSP?  Wh=
en
...
,
>> >> u-boot is supposed to read that and use it. Factory test should set i=
t
...
>> >>>
>> >>> On some searching around the web I can see that it is likely that th=
e
>> MAC
...
<div dir=3D"ltr">Of the 8 e310s that I have tested with the same image, onl=
y one of them has the actual MAC address of 00:80:2f:19:4c:37, which I was =
able to find out via:<div>hexdump /sys/bus/nvmem/devices/0-00510/nvmem</div=
><div><br></div><div>Weird.=C2=A0 Glad I found the one device that had that=
 MAC though. So that must have been patient 0. Then I copied that image to =
the others. But the question is why did they adopt the same MAC address ins=
tead of reading from the PROM at every boot up?=C2=A0 I&#39;ll have to dig =
deeper into U-Boot to see.</div></div><br><div class=3D"gmail_quote"><div d=
ir=3D"ltr" class=3D"gmail_attr">On Wed, Nov 25, 2020 at 2:09 PM Marcus D Le=
ech &lt;<a href=3D"mailto:patchvonbraun@gmail.com">patchvonbraun@gmail.com<=
/a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0=
px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><=
div dir=3D"auto">Near as I can tell the e310 gets its MAC from the motherbo=
ard i2c eeprom.=C2=A0<br><br><div dir=3D"ltr">Sent from my iPhone</div><div=
 dir=3D"ltr"><br><blockquote type=3D"cite">On Nov 25, 2020, at 12:55 PM, An=
drew Payne via USRP-users &lt;<a href=3D"mailto:usrp-users@lists.ettus.com"=
...
"ltr">So does the U-Boot environment determine the MAC address of eth0 prio=
r to booting the kernel?=C2=A0 Or is it during the make of the boot image?=
=C2=A0 I just find it a stretch to believe that I am running an image on a =
number of SDRs, and they&#39;re all using the same MAC address, possibly fr=
om the e310 for which the boot image was generated?<br><div><br></div><div>=
<br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gm=
ail_attr">On Wed, Nov 25, 2020 at 8:59 AM Philip Balister &lt;<a href=3D"ma=
ilto:philip@balister.org" target=3D"_blank">philip@balister.org</a>&gt; wro=
te:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px =
0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">Mine is diff=
erent, but both seem to be from the National Instruments<br>
