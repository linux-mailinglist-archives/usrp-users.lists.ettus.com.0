...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 62D0D17F7C
	for <lists+usrp-users@lfdr.de>; Wed,  8 May 2019 20:05:55 +0200 (CEST)
Received: from [::1] (port=60866 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.91)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1hOQwt-0000mN-Fj; Wed, 08 May 2019 14:05:47 -0400
Received: from atl4mhob12.registeredsite.com ([209.17.115.50]:53742)
 by mm2.emwd.com with esmtp (Exim 4.91)
 (envelope-from <k5so@k5so.com>) id 1hOQwL-0000YX-TH
 for usrp-users@lists.ettus.com; Wed, 08 May 2019 14:05:43 -0400
Received: from mailpod.hostingplatform.com
 (atl4qobmail01pod3.registeredsite.com [10.30.77.67])
 by atl4mhob12.registeredsite.com (8.14.4/8.14.4) with ESMTP id x48I4UdR026491
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL)
 for <usrp-users@lists.ettus.com>; Wed, 8 May 2019 14:04:31 -0400
Received: (qmail 40692 invoked by uid 0); 8 May 2019 18:04:30 -0000
...
Received: from unknown (HELO ?192.168.1.76?) (k5so@k5so.com@192.206.203.10)
 by 0 with ESMTPA; 8 May 2019 18:04:30 -0000
Message-Id: <EC7DA97C-5541-4037-AB6B-26AE1712B50D@k5so.com>
Mime-Version: 1.0 (Mac OS X Mail 11.5 \(3445.9.1\))
Date: Wed, 8 May 2019 12:04:28 -0600
In-Reply-To: <5CD3121D.6040508@gmail.com>
...
Content-Type: multipart/mixed; boundary="===============8365482476527538531=="
...
Content-Type: multipart/alternative;
	boundary="Apple-Mail=_69A340BB-1684-4684-8EC8-67B75DFD7785"


--Apple-Mail=_69A340BB-1684-4684-8EC8-67B75DFD7785
...
At least we know now what we need for this N210 and what to expect from =
it in terms of performance if we ever find the .bit file too. =20
...
good, Marcus. &nbsp;I would greatly appreciate it.<div class=3D""><br =
class=3D""></div><div class=3D"">If we can get our hands on the =
=E2=80=9Cusrp_n210_r2_fpga.bit=E2=80=9D from anywhere we could load it =
and install an ancient UHD version that has the associated .bin files =
for rev2 and run with that setup to have at least a minimal amount of =
utility from the N210, albeit not all the niceties and functionality of =
a modern UHD version. &nbsp;<div class=3D""><br class=3D""></div><div =
class=3D"">Thanks Jason, Marcus, and Robin for the information. =
&nbsp;Much appreciated. &nbsp;At least we know now what we need for this =
N210 and what to expect from it in terms of performance if we ever find =
the .bit file too. &nbsp;</div><div class=3D""><br class=3D""></div><div =
class=3D"">Best regards to all,&nbsp;</div><div class=3D""><br =
class=3D""></div><div class=3D"">Joe<br class=3D""><div><br =
class=3D""><blockquote type=3D"cite" class=3D""><div class=3D"">On May =
8, 2019, at 11:30 AM, Marcus D. Leech via USRP-users &lt;<a =
...
http-equiv=3D"Content-Type" class=3D"">
 =20
  <div bgcolor=3D"#FFFFFF" text=3D"#000000" class=3D"">
    <div class=3D"moz-cite-prefix">On 05/08/2019 01:24 PM, Robin Coxe
      wrote:<br class=3D"">
    </div>
    <blockquote =
cite=3D"mid:CAGVTi8UrRix7wt_BxCN8rNBvFGD8d4Uz8Td7hWHGpg+G_=3DquAw@mail.gma=
...
moz-do-not-send=3D"true" href=3D"http://files.ettus.com/" =
...
class=3D"">usrp-users@lists.ettus.com</a>&gt;
          ...
          <blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px
            ...
            <div bgcolor=3D"#FFFFFF" class=3D"">
              <div =
class=3D"gmail-m_-1639864966745732941moz-cite-prefix">On
...
class=3D"">jason@gardettoengineering.com</a>&gt;
                        ...
                        wrote:</div>
                      <br =
class=3D"gmail-m_-1639864966745732941Apple-interchange-newline">
                      <div class=3D"">
                        <div =
...
look
                          ...
                          luck:&nbsp;<a moz-do-not-send=3D"true" =
...
class=3D"gmail-m_-1639864966745732941Apple-converted-space">&nbsp;</span>m=
ight
...
Sorry, can't
                        ...
                        <div id=3D"gmail-m_-1639864966745732941Signature" =
...
style=3D"display:inline-block;width:1284.77px" class=3D"">
                            <div =
id=3D"gmail-m_-1639864966745732941divRplyFwdMsg" dir=3D"ltr" =
class=3D""><font style=3D"font-size:11pt" face=3D"Calibri, sans-serif" =
class=3D""><b class=3D"">From:</b><span =
class=3D"gmail-m_-1639864966745732941Apple-converted-space">&nbsp;</span>U=
SRP-users
...
class=3D"gmail-m_-1639864966745732941Apple-converted-space">&nbsp;</span>W=
ednesday,

                                May 8, 2019 11:55 AM<br class=3D"">
                                <b class=3D"">To:</b><span =
class=3D"gmail-m_-1639864966745732941Apple-converted-space">&nbsp;</span>J=
oe
                                Martin via USRP-users<br class=3D"">
                                <b class=3D"">Subject:</b><span =
class=3D"gmail-m_-1639864966745732941Apple-converted-space">&nbsp;</span>[=
USRP-users]
...
the Linux
                              ...
                              <div class=3D""><span =
id=3D"gmail-m_-1639864966745732941cid:70A3E5A1-EF1B-4D99-B156-F8CD7369666A=
" class=3D"">&lt;Screenshot
...
It seems no
                ...
                <br class=3D"">
                <fieldset =
class=3D"gmail-m_-1639864966745732941mimeAttachmentHeader"></fieldset>
                <br class=3D"">
                <pre =
class=3D"">_______________________________________________
USRP-users mailing list
<a moz-do-not-send=3D"true" =
class=3D"gmail-m_-1639864966745732941moz-txt-link-abbreviated" =
href=3D"mailto:USRP-users@lists.ettus.com" =
target=3D"_blank">USRP-users@lists.ettus.com</a>
<a moz-do-not-send=3D"true" =
class=3D"gmail-m_-1639864966745732941moz-txt-link-freetext" =
