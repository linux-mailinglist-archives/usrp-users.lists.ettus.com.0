...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 43544F4F03
	for <lists+usrp-users@lfdr.de>; Fri,  8 Nov 2019 16:13:09 +0100 (CET)
Received: from [::1] (port=46512 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iT5wh-0003C1-IC; Fri, 08 Nov 2019 10:13:07 -0500
Received: from mail-lf1-f43.google.com ([209.85.167.43]:37427)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <jlockhartrt@gmail.com>)
 id 1iT5wc-00034X-Pc
 for usrp-users@lists.ettus.com; Fri, 08 Nov 2019 10:13:03 -0500
Received: by mail-lf1-f43.google.com with SMTP id b20so4734174lfp.4
 for <usrp-users@lists.ettus.com>; Fri, 08 Nov 2019 07:12:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=HAMe3vV1fUXGVtJsp57W807i2lhP7tttLlfydp8BGtg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=HAMe3vV1fUXGVtJsp57W807i2lhP7tttLlfydp8BGtg=;
 b=
X-Gm-Message-State: APjAAAXs2OD+n00sglBDgDtLUMYJ9e3OnxmlS0AqGMHBHkVLqHUSKLGF
 6+88OBsvPFC762cZmuqvrh6XyQngkV4MHitrp7I=
X-Google-Smtp-Source: APXvYqwVYMibJ//LBsVkeKt+LuoLuFQi234/B7hF9agiK5wUNhXg4EklRIOfvonQ5e3h6+F5stmZPeuAcOwwekidFM0=
X-Received: by 2002:ac2:5deb:: with SMTP id z11mr7336410lfq.35.1573225940673; 
 Fri, 08 Nov 2019 07:12:20 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CA+JMMq9wAx+ML3=AsrSjyi+-E0gQrub0UnV8BC_wS7+ypANkFg@mail.gmail.com>
Date: Fri, 8 Nov 2019 10:09:44 -0500
Message-ID: <CALY+5sK3M_Jb0aAv9QWoC+kHfn=8UPpWo1i94_oWXxy0JjU13g@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============0558778816463369278=="
...
--===============0558778816463369278==
Content-Type: multipart/related; boundary="0000000000005894270596d7352b"

--0000000000005894270596d7352b
Content-Type: multipart/alternative; boundary="0000000000005894240596d7352a"

--0000000000005894240596d7352a
...
>>   File
>> "/home/root/localinstall/usr/lib/python2.7/site-packages/ettus/ettus_swi=
g.py",
>> line 1307, in make
>>     return _ettus_swig.device3_make(*args, **kwargs)
>> RuntimeError: EnvironmentError: IOError: [0/SplitStream_0] sr_read64()
>> failed: EnvironmentError: IOError: Block ctrl (CE_01_Port_21) no respons=
e
...
>>   at /home/jon/rfnoc_3.14.1.1/src/uhd/host/lib/rfnoc/ctrl_iface.cpp:142
>>
>> This is only occurring when I use the split stream block in RFNoC. I hav=
e
...
>>
>> find: =E2=80=98rfnoc_ce_auto_inst_e310.v=E2=80=99: No such file or direc=
tory
>>
...
<div dir=3D"ltr"><div>Greetings Nick,</div><div><br></div><div>Here is the =
screenshot of my GR flow graph, though it shouldn&#39;t matter as the Split=
_Stream RFNoC Block I believe is a failure of the python or Verilog but the=
 solutions in the link I sent in my previous email did not resolve the issu=
e. <br></div><div><br></div><div><div><img src=3D"cid:ii_k2qa0bd70" alt=3D"=
