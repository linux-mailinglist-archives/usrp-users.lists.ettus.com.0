...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 80FE43C25FA
	for <lists+usrp-users@lfdr.de>; Fri,  9 Jul 2021 16:32:38 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id C77443844F7
	for <lists+usrp-users@lfdr.de>; Fri,  9 Jul 2021 10:32:36 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=cttc.es header.i=@cttc.es header.b="cxfGuz0t";
	dkim-atps=neutral
Received: from mx01.puc.rediris.es (outbound3mad.lav.puc.rediris.es [130.206.19.142])
	by mm2.emwd.com (Postfix) with ESMTPS id 0C1C7384441
	for <usrp-users@lists.ettus.com>; Fri,  9 Jul 2021 10:31:43 -0400 (EDT)
Received: from leo.cttc.es (leo.cttc.es [84.88.62.208])
	by mx01.puc.rediris.es  with ESMTP id 169EVgTn020402-169EVgTp020402
	(version=TLSv1.3 cipher=TLS_AES_256_GCM_SHA384 bits=256 verify=OK)
	for <usrp-users@lists.ettus.com>; Fri, 9 Jul 2021 16:31:42 +0200
Received: from localhost (localhost [127.0.0.1])
To: usrp-users@lists.ettus.com
References: <0f01b8f9-0390-462f-f650-3e108ced0508@cttc.es>
 <60E843EE.2020702@gmail.com>
From: Armin Ghani <aghani@cttc.es>
Message-ID: <de086712-0b2c-bd0a-2403-a21e3d60195c@cttc.es>
Date: Fri, 9 Jul 2021 16:31:40 +0200
MIME-Version: 1.0
In-Reply-To: <60E843EE.2020702@gmail.com>
Content-Language: en-US
X-FE-Attachment-Name: eialihcnnajedijn.jpeg
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; d=cttc.es; s=DKIM; c=relaxed/relaxed;
 ...
 bh=AQ6aLy+3/FAoqsy16Anv0rHs4nb2xBAGRJT8KGJyBMY=;
 b=
Message-ID-Hash: SVZOOGCVLZTCFDE6SOOKZQDIQXUH6AJW
X-Message-ID-Hash: SVZOOGCVLZTCFDE6SOOKZQDIQXUH6AJW
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/SVZOOGCVLZTCFDE6SOOKZQDIQXUH6AJW/>
...
Content-Type: multipart/mixed; boundary="===============3952434269208536949=="

This is a multi-part message in MIME format.
--===============3952434269208536949==
Content-Type: multipart/alternative;
 boundary="------------CDA64E7DDE5D14E04FE5BA86"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------CDA64E7DDE5D14E04FE5BA86
...
>>
>>
> What happens if you use the "skip_dram=3D1" argument in the device argu=
ment?
>
>
>
...
Content-Type: multipart/related;
 boundary="------------6C9655FB96965A91E44DB144"


--------------6C9655FB96965A91E44DB144
...
<html>
  ...
  <body>
    ...
    <div class=3D"moz-cite-prefix">On 9/7/21 14:41, Marcus D. Leech wrote=
:<br>
    </div>
    <blockquote type=3D"cite" cite=3D"mid:60E843EE.2020702@gmail.com">
      ...
      <blockquote
        ...
        <p>when trying to run a flowgraph which consists one multi_usrp
          ...
          and running the flowgrapth I get this error:</p>
        <p>Executing: /usr/bin/python3 -u
          ...
          0xD0C0000000000000)<br>
          [INFO] [MULTI_USRP]=A0=A0=A0=A0 1) catch time transition at pps=
 edge<br>
          [INFO] [MULTI_USRP]=A0=A0=A0=A0 2) set times next pps (synchron=
ously)<br>
...
l"><img
          src=3D"cid:part1.1226B4F0.C9323498@cttc.es" width=3D"151"
...
Content-Type: image/jpeg;
 name="eialihcnnajedijn.jpeg"
Content-Transfer-Encoding: base64
Content-ID: <part1.1226B4F0.C9323498@cttc.es>
Content-Disposition: inline;
 filename="eialihcnnajedijn.jpeg"
