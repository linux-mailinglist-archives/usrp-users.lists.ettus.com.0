...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id E12E8A9E4B5
	for <lists+usrp-users@lfdr.de>; Sun, 27 Apr 2025 23:38:18 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id ABC82386109
	for <lists+usrp-users@lfdr.de>; Sun, 27 Apr 2025 17:38:17 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1745789897; bh=o/pv+fywntrPN7zvNB8HKBfB+mS3wTUTRGDWm5wGf9g=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-io1-f52.google.com (mail-io1-f52.google.com [209.85.166.52])
	by mm2.emwd.com (Postfix) with ESMTPS id ACF12385F12
	for <usrp-users@lists.ettus.com>; Sun, 27 Apr 2025 17:37:19 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="ZX8pljJY";
	dkim-atps=neutral
Received: by mail-io1-f52.google.com with SMTP id ca18e2360f4ac-8613f456960so113498839f.1
        for <usrp-users@lists.ettus.com>; Sun, 27 Apr 2025 14:37:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1745789839; x=1746394639; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=EevNfOBjyy8Z6fU9H7K0kFpt+sYzmq/DALhT5U1aoXI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1745789839; x=1746394639;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=EevNfOBjyy8Z6fU9H7K0kFpt+sYzmq/DALhT5U1aoXI=;
        b=
X-Gm-Message-State: AOJu0Yz6k6vjlfY7U02duS/H+savDcio5APFGemCBQQ/z+OhjzHF9pDC
	0DzkD+5/ZmNea+21ZLiNz50TELZjXFsrn9WaJK8tcg1kd0pSAHNwE8p5TKoBS3lHNqBREErgT5D
	3X+lFJJcy/r7kRbR512VA5KVdCDMXrMoQHAI=
X-Gm-Gg: ASbGnctL31tXb/vamTuahE7zg++rnGhtGbOV1vPwCvVcl3Lwmdyv9+i3iwpy7NfeZQg
	rxMcNShdYelmptiIAGfs9uOUwTPee9JeH42sL4toDiampvsT0bqmb0ktwb8CzM4qXNMjO2tEIsV
	j87jaiWUPWaQ/FSi1S
X-Google-Smtp-Source: AGHT+IH+ultDCxx0Q83xiKPm4skx6akwLUB2vvm+1SB99ip6NbkES255C9p6abruZNugHZh96rM4jugeI0p2mvYN/HA=
X-Received: by 2002:a05:6602:2cc4:b0:864:4a9b:f1f1 with SMTP id
 ca18e2360f4ac-8645cfacf61mr1137548839f.14.1745789838882; Sun, 27 Apr 2025
 14:37:18 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAAxXO2HWGvwy=V80crP6yajNPeYjvn3qYV-kyPPD0Wcaq-4tAA@mail.gmail.com>
From: Nikos Balkanas <nbalkanas@gmail.com>
Date: Mon, 28 Apr 2025 00:37:06 +0300
X-Gm-Features: ATxdqUE_Cj6gVQ1ePQWa8xbH8zbNTdtCQJKE5_TQrYL6eFNMhi_LvAE5HkPPOAg
Message-ID: <CAAxXO2EHUfxCoFaBMiUkp=JYvv4hgNYtbVwpW6udYajdtdxSBA@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Message-ID-Hash: DOT4S4OZRDTFCQPW33QOVHNMEJOLQXQ5
X-Message-ID-Hash: DOT4S4OZRDTFCQPW33QOVHNMEJOLQXQ5
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/DOT4S4OZRDTFCQPW33QOVHNMEJOLQXQ5/>
...
Content-Type: multipart/mixed; boundary="===============1499210734580903685=="

--===============1499210734580903685==
Content-Type: multipart/alternative; boundary="0000000000003300730633c95fd7"

--0000000000003300730633c95fd7
...
On Sat, Apr 26, 2025 at 7:02=E2=80=AFAM Nikos Balkanas <nbalkanas@gmail.com=
> wrote:
...
> Nikos
>
> On Sat, Apr 26, 2025 at 6:45=E2=80=AFAM Marcus D. Leech <patchvonbraun@gm=
ail.com>
> wrote:
>
...
>>   the requirements of your application.  So, a common programming patter=
n
...
>> Nikos
>>
>> On Sat, Apr 26, 2025 at 5:46=E2=80=AFAM Marcus D. Leech <patchvonbraun@g=
mail.com>
>> wrote:
>>
...
>>> for your fast reply.
>>>
>>> On Sat, Apr 26, 2025 at 4:08=E2=80=AFAM Marcus D. Leech <patchvonbraun@=
gmail.com>
>>> wrote:
>>>
...
>>>>
>>>> So, 1.996ksps vs 19.960ksps?   You hardly need a 10Gbit link to suppor=
t
...
>>>
>>>>
>>>> On a related question. it seems that the streamer doesn't crash anymor=
e
>>>> when receiving less than MAXSPS samples, instead it reads 0:(
>>>> This was due to the sse2 code not aligned in convert.
>>>> I change my stream args to cpu_format=3Dsc16, otw=3Dsc16, so no conver=
sion
>>>> required.
>>>> Streamer still doesn't read anything. Is there a reason for it?
>>>>
>>>> You'd need to share more of your code.  This should just work as far a=
s
>>>> I can tell.
>>>>
...
iv><div class=3D"gmail_default" style=3D"font-size:small">You were right. N=
o need to change NIC:)</div><div class=3D"gmail_default" style=3D"font-size=
:small">This is not a software issue.=C2=A0uhd_rx_streamer_max_num_samps ru=
ns right after uhd initialization before</div><div class=3D"gmail_default" =
style=3D"font-size:small">any other code had the chance to run.</div><div c=
lass=3D"gmail_default" style=3D"font-size:small">Link capacity doesn&#39;t =
seem to be the issue either...</div><div class=3D"gmail_default" style=3D"f=
ont-size:small">Running pchar on the link, descendant of pathchar, reports =
a throughput of 5.619 Kb/s requesting ICMP replies,</div><div class=3D"gmai=
l_default" style=3D"font-size:small">to varying packet sizes (32-&gt;9000 (=
MTU), incr by 32).=C2=A0</div><div class=3D"gmail_default" style=3D"font-si=
ze:small">sudo pchar -m 9000 -p ipv4icmp usrp</div><div class=3D"gmail_defa=
ult" style=3D"font-size:small"><a href=3D"https://www.kitchenlab.org/www/bm=
ah/Software/pchar/">https://www.kitchenlab.org/www/bmah/Software/pchar/</a>=
</div><div class=3D"gmail_default" style=3D"font-size:small"><br></div><div=
 class=3D"gmail_default" style=3D"font-size:small">It corresponds to 351.21=
8.019 16-bit samples or 175,609.044 32-bit samples, if each sample is 32-bi=
t(real=C2=A0+ imag)</div><div class=3D"gmail_default" style=3D"font-size:sm=
all">Seems that uhd is not running at link capacity but is doing smt else.<=
/div><div class=3D"gmail_default" style=3D"font-size:small">I will have=C2=
=A0 to download and check with the sources...</div><div class=3D"gmail_defa=
ult" style=3D"font-size:small">The package version for Ubuntu 24.04 is uhd =
4.6.0.</div><div class=3D"gmail_default" style=3D"font-size:small">Where ca=
n I download the sources for uhd 4.6.0?</div><div class=3D"gmail_default" s=
tyle=3D"font-size:small"><br></div><div class=3D"gmail_default" style=3D"fo=
nt-size:small">BR</div><div class=3D"gmail_default" style=3D"font-size:smal=
l">Nikos</div></div><br><div class=3D"gmail_quote gmail_quote_container"><d=
iv dir=3D"ltr" class=3D"gmail_attr">On Sat, Apr 26, 2025 at 7:02=E2=80=AFAM=
...
Thanks for your time.</div><div class=3D"gmail_default" style=3D"font-size:=
small">I will check out the example.</div><div class=3D"gmail_default" styl=
e=3D"font-size:small">This is not a buffer problem. I just need 1024 Sample=
s (real+imaginary) for FFT...</div><div class=3D"gmail_default" style=3D"fo=
nt-size:small">I should be able to get them in a single pass.</div><div cla=
ss=3D"gmail_default" style=3D"font-size:small">You saw my code, not a smoki=
ng gun there.</div><div class=3D"gmail_default" style=3D"font-size:small"><=
br></div><div class=3D"gmail_default" style=3D"font-size:small">This is pro=
bably is a physical problem.</div><div class=3D"gmail_default" style=3D"fon=
t-size:small">Cable is an SFP fiber dedicated line. Cannot go bad.</div><di=
v class=3D"gmail_default" style=3D"font-size:small">Maybe the connections a=
re not sitting right :(...</div><div class=3D"gmail_default" style=3D"font-=
...
>On Sat, Apr 26, 2025 at 6:45=E2=80=AFAM Marcus D. Leech &lt;<a href=3D"mai=
