...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 61C0325B343
	for <lists+usrp-users@lfdr.de>; Wed,  2 Sep 2020 19:59:48 +0200 (CEST)
Received: from [::1] (port=45684 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1kDX2u-0005ZH-B1; Wed, 02 Sep 2020 13:59:44 -0400
Received: from mail-oo1-f42.google.com ([209.85.161.42]:34681)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <cogwsn@gmail.com>) id 1kDX2q-0005Sf-7d
 for USRP-users@lists.ettus.com; Wed, 02 Sep 2020 13:59:40 -0400
Received: by mail-oo1-f42.google.com with SMTP id k63so67472oob.1
 for <USRP-users@lists.ettus.com>; Wed, 02 Sep 2020 10:59:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to;
 bh=7s1mTZT0KyJaH3nFgG80F7cxwgIyQT6RQQ61DV6Fs8o=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=7s1mTZT0KyJaH3nFgG80F7cxwgIyQT6RQQ61DV6Fs8o=;
 b=
X-Gm-Message-State: AOAM531zpGf+uXjb1CISxBaNTSLmC/Jebba9M44MfiuNaDj0TcndIB30
 V+Whl7/mGer88MXCMlHmldFIYF9L6F9wVVMxhd7gEvLvE5o=
X-Google-Smtp-Source: ABdhPJzX8jrgwFAafwu5fM3q5V72lS40/iM1fupn7xPFHC79JmELMhcDX7iG38soQwZXGNDOXwO/LaV4sLkVW1KwxfM=
X-Received: by 2002:a4a:c909:: with SMTP id v9mr6352172ooq.43.1599069539184;
 Wed, 02 Sep 2020 10:58:59 -0700 (PDT)
MIME-Version: 1.0
References: <5144B3B6-EEDB-446E-BE6F-8EA289E45146@jhuapl.edu>
In-Reply-To: <5144B3B6-EEDB-446E-BE6F-8EA289E45146@jhuapl.edu>
Date: Wed, 2 Sep 2020 19:58:47 +0200
Message-ID: <CAOExtcTaVfk6B7L_9qVCYCiqR2tYsbzspU4Zd+BUk6nKidbX5g@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============5137341210092226159=="
...
--===============5137341210092226159==
Content-Type: multipart/alternative; boundary="000000000000dab27105ae586328"

--000000000000dab27105ae586328
...
>
>
> I=E2=80=99m having a problem using the front panel GPIO on an N320.  I re=
verted
> back to a standard =E2=80=9CHG=E2=80=9D FPGA build and compiled the GPIO =
example program
> (UHD 3.14.0).   However, when I run the example program I get the followi=
ng:
>
>
>
...
>
>
> See below for a =E2=80=9Cuhd_uspr_probe=E2=80=9D, =E2=80=9Cuhd_config_inf=
o=E2=80=9D dump, and the terminal
...
> mgmt_addr=3D192.168.20.2,type=3Dn3xx,product=3Dn320,serial=3D31A5C5A,clai=
med=3DFalse,addr=3D192.168.20.2
>
...
> -DUHD_LOG_CONSOLE_LEVEL=3D2 -DUHD_LOG_FILE_LEVEL=3D2 -DUHD_LOG_CONSOLE_CO=
LOR
>
> C++ flags: -DUHD_RFNOC_ENABLED -DHAVE_CONFIG_H -DUHD_LOG_MIN_LEVEL=3D1
> -DUHD_LOG_CONSOLE_LEVEL=3D2 -DUHD_LOG_FILE_LEVEL=3D2 -DUHD_LOG_CONSOLE_CO=
...
<div dir=3D"ltr"><div dir=3D"ltr">Hi,=C2=A0<div><br></div><div>I am also ha=
ving the issue. Can anyone please help with the information :)</div><div><b=
r></div><div>For N310, there is FP0 available=C2=A0but for N320 I get follo=
wing run time error:=C2=A0</div><div>&quot;=C2=A0 what(): =C2=A0RuntimeErro=
r: The hardware has no GPIO bank `FP0&#39; &quot;</div><div><br></div><div>=
Regards</div><div>Sumit=C2=A0</div></div><br><div class=3D"gmail_quote"><di=
v dir=3D"ltr" class=3D"gmail_attr">On Mon, Jan 27, 2020 at 11:02 PM Nowicki=
, Ed H. via USRP-users &lt;<a href=3D"mailto:usrp-users@lists.ettus.com">us=
...
<div lang=3D"EN-US">
<div class=3D"gmail-m_5465625335197139286WordSection1">
...
<div>
<div id=3D"gmail-m_5465625335197139286APLWarningText">
