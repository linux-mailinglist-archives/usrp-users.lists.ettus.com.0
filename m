...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id B6CEEEB6E3
	for <lists+usrp-users@lfdr.de>; Thu, 31 Oct 2019 19:28:19 +0100 (CET)
Received: from [::1] (port=52270 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iQFB9-0003rJ-Vg; Thu, 31 Oct 2019 14:28:15 -0400
Received: from mail-lj1-f173.google.com ([209.85.208.173]:46939)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <sam.reiter@ettus.com>)
 id 1iQFB5-0003hm-3c
 for usrp-users@lists.ettus.com; Thu, 31 Oct 2019 14:28:11 -0400
Received: by mail-lj1-f173.google.com with SMTP id w8so7649393lji.13
 for <usrp-users@lists.ettus.com>; Thu, 31 Oct 2019 11:27:50 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ettus-com.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=vBXKYDBa3zudzlgna+i9A2g/O0hjSNhHyflFnVr6+/g=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=vBXKYDBa3zudzlgna+i9A2g/O0hjSNhHyflFnVr6+/g=;
 b=
X-Gm-Message-State: APjAAAXU6g58sXGydxWbHisxm+0oTtKGF8kRSZ9D3jbz4XTJalT2qf9R
 jk6GyehwMmOvmFPpdUt79YghQE9D6p9fDQ/wsxulAUOY
X-Google-Smtp-Source: APXvYqzYtFziSqS4Rgkq3+KAQS3OUM2BjZdZ5jFP+1uqTtvROa5JTwYM8PgyBjrATT1sOXceq3mpg86IQCiicMT3YX0=
X-Received: by 2002:a05:651c:96:: with SMTP id
 22mr3801663ljq.141.1572546449528; 
 Thu, 31 Oct 2019 11:27:29 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CALSKgPxrBuOSR4r-LonrzyCjFMR=7=GtYTtXjd9OrX8uhRvoeQ@mail.gmail.com>
Date: Thu, 31 Oct 2019 13:27:16 -0500
Message-ID: <CANf970ZyD=Jr-tZBBjVkp1yc6BdfOZZ0nyT6ssY1QbtmZ9e-ow@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============5491728091186303107=="
...
--===============5491728091186303107==
Content-Type: multipart/related; boundary="00000000000084b1da059639003b"

--00000000000084b1da059639003b
Content-Type: multipart/alternative; boundary="00000000000084b1d8059639003a"

--00000000000084b1d8059639003a
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

I'm not sure if the graphics card thing is worth spending too much time on
...
Here are a couple other commands I'd like you to run and report the outputs
of:
...
On Wed, Oct 30, 2019 at 8:21 AM Wheberth Damascena Dias <wheberth@gmail.com=
>
wrote:

> Another piece of info. The manual of the PCIe-8371 card states that it ma=
y
...
>>>
>>> Em sex, 25 de out de 2019 =C3=A0s 18:28, Sam Reiter <sam.reiter@ettus.c=
om>
>>> escreveu:
>>>
...
>>>> connected to the computer. It might be worth making the X310's PCIe li=
nk
...
>>>>> i7 6th gen with ubuntu 18.04 kernel  4.15.0, libuhd and uhd-host on s=
ame
>>>>> version.
>>>>>
...
<div dir=3D"ltr">I&#39;m not sure if the graphics card thing is worth spend=
ing too much time on -- I can&#39;t find a great answer for the reasoning b=
ehind it either.<br><br>From the initial lspci output, there don&#39;t seem=
 to be any kernel drivers handling the 8371. Were you able to try recompili=
ng and reloading the RIO drivers after installing your new CPU?<br><br>Here=
 are a couple other commands I&#39;d like you to run and report the outputs=
 of:<br><br><b>sudo lspci -vvv</b><br><br><b>dmesg</b><br><br><b>lsmod</b><=
br><br>If you could attach those outputs as text files, that may be helpful=
 in moving this forward. Feel free to pass along any changes you observed b=
etween 18.04 and 16.04 as well.<br><br>-Sam</div><br><div class=3D"gmail_qu=
ote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Oct 30, 2019 at 8:21 AM =
Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com">wheberth@=
gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div dir=3D"ltr"><div>Another piece of info. The manual of the P=
CIe-8371 card states that it may not work in a slot intended for graphics c=
ard. Anyone have an idea of the reason for that?</div><div><br></div><div><=
div><img src=3D"cid:ii_k2db2u0v1" alt=3D"image.png" width=3D"566" height=3D=
"270"><br></div></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr"=
 class=3D"gmail_attr">Em ter, 29 de out de 2019 =C3=A0s 16:11, Wheberth Dam=
ascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com" target=3D"_blank">whe=
berth@gmail.com</a>&gt; escreveu:<br></div><blockquote class=3D"gmail_quote=
" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);=
padding-left:1ex"><div dir=3D"ltr"><div>Here is the full output of the lspc=
i. I will try to install Ubuntu 16.04 and see <br></div><div><br></div><div=
>00:00.0 Host bridge: Intel Corporation Device 3e30 (rev 0a)<br>00:01.0 PCI=
 bridge: Intel Corporation Xeon E3-1200 v5/E3-1500 v5/6th Gen Core Processo=
r PCIe Controller (x16) (rev 0a)<br>00:02.0 VGA compatible controller: Inte=
l Corporation Device 3e98<br>00:14.0 USB controller: Intel Corporation Cann=
on Lake PCH USB 3.1 xHCI Host Controller (rev 10)<br>00:14.2 RAM memory: In=
tel Corporation Cannon Lake PCH Shared SRAM (rev 10)<br>00:14.3 Network con=
troller: Intel Corporation Wireless-AC 9560 [Jefferson Peak] (rev 10)<br>00=
:16.0 Communication controller: Intel Corporation Cannon Lake PCH HECI Cont=
roller (rev 10)<br>00:17.0 SATA controller: Intel Corporation Cannon Lake P=
CH SATA AHCI Controller (rev 10)<br>00:1b.0 PCI bridge: Intel Corporation D=
evice a340 (rev f0)<br>00:1c.0 PCI bridge: Intel Corporation Device a338 (r=
ev f0)<br>00:1d.0 PCI bridge: Intel Corporation Cannon Lake PCH PCI Express=
 Root Port 9 (rev f0)<br>00:1f.0 ISA bridge: Intel Corporation Device a305 =
(rev 10)<br>00:1f.3 Audio device: Intel Corporation Cannon Lake PCH cAVS (r=
ev 10)<br>00:1f.4 SMBus: Intel Corporation Cannon Lake PCH SMBus Controller=
 (rev 10)<br>00:1f.5 Serial bus controller [0c80]: Intel Corporation Cannon=
 Lake PCH SPI Controller (rev 10)<br>00:1f.6 Ethernet controller: Intel Cor=
poration Ethernet Connection (7) I219-V (rev 10)<br>01:00.0 PCI bridge: PLX=
 Technology, Inc. PEX 8608 8-lane, 8-Port PCI Express Gen 2 (5.0 GT/s) Swit=
ch (rev ba)<br>02:01.0 PCI bridge: PLX Technology, Inc. PEX 8608 8-lane, 8-=
Port PCI Express Gen 2 (5.0 GT/s) Switch (rev ba)<br>03:00.0 Signal process=
ing controller: National Instruments PXIe/PCIe Device<br></div></div><br><d=
iv class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em sex, 25 d=
e out de 2019 =C3=A0s 20:55, Wheberth Damascena Dias &lt;<a href=3D"mailto:=
wheberth@gmail.com" target=3D"_blank">wheberth@gmail.com</a>&gt; escreveu:<=
br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8e=
x;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"=
><div>This computer has a mini-ITX board (ASUS ROG Strix Z390-I ) with just=
 one x16 slot.=C2=A0</div><div>However,=C2=A0on monday I can get the full o=
utput of the lspci command.<br></div></div><br><div class=3D"gmail_quote"><=
div dir=3D"ltr" class=3D"gmail_attr">Em sex, 25 de out de 2019 =C3=A0s 18:2=
8, Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" target=3D"_blank"=
