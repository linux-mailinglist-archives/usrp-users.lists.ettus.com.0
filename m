...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id A6F4BD494E
	for <lists+usrp-users@lfdr.de>; Fri, 11 Oct 2019 22:29:20 +0200 (CEST)
Received: from [::1] (port=35780 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iJ1XI-00053v-PY; Fri, 11 Oct 2019 16:29:16 -0400
Received: from mail-lf1-f50.google.com ([209.85.167.50]:47013)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <sam.reiter@ettus.com>)
 id 1iJ1XE-0004xI-Mg
 for usrp-users@lists.ettus.com; Fri, 11 Oct 2019 16:29:13 -0400
Received: by mail-lf1-f50.google.com with SMTP id t8so7880750lfc.13
 for <usrp-users@lists.ettus.com>; Fri, 11 Oct 2019 13:28:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ettus-com.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=3OD5X8kuEJwedgfenOu2Crk3ONPK0vKd7OgT6i2EJhk=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=3OD5X8kuEJwedgfenOu2Crk3ONPK0vKd7OgT6i2EJhk=;
 b=
X-Gm-Message-State: APjAAAVDV9BRx922NXE55eLA5smzAV7/e1WTwOORI9flERd3tHXNHgkK
 gol7KF/TTNB+IDeJWMgxIPVT+64O8jVGXxlzfOydf6HETF/U+A==
X-Google-Smtp-Source: APXvYqx/SafWPHwHcRBAEQdb/qbd1Tf5cHaUZKbg99N3LQ3oj1ceahUtYWYy+TmFZ4l6YdfdcWZZVC6gY8BGKd/NJY4=
X-Received: by 2002:ac2:4c2c:: with SMTP id u12mr9778384lfq.104.1570825710766; 
 Fri, 11 Oct 2019 13:28:30 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAPRRyxuST9uHT-PekP67=jWDn2j9nkN1xeaizoaOF3wJW8H8HQ@mail.gmail.com>
Date: Fri, 11 Oct 2019 15:28:19 -0500
Message-ID: <CANf970Z2XWUWx-PwFooRNBqatwhAgmXYtAyijELSeRTqu+GaDg@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============7484748627578629958=="
...
--===============7484748627578629958==
Content-Type: multipart/related; boundary="0000000000008252260594a85c85"

--0000000000008252260594a85c85
Content-Type: multipart/alternative; boundary="0000000000008252240594a85c84"

--0000000000008252240594a85c84
...
>
>
> =D0=B2=D1=82, 8 =D0=BE=D0=BA=D1=82. 2019 =D0=B3. =D0=B2 16:59, Sam Reiter=
...
<div dir=3D"ltr">Ivan,<div><br></div><div>Thanks for sending that along. Fr=
om a software perspective, what parameters do you input to your attached co=
de to run it? I&#39;m trying to understand the data rates you&#39;re trying=
 to sustain over the NIC you have. I&#39;ve been combing through this past =
USRP-users thread for some additional insight:</div><div><br></div><div><a =
href=3D"http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/2014-Ma=
y/037495.html">http://lists.ettus.com/pipermail/usrp-users_lists.ettus.com/=
2014-May/037495.html</a><br></div><div><br></div><div>Based on some of thos=
e suggestions, it might be wise to try finding another NIC to bring into th=
e equation.=C2=A0</div><div><br clear=3D"all"><div><div dir=3D"ltr" class=
...
t 9, 2019 at 2:14 PM Ivan Zahartchuk via USRP-users &lt;<a href=3D"mailto:u=
...
--- Forwarded message ---------<br>=D0=9E=D1=82: <strong class=3D"gmail_sen=
dername" dir=3D"auto">Ivan Zahartchuk</strong> <span dir=3D"auto">&lt;<a hr=
ef=3D"mailto:adray0001@gmail.com" target=3D"_blank">adray0001@gmail.com</a>=
&gt;</span><br>Date: =D1=81=D1=80, 9 =D0=BE=D0=BA=D1=82. 2019 =D0=B3. =D0=
=B2 06:05<br>Subject: Re: [USRP-users] Error handling D when reading data U=
SRP N 210<br>To: Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" tar=
get=3D"_blank">sam.reiter@ettus.com</a>&gt;<br></div><br><br><div dir=3D"lt=
r"><div>CPU intel core i7 -3610QE 2.3 GGz</div><div>
RAM 16 Gb<br></div><div>=C2=A02 NIC intel 82574L gigabit ethernet and intel=
 82574LM gigabit ethernet</div><div><br></div></div><br><div class=3D"gmail=
_quote"><div dir=3D"ltr" class=3D"gmail_attr">=D0=B2=D1=82, 8 =D0=BE=D0=BA=
=D1=82. 2019 =D0=B3. =D0=B2 16:59, Sam Reiter &lt;<a href=3D"mailto:sam.rei=
ter@ettus.com" target=3D"_blank">sam.reiter@ettus.com</a>&gt;:<br></div><bl=
ockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-lef=
t:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">What hardwa=
re are you using on the host side? Specifically, I&#39;m interested in CPU,=
 RAM, and NIC.<div><br clear=3D"all"><div><div dir=3D"ltr"><div dir=3D"ltr"=
><div><div dir=3D"ltr">Sam Reiter=C2=A0</div></div></div></div></div></div>=
</div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">=
On Tue, Oct 8, 2019 at 6:22 AM Ivan Zahartchuk via USRP-users &lt;<a href=
