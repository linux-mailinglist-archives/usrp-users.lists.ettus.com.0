...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 67FD3EC8AF
	for <lists+usrp-users@lfdr.de>; Fri,  1 Nov 2019 19:56:45 +0100 (CET)
Received: from [::1] (port=42670 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iQc6F-0002cX-CY; Fri, 01 Nov 2019 14:56:43 -0400
Received: from mail-qk1-f179.google.com ([209.85.222.179]:38984)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <wddias@gmail.com>) id 1iQc6B-0002VC-7I
 for usrp-users@lists.ettus.com; Fri, 01 Nov 2019 14:56:39 -0400
Received: by mail-qk1-f179.google.com with SMTP id 15so11647005qkh.6
 for <usrp-users@lists.ettus.com>; Fri, 01 Nov 2019 11:56:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=HqC4DmhKKndxicWyjjupCltvMtS5wyCvGfth5LG195s=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=HqC4DmhKKndxicWyjjupCltvMtS5wyCvGfth5LG195s=;
 b=
X-Gm-Message-State: APjAAAVvSLccv3MzKJpumFmIr5CsN54zRCjBwoCE8zqoriWnhLiZaqLd
 QcatbCyl3xrIpuLXGipzDqLmLIlMcWcScEtz8t0=
X-Google-Smtp-Source: APXvYqxPnvJhgmGRuHPkRG7H8d0dOIURyDgrKpfuYRXs5r3LBvcAUV1TmWZgteAtqg9vwVQMTsTMd7bukCmYzcB+sNQ=
X-Received: by 2002:a37:8244:: with SMTP id e65mr6567034qkd.233.1572634557953; 
 Fri, 01 Nov 2019 11:55:57 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CALSKgPy7ket3jU4VDJM3MTP0VxgyZ5=8v_rv4ktTmB+h4NU7Zw@mail.gmail.com>
Date: Fri, 1 Nov 2019 15:55:46 -0300
Message-ID: <CALSKgPwe31Aoe0a367Gp5g+Arurjt+D=A8tC7x_+oY16ndcOhQ@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============8079312513126983823=="
...
--===============8079312513126983823==
Content-Type: multipart/related; boundary="00000000000030db0305964d845d"

--00000000000030db0305964d845d
Content-Type: multipart/alternative; boundary="00000000000030db0205964d845c"

--00000000000030db0205964d845c
...
> I have also upgraded another machine to Ubuntu 18 and the USRP worked lik=
e
> charm on this third machine (also very different from the i7 and the i9).
> - I have also noticed the that the driver is not "tied" to the PCIe devic=
e
...
>
>
> Em qui, 31 de out de 2019 =C3=A0s 16:38, Sam Reiter <sam.reiter@ettus.com=
>
> escreveu:
>
>> I also spoke with someone on our PXI team regarding 8371 compatibility,
>> what that manual note means, and some other troubleshooting steps. Not s=
ure
>> if any of this will be actionable, but here are some tidbits of knowledg=
e:
>>
>> - "Slots intended for graphics cards" are usually x16 PCIe slots that ma=
y
>> not be fully PCIe compliant. You might check the motherboard manual for =
any
>> **vague** language surrounding that slot being intended for GPU use. I
>> question whether this is relevant or not considering the fact that it wa=
s
...
>> - You can see if there are BIOS settings to change the PCIe link speed t=
o
...
>>>
>>> From the initial lspci output, there don't seem to be any kernel driver=
s
>>> handling the 8371. Were you able to try recompiling and reloading the R=
IO
...
>>>> may not work in a slot intended for graphics card. Anyone have an idea=
 of
>>>> the reason for that?
>>>>
>>>> [image: image.png]
...
>>>>> 00:14.0 USB controller: Intel Corporation Cannon Lake PCH USB 3.1 xHC=
I
>>>>> Host Controller (rev 10)
>>>>> 00:14.2 RAM memory: Intel Corporation Cannon Lake PCH Shared SRAM (re=
v
>>>>> 10)
...
>>>>> 00:1d.0 PCI bridge: Intel Corporation Cannon Lake PCH PCI Express Roo=
t
>>>>> Port 9 (rev f0)
>>>>> 00:1f.0 ISA bridge: Intel Corporation Device a305 (rev 10)
>>>>> 00:1f.3 Audio device: Intel Corporation Cannon Lake PCH cAVS (rev 10)
>>>>> 00:1f.4 SMBus: Intel Corporation Cannon Lake PCH SMBus Controller (re=
v
>>>>> 10)
...
>>>>> wheberth@gmail.com> escreveu:
>>>>>
>>>>>> This computer has a mini-ITX board (ASUS ROG Strix Z390-I ) with jus=
t
>>>>>> one x16 slot.
>>>>>> However, on monday I can get the full output of the lspci command.
>>>>>>
>>>>>> Em sex, 25 de out de 2019 =C3=A0s 18:28, Sam Reiter <sam.reiter@ettu=
s.com>
>>>>>> escreveu:
>>>>>>
...
>>>>>>> connected to the computer. It might be worth making the X310's PCIe=
 link
...
>>>>>>>> a i7 6th gen with ubuntu 18.04 kernel  4.15.0, libuhd and uhd-host=
 on same
>>>>>>>> version.
>>>>>>>>
>>>>>>>> I think this can be some PCIe related setting on the BIOS, since
>>>>>>>> the lspci shows [disabled] next to the base address, but I can't f=
ind any
...
<div dir=3D"ltr">Hi Sam,=C2=A0<div>A quick update. I found the setting you =
referred=C2=A0from the Motherboard manual.</div><div>I tried to force the P=
CIe to Gen1 but again, no luck.</div><div><br></div><div>Regards</div></div=
><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em qu=
i, 31 de out de 2019 =C3=A0s 17:39, Wheberth Damascena Dias &lt;<a href=3D"=
mailto:wheberth@gmail.com">wheberth@gmail.com</a>&gt; escreveu:<br></div><b=
lockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-le=
ft:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Hi Sa=
m,</div><div><br></div><div></div><div></div><div>- In fact the i7 machine =
is totally different from the i9. Not just a CPU upgrade a new machine with=
 a different motherboard.</div><div>- Regarding the OS version, I have down=
graded form Ubuntu 18 to Ubuntu 16 but there are no difference at all.</div=
><div>I have also upgraded another machine to Ubuntu 18 and the USRP worked=
 like charm on this third machine (also very different from the i7 and the =
i9).</div><div>- I have also noticed the that the driver is not &quot;tied&=
quot; to the PCIe device despite compiled and loaded successfully.<br></div=
><div></div><div></div><div></div><div>- The PCIe slot on this board is ind=
eed x16 gen 3. But on the BIOS, the only PCIe settings available are relate=
d to power management and Virtualization (SR-IOV).</div><div>- Being a game=
 motherboard with a single PCIe Slot looks like a good indication of intend=
ed usage.</div><div>I have also upgraded the BIOS but, again, no success.</=
div><div><br></div><div>Please find attached the lspci -vvv output form the=
 i7 and i9.</div><div>for the i9 i also included the dmesg and lsmod.</div>=
<div><br></div><div>Thank you Again.</div><div>Best Regards,<br></div><div>=
<br></div><div><br></div></div><div dir=3D"ltr"><br></div><br><div class=3D=
"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em qui, 31 de out de 20=
19 =C3=A0s 16:38, Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" ta=
rget=3D"_blank">sam.reiter@ettus.com</a>&gt; escreveu:<br></div><blockquote=
 class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px so=
lid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>I also spoke w=
ith someone on our PXI team regarding 8371 compatibility, what that manual =
note means, and some other troubleshooting steps. Not sure if any of this w=
ill be actionable, but here are some tidbits of knowledge:</div><div><br></=
div><div>- &quot;Slots intended for graphics cards&quot; are usually x16 PC=
Ie slots that may not be fully PCIe compliant. You might check the motherbo=
ard manual for any **vague** language surrounding that slot being intended =
for GPU use. I question whether this is relevant or not considering the fac=
t that it was working with your i7.<br></div><div>- Related to the point ab=
ove, gaming oriented motherboards seem to give the 8371 and similar MXI car=
ds more trouble than non-gaming motherboards. The CPU typically isn&#39;t a=
s big of a factor as motherboard / BIOS. This makes your i7 / i9 issue all =
the more puzzling. <br></div><div>- You can see if there are BIOS settings =
to change the PCIe link speed to Gen 1 and try that as well see the snippet=
...
M Sam Reiter &lt;<a href=3D"mailto:sam.reiter@ettus.com" target=3D"_blank">=
sam.reiter@ettus.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quo=
te" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204=
);padding-left:1ex"><div dir=3D"ltr">I&#39;m not sure if the graphics card =
thing is worth spending too much time on -- I can&#39;t find a great answer=
 for the reasoning behind it either.<br><br>From the initial lspci output, =
there don&#39;t seem to be any kernel drivers handling the 8371. Were you a=
ble to try recompiling and reloading the RIO drivers after installing your =
new CPU?<br><br>Here are a couple other commands I&#39;d like you to run an=
d report the outputs of:<br><br><b>sudo lspci -vvv</b><br><br><b>dmesg</b><=
br><br><b>lsmod</b><br><br>If you could attach those outputs as text files,=
 that may be helpful in moving this forward. Feel free to pass along any ch=
anges you observed between 18.04 and 16.04 as well.<br><br>-Sam</div><br><d=
iv class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Oct =
30, 2019 at 8:21 AM Wheberth Damascena Dias &lt;<a href=3D"mailto:wheberth@=
gmail.com" target=3D"_blank">wheberth@gmail.com</a>&gt; wrote:<br></div><bl=
ockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-lef=
t:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div>Anothe=
r piece of info. The manual of the PCIe-8371 card states that it may not wo=
rk in a slot intended for graphics card. Anyone have an idea of the reason =
for that?</div><div><br></div><div><div><img src=3D"cid:ii_k2db2u0v1" alt=
=3D"image.png" width=3D"566" height=3D"270"><br></div></div></div><br><div =
class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">Em ter, 29 de o=
ut de 2019 =C3=A0s 16:11, Wheberth Damascena Dias &lt;<a href=3D"mailto:whe=
berth@gmail.com" target=3D"_blank">wheberth@gmail.com</a>&gt; escreveu:<br>=
</div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;b=
order-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><d=
iv>Here is the full output of the lspci. I will try to install Ubuntu 16.04=
 and see <br></div><div><br></div><div>00:00.0 Host bridge: Intel Corporati=
on Device 3e30 (rev 0a)<br>00:01.0 PCI bridge: Intel Corporation Xeon E3-12=
00 v5/E3-1500 v5/6th Gen Core Processor PCIe Controller (x16) (rev 0a)<br>0=
0:02.0 VGA compatible controller: Intel Corporation Device 3e98<br>00:14.0 =
USB controller: Intel Corporation Cannon Lake PCH USB 3.1 xHCI Host Control=
ler (rev 10)<br>00:14.2 RAM memory: Intel Corporation Cannon Lake PCH Share=
d SRAM (rev 10)<br>00:14.3 Network controller: Intel Corporation Wireless-A=
C 9560 [Jefferson Peak] (rev 10)<br>00:16.0 Communication controller: Intel=
 Corporation Cannon Lake PCH HECI Controller (rev 10)<br>00:17.0 SATA contr=
oller: Intel Corporation Cannon Lake PCH SATA AHCI Controller (rev 10)<br>0=
0:1b.0 PCI bridge: Intel Corporation Device a340 (rev f0)<br>00:1c.0 PCI br=
idge: Intel Corporation Device a338 (rev f0)<br>00:1d.0 PCI bridge: Intel C=
orporation Cannon Lake PCH PCI Express Root Port 9 (rev f0)<br>00:1f.0 ISA =
bridge: Intel Corporation Device a305 (rev 10)<br>00:1f.3 Audio device: Int=
el Corporation Cannon Lake PCH cAVS (rev 10)<br>00:1f.4 SMBus: Intel Corpor=
ation Cannon Lake PCH SMBus Controller (rev 10)<br>00:1f.5 Serial bus contr=
oller [0c80]: Intel Corporation Cannon Lake PCH SPI Controller (rev 10)<br>=
00:1f.6 Ethernet controller: Intel Corporation Ethernet Connection (7) I219=
-V (rev 10)<br>01:00.0 PCI bridge: PLX Technology, Inc. PEX 8608 8-lane, 8-=
Port PCI Express Gen 2 (5.0 GT/s) Switch (rev ba)<br>02:01.0 PCI bridge: PL=
X Technology, Inc. PEX 8608 8-lane, 8-Port PCI Express Gen 2 (5.0 GT/s) Swi=
tch (rev ba)<br>03:00.0 Signal processing controller: National Instruments =
PXIe/PCIe Device<br></div></div><br><div class=3D"gmail_quote"><div dir=3D"=
ltr" class=3D"gmail_attr">Em sex, 25 de out de 2019 =C3=A0s 20:55, Wheberth=
 Damascena Dias &lt;<a href=3D"mailto:wheberth@gmail.com" target=3D"_blank"=
>wheberth@gmail.com</a>&gt; escreveu:<br></div><blockquote class=3D"gmail_q=
uote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,2=
04);padding-left:1ex"><div dir=3D"ltr"><div>This computer has a mini-ITX bo=
ard (ASUS ROG Strix Z390-I ) with just one x16 slot.=C2=A0</div><div>Howeve=
r,=C2=A0on monday I can get the full output of the lspci command.<br></div>=
</div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">=
Em sex, 25 de out de 2019 =C3=A0s 18:28, Sam Reiter &lt;<a href=3D"mailto:s=
am.reiter@ettus.com" target=3D"_blank">sam.reiter@ettus.com</a>&gt; escreve=
u:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0=
.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"l=
tr">Would you be able to try shifting this card to another PCIe slot in you=
r machine?<div><br></div><div>I&#39;m also interested in knowing what other=
 PCIe devices you have connected to the computer. It might be worth making =
the X310&#39;s PCIe link the only connection, at least for testing purposes=
.=C2=A0</div><div><br clear=3D"all"><div><div dir=3D"ltr"><div dir=3D"ltr">=
<div><div dir=3D"ltr">Sam=C2=A0</div></div></div></div></div><br></div></di=
v><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On W=
ed, Oct 23, 2019 at 6:58 PM Wheberth Damascena Dias &lt;<a href=3D"mailto:w=
heberth@gmail.com" target=3D"_blank">wheberth@gmail.com</a>&gt; wrote:<br><=
/div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;bo=
rder-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"auto"><d=
iv dir=3D"auto">Hi Mr Reiter,=C2=A0</div><div dir=3D"auto">Thank you for yo=
ur answer.</div><div dir=3D"auto"><br></div>Actually yes, the same X310 run=
s perfectly in another machine. Its a i7 6th gen with ubuntu 18.04 kernel=
