...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id C3FD799F1B9
	for <lists+usrp-users@lfdr.de>; Tue, 15 Oct 2024 17:45:28 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 1A0533858AB
	for <lists+usrp-users@lfdr.de>; Tue, 15 Oct 2024 11:45:28 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1729007128; bh=x5G7YbTaLU9Qag4hXtjW1hs2EGri7sJAm3YUHD1uvc0=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-io1-f43.google.com (mail-io1-f43.google.com [209.85.166.43])
	by mm2.emwd.com (Postfix) with ESMTPS id D82FD385826
	for <usrp-users@lists.ettus.com>; Tue, 15 Oct 2024 11:45:16 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=accelleran-com.20230601.gappssmtp.com header.i=@accelleran-com.20230601.gappssmtp.com header.b="SriL+qHt";
	dkim-atps=neutral
Received: by mail-io1-f43.google.com with SMTP id ca18e2360f4ac-8354d853f91so215017439f.0
        for <usrp-users@lists.ettus.com>; Tue, 15 Oct 2024 08:45:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=accelleran-com.20230601.gappssmtp.com; s=20230601; t=1729007116; x=1729611916; darn=lists.ettus.com;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=ldcQ0T/M0+8AJqR4d3RvxeF1JONpjV5RVsF6PPBXA3Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1729007116; x=1729611916;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=ldcQ0T/M0+8AJqR4d3RvxeF1JONpjV5RVsF6PPBXA3Y=;
        b=
X-Gm-Message-State: AOJu0YyI5yaigUznsJUK07p06aF9nuTOSxNdyqdNyfUhbpXzwSol3seY
	hoT+ouV9K4fb1kX+jkBl/+HO+NCDdVQQriM2Nqy/VV+xbX9EEnNTvKwrIY63rIn2jb411EzEslq
	K2fBeh6LTcGhCj6D1wMH1uhrJNZMQ0tcFvo+RIFi7VClmpgl4
X-Google-Smtp-Source: AGHT+IFviDbXX86bv4cCuwDN+R26UmUUOjjlx6ci1MunEicFvCA8rYrp7Suki7+A+pKVmpQNljJh5XVY1JgeqN5bLZc=
X-Received: by 2002:a05:6e02:13a7:b0:3a0:9159:1561 with SMTP id
 e9e14a558f8ab-3a3b5f233e1mr139902115ab.2.1729007115593; Tue, 15 Oct 2024
 08:45:15 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAO=xj9X5oG1vZmZsM9haL=erSf5+m__uxLBsaLSqH4qTa98cMQ@mail.gmail.com>
From: Houshang <houshang.azizi@accelleran.com>
Date: Tue, 15 Oct 2024 17:45:01 +0200
Message-ID: <CAO=xj9WaKp2u-FG26ZGc3eKoHb_7WKCL8B6mvOXQRAstMwJZDQ@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Content-Type: multipart/mixed; boundary="000000000000f0f885062485d61c"
Message-ID-Hash: 4UCSCGAULYCYGVSOHK75IVNMBUZJID6I
X-Message-ID-Hash: 4UCSCGAULYCYGVSOHK75IVNMBUZJID6I
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/4UCSCGAULYCYGVSOHK75IVNMBUZJID6I/>
...
--000000000000f0f885062485d61c
Content-Type: multipart/related; boundary="000000000000f0f884062485d61b"

--000000000000f0f884062485d61b
Content-Type: multipart/alternative; boundary="000000000000f0f883062485d61a"

--000000000000f0f883062485d61a
Content-Type: text/plain; charset="UTF-8"

So to summarize, both n310 and host server are running the same version of
UHD now and the *uhd_usrp_probe *command fails on the host server while it
passes in the n310 itself. See attachments.
...
<div dir=3D"ltr">So to summarize, both n310 and host server are running the=
 same version of UHD now and the <i><span style=3D"background-color:rgb(204=
,204,204)">uhd_usrp_probe </span></i>command fails on the host server while=
 it passes in the n310 itself. See attachments.<br></div><br><div class=3D"=
gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct 2024 at 1=
7:25, Houshang &lt;<a href=3D"mailto:houshang.azizi@accelleran.com" target=
...
hed the requested command output on n310.<br></div><br><div class=3D"gmail_=
quote"><div dir=3D"ltr" class=3D"gmail_attr">On Tue, 15 Oct 2024 at 17:19, =
...
Content-Transfer-Encoding: base64
Content-ID: <f_m2am6lg44>
X-Attachment-Id: f_m2am6lg44
...
--000000000000f0f885062485d61c
Content-Type: text/plain; charset="US-ASCII"; name="uhd_usrp_probe_on_server.txt"
Content-Disposition: attachment; filename="uhd_usrp_probe_on_server.txt"
Content-Transfer-Encoding: base64
Content-ID: <f_m2am6lgb5>
X-Attachment-Id: f_m2am6lgb5


--000000000000f0f885062485d61c
