...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 1640C2D147B
	for <lists+usrp-users@lfdr.de>; Mon,  7 Dec 2020 16:13:30 +0100 (CET)
Received: from [::1] (port=36742 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1kmICc-0001SB-0z; Mon, 07 Dec 2020 10:13:26 -0500
Received: from mail-oi1-f169.google.com ([209.85.167.169]:44781)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <rkossler@nd.edu>) id 1kmICY-0001KV-QG
 for usrp-users@lists.ettus.com; Mon, 07 Dec 2020 10:13:22 -0500
Received: by mail-oi1-f169.google.com with SMTP id y74so15679566oia.11
 for <usrp-users@lists.ettus.com>; Mon, 07 Dec 2020 07:13:02 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nd.edu; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=3AMbUb1YVjy2aqWSX9fQhu2USu6WGgVjPeXZEd+gjP4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=3AMbUb1YVjy2aqWSX9fQhu2USu6WGgVjPeXZEd+gjP4=;
 b=
X-Gm-Message-State: AOAM530AB+8T4Qy1IVcQGDJVwa0FgT37M4CKSd5aIwyGXTNBycAgcwoa
 inhokJYELyk8D7xoML3EaS/5MXTf7eo9S+sBS8VUSg==
X-Google-Smtp-Source: ABdhPJxqk8EARP/uoQjahg8SQ8MVUtyqR0qQWNIuuSPi/vvmkLcC5bZRgNqJPnX+Agz5nR/XLewM8+Q6dMcNAYYksFA=
X-Received: by 2002:a05:6808:9a:: with SMTP id
 s26mr6737561oic.124.1607353961091; 
 Mon, 07 Dec 2020 07:12:41 -0800 (PST)
MIME-Version: 1.0
References: <trinity-a9e545d1-8706-4d8e-aeb5-1c2492fc8b6c-1606726945931@3c-app-gmx-bap15>
 ...
 <ef21b223-acaf-3375-7162-01634acda28f@comcast.net>
In-Reply-To: <ef21b223-acaf-3375-7162-01634acda28f@comcast.net>
Date: Mon, 7 Dec 2020 10:12:29 -0500
Message-ID: <CAB__hTQCZBixiFVHKc7VzatzQ2OsQYaV8Lz1-VeCZ1XC_PPHqw@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============5740783806114446533=="
...
--===============5740783806114446533==
Content-Type: multipart/related; boundary="000000000000e1e30105b5e141b3"

--000000000000e1e30105b5e141b3
Content-Type: multipart/alternative; boundary="000000000000e1e2ff05b5e141b2"

--000000000000e1e2ff05b5e141b2
...
<div dir=3D"ltr">Hi Lukas,<div>What bandwidths are you using for=C2=A0your =
transmission and reception?=C2=A0 The full 160 MHz Tx and Rx bandwidth?</di=
v><div>Rob</div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=
=3D"gmail_attr">On Mon, Dec 7, 2020 at 4:49 AM Ron Economos via USRP-users =
...
>
 ...
 =20
  <div>
    ...
    <p><a href=3D"https://training.ti.com/sites/default/files/docs/TIPL%204=
703%20-%20Understanding%20Signal%20to%20Noise%20Ratio%20and%20Noise%20Spect=
ral%20Density%20in%20High%20Speed%20Datat%20Converters_3.pdf" target=3D"_bl=
ank">https://training.ti.com/sites/default/files/docs/TIPL%204703%20-%20Und=
erstanding%20Signal%20to%20Noise%20Ratio%20and%20Noise%20Spectral%20Density=
%20in%20High%20Speed%20Datat%20Converters_3.pdf</a><br>
    </p>
    <p>Ron<br>
    </p>
    <div>On 12/7/20 00:33, Lukas Haase via
      USRP-users wrote:<br>
    </div>
      ...
      <div style=3D"font-family:Verdana;font-size:12px">
        ...
        <ul>
          ...
          <li>The receive gain is set to 20dB. Hence I assume I do not
            make use of the 6dB &quot;digital gain&quot; in the ADC and fro=
m the
            remaining 31.6dB gain I use 20. Hence I the &quot;digital
            attenuator&quot; should be 11.5dB if that answers your question=
?</li>
          <li>At a receive gain of 20dB, the noise figure is ~5dB,
            according to specs and measurements.
            -174+5+dB10(5e6)=3D-102dBm which is exactly what I measure
        ...
        <div>
          <div>
            ...
            <div>Lukas</div>
            <div>=C2=A0</div>
            <div name=3D"quote" style=3D"margin:10px 5px 5px 10px;padding:1=
0px 0px 10px 10px;border-left:2px solid rgb(195,217,229)">
              <div style=3D"margin:0px 0px 10px"><b>Gesendet:</b>=C2=A0Mont=
ag,
                07. Dezember 2020 um 03:23 Uhr<br>
                <b>Von:</b>=C2=A0&quot;cyberphox&quot; <a href=3D"mailto:cy=
berphox@gmail.com" target=3D"_blank">&lt;cyberphox@gmail.com&gt;</a><br>
                <b>An:</b>=C2=A0&quot;Lukas Haase&quot; <a href=3D"mailto:l=
ukashaase@gmx.at" target=3D"_blank">&lt;lukashaase@gmx.at&gt;</a><br>
                <b>Cc:</b>=C2=A0&quot;Marcus D. Leech&quot;
...
ank">USRP-users@lists.ettus.com</a><br>
                <b>Betreff:</b>=C2=A0Re: [USRP-users] UBX160 TX &quot;noise
                figure&quot;?</div>
              <div name=3D"quoted-content">
                ...
                <div>=C2=A0</div>
                <div>=C2=A0</div>
                <div>Kind=C2=A0regards</div>
                <div>=C2=A0</div>
                <div>Marino</div>
                <div>=C2=A0</div>
                <div>=C2=A0
                  <div class=3D"gmail_quote">
                    <div class=3D"gmail_attr">On Mon, 7 Dec 2020 at 02:05,
                      Lukas Haase via USRP-users &lt;<a href=3D"mailto:usrp=
                      ...
                      <div>
                        <div style=3D"font-family:Verdana;font-size:12px">
                          ...
                          <div>I did now the following experiment: I
                            ...
                            -3dBFS.</div>
                          <div>This means my output power is <strong>Pout=
=3D11.44dBm</strong>
                            (cross checked with spectrum analyzer) and
                            on RX I sould have Pin=3D-34.99dBm. Indeed,
                            calculating the RMS of the received signal
                            and converting to dBm, I get <strong>Pin=3D-35.=
0224dBm</strong>.
                            Spot on!</div>
                          <div>=C2=A0</div>
                          ...
                          <div>=C2=A0</div>
                          <div><img src=3D"cid:1763dc2027cf7606a2a1" style=
=3D"width: 560px; max-width: 100%;"></div>
                          <div>=C2=A0</div>
                          <div>As you can see from the annotation, the
                            measured &quot;SNR&quot; of the received signal=
 is
...
ong>
                          ...
                          <div>
                            ...
                            <div>PS: I am aware of phase noise, DC
                              ...
                              see from my plot, I am <em>only </em>consider=
ung
                              thermal noise. The thermal noise of the
                              receiver should be orders of magnitude
                              lower (at least -102dBm) so the receiver
                              noise should not limit the results either.</d=
iv>
                            <div>=C2=A0</div>
                            <div>=C2=A0
                              <div style=3D"margin:10px 5px 5px 10px;paddin=
g:10px 0px 10px 10px;border-left:2px solid rgb(195,217,229)">
                                <div style=3D"margin:0px 0px 10px"><b>Gesen=
det:</b>=C2=A0Montag,
                                  30. November 2020 um 17:08 Uhr<br>
                                  <b>Von:</b>=C2=A0&quot;Marcus D. Leech&qu=
ot; &lt;<a href=3D"mailto:patchvonbraun@gmail.com" target=3D"_blank">patchv=
onbraun@gmail.com</a>&gt;</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div style=3D"font-family:Verdana;font-size:12px">
                          <div>
                            <div>
                              <div style=3D"margin:10px 5px 5px 10px;paddin=
g:10px 0px 10px 10px;border-left:2px solid rgb(195,217,229)">
                                <div style=3D"margin:0px 0px 10px"><br>
                                  <b>An:</b>=C2=A0&quot;Lukas Haase&quot; &=
lt;<a href=3D"mailto:lukashaase@gmx.at" target=3D"_blank">lukashaase@gmx.at=
</a>&gt;<br>
                                  <b>Cc:</b>=C2=A0<a href=3D"mailto:USRP-us=
ers@lists.ettus.com" target=3D"_blank">USRP-users@lists.ettus.com</a><br>
                                  <b>Betreff:</b>=C2=A0Re: [USRP-users]
                                  UBX160 TX &quot;noise figure&quot;?</div>
                                <div>
                                  <div style=3D"background-color:rgb(255,25=
5,255)">
                                    <div>On 11/30/2020 01:54 PM, Lukas
                                      Haase wrote:</div>
                                    <blockquote>
                                      <div style=3D"font-family:Verdana;fon=
t-size:12px">
                                        <div>Hi Marcus,</div>
                                        <div>=C2=A0</div>
...
>
                                        ...
                                        <div>Would you be willing to
                                          ...
                                          here is correct?</div>
                                        <div>=C2=A0</div>
                                        <div><img src=3D"cid:1763dc2027c710=
f08902" style=3D"width: 702px; max-width: 100%;"></div>
                                        <div>
                                          <div>=C2=A0</div>
                                          ...
                                          <div>=C2=A0</div>
                                          <div><img src=3D"cid:1763dc2027ce=
d1b66bf3" style=3D"width: 505px; max-width: 100%;"></div>
                                          <div>=C2=A0</div>
                                          <div>=C2=A0</div>
                                        </div>
                                      </div>
                                    ...
                                    value--similarly for the filter.=C2=A0
                                    Just pretend it&#39;s a fixed attenuato=
r
                                    with 0 gain.<br>
                                    <br>
                                    So the &#39;noise figure&#39; after the=
 DAC
                                    is just=C2=A0 2+(31.5 - TXGAIN) then
...
listinfo/usrp-users_lists.ettus.com</a></blockquote>
                  </div>
                </div>
              </div>
            </div>
...
--000000000000e1e2ff05b5e141b2--
--000000000000e1e30105b5e141b3
Content-Type: image/png; name="pdkeomomjiambgnc.png"
Content-Disposition: inline; filename="pdkeomomjiambgnc.png"
Content-Transfer-Encoding: base64
Content-ID: <1763dc2027cf7606a2a1>
X-Attachment-Id: 1763dc2027cf7606a2a1
...
--000000000000e1e30105b5e141b3
Content-Type: image/png; name="mcpiolcmkfcibblj.png"
Content-Disposition: inline; filename="mcpiolcmkfcibblj.png"
Content-Transfer-Encoding: base64
Content-ID: <1763dc2027c710f08902>
X-Attachment-Id: 1763dc2027c710f08902
...
--000000000000e1e30105b5e141b3
Content-Type: image/png; name="pjmkopklffiinfoa.png"
Content-Disposition: inline; filename="pjmkopklffiinfoa.png"
Content-Transfer-Encoding: base64
Content-ID: <1763dc2027ced1b66bf3>
X-Attachment-Id: 1763dc2027ced1b66bf3
