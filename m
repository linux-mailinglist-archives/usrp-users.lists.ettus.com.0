...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 95052752BAF
	for <lists+usrp-users@lfdr.de>; Thu, 13 Jul 2023 22:32:10 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 90527383C88
	for <lists+usrp-users@lfdr.de>; Thu, 13 Jul 2023 16:32:09 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1689280329; bh=yf1s8LEBomdSrIFMeK6q3ZfGjfwkAnO76/5XKotYFOw=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-oa1-f45.google.com (mail-oa1-f45.google.com [209.85.160.45])
	by mm2.emwd.com (Postfix) with ESMTPS id CF34B380A0C
	for <usrp-users@lists.ettus.com>; Thu, 13 Jul 2023 16:31:27 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="N1+xI68J";
	dkim-atps=neutral
Received: by mail-oa1-f45.google.com with SMTP id 586e51a60fabf-1b038d7a5faso899545fac.1
        for <usrp-users@lists.ettus.com>; Thu, 13 Jul 2023 13:31:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1689280287; x=1691872287;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=fp8gt0+OkVPqiQaZGpNOMXQp6aJITJbpkefeLOWHS5M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689280287; x=1691872287;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=fp8gt0+OkVPqiQaZGpNOMXQp6aJITJbpkefeLOWHS5M=;
        b=
X-Gm-Message-State: ABy/qLaAg1/3clvW7Hqxz+m8k30xdbdapssVN7mKAD+INB0jRxR7ky7x
	eAKoXFCDo1cXrsvu4r80bV2HI3SEHF0=
X-Google-Smtp-Source: APBJJlHCBu6LEBq9xSZrw+57Mf9du1J+d3BczPAIk20okU5EC0jA7BulYBtD0dL4dpnUqeEIIVhKVw==
X-Received: by 2002:a05:6870:b52a:b0:1b7:27fd:cfff with SMTP id v42-20020a056870b52a00b001b727fdcfffmr3412740oap.21.1689280286600;
        Thu, 13 Jul 2023 13:31:26 -0700 (PDT)
Received: from [192.168.2.196] (bras-base-smflon1825w-grc-09-174-93-2-82.dsl.bell.ca. [174.93.2.82])
        by smtp.googlemail.com with ESMTPSA id f23-20020a0caa97000000b006300722883fsm3388846qvb.33.2023.07.13.13.31.25
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 13 Jul 2023 13:31:26 -0700 (PDT)
Message-ID: <73784b4d-9654-5442-cd14-e7f5e1d88bdd@gmail.com>
Date: Thu, 13 Jul 2023 16:31:25 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAOkUcSs98YQgB=gV9jTrasLiUyCU2BR8R816t8=cOdqGYWfZMw@mail.gmail.com>
Message-ID-Hash: U4PTA5UARMENKUYXPOARW3HKVG7TRKR2
X-Message-ID-Hash: U4PTA5UARMENKUYXPOARW3HKVG7TRKR2
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/U4PTA5UARMENKUYXPOARW3HKVG7TRKR2/>
...
Content-Type: multipart/mixed; boundary="===============1590761060229455645=="

This is a multi-part message in MIME format.
--===============1590761060229455645==
Content-Type: multipart/alternative;
 boundary="------------fq6gZG9f0D4pLFGrzdvZ7vnz"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------fq6gZG9f0D4pLFGrzdvZ7vnz
...
>
> Marino
I was confused by the block-diagram for the 2974, which swaps the usual=20
nomenclature for the SFP0/SFP1 ports on the
 =C2=A0 X310.=C2=A0 It all makes sense now.=C2=A0 Yes, the port you're tr=
ying to reach=20
should be 192.168.40.2 using the default HG image
 =C2=A0 on the X310 component.
>
> On Thu, 13 Jul 2023 at 20:52, Marcus D. Leech=20
> <patchvonbraun@gmail.com> wrote:
>
>     On 13/07/2023 15:39, cyberphox wrote:
>>     Hi Marcus,
>>
>>     We are doing this from the embedded host PC, not from the 10G
>>     connection externally
>>
>>     Thank you
>>
>     I believe that only HG-type images are supported on the built-in
>     X310, in which case the standard IP address for
...
>
>     I don't actually have an 2974, so I'm going by datasheets of the
>     i7 SOM that's on-board, and what I know about the
>     =C2=A0 X310.
>
>
>
...
>>>         Hi all,
>>>
>>>         I have a USRP where I have a problem accessing the FPGA to
>>>         program it. Normally we use image loader like so:
>>>         uhd_image_loader --args=3D"type=3Dx300,addr=3D192.168.40.2"
...
>>>         192.168.40.2, which probably explains why the image loader
>>>         has a problem, in fact so does the usrp probe tool.=C2=A0
>>>         =C2=A0Normally all i need is to get enp1s0f0 showing up with =
IFCONFIG
>>>
>>>
>>>         image.png
...
om
>>         To clarify, are you doing this from your own host, over the
>>         10G interface, or from the embedded X86 host that's part of th=
e
>>         =C2=A0 2974?
>>
>>
...
Content-Type: multipart/related;
 boundary="------------jMdVDBh3fRdadgwNMl8wMEAq"

--------------jMdVDBh3fRdadgwNMl8wMEAq
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 13/07/2023 15:56, cyberphox wrote:<=
br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAOkUcSs98YQgB=3DgV9jTrasLiUyCU2BR8R816t8=3DcOdqGYWfZMw@mail.=
gmail.com">
...
>
    ...
    =C2=A0 X310.=C2=A0 It all makes sense now.=C2=A0 Yes, the port you're=
 trying to
    reach should be 192.168.40.2 using the default HG image<br>
    =C2=A0 on the X310 component.<br>
    <blockquote type=3D"cite"
cite=3D"mid:CAOkUcSs98YQgB=3DgV9jTrasLiUyCU2BR8R816t8=3DcOdqGYWfZMw@mail.=
gmail.com">
      <div><br>
          ...
          <blockquote class=3D"gmail_quote" style=3D"margin:0 0 0
            ...
            <div>
              ...
              <blockquote type=3D"cite">
                ...
                <div dir=3D"auto">We are doing this from the embedded hos=
t
...
>
              =C2=A0=C2=A0 SFP0 on the X310 component would be 192.168.10=
.2, NOT
              192.268.40.2.=C2=A0=C2=A0 But if you're running your own<br=
>
              =C2=A0=C2=A0 images, I can't say how it would be setup.<br>
              <br>
              I don't actually have an 2974, so I'm going by datasheets
              of the i7 SOM that's on-board, and what I know about the<br=
>
              =C2=A0 X310.</div>
            <div><br>
              <br>
                ...
                <div><br>
                  <div class=3D"gmail_quote">
                    <div dir=3D"ltr" class=3D"gmail_attr">On Thu, 13 Jul
                      2023 at 19:17, Marcus D. Leech &lt;<a
                        href=3D"mailto:patchvonbraun@gmail.com"
                      ...
                      <div>
                        <blockquote type=3D"cite">
                          <div dir=3D"ltr">Hi all,
                            ...
                            <div><span dir=3D"ltr"><font face=3D"monospac=
e">uhd_image_loader
                                  --args=3D"type=3Dx300,addr=3D192.168.40=
.2"
                                  --fpga-path=3D"AnFpgaImage.bit"</font><=
/span><br>
                            </div>
                            <div><br>
                            </div>
...
><font
                                  face=3D"monospace">sudo ifconfig
                                  enp1s0f0 192.168.40.1 netmask
                                  255.255.255.0</font></p>
                              <p class=3D"MsoNormal"
                                style=3D"margin:0cm;font-size:11pt;font-f=
amily:Calibri,sans-serif"><br>
                              </p>
                              <p class=3D"MsoNormal"
                                style=3D"margin:0cm;font-size:11pt;font-f=
amily:Calibri,sans-serif">Once
                                ...
                                tool.=C2=A0 =C2=A0Normally all i need is =
to get
                                enp1s0f0 showing up with IFCONFIG</p>
                              <br>
                            </div>
                            <div><img
                                src=3D"cid:part1.7Qa5uXgK.smy9vRR2@gmail.=
com"
                                alt=3D"image.png"
                                style=3D"width:812px;max-width:100%"
                                class=3D""><br>
                            </div>
                            <div><br>
                            </div>
...
Content-Id: <part1.7Qa5uXgK.smy9vRR2@gmail.com>
