...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 32FEA752A3F
	for <lists+usrp-users@lfdr.de>; Thu, 13 Jul 2023 20:17:07 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 2E643384AE1
	for <lists+usrp-users@lfdr.de>; Thu, 13 Jul 2023 14:17:06 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1689272226; bh=UdOi78L6lu6Gie/r+Qb2PQAK5sli+A5N1FbnrTL6jNk=;
	h=Date:To:References:From:In-Reply-To:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=
Received: from mail-qk1-f171.google.com (mail-qk1-f171.google.com [209.85.222.171])
	by mm2.emwd.com (Postfix) with ESMTPS id 0444F384092
	for <usrp-users@lists.ettus.com>; Thu, 13 Jul 2023 14:16:48 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="DIZsoKRz";
	dkim-atps=neutral
Received: by mail-qk1-f171.google.com with SMTP id af79cd13be357-76772fde287so98444785a.2
        for <usrp-users@lists.ettus.com>; Thu, 13 Jul 2023 11:16:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1689272208; x=1691864208;
        h=in-reply-to:from:references:to:content-language:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=aC3VpXeSxo3IDSrrPUQJ8+LDKx0g+FpR2CRp5jJTcKI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689272208; x=1691864208;
        h=in-reply-to:from:references:to:content-language:subject:user-agent
         :mime-version:date:message-id:x-gm-message-state:from:to:cc:subject
         :date:message-id:reply-to;
        bh=aC3VpXeSxo3IDSrrPUQJ8+LDKx0g+FpR2CRp5jJTcKI=;
        b=
X-Gm-Message-State: ABy/qLbI0ZvUTi9k09+be9/XWHd2ybBBDwnh9WM2X/OXdkvAC3dDcxJT
	VpOHt29kHW/bCVx45rWSAa3ROoHpBjM=
X-Google-Smtp-Source: APBJJlFQKigAWZo6KSdd2gw+wb9N/C7BNNE5/sSXRqxPMT2VqcMrBzS4nKcObdKi9VXe6HTMyMegng==
X-Received: by 2002:a05:620a:40cc:b0:767:9a35:73c7 with SMTP id g12-20020a05620a40cc00b007679a3573c7mr3352704qko.42.1689272207892;
        Thu, 13 Jul 2023 11:16:47 -0700 (PDT)
Received: from [192.168.2.196] ([174.93.2.82])
        by smtp.googlemail.com with ESMTPSA id p13-20020ae9f30d000000b007675bef6b0dsm3072461qkg.118.2023.07.13.11.16.47
        for <usrp-users@lists.ettus.com>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 13 Jul 2023 11:16:47 -0700 (PDT)
Message-ID: <c643ce57-4395-21c6-fe5b-3fbb14ad00c9@gmail.com>
Date: Thu, 13 Jul 2023 14:16:38 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAOkUcSviKSko5fQu-TvQrANqYqVM5-N7_TTtTuBoGu+27tmKPA@mail.gmail.com>
Message-ID-Hash: GI7O6WACR457V3ZDZ2JMQIQQDOQD2Q4V
X-Message-ID-Hash: GI7O6WACR457V3ZDZ2JMQIQQDOQD2Q4V
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/GI7O6WACR457V3ZDZ2JMQIQQDOQD2Q4V/>
...
Content-Type: multipart/mixed; boundary="===============7821336971332692443=="

This is a multi-part message in MIME format.
--===============7821336971332692443==
Content-Type: multipart/alternative;
 boundary="------------L2mjuTlXUGv70hrSFERR5jQ9"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------L2mjuTlXUGv70hrSFERR5jQ9
...
> Hi all,
>
> I have a USRP where I have a problem accessing the FPGA to program=20
> it.=C2=A0 Normally we use image loader like so:
> uhd_image_loader --args=3D"type=3Dx300,addr=3D192.168.40.2"=20
...
>
>
> Once enp1s0f0 is up, I still am not able to ping 192.168.40.2, which=20
> probably explains why the image loader has a problem, in fact so does=20
> the usrp probe tool.=C2=A0 =C2=A0Normally all i need is to get enp1s0f0=
 showing=20
> up with IFCONFIG
>
>
...
To clarify, are you doing this from your own host, over the 10G=20
...
Content-Type: multipart/related;
 boundary="------------0P1K6ad6iIwK3FgJnkCOrHkR"

--------------0P1K6ad6iIwK3FgJnkCOrHkR
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 13/07/2023 13:20, cyberphox wrote:<=
br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAOkUcSviKSko5fQu-TvQrANqYqVM5-N7_TTtTuBoGu+27tmKPA@mail.gmai=
l.com">
...
TF-8">
      <div dir=3D"ltr">Hi all,
        ...
        <div><span class=3D"gmail-ui-provider gmail-bdp gmail-bdq gmail-c
            gmail-d gmail-e gmail-f gmail-g gmail-h gmail-i gmail-j
            gmail-k gmail-l gmail-m gmail-n gmail-o gmail-p gmail-q
            gmail-r gmail-s gmail-t gmail-bdr gmail-bds gmail-w gmail-x
            gmail-y gmail-z gmail-ab gmail-ac gmail-ae gmail-af gmail-ag
            gmail-ah gmail-ai gmail-aj gmail-ak" dir=3D"ltr"><font
              face=3D"monospace">uhd_image_loader
        ...
        <div>
          <p class=3D"MsoNormal" style=3D"margin:0cm"><font style=3D""
              face=3D"monospace">sudo ifconfig enp1s0f0 192.168.40.1
              netmask 255.255.255.0</font></p>
          <p class=3D"MsoNormal"
            style=3D"margin:0cm;font-size:11pt;font-family:Calibri,sans-s=
erif"><br>
          </p>
          <p class=3D"MsoNormal"
            style=3D"margin:0cm;font-size:11pt;font-family:Calibri,sans-s=
erif">Once
            ...
            in fact so does the usrp probe tool.=C2=A0 =C2=A0Normally all=
 i need
            is to get enp1s0f0 showing up with IFCONFIG</p>
          <br>
        </div>
        <div><img src=3D"cid:part1.0Vgs8nhT.857Bp0Mk@gmail.com"
            alt=3D"image.png" class=3D"" width=3D"542" height=3D"450"><br=
>
        </div>
        <div><br>
        </div>
...
Content-Id: <part1.0Vgs8nhT.857Bp0Mk@gmail.com>
