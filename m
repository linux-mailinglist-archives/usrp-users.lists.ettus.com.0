...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 57A441948F
	for <lists+usrp-users@lfdr.de>; Thu,  9 May 2019 23:23:55 +0200 (CEST)
Received: from [::1] (port=39372 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.91)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1hOqW7-0007Yo-K0; Thu, 09 May 2019 17:23:51 -0400
Received: from atl4mhob21.registeredsite.com ([209.17.115.115]:57072)
 by mm2.emwd.com with esmtp (Exim 4.91)
 (envelope-from <k5so@k5so.com>) id 1hOqVZ-0007LP-81
 for usrp-users@lists.ettus.com; Thu, 09 May 2019 17:23:47 -0400
Received: from mailpod.hostingplatform.com
 (atl4qobmail02pod3.registeredsite.com [10.30.77.68])
 by atl4mhob21.registeredsite.com (8.14.4/8.14.4) with ESMTP id x49LMYs9026538
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL)
 for <usrp-users@lists.ettus.com>; Thu, 9 May 2019 17:22:34 -0400
Received: (qmail 22019 invoked by uid 0); 9 May 2019 21:22:34 -0000
...
Received: from unknown (HELO ?192.168.1.76?) (k5so@k5so.com@192.206.203.10)
 by 0 with ESMTPA; 9 May 2019 21:22:34 -0000
Message-Id: <31E31040-1F5D-4C84-BD3B-65CC609519A9@k5so.com>
Mime-Version: 1.0 (Mac OS X Mail 11.5 \(3445.9.1\))
Date: Thu, 9 May 2019 15:22:32 -0600
In-Reply-To: <CA+JMMq_h4jKhUH7d6_WiMCstfC8anxeamESGAQ7Q=YLaaKG59A@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============3894446368306687845=="
...
Content-Type: multipart/alternative;
	boundary="Apple-Mail=_D6D155F2-3DCC-4958-81F6-C82E9FD031D8"


--Apple-Mail=_D6D155F2-3DCC-4958-81F6-C82E9FD031D8
...
so I=E2=80=99m asking to determine whether continued effort to do so is =
likely to yield anything positive with respect to interfacing with the =
2011 hardware. =20
...
>>> Nick, Ian,=20
>>>=20
>>> If this unit happens to be incorrectly labeled as a rev 2 N210 and =
it is actually a rev 3 N210, is there hope in being able to load rev 3 =
...
class=3D"">Thanks for digging into that for us, Nick. &nbsp;Interesting. =
&nbsp;As the hardware change to rev4 occurred around mid 2011 and the =
earliest UHD version that exists on the <a =
href=3D"http://files.ettus.com/uhd" =
...
class=3D"">On May 9, 2019, at 3:06 PM, Nick Foster &lt;<a =
href=3D"mailto:bistromath@gmail.com" =
class=3D"">bistromath@gmail.com</a>&gt; wrote:</div><br =
class=3D"Apple-interchange-newline"><div class=3D""><div dir=3D"ltr" =
class=3D""><div class=3D"">So I really dug into the old archives here =
and literally pulled an old hard drive out of a closet, and found a copy =
of the old hardware repository from back in the days when N210 was =
called "USRP2+". Best that I can tell, we only ever released two =
versions to the public. We might have sold R3 stickered as R2 -- I don't =
see anything in the repository that would indicate otherwise. Rev 2/3 =
was sold until around June or July 2011, when we moved to rev 4. The =
only firmware/host code changes I can see between any of the versions =
are that R4 used LVDS clocking to the daughterboard where previous =
versions used CMOS. So I think you should be able to run r3 firmware on =
your N210.</div><div class=3D""><br class=3D""></div><div class=3D"">That =
said, the very very old N210s with very very old firmware might not have =
used the same safe/production firmware/fpga image arrangement that we =
later arrived at. The hardware is still fine, but you might be in for a =
bit of a deep dive to get it all running again.</div><div class=3D""><br =
class=3D""></div><div class=3D"">If you have a TTL-serial adapter or a =
logic analyzer that works as such, you can connect to the debug UART =
header and get printout information from the firmware at boot time. =
Another good idea would be to take a video of the front panel LEDs as =
you apply power -- the boot LED lights give good indication of the =
firmware/FPGA image loading process.<br class=3D""></div><div =
class=3D""><br class=3D""></div><div class=3D"">Nick<br =
class=3D""></div></div><br class=3D""><div class=3D"gmail_quote"><div =
dir=3D"ltr" class=3D"gmail_attr">On Thu, May 9, 2019 at 1:42 PM Joe =
...
break-word;" class=3D"">Thanks for the info, Marcus.&nbsp; However, =
seeing that Jason went through this last year with a couple of N210 he =
has it would seem unlikely that all three of the N210 are broken.&nbsp; =
That being said and considering what you jus said it seems that I =
should=E2=80=99ve been able to find some version of UHD that will =
...
class=3D"gmail-m_3428410372027926386Apple-interchange-newline"><div =
class=3D"">
 =20
   =20
 =20
  <div bgcolor=3D"#FFFFFF" class=3D"">
    <div class=3D"gmail-m_3428410372027926386moz-cite-prefix">On =
05/09/2019 04:18 PM, Joe Martin via
...
class=3D"">
 ...
 target=3D"_blank" class=3D"">usrp-users@lists.ettus.com</a>&gt;
              wrote:</div>
            <br =
class=3D"gmail-m_3428410372027926386Apple-interchange-newline">
            <div class=3D"">
             =20
              <div style=3D"overflow-wrap: break-word;" class=3D"">Okay.
...
href=3D"mailto:k5so@k5so.com" target=3D"_blank" =
...
class=3D"">k5so@k5so.com</a>&gt;
                                    wrote:</div>
                                  <br =
class=3D"gmail-m_3428410372027926386gmail-m_-2513206580084366361Apple-inte=
rchange-newline">
                                  <div class=3D"">
                                    <div class=3D"">Ian,&nbsp;
                                      <div class=3D""><br class=3D"">
...
<a class=3D"gmail-m_3428410372027926386moz-txt-link-freetext" =
href=3D"http://lists.ettus.com/mailman/listinfo/usrp-users_lists.ettus.com=
" =
target=3D"_blank">http://lists.ettus.com/mailman/listinfo/usrp-users_lists=
.ettus.com</a><br class=3D"">
            </div>
          </blockquote>
        </div>
        <br class=3D"">
      ...
      <br class=3D"">
      <fieldset =
class=3D"gmail-m_3428410372027926386mimeAttachmentHeader"></fieldset>
      <br class=3D"">
      <pre class=3D"">_______________________________________________
USRP-users mailing list
<a class=3D"gmail-m_3428410372027926386moz-txt-link-abbreviated" =
