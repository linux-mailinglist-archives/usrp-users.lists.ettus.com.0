...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BDCC3BEAA2
	for <lists+usrp-users@lfdr.de>; Wed,  7 Jul 2021 17:23:46 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 57698385283
	for <lists+usrp-users@lfdr.de>; Wed,  7 Jul 2021 11:23:45 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="ZRUd2HkP";
	dkim-atps=neutral
Received: from mail-qk1-f175.google.com (mail-qk1-f175.google.com [209.85.222.175])
	by mm2.emwd.com (Postfix) with ESMTPS id A5C33380F5F
	for <usrp-users@lists.ettus.com>; Wed,  7 Jul 2021 11:22:57 -0400 (EDT)
Received: by mail-qk1-f175.google.com with SMTP id j13so2291209qka.8
        for <usrp-users@lists.ettus.com>; Wed, 07 Jul 2021 08:22:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=message-id:date:from:user-agent:mime-version:to:cc:subject
         :references:in-reply-to;
        bh=upsxhkLfCPVSO2nHI9kzh/YzLmbAKxHsAYUVj9sfiss=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=upsxhkLfCPVSO2nHI9kzh/YzLmbAKxHsAYUVj9sfiss=;
        b=
X-Gm-Message-State: AOAM532xtjyUJdGYNu+c8FcZzehMAYU8puBbvHNYn6vQGunKZmQewy2m
	JtApP4ZKpMHnJ5+QIBxoLffherXBNiagDQ==
X-Google-Smtp-Source: ABdhPJxpfXu8B9uua340AgY7RB34gSnQj3LotSRM24fXyIjs5vE725agvuFVgaKTj809b10RZmozFg==
X-Received: by 2002:a37:bcc5:: with SMTP id m188mr18478925qkf.88.1625671377055;
        Wed, 07 Jul 2021 08:22:57 -0700 (PDT)
Received: from [192.168.2.12] (bras-base-smflon1825w-grc-18-76-67-104-5.dsl.bell.ca. [76.67.104.5])
        by smtp.googlemail.com with ESMTPSA id e12sm6960374qtj.3.2021.07.07.08.22.56
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Wed, 07 Jul 2021 08:22:56 -0700 (PDT)
Message-ID: <60E5C6CF.6020301@gmail.com>
Date: Wed, 07 Jul 2021 11:22:55 -0400
From: "Marcus D. Leech" <patchvonbraun@gmail.com>
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:31.0) Gecko/20100101 Thunderbird/31.7.0
MIME-Version: 1.0
To: Armin Ghani <aghani@cttc.es>
References: <2547566f-fdc2-8dfc-6ef0-198de1a1f578@cttc.es> <60E5BB23.7000305@gmail.com> <f135fa58-cfed-d47d-f174-56bbf4e0a693@cttc.es> <60E5BD7E.4050700@gmail.com> <388790a8-f51f-c045-0a7e-49fb88c18465@cttc.es> <60E5C54B.9070501@gmail.com> <9d3b17e9-5cfe-62d5-8f81-9946134d6de9@cttc.es>
In-Reply-To: <9d3b17e9-5cfe-62d5-8f81-9946134d6de9@cttc.es>
Message-ID-Hash: 6DC47URW4NP4EIGFW232XEBIVHVKA52G
X-Message-ID-Hash: 6DC47URW4NP4EIGFW232XEBIVHVKA52G
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/6DC47URW4NP4EIGFW232XEBIVHVKA52G/>
...
Content-Type: multipart/mixed; boundary="===============2538150332487468346=="

This is a multi-part message in MIME format.
--===============2538150332487468346==
Content-Type: multipart/alternative;
 boundary="------------090309080906080002080402"

This is a multi-part message in MIME format.
--------------090309080906080002080402
Content-Type: text/plain; charset=windows-1252; format=flowed
Content-Transfer-Encoding: quoted-printable

On 07/07/2021 11:19 AM, Armin Ghani wrote:
>
> I checked the signals at the cable end which attached to the USRP=20
> input reference.
>
> And all the cables are the same part number with same cable length. Is=20
> there anything else to check?
>
Check each X310 individually to see if this affects only a single X310=20
reference input or all of them.

If all then there's a clock-quality issue.  Like I mentioned the REF OUT=20
capability on the X310 as never, as far as I recall,
   fully-developed.
...
>>>>>>> rerefence and three distributed output references (both 10MHz=20
>>>>>>> and PPS) are fed to the three USRPs (including the USRP which=20
>>>>>>> provide reference source to the octoclock)
>>>>>>>
>>>>>>> Attached you can find the flowgraph in GNURadio to run a very=20
>>>>>>> simple system in order to evaluate the results. You can find=20
>>>>>>> more details of how UHD source and sink blocks are configured.=20
>>>>>>> In summary, for the UHD sink block, clock and time references=20
>>>>>>> are set to internal and default respectively. And UHD source=20
>>>>>>> block are configured as multi-usrp config with clock and time=20
>>>>>>> sources for both motherboards to the external.
>>>>>>>
>>>>>>> GNURadio v3.8.2.0 and UHD v3.15.0.0 are used.
>>>>>>>
>>>>>>> When I run the flowgraph, after UHD initialization for all=20
>>>>>>> USRPs, the running system ends up with the folowing output in=20
>>>>>>> console:
>>>>>>>
...
>>>>>>> performance, but your configuration will only allow 1472.This=20
...
>>>>>>> source, mboard)
>>>>>>>
>>>>>>> RuntimeError: RuntimeError: Reference Clock PLL failed to lock=20
>>>>>>> to external source.
>>>>>>>
>>>>>>>
>>>>>>> --=20
...
>>>>>> the reference is actually producing a 10MHz clock.  My recollectio=
n
...
Content-Type: multipart/related;
 boundary="------------090803090903010407070004"


--------------090803090903010407070004
...
<html>
  ...
  <body bgcolor=3D"#FFFFFF" text=3D"#000000">
    ...
    <blockquote cite=3D"mid:9d3b17e9-5cfe-62d5-8f81-9946134d6de9@cttc.es"
      type=3D"cite">
    ...
    <br>
    If all then there's a clock-quality issue.=A0 Like I mentioned the RE=
F
    OUT capability on the X310 as never, as far as I recall,<br>
    =A0 fully-developed.<br>
    <br>
    <br>
    <blockquote cite=3D"mid:9d3b17e9-5cfe-62d5-8f81-9946134d6de9@cttc.es"
      type=3D"cite">
      ...
      <blockquote type=3D"cite" cite=3D"mid:60E5C54B.9070501@gmail.com">
        <meta content=3D"text/html; charset=3Dwindows-1252"
          http-equiv=3D"Content-Type">
        <div class=3D"moz-cite-prefix">On 07/07/2021 11:14 AM, Armin Ghan=
i
          wrote:<br>
        </div>
        <blockquote
        ...
        <blockquote
          ...
          <blockquote type=3D"cite" cite=3D"mid:60E5BD7E.4050700@gmail.co=
m">
            <meta content=3D"text/html; charset=3Dwindows-1252"
              http-equiv=3D"Content-Type">
            ...
            =A0 (maybe I'm wrong) that later FPGA releases ended up
            turning it off.=A0 <br>
            <br>
            So the next thing to check is that 10MHz and 1PPS are
            actually making it out of your octoclock (with a scope) when
            things are<br>
            ...
            <blockquote
              ...
              <blockquote type=3D"cite"
                ...
                <blockquote
                  cite=3D"mid:2547566f-fdc2-8dfc-6ef0-198de1a1f578@cttc.e=
s"
                  type=3D"cite">
                  <meta http-equiv=3D"content-type" content=3D"text/html;
                    charset=3Dwindows-1252">
                  ...
                  <p>I'm trying to build a synchronouse system which has
                    2 receiver and one transmitter and Octoclock
                    CDA-2990 is used to synch both clock and time of all
                    USRPs.</p>
                  <p>Since the octoclock doesnt provide reference
                    ...
                    three distributed output references (both 10MHz and
                    PPS) are fed to the three USRPs (including the USRP
...
>
                  ...
                  recommends a send frame size of at least 4000 for best<=
br>
...
br>
                  ...
                  ID: 0xF1F0D00000000000)<a
                    class=3D"moz-txt-link-freetext"
                    href=3D"https://www.radio-astronomy.org/"
                    moz-do-not-send=3D"true">https://www.radio-astronomy.=
org/</a><br>
...
br>
                  =A0 File
                  "/usr/local/lib/python3/dist-packages/gnuradio/uhd/uhd_=
swig.py",
	...
	{page:WordSection1;}</style> </p>
                    <p class=3D"MsoNormal"
                      style=3D"margin-bottom:0in;line-height:normal"><img
                        src=3D"cid:part2.09050804.01040908@gmail.com"
                        class=3D"" align=3D"left" height=3D"100" hspace=3D=
"12"
                        width=3D"151"><span
                    ...
                    <p class=3D"MsoNormal"
                      style=3D"margin-bottom:0in;line-height:normal"><a
                        ...
                        href=3D"mailto:aghani@cttc.es"><span
                          style=3D"font-size:9.0pt;font-family:&quot;Aria=
l
                          Black&quot;,sans-serif;
                          mso-bidi-font-family:Aharoni">aghani@cttc.es</s=
pan></a><span
                        style=3D"font-size: 9.0pt;font-family:&quot;Arial
...
n
                        style=3D"font-size:9.0pt;font-family:&quot;Arial
                        Black&quot;,sans-serif;mso-bidi-font-family:
                        Aharoni">Centre Tecnol=F2gic de Telecomunicacions
                        de Catalunya (CTTC)</span></p>
                    <p class=3D"MsoNormal"
                      style=3D"margin-bottom:0in;line-height:normal"><spa=
n
                        style=3D"font-size:9.0pt;font-family:&quot;Arial
...
l
                          Black&quot;,sans-serif;
                          mso-bidi-font-family:Aharoni;mso-ansi-language:=
ES"
                  ...
                  <br>
                  <pre wrap=3D"">________________________________________=
_______
...
rp-users-leave@lists.ettus.com</a>
                ...
                <br>
                <fieldset class=3D"mimeAttachmentHeader"></fieldset>
                <pre class=3D"moz-quote-pre" wrap=3D"">__________________=
...
rmal
	...
	{page:WordSection1;}</style> </p>
                <p class=3D"MsoNormal"
                  style=3D"margin-bottom:0in;line-height:normal"><img
                    src=3D"cid:part2.09050804.01040908@gmail.com" class=3D=
""
...
rmal
	...
	{page:WordSection1;}</style> </p>
        <p class=3D"MsoNormal"
          style=3D"margin-bottom:0in;line-height:normal"><img
            src=3D"cid:part15.08020503.04050703@gmail.com" align=3D"left"
...
Content-ID: <part2.09050804.01040908@gmail.com>
...
Content-Transfer-Encoding: base64
Content-ID: <part15.08020503.04050703@gmail.com>
