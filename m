...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 25D6B45DE16
	for <lists+usrp-users@lfdr.de>; Thu, 25 Nov 2021 16:55:29 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 5EB8138422C
	for <lists+usrp-users@lfdr.de>; Thu, 25 Nov 2021 10:55:28 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=g-clemson-edu.20210112.gappssmtp.com header.i=@g-clemson-edu.20210112.gappssmtp.com header.b="n8QN7cPX";
	dkim-atps=neutral
Received: from mail-io1-f48.google.com (mail-io1-f48.google.com [209.85.166.48])
	by mm2.emwd.com (Postfix) with ESMTPS id E6DCA3841F5
	for <usrp-users@lists.ettus.com>; Thu, 25 Nov 2021 10:54:24 -0500 (EST)
Received: by mail-io1-f48.google.com with SMTP id v23so8024740iom.12
        for <usrp-users@lists.ettus.com>; Thu, 25 Nov 2021 07:54:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=g-clemson-edu.20210112.gappssmtp.com; s=20210112;
        h=mime-version:from:date:message-id:subject:to;
        bh=DbkiaRezzCECoindkMoL55v2J12v1vk3AzFbXVBph1w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to;
        bh=DbkiaRezzCECoindkMoL55v2J12v1vk3AzFbXVBph1w=;
        b=
X-Gm-Message-State: AOAM530l39ADDRgFZ5I4TYeMAGGhG6E6226BhuB2i7s5H1Ndhyc+n0aD
	Ql1UbaXKwvjM8++U7wuUztyryg5cB+JEmpHsER+C/p4wTFRpWYIl
X-Google-Smtp-Source: ABdhPJxF0RWltRrReuQA45jigCYJLfcw+67o1pKvCTC6HfS5WLGVVO5hQSO+bwBOQr/yJvm4/AVx3iZ9lEjBGHAaHMg=
X-Received: by 2002:a02:a91a:: with SMTP id n26mr29639431jam.46.1637855663083;
 Thu, 25 Nov 2021 07:54:23 -0800 (PST)
MIME-Version: 1.0
From: ChunChih Lin <chunchi@g.clemson.edu>
Date: Thu, 25 Nov 2021 10:54:13 -0500
Message-ID: <CAJ49BKjeiaLeK9-BqH59KYsA0L3D9w_jPF4ZXbFYVtC0zpfsxQ@mail.gmail.com>
To: usrp-users@lists.ettus.com
Message-ID-Hash: KJ7LY5BUY5X73EHAZSXBBKECVCZ346QA
X-Message-ID-Hash: KJ7LY5BUY5X73EHAZSXBBKECVCZ346QA
X-MailFrom: chunchi@g.clemson.edu
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-usrp-users.lists.ettus.com-0; header-match-usrp-users.lists.ettus.com-1; header-match-usrp-users.lists.ettus.com-2; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
X-Mailman-Version: 3.3.3
Precedence: list
Subject: [USRP-users] 10Gb speed on N310
List-Id: USRP-related discussion and support <usrp-users.lists.ettus.com>
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/KJ7LY5BUY5X73EHAZSXBBKECVCZ346QA/>
...
Content-Type: multipart/mixed; boundary="===============8598593607359654779=="

--===============8598593607359654779==
Content-Type: multipart/related; boundary="000000000000fe522c05d19efccf"

--000000000000fe522c05d19efccf
Content-Type: multipart/alternative; boundary="000000000000fe522a05d19efcce"

--000000000000fe522a05d19efcce
...
iv>I have a=C2=A010Gb=C2=A0PCIe NIC, Intel X520-DA1, installed on=C2=A0my d=
esktop=C2=A0and connected to sfp+1 port with SFP+ DAC cable.</div><div>I&#3=
9;m trying to verify the=C2=A0speed of the connection.</div><div>I launched=
 a iperf3 server on USRP N310, and a client from my desktop.</div><div>The =
bandwidth is fat from 10Gb. The screenshot below is from my desktop.</div><=
div><img src=3D"cid:ii_kwf4vyfw0" alt=3D"image.png" width=3D"562" height=3D=
"285"><br></div><div><br></div><div>Bath mtu of interfaces=C2=A0on N310 and=
 my desktop are set to be 9000.</div><div><br></div><div>Many thanks</div><=
div>Chun-Chih Lin</div><div><br></div></div></div></div>
...
Content-ID: <ii_kwf4vyfw0>
X-Attachment-Id: ii_kwf4vyfw0
