...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id BDF07A9E4B8
	for <lists+usrp-users@lfdr.de>; Sun, 27 Apr 2025 23:40:34 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 9307C38614A
	for <lists+usrp-users@lfdr.de>; Sun, 27 Apr 2025 17:40:33 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1745790033; bh=Xb0riZ4PckDk8iRhLA/jMQ1c3vkEj6rQXmZceY4z6Ko=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qv1-f49.google.com (mail-qv1-f49.google.com [209.85.219.49])
	by mm2.emwd.com (Postfix) with ESMTPS id DC025385F4B
	for <usrp-users@lists.ettus.com>; Sun, 27 Apr 2025 17:39:32 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="C7iWCk0o";
	dkim-atps=neutral
Received: by mail-qv1-f49.google.com with SMTP id 6a1803df08f44-6ecfbf1c7cbso77889706d6.2
        for <usrp-users@lists.ettus.com>; Sun, 27 Apr 2025 14:39:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1745789972; x=1746394772; darn=lists.ettus.com;
        h=in-reply-to:from:content-language:references:cc:to:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=XUBnEFZJyHpQmIwCjb7mlpo11Ct6YLPceDVho4p6Fxk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1745789972; x=1746394772;
        h=in-reply-to:from:content-language:references:cc:to:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=XUBnEFZJyHpQmIwCjb7mlpo11Ct6YLPceDVho4p6Fxk=;
        b=
X-Gm-Message-State: AOJu0YxkKhdPXuuAir8QfrXdIL10q7b8mfkVrFV0330pk1aF0ywF1/9P
	GAdMCIjZy9nR36zf3++++YwVeNMmTf6bPglQSRv+uGmCknx/j6GW
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IEVk2uWhc7ga9SA+V/k7bhaa9y5kDitcTDm+ICC5bC/IYOYtfFbfXZpC/QU1pWnD2tOXP48sA==
X-Received: by 2002:a05:6214:2a49:b0:6ea:d69c:a247 with SMTP id 6a1803df08f44-6f4d1eed580mr126621846d6.4.1745789972027;
        Sun, 27 Apr 2025 14:39:32 -0700 (PDT)
Received: from [192.168.2.170] ([174.93.0.120])
        by smtp.googlemail.com with ESMTPSA id 6a1803df08f44-6f4c0a74330sm49899326d6.72.2025.04.27.14.39.29
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 27 Apr 2025 14:39:30 -0700 (PDT)
Message-ID: <1392930b-c30e-4983-8787-0f7983e7cafb@gmail.com>
Date: Sun, 27 Apr 2025 17:39:19 -0400
MIME-Version: 1.0
...
Message-ID-Hash: HQUX6EX6V3MEEABV6JFEIFJPABT37YEP
X-Message-ID-Hash: HQUX6EX6V3MEEABV6JFEIFJPABT37YEP
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/HQUX6EX6V3MEEABV6JFEIFJPABT37YEP/>
...
Content-Type: multipart/mixed; boundary="===============7820528683239401501=="

This is a multi-part message in MIME format.
--===============7820528683239401501==
Content-Type: multipart/alternative;
 boundary="------------0SpippqEwxTc6KMF1fB3tX5D"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------0SpippqEwxTc6KMF1fB3tX5D
...
> This is not a software issue.=C2=A0uhd_rx_streamer_max_num_samps runs r=
ight=20
> after uhd initialization before
> any other code had the chance to run.
> Link capacity doesn't seem to be the issue either...
> Running pchar on the link, descendant of pathchar, reports a=20
...
>
> It corresponds to 351.218.019 16-bit samples or 175,609.044 32-bit=20
...
> BR
> Nikos
YOu CANNOT use ICMP tests to determine link capacity with a USRP -- ICMP=20
is processed via=C2=A0 completely different
...
>         =C2=A0 the requirements of your application.=C2=A0 So, a common
>         programming pattern is to deal with this in your application.
>
>         You should probably look at example code like rx_samples_to_fil=
e
>
>
>>
...
>>>>                 reason for it?
>>>>
>>>                 You'd need to share more of your code.=C2=A0 This sho=
uld
...
=A0 =C2=A0{
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 .cpu_format =3D "sc16",
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 .otw_format =3D "sc16",
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 .args =3D "",
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 .n_channels =3D 1,
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0.channel_list =3D &channel
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0};
...
=A0 =C2=A0 =C2=A0{
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0.stream_mode =3D
>>>             UHD_STREAM_MODE_NUM_SAMPS_AND_DONE,
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 .stream_now =3D true
>>>             =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 };
>>>
...
>>>             =C2=A0 =C2=A0 =C2=A0}
>>>
>>>                 bool uhd_init(size_t channel, double srate, double ga=
in)
>>>                 {
>>>                 double tmp;
...
>>>                 true)))
>>>                 warn(log, "Unable to set =C2=A0main thread priority (=
%d).
>>>                 %s.\n", 0, FL, LN, FN,
>>>                 err, uhdError(err));
>>>                 /* Create USRP */
...
>>>
>>>                 /* Create RX streamer */
>>>                 if ((err =3D uhd_rx_streamer_make(&rx_streamer[channe=
l])))
>>>                 {
...
>>>                 steps */
>>>
>>>                 =C2=A0 =C2=A0 =C2=A0 =C2=A0if ((err =3D uhd_usrp_set_=
rx_gain(dev[channel],
>>>                 gain, channel, "")))
>>>                 {
...
>>>                 return(FAIL);
>>>                 }
>>>                 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0if (!(err =3D
...
>>>             Sat Apr 26 03:33:48 2025 [00] [+] Master clock is at 200 =
Mhz
...
>>             limited by MTU size.=C2=A0=C2=A0 Which is typically around=
 8000 or
>>             so for "jumbo frames".
>>
>>
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 27/04/2025 17:37, Nikos Balkanas
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAAxXO2EHUfxCoFaBMiUkp=3DJYvv4hgNYtbVwpW6udYajdtdxSBA@mail.gm=
ail.com">
...
TF-8">
      <div dir=3D"ltr">
        ...
        <div class=3D"gmail_default" style=3D"font-size:small">This is no=
t a
          software issue.=C2=A0uhd_rx_streamer_max_num_samps runs right a=
fter
          uhd initialization before</div>
        <div class=3D"gmail_default" style=3D"font-size:small">any other
          code had the chance to run.</div>
        <div class=3D"gmail_default" style=3D"font-size:small">Link capac=
ity
          doesn't seem to be the issue either...</div>
        <div class=3D"gmail_default" style=3D"font-size:small">Running pc=
har
...
s://www.kitchenlab.org/www/bmah/Software/pchar/</a></div>
        <div class=3D"gmail_default" style=3D"font-size:small"><br>
        </div>
...
>
        <div class=3D"gmail_default" style=3D"font-size:small">I will hav=
e=C2=A0
          to download and check with the sources...</div>
        <div class=3D"gmail_default" style=3D"font-size:small">The packag=
e
          version for Ubuntu 24.04 is uhd 4.6.0.</div>
        <div class=3D"gmail_default" style=3D"font-size:small">Where can =
I
...
s
            ...
            <div class=3D"gmail_default" style=3D"font-size:small">I shou=
ld
              be able to get them in a single pass.</div>
            <div class=3D"gmail_default" style=3D"font-size:small">You sa=
w
...
s
            ...
            <div class=3D"gmail_default" style=3D"font-size:small">Cable =
is
              an SFP fiber dedicated line. Cannot go bad.</div>
            <div class=3D"gmail_default" style=3D"font-size:small">Maybe =
the
...
/div>
          ...
          <div class=3D"gmail_quote">
            <div dir=3D"ltr" class=3D"gmail_attr">On Sat, Apr 26, 2025 at
              6:45=E2=80=AFAM Marcus D. Leech &lt;<a
...
">Actually
                      MTU is 9000. This is one of the recommendations...<=
/div>
                    <div class=3D"gmail_default" style=3D"font-size:small=
">I
...
">maxsamples
                ...
                adapted to<br>
                =C2=A0 the requirements of your application.=C2=A0 So, a =
common
...
">Nikos</div>
                  ...
                  <div class=3D"gmail_quote">
                    <div dir=3D"ltr" class=3D"gmail_attr">On Sat, Apr 26,
                      2025 at 5:46=E2=80=AFAM Marcus D. Leech &lt;<a
...
padding-left:1ex">
                      <div>
                        <div>On 25/04/2025 22:26, Nikos Balkanas wrote:<b=
r>
                        </div>
                        <blockquote type=3D"cite">
                          <div dir=3D"ltr">
                            <div dir=3D"ltr">
                              <div class=3D"gmail_default"
                                style=3D"font-size:small">Thanks Marcus,<=
/div>
                              <div class=3D"gmail_default"
                                style=3D"font-size:small"><br>
                              </div>
                              <div class=3D"gmail_default"
                                style=3D"font-size:small">for your fast
                                reply.</div>
                            </div>
                            <br>
                            <div class=3D"gmail_quote">
                              <div dir=3D"ltr" class=3D"gmail_attr">On Sa=
t,
                                Apr 26, 2025 at 4:08=E2=80=AFAM Marcus D.=
 Leech
                                &lt;<a
                                  href=3D"mailto:patchvonbraun@gmail.com"
...
padding-left:1ex">
                                <div>
                                  ...
                                  <blockquote type=3D"cite">
                                    <div dir=3D"ltr">
                                      <div style=3D"font-size:small">Hell=
o,</div>
                                      ...
                                      <div style=3D"font-size:small">It
                                        ...
                                        uhd.</div>
                                      <div style=3D"font-size:small">Usin=
g
 ...
 You
                              ...
                              <div class=3D"gmail_default"
                                ...
                                1996 =3D 31.936 Kbps, 16 * 19960 =3D 319.=
360
                                Kbps well short of a 10 Gbps line:(</div>
                              <div class=3D"gmail_default"
                                style=3D"font-size:small">Does a complex
                                pair count as 1 sample, or 2?</div>
                              <div class=3D"gmail_default"
                                style=3D"font-size:small">I have followed
                                all the instructions in=C2=A0<a
...
/kb.ettus.com/USRP_Host_Performance_Tuning_Tips_and_Tricks</a>,</div>
                              <div class=3D"gmail_default"
                                style=3D"font-size:small">Even installed
...
v>
                                      ...
                                      <div style=3D"font-size:small">I
                                        ...
                                        cpu_format=3Dsc16, otw=3Dsc16, so=
 no
                                        conversion required.</div>
                                      <div style=3D"font-size:small">Stre=
amer
                                  ...
                                  code.=C2=A0 This should just work as fa=
r as
                                  I can tell.<br>
                                  <br>
                                </div>
                              ...
                              <div><span class=3D"gmail_default"
                                  style=3D"font-size:small">Thanks. these
...
>
                              ...
                              <div class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0
...
=C2=A0</span>{<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0</span>uhd_get_last_error(errmsg,
                                  127);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
...
>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0=C2=A0</span>uhd_rx_streamer_free(&amp;rx_streamer[0]);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0</span>rx_streamer[0]
                                  =3D NULL;<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0</span>uhd_rx_metadata_free(&amp;md[0]);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0=C2=A0</span>md[0]
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0=C2=A0</span>do_exit(30);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
=C2=A0</span>}<br>
                                  <span class=3D"gmail_default"
...
padding-left:1ex">
 ...
 =C2=A0 =C2=A0 =C2=A0</span>error(log,
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>..errmsg);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0=C2=A0</span>do_exit(35);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
=C2=A0</span>}<br>
                                  <span class=3D"gmail_default"
...
=C2=A0</span>if
 ...
 =C2=A0 =C2=A0=C2=A0</span>warn(log,
                                  "Incorrect maxsamples (%ld). Expected
 ...
 i</span>f
                                  ((err =3D
                                  uhd_rx_streamer_issue_stream_cmd(rx_str=
eamer[0],
...
>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0</span>do_exit(40);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0</span>}<br>
                                </div>
...
=C2=A0</span>double
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
=C2=A0</span>uhd_rx_metadata_error_code_t
                                  err;<br>
                                  <br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0</span>if
                                  ((err =3D
                                  uhd_set_thread_priority(uhd_default_thr=
ead_priority,
                                  true)))<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0=C2=A0</span>warn(log,
                                  "Unable to set =C2=A0main thread priori=
ty
                                  (%d). %s.\n", 0, FL, LN, FN,<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 ...
 =C2=A0 =C2=A0 =C2=A0=C2=A0</span>error(log,
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0
                                    =C2=A0 =C2=A0</span>uhdError(err));<b=
r>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>dev[channel]
                                  =3D NULL;<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0
...
=C2=A0</span>if
                                  ((err =3D
                                  uhd_rx_streamer_make(&amp;rx_streamer[c=
hannel])))<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
=C2=A0</span>{<br>
 ...
 =C2=A0 =C2=A0=C2=A0</span>error(log,
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0=C2=A0</span>channel,
                                  err, uhdError(err));<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0</span>return(FAIL);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 </span>}<br>
                                  <span class=3D"gmail_default"
...
=C2=A0</span>/*
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">G</span>et
                                  master clock rate */<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0</span>if
                                  ((err =3D
                                  uhd_usrp_get_master_clock_rate(dev[chan=
nel],
                                  0, &amp;tmp)))=C2=A0</div>
                              </blockquote>
                              <blockquote class=3D"gmail_quote"
...
padding-left:1ex">
 ...
 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>error(log,
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0
                                    =C2=A0 =C2=A0</span>LN, FN, tmp/10000=
00, err,
                                  uhdError(err));<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0=C2=A0</span>return(FAIL);<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 </span>}<br>
                                  <span class=3D"gmail_default"
...
padding-left:1ex">
 ...
 =C2=A0 =C2=A0</span>{<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0=C2=A0</span>error(log,
                                  "Failed to set tuner[%d] gain to %.0lf
                                  db (%d). %s.\n", 0, FL,<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0
                                    =C2=A0 =C2=A0 =C2=A0</span>LN, FN, ch=
annel, gain,
                                  err, uhdError(err));<br>
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 ...
 =C2=A0 =C2=A0 =C2=A0i</span>f
                                  ...
                                  <span class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0
                                    =C2=A0=C2=A0</span>info(log, "Tuner[%=
d] gain
                                  set to %.0lf (%.0lf) dB\n", 0,
                                  channel, tmp,<span
                                    class=3D"gmail_default"
                                    style=3D"font-size:small">=C2=A0</spa=
n>gain);</div>
                              </blockquote>
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0=C2=A0</span>./*
                              ...
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>uhd_usrp_set_rx_bandwidth(dev[chann=
el],
                              srate, channel);<br>
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0</span>./*
                              ...
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0=C2=A0</span>if
                              ((err =3D
                              uhd_usrp_set_rx_dc_offset_enabled(dev[chann=
el],
                              false, channel)))<br>
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
...
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0
                                =C2=A0</span>warn(log, "Failed to disable
                              FPGA DC offset on channel %d(%d). %s.\n",
                              0,<br>
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0
                                =C2=A0 =C2=A0 =C2=A0</span>FL, LN, FN, ch=
annel, err,
                              uhdError(err));</div>
...
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>}<br>
                              <span class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>info(stderr,
                            ...
                            <div class=3D"gmail_quote"><span
                                class=3D"gmail_default"
                                style=3D"font-size:small">=C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0</span>return(SUCCESS);<br>
                              <div><span class=3D"gmail_default"
                                  style=3D"font-size:small">=C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0}</span></div>
                              <div><span class=3D"gmail_default"
                              ...
                              <div><span class=3D"gmail_default"
                                  style=3D"font-size:small">This is the
                                  generated output:</span>=C2=A0</div>
                              <div><br>
                              </div>
                              <div><span class=3D"gmail_default"
                                  style=3D"font-size:small"></span>[INFO]
                              ...
                              <div><span class=3D"gmail_default"
                                  style=3D"font-size:small"></span></div>
                              <div><span class=3D"gmail_default"
                                  style=3D"font-size:small">I hope this
...
padding-left:1ex">
                                <div>
                                  <blockquote type=3D"cite">
                                    <div dir=3D"ltr">
                                      <div style=3D"font-size:small"> </d=
iv>
                                      <div style=3D"font-size:small">TIA<=
/div>
...
users-leave@lists.ettus.com</a>
                        ...
                        is limited by MTU size.=C2=A0=C2=A0 Which is typi=
cally
