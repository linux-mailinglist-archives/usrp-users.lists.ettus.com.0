...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id B36E06E3D33
	for <lists+usrp-users@lfdr.de>; Mon, 17 Apr 2023 03:36:56 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 8A4D6381011
	for <lists+usrp-users@lfdr.de>; Sun, 16 Apr 2023 21:36:55 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1681695415; bh=dcKcPlkjeNxgJQljrLmVU+tkpF4Rwx5pWvTk5+GWBqY=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-yw1-f181.google.com (mail-yw1-f181.google.com [209.85.128.181])
	by mm2.emwd.com (Postfix) with ESMTPS id 2DFA638009D
	for <usrp-users@lists.ettus.com>; Sun, 16 Apr 2023 21:36:19 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="CKigXl5z";
	dkim-atps=neutral
Received: by mail-yw1-f181.google.com with SMTP id 00721157ae682-54fc337a650so151896637b3.4
        for <usrp-users@lists.ettus.com>; Sun, 16 Apr 2023 18:36:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1681695379; x=1684287379;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:from:to:cc:subject:date
         :message-id:reply-to;
        bh=yORP326nnHecw/m5PFkm91cFJeZ7ofvxcOGKES+X8vU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1681695379; x=1684287379;
        h=in-reply-to:from:references:cc:to:content-language:subject
         :user-agent:mime-version:date:message-id:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=yORP326nnHecw/m5PFkm91cFJeZ7ofvxcOGKES+X8vU=;
        b=
X-Gm-Message-State: AAQBX9da4ga+F2vuVt34ZKtf+2yKA73W4fE/y9LvASnM7IrXEnmlW6JA
	CJpH84IDnA8gwhfr21RZqEIrKaJSssI=
X-Google-Smtp-Source: AKy350bAiY8V61VRASvWOEiogzJqXVdDh/Mi6PCTflx1TG67o0Io4ZooQd90rmbxB1LrEp0bN1NY8w==
X-Received: by 2002:a81:6c86:0:b0:541:694a:4c69 with SMTP id h128-20020a816c86000000b00541694a4c69mr15723190ywc.52.1681695379401;
        Sun, 16 Apr 2023 18:36:19 -0700 (PDT)
Received: from [192.168.2.199] (bras-base-smflon1825w-grc-09-174-93-2-82.dsl.bell.ca. [174.93.2.82])
        by smtp.googlemail.com with ESMTPSA id d64-20020a811d43000000b0054c055b8ffcsm2837943ywd.41.2023.04.16.18.36.18
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 16 Apr 2023 18:36:18 -0700 (PDT)
Message-ID: <67e3a035-c2c9-0112-910c-46faed961d89@gmail.com>
Date: Sun, 16 Apr 2023 21:36:18 -0400
MIME-Version: 1.0
...
In-Reply-To: <CAN=AL9MBP=uONwAN0zaUAUpHqgdvpNcSQNzrdmrH68=4Dcxp3Q@mail.gmail.com>
Message-ID-Hash: 2DLVRWNL5M5Z462OYDTJEPTSKKB4WHEN
X-Message-ID-Hash: 2DLVRWNL5M5Z462OYDTJEPTSKKB4WHEN
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/2DLVRWNL5M5Z462OYDTJEPTSKKB4WHEN/>
...
Content-Type: multipart/mixed; boundary="===============4869704503918154080=="

This is a multi-part message in MIME format.
--===============4869704503918154080==
Content-Type: multipart/alternative;
 boundary="------------RrizxtbY0oqoAQI66WEHkoKG"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------RrizxtbY0oqoAQI66WEHkoKG
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 16/04/2023 21:13, David Bengtson wrote:
> Yes, it's pretty typical that the output of an SDR needs additional=20
> filtering and gain on the transmit side, and similarly filters and=20
> gain on the receive side. I spent a substantial fraction of my time at=20
> a previous job designing application specific front ends for Ettus SDR'=
s.
>
> Dave
>
>
In my other job, I do radio astronomy.=C2=A0=C2=A0 "Filter early, filter =
often" is=20
what gets the job done in that domain.=C2=A0 A many-octave
 =C2=A0 tunable filter with variable bandwidth would be a nice thing, exc=
ept=20
for the ongoing miners strike at the
 =C2=A0 unobtanium mines...


> On Wed, Apr 12, 2023 at 8:39=E2=80=AFPM Marcus D. Leech=20
...
>>     B210 harmonics
>>
>     Thanks Ron.=C2=A0 That looks like what my TinySA produced for 250Mh=
z
...
>     =C2=A0 (often, not always) remediate this issue.=C2=A0 The E3xx ser=
ies, the
...
>     =C2=A0 unintended consequences of architecture choices deeper withi=
n
>     the radio.=C2=A0=C2=A0 Since SDRs in general don't get to be
...
up
>     =C2=A0 with a universal RF filtering scheme that is suitable for al=
l
>     applications.
>
...
>>>         even harmonics (2*fundamental, =E2=80=A6) did not change powe=
r, and
...
>>>             39% with a 100MHz to 23% with a 1GHz carrier.=C2=A0The se=
cond
...
Content-Type: multipart/related;
 boundary="------------mjNK1b0m0sS58cZiCSaLtfPu"

--------------mjNK1b0m0sS58cZiCSaLtfPu
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 16/04/2023 21:13, David Bengtson
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:CAN=3DAL9MBP=3DuONwAN0zaUAUpHqgdvpNcSQNzrdmrH68=3D4Dcxp3Q@mai=
l.gmail.com">
...
TF-8">
    ...
    In my other job, I do radio astronomy.=C2=A0=C2=A0 "Filter early, fil=
ter
    often" is what gets the job done in that domain.=C2=A0 A many-octave<=
br>
...
l.gmail.com">
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Wed, Apr 12, 2023 at
          8:39=E2=80=AFPM Marcus D. Leech &lt;<a
        ...
        <blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px
          ...
          <div>
            ...
            <blockquote type=3D"cite">
              ...
              <p>I don't think there's any remedy except for external
                filters.</p>
              <p>Ron</p>
              <img src=3D"cid:part1.OX47M0h5.iV00loxj@gmail.com" alt=3D"B=
210
                harmonics" class=3D"" width=3D"800" height=3D"480">
              <div><br>
              </div>
            </blockquote>
 ...
 can<br>
            =C2=A0 record spectra with it.=C2=A0 There's a Linux app for =
it that I
            need to explore....<br>
            <br>
            <br>
            ...
            =C2=A0 signal, which means that all the odd-order harmonics w=
ill
            be present in it, and naturally, mix with the baseband.<br>
            =C2=A0 There's nothing that can be done other than, as you po=
int
            out, filter.=C2=A0 As you move up in frequency, this becomes<=
br>
            =C2=A0 very much easier of course, and at 2GHz, the 3rd harmo=
nic
            ...
            =C2=A0 (often, not always) remediate this issue.=C2=A0 The E3=
xx
...
c
            application is using them as their "radio bits", it's hard
            to come up<br>
            =C2=A0 with a universal RF filtering scheme that is suitable =
for
            all applications.<br>
            <br>
            I'd never noticed this issue because I don't really ever TX
            in my "day job" use of these devices (radio astronomy), and
            on<br>
            =C2=A0 the RX side, I always pre-filter anyway, usually rathe=
r
            aggressively.<br>
            <br>
            <br>
            <blockquote type=3D"cite">
              <div> </div>
              <div>On 4/12/23 16:20, Shenk, Trey E via USRP-users wrote:<=
br>
              </div>
              <blockquote type=3D"cite">
                <div>
                  <p class=3D"MsoNormal">The original signal that I showe=
d
...
s.ettus.com</a><br>
                  ...
                  <blockquote style=3D"margin-top:5pt;margin-bottom:5pt">
                    <p class=3D"MsoNormal">I first tried turning the gain
                      ...
                      (2*fundamental, =E2=80=A6) did not change power, an=
d the
                  ...
                  <p class=3D"MsoNormal">What is the nature of the
                    ...
                    <br>
                    If you use an example app like "tx_waveforms" with,
...
sts.ettus.com</a><br>
                    ...
                    <div style=3D"border-color:currentcolor currentcolor
                      currentcolor rgb(215,118,0);border-style:none none
                      none solid;border-width:medium medium medium
                      6pt;padding:0in;font-size:1.15rem">
                      <p class=3D"MsoNormal"
                        style=3D"text-align:center;background:rgb(247,227=
,204)"
                        align=3D"center"> <span
                          style=3D"font-family:&quot;Arial&quot;,sans-ser=
...
t">=C2=A0</p>
                        ...
                        <div>
                          ...
                          <blockquote
                            ...
                            <p class=3D"MsoNormal"
                              style=3D"margin-bottom:12pt">On Apr 10,
                        ...
                        <blockquote
                          ...
                          <div>
                            ...
                            <p style=3D"background:white"><span
                                style=3D"font-size:10.5pt;color:black">I'=
m
                                ...
                                with a 1GHz carrier.=C2=A0The second harm=
onic
...
">Thanks,<br>
                            ...
                            <p class=3D"MsoNormal">=C2=A0</p>
                            <div>
                              <p class=3D"MsoNormal">&lt;carrier_freqswee=
p_fc0200M_gain55.png&gt;</p>
                            </div>
...
Content-Id: <part1.OX47M0h5.iV00loxj@gmail.com>
