...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id D1306B0F207
	for <lists+usrp-users@lfdr.de>; Wed, 23 Jul 2025 14:15:46 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 4D758385B17
	for <lists+usrp-users@lfdr.de>; Wed, 23 Jul 2025 08:15:33 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1753272933; bh=qfzj9n8jBgr+JDUdvWapyHE6/lR7afOBKcGDF1DJbFc=;
	h=From:To:Date:Subject:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=
Received: from za-smtp-delivery-57.mimecast.co.za (za-smtp-delivery-57.mimecast.co.za [41.74.201.57])
	by mm2.emwd.com (Postfix) with ESMTPS id B0AFC3859EF
	for <usrp-users@lists.ettus.com>; Wed, 23 Jul 2025 08:14:36 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (1024-bit key; unprotected) header.d=vastech.co.za header.i=@vastech.co.za header.b="DNXAyk1c";
	dkim-atps=neutral
Received: from mail.vastech.co.za (41.193.248.106 [41.193.248.106]) by
 relay.mimecast.com with ESMTP id za-mta-25-OOiPpJVnM-eSgiwOo6_S2A-1; Wed,
 23 Jul 2025 14:14:32 +0200
X-MC-Unique: OOiPpJVnM-eSgiwOo6_S2A-1
X-Mimecast-MFC-AGG-ID: OOiPpJVnM-eSgiwOo6_S2A_1753272872
dkim-signature: v=1; a=rsa-sha256; d=vastech.co.za; s=dkim;
	...
	bh=MPv3rLBWInIzz9Ow5F1SYMtstoZ3U7bFrzmEsESvfuc=;
	b=DNXAyk1c1/Q4+4Iv9lONy6Q3yML/Kp3+DeS+orMxgwqjIJ8svEE0BO/XmA/rxGuTRszKKNySfExgtYvfeqCvVAdcsi4hSo63p6naV/IQSxrWgmYO8smL2Hfsi1klxnak2Oe8t/petH24WBuulYZOi+gwh48TJ88qbpfEC/DNC3s=
Received: from EXCHANGE2.vastech.co.za (Unknown [172.30.81.30])
	by mail.vastech.co.za with ESMTPSA
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256)
	; Wed, 23 Jul 2025 14:14:29 +0200
Received: from exchange3.vastech.co.za (172.30.81.31) by
 ...
 15.2.1118.40; Wed, 23 Jul 2025 14:14:28 +0200
Received: from exchange3.vastech.co.za ([172.30.81.31]) by
 exchange3.vastech.co.za ([172.30.81.31]) with mapi id 15.02.1118.040; Wed, 23
 Jul 2025 14:14:28 +0200
From: Kevin Williams <kevin.williams@vastech.co.za>
To: "usrp-users@lists.ettus.com" <usrp-users@lists.ettus.com>
Thread-Topic: remote streaming starts, but stops after a few packets received
Thread-Index: Adv7yvkJv5zhuP5TSkWsizBU3L8RAQ==
Date: Wed, 23 Jul 2025 12:14:28 +0000
Message-ID: <111b29cda9ce4309b4966fcfcc3b7ece@vastech.co.za>
...
MIME-Version: 1.0
Message-ID-Hash: 3B26RLMCMQW62BCKWJGQG4BGU2QH5ZEU
X-Message-ID-Hash: 3B26RLMCMQW62BCKWJGQG4BGU2QH5ZEU
X-MailFrom: kevin.williams@vastech.co.za
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
X-Mailman-Version: 3.3.3
Precedence: list
Subject: [USRP-users] remote streaming starts, but stops after a few packets received
List-Id: "Discussion and technical support related to USRP, UHD, RFNoC" <usrp-users.lists.ettus.com>
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/3B26RLMCMQW62BCKWJGQG4BGU2QH5ZEU/>
...
Content-Type: multipart/mixed; boundary="===============5407068334461456458=="

--===============5407068334461456458==
Content-Language: en-US
Content-Type: multipart/signed; protocol="application/x-pkcs7-signature";
	micalg=2.16.840.1.101.3.4.2.3;
	boundary="----=_NextPart_000_00D7_01DBFBDC.1984C4B0"

------=_NextPart_000_00D7_01DBFBDC.1984C4B0
Content-Type: multipart/alternative;
	boundary="----=_NextPart_001_00D8_01DBFBDC.1984C4B0"


------=_NextPart_001_00D8_01DBFBDC.1984C4B0
...
class=3DMsoNormal><span lang=3DEN-US>I have enabled remote streaming but =
according to wireshark I only receive 6x 4k =
packets.<o:p></o:p></span></p><p class=3DMsoNormal><span =
lang=3DEN-US><o:p>&nbsp;</o:p></span></p><p class=3DMsoNormal><span =
lang=3DEN-US>Everything about them is correct &#8211; the destination =
ip, port, size, etc.<o:p></o:p></span></p><p class=3DMsoNormal><span =
lang=3DEN-US><o:p>&nbsp;</o:p></span></p><p class=3DMsoNormal><span =
...
ble_fc=3D0<o:p></o:p></span></p><p class=3DMsoNormal><span =
lang=3DEN-US>[DEBUG] [X300::SFP0::TA_CTL] On transport adapter 0: Adding =
route from EPID 6 to destination 172.17.0.2:1234 (MAC Address: =
02:42:ac:11:00:02), stream mode FULL_PACKET (0)<o:p></o:p></span></p><p =
class=3DMsoNormal><span lang=3DEN-US><o:p>&nbsp;</o:p></span></p><p =
class=3DMsoNormal><span lang=3DEN-US>What could cause that streaming to =
stop (given there is no flow control)?<o:p></o:p></span></p><p =
class=3DMsoNormal><span lang=3DEN-US><o:p>&nbsp;</o:p></span></p><p =
...
CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNTA3MjMxMjE0MjdaME8GCSqGSIb3DQEJ
BDFCBECnujj36+4jKYe07t0FE21pv0ScV4xhfEy0s6UT0/sUzDXjW8lACFiH9+QCY2bF6LGLM8SN
3tGxhxuIbPtja/nlMH0GCSsGAQQBgjcQBDFwMG4waTEmMCQGCSqGSIb3DQEJARYXaXRzdXBwb3J0
...

