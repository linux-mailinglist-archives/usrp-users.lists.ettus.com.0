...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A9C88A9C48
	for <lists+usrp-users@lfdr.de>; Thu, 18 Apr 2024 16:07:57 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 2D78D386542
	for <lists+usrp-users@lfdr.de>; Thu, 18 Apr 2024 10:07:56 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1713449276; bh=iIHELibvDbj6WgZ39g+3NvJi+3ILn+qri/z+CdYfz40=;
	h=Date:To:References:From:In-Reply-To:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=
Received: from mail-oi1-f178.google.com (mail-oi1-f178.google.com [209.85.167.178])
	by mm2.emwd.com (Postfix) with ESMTPS id D8EAC3861BD
	for <usrp-users@lists.ettus.com>; Thu, 18 Apr 2024 10:07:44 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="jakWXiYu";
	dkim-atps=neutral
Received: by mail-oi1-f178.google.com with SMTP id 5614622812f47-3c7220ec523so145844b6e.2
        for <usrp-users@lists.ettus.com>; Thu, 18 Apr 2024 07:07:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1713449264; x=1714054064; darn=lists.ettus.com;
        h=in-reply-to:from:references:to:content-language:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=ToNw2K44ioFKhY65giqZNMMFbSv3IHBgqKhP/wRAq3Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1713449264; x=1714054064;
        h=in-reply-to:from:references:to:content-language:subject:user-agent
         :mime-version:date:message-id:x-gm-message-state:from:to:cc:subject
         :date:message-id:reply-to;
        bh=ToNw2K44ioFKhY65giqZNMMFbSv3IHBgqKhP/wRAq3Q=;
        b=
X-Gm-Message-State: AOJu0YzAEH0UItNmxFAGxyCALj3rwxHY1LTkPgqQp2Qa/xtIYq+sjkTX
	iMb7HYa31RMPwzAkbZD+VAPL8Q/KAsUdjYZz3j+ScnY39QWot/crUbOl6w==
X-Google-Smtp-Source: AGHT+IGzPLmAVE38W6nyEeY17CAs8s/u/FGoYnnH2HKrng7AIUiEcklxUGEAtmc9+HQv1tgJrjRGCw==
X-Received: by 2002:a05:6808:3a97:b0:3c5:fcff:3979 with SMTP id fb23-20020a0568083a9700b003c5fcff3979mr2963212oib.48.1713449263172;
        Thu, 18 Apr 2024 07:07:43 -0700 (PDT)
Received: from [192.168.2.170] (bras-base-smflon1825w-grc-07-174-93-0-192.dsl.bell.ca. [174.93.0.192])
        by smtp.googlemail.com with ESMTPSA id c3-20020ac85183000000b00436e193f408sm688496qtn.28.2024.04.18.07.07.42
        for <usrp-users@lists.ettus.com>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 18 Apr 2024 07:07:42 -0700 (PDT)
Message-ID: <912423d2-5f78-4622-ba96-44197cbc7d18@gmail.com>
Date: Thu, 18 Apr 2024 10:07:41 -0400
MIME-Version: 1.0
...
Message-ID-Hash: IFMLISCBWATF5FJJ5VSODOFQDCGYDSBC
X-Message-ID-Hash: IFMLISCBWATF5FJJ5VSODOFQDCGYDSBC
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/IFMLISCBWATF5FJJ5VSODOFQDCGYDSBC/>
...
Content-Type: multipart/mixed; boundary="===============6602732134566046212=="

This is a multi-part message in MIME format.
--===============6602732134566046212==
Content-Type: multipart/alternative;
 boundary="------------HZShk0A3rMsK7Bl4FMyUegHf"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------HZShk0A3rMsK7Bl4FMyUegHf
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 18/04/2024 09:00, Martin Anderseck wrote:
>
...
> here: https://files.ettus.com/manual/page_usrp_x4xx.html#x4xx_adc_self_=
cal
>
...
>
>
There will always be component-to-component variation in RF components,=20
and this tends to get worse at higher frequencies.
 =C2=A0 Such variability can sometimes be as much as a few dB, as shown a=
bove.

When you buy a piece of *measurement equipment*, these variations in=20
apparent gain are calibrated and "trimmed" at
 =C2=A0 the factory (and indeed, most pieces of test equipment require=20
re-calibration every few years).=C2=A0=C2=A0=C2=A0 USRPs are not, per se,
 =C2=A0 measurement equipment, although could be used in that context onc=
e=20
...
Content-Type: multipart/related;
 boundary="------------6MSsx05RVKVPMYdVR6ZWLiuf"

--------------6MSsx05RVKVPMYdVR6ZWLiuf
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 18/04/2024 09:00, Martin Anderseck
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:PH0PR04MB83115908F44B4BB9C7FB8713F30E2@PH0PR04MB8311.namprd04=
.prod.outlook.com">
...
<o:idmap v:ext=3D"edit" data=3D"1" />
      ...
      <div class=3D"WordSection1">
        <p class=3D"MsoNormal"><span
            ...
            lang=3D"EN-US">You mention that self-calibration for each
            channel is running. Please don=E2=80=99t get wrong what this
            calibration is doing. This ADC self-cal is only responsible
            for reducing unwanted spurs in the ADCs as described here: <a
href=3D"https://files.ettus.com/manual/page_usrp_x4xx.html#x4xx_adc_self_=
cal"
              moz-do-not-send=3D"true" class=3D"moz-txt-link-freetext">
https://files.ettus.com/manual/page_usrp_x4xx.html#x4xx_adc_self_cal</a><=
o:p></o:p></span></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
        ...
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US">This ADC self-cal, however, will not handle an=
y
            power differences. From what you write it=E2=80=99s not possi=
ble to
            get absolute power values, so the relative differences are
            impossible to get, too. Since those devices are SDRs and not
            dedicated measurement equipment it is expected that there
            may be differences (not huge ones though, please see the
...
l</a>).
            If the existing accuracy is insufficient, it is possible to
            use the power API:
            <a
href=3D"https://files.ettus.com/manual/page_zbx.html#zbx_pwr_cal"
              moz-do-not-send=3D"true" class=3D"moz-txt-link-freetext">ht=
tps://files.ettus.com/manual/page_zbx.html#zbx_pwr_cal</a><o:p></o:p></sp=
an></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US"><o:p>=C2=A0</o:p></span></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US">You mention you used a loopback connection.
            Does that mean that you connected cables to the front panel
            connectors for this? To exclude them from the issue you
            might try using the internal loopback =E2=80=9Cantenna=E2=80=9D=
 for both the
            RX and TX path (see get_rx_antennas() for a list of
            antennas). This will use the internal loopback that is on
            the daughterboard for each channel. When using the internal
            loopback ensure you have compensated the lack of the 30 dB
            attenuator (e.g. by reducing the=C2=A0 gain on the TX side) a=
s
            typically in an external loopback you would use 30 dB
            attenuation (<a
href=3D"https://kb.ettus.com/USRP_X410/X440_Getting_Started_Guide#Proper_=
Care_and_Handling"
              moz-do-not-send=3D"true" class=3D"moz-txt-link-freetext">ht=
tps://kb.ettus.com/USRP_X410/X440_Getting_Started_Guide#Proper_Care_and_H=
andling</a>).
            <o:p></o:p></span></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
        ...
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US">For the phase difference: You don=E2=80=99t me=
ntion how
            you start the signal generation. I guess timed commands are
            what you=E2=80=99re missing:
            <a
...
D</a><o:p></o:p></span></p>
        ...
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US">I hope that gets you a bit further.<o:p></o:p>=
</span></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US"><o:p>=C2=A0</o:p></span></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
            lang=3D"EN-US">Best regards,<o:p></o:p></span></p>
        <p class=3D"MsoNormal"><span
            style=3D"font-size:11.0pt;mso-fareast-language:EN-US"
...
style=3D"font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif"
                lang=3D"EN-US"> zhou via USRP-users
...
mailto:usrp-users@lists.ettus.com">usrp-users@lists.ettus.com</a><br>
                <b>Subject:</b> [USRP-users] Unbalanced power among
...
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US">Hi All,<o:p></o:p></span></p>
          </div>
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
          ...
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US">I am using X410 with UHD 4.5. There are 4
                Tx and 4 Rx in this unit. I am checking the RF signal by
                using loopback connection, that is, Tx is connected to
                Rx in the same USRP. .<o:p></o:p></span></p>
          </div>
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
          ...
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US">The same single tone signal is transmitted
                on all 4 Tx antennas, but I find that the received power
                levels are significantly different among antennas as
                shown in plot below. There are two ZBX daughterboards in
                X410; ant0 and ant1 in the 1st board and ant2 and ant3
                in the 2nd. It seems that in the same daughterboard,
                power in the 1st antenna is higher than the 2nd antenna.<=
o:p></o:p></span></p>
          </div>
          <div>
            <p class=3D"MsoNormal"><span
...
lor:black"
                lang=3D"EN-US">The carrier frequency is 7GHz. Sampling
                rate 491.52MHz. In every test, UHD does self calibration
                for each channel.</span><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
...
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif;co=
lor:black"
                lang=3D"EN-US">Apart from power difference, there is also
                phase difference between antennas.</span><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US"><o:p></o:p></span></p>
          </div>
          <div>
...
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif;co=
lor:black"
                lang=3D"EN-US">How to make tx power closer between
                antennas?</span><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US"><o:p></o:p></span></p>
          </div>
...
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif;co=
lor:black"
                lang=3D"EN-US">And, is there a way to adjust the carrier
                phase for individual antenna?</span><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US"><o:p></o:p></span></p>
          </div>
          <div>
...
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"><=
img
                  style=3D"width:7.302in;height:5.3385in"
                  id=3D"Picture_x0020_1"
                  src=3D"cid:part1.3F5a6SuJ.YNZbSWyw@gmail.com"
                  alt=3D"Inline image" class=3D"" width=3D"701" height=3D=
"513"
                  border=3D"0"></span><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"><=
o:p></o:p></span></p>
          </div>
          <div>
...
o:p>=C2=A0</o:p></span></p>
          ...
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US">Thanks for any suggestion.<o:p></o:p></spa=
n></p>
          </div>
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
          ...
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"
                lang=3D"EN-US">Kind regards,<o:p></o:p></span></p>
          </div>
          <div>
            <p class=3D"MsoNormal"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif">H=
ongwei<o:p></o:p></span></p>
          </div>
          <div>
            <p class=3D"MsoNormal" style=3D"margin-bottom:12.0pt"><span
style=3D"font-size:10.0pt;font-family:&quot;Helvetica&quot;,sans-serif"><=
o:p>=C2=A0</o:p></span><br>
            </p>
          </div>
        </div>
      </div>
    </blockquote>
    There will always be component-to-component variation in RF
    components, and this tends to get worse at higher frequencies.<br>
    =C2=A0 Such variability can sometimes be as much as a few dB, as show=
n
    above.<br>
    <br>
    When you buy a piece of *measurement equipment*, these variations in
    apparent gain are calibrated and "trimmed" at<br>
    =C2=A0 the factory (and indeed, most pieces of test equipment require
    re-calibration every few years).=C2=A0=C2=A0=C2=A0 USRPs are not, per=
 se,<br>
    =C2=A0 measurement equipment, although could be used in that context =
once
    the variability is accounted for in your particular<br>
    =C2=A0 application.<br>
    <br>
    <br>
  </body>
</html>
...
Content-Id: <part1.3F5a6SuJ.YNZbSWyw@gmail.com>
