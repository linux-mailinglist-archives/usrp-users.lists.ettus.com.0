...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id D811F4A75A7
	for <lists+usrp-users@lfdr.de>; Wed,  2 Feb 2022 17:19:59 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 27C9E3855EC
	for <lists+usrp-users@lfdr.de>; Wed,  2 Feb 2022 11:19:59 -0500 (EST)
Received: from postman.dtnt.info (postman.dtnt.info [62.219.91.51])
	by mm2.emwd.com (Postfix) with ESMTPS id E067E384677
	for <usrp-users@lists.ettus.com>; Wed,  2 Feb 2022 11:07:04 -0500 (EST)
Received: from o.dtnt.email (o.dtnt.email [62.219.91.154])
	by postman.dtnt.info (Postfix) with ESMTPS id 043B841C6D
	for <usrp-users@lists.ettus.com>; Wed,  2 Feb 2022 17:53:09 +0200 (IST)
Received: from o.dtnt.email (o.dtnt.email [127.0.0.1])
	by o.dtnt.email (Postfix) with ESMTP id 81EA09FFB1
	for <usrp-users@lists.ettus.com>; Wed,  2 Feb 2022 17:52:58 +0200 (IST)
...
Received: from o.dtnt.email ([127.0.0.1])
	...
	with ESMTP id oC1msfhsrWbZ for <usrp-users@lists.ettus.com>;
	Wed,  2 Feb 2022 17:52:56 +0200 (IST)
Received: from mail-wr1-f53.google.com (mail-wr1-f53.google.com [209.85.221.53])
	by o.dtnt.email (Postfix) with ESMTPSA id C69489FAEC
	for <usrp-users@lists.ettus.com>; Wed,  2 Feb 2022 17:52:55 +0200 (IST)
Received: by mail-wr1-f53.google.com with SMTP id s9so39128380wrb.6
        for <usrp-users@lists.ettus.com>; Wed, 02 Feb 2022 07:52:55 -0800 (PST)
X-Gm-Message-State: AOAM5314mqOJVL0Pcv15Q9+O46VRm3T4SEr871Ew9JHs9e8YnVycSk/X
	Ajke1o7ps+WuCGXy063MwhfNZOn2ytOdDnHqBTM=
X-Google-Smtp-Source: ABdhPJyMxiP6dFDy8s16z4htcF6lru9CwFax4ZQYT41U8CYFrC8dfT+glsbMvYVxUtP6I5u2oVEwVUP1uLMvDIAHma0=
X-Received: by 2002:a5d:598b:: with SMTP id n11mr25885496wri.702.1643817174902;
 Wed, 02 Feb 2022 07:52:54 -0800 (PST)
MIME-Version: 1.0
References: <164366958084.11274.12985129402155989646@mm2.emwd.com>
 ...
 <CACDReSzP726PKt+Ja9pY+eNr=jOUx5Ei2=xN3teH2hL8t_O+Ew@mail.gmail.com> <CAB__hTSs4v0uSvCC+ESniGc4uLH2WHhfJP9_7uAtEhR_bi9e+g@mail.gmail.com>
In-Reply-To: <CAB__hTSs4v0uSvCC+ESniGc4uLH2WHhfJP9_7uAtEhR_bi9e+g@mail.gmail.com>
From: Ofer Saferman <ofer@navigicom.com>
Date: Wed, 2 Feb 2022 17:52:42 +0200
X-Gmail-Original-Message-ID: <CACDReSwqf0-O_3o-G6cJxFSmoQi3CXgfWASLutEPbutarRoWnw@mail.gmail.com>
Message-ID: <CACDReSwqf0-O_3o-G6cJxFSmoQi3CXgfWASLutEPbutarRoWnw@mail.gmail.com>
To: Rob Kossler <rkossler@nd.edu>
X-DTNT-MailScanner-Information: Please contact the ISP for more information
X-DTNT-MailScanner-ID: 043B841C6D.AB156
X-DTNT-MailScanner: Found to be clean
X-DTNT-MailScanner-From: ofer@navigicom.com
X-Spam-Status: No
Message-ID-Hash: 4GPHGIUTWEOFCXE7H5YHUZDEHBWBS74L
X-Message-ID-Hash: 4GPHGIUTWEOFCXE7H5YHUZDEHBWBS74L
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/4GPHGIUTWEOFCXE7H5YHUZDEHBWBS74L/>
...
Content-Type: multipart/mixed; boundary="===============5310014172829991371=="

--===============5310014172829991371==
Content-Type: multipart/alternative; boundary="000000000000c92c8d05d70b021f"

--000000000000c92c8d05d70b021f
...
> >>>>>>
> >>>>>> Hi Ofer,
> >>>>>> Considering just a single port replay block, it seems that you want
> to do the following:
...
> >>>>>>>>> c. Then how do I get the rx_stream to dump it to file? Do I need
> to do playback for this to happen, mirroring what is going on in the
...
<div dir=3D"ltr"><div>Hello Rob,</div><div><br></div><div>If the issue_stre=
am_command for the radio does not trigger the recording for the replay bloc=
k and I have to do it manually I lose the timed command to start recording =
of both channels at the same time.</div><div>That was the primary purpose o=
f the exercise - To cause 2 replay block channels to record 2 radio rx chan=
nels simultaneously.<br></div><div><br></div><div>Regards,</div><div>Ofer=
=C2=A0 <br></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" clas=
s=3D"gmail_attr">On Wed, Feb 2, 2022 at 4:21 PM Rob Kossler &lt;<a href=3D"=
mailto:rkossler@nd.edu">rkossler@nd.edu</a>&gt; wrote:<br></div><blockquote=
 class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px so=
lid rgb(204,204,204);padding-left:1ex">On Wed, Feb 2, 2022 at 4:02 AM Ofer =
Saferman &lt;<a href=3D"mailto:ofer@navigicom.com" target=3D"_blank">ofer@n=
avigicom.com</a>&gt; wrote:<br>
<br>
