...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id D59A6386B68
	for <lists+usrp-users@lfdr.de>; Mon, 17 May 2021 22:32:11 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 286A7385042
	for <lists+usrp-users@lfdr.de>; Mon, 17 May 2021 16:32:11 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="ehqNlvC0";
	dkim-atps=neutral
Received: from mail-qk1-f175.google.com (mail-qk1-f175.google.com [209.85.222.175])
	by mm2.emwd.com (Postfix) with ESMTPS id D285A384C6A
	for <usrp-users@lists.ettus.com>; Mon, 17 May 2021 16:31:22 -0400 (EDT)
Received: by mail-qk1-f175.google.com with SMTP id 197so7122220qkl.12
        for <usrp-users@lists.ettus.com>; Mon, 17 May 2021 13:31:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=message-id:date:from:user-agent:mime-version:to:cc:subject
         :references:in-reply-to;
        bh=UeNS/8ND3tbCjBKq7XtbDvioa25blpTCJ2wPNuKWmn4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UeNS/8ND3tbCjBKq7XtbDvioa25blpTCJ2wPNuKWmn4=;
        b=
X-Gm-Message-State: AOAM5314wPwl5RzsWUYOxecc/9cyZ0W9g+YprPAXQNtJCdC5J2WJfcqO
	XaiqUXHYgqKIo6gvvA3UbOyjHFcgh0o=
X-Google-Smtp-Source: ABdhPJy3z+3nYfNEMSjMWrWBE1fM3V5Y3dQrfFXrvCVe+vBuhJQ2iw5Zh7StUI+b3rP8wc/s683jcQ==
X-Received: by 2002:a05:620a:8dd:: with SMTP id z29mr1783984qkz.492.1621283482005;
        Mon, 17 May 2021 13:31:22 -0700 (PDT)
Received: from [192.168.2.12] (bras-base-smflon1825w-grc-18-76-67-104-5.dsl.bell.ca. [76.67.104.5])
        by smtp.googlemail.com with ESMTPSA id i5sm11181164qki.115.2021.05.17.13.31.21
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 17 May 2021 13:31:21 -0700 (PDT)
Message-ID: <60A2D298.5000802@gmail.com>
Date: Mon, 17 May 2021 16:31:20 -0400
From: "Marcus D. Leech" <patchvonbraun@gmail.com>
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:31.0) Gecko/20100101 Thunderbird/31.7.0
MIME-Version: 1.0
To: "Zeng, Huacheng" <huacheng.zeng@gmail.com>
References: <CAL0m=NacROnWkmwJaSFc_EdtF3Rs9bFitbTwJQjCgPY==ZKpow@mail.gmail.com> <F69F86F2-31B7-487E-8714-6542540F800E@gmail.com> <CAL0m=NbmR3DY6e_AKX-inbdO-d1cAE+Yz1MJHTTj0uH2oRBi9Q@mail.gmail.com>
In-Reply-To: <CAL0m=NbmR3DY6e_AKX-inbdO-d1cAE+Yz1MJHTTj0uH2oRBi9Q@mail.gmail.com>
Message-ID-Hash: LGIYWZRMKQCK7S7CN6TKWW3MNYUF66U2
X-Message-ID-Hash: LGIYWZRMKQCK7S7CN6TKWW3MNYUF66U2
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/LGIYWZRMKQCK7S7CN6TKWW3MNYUF66U2/>
...
Content-Type: multipart/mixed; boundary="===============4629427881764906986=="

This is a multi-part message in MIME format.
--===============4629427881764906986==
Content-Type: multipart/alternative;
 boundary="------------080806070501030909030107"

This is a multi-part message in MIME format.
--------------080806070501030909030107
...
> Hi Marcus,
>
> Thank you for the reply. I am using SBX (40MHz) daughterboards for=20
> X310. For my software setting, I'm not sure what is the best way to=20
> present the details. So I copied my code below. Hopeful it is not=20
...
Specifically, you'll need to use timed commands to tune your two card,=20
so that the phase-resynch feature of the ADF4351 can
...
>     //cout << boost::format("Using Device: %s") %=20
> usrp->get_pp_string() << endl;
>
>     //always select the subdevice first, the channel mapping affects=20
> the other settings
...
>         this_thread::sleep_for(chrono::seconds(1)); //wait for pps=20
> sync_opt pulse
...
>         cout << boost::format("Actual RX Freq: %f MHz...") % (usrp ->=20
> get_rx_freq(ch) / 1e6) << endl;
>         cout << boost::format("Actual TX Freq: %f MHz...") % (usrp ->=20
> get_tx_freq(ch) / 1e6) << endl;
>
>         //set the rx sample rate (sets across all channels)
>         usrp -> set_rx_rate(sam_rate, ch);
>         usrp -> set_tx_rate(sam_rate, ch);
>         cout << boost::format("Actual RX Rate: %f Msps...") % (usrp ->=20
> get_rx_rate(ch) / 1e6) << endl;
>         cout << boost::format("Actual TX Rate: %f Msps...") % (usrp ->=20
...
>         cout << boost::format("Actual RX Gain: %f dB...") % usrp ->=20
> get_rx_gain(ch) << endl;
>         cout << boost::format("Actual TX Gain: %f dB...") % usrp ->=20
> get_tx_gain(ch) << endl;
>
>         //set the analog frontend filter bandwidth
>         usrp -> set_rx_bandwidth(analg_bw, ch);
>         usrp -> set_tx_bandwidth(analg_bw, ch);
>         cout << boost::format("Actual RX Bandwidth: %f MHz...") %=20
> (usrp -> get_rx_bandwidth(ch) / 1e6) << endl;
>         cout << boost::format("Actual TX Bandwidth: %f MHz...") %=20
...
>     stream_cmd.time_spec =3D usrp -> get_time_now() +=20
> uhd::time_spec_t(seconds_in_future);
>     rx_stream -> issue_stream_cmd(stream_cmd); //tells all channels to=20
> stream
>
>     //cout<<"time real: " <<stream_cmd.time_spec.get_real_secs() << end=
l;
>     //cout<<"time full: " <<stream_cmd.time_spec.get_full_secs() << end=
l;
>     //cout<<"time frac: " <<stream_cmd.time_spec.get_frac_secs() << end=
l;
>     //the first call to recv() will block this many seconds before=20
> receiving
>     timeout =3D seconds_in_future + 0.1; //timeout (delay before receiv=
e=20
> + padding)
>
>     cout << "^^^^^^^^^^^^^^^^^^^^^^^^ complete SDR initialization=20
> ^^^^^^^^^^^^^^^^^^^^^" << endl;
> }
>
> sdr_dev::~sdr_dev() {}
...
> }
>
> size_t sdr_dev::receive(vector < complex < float > * > rx_buff_ptr,=20
...
> size_t sdr_dev::usrp_receive(vector < complex < float > * >=20
...
>
>         for (int i =3D 0; i < rx_buff_ptr.size(); i++)=20
> rx_buff_ptr_tmp[i] =3D & rx_buff_ptr[i][acc_num_samps];
>
>         size_t num_rx_samps =3D rx_stream -> recv(rx_buff_ptr_tmp,=20
...
>             if (rx_md.error_code =3D=3D=20
> uhd::rx_metadata_t::ERROR_CODE_TIMEOUT) break;
>             if (rx_md.error_code !=3D uhd::rx_metadata_t::ERROR_CODE_NO=
NE) {
>                 throw runtime_error(str(boost::format("Receiver error=20
> %s") % rx_md.strerror()));
>             }
>             cout << boost::format("Received packet: %u samples, %u=20
> full secs, %f frac secs")\ %
>                 num_rx_samps\ %
...
>         cerr << "Receive timeout before all samples received..." << end=
l;
>     }
>
...
> }
>
> size_t sdr_dev::transmit(vector < complex < float > * > tx_buff_ptr,=20
> size_t requested_num_samps) {
>
>     if (is_usrp_enabled =3D=3D true)
...
> }
>
> size_t sdr_dev::usrp_transmit(vector < complex < float > * >=20
> tx_buff_ptr, size_t requested_num_samps) {
>     //setup metadata for the first packet
>     tx_md.start_of_burst =3D true; // not clear what is the difference=20
> between "false" and "true"
>     tx_md.end_of_burst =3D false;
>     tx_md.has_time_spec =3D true; //??? should be true or false
>     tx_md.time_spec =3D usrp -> get_time_now() +=20
> uhd::time_spec_t(0.001); //0.1
>
>     //the first call to send() will block this many seconds before=20
> sending:
>     timeout =3D seconds_in_future + 0.1; //timeout (delay before=20
> transmit + padding)
>
...
>         }
>
>         for (int i =3D 0; i < tx_buff_ptr.size(); i++)=20
> tx_buff_ptr_tmp[i] =3D & tx_buff_ptr[i][acc_num_samps];
>
>         //send a single packet
>         size_t num_tx_samps =3D tx_stream -> send(tx_buff_ptr_tmp,=20
...
>         }
>         if (is_debg_enabled =3D=3D true) {
>             cout << boost::format("Sent packet: %u samples") %=20
> num_tx_samps << endl;
>         }
...
>         size_t acks =3D 0;
>         //loop through all messages for the ACK packets (may have=20
> underflow messages in queue)
>         while (acks < channel_nums.size() and tx_stream ->=20
> recv_async_msg(async_md, seconds_in_future)) {
>             if (async_md.event_code =3D=3D=20
...
> }
>
> On Mon, May 17, 2021 at 3:24 PM Marcus D Leech=20
> <patchvonbraun@gmail.com <mailto:patchvonbraun@gmail.com>> wrote:
>
>     You haven=E2=80=99t said what type of daughter cards you=E2=80=99re=
 using.
>
...
>>     <huacheng.zeng@gmail.com <mailto:huacheng.zeng@gmail.com>> wrote:
>>
>>     =EF=BB=BF
>>     An update - I update UHD to 4.0 version and run the code again.
>>     With this version I got some warning message (see below). Did I
>>     set up the X310 usrp improperly?
>>
>>
...
>>     <zenghuacheng@gmail.com <mailto:zenghuacheng@gmail.com>> wrote:
>>
>>         Hi all,
>>
>>         I am using X310 as an MIMO transmitter to send two data
>>         streams. I observed from the received signal that the two
>>         data streams are misaligned in the time domain. I suspect
>>         that it is the X310's timing/frequency synchronization
>>         problem. Below is the output information. Is there any C++
>>         API reference for setting up X310 as a MIMO
>>         transmitter/receiver? Any suggestions would be appreciated.
>>
>>         Thanks,
>>         Hua
>>
...
pe">
  ...
  <body bgcolor=3D"#FFFFFF" text=3D"#000000">
    <div class=3D"moz-cite-prefix">On 05/17/2021 04:27 PM, Zeng, Huacheng
      wrote:<br>
    </div>
    <blockquote
cite=3D"mid:CAL0m=3DNbmR3DY6e_AKX-inbdO-d1cAE+Yz1MJHTTj0uH2oRBi9Q@mail.gm=
ail.com"
      type=3D"cite">
      <div dir=3D"ltr">
        <div>Hi Marcus,</div>
        ...
        <div>Thank you for the reply. I am using SBX (40MHz)=C2=A0
          daughterboards for X310. For my software setting, I'm not sure
...
zation_and_MIMO_Capability_with_USRP_Devices">https://kb.ettus.com/Synchr=
onization_and_MIMO_Capability_with_USRP_Devices</a><br>
    ...
    =C2=A0 be used to produce phase synchronization of the two LOs involv=
ed
    here.<br>
    <br>
    <br>
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D</div>
        ...
        <div>int main() {<br>
          ...
          "addr=3D192.168.10.2,type=3Dx300,master_clock_rate=3D200e6";<br=
>
          =C2=A0 =C2=A0 sp.chan_num =3D 2;<br>
          =C2=A0 =C2=A0 sp.chan_str =3D "0,1";<br>
          =C2=A0 =C2=A0 sp.sync_opt =3D "internal"; //"pps", "mimo"<br>
          ...
          =C2=A0 =C2=A0 chan_str =3D sp.chan_str; // specify "0", "1", "0=
,1", etc<br>
          =C2=A0 =C2=A0 chan_num =3D sp.chan_num;<br>
          =C2=A0 =C2=A0 sync_opt =3D sp.sync_opt; //"pps", "mimo", "defau=
lt"<br>
          <br>
          ...
          =C2=A0 =C2=A0 usrp =3D uhd::usrp::multi_usrp::make(ip_addrs);<b=
r>
          =C2=A0 =C2=A0 //cout &lt;&lt; boost::format("Using Device: %s")=
 %
          usrp-&gt;get_pp_string() &lt;&lt; endl;<br>
          <br>
          =C2=A0 =C2=A0 //always select the subdevice first, the channel =
mapping
          affects the other settings<br>
          =C2=A0 =C2=A0 // usrp-&gt;set_rx_subdev_spec(subdev); //sets ac=
ross all
          mboards<br>
          =C2=A0 =C2=A0 // usrp-&gt;set_tx_subdev_spec(subdev); //sets ac=
ross all
          mboards<br>
          <br>
          =C2=A0 =C2=A0 // clock and time sync_opthronization<br>
          =C2=A0 =C2=A0 if (sync_opt =3D=3D "pps") {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_clock_source("extern=
al");<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_time_source("externa=
l");<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt;
          set_time_unknown_pps(uhd::time_spec_t(0.0));<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 this_thread::sleep_for(chrono::seco=
nds(1)); //wait for
          pps sync_opt pulse<br>
          =C2=A0 =C2=A0 } else if (sync_opt =3D=3D "mimo") {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; "MIMO cable" &lt;&lt;=
 endl;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 UHD_ASSERT_THROW(usrp -&gt; get_num=
_mboards() =3D=3D 2);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //make mboard 1 a slave over the MI=
MO Cable<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_clock_source("mimo",=
 1);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_time_source("mimo", =
1);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //set time on the master (mboard 0)=
<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_time_now(uhd::time_s=
pec_t(0.0), 0);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //sleep a bit while the slave locks=
 its time to the
          master<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 this_thread::sleep_for(chrono::mill=
iseconds(500));<br>
          =C2=A0 =C2=A0 } else {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_time_now(uhd::time_s=
pec_t(1.0));<br>
          ...
          =C2=A0 =C2=A0 tune_request.args =3D uhd::device_addr_t("mode_n=3D=
integer");<br>
...
, ch);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::format("Actual=
 RX Freq: %f
          MHz...") % (usrp -&gt; get_rx_freq(ch) / 1e6) &lt;&lt; endl;<br=
>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::format("Actual=
 TX Freq: %f
          MHz...") % (usrp -&gt; get_tx_freq(ch) / 1e6) &lt;&lt; endl;<br=
>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //set the rx sample rate (sets acro=
ss all channels)<br>
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::format("Actual=
 RX Rate: %f
          Msps...") % (usrp -&gt; get_rx_rate(ch) / 1e6) &lt;&lt; endl;<b=
r>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::format("Actual=
 TX Rate: %f
          Msps...") % (usrp -&gt; get_tx_rate(ch) / 1e6) &lt;&lt; endl;<b=
r>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //set antenna ...<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_rx_antenna(rx_ant_na=
me, ch);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_tx_antenna(tx_ant_na=
me, ch);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; "Rx antenna is " &lt;=
&lt; usrp -&gt;
          get_rx_antenna(ch) &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; "Tx antenna is " &lt;=
&lt; usrp -&gt;
...
;<br>
 ...
 TX Gain: %f
          ...
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //set the analog frontend filter ba=
ndwidth<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_rx_bandwidth(analg_b=
w, ch);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_tx_bandwidth(analg_b=
w, ch);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::format("Actual=
 RX Bandwidth: %f
 ...
 TX Bandwidth: %f
          ...
          endl;<br>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 usrp -&gt; set_rx_dc_offset(false, =
ch);<br>
          <br>
          =C2=A0 =C2=A0 }<br>
          <br>
          =C2=A0 =C2=A0 //detect which channels to use<br>
          =C2=A0 =C2=A0 cout &lt;&lt; "RX channel num: " &lt;&lt; usrp -&=
gt;
          get_rx_num_channels() &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 cout &lt;&lt; "TX channel num: " &lt;&lt; usrp -&=
gt;
          get_tx_num_channels() &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 vector &lt; string &gt; channel_strings;<br>
          =C2=A0 =C2=A0 boost::split(channel_strings, chan_str,
          boost::is_any_of("\"',"));<br>
          =C2=A0 =C2=A0 for (size_t ch =3D 0; ch &lt; channel_strings.siz=
e(); ch++)
          {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 size_t chan =3D stoi(channel_string=
s[ch]);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 if (chan &gt;=3D usrp -&gt; get_rx_=
num_channels()) {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 throw runtime_error("=
Invalid channel(s)
          specified.");<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 } else {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 channel_nums.push_bac=
k(stoi(channel_strings[ch]));<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 }<br>
          =C2=A0 =C2=A0 }<br>
          <br>
          =C2=A0 =C2=A0 //create a receive streamer<br>
          =C2=A0 =C2=A0 //linearly map channels (index0 =3D channel0, ind=
ex1 =3D
          channel1, ...)<br>
          =C2=A0 =C2=A0 uhd::stream_args_t stream_args("fc32"); //complex=
 floats<br>
          =C2=A0 =C2=A0 stream_args.channels =3D channel_nums;<br>
          =C2=A0 =C2=A0 rx_stream =3D usrp -&gt; get_rx_stream(stream_arg=
s);<br>
          =C2=A0 =C2=A0 tx_stream =3D usrp -&gt; get_tx_stream(stream_arg=
s);<br>
          <br>
          =C2=A0 =C2=A0 // pkt max size<br>
          =C2=A0 =C2=A0 tx_max_num_samps =3D tx_stream -&gt; get_max_num_=
samps();<br>
          =C2=A0 =C2=A0 rx_max_num_samps =3D rx_stream -&gt; get_max_num_=
samps();<br>
          =C2=A0 =C2=A0 cout &lt;&lt; "tx_max_num_samps =3D " &lt;&lt;
          tx_max_num_samps &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 cout &lt;&lt; "rx_max_num_samps =3D " &lt;&lt;
...
>
          ...
          =C2=A0 =C2=A0 rx_stream -&gt; issue_stream_cmd(stream_cmd); //t=
ells all
          ...
          =C2=A0 =C2=A0 //the first call to recv() will block this many s=
econds
          before receiving<br>
          =C2=A0 =C2=A0 timeout =3D seconds_in_future + 0.1; //timeout (d=
elay before
          receive + padding)<br>
          <br>
          =C2=A0 =C2=A0 cout &lt;&lt; "^^^^^^^^^^^^^^^^^^^^^^^^ complete =
SDR
...
>
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 return usrp_receive(rx_buff_ptr, re=
quested_num_samps);<br>
          =C2=A0 =C2=A0 else<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 return simu_receive(rx_buff_ptr, re=
quested_num_samps);<br>
          <br>
          }<br>
          <br>
          ...
          =C2=A0 =C2=A0 size_t total_num_samps =3D requested_num_samps;<b=
r>
          <br>
          =C2=A0 =C2=A0 vector &lt; complex &lt; float &gt; * &gt; rx_buf=
f_ptr_tmp
          =3D rx_buff_ptr;<br>
          <br>
          =C2=A0 =C2=A0 while (acc_num_samps &lt; total_num_samps) {<br>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 for (int i =3D 0; i &lt; rx_buff_pt=
r.size(); i++)
          rx_buff_ptr_tmp[i] =3D &amp; rx_buff_ptr[i][acc_num_samps];<br>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 size_t num_rx_samps =3D rx_stream -=
&gt;
          recv(rx_buff_ptr_tmp, total_num_samps - acc_num_samps, rx_md,
          timeout);<br>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //use a small timeout for subsequen=
t packets<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 timeout =3D 0.1;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 if (is_debg_enabled =3D=3D true) {<=
br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 //handle the error co=
de<br>
...
!=3D
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::=
format("Received packet: %u
          samples, %u full secs, %f frac secs")\ %<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 num_rx_=
samps\ %<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 rx_md.t=
ime_spec.get_full_secs()\ %<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 rx_md.t=
ime_spec.get_frac_secs()\ &lt;&lt;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 endl;<b=
r>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 }<br>
...
>
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cerr &lt;&lt; "Receive timeout befo=
re all samples
          received..." &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 }<br>
          <br>
          ...
          =C2=A0 =C2=A0 tx_md.start_of_burst =3D true; // not clear what =
is the
          difference between "false" and "true"<br>
          =C2=A0 =C2=A0 tx_md.end_of_burst =3D false;<br>
          =C2=A0 =C2=A0 tx_md.has_time_spec =3D true; //??? should be tru=
e or false<br>
          =C2=A0 =C2=A0 tx_md.time_spec =3D usrp -&gt; get_time_now() +
          uhd::time_spec_t(0.001); //0.1 =C2=A0<br>
          <br>
          =C2=A0 =C2=A0 //the first call to send() will block this many s=
econds
          before sending:<br>
          =C2=A0 =C2=A0 timeout =3D seconds_in_future + 0.1; //timeout (d=
elay before
          transmit + padding)<br>
          <br>
          =C2=A0 =C2=A0 vector &lt; complex &lt; float &gt; * &gt; tx_buf=
f_ptr_tmp
          =3D tx_buff_ptr;<br>
          <br>
          =C2=A0 =C2=A0 size_t acc_num_samps =3D 0; //number of accumulat=
ed samples<br>
          =C2=A0 =C2=A0 size_t total_num_samps =3D requested_num_samps;<b=
r>
          =C2=A0 =C2=A0 while (acc_num_samps &lt; total_num_samps) {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 size_t samps_to_send =3D total_num_=
samps -
          acc_num_samps;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 if (samps_to_send &gt; tx_max_num_s=
amps) {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 samps_to_send =3D tx_=
max_num_samps;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 } else {<br>
...
=3D true;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 }<br>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 for (int i =3D 0; i &lt; tx_buff_pt=
r.size(); i++)
          tx_buff_ptr_tmp[i] =3D &amp; tx_buff_ptr[i][acc_num_samps];<br>
          <br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //send a single packet<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 size_t num_tx_samps =3D tx_stream -=
&gt;
          send(tx_buff_ptr_tmp, samps_to_send, tx_md, timeout);<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //do not use time spec for subseque=
nt packets<br>
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 cerr &lt;&lt; "Send t=
imeout..." &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 }<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 if (is_debg_enabled =3D=3D true) {<=
br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; boost::=
format("Sent packet: %u
...
>
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; endl &lt;&lt; "Waitin=
g for async_opt
          burst ACK... " &lt;&lt; flush;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 size_t acks =3D 0;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 //loop through all messages for the=
 ACK packets (may
          ...
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 if (async_md.event_co=
de =3D=3D
...
{<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; "fail" =
&lt;&lt; endl;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 } else {<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 cout &lt;&lt; "ack re=
ceived" &lt;&lt; endl;<br>
          =C2=A0 =C2=A0 =C2=A0 =C2=A0 }<br>
          =C2=A0 =C2=A0 }<br>
          <br>
      ...
      <div class=3D"gmail_quote">
        <div dir=3D"ltr" class=3D"gmail_attr">On Mon, May 17, 2021 at 3:2=
4
...
om</a>&gt;
        ...
        <blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px
          ...
          <div dir=3D"auto">You haven=E2=80=99t said what type of daughte=
r cards
            ...
            <div>In your software.=C2=A0<br>
              ...
              <div dir=3D"ltr"><br>
                <blockquote type=3D"cite">On May 17, 2021, at 1:56 PM,
                  Zeng, Huacheng &lt;<a moz-do-not-send=3D"true"
                ...
                <div dir=3D"ltr">=EF=BB=BF
                  ...
                  <div class=3D"gmail_quote">
                    <div dir=3D"ltr" class=3D"gmail_attr">On Mon, May 17,
                      2021 at 12:04 PM Huacheng Zeng &lt;<a
                        moz-do-not-send=3D"true"
                        href=3D"mailto:zenghuacheng@gmail.com"
                        target=3D"_blank">zenghuacheng@gmail.com</a>&gt;
                      wrote:<br>
                    </div>
...
br>
                      To unsubscribe send an email to <a
                        ...
                        target=3D"_blank">usrp-users-leave@lists.ettus.co=
m</a><br>
                    </blockquote>
                  </div>
...
span><br>
                  <span>USRP-users mailing list -- <a
                      moz-do-not-send=3D"true"
                      href=3D"mailto:usrp-users@lists.ettus.com"
                      target=3D"_blank">usrp-users@lists.ettus.com</a></s=
pan><br>
                  <span>To unsubscribe send an email to <a
                      moz-do-not-send=3D"true"
                      href=3D"mailto:usrp-users-leave@lists.ettus.com"
                      target=3D"_blank">usrp-users-leave@lists.ettus.com<=
/a></span><br>
                </div>
              </blockquote>
            </div>
