...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 58D4C3C2714
	for <lists+usrp-users@lfdr.de>; Fri,  9 Jul 2021 17:51:04 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 5D0D6384938
	for <lists+usrp-users@lfdr.de>; Fri,  9 Jul 2021 11:51:03 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="l3TsFDGv";
	dkim-atps=neutral
Received: from mail-qk1-f180.google.com (mail-qk1-f180.google.com [209.85.222.180])
	by mm2.emwd.com (Postfix) with ESMTPS id 91597384821
	for <usrp-users@lists.ettus.com>; Fri,  9 Jul 2021 11:50:11 -0400 (EDT)
Received: by mail-qk1-f180.google.com with SMTP id e14so9724291qkl.9
        for <usrp-users@lists.ettus.com>; Fri, 09 Jul 2021 08:50:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=message-id:date:from:user-agent:mime-version:to:subject:references
         :in-reply-to;
        bh=s4nboBCBBh3t6mwdY2m2ZHayRh67oJJWFJubbKzOYjw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=s4nboBCBBh3t6mwdY2m2ZHayRh67oJJWFJubbKzOYjw=;
        b=
X-Gm-Message-State: AOAM532MunnLKTL0cSu/DoigGBKcG8Nf3p2CuVk2oHJncxhy2iZurQ2N
	65KOI2Tf08xcMS1PO2HtIs2kbfsj6QIrxQ==
X-Google-Smtp-Source: ABdhPJz1QhqovPO0GxvSSG3h0S3yv+OpHw3Fy6YZgBvInh8L8lENXucBnKse7fkWnMJ/7RI1vNWF2g==
X-Received: by 2002:a37:a2d4:: with SMTP id l203mr34494179qke.154.1625845810840;
        Fri, 09 Jul 2021 08:50:10 -0700 (PDT)
Received: from [192.168.2.12] (bras-base-smflon1825w-grc-18-76-67-104-5.dsl.bell.ca. [76.67.104.5])
        by smtp.googlemail.com with ESMTPSA id z188sm2753566qkd.68.2021.07.09.08.50.10
        for <usrp-users@lists.ettus.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 09 Jul 2021 08:50:10 -0700 (PDT)
Message-ID: <60E87031.4000103@gmail.com>
Date: Fri, 09 Jul 2021 11:50:09 -0400
From: "Marcus D. Leech" <patchvonbraun@gmail.com>
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:31.0) Gecko/20100101 Thunderbird/31.7.0
MIME-Version: 1.0
To: usrp-users@lists.ettus.com
References: <0f01b8f9-0390-462f-f650-3e108ced0508@cttc.es> <60E843EE.2020702@gmail.com> <de086712-0b2c-bd0a-2403-a21e3d60195c@cttc.es>
In-Reply-To: <de086712-0b2c-bd0a-2403-a21e3d60195c@cttc.es>
Message-ID-Hash: X3UWWFIXGUVMNITJDZQSIYP44UCYG2ZM
X-Message-ID-Hash: X3UWWFIXGUVMNITJDZQSIYP44UCYG2ZM
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/X3UWWFIXGUVMNITJDZQSIYP44UCYG2ZM/>
...
Content-Type: multipart/mixed; boundary="===============3410884646250787009=="

This is a multi-part message in MIME format.
--===============3410884646250787009==
Content-Type: multipart/alternative;
 boundary="------------030500020206010003090102"

This is a multi-part message in MIME format.
--------------030500020206010003090102
...
> Thanks Marcus.
>
> It helped to resolve the error. But UHD consistently prints "L" in the=20
> output.
>
...
Content-Type: multipart/related;
 boundary="------------000201000505010701070909"


--------------000201000505010701070909
...
<html>
  ...
  <body bgcolor=3D"#FFFFFF" text=3D"#000000">
    ...
    <blockquote cite=3D"mid:de086712-0b2c-bd0a-2403-a21e3d60195c@cttc.es"
      type=3D"cite">
      <meta http-equiv=3D"Content-Type" content=3D"text/html;
        charset=3Dwindows-1252">
      <p>Thanks Marcus.</p>
      <p>It helped to resolve the error. But UHD consistently prints "L"
        in the output.</p>
    ...
    <blockquote cite=3D"mid:de086712-0b2c-bd0a-2403-a21e3d60195c@cttc.es"
      ...
      <blockquote type=3D"cite" cite=3D"mid:60E843EE.2020702@gmail.com">
        <meta content=3D"text/html; charset=3Dwindows-1252"
          http-equiv=3D"Content-Type">
        <div class=3D"moz-cite-prefix">On 07/09/2021 07:40 AM, Armin Ghan=
i
          wrote:<br>
        </div>
        <blockquote
          ...
          <p>Executing: /usr/bin/python3 -u
            ...
            0xD0C0000000000000)<br>
            [INFO] [MULTI_USRP]=A0=A0=A0=A0 1) catch time transition at p=
ps edge<br>
        ...
        What happens if you use the "skip_dram=3D1" argument in the devic=
e
        argument?<br>
        <br>
        <br>
	...
	{page:WordSection1;}</style> </p>
        <p class=3D"MsoNormal"
          style=3D"margin-bottom:0in;line-height:normal"><img
            src=3D"cid:part3.02000205.01080201@gmail.com" align=3D"left"
...
Content-ID: <part3.02000205.01080201@gmail.com>
