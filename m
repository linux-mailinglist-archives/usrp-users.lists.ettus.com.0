...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B127490AC9
	for <lists+usrp-users@lfdr.de>; Mon, 17 Jan 2022 15:53:41 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 527C63850EE
	for <lists+usrp-users@lfdr.de>; Mon, 17 Jan 2022 09:53:40 -0500 (EST)
Authentication-Results: mm2.emwd.com;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=univ-ubs.fr header.i=@univ-ubs.fr header.b="mW+WHT3B";
	dkim-atps=neutral
Received: from smtpout02-ext4.partage.renater.fr (smtpout02-ext4.partage.renater.fr [194.254.241.31])
	by mm2.emwd.com (Postfix) with ESMTP id 68E2C3850EE
	for <usrp-users@lists.ettus.com>; Mon, 17 Jan 2022 09:52:40 -0500 (EST)
Received: from zmtaout02.partage.renater.fr (zmtaout02.partage.renater.fr [194.254.241.30])
	by smtpout20.partage.renater.fr (Postfix) with ESMTP id 7ED43C0148;
	Mon, 17 Jan 2022 15:52:36 +0100 (CET)
Received: from zmtaout02.partage.renater.fr (localhost [127.0.0.1])
	by zmtaout02.partage.renater.fr (Postfix) with ESMTPS id 6079820E02;
	Mon, 17 Jan 2022 15:51:39 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by zmtaout02.partage.renater.fr (Postfix) with ESMTP id 4737820E6D;
	Mon, 17 Jan 2022 15:51:39 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.10.3 zmtaout02.partage.renater.fr 4737820E6D
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=univ-ubs.fr;
	s=17793E05-77B4-4C60-8F0C-0A8087DD0087; t=1642431099;
	bh=TuKRIJVYt1HIoySOdFUnKHEAUdP7C6IrQaMkazL3dk0=;
	h=Message-ID:Date:MIME-Version:From:To;
	b=
...
Received: from zmtaout02.partage.renater.fr ([127.0.0.1])
	...
	with ESMTP id sI97rD9x54x6; Mon, 17 Jan 2022 15:51:39 +0100 (CET)
Received: from [0.0.0.0] (unknown [194.254.241.251])
	by zmtaout02.partage.renater.fr (Postfix) with ESMTPA id E40A820E02;
	Mon, 17 Jan 2022 15:51:38 +0100 (CET)
Message-ID: <2deb19c5-a38a-2db7-5789-3a297e134452@univ-ubs.fr>
Date: Mon, 17 Jan 2022 15:51:38 +0100
MIME-Version: 1.0
...
References: <7a0dba07-cfba-e011-e7d5-d0d7624a6218@univ-ubs.fr>
 ...
 <932ad7c6-d1da-b50b-578e-a41ae1264329@univ-ubs.fr>
X-Pep-Version: 2.1
In-Reply-To: <932ad7c6-d1da-b50b-578e-a41ae1264329@univ-ubs.fr>
X-Renater-Ptge-SpamState: clean
X-Renater-Ptge-SpamScore: -100
Message-ID-Hash: ADVQMGZQOV3FLPERYD2OZCCKABGXFC3G
X-Message-ID-Hash: ADVQMGZQOV3FLPERYD2OZCCKABGXFC3G
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/ADVQMGZQOV3FLPERYD2OZCCKABGXFC3G/>
...
Content-Type: multipart/mixed; boundary="===============0568185547531631419=="

--===============0568185547531631419==
Content-Language: en-US
Content-Type: multipart/alternative; boundary="47cf43c66f3c0e1528e05d54517ac597"

--47cf43c66f3c0e1528e05d54517ac597
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: quoted-printable

Hello,

Is there any new idea on the topic=3F Is this a bug in the fir=5Ffilter =20
R=46NoC block=3F I haven't found a way to make it work yet...

Camille.

On 1/14/22 10:41, Camille Moniere wrote:
> Just a typo, I used firS in the file, and I change the first =20
> occurrence while pasting the file, considering my use of fir0 in my
> explanations.
> There it is, with only fir0 (even if it does not change the initial =20
> issue):
>
> =23 General parameters
> =23 -----------------------------------------
> schema: rfnoc=5Fimagebuilder=5Fargs=23 Identifier for the schema used t=
o =20
> validate this file
> copyright: 'Camille Moni=C3=A8re'=23 Copyright information used in file=
 headers
...
> =23 ------------------------------------------
> =23 =46ormat: A list of connection maps (list of key-value pairs) with =
the =20
> following keys
...
> =23 BSP Connections
> - =7B srcblk: radio0, srcport: ctrl=5Fport, dstblk: =5Fdevice=5F, dstpo=
rt: =20
> ctrlport=5Fradio0=7D
> - =7B srcblk: =5Fdevice=5F, srcport: x300=5Fradio0, dstblk: radio0, dst=
port: =20
> x300=5Fradio=7D
> - =7B srcblk: =5Fdevice=5F, srcport: time=5Fkeeper, dstblk: radio0, dst=
port: =20
> time=5Fkeeper=7D
...
> clk=5Fdomains:
> - =7B srcblk: =5Fdevice=5F, srcport: radio, dstblk: radio0, dstport: ra=
dio=7D
...
>> fir0. But I also would have expected rfnoc=5Fimage=5Fbuilder to throw =
an =20
>> error for that.
>>
>> Wade
...
>>     =23 General parameters
>>     =23 -----------------------------------------
>>     schema: rfnoc=5Fimagebuilder=5Fargs=23 Identifier for the schema u=
sed
...
>>     =23 A list of all static connections in design
>>     =23 ------------------------------------------
>>     =23 =46ormat: A list of connection maps (list of key-value pairs)
...
0=7D
>>     - =7B srcblk: ddc0, srcport: out=5F0, dstblk: firS, dstport: in=5F=
0=7D
>>     - =7B srcblk: firS, srcport: out=5F0, dstblk: ep0, dstport: in0=7D=

>>     =23 BSP Connections
>>     - =7B srcblk: radio0, srcport: ctrl=5Fport, dstblk: =5Fdevice=5F,
>>     dstport: ctrlport=5Fradio0=7D
...
>>     clk=5Fdomains:
>>     - =7B srcblk: =5Fdevice=5F, srcport: radio, dstblk: radio0, dstpor=
t: radio=7D
>>     - =7B srcblk: =5Fdevice=5F, srcport: ce, dstblk: ddc0, dstport: ce=
=7D
>>     - =7B srcblk: =5Fdevice=5F, srcport: ce, dstblk: firS, dstport: ce=
=7D
>>
>>
...
20e6=22)
>>     radio=5Fcrtl =3D uhd.rfnoc.RadioControl(graph.get=5Fblock(=220/Rad=
io=230=22))
>>     ddc=5Fcrtl =3D uhd.rfnoc.DdcBlockControl(graph.get=5Fblock(=220/DD=
C=230=22))
...
>>     actual=5Frf=5Ffreq =3D radio=5Fcrtl.set=5Frx=5Ffrequency(target=5F=
freq, 0)
...
>>     stream=5Fcmd =3D uhd.types.StreamCMD(uhd.types.StreamMode.num=5Fdo=
ne)
>>     stream=5Fcmd.stream=5Fnow =3D True
>>     stream=5Fcmd.num=5Fsamps =3D num=5Fsamps
>>     stream=5Fcmd.time=5Fspec =3D uhd.types.TimeSpec(1, 0) =23 Wait 1s =
before
>>     reception
...
>>>     input of the =46IR filter. Something like this in your clk=5Fdoma=
ins
>>>     section:
>>>
>>>     clk=5Fdomains:
>>>     =C2=A0 =C2=A0 - =7B srcblk: =5Fdevice=5F, srcport: ce, dstblk: fi=
r0, dstport: ce =7D
>>>
>>>     Wade
>>>
>>>     On Thu, Jan 13, 2022 at 10:04 AM Wade =46ife <wade.fife=40ettus.c=
om>
>>>     wrote:
>>>
>>>         Hi Camille,
...
>>>             When the =46IR is used, I can't retrieve any data. I got
>>>             an Overflow
...
>>>             for each new input
>>>             (sc16 too). Am I wrong=3F Or is there specific setup I
>>>             have forgotten=3F
...
=3DUT=46-8=22>
  ...
  <body>
    Hello,<br>
    <br>
    Is there any new idea on the topic=3F Is this a bug in the fir=5Ffilt=
er
    R=46NoC block=3F I haven't found a way to make it work yet...<br>
    <br>
    Camille.<br>
    <br>
    <div class=3D=22moz-cite-prefix=22>On 1/14/22 10:41, Camille Moniere
      wrote:<br>
    </div>
    <blockquote type=3D=22cite=22
      cite=3D=22mid:932ad7c6-d1da-b50b-578e-a41ae1264329=40univ-ubs.fr=22=
>
...
et=3DUT=46-8=22>
      ...
      occurrence while pasting the file, considering my use of <tt>fir0</=
tt>
      in my<br>
      explanations. <br>
      ...
      <br>
      <div style=3D=22color: =23d4d4d4;background-color: =231e1e1e;font-f=
amily: 'Droid Sans Mono =46or Powerline', 'Droid Sans Mono', 'monospace',=
 monospace, 'Droid Sans =46allback';font-weight: normal;font-size: 14px;l=
ine-height: 19px;white-space: pre;=22><div><span style=3D=22color: =236a9=
955;=22>=23 General parameters</span></div><div><span style=3D=22color: =23=
...
mail.gmail.com=22>
        ...
        <div class=3D=22gmail=5Fquote=22>
          <div dir=3D=22ltr=22 class=3D=22gmail=5Fattr=22>On Thu, Jan 13,=
 2022 at
            11:19 AM Camille Moniere &lt;<a
              href=3D=22mailto:camille.moniere=40univ-ubs.fr=22
              moz-do-not-send=3D=22true=22 class=3D=22moz-txt-link-freete=
xt=22>camille.moniere=40univ-ubs.fr</a>&gt;
            wrote:<br>
          </div>
          <blockquote class=3D=22gmail=5Fquote=22 style=3D=22margin:0px 0=
px 0px
            0.8ex;border-left:1px solid
            rgb(204,204,204);padding-left:1ex=22>
            <div> Hi wade, <br>
              <br>
              I had already linked the =46IR <tt>ce</tt> to the <tt>ce</t=
t>
              of the <tt>=5Fdevice=5F</tt>.<br>
              <br>
              Also, this custom image aims only to receive data (so no <t=
t>duc</tt>
              ...
              <br>
              Here the YAML file I use with <tt>rfnoc=5Fimage=5Fbuilder</=
tt>:<br>
              <br>
              <div style=3D=22color:rgb(212,212,212);background-color:rgb=
(30,30,30);font-family:&quot;Droid Sans Mono =46or Powerline&quot;,&quot;=
Droid Sans Mono&quot;,&quot;monospace&quot;,monospace,&quot;Droid Sans =46=
allback&quot;;font-weight:normal;font-size:14px;line-height:19px;white-sp=
ace:pre-wrap=22><div><span style=3D=22color:rgb(106,153,85)=22>=23 Genera=
l parameters</span></div><div><span style=3D=22color:rgb(106,153,85)=22>=23=
 -----------------------------------------</span></div><div><span style=3D=
...
Droid Sans Mono&quot;,&quot;monospace&quot;,monospace,&quot;Droid Sans =46=
allback&quot;;font-weight:normal;font-size:14px;line-height:19px;white-sp=
ace:pre-wrap=22><div><span style=3D=22color:rgb(197,134,192)=22>import</s=
pan><span style=3D=22color:rgb(212,212,212)=22> numpy </span><span style=3D=
...
>
              <br>
              Without the =46ir (and adapting the code of course), I get
              ...
              <blockquote type=3D=22cite=22>
                <div dir=3D=22ltr=22>
                  <div>In particular, make sure you have a clock
                    connected to the CE input of the =46IR filter.
                    Something like this in your clk=5Fdomains section:</d=
iv>
                  <div><br>
                  </div>
                  <div>clk=5Fdomains:</div>
                  <div>=C2=A0 =C2=A0 - =7B srcblk: =5Fdevice=5F, srcport:=
 ce, dstblk:
                ...
                <br>
                <div class=3D=22gmail=5Fquote=22>
                  <div dir=3D=22ltr=22 class=3D=22gmail=5Fattr=22>On Thu,=
 Jan 13, 2022
                    at 10:04 AM Wade =46ife &lt;<a
                      href=3D=22mailto:wade.fife=40ettus.com=22 target=3D=
=22=5Fblank=22
                      moz-do-not-send=3D=22true=22
                      class=3D=22moz-txt-link-freetext=22>wade.fife=40ett=
us.com</a>&gt;
                    wrote:<br>
                  </div>
                  <blockquote class=3D=22gmail=5Fquote=22 style=3D=22marg=
in:0px 0px
                    ...
                    <div dir=3D=22ltr=22>
                      ...
                      <div>Maybe you could share your R=46NoC YML file an=
d
                    ...
                    <br>
                    <div class=3D=22gmail=5Fquote=22>
                      <div dir=3D=22ltr=22 class=3D=22gmail=5Fattr=22>On =
Thu, Jan 13,
                        2022 at 8:32 AM Camille Moniere &lt;<a
                          href=3D=22mailto:camille.moniere=40univ-ubs.fr=22=

                          target=3D=22=5Fblank=22 moz-do-not-send=3D=22tr=
ue=22
                          class=3D=22moz-txt-link-freetext=22>camille.mon=
iere=40univ-ubs.fr</a>&gt;
                        wrote:<br>
                      </div>
                      <blockquote class=3D=22gmail=5Fquote=22 style=3D=22=
margin:0px
                        0px 0px 0.8ex;border-left:1px solid
                        rgb(204,204,204);padding-left:1ex=22>Hello
                        everyone,<br>
                        <br>
...
.
                        ...
                        I even got a =22Late=C2=A0 <br>
                        Command=22 error, even when using=C2=A0 R=46NoC i=
n C++<br>
                        ...
                        (sc16 too). Am I wrong=3F Or is there specific
                        setup I have forgotten=3F<br>
...
lists.ettus.com</a><br>
                        To unsubscribe send an email to <a
                          href=3D=22mailto:usrp-users-leave=40lists.ettus=
.com=22
                          target=3D=22=5Fblank=22 moz-do-not-send=3D=22tr=
ue=22
                          class=3D=22moz-txt-link-freetext=22>usrp-users-=
leave=40lists.ettus.com</a><br>
                      </blockquote>
                    </div>
                  </blockquote>
                </div>
