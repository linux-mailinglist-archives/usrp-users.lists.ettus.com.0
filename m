...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id A4531105B8A
	for <lists+usrp-users@lfdr.de>; Thu, 21 Nov 2019 22:02:40 +0100 (CET)
Received: from [::1] (port=39108 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1iXtb2-00030i-1F; Thu, 21 Nov 2019 16:02:36 -0500
Received: from mail-lj1-f169.google.com ([209.85.208.169]:44590)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <jlockhartrt@gmail.com>)
 id 1iXtay-0002u2-0w
 for usrp-users@lists.ettus.com; Thu, 21 Nov 2019 16:02:32 -0500
Received: by mail-lj1-f169.google.com with SMTP id g3so4779725ljl.11
 for <usrp-users@lists.ettus.com>; Thu, 21 Nov 2019 13:02:11 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=CAiX1IDzfC0kwGLaL+U2fM9ykH/OzNAC77+jL8fpuBc=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=CAiX1IDzfC0kwGLaL+U2fM9ykH/OzNAC77+jL8fpuBc=;
 b=
X-Gm-Message-State: APjAAAXezzHoHQTGgO/Kej9y63trTMY7Nqd88G9IdptzeSCptCxRJidu
 RjGHNXVRAbIilXmv/J5xvHSh3o53LgKdiES+/1U=
X-Google-Smtp-Source: APXvYqyRg1tWyYF1TQZ5wAUY2O/fOBeTJFOoMOBeHZAY7KAEq6AyeJhQJP92tW4XxpteS/5PvmDfuc1D6/Z8oVCYejI=
X-Received: by 2002:a2e:9247:: with SMTP id v7mr4296170ljg.55.1574370110719;
 Thu, 21 Nov 2019 13:01:50 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CALY+5sJjLEtyF9R2wvA+eiCOQyMpS6=89=HR0J+e-teE+-Du_A@mail.gmail.com>
Date: Thu, 21 Nov 2019 15:59:08 -0500
Message-ID: <CALY+5sKfTtaUu-qhvbKcVNPke3Lb4zkurwqf7LmDJVmn3vyL+Q@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============5474799443648380564=="
...
--===============5474799443648380564==
Content-Type: multipart/alternative; boundary="00000000000031cd370597e19b67"

--00000000000031cd370597e19b67
...
<div dir=3D"ltr"><div>Also, when I compiled from the OOT directory for ARM,=
 I used this command, which I pieced together from the RFNoC build guide, a=
nd the release-4 guide for cross-compiling gr-ettus. <br></div><div><br></d=
iv><div>cmake -DCMAKE_TOOLCHAIN_FILE=3D~/rfnoc/src/gnuradio/cmake/Toolchain=
s/oe-sdk_cross.cmake -DCMAKE_INSTALL_PREFIX=3D/usr -DUHD_FPGA_DIR=3D&quot;/=
home/jon/rfnoc/src/uhd/fpga-src/&quot; ../</div><div><br></div><div>Regards=
,</div><div>Jon<br></div></div><br><div class=3D"gmail_quote"><div dir=3D"l=
tr" class=3D"gmail_attr">On Thu, Nov 21, 2019 at 3:48 PM Jonathan Lockhart =
&lt;<a href=3D"mailto:jlockhartrt@gmail.com">jlockhartrt@gmail.com</a>&gt; =
...
t:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"auto">Hi Jon,<di=
v dir=3D"auto"><br></div><div dir=3D"auto">The rfnoc &quot;nocscript&quot; =
xml definition can create arguments and attach to the device tree like you =
are trying to set there (it&#39;s not compiled directly, but rather created=
 dynamically from the xml definition)</div><div dir=3D"auto"><br></div><div=
 dir=3D"auto">Recommended debugging...</div><div dir=3D"auto">1. Check your=
 OOT gain block xml (in rfnoc/blocks) and make sure it has a &quot;gain&quo=
t; field in the &quot;args&quot; list. You&#39;ll also want to make sure it=
 writes your desired register, but I don&#39;t think you&#39;re even gettin=
g that far</div><div dir=3D"auto">2. Make sure the block xml is installed o=
n the e310 embedded prefix and is found at run time during uhd_usrp_probe a=
nd when running your application. If it&#39;s not in the right place or not=
 attaching to your block then it won&#39;t create the gain argument</div><d=
iv dir=3D"auto"><br></div><div dir=3D"auto">I&#39;m guessing it&#39;s one o=
f those two possibilities...=C2=A0</div><div dir=3D"auto">EJ</div></div><br=
><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, N=
ov 21, 2019, 3:19 PM Jonathan Lockhart via USRP-users &lt;<a href=3D"mailto=
...
r=3D"ltr"><div>Greetings,</div><div><br></div><div>I was able to get the AR=
M cross compile working. I removed the build directory and re-sourced the d=
ev environment and then the cross-compile used the -mfloar=3Dhard flag. Not=
 sure what caused the issue earlier and why it wasn&#39;t picking it up. <b=
r></div><div><br></div><div>Now I have a different issue. So I have complet=
ed this guide: <a href=3D"https://kb.ettus.com/Getting_Started_with_RFNoC_D=
evelopment" rel=3D"noreferrer noreferrer" target=3D"_blank">https://kb.ettu=
s.com/Getting_Started_with_RFNoC_Development</a></div><div><br></div><div>I=
 modified the GNURadio just a bit so that the output from gain was placed o=
n a ZMQ push, and the graphics were on the host to graph the signal (seen i=
n the screenshots below).</div><div><br></div><div><img src=3D"https://mail=
.google.com/mail/?ui=3D2&amp;ik=3D1ae818862e&amp;attid=3D0.1&amp;th=3D16e8f=
a0d29d41a0b&amp;view=3Dfimg&amp;rm=3D16e8fa0d29d41a0b&amp;sz=3Dw1600-h1000&=
amp;attbid=3DANGjdJ9y7gFvlLamcYxSJn6AlQPaOWxC-yKbQfs66eomTeFYM6q3_niAOKNUXc=
1Zg3SMXvqL5kKB2WW0iVIUpeHmo3J5jnu8i5PrKbSufhNtuNcli1NuCSF6ANVjs9A&amp;disp=
=3Demb&amp;realattid=3Dii_k395j53q0&amp;zw" alt=3D"Screenshot from 2019-11-=
21 15-06-33.jpg" width=3D"566" height=3D"323"></div><div><br></div><div><di=
v><div><img src=3D"https://mail.google.com/mail/?ui=3D2&amp;ik=3D1ae818862e=
&amp;attid=3D0.2&amp;th=3D16e8fa0d29d41a0b&amp;view=3Dfimg&amp;rm=3D16e8fa0=
d29d41a0b&amp;sz=3Dw1600-h1000&amp;attbid=3DANGjdJ-pgUA2IxgobGph9ydEXrRSxBi=
Z2abKuAIUC6-7E30-eRFqzoPp7Si4HBspS4AqGUMX1xI3FnJFhwEqKs4fyPQ6s4_qFai45x5Qaz=
bWRR2aPlrFaKrc6EfeGhw&amp;disp=3Demb&amp;realattid=3Dii_k395j8qd1&amp;zw" a=
lt=3D"Screenshot from 2019-11-21 15-010-44.jpg" width=3D"566" height=3D"335=
"><br></div></div><div><br></div><div>However, when I run the top file for =
the USRP, I am running into this error. <br></div><div><br></div><div>Trace=
back (most recent call last):<br>=C2=A0 File &quot;rfnoc_myGain_usrp.py&quo=
t;, line 223, in &lt;module&gt;<br>=C2=A0 =C2=A0 main()<br>=C2=A0 File &quo=
t;rfnoc_myGain_usrp.py&quot;, line 212, in main<br>=C2=A0 =C2=A0 tb =3D top=
_block_cls(fpga_path=3Doptions.fpga_path, rx_gain=3Doptions.rx_gain, rx_dig=
ital_gain=3Doptions.rx_digital_gain, rx_freq=3Doptions.rx_freq, host_ip_add=
r=3Doptions.host_ip_addr)<br>=C2=A0 File &quot;rfnoc_myGain_usrp.py&quot;, =
line 117, in __init__<br>=C2=A0 =C2=A0 self.tutorial_gain_0.set_arg(&quot;g=
ain&quot;, rx_digital_gain)<br>=C2=A0 File &quot;/home/root/newinstall/usr/=
lib/python2.7/site-packages/tutorial/tutorial_swig.py&quot;, line 315, in s=
et_arg<br>=C2=A0 =C2=A0 return _tutorial_swig.gain_sptr_set_arg(self, *args=
)<br>RuntimeError: LookupError: Path not found in tree: /mboards/0/xbar/gai=
n_0/args/0/gain/value</div><div><br></div><div>No where else in building GN=
URadio scripts and .bit files does this &quot;/mboards&quot; arise, and I h=
ave looked through my verilog file for gain (gain.v) and it is correct per =
the instructions in the linked guide, and I built the python and gnuradio h=
ook exactly as the instructions stated to. <br></div><div><br></div><div>An=
yone have an troubleshooting ideas b/c I am currently at a loss. It did pas=
t the test bench they have you build with no issues. <br></div><div><br></d=
iv><div>Regards,</div><div></div><div></div><div>Jon</div><div><br></div><d=
iv><br></div><div><br></div></div></div></div></div><br><div class=3D"gmail=
_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Nov 20, 2019 at 3:21 =
PM Jonathan Lockhart &lt;<a href=3D"mailto:jlockhartrt@gmail.com" rel=3D"no=
referrer noreferrer" target=3D"_blank">jlockhartrt@gmail.com</a>&gt; wrote:=
<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8=
ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr=
"><div dir=3D"ltr"><div>Greetings,</div><div><br></div><div>I am having som=
e issues completing the RFNOC build tutorial on the Ettus E312. The referen=
ce documentation is using an X3xx series radio, and from the final python s=
cript it appears to be running the GNR script natively on the host. I built=
 the exact script from the KB but when running on the radio it fails statin=
g it can&#39;t &quot;import tutorial.&quot; I realized all the files that w=
ere installed were placed on the host but not cross compiled for the E3xx u=
sing the SDK and ARM cross compile tool. I tried to complete this task, but=
 unfortunately the compilation dies here. </div><div><br></div><div>/home/j=
on/rfnoc/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi/usr/include/gnu/stu=
bs.h:7:11: fatal error: gnu/stubs-soft.h: No such file or directory<br>=C2=
=A0# include &lt;gnu/stubs-soft.h&gt;<br>=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0=
 =C2=A0^~~~~~~~~~~~~~~~~~<br>compilation terminated.</div><div><br></div><d=
iv>Now I did find the stubs-soft.h file in the libc6-dev-armel-cross in the=
 apt repo. I installed it and tried to cp the file into the /home/jon/rfnoc=
/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi/usr/include/gnu/ location b=
ut it still doesn&#39;t like that. I verified that on my echo $CC that the =
-mfloat is set to hard as shown here.</div><div><br></div><div>jon@jon-Opti=
Plex-9020:~/rfnoc/src/rfnoc-tutorial$ echo $CC<br>arm-oe-linux-gnueabi-gcc =
-march=3Darmv7-a -mfloat-abi=3Dhard -mfpu=3Dneon --sysroot=3D/home/jon/rfno=
c/oe/sysroots/armv7ahf-vfp-neon-oe-linux-gnueabi</div><div><br></div><div>S=
o I am not sure why the gain module in the tutorial is looking for the soft=
 file. <br></div><div><br></div><div>If anyone has experience in porting th=
eir OOT modules over to the E-series of radios I would appreciate the help.=
 <br></div><div><br></div><div>Regards,</div><div>Jon<br></div></div></div>
</blockquote></div></div>
