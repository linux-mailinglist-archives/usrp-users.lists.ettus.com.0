...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 648EBB15DCA
	for <lists+usrp-users@lfdr.de>; Wed, 30 Jul 2025 12:06:50 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 41B33386791
	for <lists+usrp-users@lfdr.de>; Wed, 30 Jul 2025 06:06:49 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1753870009; bh=olMtXGeTMXCz6CAQxfn+2JVlYkE4ezI+5OCVArtLiRE=;
	h=References:In-Reply-To:From:Date:Cc:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=
Received: from mail-ej1-f41.google.com (mail-ej1-f41.google.com [209.85.218.41])
	by mm2.emwd.com (Postfix) with ESMTPS id 19D1338677E
	for <usrp-users@lists.ettus.com>; Wed, 30 Jul 2025 06:06:13 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=ettus-com.20230601.gappssmtp.com header.i=@ettus-com.20230601.gappssmtp.com header.b="hdEJmI8E";
	dkim-atps=neutral
Received: by mail-ej1-f41.google.com with SMTP id a640c23a62f3a-ae3be3eabd8so184215566b.1
        for <usrp-users@lists.ettus.com>; Wed, 30 Jul 2025 03:06:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ettus-com.20230601.gappssmtp.com; s=20230601; t=1753869972; x=1754474772; darn=lists.ettus.com;
        h=cc:subject:message-id:date:from:in-reply-to:references:mime-version
         :from:to:cc:subject:date:message-id:reply-to;
        bh=9J06EVawbLi/l9YZL5xrPr1fT438i0u3T79wS/GWeSI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1753869972; x=1754474772;
        h=cc:subject:message-id:date:from:in-reply-to:references:mime-version
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=9J06EVawbLi/l9YZL5xrPr1fT438i0u3T79wS/GWeSI=;
        b=
X-Gm-Message-State: AOJu0YwdGOIn1xmNLuUH17P7eZ9Zmdng2QA8nO2+7yHIqObfgMrFzcy9
	6kP7arEpKZKL5A8MuzK7h7f24f8FG/LtLuc1ICYrpsy/iiHMfRgywNh8EcPve7rNjsi/mQUdPBF
	0bmTnHS6QZ2NXWMqL7aRuwENzgggTyFxkE+D8HwROc9Bs5jeWa7A3UZo=
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IF3xW/0YTiFyHZzcVZX1D+ztuF/g5RPDYxDbNNiRvL4q+GiA05CD4bNW3JmKFZgYd4ikaA4AwWk8gzFQth8Oak=
X-Received: by 2002:a17:906:d555:b0:af2:31a9:c981 with SMTP id
 a640c23a62f3a-af8fd353894mr325251266b.23.1753869970702; Wed, 30 Jul 2025
 03:06:10 -0700 (PDT)
MIME-Version: 1.0
...
Date: Wed, 30 Jul 2025 12:05:56 +0200
X-Gm-Features: Ac12FXx6O6Kgir6jnSZJbOxf9GvbqngA1Gp2mXemj4NqYLBdrkVVc0_tfkC7y9c
Message-ID: <CAFOi1A4-F0zGAfF_C5aBBwTy1UwzE=LcsHy4esHUKU-R1fzaZA@mail.gmail.com>
Cc: "usrp-users@lists.ettus.com" <usrp-users@lists.ettus.com>
Message-ID-Hash: 76BBP5EDDIXH667OSJPRC5VSTK27ZKX3
X-Message-ID-Hash: 76BBP5EDDIXH667OSJPRC5VSTK27ZKX3
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/76BBP5EDDIXH667OSJPRC5VSTK27ZKX3/>
...
Content-Type: multipart/mixed; boundary="===============5123508949456184008=="

--===============5123508949456184008==
Content-Type: multipart/related; boundary="0000000000009847bb063b22acf6"

--0000000000009847bb063b22acf6
Content-Type: multipart/alternative; boundary="0000000000009847ba063b22acf5"

--0000000000009847ba063b22acf5
...
On Tue, Jul 29, 2025 at 5:27=E2=80=AFPM Kevin Williams <kevin.williams@vast=
ech.co.za>
wrote:
...
092992d45/fpga/usrp3/lib/rfnoc/blocks/rfnoc_block_radio/radio_rx_core.v#L56=
5
> <https://url.za.m.mimecastprotect.com/s/yS8OCg5KEEcwEvmhNf8i42SUD?domain=
=3Dgithub.com>
>
>
>
...
<div dir=3D"ltr"><div>It&#39;s a headscratcher, for sure. *Something* is ho=
lding up the radio. I&#39;m very sure that if you connect just the radio, o=
r the radio+DDC to an SEP and do remote streaming, it won&#39;t choke. But =
if it does, then I&#39;d like to know so we can look into it.</div><div><br=
></div><div>--M</div></div><br><div class=3D"gmail_quote gmail_quote_contai=
ner"><div dir=3D"ltr" class=3D"gmail_attr">On Tue, Jul 29, 2025 at 5:27=E2=
...
4,204,204);padding-left:1ex"><div class=3D"msg8253101306612140783"><div lan=
g=3D"EN-ZA"><div class=3D"m_8253101306612140783WordSection1"><p class=3D"Ms=
oNormal"><span>This is the issue =E2=80=93 my block processes inputs 1:1 wi=
thout requiring to give back-pressure.<u></u><u></u></span></p><p class=3D"=
MsoNormal"><span><u></u>=C2=A0<u></u></span></p><p class=3D"MsoNormal"><spa=
n>It decimates, sure, but that is 1:N.<u></u><u></u></span></p><p class=3D"=
MsoNormal"><span><u></u>=C2=A0<u></u></span></p><p class=3D"MsoNormal"><spa=
n>I don=E2=80=99t understand how that radio block can get its fifo nearly f=
ull?<u></u><u></u></span></p><p class=3D"MsoNormal"><span><u></u>=C2=A0<u><=
/u></span></p><p class=3D"MsoNormal"><b><span lang=3D"EN-US">From:</span></=
b><span lang=3D"EN-US"> Brian Padalino &lt;<a href=3D"mailto:bpadalino@gmai=
l.com" target=3D"_blank">bpadalino@gmail.com</a>&gt; <br><b>Sent:</b> Tuesd=
ay, 29 July 2025 17:12<br><b>To:</b> Kevin Williams &lt;<a href=3D"mailto:k=
evin.williams@vastech.co.za" target=3D"_blank">kevin.williams@vastech.co.za=
</a>&gt;<br><b>Cc:</b> <a href=3D"mailto:nbalkanas@gmail.com" target=3D"_bl=
ank">nbalkanas@gmail.com</a>; <a href=3D"mailto:usrp-users@lists.ettus.com"=
 target=3D"_blank">usrp-users@lists.ettus.com</a>; Werner Bode &lt;<a href=
=3D"mailto:werner.bode@vastech.co.za" target=3D"_blank">werner.bode@vastech=
.co.za</a>&gt;<br><b>Subject:</b> Re: [USRP-users] Re: [EXTERNAL]Re: remote=
 streaming starts, but stops after a few packets received<u></u><u></u></sp=
an></p><p class=3D"MsoNormal"><u></u>=C2=A0<u></u></p><div><div><p class=3D=
"MsoNormal">On Tue, Jul 29, 2025 at 11:06=E2=80=AFAM Kevin Williams &lt;<a =
href=3D"mailto:kevin.williams@vastech.co.za" target=3D"_blank">kevin.willia=
ms@vastech.co.za</a>&gt; wrote:<u></u><u></u></p></div><div><blockquote sty=
le=3D"border-width:medium medium medium 1pt;border-style:none none none sol=
id;border-color:currentcolor currentcolor currentcolor rgb(204,204,204);pad=
ding:0cm 0cm 0cm 6pt;margin-left:4.8pt;margin-right:0cm"><div><div><div><p =
class=3D"MsoNormal">This is strange.<u></u><u></u></p><p class=3D"MsoNormal=
">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">I now assert tready perman=
ently for the radio regardless. (I before used to pass downstream tready up=
).<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=
=3D"MsoNormal">Now I still see the stream stalling, but after a few 10=E2=
=80=99000 packets of both usrp ports being used for tx (now 4x streams bein=
g transmitted).<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u=
></p><p class=3D"MsoNormal">It then drops to only one port, and then stalls=
 =E2=80=93 even though this is remote streaming.<u></u><u></u></p><p class=
=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">How is it pos=
sible that the host causes the usrp to abandon a nic in remote streaming mo=
de when the radio is always seeing tready?<u></u><u></u></p><p class=3D"Mso=
Normal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">Just before the stal=
l I still see the usrp writing an overflow packet.<u></u><u></u></p><p clas=
s=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal"><img border=
=3D"0" width=3D"1040" height=3D"838" style=3D"width: 10.8333in; height: 8.7=
291in;" id=3D"m_8253101306612140783m_1590977016333117940Picture_x0020_1" sr=
c=3D"cid:ii_1985a6e3ce74cff311"><u></u><u></u></p><p class=3D"MsoNormal">=
=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">How is this possible?<u></u>=
<u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNo=
rmal"><img border=3D"0" width=3D"1165" height=3D"51" style=3D"width: 12.135=
4in; height: 0.5312in;" id=3D"m_8253101306612140783m_1590977016333117940Pic=
ture_x0020_2" src=3D"cid:ii_1985a6e3ce85b16b22"><u></u><u></u></p><p class=
=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u>=
<u></u></p></div></div></div></blockquote><div><p class=3D"MsoNormal"><u></=
u>=C2=A0<u></u></p></div><div><p class=3D"MsoNormal">It&#39;s because of th=
e radio RX FSM here:<u></u><u></u></p></div><div><p class=3D"MsoNormal"><u>=
</u>=C2=A0<u></u></p></div><div><p class=3D"MsoNormal">=C2=A0=C2=A0<a href=
=3D"https://url.za.m.mimecastprotect.com/s/yS8OCg5KEEcwEvmhNf8i42SUD?domain=
=3Dgithub.com" target=3D"_blank">https://github.com/EttusResearch/uhd/blob/=
40403b7c00154e4559c47bd6dde924f092992d45/fpga/usrp3/lib/rfnoc/blocks/rfnoc_=
block_radio/radio_rx_core.v#L565</a><u></u><u></u></p></div><div><p class=
=3D"MsoNormal"><u></u>=C2=A0<u></u></p></div><div><p class=3D"MsoNormal">Wh=
en an error condition occurs, it reports the OVERFLOW then it waits for ano=
ther stream command to start up again.<u></u><u></u></p></div><div><p class=
=3D"MsoNormal"><u></u>=C2=A0<u></u></p></div><div><p class=3D"MsoNormal">Fo=
r what it&#39;s worth, I don&#39;t think you should blindly give it TREADY =
asserted when things can&#39;t process things downstream. The block should =
be designed such that you know you can consume all the samples in real time=
.<u></u><u></u></p></div><div><p class=3D"MsoNormal"><u></u>=C2=A0<u></u></=
p></div><div><p class=3D"MsoNormal">Brian<u></u><u></u></p></div></div></di=
v></div></div>_______________________________________________<br>
...
Content-ID: <ii_1985a6e3ce74cff311>
X-Attachment-Id: ii_1985a6e3ce74cff311
...
Content-Transfer-Encoding: base64
Content-ID: <ii_1985a6e3ce85b16b22>
X-Attachment-Id: ii_1985a6e3ce85b16b22
