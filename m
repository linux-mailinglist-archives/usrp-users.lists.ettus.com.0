...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A3076BEF1
	for <lists+usrp-users@lfdr.de>; Wed, 17 Jul 2019 17:23:41 +0200 (CEST)
Received: from [::1] (port=47256 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.92)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1hnlmN-0007r9-Dw; Wed, 17 Jul 2019 11:23:39 -0400
Received: from mail-ot1-f51.google.com ([209.85.210.51]:38463)
 by mm2.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
 (Exim 4.92) (envelope-from <nate.temple@ettus.com>)
 id 1hnlmJ-0007jj-Jo
 for usrp-users@lists.ettus.com; Wed, 17 Jul 2019 11:23:35 -0400
Received: by mail-ot1-f51.google.com with SMTP id d17so25466652oth.5
 for <usrp-users@lists.ettus.com>; Wed, 17 Jul 2019 08:23:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ettus-com.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=1KI5Aqf81Q3/W1Cb6VExwbKtAD56rtuJFoPq3PpoMX0=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=1KI5Aqf81Q3/W1Cb6VExwbKtAD56rtuJFoPq3PpoMX0=;
 b=
X-Gm-Message-State: APjAAAXLp9fMmpLi0xiGiM9R+qac0agXCt0+mJ3JZAkp/yQZcTXCWER9
 jMC8LxJ6N1Po+o1bCtTnKKcRecJZr71U8R30OsZN1TeL
X-Google-Smtp-Source: APXvYqwr+2VnjDtXcD2rSH4/V9H2mBXMUqjNhkB/av4C/24j3yLzbkj0VeEUlKvelVf2Cz5+9Y2FbAjblMY7t3Ooh9E=
X-Received: by 2002:a9d:5a91:: with SMTP id w17mr943572oth.32.1563376974865;
 Wed, 17 Jul 2019 08:22:54 -0700 (PDT)
MIME-Version: 1.0
...
Date: Wed, 17 Jul 2019 08:23:13 -0700
Message-ID: <CAL263iwxwhM8PicewVr=MKCxMSVbcM-961cf-GxVqH16ktcc6w@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============8606118414630054047=="
...
--===============8606118414630054047==
Content-Type: multipart/alternative; boundary="0000000000003cbd8c058de21197"

--0000000000003cbd8c058de21197
...
lvetica,sans-serif">Hi Sumit,<br><br>So it looks like you have multiple ver=
sion of UHD installed:<br><br>john@john-Precision-M4600:~/pybombs/src/gnura=
dio/gr-digital/examples/narrowband$ sudo ./benchmark_tx.py -f 2.45G -S 10<b=
r>linux; GNU C++ version 5.3.1 20151219; Boost_105800; UHD_003.009.002-0-un=
known<br><br><br>john@john-Precision-M4600:~/pybombs/src/uhd/host/build/exa=
mples$ sudo ./benchmark_rate --rx_rate 10e6 --duration 600<br>[INFO] [UHD] =
linux; GNU C++ version 5.4.0 20160609; Boost_105800; UHD_3.15.0.git-1-gf83f=
af28<br><br><br>I would recommend to stick to a single UHD version and use =
the latest stable tagged released (currently 3.14.1.0) you will need to mod=
ify the pybombs recipe to use the correct git tag (v3.14.1.0). The &#39;mas=
ter&#39; branch can be unstable at times.<br><br>Also, if you have a FPGA i=
mage of say 3.15.x.x flashed on the N210 and then revert back to using 3.9.=
2, and UHD does not catch the mismatch, it will likely cause flow control e=
rrors and unstable performance.<br><br>The gr-digital/examples/narrowband/b=
enchmark_tx.py example is also buggy, and is being removed from GR 3.8. Usi=
ng the UHD benchmark_rate utility will test the hardware with a limited sco=
pe.<br><br>Regards,<br>Nate Temple<br><br></div></div><br><div class=3D"gma=
il_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Jul 17, 2019 at 8:1=
0 AM Sumit Kumar &lt;<a href=3D"mailto:cogwsn@gmail.com">cogwsn@gmail.com</=
a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0p=
x 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><d=
iv dir=3D"ltr">Sorry, here it is.<div><br></div><div>Benchmark rate summary=
:<br>=C2=A0 Num received samples: =C2=A0 =C2=A0 5999986436<br>=C2=A0 Num dr=
opped samples: =C2=A0 =C2=A0 =C2=A00<br>=C2=A0 Num overruns detected: =C2=
...
ass=3D"gmail_default" style=3D"font-family:arial,helvetica,sans-serif">Hi S=
umit,<br><br>It will take 10 minutes for that run to complete. Does it prod=
uce a report at the end of the run?<br><br>Regards,<br>Nate Temple<br></div=
></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr"=
>On Wed, Jul 17, 2019 at 8:06 AM Sumit Kumar &lt;<a href=3D"mailto:cogwsn@g=
mail.com" target=3D"_blank">cogwsn@gmail.com</a>&gt; wrote:<br></div><block=
quote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1=
px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr">Hi=C2=A0Nate,<=
div>No there are not. At the end of the last line, cursor keeps blinking, n=
o sequence errors.=C2=A0<br><div><br></div><div>john@john-Precision-M4600:~=
/pybombs/src/uhd/host/build/examples$ sudo ./benchmark_rate --rx_rate 10e6 =
--duration 600<span class=3D"gmail-m_8429522937710005813gmail-m_-7763822819=
519994741gmail-m_8077291001688814057gmail-im" style=3D"color:rgb(80,0,80)">=
<br><br>[INFO] [UHD] linux; GNU C++ version 5.4.0 20160609; Boost_105800; U=
HD_3.15.0.git-1-gf83faf28<br></span>[00:00:00.000024] Creating the usrp dev=
ice with: ...<span class=3D"gmail-m_8429522937710005813gmail-m_-77638228195=
19994741gmail-m_8077291001688814057gmail-im" style=3D"color:rgb(80,0,80)"><=
...
1472 bytes<br></span>Using Device: Single USRP:<br>=C2=A0 Device: USRP2 / N=
-Series Device<br>=C2=A0 Mboard 0: N200r4<br>=C2=A0 RX Channel: 0<br>=C2=A0=
...
=A0 TX Dboard: A<br>=C2=A0 =C2=A0 TX Subdev: SBXv3 TX<br><br>[00:00:01.7968=
95] Setting device timestamp to 0...<br>[00:00:01.797430] Testing receive r=
ate 10.000000 Msps on 1 channels<br></div></div></div><br><div class=3D"gma=
il_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Jul 17, 2019 at 4:3=
9 PM Nate Temple &lt;<a href=3D"mailto:nate.temple@ettus.com" target=3D"_bl=
ank">nate.temple@ettus.com</a>&gt; wrote:<br></div><blockquote class=3D"gma=
il_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,2=
04,204);padding-left:1ex"><div dir=3D"ltr"><div class=3D"gmail_default" sty=
le=3D"font-family:arial,helvetica,sans-serif">Hi Sumit,<br><br>If you run b=
enchmark_rate for an extend period of time, do you see any sequence errors?=
<br><br>/usr/local/lib/uhd/examples/benchmark_rate --rx_rate 10e6 --duratio=
n 600<br><br><br>Regards,<br>Nate Temple</div></div><br><div class=3D"gmail=
_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Jul 17, 2019 at 7:34 =
...
ing-left:1ex"><div dir=3D"ltr">Hi=C2=A0Nate,=C2=A0<div>Yes I addressed the =
first 2 points you mentioned.=C2=A0</div><div><br></div><div>john@john-Prec=
ision-M4600:~/pybombs/src/gnuradio/gr-digital/examples/narrowband$ sudo ./b=
enchmark_tx.py -f 2.45G -S 10<br>linux; GNU C++ version 5.3.1 20151219; Boo=
st_105800; UHD_003.009.002-0-unknown<br><br>Using Volk machine: avx_64_mmx_=
orc<br>-- Opening a USRP2/N-Series device...<br>-- Current recv frame size:=
 1472 bytes<br>-- Current send frame size: 1472 bytes<br><br>No gain specif=
ied.<br>Setting gain to 15.750000 (from [0.000000, 31.500000])<br>.........=
...........................................................................=
..........SS.SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS=
SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS=
SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS.SSSS..S......SS.S......SS.....S.=
...S...S.S.......S....S........^C<br></div><div><br></div><div>I am using .=
/benchmark_tx.py located in=C2=A0gnuradio/gr-digital/examples/narrowband</d=
iv><div><br></div><div><br></div></div><br><div class=3D"gmail_quote"><div =
dir=3D"ltr" class=3D"gmail_attr">On Wed, Jul 17, 2019 at 4:25 PM Nate Templ=
...
r><br>Done<div class=3D"gmail-m_8429522937710005813gmail-m_-776382281951999=
4741gmail-m_8077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813=
456354474750gmail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m=
_-5090455826936873702gmail-yj6qo"></div><div class=3D"gmail-m_8429522937710=
005813gmail-m_-7763822819519994741gmail-m_8077291001688814057gmail-m_-27232=
75523225085977gmail-m_-6449813456354474750gmail-m_-5406334666104058457gmail=
-m_-8630331225465229725gmail-m_-5090455826936873702gmail-adL"><br></div></d=
iv></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gma=
il_attr">On Wed, Jul 17, 2019 at 3:19 PM Jason Matusiak &lt;<a href=3D"mail=
...
<div id=3D"gmail-m_8429522937710005813gmail-m_-7763822819519994741gmail-m_8=
077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456354474750g=
mail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-50904558269=
36873702gmail-m_3403553355508831478Signature">
<div>
<div id=3D"gmail-m_8429522937710005813gmail-m_-7763822819519994741gmail-m_8=
077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456354474750g=
mail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-50904558269=
36873702gmail-m_3403553355508831478appendonsend"></div>
<div style=3D"font-family:Calibri,Arial,Helvetica,sans-serif;font-size:12pt=
;color:rgb(0,0,0)">
<br>
</div>
...
077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456354474750g=
mail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-50904558269=
36873702gmail-m_3403553355508831478divRplyFwdMsg" dir=3D"ltr"><font style=
...
<br>
<div class=3D"gmail-m_8429522937710005813gmail-m_-7763822819519994741gmail-=
...
26936873702gmail-m_3403553355508831478x_gmail_quote">
<div dir=3D"ltr" class=3D"gmail-m_8429522937710005813gmail-m_-7763822819519=
...
-m_-5090455826936873702gmail-m_3403553355508831478x_gmail_attr">On Wed, Jul=
 17, 2019 at 1:50 PM Jason Matusiak &lt;<a href=3D"mailto:jason@gardettoeng=
ineering.com" target=3D"_blank">jason@gardettoengineering.com</a>&gt; wrote=
:<br>
</div>
<blockquote class=3D"gmail-m_8429522937710005813gmail-m_-776382281951999474=
1gmail-m_8077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456=
354474750gmail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-5=
090455826936873702gmail-m_3403553355508831478x_gmail_quote" style=3D"margin=
...
077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456354474750g=
mail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-50904558269=
36873702gmail-m_3403553355508831478x_gmail-m_6506407344245079092Signature">
<div>
<div id=3D"gmail-m_8429522937710005813gmail-m_-7763822819519994741gmail-m_8=
077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456354474750g=
mail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-50904558269=
36873702gmail-m_3403553355508831478x_gmail-m_6506407344245079092appendonsen=
d"></div>
<div style=3D"font-family:Calibri,Arial,Helvetica,sans-serif;font-size:12pt=
;color:rgb(0,0,0)">
<br>
...
077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813456354474750g=
mail-m_-5406334666104058457gmail-m_-8630331225465229725gmail-m_-50904558269=
36873702gmail-m_3403553355508831478x_gmail-m_6506407344245079092divRplyFwdM=
sg" dir=3D"ltr"><font style=3D"font-size:11pt" face=3D"Calibri, sans-serif"=
 color=3D"#000000"><b>From:</b> Sumit Kumar &lt;<a href=3D"mailto:cogwsn@gm=
ail.com" target=3D"_blank">cogwsn@gmail.com</a>&gt;<br>
...
9092x_gmail_attr">On Wed, Jul 17, 2019 at 1:19 PM Jason Matusiak &lt;<a hre=
...
1gmail-m_8077291001688814057gmail-m_-2723275523225085977gmail-m_-6449813