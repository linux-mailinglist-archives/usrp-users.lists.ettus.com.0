...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 72EE0B149AD
	for <lists+usrp-users@lfdr.de>; Tue, 29 Jul 2025 10:02:16 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 31DE138657F
	for <lists+usrp-users@lfdr.de>; Tue, 29 Jul 2025 04:02:15 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1753776135; bh=2tdMSOjlY9euxLLEQ0suw/OulIYv2O3ax1qJJUaIek0=;
	h=References:In-Reply-To:From:Date:Cc:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=
Received: from mail-ed1-f47.google.com (mail-ed1-f47.google.com [209.85.208.47])
	by mm2.emwd.com (Postfix) with ESMTPS id BA7CD386563
	for <usrp-users@lists.ettus.com>; Tue, 29 Jul 2025 04:01:29 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=ettus-com.20230601.gappssmtp.com header.i=@ettus-com.20230601.gappssmtp.com header.b="vnZrI8uz";
	dkim-atps=neutral
Received: by mail-ed1-f47.google.com with SMTP id 4fb4d7f45d1cf-60c4521ae2cso9378369a12.0
        for <usrp-users@lists.ettus.com>; Tue, 29 Jul 2025 01:01:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ettus-com.20230601.gappssmtp.com; s=20230601; t=1753776088; x=1754380888; darn=lists.ettus.com;
        h=cc:subject:message-id:date:from:in-reply-to:references:mime-version
         :from:to:cc:subject:date:message-id:reply-to;
        bh=hnGIDZ5gyGRcB4KkRf5w6R6jcMEp51RjxYBTakazAQQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1753776088; x=1754380888;
        h=cc:subject:message-id:date:from:in-reply-to:references:mime-version
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=hnGIDZ5gyGRcB4KkRf5w6R6jcMEp51RjxYBTakazAQQ=;
        b=
X-Gm-Message-State: AOJu0YyZ/QBo/RonBO+EbUyg7DKOOQntFwPqJMfVZ6g6Gh/FspYL+iqo
	aiVUVQOv6lWjW13leGw2H2OptjgycEFdcbTs3YzRdMe7iOxrYKCjfgPaSSu0ZpzluRl9HCYfrwr
	ln3Cm2zeu9boAHl+9SEqqgNjKUINfw5QEUObbFvO8ABx1FIBopRtjWMPjDw==
X-Gm-Gg: ASbGncuimu8cDXqJkBUet+tG11McN3l8sbvz39oXtgyw0uvpsrMUz/HGH6S6ZHA2DQa
	sRDne2rPR6o9Xtw2vODY9clPREMK5ynpyGK+00MhdWOTSdJ4JDJBQfHJ7zUo0XyDqORUPa38A+a
	AE4Ac12dDCp0JBfZghsM+zuPtTw0VX7XcD+0+/rANaUGiVEHUPKdulydVfLSpsZ5pD75nxQQ8C4
	v+hb4oWoycGv5yfXZvZhC+qGLORX0fhELMcuK0=
X-Google-Smtp-Source: AGHT+IHaDdTOGdET9z7M4aCKWUDj1ecJgKCgoKweeEku4OcNBF/n49BFplCjDjNeigEPkJUm2mkn10XD3zJ5URglZNI=
X-Received: by 2002:a17:907:7242:b0:af4:12f6:420 with SMTP id
 a640c23a62f3a-af61770182dmr1662029966b.13.1753776087739; Tue, 29 Jul 2025
 01:01:27 -0700 (PDT)
MIME-Version: 1.0
References: <111b29cda9ce4309b4966fcfcc3b7ece@vastech.co.za>
 ...
 <CAFOi1A4X3PcST+MYSdpCSZUwZtNvBE14xSoHywGZ1RZeR7AP2g@mail.gmail.com> <f2f6f4a9aa574c9599c240b8353e2d02@vastech.co.za>
In-Reply-To: <f2f6f4a9aa574c9599c240b8353e2d02@vastech.co.za>
From: Martin Braun <martin.braun@ettus.com>
Date: Tue, 29 Jul 2025 10:01:15 +0200
X-Gm-Features: Ac12FXzXLEmttf2pEEoCpG5uZ5oB1ge9OyJcLr6wkGpWuRhD-A4h-ElefBhzyd8
Message-ID: <CAFOi1A4FsGYAbAz++Yg+rBphiXoPWYCjOLv_MYhWrmpNQZZOjA@mail.gmail.com>
Cc: "usrp-users@lists.ettus.com" <usrp-users@lists.ettus.com>
Message-ID-Hash: ZPPEFCFKPZ7ZNEP77CHQ7MYDCHDGACX3
X-Message-ID-Hash: ZPPEFCFKPZ7ZNEP77CHQ7MYDCHDGACX3
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/ZPPEFCFKPZ7ZNEP77CHQ7MYDCHDGACX3/>
...
Content-Type: multipart/mixed; boundary="===============2780038020656645624=="

--===============2780038020656645624==
Content-Type: multipart/related; boundary="000000000000ba063b063b0cd092"

--000000000000ba063b063b0cd092
Content-Type: multipart/alternative; boundary="000000000000ba063a063b0cd091"

--000000000000ba063a063b0cd091
...
On Tue, Jul 29, 2025 at 9:52=E2=80=AFAM Kevin Williams <kevin.williams@vast=
ech.co.za>
wrote:
...
> <https://url.za.m.mimecastprotect.com/s/irP4C98BNNiN4PosofKiqtmhw?domain=
=3Dgithub.com>
>
>
>
...
<div dir=3D"ltr"><div>Normally flow control is the thing that will let the =
...
EP connection has an issue.</div><div><br></div><div>If you can, connect ev=
erything statically and see how that fares.</div><div><br></div><div>--M</d=
iv></div><br><div class=3D"gmail_quote gmail_quote_container"><div dir=3D"l=
tr" class=3D"gmail_attr">On Tue, Jul 29, 2025 at 9:52=E2=80=AFAM Kevin Will=
iams &lt;<a href=3D"mailto:kevin.williams@vastech.co.za">kevin.williams@vas=
tech.co.za</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div class=3D"msg308529856188436682"><div lang=3D"EN-ZA"><div cl=
ass=3D"m_308529856188436682WordSection1"><p class=3D"MsoNormal"><span>Hi Ma=
rtin,<u></u><u></u></span></p><p class=3D"MsoNormal"><span><u></u>=C2=A0<u>=
</u></span></p><p class=3D"MsoNormal"><span>I do see a single =E2=80=9CO=E2=
=80=9D, but this is remote streaming so I didn=E2=80=99t think that should =
occur?<u></u><u></u></span></p><p class=3D"MsoNormal"><span><u></u>=C2=A0<u=
></u></span></p><p class=3D"MsoNormal"><span>Yes, this is a radio -&gt; my =
custom block dynamic connection.<u></u><u></u></span></p><p class=3D"MsoNor=
mal"><span><u></u>=C2=A0<u></u></span></p><p class=3D"MsoNormal"><span>Rega=
rds, Kevin<u></u><u></u></span></p><p class=3D"MsoNormal"><span><u></u>=C2=
=A0<u></u></span></p><p class=3D"MsoNormal"><b><span lang=3D"EN-US">From:</=
span></b><span lang=3D"EN-US"> Martin Braun &lt;<a href=3D"mailto:martin.br=
aun@ettus.com" target=3D"_blank">martin.braun@ettus.com</a>&gt; <br><b>Sent=
:</b> Tuesday, 29 July 2025 09:44<br><b>Cc:</b> <a href=3D"mailto:usrp-user=
s@lists.ettus.com" target=3D"_blank">usrp-users@lists.ettus.com</a><br><b>S=
ubject:</b> [USRP-users] Re: [EXTERNAL]Re: remote streaming starts, but sto=
ps after a few packets received<u></u><u></u></span></p><p class=3D"MsoNorm=
al"><u></u>=C2=A0<u></u></p><div><div><p class=3D"MsoNormal">Kevin,<u></u><=
u></u></p></div><div><p class=3D"MsoNormal"><u></u>=C2=A0<u></u></p></div><=
div><p class=3D"MsoNormal">based on the src port, this looks like it&#39;s =
going from Device to Host, not the other way around. This means it&#39;s an=
 async message from an RFNoC block, with address 0x1000. I can&#39;t tell f=
or sure from this screenshot, but I think this is coming from the radio, an=
d 0x1000 is the &quot;RX Error&quot; address. The data is incorrectly forma=
tted (probably an issue of the CHDR dissector, but I think it&#39;s telling=
 us the data is &quot;2&quot; (if we read this in network order).<u></u><u>=
</u></p></div><div><p class=3D"MsoNormal"><u></u>=C2=A0<u></u></p></div><di=
v><p class=3D"MsoNormal">Put these together, and we&#39;re looking at a sim=
ple overrun. Something in your chain is holding up the radio after a few pa=
ckets. Are you sure you&#39;re not seeing an &quot;O&quot; anywhere in your=
 output? You are using a radio block, right?<u></u><u></u></p></div><div><p=
 class=3D"MsoNormal"><u></u>=C2=A0<u></u></p></div><div><p class=3D"MsoNorm=
al">--M<u></u><u></u></p></div></div><p class=3D"MsoNormal"><u></u>=C2=A0<u=
></u></p><div><div><p class=3D"MsoNormal">On Tue, Jul 29, 2025 at 9:19=E2=
...
></p></div><blockquote style=3D"border-width:medium medium medium 1pt;borde=
r-style:none none none solid;border-color:currentcolor currentcolor current=
color rgb(204,204,204);padding:0cm 0cm 0cm 6pt;margin-left:4.8pt;margin-rig=
ht:0cm"><div><div><div><p class=3D"MsoNormal">Hi,<u></u><u></u></p><p class=
...
id=3D"m_308529856188436682m_1275845332921058704Picture_x0020_1" src=3D"cid:=
ii_1985531f0cf4cff311"><u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></=
u><u></u></p><div><div style=3D"border-width:1pt medium medium;border-style=
:solid none none;padding:3pt 0cm 0cm;border-color:currentcolor"><p class=3D=
"MsoNormal"><b><span lang=3D"EN-US">From:</span></b><span lang=3D"EN-US"> K=
evin Williams <br><b>Sent:</b> Tuesday, 29 July 2025 07:53<br><b>To:</b> &#=
39;<a href=3D"mailto:bpadalino@gmail.com" target=3D"_blank">bpadalino@gmail=
.com</a>&#39; &lt;<a href=3D"mailto:bpadalino@gmail.com" target=3D"_blank">=
bpadalino@gmail.com</a>&gt;<br><b>Cc:</b> &#39;<a href=3D"mailto:martin.bra=
un@ettus.com" target=3D"_blank">martin.braun@ettus.com</a>&#39; &lt;<a href=
=3D"mailto:martin.braun@ettus.com" target=3D"_blank">martin.braun@ettus.com=
</a>&gt;; &#39;<a href=3D"mailto:usrp-users@lists.ettus.com" target=3D"_bla=
nk">usrp-users@lists.ettus.com</a>&#39; &lt;<a href=3D"mailto:usrp-users@li=
sts.ettus.com" target=3D"_blank">usrp-users@lists.ettus.com</a>&gt;; Werner=
 Bode &lt;<a href=3D"mailto:werner.bode@vastech.co.za" target=3D"_blank">we=
rner.bode@vastech.co.za</a>&gt;<br><b>Subject:</b> RE: [USRP-users] Re: [EX=
TERNAL]Re: remote streaming starts, but stops after a few packets received<=
/span><u></u><u></u></p></div></div><p class=3D"MsoNormal">=C2=A0<u></u><u>=
</u></p><p class=3D"MsoNormal">Hi Brian,<u></u><u></u></p><p class=3D"MsoNo=
rmal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">I=E2=80=99ve got two o=
bservations:<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></=
p><ol start=3D"1" type=3D"1"><li class=3D"m_308529856188436682m127584533292=
1058704msolistparagraph">This is a summary of my custom block streaming whe=
re the data packet stream ends with icmp packets about the destination beco=
ming unreachable:<u></u><u></u></li></ol><p class=3D"MsoNormal">=C2=A0<u></=
u><u></u></p><p class=3D"MsoNormal">No.=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 Time=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 Source=C2=A0 Destination=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 Protocol=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 Length=C2=
=A0 Info<u></u><u></u></p><p class=3D"MsoNormal">1=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 0.000000000=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
=A0 1534 =E2=86=92 1534 Len=3D8<u></u><u></u></p><p class=3D"MsoNormal">534=
3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 49.277852197=C2=A0=C2=A0=C2=A0=C2=A0 =
10.22.128.3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 UDP=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 60=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
 49152 =E2=86=92 36716 Len=3D16<u></u><u></u></p><p class=3D"MsoNormal">&lt=
;5000-odd small udp and small rfnoc control &amp; management packets. Setup=
 I guess.&gt;<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u><=
/p><p class=3D"MsoNormal">7318=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 50.79268=
8865=C2=A0=C2=A0=C2=A0=C2=A0 10.22.128.3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0 10.22.128.1=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
 RFNOC=C2=A0 4146=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 [Data]=C2=A0=C2=A0=C2=
=A0=C2=A0 -&gt;=C2=A0=C2=A0 6 <u></u><u></u></p><p class=3D"MsoNormal">&lt;=
<span style=3D"background:yellow">first seq=3D0 rfnoc data packet of the co=
rrect size given my tlast counter</span>&gt;<u></u><u></u></p><p class=3D"M=
soNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">7319=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 50.792748665=C2=A0=C2=A0=C2=A0=C2=A0 Intel_e8:c3:4=
c=C2=A0=C2=A0=C2=A0 Broadcast=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 ARP=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 42=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 Who has 10.22.128=
.1? Tell 10.23.128.1<u></u><u></u></p><p class=3D"MsoNormal">7320=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0 50.792754229=C2=A0=C2=A0=C2=A0=C2=A0 10.22.128.=
3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.22.128.1=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 RFNOC=C2=A0 4146=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0 [Data]=C2=A0=C2=A0=C2=A0=C2=A0 -&gt;=C2=A0=C2=A0 6 <u></u><=
u></u></p><p class=3D"MsoNormal">&lt;<span style=3D"background:yellow">a fe=
w 100 more correct data packets</span>&gt;<u></u><u></u></p><p class=3D"Mso=
Normal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">7775=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 50.795514072=C2=A0=C2=A0=C2=A0=C2=A0 10.22.128.3=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.22.128.1=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 RFNOC=C2=A0 4146=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0 [Data]=C2=A0=C2=A0=C2=A0=C2=A0 -&gt;=C2=A0=C2=A0 6 <u></u><u></u>=
</p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">&=
lt;a string of more control and short 66 byte rfnoc packets, but no rfnoc d=
ata packets&gt;<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u=
></p><p class=3D"MsoNormal">7968=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 52.854=
255766=C2=A0=C2=A0=C2=A0=C2=A0 Intel_e8:c3:4c=C2=A0=C2=A0=C2=A0 Broadcast=
...
=A0=C2=A0=C2=A0=C2=A0=C2=A0 Who has 10.22.128.1? Tell 10.23.128.1<u></u><u>=
</u></p><p class=3D"MsoNormal">7969=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 53.=
238261827=C2=A0=C2=A0=C2=A0=C2=A0 Intel_e8:c3:4e=C2=A0=C2=A0 NationalInst_3=
5:aa:da=C2=A0=C2=A0=C2=A0 ARP=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 42=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 Who has 10.23.=
128.3? Tell 10.23.128.1 (duplicate use of 10.23.128.1 detected!)<u></u><u><=
/u></p><p class=3D"MsoNormal">7970=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 53.2=
38475399=C2=A0=C2=A0=C2=A0=C2=A0 NationalInst_35:aa:da=C2=A0=C2=A0=C2=A0 In=
tel_e8:c3:4e=C2=A0=C2=A0 ARP=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 60=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.3 is=
 at 00:80:2f:35:aa:da (duplicate use of 10.23.128.1 detected!)<u></u><u></u=
></p><p class=3D"MsoNormal">&lt;<span style=3D"background:yellow">then the =
destination becomes unreachable?</span>&gt;<u></u><u></u></p><p class=3D"Ms=
oNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">7971=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 53.878292746=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=
...
ble)<u></u><u></u></p><p class=3D"MsoNormal">7972=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 53.878302721=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=
...
u><u></u></p><p class=3D"MsoNormal">7973=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0 53.878308143=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.22.128.3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 ICMP=C2=A0=C2=A0=C2=A0=C2=A0 590=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 Destination unreachable (Host unreachable)<u></u><u></u>=
</p><p class=3D"MsoNormal">7974=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 53.8783=
14734=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0 10.22.128.3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
 ICMP=C2=A0=C2=A0=C2=A0=C2=A0 590=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0 Destination unreachable (Host unreachable)<u></u><u></u></p><p class=
=3D"MsoNormal">7975=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 53.878320545=C2=A0=
=C2=A0=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0 10.22.128.3=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ICMP=C2=A0=
=C2=A0=C2=A0=C2=A0 590=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 Dest=
ination unreachable (Host unreachable)<u></u><u></u></p><p class=3D"MsoNorm=
al">7976=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 53.878326301=C2=A0=C2=A0=C2=A0=
...
achable (Host unreachable)<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u=
></u><u></u></p><p class=3D"MsoNormal">&lt;after that, just arp packets and=
 the usrp broadcasting small udp packets&gt;<u></u><u></u></p><p class=3D"M=
soNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">8014=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 137.075344888=C2=A0=C2=A0 NationalInst_35:aa:da=C2=
...
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ARP Announcement for=
 10.23.128.3<u></u><u></u></p><p class=3D"MsoNormal">8015=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 137.075304321=C2=A0=C2=A0 NationalInst_35:aa:d9=C2=A0=C2=
...
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ARP Announcement for 10.22=
.128.3<u></u><u></u></p><p class=3D"MsoNormal">8016=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 140.701925975=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=A0=
...
soNormal">8017=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 140.701942078=C2=A0=C2=
...
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 38981 =E2=86=92 1534=
 Len=3D8<u></u><u></u></p><p class=3D"MsoNormal">8018=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0 142.361983307=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=
...
=3D"MsoNormal">8019=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 150.005535184=C2=A0=
...
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 1534 =E2=86=92 15=
34 Len=3D8<u></u><u></u></p><p class=3D"MsoNormal">8020=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 150.005558707=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=
...
=3D"MsoNormal">8021=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 152.097709946=C2=A0=
=C2=A0 NationalInst_35:aa:d9=C2=A0=C2=A0=C2=A0 Broadcast=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ARP=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 60=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0 ARP Announcement for 10.22.128.3<u></u><u></u></p><p class=3D"Mso=
Normal">8022=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 152.097809876=C2=A0=C2=A0 =
...
">8023=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 155.702401576=C2=A0=C2=A0 10.23.=
...
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 38981 =E2=86=92 1534 Len=
=3D8<u></u><u></u></p><p class=3D"MsoNormal">8024=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 155.702431967=C2=A0=C2=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.255=C2=A0=C2=A0=C2=A0=C2=A0 UDP=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0 50=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0 38981 =E2=86=92 1534 Len=3D8<u></u><u></u></p><p class=3D"M=
soNormal">8025=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 157.378508296=C2=A0=C2=
=A0 10.23.128.1=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 10.23.128.2=
55=C2=A0=C2=A0=C2=A0=C2=A0 UDP=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 50=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 59572 =E2=86=92 1534=
 Len=3D8<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p=
 class=3D"MsoNormal">=C2=A0<u></u><u></u></p><ol start=3D"2" type=3D"1"><li=
 class=3D"m_308529856188436682m1275845332921058704msolistparagraph">ILA res=
ults<u></u><u></u></li></ol><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p>=
<p class=3D"MsoNormal">With my block I see a continuously asserted TREADY, =
with TLAST=E2=80=99s at exactly the correct sample counts, until streaming =
stops where I see TREADY deasserted for 20-odd clocks, and then reasserted =
(without further streaming).<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0=
<u></u><u></u></p><p class=3D"MsoNormal">Regards, Kevin<u></u><u></u></p><p=
 class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<=
u></u><u></u></p><p class=3D"MsoNormal"><b><span lang=3D"EN-US">From:</span=
></b><span lang=3D"EN-US"> Brian Padalino &lt;<a href=3D"mailto:bpadalino@g=
mail.com" target=3D"_blank">bpadalino@gmail.com</a>&gt; <br><b>Sent:</b> Mo=
nday, 28 July 2025 16:49<br><b>To:</b> Kevin Williams &lt;<a href=3D"mailto=
:kevin.williams@vastech.co.za" target=3D"_blank">kevin.williams@vastech.co.=
za</a>&gt;<br><b>Cc:</b> <a href=3D"mailto:martin.braun@ettus.com" target=
=3D"_blank">martin.braun@ettus.com</a>; <a href=3D"mailto:usrp-users@lists.=
ettus.com" target=3D"_blank">usrp-users@lists.ettus.com</a><br><b>Subject:<=
/b> Re: [USRP-users] Re: [EXTERNAL]Re: remote streaming starts, but stops a=
fter a few packets received</span><u></u><u></u></p><p class=3D"MsoNormal">=
=C2=A0<u></u><u></u></p><div><div><p class=3D"MsoNormal">On Mon, Jul 28, 20=
25 at 10:15=E2=80=AFAM Kevin Williams &lt;<a href=3D"mailto:kevin.williams@=
vastech.co.za" target=3D"_blank">kevin.williams@vastech.co.za</a>&gt; wrote=
:<u></u><u></u></p></div><div><blockquote style=3D"border-width:medium medi=
um medium 1pt;border-style:none none none solid;padding:0cm 0cm 0cm 6pt;mar=
gin:5pt 0cm 5pt 4.8pt;border-color:currentcolor currentcolor currentcolor r=
gb(204,204,204)"><div><div><div><p class=3D"MsoNormal">I did an experiment =
today with just this (Ettus blocks only):<u></u><u></u></p><p class=3D"MsoN=
ormal">=C2=A0<u></u><u></u></p><p class=3D"MsoNormal">connections:<u></u><u=
></u></p><p class=3D"MsoNormal">=C2=A0 - { srcblk: radio0,=C2=A0=C2=A0=C2=
=A0=C2=A0 srcport: out_0,=C2=A0=C2=A0=C2=A0 dstblk: ep0,=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 dstport: in0}<u></u><u></u></p><p class=3D"MsoNormal">=
=C2=A0 - { srcblk: <span style=3D"background:yellow">ep6</span>,=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 srcport: out0,=C2=A0=C2=A0=C2=A0=C2=A0 ds=
tblk: ddc0, dstport: in_0 }<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0 =
- { srcblk: ddc0,=C2=A0 srcport: out_0,=C2=A0=C2=A0=C2=A0 dstblk: <span sty=
le=3D"background:yellow">ep6</span>,=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ds=
tport: in0 }<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></=
p><p class=3D"MsoNormal">Which did not work =E2=80=93 the remote streaming =
stopped.<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p=
 class=3D"MsoNormal">Changing the destination EP to a new one, ep7, worked =
again.<u></u><u></u></p><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p><p c=
lass=3D"MsoNormal">From the RFNoC 4 workshop slides I was under the impress=
ion blocks could start and end on the same SEP?<u></u><u></u></p></div></di=
v></div></blockquote><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></=
div><div><p class=3D"MsoNormal">For what it&#39;s worth, I&#39;m using remo=
te streaming with a custom block and it&#39;s working well.<u></u><u></u></=
p></div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></div><div><p c=
lass=3D"MsoNormal">In fact, the way remote streaming works (at least for an=
 X440) is that the Ethernet/UDP information is written here:<u></u><u></u><=
/p></div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></div><div><p =
class=3D"MsoNormal">=C2=A0=C2=A0<a href=3D"https://url.za.m.mimecastprotect=
.com/s/irP4C98BNNiN4PosofKiqtmhw?domain=3Dgithub.com" target=3D"_blank">htt=
ps://github.com/EttusResearch/uhd/blob/40403b7c00154e4559c47bd6dde924f09299=
2d45/fpga/usrp3/lib/rfnoc/xport_sv/chdr_xport_adapter.sv#L671</a><u></u><u>=
</u></p></div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></div><di=
v><p class=3D"MsoNormal">The kv_map uses the destination EPID as the key fo=
r the ethernet information which gets looked up for every packet.<u></u><u>=
</u></p></div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></div><di=
v><p class=3D"MsoNormal">So if the streaming works when not doing remote st=
reaming it might be something else since all data paths go through here.<u>=
</u><u></u></p></div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></=
div><div><p class=3D"MsoNormal">If you get the first few packets and it sto=
ps, is there any way you&#39;re providing `enable_fc` as an argument? That =
would enable flow control which obviously wouldn&#39;t be good if you aren&=
#39;t doing any flow control processing on your RX side.<u></u><u></u></p><=
/div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></div><div><p clas=
s=3D"MsoNormal">Lastly, I agree with Martin that you should probably add an=
 ILA to your block and the SEP interfaces to see where the AXI stream is ge=
tting stopped up.<u></u><u></u></p></div><div><p class=3D"MsoNormal">=C2=A0=
<u></u><u></u></p></div><div><p class=3D"MsoNormal">Good luck.<u></u><u></u=
></p></div><div><p class=3D"MsoNormal">=C2=A0<u></u><u></u></p></div><div><=
p class=3D"MsoNormal">Brian<u></u><u></u></p></div></div></div></div></div>=
...
Content-ID: <ii_1985531f0cf4cff311>
X-Attachment-Id: ii_1985531f0cf4cff311
