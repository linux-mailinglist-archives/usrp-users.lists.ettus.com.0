...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D865A5F5F9
	for <lists+usrp-users@lfdr.de>; Thu, 13 Mar 2025 14:31:08 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 46B3C385FF7
	for <lists+usrp-users@lfdr.de>; Thu, 13 Mar 2025 09:31:07 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1741872667; bh=w5QnumwP0jk8Ci6MD+rfu8DW3CePxw4gDtbjbCV2qqU=;
	h=References:In-Reply-To:Date:To:Subject:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From:Reply-To:From;
	b=
Received: from mail-oo1-f47.google.com (mail-oo1-f47.google.com [209.85.161.47])
	by mm2.emwd.com (Postfix) with ESMTPS id 73EF2385E95
	for <usrp-users@lists.ettus.com>; Thu, 13 Mar 2025 09:30:57 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=mode51-software.20230601.gappssmtp.com header.i=@mode51-software.20230601.gappssmtp.com header.b="3VtvEADO";
	dkim-atps=neutral
Received: by mail-oo1-f47.google.com with SMTP id 006d021491bc7-6003c670805so446591eaf.0
        for <usrp-users@lists.ettus.com>; Thu, 13 Mar 2025 06:30:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=mode51-software.20230601.gappssmtp.com; s=20230601; t=1741872656; x=1742477456; darn=lists.ettus.com;
        h=to:subject:message-id:date:from:in-reply-to:references:mime-version
         :from:to:cc:subject:date:message-id:reply-to;
        bh=ZSDkh9vwTkIPXgPX6GPcvPusaFZX2XKM94j9pLT/oc8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1741872656; x=1742477456;
        h=to:subject:message-id:date:from:in-reply-to:references:mime-version
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=ZSDkh9vwTkIPXgPX6GPcvPusaFZX2XKM94j9pLT/oc8=;
        b=
X-Gm-Message-State: AOJu0YyaEecp3wNA/oSTGo9XTUKVqp/ODgn1T4wZk3SCnKM07cCmbDIO
	STXJmuZgFW/u8NCpn84NtzWQtMkisp+irB587gwSf0nsLeowTHggswZWlK7yms2KPIEdSfv8auL
	y+IPT6lO+6dKGcMdysiE+mRJ+4IktnUKFa95m3LoAdya1kX78pp8=
X-Gm-Gg: ASbGncuIkA9YSso+n8eFehG2kvB26YDBfjjW9hkVNzIQUaeZn0X2aiLPLWEd9iFidb4
	/0EXuF4ISm23ai+fcg0qS7eNXKf5oFwKgQfyRumEvMDXBKIAqpsCQtXL+yRcuYUwTmkqXvaqFxE
	iNYe+iraAUVRndrb9Wx8I4TW+FZg==
X-Google-Smtp-Source: AGHT+IECv2rYuJGRg2tYFqaY1zgknO5FLWTm0nlE08gQJRhZHbLkGIfIR7SqZ7nHgyWsT6eOiK2b4Jgor5Plw8Xn6EY=
X-Received: by 2002:a05:6820:1f0c:b0:5fe:b3c2:29e2 with SMTP id
 006d021491bc7-601dac2249emr1221252eaf.2.1741872655954; Thu, 13 Mar 2025
 06:30:55 -0700 (PDT)
MIME-Version: 1.0
References: <CAOcWHKh6vTnK92zDn8pJFGOWFO-gSZ-NRpC88w8HzEdAstaJfA@mail.gmail.com>
In-Reply-To: <CAOcWHKh6vTnK92zDn8pJFGOWFO-gSZ-NRpC88w8HzEdAstaJfA@mail.gmail.com>
Date: Thu, 13 Mar 2025 13:30:19 +0000
X-Gm-Features: AQ5f1JrGoFdpx6FPrZjdtFvP-KgI1KenEPNGRCtFsjn8ag3jCNswbUa71BaXw14
Message-ID: <CAOcWHKiZTVeu6SJXFNCVeBNAt26VXyj_dAfYsEFNWsPgEkaNtg@mail.gmail.com>
To: usrp-users@lists.ettus.com
Message-ID-Hash: HFTJUMPQDNU4MUF6VADH4WCDTC7TS2EL
X-Message-ID-Hash: HFTJUMPQDNU4MUF6VADH4WCDTC7TS2EL
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/HFTJUMPQDNU4MUF6VADH4WCDTC7TS2EL/>
...
Content-Type: multipart/mixed; boundary="===============8629431194869698374=="

--===============8629431194869698374==
Content-Type: multipart/related; boundary="000000000000e7c0e60630395449"

--000000000000e7c0e60630395449
Content-Type: multipart/alternative; boundary="000000000000e7c0e50630395448"

--000000000000e7c0e50630395448
...
> <https://chronos.uk/product/telecom-master-clocks/timeprovider-4100-preci=
se-timing-grandmaster-r2-4/>
...
<div dir=3D"ltr">Hi,<div><br></div><div>I found some documentation for the =
Timeprovider 4100 and there are 2 ports which can be configured to output=
=C2=A0either 1PPS or 10MHz. The latter is a square wave so I guess I can pl=
ug that into the Octoclock:</div><div><br></div><div><img src=3D"cid:ii_m87=
duxqf0" alt=3D"image.png" width=3D"563" height=3D"199"><br></div><div><br><=
/div><div>The question now is if the Timeprovider&#39;s=C2=A0PPS output is =
compatible with the Octoclock. I note the pulse width is configurable is se=
t to 1000, and there is also an offset param:</div><div><br></div><div><img=
 src=3D"cid:ii_m87dw2m81" alt=3D"image.png" width=3D"563" height=3D"305"><b=
r></div><div><br></div><div><br></div><div>And, if the PPS is ok then can t=
he Octoclock derive the Freq from that or is it better to plug both in sepa=
rately.</div><div><br></div><div><br></div></div><br><div class=3D"gmail_qu=
ote gmail_quote_container"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, 13=
 Mar 2025 at 10:57, Chris Newman &lt;chris@mode51.software&gt; wrote:<br></=
div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;bor=
der-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div=
>Hi,</div><div><br></div><div>I&#39;d like to use a <a href=3D"https://chro=
nos.uk/product/telecom-master-clocks/timeprovider-4100-precise-timing-grand=
master-r2-4/" target=3D"_blank">Chronos Timeprovider 4100</a> to provide th=
e input signals to the Octoclock CDA-2990.</div><div><br></div><div>Will th=
e Octoclock accept the Timeprovider&#39;s signals for 10MHz and PPS? Presum=
ably the Timeprovider is outputting sine waves.=C2=A0</div><div><br></div><=
div>I see the Octoclock outputs the square waves needed by the=C2=A0SDRs. T=
herefore, I guess the question is - can the Octoclock convert sine waves to=
 square waves?</div><div><br></div><div>The Octoclock FAQ states:</div><div=
><br></div><div><ul><li> <b>What are the input and output specifications?</=
b></li></ul>
...
></div><div><br></div><div dir=3D"ltr" class=3D"gmail_signature"><div dir=
...
Content-ID: <ii_m87duxqf0>
X-Attachment-Id: ii_m87duxqf0
...
Content-Disposition: inline; filename="image.png"
Content-Transfer-Encoding: base64
Content-ID: <ii_m87dw2m81>
X-Attachment-Id: ii_m87dw2m81
