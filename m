...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 63DCB349C6E
	for <lists+usrp-users@lfdr.de>; Thu, 25 Mar 2021 23:41:06 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id C588438371E
	for <lists+usrp-users@lfdr.de>; Thu, 25 Mar 2021 18:40:59 -0400 (EDT)
Received: from mail-qk1-f174.google.com (mail-qk1-f174.google.com [209.85.222.174])
	by mm2.emwd.com (Postfix) with ESMTPS id DB741383FAF
	for <USRP-users@lists.ettus.com>; Thu, 25 Mar 2021 18:40:06 -0400 (EDT)
Received: by mail-qk1-f174.google.com with SMTP id c4so3510416qkg.3
        for <USRP-users@lists.ettus.com>; Thu, 25 Mar 2021 15:40:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=content-transfer-encoding:from:mime-version:subject:date:message-id
         :references:cc:in-reply-to:to;
        bh=2KpeupMp9NrTwXN2eyG2N51yzfLBoVgFSRs6tqabmXM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2KpeupMp9NrTwXN2eyG2N51yzfLBoVgFSRs6tqabmXM=;
        b=
X-Gm-Message-State: AOAM53217mMQGtU0R6tglmrLBt+DIQX8/6wValMvnIy2UOrGUSRfS3s+
	dZGMEVNIcJ7886Pw3STKIqIgCaJ6tR8=
X-Google-Smtp-Source: ABdhPJzuVE2UfNjqwAPk0xdZIDXbxGEkGmJmtzAIyTRcmJLB+WPjnKUReZf0pgmxR2hr359VihXLFg==
X-Received: by 2002:a05:620a:2158:: with SMTP id m24mr10367256qkm.306.1616712006138;
        Thu, 25 Mar 2021 15:40:06 -0700 (PDT)
Received: from [192.168.2.130] (bras-base-smflon1825w-grc-18-76-67-104-5.dsl.bell.ca. [76.67.104.5])
        by smtp.gmail.com with ESMTPSA id p66sm5464312qka.108.2021.03.25.15.40.05
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 25 Mar 2021 15:40:05 -0700 (PDT)
From: Marcus D Leech <patchvonbraun@gmail.com>
Mime-Version: 1.0 (1.0)
Date: Thu, 25 Mar 2021 18:40:05 -0400
Message-Id: <C84B8180-D431-4FCA-B6CB-14130D962FCB@gmail.com>
References: <CO6PR19MB4801B529457BF78A00D8B586C6629@CO6PR19MB4801.namprd19.prod.outlook.com>
...
Message-ID-Hash: WSICIXVKHSL2UHRISFPPXUXFZ42WTDER
X-Message-ID-Hash: WSICIXVKHSL2UHRISFPPXUXFZ42WTDER
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/WSICIXVKHSL2UHRISFPPXUXFZ42WTDER/>
...
Content-Type: multipart/mixed; boundary="===============1388566726212814746=="


--===============1388566726212814746==
Content-Type: multipart/alternative; boundary=Apple-Mail-7CE92D3D-EC3B-4E45-AD41-7D3AB6A503D3
Content-Transfer-Encoding: 7bit


--Apple-Mail-7CE92D3D-EC3B-4E45-AD41-7D3AB6A503D3
Content-Type: text/plain;
	charset=utf-8
Content-Transfer-Encoding: quoted-printable

Could you confirm that you=E2=80=99re using at least 30dB of attenuation in t=
he coax link?

Sent from my iPhone

> On Mar 25, 2021, at 6:27 PM, Jerrid Plymale <jerrid.plymale@canyon-us.com>=
 wrote:
>=20
> =EF=BB=BF
> Yes, moving TX out of the RX band has no affect on the noise level increas=
e.
> =20
> Best Regards,
> =20
...
utf-8"></head><body dir=3D"auto">Could you confirm that you=E2=80=99re using=
 at least 30dB of attenuation in the coax link?<br><br><div dir=3D"ltr">Sent=
 from my iPhone</div><div dir=3D"ltr"><br><blockquote type=3D"cite">On Mar 2=
5, 2021, at 6:27 PM, Jerrid Plymale &lt;jerrid.plymale@canyon-us.com&gt; wro=
...
<p class=3D"MsoNormal"><span style=3D"color:windowtext">Yes, moving TX out o=
f the RX band has no affect on the noise level increase.<o:p></o:p></span></=
p>
...
<p class=3D"MsoNormal">If you move the TX out of band with respect to the RX=
 do you still see the noise when the TX graph starts?<o:p></o:p></p>
<div>
<p class=3D"MsoNormal"><o:p>&nbsp;</o:p></p>
</div>
<div>
...
<p class=3D"MsoNormal" style=3D"margin-bottom:12.0pt">On Mar 25, 2021, at 3:=
57 PM, Jerrid Plymale &lt;<a href=3D"mailto:jerrid.plymale@canyon-us.com">je=
...
requency we set it to.</span><o:p></o:p></p>
<p class=3D"MsoNormal"><span style=3D"color:windowtext">&nbsp;</span><o:p></=
o:p></p>
...
in 0in">
<p class=3D"MsoNormal"><b><span style=3D"color:windowtext">From:</span></b><=
span style=3D"color:windowtext"> Marcus D Leech &lt;<a href=3D"mailto:patchv=
onbraun@gmail.com">patchvonbraun@gmail.com</a>&gt;
<br>
