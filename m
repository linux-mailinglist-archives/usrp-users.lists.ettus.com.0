...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 197EA30E52F
	for <lists+usrp-users@lfdr.de>; Wed,  3 Feb 2021 22:53:25 +0100 (CET)
Received: from [::1] (port=60788 helo=mm2.emwd.com)
	by mm2.emwd.com with esmtp (Exim 4.93)
	(envelope-from <usrp-users-bounces@lists.ettus.com>)
	id 1l7Q5R-0000TK-FU; Wed, 03 Feb 2021 16:53:21 -0500
Received: from mail-oi1-f179.google.com ([209.85.167.179]:36238)
 by mm2.emwd.com with esmtps (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 (Exim 4.93) (envelope-from <rkossler@nd.edu>) id 1l7Q5M-0000Of-Ni
 for usrp-users@lists.ettus.com; Wed, 03 Feb 2021 16:53:16 -0500
Received: by mail-oi1-f179.google.com with SMTP id d18so1533719oic.3
 for <usrp-users@lists.ettus.com>; Wed, 03 Feb 2021 13:52:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nd.edu; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=9zC+JwKHICoh3vHQnZPOFBDb+eJ34YAZAVf+OD9XCvg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=9zC+JwKHICoh3vHQnZPOFBDb+eJ34YAZAVf+OD9XCvg=;
 b=
X-Gm-Message-State: AOAM5322CnjaHPQCppNuWvS8KIgEluotLo8qAn/VUr0CznbSQoskRvws
 cyNusMoitSFY2bS0H72HZ3O8su06BPaDhjoFoQ9Bww==
X-Google-Smtp-Source: ABdhPJyp4H0XxKDgIG/nMI9H8CG8GHZ2exSNZsYZqeEHlItzQ7Y/y2904IbvWoJzPxkSbjQJ7x20dUXJNcj0m9VLaeg=
X-Received: by 2002:aca:4c85:: with SMTP id z127mr3316490oia.124.1612389155540; 
 Wed, 03 Feb 2021 13:52:35 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CAB__hTT6_UYrEdOt0Yj1gn5uZwsg-jMkDu2ayWb0fjadyA14YQ@mail.gmail.com>
Date: Wed, 3 Feb 2021 16:52:24 -0500
Message-ID: <CAB__hTR7K8242X02BPW+=8exppDi6Vu_r4HGoQstTLK5sYgVnA@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============5871159259599639808=="
...
--===============5871159259599639808==
Content-Type: multipart/alternative; boundary="000000000000db569305ba759ace"

--000000000000db569305ba759ace
...
of putting just a few symlinks in a folder and pointing to that folder from
.config/uhd.conf (dpdk_driver=<folder>). See NOTE 4 below.
...
a second time.  The following sequence fixes this (perhaps there is a
...
issues with keyboard/mouse input that became intolerably slow. I didn't
...
idea if these are reasonable values or not. The DPDK docs indicated that
...
L710 NIC, and UHD 4.0).<div><br><div>1) I can only get my application to ru=
n once and then I have to do some stuff (see NOTE 1 below) to run again.</d=
iv><div>2) I get occasional (but much too often) lock-ups of other applicat=
ions running in Ubuntu.=C2=A0 This was previously my experience using DPDK =
under 3.15 (DPDK 17.11) but I had hoped things were better now.=C2=A0 They =
are not.=C2=A0 See below for more details (NOTE 2 below) on this. Note that=
 these lockups do not occur even occasionally when not running with DPDK.</=
div><div>3) The instructions in the UHD manual are not nearly good enough t=
o get things running.</div><div>4) I first got things working as &quot;root=
&quot; (as recommended), but this caused some ancillary issues with my apps=
. Fortunately, I was able to get it to run as a lowly user (see NOTE 3 belo=
w)</div><div>5) I could not get things working even once until I followed A=
aron&#39;s advice of putting just a few symlinks in a folder and pointing t=
o that folder from .config/uhd.conf (dpdk_driver=3D&lt;folder&gt;). See NOT=
E 4 below.</div><div><br></div><div>Read on for the details if interested.<=
/div><div>Rob</div><div><br></div><div>NOTE 1: After I run and exit my app,=
 I notice that the link LEDs on the SFP ports of the N310 are not both on a=
s they should be and I am unable to run a second time.=C2=A0 The following =
sequence fixes this (perhaps there is a better sequence but I haven&#39;t f=
ound it yet) such that I am able to re-run successfully.</div><div>- sudo d=
pdk-devbind -b i40e=C2=A0 03:00.0 03.00.1=C2=A0 # bind normal driver</div><=
div>- sudo dpdk-devbind -b vfio-pci 03:00.0 03.00.1 # re-bind vfio-pci driv=
er</div><div>- physically, unplug &amp; plug QSFP+ transceiver on XL710 (so=
metimes have to do this 2 or 3 times before it &quot;fixes&quot; the link L=
EDs on N310 SFPs)</div><div><br></div><div>NOTE 2: The fact that DPDK takes=
 over the CPU cores (at least 1 if not 2 of them) seems to cause issues wit=
h other apps.=C2=A0 In the past I have even had issues with keyboard/mouse =
input that became intolerably slow. I didn&#39;t have keyboard/mouse issues=
 this time, but I did have issues with a companion application that I run a=
longside my c++/UHD application.=C2=A0 This companion application (actually=
 Matlab based control/display GUI) would lock up such that I couldn&#39;t e=
ven close it down.=C2=A0 But, once I stop my c++/UHD application, everythin=
g starts behaving normally.=C2=A0 Note that I NEVER have this issue when ru=
nning the same applications without DPDK.=C2=A0 I tried the grub update &qu=
ot;isolcpus=3DN,M&quot; but not sure if this helped or not.=C2=A0 I also tr=
ied changing my DPDK corelist from 0,1 to 6,7 because in the past I had con=
vinced myself (perhaps wrongly) that things behaved better if not using CPU=
 0.=C2=A0 I have no hard evidence to support this.=C2=A0 In the end, things=
 mostly work, but these lockups are reason enough to avoid DPDK.</div><div>=
<br></div><div>NOTE 3: I did the following to run as lowly user rather than=
 root.</div><div>1) updated /etc/security/limits.conf to use the following.=
 I really have no idea if these are reasonable values or not. The DPDK docs=
 indicated that these are the relevant settings to adjust but gave no advic=
e on what they should be set to.</div><div>&lt;username&gt; - memlock 20000=
00<br>&lt;username&gt; - nofile =C2=A02000<br>&lt;username&gt; - locks =C2=
=A0 2000<br></div><div>2) after binding the vfio-pci driver using dpdk-devb=
ind, I ran the following. The first two are commands I determined after run=
ning the DPDK usertools/dpdk-setup.sh utility and then looking at the sourc=
e to see the exact chmod settings used by this utility (BTW, this utility w=
as helpful).=C2=A0 The third was recommended in the DPDK documentation.</di=
v><div>sudo chmod a+x /dev/vfio<br>sudo chmod 0666 /dev/vfio/*<br>sudo chmo=
d a+w /dev/hugepages/<br></div><div><br></div><div>NOTE 4: The following ar=
e the few symlinks I put in a folder I created &quot;/usr/local/lib/dpdk-pm=
ds/&quot;.=C2=A0 After pointing the dpdk_driver=3D&lt;folder&gt; setting in=
 uhd.conf to this, I was able to run successfully.=C2=A0</div><div>librte_m=
empool_ring.so, librte_pmd_i40e.so, librte_pmd_ixgbe.so, and librte_pmd_rin=
g.so.</div></div></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" clas=
s=3D"gmail_attr">On Wed, Feb 3, 2021 at 10:44 AM Rob Kossler &lt;<a href=3D=
"mailto:rkossler@nd.edu">rkossler@nd.edu</a>&gt; wrote:<br></div><blockquot=
e class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px s=
olid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><div><font face=3D=
"monospace">Hi Aaron,</font></div><div><font face=3D"monospace">Two things:=
</font></div><div><font face=3D"monospace">1) I am getting an error message=
 at the conclusion of a successful run (see below). Not sure if this is som=
ething I should be looking at or if it is harmless.</font></div><div><font =
face=3D"monospace">2) I figured out a sequence of steps that can &quot;fix&=
quot; my broken state following a successful run. If I do the following, th=
e links are fixed:</font></div><div><font face=3D"monospace">=C2=A0 a) dpdk=
-devbind -b i40e 03:00.0 03:00.1=C2=A0 =C2=A0// bind to the normal driver</=
font></div><div><font face=3D"monospace">=C2=A0 b) dpdk-devbind -b vfio-pci=
 03:00.0 03:00.1=C2=A0 // bind back to the vfio-pci driver</font></div><div=
><font face=3D"monospace">=C2=A0 c) physically unplug &amp; plug the XL710 =
QSFP+ transceiver=C2=A0(mine is optical, but unplugging just the MTP does n=
ot do the trick - I need to unplug the full transceiver)</font></div><div><=
br></div><div>Once I complete the sequence above, the link LEDs are back to=
 normal and I can complete another run of benchmark_rate. This is obviously=
 a bad solution so if you have any ideas, please let me know.</div><div>Rob=
</div><div><br></div><font face=3D"monospace">[00:00:05.113788990] Testing =
receive rate 125.000000 Msps on 4 channels<br>[00:00:05.120454627] Testing =
transmit rate 125.000000 Msps on 4 channels<br>[00:00:15.373972384] Benchma=
rk complete.<br><br>Benchmark rate summary:<br>=C2=A0 Num received samples:=
 =C2=A0 =C2=A0 5099558824<br>=C2=A0 Num dropped samples: =C2=A0 =C2=A0 =C2=
=A00<br>=C2=A0 Num overruns detected: =C2=A0 =C2=A00<br>=C2=A0 Num transmit=
ted samples: =C2=A04999335588<br>=C2=A0 Num sequence errors (Tx): 0<br>=C2=
...
=A0 =C2=A0 =C2=A0 =C2=A00<br><br><br>Done!<br><br><span style=3D"background=
-color:rgb(255,255,0)">i40e_phy_conf_link(): Failed to get PHY capabilities=
: -7</span><br></font><div><br></div></div><br><div class=3D"gmail_quote"><=
div dir=3D"ltr" class=3D"gmail_attr">On Wed, Feb 3, 2021 at 10:16 AM Rob Ko=
...
x"><div dir=3D"ltr"><div dir=3D"ltr">Hi Aaron,<div>Unfortunately, I already=
 tried playing around with the link timeout increasing up to 10 seconds.=C2=
=A0 No luck.=C2=A0 But, I am presently troubleshooting the issue and trying=
 to switch back and forth between DPDK and normal networking. I am finding =
that normal networking is not working after 1 run of DPDK. And, I&#39;m not=
icing that link LEDs are messed up and normal pings are not working.=C2=A0 =
I am playing around with disconnecting / reconnecting links in order to get=
 the link LEDs back to normal.=C2=A0 My guess is that things are not cleani=
ng up as they should.=C2=A0</div><div>Rob</div></div><br><div class=3D"gmai=
l_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Feb 3, 2021 at 9:51 =
AM Aaron Rossetto via USRP-users &lt;<a href=3D"mailto:usrp-users@lists.ett=
us.com" target=3D"_blank">usrp-users@lists.ettus.com</a>&gt; wrote:<br></di=
v><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;borde=
r-left:1px solid rgb(204,204,204);padding-left:1ex">I notice in the second =
and subsequent runs, you get this message from UHD:<br>
<br>
