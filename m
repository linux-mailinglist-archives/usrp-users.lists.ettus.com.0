...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id CE0AC34061C
	for <lists+usrp-users@lfdr.de>; Thu, 18 Mar 2021 13:53:03 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 75DE4383B43
	for <lists+usrp-users@lfdr.de>; Thu, 18 Mar 2021 08:52:59 -0400 (EDT)
Received: from mail-ot1-f51.google.com (mail-ot1-f51.google.com [209.85.210.51])
	by mm2.emwd.com (Postfix) with ESMTPS id BDEE93836C1
	for <usrp-users@lists.ettus.com>; Thu, 18 Mar 2021 08:51:58 -0400 (EDT)
Received: by mail-ot1-f51.google.com with SMTP id 68-20020a9d0f4a0000b02901b663e6258dso5046131ott.13
        for <usrp-users@lists.ettus.com>; Thu, 18 Mar 2021 05:51:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=nd.edu; s=google;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=PcLxIEOsZ4b668MHUimOl2VEDlF9zjcHY1lVR9T/pWg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=PcLxIEOsZ4b668MHUimOl2VEDlF9zjcHY1lVR9T/pWg=;
        b=
X-Gm-Message-State: AOAM531Ehpl9+e9cDmlPHBYTZykMM7nJxM4nJrYzNjDOjjqJ1JvCZsvx
	ktBRCmBifcjjJ0TNuaBVPrzchp4rjMC61cmYtM4o1A==
X-Google-Smtp-Source: ABdhPJz7ggYM8OhqhwG6nbMgkHSTg32OtelG3iN56vmF49JLK1jwkLSL+4lPZxWgEmKToBMfZS7v/XPG5kR1R25J134=
X-Received: by 2002:a9d:4049:: with SMTP id o9mr7294450oti.58.1616071917342;
 Thu, 18 Mar 2021 05:51:57 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAPnVNRUAp1_OT2VZb8KyQsc-H1U+YxSEgqcNkfwx1VbU97H+1Q@mail.gmail.com>
From: Rob Kossler <rkossler@nd.edu>
Date: Thu, 18 Mar 2021 08:51:46 -0400
Message-ID: <CAB__hTRBBMFtwyTq7hcf1HU4097FgtKFqwpN_yFxFGi=xp3Ymw@mail.gmail.com>
To: Anders Wallin <anders.e.e.wallin@gmail.com>
Message-ID-Hash: KVOVCQ6XZOTZXE62XW5EJ2ODXLT7TK55
X-Message-ID-Hash: KVOVCQ6XZOTZXE62XW5EJ2ODXLT7TK55
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/KVOVCQ6XZOTZXE62XW5EJ2ODXLT7TK55/>
...
Content-Type: multipart/mixed; boundary="===============2184968500187018359=="

--===============2184968500187018359==
Content-Type: multipart/related; boundary="00000000000092a93d05bdcf10a2"

--00000000000092a93d05bdcf10a2
Content-Type: multipart/alternative; boundary="00000000000092a93b05bdcf10a1"

--00000000000092a93b05bdcf10a1
...
> The OctoClock is a decent (but not great) distribution amplifier, see e.g.
> measurements at [1]
...
>>    general comments.
>>    - *WR switch mode*: There are 3 choices: GrandMaster, Boundary Clock,
>>    or Free-running Master.  (In my use case, there are occasions where I will
...
>>       have a 10MHz/PPS reference. But, it is not clear which mode I should choose
...
<div dir=3D"ltr">Hi Anders,<div>Thanks for all of the great information. Pa=
rticularly regarding accuracy, this was much more than I expected - but ver=
y much=C2=A0appreciated.</div><div><br></div><div>Regarding modes, I want t=
o confirm: in the case where I do not have a 10MHz/PPS source, I *must* cho=
ose Free Running Master mode?=C2=A0 Or, is it possible that if I keep the d=
efault Boundary Clock mode, the WR Switch will automatically transition to =
using its internal=C2=A0oscillator when it does not have an upstream GM??</=
div><div><br></div><div>One reason that I ask is that I presently have 1 WR=
 Switch and 1 N3xx connected (with no 10 Mhz/PPS source) and my N3xx is com=
plaining about not getting a PPS signal.=C2=A0 I have tried all WR switch m=
odes.=C2=A0</div><div>Rob</div></div><br><div class=3D"gmail_quote"><div di=
r=3D"ltr" class=3D"gmail_attr">On Thu, Mar 18, 2021 at 5:48 AM Anders Walli=
n &lt;<a href=3D"mailto:anders.e.e.wallin@gmail.com">anders.e.e.wallin@gmai=
l.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"ma=
rgin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:=
1ex"><div dir=3D"ltr">Hi Rob,<div><br></div><div>Accuracy: The attached ADE=
V-plot shows the free-running and GM modes of the WR-switch (and the low-ji=
tter variant).</div><div>The OctoClock is a decent (but not great) distribu=
tion amplifier, see e.g. measurements at [1]</div><div>Some general comment=
s to this would be: in free-run mode the WR-switch is quite poor. The frequ=
ency is off by 1-10 PPM or more, and the stability is based on a fairly che=
ap/small quartz crystal in the switch. (This is not to say several slaves a=
ll connected to the same free-run switch wouldn&#39;t be synchronized all t=
o the same unstable oscillator - I don&#39;t have test-data on that).</div>=
<div>In GM mode the standard WR-switch shows about 2e-11 ADEV at 1s, with t=
he low-jitter switch potentially 10x better. If you work with a high qualit=
y source like a Cs-clock or maser this will make a difference.</div><div>No=
te that 2e-11=C2=A0@ 1s number is about the noise-floor of a time-interval =
counter like the Keygilent 53230A - so use a phase-meter like a Microsemi/c=
hip 3120A and measure 10 MHz if you want reliable numbers.</div><div><br></=
div><div>Modes:</div><div>GM: yes you must have external 10MHz and 1PPS sou=
rces. The switch locks onto one edge of the 10MHz, the edge &#39;marked&#39=
; by the 1PPS (the exact position of the 1PPS rising edge does not matter!)=
</div><div>Boundary Clock means you have a GM switch somewhere upstream, wi=
th the GM Master-port connecting to your BC-switch slave-port (usually port=
s 1 and 2). 1PPS and 10MHz (adjustable) outputs should be available in all =
modes.</div><div><br></div><div>Transceivers: There are no restrictions afa=
ik, almost any 1Gbit transceiver should work. For short 1-2m distances you =
could try DAC-cables also. Some BX10 BiDir transceivers are recognized by t=
he default firmware, and it knows how to apply a correction for the chromat=
ic dispersion. This matters only on long links.</div><div><br></div><div>Fo=
r general WR-switch questions also try the ohwr forum:=C2=A0<a href=3D"http=
s://forums.ohwr.org/" target=3D"_blank">https://forums.ohwr.org/</a></div><=
div><br></div><div>HTH,</div><div>Anders</div><div><br></div><div>[1]=C2=A0=
<a href=3D"http://www.anderswallin.net/2016/09/ettus-octoclock-distribution=
-amplifier/fda_2016-09-12_adev/" target=3D"_blank">http://www.anderswallin.=
net/2016/09/ettus-octoclock-distribution-amplifier/fda_2016-09-12_adev/</a>=
=C2=A0</div><div><br></div><div><img src=3D"cid:ii_kmeoftfq0" alt=3D"stabil=
ity_plot_2020-12x.png" width=3D"562" height=3D"337"><br></div></div><br><di=
v class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Wed, Mar 1=
7, 2021 at 4:12 PM Rob Kossler &lt;<a href=3D"mailto:rkossler@nd.edu" targe=
t=3D"_blank">rkossler@nd.edu</a>&gt; wrote:<br></div><blockquote class=3D"g=
mail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204=
,204,204);padding-left:1ex"><div dir=3D"ltr">In my use case, I have a singl=
e WR Switch (from Seven Solutions) connected to 8 N3xx devices (WR slaves) =
via single-mode fiber (~ 10m).=C2=A0 I have a few questions:<div><ul><li><b=
>Accuracy</b>: How does the accuracy of WR compare to running 10 MHz/PPS ov=
er coax of similar length (~10m) from a reference such as an OctoClock? I d=
on&#39;t need specific quantification, but I am just looking for general co=
mments.</li><li><b>WR switch mode</b>: There are 3 choices: GrandMaster, Bo=
undary Clock, or Free-running Master.=C2=A0 (In my use case, there are occa=
sions where I will have a 10MHz/PPS reference available and other occasions=
 where I won&#39;t.)</li><ul><li>It appears that if I choose GrandMaster, I=
 *must* have a 10 MHz/PPS reference input. The WR Switch does not seem to b=
ehave well if these signals are not present. Is this correct?</li><li>Conve=
rsely, if I have a 10MHz/PPS reference available and want to use it, I *mus=
t* choose GrandMaster mode. Is this correct?</li><li>I have found documenta=
tion that indicates that it is optional to have a 10MHz/PPS reference. But,=
 it is not clear which mode I should choose for the case where I do not hav=
e such a reference. I have also found documentation that indicates that the=
 PPS output is *not* available in Boundary Clock mode, but that it *is* ava=
ilable in Free-Running Master mode.=C2=A0 Does this mean that in my use cas=
e with devices that require PPS, I must use the Free-Running Master mode fo=
r times when I don&#39;t have an external reference but then switch to Gran=
dMaster mode for times when I do have an external reference?=C2=A0 (This wo=
uld imply that I would never use the default Boundary Clock mode.)</li></ul=
><li><b>Optical Transceivers</b>: There are only a few optical transceivers=
 listed on the WR website compatibility list and in the dot-config file of =
the WR Switch device. All of them are BiDi transceivers.=C2=A0=C2=A0</li><u=
l><li>In my use case with short distances, is there any disadvantage to usi=
ng 2-fiber transceivers (common wavelength of 1310nm) at both master and sl=
ave ports? I recognize that single fiber BiDi solutions have the advantage =
that the Tx and Rx path lengths are identical, but I would expect that a du=
plex fiber has *very* similar path lengths and it has the advantage of comm=
on wavelength.</li></ul></ul>Rob</div></div>
