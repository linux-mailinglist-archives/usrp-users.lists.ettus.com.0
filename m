...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F6BF526767
	for <lists+usrp-users@lfdr.de>; Fri, 13 May 2022 18:47:41 +0200 (CEST)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id 7D9EC384380
	for <lists+usrp-users@lfdr.de>; Fri, 13 May 2022 12:47:40 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1652460460; bh=KPWRb9YqGR4Wdfw9wOLlYTqKh9WdjUciC+qiQB+WfQA=;
	h=Date:To:References:From:In-Reply-To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-qt1-f173.google.com (mail-qt1-f173.google.com [209.85.160.173])
	by mm2.emwd.com (Postfix) with ESMTPS id 402743849C3
	for <usrp-users@lists.ettus.com>; Fri, 13 May 2022 12:46:30 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="a4n2v+Iw";
	dkim-atps=neutral
Received: by mail-qt1-f173.google.com with SMTP id t16so7222282qtr.9
        for <usrp-users@lists.ettus.com>; Fri, 13 May 2022 09:46:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=message-id:date:mime-version:user-agent:subject:content-language:to
         :cc:references:from:in-reply-to;
        bh=xIPW6/2Ig/eoFWI84Ftw5n+x73BZUF6Yq/RF+zX/0oM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xIPW6/2Ig/eoFWI84Ftw5n+x73BZUF6Yq/RF+zX/0oM=;
        b=
X-Gm-Message-State: AOAM530WDxBdm3ZIckt7d/wZDfQrJB5lnRPqBm4Cs6BZPnQpdJcL/ab2
	JtVSXrlibRFeiSAnDjVI28M=
X-Google-Smtp-Source: ABdhPJwFey7gaMnxN7oUtrnA7GpNXkHLYeq8cn5uTirlr3oeoA+X1g5vyEfck06jVdLFncX2b5H0JA==
X-Received: by 2002:a05:622a:d6:b0:2f3:f4bb:4e55 with SMTP id p22-20020a05622a00d600b002f3f4bb4e55mr5549483qtw.386.1652460389629;
        Fri, 13 May 2022 09:46:29 -0700 (PDT)
Received: from [192.168.2.164] (bras-base-smflon1825w-grc-19-76-68-79-178.dsl.bell.ca. [76.68.79.178])
        by smtp.googlemail.com with ESMTPSA id b16-20020ac86bd0000000b002f39b99f6c6sm1660349qtt.96.2022.05.13.09.46.28
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 13 May 2022 09:46:28 -0700 (PDT)
Message-ID: <d415bc8d-7737-7c16-6ac7-6b0a9cbe6307@gmail.com>
Date: Fri, 13 May 2022 12:46:27 -0400
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:91.0) Gecko/20100101
 Thunderbird/91.8.1
Content-Language: en-US
To: David Raeman <david@SynopticEngineering.com>,
 Marcin Puchlik <puchlikmarcin@gmail.com>
...
In-Reply-To: <PH1P110MB1665D1C1C9AACA64C891AD1FB7CA9@PH1P110MB1665.NAMP110.PROD.OUTLOOK.COM>
Message-ID-Hash: WVE7H3YIKLWF24ZDUTGUAGMXT5DJHNWS
X-Message-ID-Hash: WVE7H3YIKLWF24ZDUTGUAGMXT5DJHNWS
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/WVE7H3YIKLWF24ZDUTGUAGMXT5DJHNWS/>
...
Content-Type: multipart/mixed; boundary="===============6077458497099663680=="

This is a multi-part message in MIME format.
--===============6077458497099663680==
Content-Type: multipart/alternative;
 boundary="------------x5Y8tgyEWAyEIhw02YEbeBKs"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------x5Y8tgyEWAyEIhw02YEbeBKs
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: quoted-printable

On 2022-05-13 12:31, David Raeman wrote:
>
> There is a motherboard sensor that you can query to check the=20
> =E2=80=98ref_locked=E2=80=99 status.
>
> However, I had noted its behavior during clock loss is inconsistent=20
> across models. In UHD 4.1 (and I=E2=80=99m working from memory here), s=
ome=20
> models (e.g. E320) check a digital lock-detect signal and always=20
> report the current lock status.=C2=A0 Other models (e.g. N320) query a=20
> register which latches a bit when the external clock is lost, and the=20
> latched bit is only cleared during initialization. On these models,=20
> once the external clock is removed the =E2=80=98ref_locked=E2=80=99 sen=
sor will=20
> continue to return false even if the clock is later reapplied while=20
> running.
>
> I can=E2=80=99t specifically speak to the B200 or UHD 3.15.
>
> Hope this helps,
>
> David
...
But historically different models have had somewhat different behavior=20
around 1PPS and external references.=C2=A0=C2=A0 My recollection for exam=
ple is=20
that on USRP2 when you ask
 =C2=A0 for external ref and there's none there, it raises an exception.
...
> *Subject:* [USRP-users] Re: Why do we need 1 PPS and 10 MHz signal to=20
> synchronize
>
...
>
>         Will=C2=A0it be enough to clock USRP from the external 10 MHz
...
ps edge
>         [INFO] [MULTI_USRP] =C2=A0 =C2=A0 2) set times next pps (synchr=
onously)
>         [INFO] [B200] Asking for clock rate 51.200000 MHz...
>         [INFO] [B200] OK
>         [INFO] [B200] Asking for clock rate 51.200000 MHz...
>         [INFO] [B200] OK
>         [WARNING] [AD936X] Selected Tx sample rate (0.2 MHz) is less th=
an
...
>             =C2=A0 frequency accuracy and drift characteristics than ar=
e
...
>                         we need=C2=A01 PPS signal? How is it used by th=
e
...
>                     that at the next
>                     =C2=A0 1PPS, to set the timestamp clock to the valu=
e
...
Content-Type: multipart/related;
 boundary="------------XQgA0vbLf4qpgCEgCX0qW811"

--------------XQgA0vbLf4qpgCEgCX0qW811
...
-8">
  ...
  <body>
    <div class=3D"moz-cite-prefix">On 2022-05-13 12:31, David Raeman
      wrote:<br>
    </div>
    <blockquote type=3D"cite"
cite=3D"mid:PH1P110MB1665D1C1C9AACA64C891AD1FB7CA9@PH1P110MB1665.NAMP110.=
PROD.OUTLOOK.COM">
...
<o:idmap v:ext=3D"edit" data=3D"1" />
      ...
      <div class=3D"WordSection1">
        <p class=3D"MsoNormal">There is a motherboard sensor that you can
          query to check the =E2=80=98ref_locked=E2=80=99 status.
          <o:p></o:p></p>
        <p class=3D"MsoNormal"><o:p>=C2=A0</o:p></p>
        <p class=3D"MsoNormal">However, I had noted its behavior during
          clock loss is inconsistent across models. In UHD 4.1 (and I=E2=80=
=99m
          working from memory here), some models (e.g. E320) check a
          digital lock-detect signal and always report the current lock
          status.=C2=A0 Other models (e.g. N320) query a register which
          latches a bit when the external clock is lost, and the latched
          bit is only cleared during initialization. On these models,
          once the external clock is removed the =E2=80=98ref_locked=E2=80=
=99 sensor
          will continue to return false even if the clock is later
          reapplied while running.<o:p></o:p></p>
        <p class=3D"MsoNormal"><o:p>=C2=A0</o:p></p>
        <p class=3D"MsoNormal">I can=E2=80=99t specifically speak to the =
B200 or
          UHD 3.15.<o:p></o:p></p>
        <p class=3D"MsoNormal"><o:p>=C2=A0</o:p></p>
...
br>
    <br>
    But historically different models have had somewhat different
    behavior around 1PPS and external references.=C2=A0=C2=A0 My recollec=
tion for
    example is that on USRP2 when you ask<br>
    =C2=A0 for external ref and there's none there, it raises an exceptio=
n.<br>
    <br>
    <br>
    <blockquote type=3D"cite"
...
n
          ...
          <div>
            <div style=3D"border:none;border-top:solid #E1E1E1
              ...
              <p class=3D"MsoNormal"><b>From:</b> Marcin Puchlik
                <a class=3D"moz-txt-link-rfc2396E" href=3D"mailto:puchlik=
marcin@gmail.com">&lt;puchlikmarcin@gmail.com&gt;</a> <br>
                <b>Sent:</b> Friday, May 13, 2022 10:38 AM<br>
...
mailto:usrp-users@lists.ettus.com">usrp-users@lists.ettus.com</a><br>
                <b>Subject:</b> [USRP-users] Re: Why do we need 1 PPS
                and 10 MHz signal to synchronize<o:p></o:p></p>
            </div>
          </div>
          <p class=3D"MsoNormal"><o:p>=C2=A0</o:p></p>
          <div>
            <p class=3D"MsoNormal">But you know what I observed and what
              is weird? When I ask for an external source and I
              intentionally turn off the external generator providing a
              10 MHz signal, USRP behaves as if it was still seeing a 10
              MHz reference signal at its input. Doesn't matter if the
              generator is switched on or off - USRP behaves the same
              way. Because of that I am=C2=A0 not sure if USRP is being
              clocked=C2=A0from an internal or external clock source. Is =
it
              the bug in the GNU radio or UHD or am I doing=C2=A0somethin=
g
              wrong? How can I get the feedback from the USRP hardware
              that it was locked to the external clock? Is it even
              possible?=C2=A0<br clear=3D"all">
              <o:p></o:p></p>
            <div>
              <div>
                <div>
...
arcus D.
            ...
            <blockquote style=3D"border:none;border-left:solid #CCCCCC
              ...
              <div>
                <div>
                  <p class=3D"MsoNormal">On 2022-05-11 09:51, Marcin
                    Puchlik wrote:<o:p></o:p></p>
                </div>
                <blockquote style=3D"margin-top:5.0pt;margin-bottom:5.0pt=
">
                  <div>
                    <div>
                      <p class=3D"MsoNormal">Will=C2=A0it be enough to cl=
ock
                        USRP from the external 10 MHz signal generator?
                        When I run the flowgraph I cannot see the
                        information that is using the external clock.
                        Here is the output from GNU Radio:<o:p></o:p></p>
                    </div>
                    <div>
                      <p class=3D"MsoNormal">[INFO] [UHD] linux; GNU C++
                        version 9.4.0; Boost_107100;
                        ...
                        [INFO] [B200] Performing register loopback
                        test... <br>
                        [INFO] [B200] Register loopback test passed<br>
                        [INFO] [B200] Setting master clock rate
                        selection to 'automatic'.<br>
                        [INFO] [B200] Asking for clock rate 16.000000
                        MHz... <br>
                        [INFO] [B200] Actually got clock rate 16.000000
                        MHz.<br>
                        [INFO] [B200] Asking for clock rate 51.200000
                        MHz... <br>
                        [INFO] [B200] Actually got clock rate 51.200000
                        MHz.<br>
                        [INFO] [MULTI_USRP] =C2=A0 =C2=A0 1) catch time t=
ransition
                        at pps edge<br>
                        [INFO] [MULTI_USRP] =C2=A0 =C2=A0 2) set times ne=
xt pps
                        (synchronously)<br>
                        [INFO] [B200] Asking for clock rate 51.200000
                        MHz... <br>
                        ...
                        MHz... <br>
                        [INFO] [B200] OK<br>
                        [WARNING] [AD936X] Selected Tx sample rate (0.2
                        MHz) is less than<br>
                        analog frontend filter bandwidth (0.2 MHz).<o:p><=
/o:p></p>
                    </div>
                    <div>
                      <p class=3D"MsoNormal"><o:p>=C2=A0</o:p></p>
                    ...
                    <p class=3D"MsoNormal"><img
                        style=3D"width:5.8541in;height:5.8541in"
                        id=3D"Picture_x0020_1"
                        src=3D"cid:part1.1AUzMXAj.08opt0XR@gmail.com"
                        class=3D"" width=3D"562" height=3D"562" border=3D=
"0"><o:p></o:p></p>
                  </div>
                  <p class=3D"MsoNormal"><o:p>=C2=A0</o:p></p>
                </blockquote>
                <p class=3D"MsoNormal">Yeah, I don't think it puts out an
                  "i'm locked to the external reference" message.<br>
                  <br>
                  But you've asked for "external" clock source, so you
                  should be good to go, assuming your external generator
...
">
                  <div>
                    <div>
                      <p class=3D"MsoNormal">=C5=9Br., 11 maj 2022 o
...
mail.com</a>&gt;
                    ...
                    <blockquote style=3D"border:none;border-left:solid
                      ...
                      <div>
                        <div>
                          <p class=3D"MsoNormal">On 2022-05-11 09:18,
                            Marcin Puchlik wrote:<o:p></o:p></p>
                        </div>
                        <blockquote
...
>
                            <div>
                              <p class=3D"MsoNormal">Thank you very much
                                for the answer. Does it mean that 1 PPS
                                signal is optional? Can I only provide
                                an external 10 MHz clock without 1 PPS?<b=
r
                                  clear=3D"all">
                                <o:p></o:p></p>
                              <div>
                                <div>
                                  <div>
                                    <div>
                                      <div>
                                        <p class=3D"MsoNormal"><b>Z
                                            powa=C5=BCaniem=C2=A0</b> <o:=
p></o:p></p>
                                        <div>
                                          <p class=3D"MsoNormal"><b>Marci=
n
                                              Puchlik</b><o:p></o:p></p>
                                        </div>
                                      </div>
                        ...
                        <p class=3D"MsoNormal"><b>Yes, absolutely.=C2=A0 =
If
                            timestamp synchronization is not important
                            to you, then you can just provide a 10MHz
                            reference when you want better<br>
                            =C2=A0 frequency accuracy and drift
                            characteristics than are offered by the
                            on-board clock and/or you want some type of
...
>
                          ...
                          <div>
                            <div>
                              <p class=3D"MsoNormal">=C5=9Br., 11 maj 202=
2 o
...
nbraun@gmail.com</a>&gt;
                            ...
                            <blockquote
                              ...
                              <div>
                                <div>
                                  <p class=3D"MsoNormal">On 2022-05-11
                                    06:17, Marcin Puchlik wrote:<o:p></o:=
p></p>
                                </div>
                                <blockquote
                                  style=3D"margin-top:5.0pt;margin-bottom=
:5.0pt">
                                  <div>
                                    <p class=3D"MsoNormal">Hello
                                      Community, <o:p></o:p></p>
                                    <div>
                                      <p class=3D"MsoNormal">Like in the
                                        topic, I know that a stable 10
                                        MHz source is needed as a clock
                                        signal but why do we need=C2=A01 =
PPS
                                        signal? How is it used by the
                                        USRP hardware? Can someone
                                        explain that to me?<o:p></o:p></p=
>
                                    </div>
                                    <div>
                                      <p class=3D"MsoNormal">Thanks<o:p><=
/o:p></p>
                                    </div>
                                    <div>
                                      <div>
...
<o:p></o:p></p>
                                  ...
                                  <p class=3D"MsoNormal"><o:p>=C2=A0</o:p=
></p>
                                  <pre>__________________________________=
_____________<o:p></o:p></pre>
                                  <pre>USRP-users mailing list -- <a href=
=3D"mailto:usrp-users@lists.ettus.com" target=3D"_blank" moz-do-not-send=3D=
"true" class=3D"moz-txt-link-freetext">usrp-users@lists.ettus.com</a><o:p=
></o:p></pre>
                                  <pre>To unsubscribe send an email to <a=
 href=3D"mailto:usrp-users-leave@lists.ettus.com" target=3D"_blank" moz-d=
o-not-send=3D"true" class=3D"moz-txt-link-freetext">usrp-users-leave@list=
s.ettus.com</a><o:p></o:p></pre>
                                </blockquote>
                                <p class=3D"MsoNormal"
                                  style=3D"margin-bottom:12.0pt">1PPS is
                                  used to provide timestamp-clock
                                  synchronization across multiple
                                  devices, typically.=C2=A0 This is impor=
tant
                                  when your application requires this,
                                  such as in MIMO or<br>
                                  =C2=A0 multi-receiver TDOA schemes, etc=
.<br>
                                  <br>
                                  Basically, when you have multiple
                                  devices you use set_time_unknown_pps()
                                  or set_time_next_pps() to signal to
                                  all devices in your multi_usrp object=C2=
=A0
                                  that at the next<br>
                                  =C2=A0 1PPS, to set the timestamp clock=
 to
                                  the value given in the the API call.<br=
>
                                  <br>
                                  This turns out to be useful even in
                                  single devices that are "bicameral",
                                  such as B210 and X310, where there are
                                  (for historic and architectural
                                  reasons)<br>
                                  =C2=A0 TWO timestamp clocks.=C2=A0 Use =
the 1PPS
...
ue"
                                  class=3D"moz-txt-link-freetext">
                                  usrp-users-leave@lists.ettus.com</a><o:=
p></o:p></p>
                            </blockquote>
                          </div>
                        </blockquote>
...
Content-Id: <part1.1AUzMXAj.08opt0XR@gmail.com>
