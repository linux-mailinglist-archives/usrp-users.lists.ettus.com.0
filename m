...
Received: from mm2.emwd.com (mm2.emwd.com [172.104.30.75])
	by mail.lfdr.de (Postfix) with ESMTPS id 059B16B9E36
	for <lists+usrp-users@lfdr.de>; Tue, 14 Mar 2023 19:23:56 +0100 (CET)
Received: from mm2.emwd.com (localhost [127.0.0.1])
	by mm2.emwd.com (Postfix) with ESMTP id DAD3E383F00
	for <lists+usrp-users@lfdr.de>; Tue, 14 Mar 2023 14:23:54 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=emwd.com; s=harmony;
	t=1678818234; bh=jkl6JmVFsDoDcSF5TIhO4JAU3eHItaXL7o1lWKQ/bao=;
	h=References:In-Reply-To:From:Date:To:CC:Subject:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=
Received: from mail-ed1-f44.google.com (mail-ed1-f44.google.com [209.85.208.44])
	by mm2.emwd.com (Postfix) with ESMTPS id F2BE8383E5E
	for <usrp-users@lists.ettus.com>; Tue, 14 Mar 2023 14:23:12 -0400 (EDT)
Authentication-Results: mm2.emwd.com;
	dkim=pass (2048-bit key; unprotected) header.d=nd.edu header.i=@nd.edu header.b="e5rOAWeZ";
	dkim-atps=neutral
Received: by mail-ed1-f44.google.com with SMTP id eg48so6509604edb.13
        for <usrp-users@lists.ettus.com>; Tue, 14 Mar 2023 11:23:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=nd.edu; s=google; t=1678818191;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=odI/qhMY0TAfEhmKnz8lq6gxnP9ELrRCNUmczI+L7J4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1678818191;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=odI/qhMY0TAfEhmKnz8lq6gxnP9ELrRCNUmczI+L7J4=;
        b=
X-Gm-Message-State: AO0yUKUjvP+itDfE0YGjduPEP/1zplgnp0o+w7kKyw40FkVBc/Ayy6QG
	OmPgagp4moYDbzABtine2z63N4WQrUuGCiyfcRQQQJqSWmshXKRM
X-Google-Smtp-Source: AK7set8OadGBliXL/L5GzmciVp3ksrty8sC3POQsdJCnvbxxtxuo/fL2M2SyIN9qfZc3/+HgVavqTuSWoGkmMDfZkUA=
X-Received: by 2002:a17:906:340f:b0:91f:a4b8:9a4a with SMTP id
 c15-20020a170906340f00b0091fa4b89a4amr1761177ejb.6.1678818191153; Tue, 14 Mar
...
References: <PH0PR15MB4704C1D70796EEDE9A062100E3B79@PH0PR15MB4704.namprd15.prod.outlook.com>
 ...
 <a60694a4-aa5c-95e0-817d-642a6c0e0171@gmail.com>
In-Reply-To: <a60694a4-aa5c-95e0-817d-642a6c0e0171@gmail.com>
From: Rob Kossler <rkossler@nd.edu>
Date: Tue, 14 Mar 2023 14:22:58 -0400
Message-ID: <CAB__hTRQZxSNbdTvRRgFEXzgmEMZRPRjiZb+F1wpy40rmEG_Mg@mail.gmail.com>
To: "Marcus D. Leech" <patchvonbraun@gmail.com>
Message-ID-Hash: EQ67PBSPBBYFO22SLTLAE52E2N3HZOFT
X-Message-ID-Hash: EQ67PBSPBBYFO22SLTLAE52E2N3HZOFT
...
Archived-At: <https://lists.ettus.com/archives/list/usrp-users@lists.ettus.com/message/EQ67PBSPBBYFO22SLTLAE52E2N3HZOFT/>
...
Content-Type: multipart/mixed; boundary="===============8528791754591091282=="

--===============8528791754591091282==
Content-Type: multipart/alternative; boundary="000000000000ed897405f6e051a1"

--000000000000ed897405f6e051a1
...
On Tue, Mar 14, 2023 at 12:10=E2=80=AFPM Marcus D. Leech <patchvonbraun@gma=
il.com>
wrote:
...
> When using sc8's, I got (I3 Q3 I2 Q2 I1 Q1 I0 Q0) which I didn't expect a=
t
> all.
>
> Regards,
...
> *Subject:* [USRP-users] Re: RFNOC module sending back (or receiving) data
> in the wrong order
>
...
>
>
> On Wed, Mar 8, 2023 at 1:45=E2=80=AFPM Marcus D. Leech <patchvonbraun@gma=
il.com>
> wrote:
>
...
<div dir=3D"ltr">I think that there are 2 places where byte ordering occurs=
: in the FPGA at the Streaming Endpoint (SEP) and in UHD with a particular =
converter.=C2=A0 Assuming a 64-bit CHDR word coming into the SEP, the SEP o=
rders the bytes according to what it thinks the &quot;item&quot; size is (I=
 really don&#39;t know how it knows the item size or if/how you can configu=
re it differently). But, in any case, if the SEP thinks that the item size =
is 4 bytes, it will order the bytes by MSB in order to send across the link=
 (e.g., Ethernet). If the CHDR width is 8 bytes and the item size is 4 byte=
s, I&#39;m not sure if the SEP will send the lower &quot;item&quot; first o=
r the upper &quot;item&quot; first.=C2=A0=C2=A0<div><br></div><div>On the U=
HD side, it will assume an item type based on the rx streamer OTW setting (=
e.g., &quot;sc16&quot;) and will swap bytes if needed for a little=C2=A0end=
ian host.=C2=A0 (I do not know if the OTW setting affects the behavior of t=
he SEP on the FPGA but perhaps it does.)</div><div><br></div><div>Until I u=
nderstand things better, I have resigned myself to having to assume that bo=
th the FPGA and UHD will treat my bytes as an sc16 such that I have to pre-=
arrange and/or post-arrange any manipulations performed by the SEP and UHD =
converter.=C2=A0 This is not very convenient.</div><div>Rob</div></div><br>=
<div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Tue, Ma=
r 14, 2023 at 12:10=E2=80=AFPM Marcus D. Leech &lt;<a href=3D"mailto:patchv=
...
e:12pt;color:rgb(0,0,0);background-color:rgb(255,255,255)">
      ...
      <div id=3D"m_5998183473085879005divRplyFwdMsg" dir=3D"ltr"><font styl=
